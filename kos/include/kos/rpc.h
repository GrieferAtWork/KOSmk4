...
__CDECLARE_OPT(__ATTR_IN(3) __ATTR_INS(4, 5),int,__NOTHROW_RPC,rpc_schedule,(__pid_t __target_tid, unsigned int __mode, void const *__program, void const *const *__params, __SIZE_TYPE__ __max_param_count),(__target_tid,__mode,__program,__params,__max_param_count))
/* >> rpc_serve(2)
