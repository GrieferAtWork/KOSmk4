...
__COMPILER_CEIDECLARE(__ATTR_WUNUSED __NOBLOCK __ATTR_NONNULL((1)),__BOOL,__NOTHROW,__FCALL,shared_recursive_lock_tryacquire,(struct shared_recursive_lock *__restrict __self),{
...
/* >> shared_recursive_lock_tryacquire(3)
 * Try to acquire a recursive lock to `self' */
__LOCAL __ATTR_WUNUSED __NOBLOCK __ATTR_NONNULL((1)) __BOOL __NOTHROW(__FCALL shared_recursive_lock_tryacquire)(struct shared_recursive_lock *__restrict __self) {
	if (__hybrid_atomic_xch(__self->sr_lock.sl_lock, 1, __ATOMIC_ACQUIRE) == 0) {
		__shared_recursive_lock_setown(__self);
		return 1;
	}
...
__COMPILER_CEIDECLARE(__NOBLOCK __ATTR_NONNULL((1)),__BOOL,__NOTHROW,__FCALL,shared_recursive_lock_release,(struct shared_recursive_lock *__restrict __self),{
	__COMPILER_BARRIER();
 ...
 * @return: true:  The lock has become free.
 * @return: false: You're still holding the lock */
__LIBC __NOBLOCK __ATTR_NONNULL((1)) __BOOL __NOTHROW(__FCALL shared_recursive_lock_release)(struct shared_recursive_lock *__restrict __self) __CASMNAME_SAME("shared_recursive_lock_release");
#elif defined(__shared_lock_send)
/* >> shared_recursive_lock_release(3)
 * Release a recursive lock from `self'
 * @return: true:  The lock has become free.
 * @return: false: You're still holding the lock */
__LOCAL __NOBLOCK __ATTR_NONNULL((1)) __BOOL __NOTHROW(__FCALL shared_recursive_lock_release)(struct shared_recursive_lock *__restrict __self) {
	__COMPILER_BARRIER();
	__hybrid_assertf(__self->sr_lock.sl_lock != 0, "Lock isn't acquired");
	__hybrid_assertf(__shared_recursive_lock_isown(__self), "You're not the owner of this lock");
	if (__self->sr_rcnt == 0) {
...
__COMPILER_CREDIRECT_VOID(__LIBC,__BLOCKING __ATTR_NONNULL((1)),__THROWING,__FCALL,__localdep_shared_lock_acquire,(struct shared_lock *__restrict __self),shared_lock_acquire,(__self))
...
__COMPILER_CEIDECLARE(__BLOCKING __ATTR_NONNULL((1)),void,__THROWING,__FCALL,shared_recursive_lock_acquire,(struct shared_recursive_lock *__restrict __self),{
	if (__shared_recursive_lock_isown(__self)) {
		++__self->sr_rcnt;
		return;
	}
...
/* >> shared_recursive_lock_acquire(3)
 * Acquire a recursive lock to the given shared_recursive_lock. */
__LIBC __BLOCKING __ATTR_NONNULL((1)) void (__FCALL shared_recursive_lock_acquire)(struct shared_recursive_lock *__restrict __self) __THROWS(__E_WOULDBLOCK, ...) __CASMNAME_SAME("shared_recursive_lock_acquire");
...
/* >> shared_recursive_lock_acquire(3)
 * Acquire a recursive lock to the given shared_recursive_lock. */
__LOCAL __BLOCKING __ATTR_NONNULL((1)) void (__FCALL shared_recursive_lock_acquire)(struct shared_recursive_lock *__restrict __self) __THROWS(__E_WOULDBLOCK, ...) {
	if (__shared_recursive_lock_isown(__self)) {
		++__self->sr_rcnt;
		return;
	}
...
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,__localdep_shared_lock_acquire_with_timeout,(struct shared_lock *__restrict __self, __shared_lock_timespec __abs_timeout),shared_lock_acquire_with_timeout,(__self,__abs_timeout))
 ...
 * @return: true:  Successfully acquired a lock.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,__localdep_shared_lock_acquire_with_timeout,(struct shared_lock *__restrict __self, __shared_lock_timespec __abs_timeout),shared_lock_acquire_with_timeout64,(__self,__abs_timeout))
 ...
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CEIDECLARE(__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_acquire_with_timeout,(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout),{
	__BOOL __result;
	if (__shared_recursive_lock_isown(__self)) {
		++__self->sr_rcnt;
		return 1;
 ...
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__LIBC __ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)) __BOOL (__FCALL shared_recursive_lock_acquire_with_timeout)(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout) __THROWS(__E_WOULDBLOCK, ...) __CASMNAME_SAME("shared_recursive_lock_acquire_with_timeout");
 ...
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_acquire_with_timeout,(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout),shared_recursive_lock_acquire_with_timeout64,(__self,__abs_timeout))
 ...
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__LOCAL __ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)) __BOOL (__FCALL shared_recursive_lock_acquire_with_timeout)(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout) __THROWS(__E_WOULDBLOCK, ...) {
	__BOOL __result;
	if (__shared_recursive_lock_isown(__self)) {
		++__self->sr_rcnt;
		return 1;
...
__COMPILER_CREDIRECT_VOID(__LIBC,__BLOCKING __ATTR_NONNULL((1)),__THROWING,__FCALL,__localdep_shared_lock_waitfor,(struct shared_lock *__restrict __self),shared_lock_waitfor,(__self))
#elif defined(__KERNEL__) || defined(__CRT_HAVE_LFutexExprI64) || defined(__CRT_HAVE_LFutexExprI) || (defined(__cplusplus) && defined(__KOS__) && (defined(__CRT_HAVE_LFutexExpr64) || defined(__CRT_HAVE_LFutexExpr)))
__NAMESPACE_LOCAL_END
...
__COMPILER_CEIDECLARE(__BLOCKING __ATTR_NONNULL((1)),void,__THROWING,__FCALL,shared_recursive_lock_waitfor,(struct shared_recursive_lock *__restrict __self),{
	if (__shared_recursive_lock_isown(__self))
		return;
...
/* >> shared_recursive_lock_waitfor(3)
 * Wait until acquiring a recursive lock to `self' no longer blocks */
__LIBC __BLOCKING __ATTR_NONNULL((1)) void (__FCALL shared_recursive_lock_waitfor)(struct shared_recursive_lock *__restrict __self) __THROWS(__E_WOULDBLOCK, ...) __CASMNAME_SAME("shared_recursive_lock_waitfor");
...
/* >> shared_recursive_lock_waitfor(3)
 * Wait until acquiring a recursive lock to `self' no longer blocks */
__LOCAL __BLOCKING __ATTR_NONNULL((1)) void (__FCALL shared_recursive_lock_waitfor)(struct shared_recursive_lock *__restrict __self) __THROWS(__E_WOULDBLOCK, ...) {
	if (__shared_recursive_lock_isown(__self))
		return;
	(__NAMESPACE_LOCAL_SYM __localdep_shared_lock_waitfor)(&__self->sr_lock);
}
 ...
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,__localdep_shared_lock_waitfor_with_timeout,(struct shared_lock *__restrict __self, __shared_lock_timespec __abs_timeout),shared_lock_waitfor_with_timeout,(__self,__abs_timeout))
 ...
 * @return: true:  The lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,__localdep_shared_lock_waitfor_with_timeout,(struct shared_lock *__restrict __self, __shared_lock_timespec __abs_timeout),shared_lock_waitfor_with_timeout64,(__self,__abs_timeout))
#elif defined(__KERNEL__) || defined(__CRT_HAVE_LFutexExprI) || defined(__CRT_HAVE_LFutexExprI64) || (defined(__cplusplus) && defined(__KOS__) && (defined(__CRT_HAVE_LFutexExpr) || defined(__CRT_HAVE_LFutexExpr64)))
__NAMESPACE_LOCAL_END
 ...
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CEIDECLARE(__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_waitfor_with_timeout,(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout),{
	if (__shared_recursive_lock_isown(__self))
		return 1;
 ...
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__LIBC __ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)) __BOOL (__FCALL shared_recursive_lock_waitfor_with_timeout)(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout) __THROWS(__E_WOULDBLOCK, ...) __CASMNAME_SAME("shared_recursive_lock_waitfor_with_timeout");
 ...
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_waitfor_with_timeout,(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout),shared_recursive_lock_waitfor_with_timeout64,(__self,__abs_timeout))
 ...
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__LOCAL __ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)) __BOOL (__FCALL shared_recursive_lock_waitfor_with_timeout)(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout) __THROWS(__E_WOULDBLOCK, ...) {
	if (__shared_recursive_lock_isown(__self))
		return 1;
	return (__NAMESPACE_LOCAL_SYM __localdep_shared_lock_waitfor_with_timeout)(&__self->sr_lock, __abs_timeout);
}
 ...
 * @return: true:  Successfully acquired a lock.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,__localdep_shared_lock_acquire_with_timeout64,(struct shared_lock *__restrict __self, struct timespec64 const *__abs_timeout),shared_lock_acquire_with_timeout,(__self,__abs_timeout))
#elif defined(__CRT_HAVE_shared_lock_acquire_with_timeout64)
/* >> shared_lock_acquire_with_timeout(3), shared_lock_acquire_with_timeout64(3)
 * Acquire a lock to the given shared_lock, and block until `abs_timeout' or indefinitely.
 * @return: true:  Successfully acquired a lock.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,__localdep_shared_lock_acquire_with_timeout64,(struct shared_lock *__restrict __self, struct timespec64 const *__abs_timeout),shared_lock_acquire_with_timeout64,(__self,__abs_timeout))
 ...
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CEIREDIRECT(__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_acquire_with_timeout64,(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout),shared_recursive_lock_acquire_with_timeout,{
	__BOOL __result;
	if (__shared_recursive_lock_isown(__self)) {
		++__self->sr_rcnt;
		return 1;
 ...
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_acquire_with_timeout64,(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout),shared_recursive_lock_acquire_with_timeout,(__self,__abs_timeout))
#elif defined(__CRT_HAVE_shared_recursive_lock_acquire_with_timeout64)
/* >> shared_recursive_lock_acquire_with_timeout(3), shared_recursive_lock_acquire_with_timeout64(3)
 * Acquire a recursive lock to the given shared_recursive_lock.
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__LIBC __ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)) __BOOL (__FCALL shared_recursive_lock_acquire_with_timeout64)(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout) __THROWS(__E_WOULDBLOCK, ...) __CASMNAME_SAME("shared_recursive_lock_acquire_with_timeout64");
 ...
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__LOCAL __ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)) __BOOL (__FCALL shared_recursive_lock_acquire_with_timeout64)(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout) __THROWS(__E_WOULDBLOCK, ...) {
	__BOOL __result;
	if (__shared_recursive_lock_isown(__self)) {
		++__self->sr_rcnt;
		return 1;
 ...
 * @return: true:  The lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,__localdep_shared_lock_waitfor_with_timeout64,(struct shared_lock *__restrict __self, struct timespec64 const *__abs_timeout),shared_lock_waitfor_with_timeout,(__self,__abs_timeout))
#elif defined(__CRT_HAVE_shared_lock_waitfor_with_timeout64)
/* >> shared_lock_waitfor_with_timeout(3), shared_lock_waitfor_with_timeout64(3)
 * Wait for `self' to become available, blocking until `abs_timeout' or indefinitely.
 * @return: true:  The lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,__localdep_shared_lock_waitfor_with_timeout64,(struct shared_lock *__restrict __self, struct timespec64 const *__abs_timeout),shared_lock_waitfor_with_timeout64,(__self,__abs_timeout))
#elif defined(__CRT_HAVE_LFutexExprI64) || defined(__CRT_HAVE_LFutexExprI) || (defined(__cplusplus) && defined(__KOS__) && (defined(__CRT_HAVE_LFutexExpr64) || defined(__CRT_HAVE_LFutexExpr)))
__NAMESPACE_LOCAL_END
 ...
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CEIREDIRECT(__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_waitfor_with_timeout64,(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout),shared_recursive_lock_waitfor_with_timeout,{
	if (__shared_recursive_lock_isown(__self))
		return 1;
 ...
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_waitfor_with_timeout64,(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout),shared_recursive_lock_waitfor_with_timeout,(__self,__abs_timeout))
#elif defined(__CRT_HAVE_shared_recursive_lock_waitfor_with_timeout64)
/* >> shared_recursive_lock_waitfor_with_timeout(3), shared_recursive_lock_waitfor_with_timeout64(3)
 * Wait until acquiring a recursive lock to `self' no longer blocks
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__LIBC __ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)) __BOOL (__FCALL shared_recursive_lock_waitfor_with_timeout64)(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout) __THROWS(__E_WOULDBLOCK, ...) __CASMNAME_SAME("shared_recursive_lock_waitfor_with_timeout64");
 ...
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__LOCAL __ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)) __BOOL (__FCALL shared_recursive_lock_waitfor_with_timeout64)(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout) __THROWS(__E_WOULDBLOCK, ...) {
	if (__shared_recursive_lock_isown(__self))
		return 1;
	return (__NAMESPACE_LOCAL_SYM __localdep_shared_lock_waitfor_with_timeout64)(&__self->sr_lock, __abs_timeout);
}
 ...
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CEIREDIRECT(__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_acquire,(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout),shared_recursive_lock_acquire_with_timeout,{
	__BOOL __result;
	if (__shared_recursive_lock_isown(__self)) {
		++__self->sr_rcnt;
		return 1;
 ...
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_acquire,(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout),shared_recursive_lock_acquire_with_timeout,(__self,__abs_timeout))
#elif defined(__CRT_HAVE_shared_recursive_lock_acquire_with_timeout64) && (defined(__USE_TIME_BITS64) || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)
/* >> shared_recursive_lock_acquire_with_timeout(3), shared_recursive_lock_acquire_with_timeout64(3)
 * Acquire a recursive lock to the given shared_recursive_lock.
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_acquire,(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout),shared_recursive_lock_acquire_with_timeout64,(__self,__abs_timeout))
#elif (defined(__CRT_HAVE_shared_lock_acquire_with_timeout) && (!defined(__USE_TIME_BITS64) || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)) || (defined(__CRT_HAVE_shared_lock_acquire_with_timeout64) && (defined(__USE_TIME_BITS64) || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)) || defined(__KERNEL__) || defined(__CRT_HAVE_LFutexExprI) || defined(__CRT_HAVE_LFutexExprI64) || (defined(__cplusplus) && defined(__KOS__) && (defined(__CRT_HAVE_LFutexExpr) || defined(__CRT_HAVE_LFutexExpr64)))
} /* extern "C++" */
__NAMESPACE_LOCAL_BEGIN
#ifndef __local___localdep_shared_lock_acquire_with_timeout_defined
 ...
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__LOCAL __ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)) __BOOL (__FCALL shared_recursive_lock_acquire)(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout) __THROWS(__E_WOULDBLOCK, ...) {
	__BOOL __result;
	if (__shared_recursive_lock_isown(__self)) {
		++__self->sr_rcnt;
		return 1;
 ...
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CEIREDIRECT(__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_waitfor,(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout),shared_recursive_lock_waitfor_with_timeout,{
	if (__shared_recursive_lock_isown(__self))
		return 1;
	return (__NAMESPACE_LOCAL_SYM __localdep_shared_lock_waitfor_with_timeout)(&__self->sr_lock, __abs_timeout);
})
 ...
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_waitfor,(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout),shared_recursive_lock_waitfor_with_timeout,(__self,__abs_timeout))
#elif defined(__CRT_HAVE_shared_recursive_lock_waitfor_with_timeout64) && (defined(__USE_TIME_BITS64) || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)
/* >> shared_recursive_lock_waitfor_with_timeout(3), shared_recursive_lock_waitfor_with_timeout64(3)
 * Wait until acquiring a recursive lock to `self' no longer blocks
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_waitfor,(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout),shared_recursive_lock_waitfor_with_timeout64,(__self,__abs_timeout))
#elif (defined(__CRT_HAVE_shared_lock_waitfor_with_timeout) && (!defined(__USE_TIME_BITS64) || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)) || (defined(__CRT_HAVE_shared_lock_waitfor_with_timeout64) && (defined(__USE_TIME_BITS64) || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)) || defined(__KERNEL__) || defined(__CRT_HAVE_LFutexExprI) || defined(__CRT_HAVE_LFutexExprI64) || (defined(__cplusplus) && defined(__KOS__) && (defined(__CRT_HAVE_LFutexExpr) || defined(__CRT_HAVE_LFutexExpr64)))
} /* extern "C++" */
__NAMESPACE_LOCAL_BEGIN
#ifndef __local___localdep_shared_lock_waitfor_with_timeout_defined
 ...
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__LOCAL __ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)) __BOOL (__FCALL shared_recursive_lock_waitfor)(struct shared_recursive_lock *__restrict __self, __shared_lock_timespec __abs_timeout) __THROWS(__E_WOULDBLOCK, ...) {
	if (__shared_recursive_lock_isown(__self))
		return 1;
	return (__NAMESPACE_LOCAL_SYM __localdep_shared_lock_waitfor_with_timeout)(&__self->sr_lock, __abs_timeout);
}
 ...
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CEIREDIRECT(__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_acquire,(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout),shared_recursive_lock_acquire_with_timeout,{
	__BOOL __result;
	if (__shared_recursive_lock_isown(__self)) {
		++__self->sr_rcnt;
		return 1;
 ...
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_acquire,(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout),shared_recursive_lock_acquire_with_timeout,(__self,__abs_timeout))
#elif defined(__CRT_HAVE_shared_recursive_lock_acquire_with_timeout64)
/* >> shared_recursive_lock_acquire_with_timeout(3), shared_recursive_lock_acquire_with_timeout64(3)
 * Acquire a recursive lock to the given shared_recursive_lock.
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_acquire,(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout),shared_recursive_lock_acquire_with_timeout64,(__self,__abs_timeout))
#elif (defined(__CRT_HAVE_shared_lock_acquire_with_timeout) && __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__) || defined(__CRT_HAVE_shared_lock_acquire_with_timeout64) || defined(__CRT_HAVE_LFutexExprI64) || defined(__CRT_HAVE_LFutexExprI) || (defined(__cplusplus) && defined(__KOS__) && (defined(__CRT_HAVE_LFutexExpr64) || defined(__CRT_HAVE_LFutexExpr)))
} /* extern "C++" */
__NAMESPACE_LOCAL_BEGIN
#ifndef __local___localdep_shared_lock_acquire_with_timeout64_defined
 ...
 * @return: true:  Successfully acquired a recursive lock.
 * @return: false: The given `abs_timeout' has expired. */
__LOCAL __ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)) __BOOL (__FCALL shared_recursive_lock_acquire)(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout) __THROWS(__E_WOULDBLOCK, ...) {
	__BOOL __result;
	if (__shared_recursive_lock_isown(__self)) {
		++__self->sr_rcnt;
		return 1;
 ...
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CEIREDIRECT(__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_waitfor,(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout),shared_recursive_lock_waitfor_with_timeout,{
	if (__shared_recursive_lock_isown(__self))
		return 1;
	return (__NAMESPACE_LOCAL_SYM __localdep_shared_lock_waitfor_with_timeout64)(&__self->sr_lock, __abs_timeout);
})
 ...
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_waitfor,(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout),shared_recursive_lock_waitfor_with_timeout,(__self,__abs_timeout))
#elif defined(__CRT_HAVE_shared_recursive_lock_waitfor_with_timeout64)
/* >> shared_recursive_lock_waitfor_with_timeout(3), shared_recursive_lock_waitfor_with_timeout64(3)
 * Wait until acquiring a recursive lock to `self' no longer blocks
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__COMPILER_CREDIRECT(__LIBC,__ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)),__BOOL,__THROWING,__FCALL,shared_recursive_lock_waitfor,(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout),shared_recursive_lock_waitfor_with_timeout64,(__self,__abs_timeout))
#elif (defined(__CRT_HAVE_shared_lock_waitfor_with_timeout) && __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__) || defined(__CRT_HAVE_shared_lock_waitfor_with_timeout64) || defined(__CRT_HAVE_LFutexExprI64) || defined(__CRT_HAVE_LFutexExprI) || (defined(__cplusplus) && defined(__KOS__) && (defined(__CRT_HAVE_LFutexExpr64) || defined(__CRT_HAVE_LFutexExpr)))
} /* extern "C++" */
__NAMESPACE_LOCAL_BEGIN
#ifndef __local___localdep_shared_lock_waitfor_with_timeout64_defined
 ...
 * @return: true:  A lock became available.
 * @return: false: The given `abs_timeout' has expired. */
__LOCAL __ATTR_WUNUSED __BLOCKING __ATTR_NONNULL((1)) __BOOL (__FCALL shared_recursive_lock_waitfor)(struct shared_recursive_lock *__restrict __self, struct timespec64 const *__abs_timeout) __THROWS(__E_WOULDBLOCK, ...) {
	if (__shared_recursive_lock_isown(__self))
		return 1;
	return (__NAMESPACE_LOCAL_SYM __localdep_shared_lock_waitfor_with_timeout64)(&__self->sr_lock, __abs_timeout);
}
