...
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__SSIZE_TYPE__,__NOTHROW,memeq_nopf,(void const *__lhs, void const *__rhs, __SIZE_TYPE__ __num_bytes),(__lhs,__rhs,__num_bytes))
...
__CDECLARE(__ATTR_WUNUSED __NOBLOCK __ATTR_NONNULL((2)),__BOOL,__NOTHROW,readb_nopf,(void const *__addr, __UINT8_TYPE__ *__presult),(__addr,__presult))
 ...
 * Try to read from a possibly faulty `addr' into `*presult'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK __ATTR_NONNULL((2)),__BOOL,__NOTHROW,readw_nopf,(void const *__addr, __UINT16_TYPE__ *__presult),(__addr,__presult))
 ...
 * Try to read from a possibly faulty `addr' into `*presult'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK __ATTR_NONNULL((2)),__BOOL,__NOTHROW,readl_nopf,(void const *__addr, __UINT32_TYPE__ *__presult),(__addr,__presult))
 ...
 * Try to read from a possibly faulty `addr' into `*presult'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK __ATTR_NONNULL((2)),__BOOL,__NOTHROW,readq_nopf,(void const *__addr, __UINT64_TYPE__ *__presult),(__addr,__presult))
...
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,writeb_nopf,(void *__addr, __UINT8_TYPE__ __val),(__addr,__val))
 ...
 * Try to write `val' into a possibly faulty `addr'
 * Return  `true'  on  success,  `false'  on  error */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,writew_nopf,(void *__addr, __UINT16_TYPE__ __val),(__addr,__val))
 ...
 * Try to write `val' into a possibly faulty `addr'
 * Return  `true'  on  success,  `false'  on  error */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,writel_nopf,(void *__addr, __UINT32_TYPE__ __val),(__addr,__val))
 ...
 * Try to write `val' into a possibly faulty `addr'
 * Return  `true'  on  success,  `false'  on  error */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,writeq_nopf,(void *__addr, __UINT64_TYPE__ __val),(__addr,__val))
...
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__SIZE_TYPE__,__NOTHROW,memcpy_nopf,(void *__dst, void const *__src, __SIZE_TYPE__ __num_bytes),(__dst,__src,__num_bytes))
...
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__SIZE_TYPE__,__NOTHROW,memset_nopf,(void *__dst, int __byte, __SIZE_TYPE__ __num_bytes),(__dst,__byte,__num_bytes))
 ...
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK __ATTR_NONNULL((3)),__BOOL,__NOTHROW,atomic_xchb_nopf,(void const *__addr, __UINT8_TYPE__ __newval, __UINT8_TYPE__ *__poldval),(__addr,__newval,__poldval))
 ...
 * old value in `*poldval', and loading a new value from `newval'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK __ATTR_NONNULL((3)),__BOOL,__NOTHROW,atomic_xchw_nopf,(void const *__addr, __UINT16_TYPE__ __newval, __UINT16_TYPE__ *__poldval),(__addr,__newval,__poldval))
 ...
 * old value in `*poldval', and loading a new value from `newval'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK __ATTR_NONNULL((3)),__BOOL,__NOTHROW,atomic_xchl_nopf,(void const *__addr, __UINT32_TYPE__ __newval, __UINT32_TYPE__ *__poldval),(__addr,__newval,__poldval))
 ...
 * old value in `*poldval', and loading a new value from `newval'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK __ATTR_NONNULL((3)),__BOOL,__NOTHROW,atomic_xchq_nopf,(void const *__addr, __UINT64_TYPE__ __newval, __UINT64_TYPE__ *__poldval),(__addr,__newval,__poldval))
 ...
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,atomic_orb_nopf,(void *__addr, __UINT8_TYPE__ __mask),(__addr,__mask))
 ...
 * Try to atomically turn on all bits from `mask' at the possibly faulty `addr'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,atomic_orw_nopf,(void *__addr, __UINT16_TYPE__ __mask),(__addr,__mask))
 ...
 * Try to atomically turn on all bits from `mask' at the possibly faulty `addr'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,atomic_orl_nopf,(void *__addr, __UINT32_TYPE__ __mask),(__addr,__mask))
 ...
 * Try to atomically turn on all bits from `mask' at the possibly faulty `addr'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,atomic_orq_nopf,(void *__addr, __UINT64_TYPE__ __mask),(__addr,__mask))
 ...
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,atomic_andb_nopf,(void *__addr, __UINT8_TYPE__ __mask),(__addr,__mask))
 ...
 * Try to atomically mask all bits with `mask' at the possibly faulty `addr'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,atomic_andw_nopf,(void *__addr, __UINT16_TYPE__ __mask),(__addr,__mask))
 ...
 * Try to atomically mask all bits with `mask' at the possibly faulty `addr'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,atomic_andl_nopf,(void *__addr, __UINT32_TYPE__ __mask),(__addr,__mask))
 ...
 * Try to atomically mask all bits with `mask' at the possibly faulty `addr'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,atomic_andq_nopf,(void *__addr, __UINT64_TYPE__ __mask),(__addr,__mask))
 ...
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,atomic_xorb_nopf,(void *__addr, __UINT8_TYPE__ __mask),(__addr,__mask))
 ...
 * Try to atomically flip all bits from `mask' at the possibly faulty `addr'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,atomic_xorw_nopf,(void *__addr, __UINT16_TYPE__ __mask),(__addr,__mask))
 ...
 * Try to atomically flip all bits from `mask' at the possibly faulty `addr'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,atomic_xorl_nopf,(void *__addr, __UINT32_TYPE__ __mask),(__addr,__mask))
 ...
 * Try to atomically flip all bits from `mask' at the possibly faulty `addr'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK,__BOOL,__NOTHROW,atomic_xorq_nopf,(void *__addr, __UINT64_TYPE__ __mask),(__addr,__mask))
 ...
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK __ATTR_NONNULL((4)),__BOOL,__NOTHROW,atomic_cmpxchb_nopf,(void *__addr, __UINT8_TYPE__ __oldval, __UINT8_TYPE__ __newval, __UINT8_TYPE__ *__preal_oldval),(__addr,__oldval,__newval,__preal_oldval))
 ...
 * Try to do an atomic-compare-exchange at the possibly faulty `addr'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK __ATTR_NONNULL((4)),__BOOL,__NOTHROW,atomic_cmpxchw_nopf,(void *__addr, __UINT16_TYPE__ __oldval, __UINT16_TYPE__ __newval, __UINT16_TYPE__ *__preal_oldval),(__addr,__oldval,__newval,__preal_oldval))
 ...
 * Try to do an atomic-compare-exchange at the possibly faulty `addr'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK __ATTR_NONNULL((4)),__BOOL,__NOTHROW,atomic_cmpxchl_nopf,(void *__addr, __UINT32_TYPE__ __oldval, __UINT32_TYPE__ __newval, __UINT32_TYPE__ *__preal_oldval),(__addr,__oldval,__newval,__preal_oldval))
 ...
 * Try to do an atomic-compare-exchange at the possibly faulty `addr'
 * Return `true' on success, `false' on fault */
__CDECLARE(__ATTR_WUNUSED __NOBLOCK __ATTR_NONNULL((4)),__BOOL,__NOTHROW,atomic_cmpxchq_nopf,(void *__addr, __UINT64_TYPE__ __oldval, __UINT64_TYPE__ __newval, __UINT64_TYPE__ *__preal_oldval),(__addr,__oldval,__newval,__preal_oldval))
