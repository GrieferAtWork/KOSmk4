...
#endif /* ... */
#if defined(__CRT_HAVE_lfutexlockexpr) && (!defined(__USE_TIME_BITS64) || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)
/* >> lfutexlockexpr(2)
...
#elif defined(__CRT_HAVE_lfutexlockexpr64) && (defined(__USE_TIME_BITS64) || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)
/* >> lfutexlockexpr(2)
 * A  function that is similar to `lfutexexpr()', but  allows for the use of one central
 * locking futex that is used for waiting and may be distinct from any other given futex
 * object pointer.
...
#endif /* ... */
#if defined(__CRT_HAVE_lfutexlockexpr) && __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__
/* >> lfutexlockexpr(2)
 * A  function that is similar to `lfutexexpr()', but  allows for the use of one central
 * locking futex that is used for waiting and may be distinct from any other given futex
 * object pointer.
...
#elif defined(__CRT_HAVE_lfutexlockexpr64)
/* >> lfutexlockexpr(2)
 * A  function that is similar to `lfutexexpr()', but  allows for the use of one central
 * locking futex that is used for waiting and may be distinct from any other given futex
 * object pointer.
