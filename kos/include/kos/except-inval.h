...
enum {
	...
	E_INVALID_ARGUMENT_CONTEXT_SYSCTL_COMMAND,                     /* E_INVALID_ARGUMENT_UNKNOWN_COMMAND: The `cmd' passed to `sysctl()' wasn't recognized */
	...
	E_INVALID_ARGUMENT_CONTEXT_IOCTL_MOUSEIO_SETABSRECT_BADBOUNDS, /* E_INVALID_ARGUMENT_BAD_VALUE: The bounds specified are invalid and cannot be used */
	...
	E_INVALID_ARGUMENT_CONTEXT_SIGNAL_SIGSET_SIZE,                 /* E_INVALID_ARGUMENT_BAD_VALUE: The sigset size passed to one of the RT signal system calls is incorrect */
	...
	E_INVALID_ARGUMENT_CONTEXT_RAISE_PID,                          /* E_INVALID_ARGUMENT_BAD_VALUE: Bad pid value to one of the signal functions */
	E_INVALID_ARGUMENT_CONTEXT_RAISE_TGID,                         /* E_INVALID_ARGUMENT_BAD_VALUE: Bad tgid value to one of the signal functions */
	E_INVALID_ARGUMENT_CONTEXT_RAISE_SIGINFO_BADCODE,              /* E_INVALID_ARGUMENT_BAD_VALUE: Attempted to raise a signal using `rt_sigqueueinfo()' or `rt_tgsigqueueinfo()' with a bad `si_code' */
	E_INVALID_ARGUMENT_CONTEXT_MKTTY_FLAGS,                        /* E_INVALID_ARGUMENT_RESERVED_ARGUMENT: The `reserved' argument passed to `mktty()' is non-zero */
	E_INVALID_ARGUMENT_CONTEXT_MKTTY_NAME,                         /* E_INVALID_ARGUMENT_BAD_VALUE: The `name' argument passed to `mktty()' is too long */
	...
	E_INVALID_ARGUMENT_CONTEXT_EVENTFD_BUFSIZE,                    /* E_INVALID_ARGUMENT_BAD_VALUE: Attempted to read()/write() to/from an eventfd object using a buffer size less that 8 */
	E_INVALID_ARGUMENT_CONTEXT_EVENTFD_WRITE_FFFFFFFFFFFFFFFFh,    /* E_INVALID_ARGUMENT_BAD_VALUE: Attempted to write 0xffffffffffffffff to an eventfd object */
...
#define E_INVALID_ARGUMENT_CONTEXT_SYSCTL_COMMAND                     E_INVALID_ARGUMENT_CONTEXT_SYSCTL_COMMAND                     /* E_INVALID_ARGUMENT_UNKNOWN_COMMAND: The `cmd' passed to `sysctl()' wasn't recognized */
...
#define E_INVALID_ARGUMENT_CONTEXT_IOCTL_MOUSEIO_SETABSRECT_BADBOUNDS E_INVALID_ARGUMENT_CONTEXT_IOCTL_MOUSEIO_SETABSRECT_BADBOUNDS /* E_INVALID_ARGUMENT_BAD_VALUE: The bounds specified are invalid and cannot be used */
...
#define E_INVALID_ARGUMENT_CONTEXT_SIGNAL_SIGSET_SIZE                 E_INVALID_ARGUMENT_CONTEXT_SIGNAL_SIGSET_SIZE                 /* E_INVALID_ARGUMENT_BAD_VALUE: The sigset size passed to one of the RT signal system calls is incorrect */
...
#define E_INVALID_ARGUMENT_CONTEXT_RAISE_PID                          E_INVALID_ARGUMENT_CONTEXT_RAISE_PID                          /* E_INVALID_ARGUMENT_BAD_VALUE: Bad pid value to one of the signal functions */
#define E_INVALID_ARGUMENT_CONTEXT_RAISE_TGID                         E_INVALID_ARGUMENT_CONTEXT_RAISE_TGID                         /* E_INVALID_ARGUMENT_BAD_VALUE: Bad tgid value to one of the signal functions */
#define E_INVALID_ARGUMENT_CONTEXT_RAISE_SIGINFO_BADCODE              E_INVALID_ARGUMENT_CONTEXT_RAISE_SIGINFO_BADCODE              /* E_INVALID_ARGUMENT_BAD_VALUE: Attempted to raise a signal using `rt_sigqueueinfo()' or `rt_tgsigqueueinfo()' with a bad `si_code' */
#define E_INVALID_ARGUMENT_CONTEXT_MKTTY_FLAGS                        E_INVALID_ARGUMENT_CONTEXT_MKTTY_FLAGS                        /* E_INVALID_ARGUMENT_RESERVED_ARGUMENT: The `reserved' argument passed to `mktty()' is non-zero */
#define E_INVALID_ARGUMENT_CONTEXT_MKTTY_NAME                         E_INVALID_ARGUMENT_CONTEXT_MKTTY_NAME                         /* E_INVALID_ARGUMENT_BAD_VALUE: The `name' argument passed to `mktty()' is too long */
...
#define E_INVALID_ARGUMENT_CONTEXT_EVENTFD_BUFSIZE                    E_INVALID_ARGUMENT_CONTEXT_EVENTFD_BUFSIZE                    /* E_INVALID_ARGUMENT_BAD_VALUE: Attempted to read()/write() to/from an eventfd object using a buffer size less that 8 */
#define E_INVALID_ARGUMENT_CONTEXT_EVENTFD_WRITE_FFFFFFFFFFFFFFFFh    E_INVALID_ARGUMENT_CONTEXT_EVENTFD_WRITE_FFFFFFFFFFFFFFFFh    /* E_INVALID_ARGUMENT_BAD_VALUE: Attempted to write 0xffffffffffffffff to an eventfd object */
...
#define E_INVALID_ARGUMENT_CONTEXT_SYSCTL_COMMAND                     64  /* E_INVALID_ARGUMENT_UNKNOWN_COMMAND: The `cmd' passed to `sysctl()' wasn't recognized */
...
#define E_INVALID_ARGUMENT_CONTEXT_IOCTL_MOUSEIO_SETABSRECT_BADBOUNDS 83  /* E_INVALID_ARGUMENT_BAD_VALUE: The bounds specified are invalid and cannot be used */
...
#define E_INVALID_ARGUMENT_CONTEXT_SIGNAL_SIGSET_SIZE                 85  /* E_INVALID_ARGUMENT_BAD_VALUE: The sigset size passed to one of the RT signal system calls is incorrect */
...
#define E_INVALID_ARGUMENT_CONTEXT_RAISE_PID                          88  /* E_INVALID_ARGUMENT_BAD_VALUE: Bad pid value to one of the signal functions */
#define E_INVALID_ARGUMENT_CONTEXT_RAISE_TGID                         89  /* E_INVALID_ARGUMENT_BAD_VALUE: Bad tgid value to one of the signal functions */
#define E_INVALID_ARGUMENT_CONTEXT_RAISE_SIGINFO_BADCODE              90  /* E_INVALID_ARGUMENT_BAD_VALUE: Attempted to raise a signal using `rt_sigqueueinfo()' or `rt_tgsigqueueinfo()' with a bad `si_code' */
#define E_INVALID_ARGUMENT_CONTEXT_MKTTY_FLAGS                        91  /* E_INVALID_ARGUMENT_RESERVED_ARGUMENT: The `reserved' argument passed to `mktty()' is non-zero */
#define E_INVALID_ARGUMENT_CONTEXT_MKTTY_NAME                         92  /* E_INVALID_ARGUMENT_BAD_VALUE: The `name' argument passed to `mktty()' is too long */
...
#define E_INVALID_ARGUMENT_CONTEXT_EVENTFD_BUFSIZE                    95  /* E_INVALID_ARGUMENT_BAD_VALUE: Attempted to read()/write() to/from an eventfd object using a buffer size less that 8 */
#define E_INVALID_ARGUMENT_CONTEXT_EVENTFD_WRITE_FFFFFFFFFFFFFFFFh    96  /* E_INVALID_ARGUMENT_BAD_VALUE: Attempted to write 0xffffffffffffffff to an eventfd object */
