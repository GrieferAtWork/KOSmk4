 ...
 * @return: -1:       Error (s.a. `errno') */
__CDECLARE_OPT(__ATTR_ACCESS_RWS(2, 3),__STDC_UINT_AS_SIZE_T,__THROWING,EPollWait,(__fd_t __epfd, struct epoll_event *__events, __STDC_UINT_AS_SIZE_T __maxevents, int __timeout),(__epfd,__events,__maxevents,__timeout))
/* >> epoll_pwait(2)
 ...
 * @return: 0:        No events happened before `timeout' expired.
 * @return: -1:       Error (s.a. `errno') */
__CDECLARE_OPT(__ATTR_ACCESS_RO_OPT(5) __ATTR_ACCESS_RWS(2, 3),__STDC_UINT_AS_SIZE_T,__THROWING,EPollPWait,(__fd_t __epfd, struct epoll_event *__events, __STDC_UINT_AS_SIZE_T __maxevents, int __timeout, sigset_t const *__ss),(__epfd,__events,__maxevents,__timeout,__ss))
...
__CDECLARE_VOID_OPT(__ATTR_ACCESS_RO(3) __ATTR_NONNULL((6)),__THROWING,EPollRpcExec,(__fd_t __epfd, __fd_t __fd, struct epoll_event const *___event, __pid_t __target_tid, unsigned int __mode, prpc_exec_callback_t __func),(__epfd,__fd,___event,__target_tid,__mode,__func))
#endif /* __USE_KOS */
