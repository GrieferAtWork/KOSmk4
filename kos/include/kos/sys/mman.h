...
__CDECLARE(__ATTR_WUNUSED,void *,__THROWING,MMap,(void *__addr, size_t __len, __STDC_INT_AS_UINT_T __prot, __STDC_INT_AS_UINT_T __flags, __fd_t __fd, __FS_TYPE(pos) __offset),(__addr,__len,__prot,__flags,__fd,__offset))
 ...
 *               MAP_NONBLOCK | MAP_NORESERVE | MAP_POPULATE  | MAP_STACK | MAP_SYNC  |
 *               MAP_UNINITIALIZED | MAP_DONT_MAP | MAP_FIXED_NOREPLACE' */
__CREDIRECT(__ATTR_WUNUSED,void *,__THROWING,MMap,(void *__addr, size_t __len, __STDC_INT_AS_UINT_T __prot, __STDC_INT_AS_UINT_T __flags, __fd_t __fd, __FS_TYPE(pos) __offset),MMap64,(__addr,__len,__prot,__flags,__fd,__offset))
 ...
 *               MAP_NONBLOCK | MAP_NORESERVE | MAP_POPULATE  | MAP_STACK | MAP_SYNC  |
 *               MAP_UNINITIALIZED | MAP_DONT_MAP | MAP_FIXED_NOREPLACE' */
__NAMESPACE_LOCAL_USING_OR_IMPL(MMap, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_WUNUSED void *(__LIBCCALL MMap)(void *__addr, size_t __len, __STDC_INT_AS_UINT_T __prot, __STDC_INT_AS_UINT_T __flags, __fd_t __fd, __FS_TYPE(pos) __offset) __THROWS(...) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(MMap))(__addr, __len, __prot, __flags, __fd, __offset); })
#endif /* ... */
/* >> munmap(2)
 * Unmap memory from `addr...+=len' */
__CDECLARE_VOID_OPT(__ATTR_NONNULL((1)),__THROWING,MUnmap,(void *__addr, size_t __len),(__addr,__len))
/* >> mprotect(2)
 * @param prot: Either `PROT_NONE', or set of `PROT_EXEC | PROT_WRITE |
 *              PROT_READ | PROT_SEM | PROT_GROWSUP | PROT_GROWSDOWN' */
__CDECLARE_VOID_OPT(__ATTR_NONNULL((1)),__THROWING,MProtect,(void *__addr, size_t __len, __STDC_INT_AS_UINT_T __prot),(__addr,__len,__prot))
/* >> msync(2)
 * @param flags: Set of `MS_ASYNC | MS_INVALIDATE | MS_SYNC' */
__CDECLARE_VOID_OPT(__ATTR_NONNULL((1)),__THROWING,MSync,(void *__addr, size_t __len, __STDC_INT_AS_UINT_T __flags),(__addr,__len,__flags))
/* >> mlock(2) */
__CDECLARE_VOID_OPT(__ATTR_NONNULL((1)),__THROWING,MLock,(void const *__addr, size_t __len),(__addr,__len))
/* >> munlock(2) */
__CDECLARE_VOID_OPT(__ATTR_NONNULL((1)),__THROWING,MUnlock,(void const *__addr, size_t __len),(__addr,__len))
/* >> mlockall(2)
...
__CDECLARE(__ATTR_NONNULL((1)),__fd_t,__THROWING,ShmOpen,(char const *__name, __oflag_t __oflags, mode_t __mode),(__name,__oflags,__mode))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(ShmOpen, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_NONNULL((1)) __fd_t (__LIBCCALL ShmOpen)(char const *__name, __oflag_t __oflags, mode_t __mode) __THROWS(...) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(ShmOpen))(__name, __oflags, __mode); })
...
__CDECLARE_VOID(__ATTR_NONNULL((1)),__THROWING,ShmUnlink,(char const *__name),(__name))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(ShmUnlink, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_NONNULL((1)) void (__LIBCCALL ShmUnlink)(char const *__name) __THROWS(...) { (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(ShmUnlink))(__name); })
#endif /* __CRT_HAVE_Unlink || (__AT_FDCWD && __CRT_HAVE_UnlinkAt) */
#endif /* !__CRT_HAVE_ShmUnlink */

#ifdef __USE_MISC
#ifdef __CRT_HAVE_MAdvise
__CDECLARE_VOID(__ATTR_NONNULL((1)),__THROWING,MAdvise,(void *__addr, size_t __len, __STDC_INT_AS_UINT_T __advice),(__addr,__len,__advice))
#else /* __CRT_HAVE_MAdvise */
#include <libc/local/kos.sys.mman/MAdvise.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(MAdvise, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_NONNULL((1)) void (__LIBCCALL MAdvise)(void *__addr, size_t __len, __STDC_INT_AS_UINT_T __advice) __THROWS(...) { (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(MAdvise))(__addr, __len, __advice); })
#endif /* !__CRT_HAVE_MAdvise */
__CDECLARE_VOID_OPT(__ATTR_NONNULL((1)),__THROWING,MInCore,(void *__start, size_t __len, unsigned char *__vec),(__start,__len,__vec))
#endif /* __USE_MISC */
 ...
 *               MAP_NONBLOCK | MAP_NORESERVE | MAP_POPULATE  | MAP_STACK | MAP_SYNC  |
 *               MAP_UNINITIALIZED | MAP_DONT_MAP | MAP_FIXED_NOREPLACE' */
__CREDIRECT(__ATTR_WUNUSED,void *,__THROWING,MMap64,(void *__addr, size_t __len, __STDC_INT_AS_UINT_T __prot, __STDC_INT_AS_UINT_T __flags, __fd_t __fd, __pos64_t __offset),MMap,(__addr,__len,__prot,__flags,__fd,__offset))
 ...
 *               MAP_NONBLOCK | MAP_NORESERVE | MAP_POPULATE  | MAP_STACK | MAP_SYNC  |
 *               MAP_UNINITIALIZED | MAP_DONT_MAP | MAP_FIXED_NOREPLACE' */
__CDECLARE(__ATTR_WUNUSED,void *,__THROWING,MMap64,(void *__addr, size_t __len, __STDC_INT_AS_UINT_T __prot, __STDC_INT_AS_UINT_T __flags, __fd_t __fd, __pos64_t __offset),(__addr,__len,__prot,__flags,__fd,__offset))
 ...
 *               MAP_NONBLOCK | MAP_NORESERVE | MAP_POPULATE  | MAP_STACK | MAP_SYNC  |
 *               MAP_UNINITIALIZED | MAP_DONT_MAP | MAP_FIXED_NOREPLACE' */
__NAMESPACE_LOCAL_USING_OR_IMPL(MMap64, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_WUNUSED void *(__LIBCCALL MMap64)(void *__addr, size_t __len, __STDC_INT_AS_UINT_T __prot, __STDC_INT_AS_UINT_T __flags, __fd_t __fd, __pos64_t __offset) __THROWS(...) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(MMap64))(__addr, __len, __prot, __flags, __fd, __offset); })
#endif /* ... */
#endif /* __USE_LARGEFILE64 */

#ifdef __USE_XOPEN2K
#ifdef __CRT_HAVE_PosixMAdvise
__CDECLARE_VOID(__ATTR_NONNULL((1)),__THROWING,PosixMAdvise,(void *__addr, size_t __len, __STDC_INT_AS_UINT_T __advice),(__addr,__len,__advice))
#else /* __CRT_HAVE_PosixMAdvise */
#include <libc/local/kos.sys.mman/PosixMAdvise.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(PosixMAdvise, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_NONNULL((1)) void (__LIBCCALL PosixMAdvise)(void *__addr, size_t __len, __STDC_INT_AS_UINT_T __advice) __THROWS(...) { (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(PosixMAdvise))(__addr, __len, __advice); })
...
__LIBC void *(__VLIBCCALL MRemap)(void *__addr, size_t __old_len, size_t __new_len, __STDC_INT_AS_UINT_T __flags, ...) __THROWS(...) __CASMNAME_SAME("MRemap");
...
/* >> pkey_mprotect(2) */
__CDECLARE_VOID_OPT(,__THROWING,PKeyMprotect,(void *__addr, size_t __len, __STDC_INT_AS_UINT_T __prot, int __pkey),(__addr,__len,__prot,__pkey))
#endif /* __USE_GNU */
