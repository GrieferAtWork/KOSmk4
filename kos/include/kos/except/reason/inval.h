...
#define E_INVALID_ARGUMENT_CONTEXT_CLONE3_INVALID_FLAGS             208 /* E_INVALID_ARGUMENT_UNKNOWN_FLAG: Unrecognized `struct clone_args::ca_flags' passed to `clone3(2)' */
#define E_INVALID_ARGUMENT_CONTEXT_CLONE3_INVALID_SIZE              209 /* E_INVALID_ARGUMENT_BAD_VALUE: Unrecognized `size' argument passed to `clone3(2)' */
#define E_INVALID_ARGUMENT_CONTEXT_CLONE_THREAD_WITH_NEWPID         210 /* E_INVALID_ARGUMENT_BAD_FLAG_COMBINATION: Both `CLONE_THREAD` and 'CLONE_NEWPID' were given. */
...
#define E_INVALID_ARGUMENT_CONTEXT_BADCAP                           217 /* E_INVALID_ARGUMENT_UNKNOWN_COMMAND: Unknown capability code specified */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_COMMAND                    218 /* E_INVALID_ARGUMENT_UNKNOWN_COMMAND: Unknown prctl() command */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_SET_KEEPCAPS_BADBOOL       219 /* E_INVALID_ARGUMENT_UNKNOWN_COMMAND: `arg' in `prctl(PR_SET_KEEPCAPS, arg)' must be `0' or `1' */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_SET_TIMING_BADMODE         220 /* E_INVALID_ARGUMENT_UNKNOWN_COMMAND: `arg' in `prctl(PR_SET_TIMING, arg)' must be `PR_TIMING_STATISTICAL' */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_SET_ENDIAN_BADENDIAN       221 /* E_INVALID_ARGUMENT_UNKNOWN_COMMAND: `arg' in `prctl(PR_SET_ENDIAN, arg)' is invalid or not supported */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_SET_SECUREBITS_BADBITS     222 /* E_INVALID_ARGUMENT_UNKNOWN_FLAG: `arg' in `prctl(PR_SET_SECUREBITS, arg)' contains bits other than `SECBIT_*' from <kos/capability.h> */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_SET_NO_NEW_PRIVS_BADBOOL   223 /* E_INVALID_ARGUMENT_UNKNOWN_COMMAND: `arg' in `prctl(PR_SET_NO_NEW_PRIVS, arg, 0, 0, 0)' must be `0' or `1' */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_SET_NO_NEW_PRIVS_RESERVED3 224 /* E_INVALID_ARGUMENT_RESERVED_ARGUMENT: `zero' in `prctl(PR_SET_NO_NEW_PRIVS, arg, zero, 0, 0)' must be `0' */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_SET_NO_NEW_PRIVS_RESERVED4 225 /* E_INVALID_ARGUMENT_RESERVED_ARGUMENT: `zero' in `prctl(PR_SET_NO_NEW_PRIVS, arg, 0, zero, 0)' must be `0' */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_SET_NO_NEW_PRIVS_RESERVED5 226 /* E_INVALID_ARGUMENT_RESERVED_ARGUMENT: `zero' in `prctl(PR_SET_NO_NEW_PRIVS, arg, 0, 0, zero)' must be `0' */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_GET_NO_NEW_PRIVS_RESERVED2 227 /* E_INVALID_ARGUMENT_RESERVED_ARGUMENT: `zero' in `prctl(PR_GET_NO_NEW_PRIVS, zero, 0, 0, 0)' must be `0' */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_GET_NO_NEW_PRIVS_RESERVED3 228 /* E_INVALID_ARGUMENT_RESERVED_ARGUMENT: `zero' in `prctl(PR_GET_NO_NEW_PRIVS, 0, zero, 0, 0)' must be `0' */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_GET_NO_NEW_PRIVS_RESERVED4 229 /* E_INVALID_ARGUMENT_RESERVED_ARGUMENT: `zero' in `prctl(PR_GET_NO_NEW_PRIVS, 0, 0, zero, 0)' must be `0' */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_GET_NO_NEW_PRIVS_RESERVED5 230 /* E_INVALID_ARGUMENT_RESERVED_ARGUMENT: `zero' in `prctl(PR_GET_NO_NEW_PRIVS, 0, 0, 0, zero)' must be `0' */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_CAP_AMBIENT_BADSUBMODE     231 /* E_INVALID_ARGUMENT_UNKNOWN_COMMAND: `arg' in `prctl(PR_CAP_AMBIENT, arg, cap, 0, 0)' must be one of `PR_CAP_AMBIENT_*' */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_CAP_AMBIENT_RESERVED3      232 /* E_INVALID_ARGUMENT_RESERVED_ARGUMENT: `zero' in `prctl(PR_CAP_AMBIENT, PR_CAP_AMBIENT_CLEAR_ALL, zero, 0, 0)' must be `0' */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_CAP_AMBIENT_RESERVED4      233 /* E_INVALID_ARGUMENT_RESERVED_ARGUMENT: `zero' in `prctl(PR_CAP_AMBIENT, arg, cap, zero, 0)' must be `0' */
#define E_INVALID_ARGUMENT_CONTEXT_PRCTL_CAP_AMBIENT_RESERVED5      234 /* E_INVALID_ARGUMENT_RESERVED_ARGUMENT: `zero' in `prctl(PR_CAP_AMBIENT, arg, cap, 0, zero)' must be `0' */
