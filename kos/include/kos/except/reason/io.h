...
enum {
	...
	E_IOERROR_SUBSYSTEM_VIDEO,    /* The error stems from the network sub-system */
};
#endif /* __CC__ */
/*[[[AUTO]]]*/
...
#define E_IOERROR_SUBSYSTEM_VIDEO    E_IOERROR_SUBSYSTEM_VIDEO    /* The error stems from the network sub-system */
...
#define E_IOERROR_SUBSYSTEM_VIDEO    7 /* The error stems from the network sub-system */
...
enum {
	...
	E_IOERROR_REASON_VIDEO_VMWARE_BAD_VIDEO_MODE,   /* E_IOERROR_SUBSYSTEM_VIDEO */
	E_IOERROR_REASON_VIDEO_VMWARE_STRIDE_TOO_LARGE, /* E_IOERROR_SUBSYSTEM_VIDEO */
};
#endif /* __CC__ */
/*[[[AUTO]]]*/
#ifdef __COMPILER_PREFERR_ENUMS
...
#define E_IOERROR_REASON_VIDEO_VMWARE_BAD_VIDEO_MODE   E_IOERROR_REASON_VIDEO_VMWARE_BAD_VIDEO_MODE   /* E_IOERROR_SUBSYSTEM_VIDEO */
#define E_IOERROR_REASON_VIDEO_VMWARE_STRIDE_TOO_LARGE E_IOERROR_REASON_VIDEO_VMWARE_STRIDE_TOO_LARGE /* E_IOERROR_SUBSYSTEM_VIDEO */
#else /* __COMPILER_PREFERR_ENUMS */
...
#define E_IOERROR_REASON_VIDEO_VMWARE_BAD_VIDEO_MODE   18 /* E_IOERROR_SUBSYSTEM_VIDEO */
#define E_IOERROR_REASON_VIDEO_VMWARE_STRIDE_TOO_LARGE 19 /* E_IOERROR_SUBSYSTEM_VIDEO */
#endif /* !__COMPILER_PREFERR_ENUMS */
/*[[[end]]]*/
