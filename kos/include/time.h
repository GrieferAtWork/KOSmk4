...
#include <__stdinc.h>
#if defined(_CXX_CTIME) && !defined(__CXX_SYSTEM_HEADER)
...
#endif /* !__clock_defined && !__std_clock_defined */
#if !defined(__time_defined) && defined(__std_time_defined)
#define __time_defined 1
__NAMESPACE_STD_USING(time)
#endif /* !__time_defined && !__std_time_defined */
...
#else /* _CXX_CTIME && !__CXX_SYSTEM_HEADER */
#include <__crt.h>
...
__NAMESPACE_STD_BEGIN
#ifndef __std_clock_defined
#define __std_clock_defined 1
#if defined(__CRT_HAVE_clock)
/* Time used by the program so far (user time + system time)
 * The result / CLOCKS_PER_SECOND is program time in seconds */
__CDECLARE(__ATTR_WUNUSED,clock_t,__NOTHROW_NCX,clock,(void),())
#else /* LIBC: clock */
#undef __std_clock_defined
#endif /* clock... */
#endif /* !__std_clock_defined */
#ifndef __std_time_defined
#define __std_time_defined 1
...
#else /* CUSTOM: time */
#undef __std_time_defined
#endif /* time... */
#endif /* !__std_time_defined */
#ifndef __NO_FPU
...
__CREDIRECT(__ATTR_WUNUSED __ATTR_CONST,double,__NOTHROW_NCX,difftime,(time_t __time1, time_t __time0),difftime64,(__time1,__time0))
#elif defined(__CRT_HAVE__difftime64) && (defined(__USE_TIME_BITS64))
/* Return the difference between TIME1 and TIME0 */
__CREDIRECT(__ATTR_WUNUSED __ATTR_CONST,double,__NOTHROW_NCX,difftime,(time_t __time1, time_t __time0),_difftime64,(__time1,__time0))
#elif defined(__CRT_HAVE_difftime) && (!defined(__USE_TIME_BITS64))
/* Return the difference between TIME1 and TIME0 */
__CDECLARE(__ATTR_WUNUSED __ATTR_CONST,double,__NOTHROW_NCX,difftime,(time_t __time1, time_t __time0),(__time1,__time0))
#elif defined(__CRT_HAVE__difftime32) && (!defined(__USE_TIME_BITS64))
/* Return the difference between TIME1 and TIME0 */
__CREDIRECT(__ATTR_WUNUSED __ATTR_CONST,double,__NOTHROW_NCX,difftime,(time_t __time1, time_t __time0),_difftime32,(__time1,__time0))
#else /* LIBC: difftime */
__NAMESPACE_STD_END
#include <local/time/difftime.h>
__NAMESPACE_STD_BEGIN
/* Return the difference between TIME1 and TIME0 */
__NAMESPACE_LOCAL_USING_OR_IMPL(difftime, __FORCELOCAL __ATTR_WUNUSED __ATTR_CONST double __NOTHROW_NCX(__LIBCCALL difftime)(time_t __time1, time_t __time0) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(difftime))(__time1, __time0); })
#endif /* difftime... */
#endif /* !__std_difftime_defined */
#endif /* !__NO_FPU */
#if defined(__CRT_HAVE_ctime64) && (defined(__USE_TIME_BITS64))
/* Equivalent to `asctime (localtime (timer))' */
__CREDIRECT(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),char *,__NOTHROW_NCX,ctime,(time_t const *__timer),ctime64,(__timer))
#elif defined(__CRT_HAVE__ctime64) && (defined(__USE_TIME_BITS64))
/* Equivalent to `asctime (localtime (timer))' */
__CREDIRECT(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),char *,__NOTHROW_NCX,ctime,(time_t const *__timer),_ctime64,(__timer))
#elif defined(__CRT_HAVE_ctime) && (!defined(__USE_TIME_BITS64))
/* Equivalent to `asctime (localtime (timer))' */
__CDECLARE(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),char *,__NOTHROW_NCX,ctime,(time_t const *__timer),(__timer))
#elif defined(__CRT_HAVE__ctime32) && (!defined(__USE_TIME_BITS64))
/* Equivalent to `asctime (localtime (timer))' */
__CREDIRECT(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),char *,__NOTHROW_NCX,ctime,(time_t const *__timer),_ctime32,(__timer))
#else /* LIBC: ctime */
__NAMESPACE_STD_END
#include <local/time/ctime.h>
__NAMESPACE_STD_BEGIN
/* Equivalent to `asctime (localtime (timer))' */
__NAMESPACE_LOCAL_USING_OR_IMPL(ctime, __FORCELOCAL __ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)) char *__NOTHROW_NCX(__LIBCCALL ctime)(time_t const *__timer) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(ctime))(__timer); })
#endif /* ctime... */
#if defined(__CRT_HAVE_gmtime64) && (defined(__USE_TIME_BITS64))
/* Return the `struct tm' representation of *TIMER
 * in Universal Coordinated Time (aka Greenwich Mean Time) */
__CREDIRECT(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),struct tm *,__NOTHROW_NCX,gmtime,(time_t const *__timer),gmtime64,(__timer))
#elif defined(__CRT_HAVE__gmtime64) && (defined(__USE_TIME_BITS64))
/* Return the `struct tm' representation of *TIMER
 * in Universal Coordinated Time (aka Greenwich Mean Time) */
__CREDIRECT(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),struct tm *,__NOTHROW_NCX,gmtime,(time_t const *__timer),_gmtime64,(__timer))
#elif defined(__CRT_HAVE_gmtime) && (!defined(__USE_TIME_BITS64))
/* Return the `struct tm' representation of *TIMER
 * in Universal Coordinated Time (aka Greenwich Mean Time) */
__CDECLARE(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),struct tm *,__NOTHROW_NCX,gmtime,(time_t const *__timer),(__timer))
#elif defined(__CRT_HAVE__gmtime32) && (!defined(__USE_TIME_BITS64))
/* Return the `struct tm' representation of *TIMER
 * in Universal Coordinated Time (aka Greenwich Mean Time) */
__CREDIRECT(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),struct tm *,__NOTHROW_NCX,gmtime,(time_t const *__timer),_gmtime32,(__timer))
#else /* LIBC: gmtime */
__NAMESPACE_STD_END
...
/* Return the `struct tm' representation of *TIMER
 * in Universal Coordinated Time (aka Greenwich Mean Time) */
__NAMESPACE_LOCAL_USING_OR_IMPL(gmtime, __FORCELOCAL __ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)) struct tm *__NOTHROW_NCX(__LIBCCALL gmtime)(time_t const *__timer) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(gmtime))(__timer); })
#endif /* gmtime... */
#if defined(__CRT_HAVE_localtime64) && (defined(__USE_TIME_BITS64))
/* Return the `struct tm' representation of *TIMER in the local timezone */
__CREDIRECT(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),struct tm *,__NOTHROW_NCX,localtime,(time_t const *__timer),localtime64,(__timer))
#elif defined(__CRT_HAVE__localtime64) && (defined(__USE_TIME_BITS64))
/* Return the `struct tm' representation of *TIMER in the local timezone */
__CREDIRECT(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),struct tm *,__NOTHROW_NCX,localtime,(time_t const *__timer),_localtime64,(__timer))
#elif defined(__CRT_HAVE_localtime) && (!defined(__USE_TIME_BITS64))
/* Return the `struct tm' representation of *TIMER in the local timezone */
__CDECLARE(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),struct tm *,__NOTHROW_NCX,localtime,(time_t const *__timer),(__timer))
#elif defined(__CRT_HAVE__localtime32) && (!defined(__USE_TIME_BITS64))
/* Return the `struct tm' representation of *TIMER in the local timezone */
__CREDIRECT(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),struct tm *,__NOTHROW_NCX,localtime,(time_t const *__timer),_localtime32,(__timer))
#else /* LIBC: localtime */
__NAMESPACE_STD_END
#include <local/time/localtime.h>
__NAMESPACE_STD_BEGIN
/* Return the `struct tm' representation of *TIMER in the local timezone */
__NAMESPACE_LOCAL_USING_OR_IMPL(localtime, __FORCELOCAL __ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)) struct tm *__NOTHROW_NCX(__LIBCCALL localtime)(time_t const *__timer) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(localtime))(__timer); })
#endif /* localtime... */
...
__CDECLARE(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),char *,__NOTHROW_NCX,asctime,(struct tm const *__tp),(__tp))
#else /* LIBC: asctime */
__NAMESPACE_STD_END
...
/* Return a string of the form "Day Mon dd hh:mm:ss yyyy\n"
 * that is the representation of TP in this format */
__NAMESPACE_LOCAL_USING_OR_IMPL(asctime, __FORCELOCAL __ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)) char *__NOTHROW_NCX(__LIBCCALL asctime)(struct tm const *__tp) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(asctime))(__tp); })
#endif /* asctime... */
#ifdef __USE_ISOC11
...
__CDECLARE(__ATTR_NONNULL((1)),int,__NOTHROW_NCX,timespec_get,(struct timespec *__ts, int __base),(__ts,__base))
#else /* LIBC: timespec_get */
...
/* Return the difference between TIME1 and TIME0 */
__CDECLARE(__ATTR_WUNUSED __ATTR_CONST,double,__NOTHROW_NCX,difftime64,(__time64_t __time1, __time64_t __time0),(__time1,__time0))
#elif defined(__CRT_HAVE_difftime) && (__SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)
/* Return the difference between TIME1 and TIME0 */
__CREDIRECT(__ATTR_WUNUSED __ATTR_CONST,double,__NOTHROW_NCX,difftime64,(__time64_t __time1, __time64_t __time0),difftime,(__time1,__time0))
#elif defined(__CRT_HAVE__difftime64)
/* Return the difference between TIME1 and TIME0 */
__CREDIRECT(__ATTR_WUNUSED __ATTR_CONST,double,__NOTHROW_NCX,difftime64,(__time64_t __time1, __time64_t __time0),_difftime64,(__time1,__time0))
#else /* LIBC: difftime64 */
#include <local/time/difftime64.h>
/* Return the difference between TIME1 and TIME0 */
__NAMESPACE_LOCAL_USING_OR_IMPL(difftime64, __FORCELOCAL __ATTR_WUNUSED __ATTR_CONST double __NOTHROW_NCX(__LIBCCALL difftime64)(__time64_t __time1, __time64_t __time0) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(difftime64))(__time1, __time0); })
#endif /* difftime64... */
...
/* Equivalent to `asctime (localtime (timer))' */
__CDECLARE(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),char *,__NOTHROW_NCX,ctime64,(__time64_t const *__timer),(__timer))
#elif defined(__CRT_HAVE_ctime) && (__SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)
/* Equivalent to `asctime (localtime (timer))' */
__CREDIRECT(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),char *,__NOTHROW_NCX,ctime64,(__time64_t const *__timer),ctime,(__timer))
#elif defined(__CRT_HAVE__ctime64)
/* Equivalent to `asctime (localtime (timer))' */
__CREDIRECT(__ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)),char *,__NOTHROW_NCX,ctime64,(__time64_t const *__timer),_ctime64,(__timer))
#else /* LIBC: ctime64 */
#include <local/time/ctime64.h>
/* Equivalent to `asctime (localtime (timer))' */
__NAMESPACE_LOCAL_USING_OR_IMPL(ctime64, __FORCELOCAL __ATTR_WUNUSED __ATTR_RETNONNULL __ATTR_NONNULL((1)) char *__NOTHROW_NCX(__LIBCCALL ctime64)(__time64_t const *__timer) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(ctime64))(__timer); })
#endif /* ctime64... */
...
__CREDIRECT(__ATTR_NONNULL((1)),int,__NOTHROW_NCX,stime,(time_t const *__when),stime64,(__when))
#elif defined(__CRT_HAVE_stime) && (!defined(__USE_TIME_BITS64))
/* Set the system time to *WHEN. This call is restricted to the superuser */
__CDECLARE(__ATTR_NONNULL((1)),int,__NOTHROW_NCX,stime,(time_t const *__when),(__when))
#elif (defined(__CRT_HAVE_stime) || defined(__CRT_HAVE_stime64))
#include <local/time/stime.h>
/* Set the system time to *WHEN. This call is restricted to the superuser */
__NAMESPACE_LOCAL_USING_OR_IMPL(stime, __FORCELOCAL __ATTR_NONNULL((1)) int __NOTHROW_NCX(__LIBCCALL stime)(time_t const *__when) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(stime))(__when); })
#endif /* stime... */
#if defined(__CRT_HAVE_timegm64) && (defined(__USE_TIME_BITS64))
/* Like `mktime', but for TP represents Universal Time, not local time */
__CREDIRECT(__ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)),time_t,__NOTHROW_NCX,timegm,(struct tm *__tp),timegm64,(__tp))
#elif defined(__CRT_HAVE_timegm) && (!defined(__USE_TIME_BITS64))
/* Like `mktime', but for TP represents Universal Time, not local time */
__CDECLARE(__ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)),time_t,__NOTHROW_NCX,timegm,(struct tm *__tp),(__tp))
#else /* LIBC: timegm */
#include <local/time/timegm.h>
/* Like `mktime', but for TP represents Universal Time, not local time */
__NAMESPACE_LOCAL_USING_OR_IMPL(timegm, __FORCELOCAL __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)) time_t __NOTHROW_NCX(__LIBCCALL timegm)(struct tm *__tp) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(timegm))(__tp); })
#endif /* timegm... */
#if defined(__CRT_HAVE_mktime64) && (defined(__USE_TIME_BITS64))
/* Another name for `mktime' */
__CREDIRECT(__ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)),time_t,__NOTHROW_NCX,timelocal,(struct tm *__tp),mktime64,(__tp))
#elif defined(__CRT_HAVE__mktime64) && (defined(__USE_TIME_BITS64))
/* Another name for `mktime' */
__CREDIRECT(__ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)),time_t,__NOTHROW_NCX,timelocal,(struct tm *__tp),_mktime64,(__tp))
#elif defined(__CRT_HAVE_timelocal64) && (defined(__USE_TIME_BITS64))
/* Another name for `mktime' */
__CREDIRECT(__ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)),time_t,__NOTHROW_NCX,timelocal,(struct tm *__tp),timelocal64,(__tp))
#elif defined(__CRT_HAVE_mktime) && (!defined(__USE_TIME_BITS64))
/* Another name for `mktime' */
__CREDIRECT(__ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)),time_t,__NOTHROW_NCX,timelocal,(struct tm *__tp),mktime,(__tp))
#elif defined(__CRT_HAVE__mktime32) && (!defined(__USE_TIME_BITS64))
/* Another name for `mktime' */
__CREDIRECT(__ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)),time_t,__NOTHROW_NCX,timelocal,(struct tm *__tp),_mktime32,(__tp))
#elif defined(__CRT_HAVE_timelocal) && (!defined(__USE_TIME_BITS64))
/* Another name for `mktime' */
__CDECLARE(__ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)),time_t,__NOTHROW_NCX,timelocal,(struct tm *__tp),(__tp))
#else /* LIBC: mktime */
#include <local/time/mktime.h>
/* Another name for `mktime' */
__FORCELOCAL __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)) time_t __NOTHROW_NCX(__LIBCCALL timelocal)(struct tm *__tp) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(mktime))((struct tm __KOS_FIXED_CONST *)__tp); }
#endif /* timelocal... */
#if defined(__CRT_HAVE_dysize)
/* Return the number of days in YEAR */
__CDECLARE(__ATTR_CONST __ATTR_WUNUSED,int,__NOTHROW_NCX,dysize,(int __year),(__year))
#else /* LIBC: dysize */
#include <local/time/dysize.h>
/* Return the number of days in YEAR */
__NAMESPACE_LOCAL_USING_OR_IMPL(dysize, __FORCELOCAL __ATTR_CONST __ATTR_WUNUSED int __NOTHROW_NCX(__LIBCCALL dysize)(int __year) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(dysize))(__year); })
#endif /* dysize... */
...
#endif /* clock_settime... */
#if defined(__CRT_HAVE_timer_create)
...
#endif /* timer_create... */
#if defined(__CRT_HAVE_timer_delete)
...
__CREDIRECT(__ATTR_NONNULL((3)),int,__NOTHROW_NCX,timer_settime,(timer_t __timerid, int __flags, struct itimerspec const *__restrict __value, struct itimerspec *__restrict __ovalue),timer_settime64,(__timerid,__flags,__value,__ovalue))
#elif defined(__CRT_HAVE_timer_settime) && (!defined(__USE_TIME_BITS64))
/* Set timer TIMERID to VALUE, returning old value in OVALUE */
__CDECLARE(__ATTR_NONNULL((3)),int,__NOTHROW_NCX,timer_settime,(timer_t __timerid, int __flags, struct itimerspec const *__restrict __value, struct itimerspec *__restrict __ovalue),(__timerid,__flags,__value,__ovalue))
#elif (defined(__CRT_HAVE_timer_settime) || defined(__CRT_HAVE_timer_settime64))
#include <local/time/timer_settime.h>
/* Set timer TIMERID to VALUE, returning old value in OVALUE */
__NAMESPACE_LOCAL_USING_OR_IMPL(timer_settime, __FORCELOCAL __ATTR_NONNULL((3)) int __NOTHROW_NCX(__LIBCCALL timer_settime)(timer_t __timerid, int __flags, struct itimerspec const *__restrict __value, struct itimerspec *__restrict __ovalue) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(timer_settime))(__timerid, __flags, __value, __ovalue); })
#endif /* timer_settime... */
...
#endif /* timer_gettime... */
#if defined(__CRT_HAVE_timer_getoverrun)
/* Get expiration overrun for timer TIMERID */
__CDECLARE(,int,__NOTHROW_NCX,timer_getoverrun,(timer_t __timerid),(__timerid))
#endif /* timer_getoverrun... */

#ifdef __USE_XOPEN2K
#if defined(__CRT_HAVE_clock_nanosleep64) && (defined(__USE_TIME_BITS64))
/* High-resolution sleep with the specified clock */
__CREDIRECT(__ATTR_NONNULL((3)),int,__NOTHROW_RPC,clock_nanosleep,(clockid_t __clock_id, int __flags, struct timespec const *__restrict __requested_time, struct timespec *__remaining),clock_nanosleep64,(__clock_id,__flags,__requested_time,__remaining))
...
/* Pause execution for a number of nanoseconds */
__CDECLARE(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,nanosleep64,(struct __timespec64 const *__restrict __requested_time, struct __timespec64 *__remaining),(__requested_time,__remaining))
...
/* Get resolution of clock CLOCK_ID */
__CDECLARE(__ATTR_NONNULL((2)),int,__NOTHROW_NCX,clock_getres64,(clockid_t __clock_id, struct __timespec64 *__res),(__clock_id,__res))
...
/* Get current value of clock CLOCK_ID and store it in TP */
__CDECLARE(__ATTR_NONNULL((2)),int,__NOTHROW_NCX,clock_gettime64,(clockid_t __clock_id, struct __timespec64 *__tp),(__clock_id,__tp))
...
#if defined(__CRT_HAVE_clock_settime64)
/* Set clock CLOCK_ID to value TP */
__CDECLARE(__ATTR_NONNULL((2)),int,__NOTHROW_NCX,clock_settime64,(clockid_t __clock_id, struct __timespec64 const *__tp),(__clock_id,__tp))
...
/* Set timer TIMERID to VALUE, returning old value in OVALUE */
__CDECLARE(__ATTR_NONNULL((3)),int,__NOTHROW_NCX,timer_settime64,(timer_t __timerid, int __flags, struct itimerspec64 const *__restrict __value, struct itimerspec64 *__restrict __ovalue),(__timerid,__flags,__value,__ovalue))
#elif defined(__CRT_HAVE_timer_settime) && (__SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)
/* Set timer TIMERID to VALUE, returning old value in OVALUE */
__CREDIRECT(__ATTR_NONNULL((3)),int,__NOTHROW_NCX,timer_settime64,(timer_t __timerid, int __flags, struct itimerspec64 const *__restrict __value, struct itimerspec64 *__restrict __ovalue),timer_settime,(__timerid,__flags,__value,__ovalue))
#elif defined(__CRT_HAVE_timer_settime)
#include <local/time/timer_settime64.h>
/* Set timer TIMERID to VALUE, returning old value in OVALUE */
__NAMESPACE_LOCAL_USING_OR_IMPL(timer_settime64, __FORCELOCAL __ATTR_NONNULL((3)) int __NOTHROW_NCX(__LIBCCALL timer_settime64)(timer_t __timerid, int __flags, struct itimerspec64 const *__restrict __value, struct itimerspec64 *__restrict __ovalue) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(timer_settime64))(__timerid, __flags, __value, __ovalue); })
...
/* High-resolution sleep with the specified clock */
__CDECLARE(__ATTR_NONNULL((3)),int,__NOTHROW_RPC,clock_nanosleep64,(clockid_t __clock_id, int __flags, struct __timespec64 const *__requested_time, struct __timespec64 *__remaining),(__clock_id,__flags,__requested_time,__remaining))
...
__CDECLARE(__ATTR_NONNULL((1, 3, 4)),size_t,__NOTHROW_NCX,strftime_l,(char *__restrict __buf, size_t __bufsize, char const *__restrict __format, struct tm const *__restrict __tp, __locale_t __locale),(__buf,__bufsize,__format,__tp,__locale))
...
/* Similar to `strftime' but take the information from
 * the provided locale and not the global locale */
__NAMESPACE_LOCAL_USING_OR_IMPL(strftime_l, __FORCELOCAL __ATTR_NONNULL((1, 3, 4)) size_t __NOTHROW_NCX(__LIBCCALL strftime_l)(char *__restrict __buf, size_t __bufsize, char const *__restrict __format, struct tm const *__restrict __tp, __locale_t __locale) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(strftime_l))(__buf, __bufsize, __format, __tp, __locale); })
#endif /* strftime_l... */
#endif /* __USE_XOPEN2K8 */
...
/* Return the `struct tm' representation of *TIMER in UTC, using *TP to store the result */
__NAMESPACE_LOCAL_USING_OR_IMPL(gmtime_r, __FORCELOCAL __ATTR_NONNULL((1, 2)) struct tm *__NOTHROW_NCX(__LIBCCALL gmtime_r)(time_t const *__restrict __timer, struct tm *__restrict __tp) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(gmtime_r))(__timer, __tp); })
#endif /* gmtime_r... */
#if defined(__CRT_HAVE_localtime_r)
/* Return the `struct tm' representation of *TIMER in local time, using *TP to store the result */
__CDECLARE(__ATTR_NONNULL((1, 2)),struct tm *,__NOTHROW_NCX,localtime_r,(time_t const *__restrict __timer, struct tm *__restrict __tp),(__timer,__tp))
#else /* LIBC: localtime_r */
#include <local/time/localtime_r.h>
/* Return the `struct tm' representation of *TIMER in local time, using *TP to store the result */
__NAMESPACE_LOCAL_USING_OR_IMPL(localtime_r, __FORCELOCAL __ATTR_NONNULL((1, 2)) struct tm *__NOTHROW_NCX(__LIBCCALL localtime_r)(time_t const *__restrict __timer, struct tm *__restrict __tp) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(localtime_r))(__timer, __tp); })
#endif /* localtime_r... */
#if defined(__CRT_HAVE_ctime_r)
/* Equivalent to `asctime_r (localtime_r (timer, *TMP*), buf)' */
__CDECLARE(__ATTR_NONNULL((1, 2)),char *,__NOTHROW_NCX,ctime_r,(time_t const *__restrict __timer, char __buf[26]),(__timer,__buf))
#else /* LIBC: ctime_r */
#include <local/time/ctime_r.h>
/* Equivalent to `asctime_r (localtime_r (timer, *TMP*), buf)' */
__NAMESPACE_LOCAL_USING_OR_IMPL(ctime_r, __FORCELOCAL __ATTR_NONNULL((1, 2)) char *__NOTHROW_NCX(__LIBCCALL ctime_r)(time_t const *__restrict __timer, char __buf[26]) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(ctime_r))(__timer, __buf); })
#endif /* ctime_r... */
