...
__CDECLARE(__ATTR_OUT(1),int,__NOTHROW_NCX,uname,(struct utsname *__name),(__name))
#elif defined(__CRT_HAVE___uname)
/* >> uname(2)
 * Put information about the system in `name'
 * @return: 0:  Success
 * @return: -1: Error (s.a. `errno') */
__CREDIRECT(__ATTR_OUT(1),int,__NOTHROW_NCX,uname,(struct utsname *__name),__uname,(__name))
#elif defined(__CRT_HAVE___libc_uname)
/* >> uname(2)
 * Put information about the system in `name'
 * @return: 0:  Success
 * @return: -1: Error (s.a. `errno') */
__CREDIRECT(__ATTR_OUT(1),int,__NOTHROW_NCX,uname,(struct utsname *__name),__libc_uname,(__name))
#endif /* ... */
