...
__CDECLARE(__ATTR_INOUT_OPT(3),ssize_t,__NOTHROW_NCX,sendfile,(__fd_t __out_fd, __fd_t __in_fd, __off_t *__offset, size_t __count),(__out_fd,__in_fd,__offset,__count))
#elif defined(__CRT_HAVE_sendfile64) && (defined(__USE_FILE_OFFSET64) || __SIZEOF_OFF32_T__ == __SIZEOF_OFF64_T__)
__CREDIRECT(__ATTR_INOUT_OPT(3),ssize_t,__NOTHROW_NCX,sendfile,(__fd_t __out_fd, __fd_t __in_fd, __off_t *__offset, size_t __count),sendfile64,(__out_fd,__in_fd,__offset,__count))
#elif defined(__CRT_HAVE_sendfile64) || defined(__CRT_HAVE_sendfile)
#include <libc/local/sys.sendfile/sendfile.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(sendfile, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_INOUT_OPT(3) ssize_t __NOTHROW_NCX(__LIBCCALL sendfile)(__fd_t __out_fd, __fd_t __in_fd, __off_t *__offset, size_t __count) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(sendfile))(__out_fd, __in_fd, __offset, __count); })
#endif /* ... */
