 ...
 */
#ifndef _SYS_SYSCALL_TRACE32_H
#define _SYS_SYSCALL_TRACE32_H 1
...
#define __PRIVATE_SYSCALL32_TRACE_LFORMAT_1(name)      __NR32AN0_##name ": " __NR32ATRF0_##name
#define __PRIVATE_SYSCALL32_TRACE_LFORMAT_2(name)      __PRIVATE_SYSCALL32_TRACE_LFORMAT_1(name) ", " __NR32AN1_##name ": " __NR32ATRF1_##name
#define __PRIVATE_SYSCALL32_TRACE_LFORMAT_3(name)      __PRIVATE_SYSCALL32_TRACE_LFORMAT_2(name) ", " __NR32AN2_##name ": " __NR32ATRF2_##name
#define __PRIVATE_SYSCALL32_TRACE_LFORMAT_4(name)      __PRIVATE_SYSCALL32_TRACE_LFORMAT_3(name) ", " __NR32AN3_##name ": " __NR32ATRF3_##name
#define __PRIVATE_SYSCALL32_TRACE_LFORMAT_5(name)      __PRIVATE_SYSCALL32_TRACE_LFORMAT_4(name) ", " __NR32AN4_##name ": " __NR32ATRF4_##name
#define __PRIVATE_SYSCALL32_TRACE_LFORMAT_6(name)      __PRIVATE_SYSCALL32_TRACE_LFORMAT_5(name) ", " __NR32AN5_##name ": " __NR32ATRF5_##name
...
#endif /* !_SYS_SYSCALL32_TRACE32_H */
