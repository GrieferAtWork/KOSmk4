...
__CDECLARE(,int,__NOTHROW_NCX,vtimes,(struct vtimes *__current, struct vtimes *__child),(__current,__child))
 ...
 * @return: 0:  Success
 * @return: -1: Error (s.a. `errno') */
__NAMESPACE_LOCAL_USING_OR_IMPL(vtimes, __FORCELOCAL __ATTR_ARTIFICIAL int __NOTHROW_NCX(__LIBCCALL vtimes)(struct vtimes *__current, struct vtimes *__child) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(vtimes))(__current, __child); })
