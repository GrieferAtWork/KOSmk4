...
__CDECLARE_OPT(__ATTR_WUNUSED __ATTR_ACCESS_WRS(1, 2),ssize_t,__NOTHROW_NCX,getrandom,(void *__buf, size_t __num_bytes, unsigned int __flags),(__buf,__num_bytes,__flags))
