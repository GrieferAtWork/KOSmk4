...
__CDECLARE(,__watchfd_t,__NOTHROW_NCX,inotify_add_watch,(__fd_t __notify_fd, char const *__pathname, __UINT32_TYPE__ __mask),(__notify_fd,__pathname,__mask))
...
/* >> inotify_add_watch(2)
 * @param: mask: Set of `IN_ALL_EVENTS | ...' */
__NAMESPACE_LOCAL_USING_OR_IMPL(inotify_add_watch, __FORCELOCAL __ATTR_ARTIFICIAL __watchfd_t __NOTHROW_NCX(__LIBCCALL inotify_add_watch)(__fd_t __notify_fd, char const *__pathname, __UINT32_TYPE__ __mask) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(inotify_add_watch))(__notify_fd, __pathname, __mask); })
...
__CDECLARE_OPT(,int,__NOTHROW_NCX,inotify_rm_watch,(__fd_t __notify_fd, __watchfd_t __wd),(__notify_fd,__wd))

#ifdef __USE_KOS
/* >> inotify_add_watch_at(2)
 * @param: atflags: Set of `AT_SYMLINK_NOFOLLOW | AT_DOSPATH | AT_EMPTY_PATH'
 * @param: mask:    Set of `IN_ALL_EVENTS | ...' */
__CDECLARE_OPT(,__watchfd_t,__NOTHROW_NCX,inotify_add_watch_at,(__fd_t __notify_fd, __fd_t __dirfd, char const *__pathname, __atflag_t __atflags, __UINT32_TYPE__ __mask),(__notify_fd,__dirfd,__pathname,__atflags,__mask))
#endif /* __USE_KOS */
