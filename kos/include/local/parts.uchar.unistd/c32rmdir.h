...
#include <__crt.h>
#if defined(__CRT_AT_FDCWD) && ((defined(__CRT_HAVE_wunlinkat) && (__SIZEOF_WCHAR_T__ == 4) && defined(__LIBCCALL_IS_LIBKCALL)) || (defined(__CRT_HAVE_DOS$wunlinkat) && defined(__LIBCCALL_IS_LIBKCALL)) || defined(__CRT_HAVE_DOS$KOS$wunlinkat))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__LIBKCALL,__localdep_c32unlinkat,(__fd_t __dfd, __CHAR32_TYPE__ const *__name, __atflag_t __flags),wunlinkat,(__dfd,__name,__flags))
...
/* >> unlinkat(2)
 * Remove a file, symbolic link, device or FIFO referred to by `DFD:NAME' */
__CREDIRECT_KOS(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_c32unlinkat,(__fd_t __dfd, __CHAR32_TYPE__ const *__name, __atflag_t __flags),KOS$wunlinkat,(__dfd,__name,__flags))
#else /* ... */
...
#else /* __CRT_AT_FDCWD && ((__CRT_HAVE_wunlinkat && (__SIZEOF_WCHAR_T__ == 4) && __LIBCCALL_IS_LIBKCALL) || (__CRT_HAVE_DOS$wunlinkat && __LIBCCALL_IS_LIBKCALL) || __CRT_HAVE_DOS$KOS$wunlinkat) */
#undef __local_c32rmdir_defined
#endif /* !__CRT_AT_FDCWD || ((!__CRT_HAVE_wunlinkat || !(__SIZEOF_WCHAR_T__ == 4) || !__LIBCCALL_IS_LIBKCALL) && (!__CRT_HAVE_DOS$wunlinkat || !__LIBCCALL_IS_LIBKCALL) && !__CRT_HAVE_DOS$KOS$wunlinkat) */
