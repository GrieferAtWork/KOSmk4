...
#else /* __CRT_AT_FDCWD && __AT_EACCESS && ((__CRT_HAVE_wfaccessat && (__SIZEOF_WCHAR_T__ == 2) && __LIBCCALL_IS_LIBDCALL) || (__CRT_HAVE_DOS$wfaccessat && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_DOS$DOS$wfaccessat) */
