...
#include <__crt.h>
#if defined(__CRT_AT_FDCWD) && ((defined(__CRT_HAVE_wunlinkat) && (__SIZEOF_WCHAR_T__ == 2) && defined(__LIBCCALL_IS_LIBDCALL)) || (defined(__CRT_HAVE_DOS$wunlinkat) && defined(__LIBCCALL_IS_LIBDCALL)) || defined(__CRT_HAVE_DOS$DOS$wunlinkat))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__LIBDCALL,__localdep_c16unlinkat,(__fd_t __dfd, __CHAR16_TYPE__ const *__name, __atflag_t __flags),wunlinkat,(__dfd,__name,__flags))
...
/* >> unlinkat(2)
 * Remove a file, symbolic link, device or FIFO referred to by `DFD:NAME' */
__CREDIRECT_DOS(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_c16unlinkat,(__fd_t __dfd, __CHAR16_TYPE__ const *__name, __atflag_t __flags),DOS$wunlinkat,(__dfd,__name,__flags))
#else /* ... */
...
#else /* __CRT_AT_FDCWD && ((__CRT_HAVE_wunlinkat && (__SIZEOF_WCHAR_T__ == 2) && __LIBCCALL_IS_LIBDCALL) || (__CRT_HAVE_DOS$wunlinkat && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_DOS$DOS$wunlinkat) */
#undef __local_c16unlink_defined
#endif /* !__CRT_AT_FDCWD || ((!__CRT_HAVE_wunlinkat || !(__SIZEOF_WCHAR_T__ == 2) || !__LIBCCALL_IS_LIBDCALL) && (!__CRT_HAVE_DOS$wunlinkat || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$DOS$wunlinkat) */
