...
/* >> truncate64(2)
 * Truncate the given file `FILE' to a length of `LENGTH' */
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),int,__NOTHROW_NCX,__LIBDCALL,__localdep_c16truncate64,(__CHAR16_TYPE__ const *__file, __PIO_OFFSET64 __length),wtruncate64,(__file,__length))
...
/* >> truncate64(2)
 * Truncate the given file `FILE' to a length of `LENGTH' */
__CREDIRECT_DOS(__ATTR_NONNULL((1)),int,__NOTHROW_NCX,__localdep_c16truncate64,(__CHAR16_TYPE__ const *__file, __PIO_OFFSET64 __length),DOS$wtruncate64,(__file,__length))
...
/* >> truncate64(2)
 * Truncate the given file `FILE' to a length of `LENGTH' */
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),int,__NOTHROW_NCX,__LIBDCALL,__localdep_c16truncate64,(__CHAR16_TYPE__ const *__file, __PIO_OFFSET64 __length),wtruncate,(__file,__length))
...
/* >> truncate64(2)
 * Truncate the given file `FILE' to a length of `LENGTH' */
__CREDIRECT_DOS(__ATTR_NONNULL((1)),int,__NOTHROW_NCX,__localdep_c16truncate64,(__CHAR16_TYPE__ const *__file, __PIO_OFFSET64 __length),DOS$wtruncate,(__file,__length))
...
#else /* (__CRT_HAVE_wtruncate64 && (__SIZEOF_WCHAR_T__ == 2) && __LIBCCALL_IS_LIBDCALL) || (__CRT_HAVE_DOS$wtruncate64 && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_DOS$DOS$wtruncate64 || (__CRT_HAVE_DOS$wtruncate && (__SIZEOF_OFF32_T__ == __SIZEOF_OFF64_T__) && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_wtruncate || (__CRT_HAVE_DOS$wtruncate && __SIZEOF_WCHAR_T__ == 4) || (__CRT_HAVE_DOS$wtruncate && __SIZEOF_WCHAR_T__ == 2) || ((__CRT_HAVE_open64 || __CRT_HAVE___open64 || __CRT_HAVE_open || __CRT_HAVE__open || __CRT_HAVE___open) && (__CRT_HAVE_ftruncate64 || __CRT_HAVE__chsize_s || __CRT_HAVE_ftruncate) && (__SIZEOF_WCHAR_T__ == 2)) || (__CRT_HAVE_DOS$wtruncate && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_DOS$DOS$wtruncate || ((__CRT_HAVE_open64 || __CRT_HAVE___open64 || __CRT_HAVE_open || __CRT_HAVE__open || __CRT_HAVE___open) && (__CRT_HAVE_ftruncate64 || __CRT_HAVE__chsize_s || __CRT_HAVE_ftruncate)) || ((__CRT_HAVE_open64 || __CRT_HAVE___open64 || __CRT_HAVE_open || __CRT_HAVE__open || __CRT_HAVE___open || (__CRT_AT_FDCWD && (__CRT_HAVE_openat64 || __CRT_HAVE_openat))) && ((__CRT_HAVE__chsize && !__USE_FILE_OFFSET64) || (__CRT_HAVE_chsize && !__USE_FILE_OFFSET64) || __CRT_HAVE_ftruncate || __CRT_HAVE_ftruncate64 || __CRT_HAVE__chsize_s)) */
#undef __local_c16truncate_defined
#endif /* (!__CRT_HAVE_wtruncate64 || !(__SIZEOF_WCHAR_T__ == 2) || !__LIBCCALL_IS_LIBDCALL) && (!__CRT_HAVE_DOS$wtruncate64 || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$DOS$wtruncate64 && (!__CRT_HAVE_DOS$wtruncate || !(__SIZEOF_OFF32_T__ == __SIZEOF_OFF64_T__) || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_wtruncate && (!__CRT_HAVE_DOS$wtruncate || !__SIZEOF_WCHAR_T__ == 4) && (!__CRT_HAVE_DOS$wtruncate || !__SIZEOF_WCHAR_T__ == 2) && ((!__CRT_HAVE_open64 && !__CRT_HAVE___open64 && !__CRT_HAVE_open && !__CRT_HAVE__open && !__CRT_HAVE___open) || (!__CRT_HAVE_ftruncate64 && !__CRT_HAVE__chsize_s && !__CRT_HAVE_ftruncate) || !(__SIZEOF_WCHAR_T__ == 2)) && (!__CRT_HAVE_DOS$wtruncate || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$DOS$wtruncate && ((!__CRT_HAVE_open64 && !__CRT_HAVE___open64 && !__CRT_HAVE_open && !__CRT_HAVE__open && !__CRT_HAVE___open) || (!__CRT_HAVE_ftruncate64 && !__CRT_HAVE__chsize_s && !__CRT_HAVE_ftruncate)) && ((!__CRT_HAVE_open64 && !__CRT_HAVE___open64 && !__CRT_HAVE_open && !__CRT_HAVE__open && !__CRT_HAVE___open && (!__CRT_AT_FDCWD || (!__CRT_HAVE_openat64 && !__CRT_HAVE_openat))) || ((!__CRT_HAVE__chsize || __USE_FILE_OFFSET64) && (!__CRT_HAVE_chsize || __USE_FILE_OFFSET64) && !__CRT_HAVE_ftruncate && !__CRT_HAVE_ftruncate64 && !__CRT_HAVE__chsize_s)) */
