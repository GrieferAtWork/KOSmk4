...
#include <__crt.h>
#if defined(__CRT_AT_FDCWD) && ((defined(__CRT_HAVE_wreadlinkat) && (__SIZEOF_WCHAR_T__ == 2) && defined(__LIBCCALL_IS_LIBDCALL)) || (defined(__CRT_HAVE_DOS$wreadlinkat) && defined(__LIBCCALL_IS_LIBDCALL)) || defined(__CRT_HAVE_DOS$DOS$wreadlinkat))
 ...
 *          make use of the buffer in its entirety.
 * When targeting KOS, consider using `freadlinkat(2)' with `AT_READLINK_REQSIZE'. */
__CREDIRECT_DOS(__ATTR_NONNULL((2, 3)),__SSIZE_TYPE__,__NOTHROW_RPC,__localdep_c16readlinkat,(__fd_t __dfd, __CHAR16_TYPE__ const *__restrict __path, __CHAR16_TYPE__ *__restrict __buf, __SIZE_TYPE__ __buflen),DOS$wreadlinkat,(__dfd,__path,__buf,__buflen))
#else /* ... */
...
#else /* __CRT_AT_FDCWD && ((__CRT_HAVE_wreadlinkat && (__SIZEOF_WCHAR_T__ == 2) && __LIBCCALL_IS_LIBDCALL) || (__CRT_HAVE_DOS$wreadlinkat && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_DOS$DOS$wreadlinkat) */
#undef __local_c16readlink_defined
#endif /* !__CRT_AT_FDCWD || ((!__CRT_HAVE_wreadlinkat || !(__SIZEOF_WCHAR_T__ == 2) || !__LIBCCALL_IS_LIBDCALL) && (!__CRT_HAVE_DOS$wreadlinkat || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$DOS$wreadlinkat) */
