...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32casecoll))(__CHAR32_TYPE__ const *__s1, __CHAR32_TYPE__ const *__s2) {
	return __localdep_c32casecmp(__s1, __s2);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c32casecoll_defined
#define __local___localdep_c32casecoll_defined 1
