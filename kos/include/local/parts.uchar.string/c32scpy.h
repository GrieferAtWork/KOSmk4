 ...
 */
#ifndef __local_c32scpy_defined
#define __local_c32scpy_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(c32scpy) __ATTR_RETNONNULL __ATTR_NONNULL((1, 2)) __CHAR32_TYPE__ *
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32scpy))(__CHAR32_TYPE__ *__restrict __buf, __CHAR32_TYPE__ const *__restrict __src) {
	return (__CHAR32_TYPE__ *)__localdep_memcpyl(__buf, __src, __localdep_c32slen(__src) + 1);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c32scpy_defined
#define __local___localdep_c32scpy_defined 1
#define __localdep_c32scpy __LIBC_LOCAL_NAME(c32scpy)
#endif /* !__local___localdep_c32scpy_defined */
#endif /* !__local_c32scpy_defined */
