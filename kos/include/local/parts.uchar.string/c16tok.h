...
/* Dependency: c16cspn from parts.uchar.string */
#ifndef __local___localdep_c16cspn_defined
#define __local___localdep_c16cspn_defined 1
#if defined(__CRT_HAVE_wcscspn) && (__SIZEOF_WCHAR_T__ == 2) && defined(__LIBCCALL_IS_LIBDCALL)
__COMPILER_REDIRECT(__LIBC,__ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)),__SIZE_TYPE__,__NOTHROW_NCX,__LIBDCALL,__localdep_c16cspn,(__CHAR16_TYPE__ const *__haystack, __CHAR16_TYPE__ const *__reject),wcscspn,(__haystack,__reject))
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_c16cspn (*(__SIZE_TYPE__(__LIBDCALL *)(__CHAR16_TYPE__ const *, __CHAR16_TYPE__ const *))&__LIBC_LOCAL_NAME(wcscspn))
#else /* ... */
__NAMESPACE_LOCAL_END
...
/* Dependency: c16spn from parts.uchar.string */
...
__COMPILER_REDIRECT(__LIBC,__ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)),__SIZE_TYPE__,__NOTHROW_NCX,__LIBDCALL,__localdep_c16spn,(__CHAR16_TYPE__ const *__haystack, __CHAR16_TYPE__ const *__accept),wcsspn,(__haystack,__accept))
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_c16spn (*(__SIZE_TYPE__(__LIBDCALL *)(__CHAR16_TYPE__ const *, __CHAR16_TYPE__ const *))&__LIBC_LOCAL_NAME(wcsspn))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16tok))(__CHAR16_TYPE__ *__string, __CHAR16_TYPE__ const *__restrict __delim, __CHAR16_TYPE__ **__restrict __save_ptr) {
...
#define __local___localdep_c16tok_defined 1
