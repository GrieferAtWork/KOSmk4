...
/* Dependency: c16ncmp from parts.uchar.string */
#ifndef __local___localdep_c16ncmp_defined
#define __local___localdep_c16ncmp_defined 1
...
__COMPILER_REDIRECT(__LIBC,__ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)),int,__NOTHROW_NCX,__LIBDCALL,__localdep_c16ncmp,(__CHAR16_TYPE__ const *__s1, __CHAR16_TYPE__ const *__s2, __SIZE_TYPE__ __maxlen),wcsncmp,(__s1,__s2,__maxlen))
...
__NAMESPACE_LOCAL_BEGIN
/* Same as `strcmp', but compare at most `MAXLEN' characters from either string */
#define __localdep_c16ncmp (*(int(__LIBDCALL *)(__CHAR16_TYPE__ const *, __CHAR16_TYPE__ const *, __SIZE_TYPE__))&__LIBC_LOCAL_NAME(wcsncmp))
#else /* ... */
__NAMESPACE_LOCAL_END
