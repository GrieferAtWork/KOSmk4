 ...
 */
#ifndef __local_wildc32casecmp_defined
#define __local_wildc32casecmp_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(wildc32casecmp) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)) int
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(wildc32casecmp))(__CHAR32_TYPE__ const *__pattern, __CHAR32_TYPE__ const *__string) {
		...
		if (*__pattern == '*') {
			...
			for (;;) {
				...
				if (__card_post == __ch || __card_post == (__CHAR32_TYPE__)__localdep_towlower(__ch)) {
					...
					if (!__LIBC_LOCAL_NAME(wildc32casecmp)(__string, __pattern))
						return 0;
				} else if (!__ch) {
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_wildc32casecmp_defined
#define __local___localdep_wildc32casecmp_defined 1
#define __localdep_wildc32casecmp __LIBC_LOCAL_NAME(wildc32casecmp)
#endif /* !__local___localdep_wildc32casecmp_defined */
#endif /* !__local_wildc32casecmp_defined */
