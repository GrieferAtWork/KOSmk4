...
/* Dependency: c16chr from parts.uchar.string */
#ifndef __local___localdep_c16chr_defined
#define __local___localdep_c16chr_defined 1
#if defined(__CRT_HAVE_wcschr) && (__SIZEOF_WCHAR_T__ == 2) && defined(__LIBCCALL_IS_LIBDCALL)
/* Return the pointer of the first instance of `NEEDLE', or `NULL' if `NEEDLE' wasn't found. */
__COMPILER_REDIRECT(__LIBC,__ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1)),__CHAR16_TYPE__ *,__NOTHROW_NCX,__LIBDCALL,__localdep_c16chr,(__CHAR16_TYPE__ const *__restrict __haystack, __CHAR16_TYPE__ __needle),wcschr,(__haystack,__needle))
...
__NAMESPACE_LOCAL_BEGIN
/* Return the pointer of the first instance of `NEEDLE', or `NULL' if `NEEDLE' wasn't found. */
#define __localdep_c16chr (*(__CHAR16_TYPE__ *(__LIBDCALL *)(__CHAR16_TYPE__ const *__restrict, __CHAR16_TYPE__))&__LIBC_LOCAL_NAME(wcschr))
#else /* ... */
__NAMESPACE_LOCAL_END
#include <local/parts.uchar.string/c16chr.h>
__NAMESPACE_LOCAL_BEGIN
/* Return the pointer of the first instance of `NEEDLE', or `NULL' if `NEEDLE' wasn't found. */
#define __localdep_c16chr (*(__CHAR16_TYPE__ *(__LIBDCALL *)(__CHAR16_TYPE__ const *__restrict, __CHAR16_TYPE__))&__LIBC_LOCAL_NAME(c16chr))
#endif /* !... */
#endif /* !__local___localdep_c16chr_defined */
__LOCAL_LIBC(c16sep) __ATTR_LEAF __ATTR_NONNULL((1, 2)) __CHAR16_TYPE__ *
...
#define __local___localdep_c16sep_defined 1
