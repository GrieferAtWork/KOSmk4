...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(fuzzy_c16cmp))(__CHAR16_TYPE__ const *__s1, __CHAR16_TYPE__ const *__s2) {
	return __localdep_fuzzy_c16memcmp(__s1, __localdep_c16len(__s1), __s2, __localdep_c16len(__s2));
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_fuzzy_c16cmp_defined
#define __local___localdep_fuzzy_c16cmp_defined 1
#define __localdep_fuzzy_c16cmp __LIBC_LOCAL_NAME(fuzzy_c16cmp)
#endif /* !__local___localdep_fuzzy_c16cmp_defined */
...
#undef __local_fuzzy_c16cmp_defined
