...
#define __local_c32upr_l_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(c32upr_l) __ATTR_LEAF __ATTR_RETNONNULL __ATTR_NONNULL((1)) __CHAR32_TYPE__ *
...
#define __local___localdep_c32upr_l_defined 1
