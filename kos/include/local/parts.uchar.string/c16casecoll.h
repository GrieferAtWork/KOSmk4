...
#define __local_c16casecoll_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(c16casecoll) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)) int
...
#define __local___localdep_c16casecoll_defined 1
