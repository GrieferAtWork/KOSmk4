...
/* Dependency: c16chrnul from parts.uchar.string */
...
__COMPILER_REDIRECT(__LIBC,__ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1)),__CHAR16_TYPE__ *,__NOTHROW_NCX,__LIBDCALL,__localdep_c16chrnul,(__CHAR16_TYPE__ const *__haystack, __CHAR16_TYPE__ __needle),wcschrnul,(__haystack,__needle))
...
__NAMESPACE_LOCAL_BEGIN
/* Same as `wcschr', but return `wcsend(STR)', rather than `NULL' if `NEEDLE' wasn't found. */
#define __localdep_c16chrnul (*(__CHAR16_TYPE__ *(__LIBDCALL *)(__CHAR16_TYPE__ const *, __CHAR16_TYPE__))&__LIBC_LOCAL_NAME(wcschrnul))
#else /* ... */
__NAMESPACE_LOCAL_END
#include <local/parts.uchar.string/c16chrnul.h>
__NAMESPACE_LOCAL_BEGIN
/* Same as `wcschr', but return `wcsend(STR)', rather than `NULL' if `NEEDLE' wasn't found. */
#define __localdep_c16chrnul (*(__CHAR16_TYPE__ *(__LIBDCALL *)(__CHAR16_TYPE__ const *, __CHAR16_TYPE__))&__LIBC_LOCAL_NAME(c16chrnul))
#endif /* !... */
...
__LOCAL_LIBC(c16off) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1)) __SIZE_TYPE__
...
#define __local___localdep_c16off_defined 1
