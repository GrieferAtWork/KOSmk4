...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32ncmp))(__CHAR32_TYPE__ const *__s1, __CHAR32_TYPE__ const *__s2, __SIZE_TYPE__ __maxlen) {
...
#define __local___localdep_c32ncmp_defined 1
