...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16nrev))(__CHAR16_TYPE__ *__restrict __str, __SIZE_TYPE__ __maxlen) {
#if 2 == 2
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c16nrev_defined
#define __local___localdep_c16nrev_defined 1
#define __localdep_c16nrev __LIBC_LOCAL_NAME(c16nrev)
#endif /* !__local___localdep_c16nrev_defined */
