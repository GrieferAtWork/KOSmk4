...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32ndup))(__CHAR32_TYPE__ const *__restrict __string, __SIZE_TYPE__ __max_chars) {
	__SIZE_TYPE__ __resultsize = __localdep_c32nlen(__string, __max_chars) * sizeof(__CHAR32_TYPE__);
...
#define __local___localdep_c32ndup_defined 1
