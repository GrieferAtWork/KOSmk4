...
#ifndef __local___localdep_wildc16cmp_defined
#define __local___localdep_wildc16cmp_defined 1
#define __localdep_wildc16cmp __LIBC_LOCAL_NAME(wildc16cmp)
#endif /* !__local___localdep_wildc16cmp_defined */
