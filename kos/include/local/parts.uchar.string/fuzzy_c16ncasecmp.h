...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(fuzzy_c16ncasecmp))(__CHAR16_TYPE__ const *__s1, __SIZE_TYPE__ __s1_maxlen, __CHAR16_TYPE__ const *__s2, __SIZE_TYPE__ __s2_maxlen) {
	return __localdep_fuzzy_c16memcasecmp(__s1, __localdep_c16nlen(__s1, __s1_maxlen), __s2, __localdep_c16nlen(__s2, __s2_maxlen));
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_fuzzy_c16ncasecmp_defined
#define __local___localdep_fuzzy_c16ncasecmp_defined 1
#define __localdep_fuzzy_c16ncasecmp __LIBC_LOCAL_NAME(fuzzy_c16ncasecmp)
#endif /* !__local___localdep_fuzzy_c16ncasecmp_defined */
...
#undef __local_fuzzy_c16ncasecmp_defined
