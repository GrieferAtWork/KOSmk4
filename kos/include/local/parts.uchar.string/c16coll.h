...
/* Dependency: c16cmp from parts.uchar.string */
#ifndef __local___localdep_c16cmp_defined
#define __local___localdep_c16cmp_defined 1
#if defined(__CRT_HAVE_wcscmp) && (__SIZEOF_WCHAR_T__ == 2) && defined(__LIBCCALL_IS_LIBDCALL)
/* Compare 2 strings and return the difference of the first non-matching character, or `0' if they are identical */
__COMPILER_REDIRECT(__LIBC,__ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)),int,__NOTHROW_NCX,__LIBDCALL,__localdep_c16cmp,(__CHAR16_TYPE__ const *__s1, __CHAR16_TYPE__ const *__s2),wcscmp,(__s1,__s2))
...
__NAMESPACE_LOCAL_BEGIN
/* Compare 2 strings and return the difference of the first non-matching character, or `0' if they are identical */
#define __localdep_c16cmp (*(int(__LIBDCALL *)(__CHAR16_TYPE__ const *, __CHAR16_TYPE__ const *))&__LIBC_LOCAL_NAME(wcscmp))
#else /* ... */
__NAMESPACE_LOCAL_END
...
#define __local___localdep_c16coll_defined 1
