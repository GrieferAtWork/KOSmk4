...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(wildc16casecmp_l))(__CHAR16_TYPE__ const *__pattern, __CHAR16_TYPE__ const *__string, __locale_t __locale) {
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_wildc16casecmp_l_defined
#define __local___localdep_wildc16casecmp_l_defined 1
#define __localdep_wildc16casecmp_l __LIBC_LOCAL_NAME(wildc16casecmp_l)
#endif /* !__local___localdep_wildc16casecmp_l_defined */
