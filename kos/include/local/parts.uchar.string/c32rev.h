...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32rev))(__CHAR32_TYPE__ *__restrict __str) {
#if 4 == 2
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c32rev_defined
#define __local___localdep_c32rev_defined 1
#define __localdep_c32rev __LIBC_LOCAL_NAME(c32rev)
#endif /* !__local___localdep_c32rev_defined */
