...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(fuzzy_c32ncasecmp))(__CHAR32_TYPE__ const *__s1, __SIZE_TYPE__ __s1_maxlen, __CHAR32_TYPE__ const *__s2, __SIZE_TYPE__ __s2_maxlen) {
	return __localdep_fuzzy_c32memcasecmp(__s1, __localdep_c32nlen(__s1, __s1_maxlen), __s2, __localdep_c32nlen(__s2, __s2_maxlen));
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_fuzzy_c32ncasecmp_defined
#define __local___localdep_fuzzy_c32ncasecmp_defined 1
#define __localdep_fuzzy_c32ncasecmp __LIBC_LOCAL_NAME(fuzzy_c32ncasecmp)
#endif /* !__local___localdep_fuzzy_c32ncasecmp_defined */
...
#undef __local_fuzzy_c32ncasecmp_defined
