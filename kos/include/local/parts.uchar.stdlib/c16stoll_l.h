...
/* Dependency: c16stoll from parts.uchar.stdlib */
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),__LONGLONG,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stoll,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, int __base),wcstoll,(__nptr,__endptr,__base))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),__LONGLONG,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stoll,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, int __base),wcstoq,(__nptr,__endptr,__base))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),__LONGLONG,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stoll,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, int __base),wcstol,(__nptr,__endptr,__base))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),__LONGLONG,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stoll,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, int __base),wcsto64,(__nptr,__endptr,__base))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),__LONGLONG,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stoll,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, int __base),_wcstoi64,(__nptr,__endptr,__base))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),__LONGLONG,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stoll,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, int __base),wcsto32,(__nptr,__endptr,__base))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),__LONGLONG,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stoll,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, int __base),wcstoimax,(__nptr,__endptr,__base))
