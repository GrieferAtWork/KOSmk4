...
/* Dependency: c16stoull from parts.uchar.stdlib */
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),__ULONGLONG,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stoull,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, int __base),wcstoull,(__nptr,__endptr,__base))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),__ULONGLONG,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stoull,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, int __base),wcstouq,(__nptr,__endptr,__base))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),__ULONGLONG,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stoull,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, int __base),wcstoul,(__nptr,__endptr,__base))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),__ULONGLONG,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stoull,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, int __base),wcstou32,(__nptr,__endptr,__base))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),__ULONGLONG,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stoull,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, int __base),wcstou64,(__nptr,__endptr,__base))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),__ULONGLONG,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stoull,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, int __base),_wcstoui64,(__nptr,__endptr,__base))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1)),__ULONGLONG,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stoull,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, int __base),wcstoumax,(__nptr,__endptr,__base))
