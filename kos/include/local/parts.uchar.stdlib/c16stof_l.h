...
/* Dependency: c16stof from parts.uchar.stdlib */
...
__COMPILER_REDIRECT(__LIBC,__ATTR_PURE __ATTR_NONNULL((1)),float,__NOTHROW_NCX,__LIBDCALL,__localdep_c16stof,(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr),wcstof,(__nptr,__endptr))
...
#define __local___localdep_c16stof_l_defined 1
