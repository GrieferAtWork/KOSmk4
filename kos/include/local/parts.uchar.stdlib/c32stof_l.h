...
/* Dependency: c32stof from parts.uchar.stdlib */
...
__COMPILER_REDIRECT(__LIBC,__ATTR_PURE __ATTR_NONNULL((1)),float,__NOTHROW_NCX,__LIBKCALL,__localdep_c32stof,(__CHAR32_TYPE__ const *__restrict __nptr, __CHAR32_TYPE__ **__endptr),wcstof,(__nptr,__endptr))
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_c32stof (*(float(__LIBKCALL *)(__CHAR32_TYPE__ const *__restrict, __CHAR32_TYPE__ **))&__LIBC_LOCAL_NAME(wcstof))
#else /* ... */
__NAMESPACE_LOCAL_END
...
#define __local___localdep_c32stof_l_defined 1
