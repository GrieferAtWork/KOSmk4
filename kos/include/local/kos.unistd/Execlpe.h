...
__CREDIRECT_VOID(__ATTR_NORETURN __ATTR_NONNULL((1, 2, 3)),__THROWING,__localdep_Execvpe,(char const *__restrict __file, __TARGV, __TENVP),Execvpe,(__file,,))
#else /* LIBC: Execvpe */
...
__LOCAL_LIBC(Execlpe) __ATTR_NORETURN __ATTR_NONNULL((1)) __ATTR_SENTINEL_O(1) void
(__VLIBCCALL __LIBC_LOCAL_NAME(Execlpe))(char const *__restrict __file,
                                         char const *__args,
                                         ... /*, (char *)NULL, (char **)environ*/) __THROWS(...) {
#line 76 "kos/src/libc/magic/kos.unistd.c"
