...
__EXTERNINLINE __ATTR_CONST __ATTR_WUNUSED int __NOTHROW(__LIBCCALL __localdep_iscntrl)(int __ch) { return __builtin_iscntrl(__ch); }
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(iscntrl_l))(int __ch,
                                                       __locale_t __locale) {
#line 338 "kos/src/libc/magic/ctype.c"
