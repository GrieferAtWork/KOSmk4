...
#define __local_isalpha_l_defined 1
...
__FORCELOCAL __ATTR_CONST __ATTR_WUNUSED int __NOTHROW(__LIBCCALL __localdep_isalpha)(int __ch) { return __builtin_isalpha(__ch); }
...
__LOCAL_LIBC(isalpha_l) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(isalpha_l))(int __ch,
                                                       __locale_t __locale) {
#line 439 "kos/src/libc/magic/ctype.c"
...
#include <__hybrid/__byteorder.__h>
	...
	return ((__localdep___locale_ctype_ptr_l(__locale) + 1)[__ch & 0xff] & 3) != 0;
#elif defined(__CRT_HAVE__isctype_l) && defined(__CRT_DOS)
	return __localdep__isctype_l(__ch, 0x0103, __locale);
#else
	(void)__locale;
	return __localdep_isalpha(__ch);
#endif
}
