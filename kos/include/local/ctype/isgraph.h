 ...
 */
#ifndef __local_isgraph_defined
#define __local_isgraph_defined 1
...
__LOCAL_LIBC(isgraph) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(isgraph))(int __ch) {
...
#include <__hybrid/__byteorder.__h>
	...
	return (*__localdep___ctype_b_loc())[__ch] & (1 << 7);
#else
	return (*__localdep___ctype_b_loc())[__ch] & (1 << 15);
#endif
