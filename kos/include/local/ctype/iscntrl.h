 ...
 */
#ifndef __local_iscntrl_defined
#define __local_iscntrl_defined 1
...
__LOCAL_LIBC(iscntrl) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(iscntrl))(int __ch) {
...
#include <__hybrid/__byteorder.__h>
	...
	return ((__localdep___locale_ctype_ptr() + 1)[__ch & 0xff] & 040) != 0;
#elif defined(__CRT_HAVE__isctype) && defined(__CRT_DOS)
	return __localdep__isctype(__ch, 0x0020);
#else
	return (__UINT8_TYPE__)__ch <= 0x1f || (__UINT8_TYPE__)__ch == 0x7f;
#endif
}
__NAMESPACE_LOCAL_END
#endif /* !__local_iscntrl_defined */
