 ...
 *  - syslog:           Unbuffered system-log output.
 *  - ...               There are a _lot_ more... */
__LOCAL_LIBC(format_printf) __ATTR_NONNULL((1, 3)) __ATTR_LIBC_PRINTF(3, 4) __SSIZE_TYPE__
(__VLIBCCALL __LIBC_LOCAL_NAME(format_printf))(__pformatprinter __printer,
                                               void *__arg,
...
#line 868 "kos/src/libc/magic/format-printer.c"
	...
	__result = __localdep_format_vprintf(__printer, __arg, __format, __args);
