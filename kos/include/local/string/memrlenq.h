...
#define __localdep_memrendq __LIBC_FAST_NAME(memrendq)
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(memrlenq))(void const *__restrict __haystack, __UINT64_TYPE__ __qword, __SIZE_TYPE__ __n_qwords) {
