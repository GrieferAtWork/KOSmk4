...
__LOCAL_LIBC(strpbrk) __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1, 2)) char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(strpbrk))(char const *__haystack,
                                                     char const *__accept) {
