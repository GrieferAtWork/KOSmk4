...
__CREDIRECT(__ATTR_WUNUSED __ATTR_RETNONNULL,char *,__NOTHROW_NCX,__localdep_strerror,(int __errnum),strerror,(__errnum))
#else /* LIBC: strerror */
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(strerror_l))(int __errnum,
                                                        __locale_t __locale) {
#line 439 "kos/src/libc/magic/string.c"
	(void)__locale;
