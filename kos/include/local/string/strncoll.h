...
__FORCELOCAL __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1, 2)) int __NOTHROW_NCX(__LIBCCALL __localdep_strncmp)(char const *__s1, char const *__s2, __SIZE_TYPE__ __maxlen) { return __builtin_strncmp(__s1, __s2, __maxlen); }
#elif defined(__CRT_HAVE_strncmp)
/* Same as `strcmp', but compare at most `MAXLEN' characters from either string */
__CREDIRECT(__ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1, 2)),int,__NOTHROW_NCX,__localdep_strncmp,(char const *__s1, char const *__s2, __SIZE_TYPE__ __maxlen),strncmp,(__s1,__s2,__maxlen))
#else /* LIBC: strncmp */
...
__LOCAL_LIBC(strncoll) __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1, 2)) int
