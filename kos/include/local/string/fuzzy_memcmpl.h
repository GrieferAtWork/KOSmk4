...
#line 4602 "kos/src/libc/magic/string.c"
	...
	for (__i = 0; __i < __s1_dwords; ++__i) {
		...
		__localdep_memcpyc((__UINT8_TYPE__ *)__v0, (__UINT8_TYPE__ *)__v1, __s2_dwords, sizeof(__SIZE_TYPE__));
	}
