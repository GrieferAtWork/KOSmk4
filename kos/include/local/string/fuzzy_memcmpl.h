...
#define __local_fuzzy_memcmpl_defined 1
...
__LOCAL_LIBC(fuzzy_memcmpl) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 3)) __SIZE_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(fuzzy_memcmpl))(void const *__s1,
                                                           __SIZE_TYPE__ __s1_dwords,
                                                           void const *__s2,
                                                           __SIZE_TYPE__ __s2_dwords) {
#line 3974 "kos/src/libc/magic/string.c"
	...
	if (__s2_dwords > __s1_dwords) {
		...
		{ __SIZE_TYPE__ __temp = __s1_dwords; __s1_dwords = __s2_dwords; __s2_dwords = __temp; }
	}
...
#endif
	for (__i = 0; __i < __s2_dwords; ++__i) __v0[__i] = __i;
	for (__i = 0; __i < __s1_dwords; ++__i) {
		...
		__localdep_memcpyq((__UINT64_TYPE__ *)__v0, (__UINT64_TYPE__ *)__v1, __s2_dwords);
#elif __SIZEOF_SIZE_T__ == 4
		__localdep_memcpyl((__UINT32_TYPE__ *)__v0, (__UINT32_TYPE__ *)__v1, __s2_dwords);
#elif __SIZEOF_SIZE_T__ == 2
		__localdep_memcpyw((__UINT16_TYPE__ *)__v0, (__UINT16_TYPE__ *)__v1, __s2_dwords);
#else
		__localdep_memcpy((__UINT8_TYPE__ *)__v0, (__UINT8_TYPE__ *)__v1, __s2_dwords*sizeof(__SIZE_TYPE__));
#endif
	}
