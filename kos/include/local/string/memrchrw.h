...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(memrchrw))(/*aligned(2)*/ void const *__restrict __haystack,
                                                      __UINT16_TYPE__ __word,
                                                      __SIZE_TYPE__ __n_words) {
#line 1334 "kos/src/libc/magic/string.c"
