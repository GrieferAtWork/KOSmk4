...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(fuzzy_memcmpq))(void const *__s1, __SIZE_TYPE__ __s1_qwords, void const *__s2, __SIZE_TYPE__ __s2_qwords) {
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_fuzzy_memcmpq_defined
#define __local___localdep_fuzzy_memcmpq_defined 1
#define __localdep_fuzzy_memcmpq __LIBC_LOCAL_NAME(fuzzy_memcmpq)
#endif /* !__local___localdep_fuzzy_memcmpq_defined */
#else /* !__NO_MALLOCA */
#undef __local_fuzzy_memcmpq_defined
#endif /* __NO_MALLOCA */
