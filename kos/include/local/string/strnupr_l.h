 ...
 */
#ifndef __local_strnupr_l_defined
#define __local_strnupr_l_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(strnupr_l) __ATTR_LEAF __ATTR_RETNONNULL __ATTR_NONNULL((1)) char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(strnupr_l))(char *__restrict __str, __SIZE_TYPE__ __maxlen, __locale_t __locale) {
	char *__iter, __ch;
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_strnupr_l_defined
#define __local___localdep_strnupr_l_defined 1
#define __localdep_strnupr_l __LIBC_LOCAL_NAME(strnupr_l)
#endif /* !__local___localdep_strnupr_l_defined */
#endif /* !__local_strnupr_l_defined */
