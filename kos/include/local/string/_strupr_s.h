...
__EXTERNINLINE __ATTR_CONST __ATTR_WUNUSED int __NOTHROW(__LIBCCALL __localdep_toupper)(int __ch) { return __builtin_toupper(__ch); }
...
#line 5048 "kos/src/libc/magic/string.c"
	char *__iter, __ch;
	if (__buf == __NULLPTR)
		return __EINVAL;
