...
__LOCAL_LIBC(memrxchr) __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)) void *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(memrxchr))(void const *__restrict __haystack,
                                                      int __needle,
                                                      __SIZE_TYPE__ __n_bytes) {
#line 1559 "kos/src/libc/magic/string.c"
