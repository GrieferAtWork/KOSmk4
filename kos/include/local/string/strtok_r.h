...
__FORCELOCAL __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1, 2)) __SIZE_TYPE__ __NOTHROW_NCX(__LIBCCALL __localdep_strspn)(char const *__haystack, char const *__accept) { return __builtin_strspn(__haystack, __accept); }
#elif defined(__CRT_HAVE_strspn)
__CREDIRECT(__ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1, 2)),__SIZE_TYPE__,__NOTHROW_NCX,__localdep_strspn,(char const *__haystack, char const *__accept),strspn,(__haystack,__accept))
#else /* LIBC: strspn */
...
__FORCELOCAL __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1, 2)) __SIZE_TYPE__ __NOTHROW_NCX(__LIBCCALL __localdep_strcspn)(char const *__haystack, char const *__reject) { return __builtin_strcspn(__haystack, __reject); }
#elif defined(__CRT_HAVE_strcspn)
__CREDIRECT(__ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1, 2)),__SIZE_TYPE__,__NOTHROW_NCX,__localdep_strcspn,(char const *__haystack, char const *__reject),strcspn,(__haystack,__reject))
#else /* LIBC: strcspn */
...
__LOCAL_LIBC(strtok_r) __ATTR_NONNULL((2, 3)) char *
