...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(c16rtomb))(char *__restrict __s, __CHAR16_TYPE__ __c16, __mbstate_t *__restrict __mbs) {
	...
	if (!__mbs) {
		static __mbstate_t __c16rtomb_mbs = __MBSTATE_INIT;
