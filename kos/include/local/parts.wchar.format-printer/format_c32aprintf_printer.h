...
#ifndef ____localdep_format_c32aprintf_alloc_defined
#define ____localdep_format_c32aprintf_alloc_defined 1
 ...
 * to append additional data to the end of `self'
 * @return: NULL: Failed to allocate additional memory */
#define __localdep_format_c32aprintf_alloc (*(__CHAR32_TYPE__ *(__LIBCCALL*)(struct format_c32aprintf_data *__restrict, __SIZE_TYPE__))&(__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(format_waprintf_alloc)))
 ...
 * to append additional data to the end of `self'
 * @return: NULL: Failed to allocate additional memory */
#define __localdep_format_c32aprintf_alloc (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(format_c32aprintf_alloc))
#endif /* LIBC: format_c32aprintf_alloc */
#else /* CUSTOM: format_waprintf_alloc */
#undef ____localdep_format_c32aprintf_alloc_defined
#endif /* format_c32aprintf_alloc... */
#endif /* !____localdep_format_c32aprintf_alloc_defined */
