...
#include <__crt.h>
#if defined(__CRT_HAVE_format_waprintf_alloc) || (defined(__CRT_HAVE_DOS$format_waprintf_alloc) && __SIZEOF_WCHAR_T__ == 4) || (defined(__CRT_HAVE_DOS$format_waprintf_alloc) && __SIZEOF_WCHAR_T__ == 2) || defined(__CRT_HAVE_realloc)
...
__CREDIRECT(__ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_WUNUSED __ATTR_NONNULL((1)),__WCHAR_TYPE__ *,__NOTHROW_NCX,__localdep_format_waprintf_alloc,(struct format_waprintf_data *__restrict __self, __SIZE_TYPE__ __num_wchars),format_waprintf_alloc,(__self,__num_wchars))
#elif defined(__CRT_HAVE_DOS$format_waprintf_alloc) && __SIZEOF_WCHAR_T__ == 4
__NAMESPACE_LOCAL_END
#ifndef __format_waprintf_data_defined
#define __format_waprintf_data_defined 1
struct format_waprintf_data {
 ...
 * to append additional data to the end of `self'
 * @return: NULL: Failed to allocate additional memory */
__CREDIRECT_KOS(__ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_WUNUSED __ATTR_NONNULL((1)),__CHAR32_TYPE__ *,__NOTHROW_NCX,__localdep_format_waprintf_alloc,(struct format_c32aprintf_data *__restrict __self, __SIZE_TYPE__ __num_wchars),format_waprintf_alloc,(__self,__num_wchars))
 ...
 * to append additional data to the end of `self'
 * @return: NULL: Failed to allocate additional memory */
__CREDIRECT_DOS(__ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_WUNUSED __ATTR_NONNULL((1)),__CHAR16_TYPE__ *,__NOTHROW_NCX,__localdep_format_waprintf_alloc,(struct format_c16aprintf_data *__restrict __self, __SIZE_TYPE__ __num_wchars),format_waprintf_alloc,(__self,__num_wchars))
...
#else /* __CRT_HAVE_format_waprintf_alloc || (__CRT_HAVE_DOS$format_waprintf_alloc && __SIZEOF_WCHAR_T__ == 4) || (__CRT_HAVE_DOS$format_waprintf_alloc && __SIZEOF_WCHAR_T__ == 2) || __CRT_HAVE_realloc */
#undef __local_format_waprintf_printer_defined
#endif /* !__CRT_HAVE_format_waprintf_alloc && (!__CRT_HAVE_DOS$format_waprintf_alloc || !__SIZEOF_WCHAR_T__ == 4) && (!__CRT_HAVE_DOS$format_waprintf_alloc || !__SIZEOF_WCHAR_T__ == 2) && !__CRT_HAVE_realloc */
