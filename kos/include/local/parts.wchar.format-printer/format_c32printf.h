 ...
 *  - syslog:           Unbuffered system-log output.
 *  - ...               There are a _lot_ more... */
__LOCAL_LIBC(format_c32printf) __ATTR_NONNULL((1, 3)) __ATTR_LIBC_PRINTF(3, 4) __SSIZE_TYPE__
__NOTHROW_NCX(__VLIBCCALL __LIBC_LOCAL_NAME(format_c32printf))(__pc32formatprinter __printer,
                                                               void *__arg,
