...
__LOCAL_LIBC(_vscprintf_p_l) __ATTR_WUNUSED __ATTR_NONNULL((1)) __ATTR_LIBC_PRINTF_P(1, 0) __STDC_INT_AS_SIZE_T
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_vscprintf_p_l))(char const *__restrict __format,
                                                            __locale_t __locale,
                                                            __builtin_va_list __args) {
#line 2452 "kos/src/libc/magic/stdio.c"
	(void)__locale;
