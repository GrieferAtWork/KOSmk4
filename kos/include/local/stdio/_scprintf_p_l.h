...
__CREDIRECT(__ATTR_LIBC_PRINTF_P(1, 0) __ATTR_WUNUSED __ATTR_NONNULL((1)),__STDC_INT_AS_SIZE_T,__NOTHROW_NCX,__localdep__vscprintf_p_l,(char const *__restrict __format, __locale_t __locale, __builtin_va_list __args),_vscprintf_p_l,(__format,__locale,__args))
...
__LOCAL_LIBC(_scprintf_p_l) __ATTR_LIBC_PRINTF_P(1, 3) __ATTR_WUNUSED __ATTR_NONNULL((1)) __STDC_INT_AS_SIZE_T
__NOTHROW_NCX(__VLIBCCALL __LIBC_LOCAL_NAME(_scprintf_p_l))(char const *__restrict __format,
                                                            __locale_t __locale,
                                                            ...) {
#line 2267 "kos/src/libc/magic/stdio.c"
