...
#if ((defined(__CRT_HAVE_ftruncate) || defined(__CRT_HAVE__chsize)) || defined(__CRT_HAVE_ftruncate64) || (defined(__CRT_HAVE_ftruncate) && __SIZEOF_OFF32_T__ == __SIZEOF_OFF64_T__) || defined(__CRT_HAVE__chsize_s)) && (defined(__CRT_HAVE_fileno) || defined(__CRT_HAVE__fileno) || defined(__CRT_HAVE_fileno_unlocked))
...
#endif /* ((defined(__CRT_HAVE_ftruncate) || defined(__CRT_HAVE__chsize)) || defined(__CRT_HAVE_ftruncate64) || (defined(__CRT_HAVE_ftruncate) && __SIZEOF_OFF32_T__ == __SIZEOF_OFF64_T__) || defined(__CRT_HAVE__chsize_s)) && (defined(__CRT_HAVE_fileno) || defined(__CRT_HAVE__fileno) || defined(__CRT_HAVE_fileno_unlocked)) */
