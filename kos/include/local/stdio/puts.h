...
__CEIREDIRECT(__ATTR_NONNULL((1, 2)),__STDC_INT_AS_SSIZE_T,,__localdep_fputs,(char const *__restrict __str, __FILE *__restrict __stream),fputs,{ return __builtin_fputs(__str, __stream); }) __THROWS(...)
