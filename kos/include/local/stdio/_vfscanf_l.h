...
__LOCAL_LIBC(_vfscanf_l) __ATTR_WUNUSED __ATTR_NONNULL((1, 2)) __ATTR_LIBC_SCANF(2, 4) __STDC_INT_AS_SIZE_T
(__LIBCCALL __LIBC_LOCAL_NAME(_vfscanf_l))(__FILE *__restrict __stream,
                                           char const *__restrict __format,
                                           __locale_t __locale,
                                           __builtin_va_list __args) __THROWS(...) {
#line 2261 "kos/src/libc/magic/stdio.c"
	(void)__locale;
