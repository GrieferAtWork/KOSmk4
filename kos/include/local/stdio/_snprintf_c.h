...
__CREDIRECT(__ATTR_LIBC_PRINTF(3, 0) __ATTR_NONNULL((3)),__STDC_INT_AS_SIZE_T,__NOTHROW_NCX,__localdep__vsnprintf_c,(char *__restrict __buf, __SIZE_TYPE__ __bufsize, char const *__restrict __format, __builtin_va_list __args),_vsnprintf_c,(__buf,__bufsize,__format,__args))
...
__NOTHROW_NCX(__VLIBCCALL __LIBC_LOCAL_NAME(_snprintf_c))(char *__restrict __buf,
                                                          ...
                                                          ...) {
#line 2526 "kos/src/libc/magic/stdio.c"
