...
__CREDIRECT(__ATTR_NONNULL((1, 2)) __ATTR_LIBC_PRINTF_P(2, 0),__STDC_INT_AS_SIZE_T,,__localdep__vfprintf_p_l,(__FILE *__restrict __stream, char const *__restrict __format, __locale_t __locale, __builtin_va_list __args),_vfprintf_p_l,(__stream,__format,__locale,__args)) __THROWS(...)
...
__LOCAL_LIBC(_fprintf_p_l) __ATTR_NONNULL((1, 2)) __ATTR_LIBC_PRINTF_P(2, 4) __STDC_INT_AS_SIZE_T
(__VLIBCCALL __LIBC_LOCAL_NAME(_fprintf_p_l))(__FILE *__restrict __stream,
                                              char const *__restrict __format,
                                              __locale_t __locale,
                                              ...) __THROWS(...) {
#line 2626 "kos/src/libc/magic/stdio.c"
...
#endif /* (__CRT_DOS && __CRT_HAVE__flsbuf) || __CRT_HAVE_fwrite || __CRT_HAVE_fwrite_s || __CRT_HAVE_fwrite_unlocked || __CRT_HAVE__fwrite_nolock || __CRT_HAVE__IO_fwrite || __CRT_HAVE_fputc || __CRT_HAVE_putc || __CRT_HAVE__IO_putc || __CRT_HAVE_fputc_unlocked || __CRT_HAVE_putc_unlocked || __CRT_HAVE__vfprintf_p || __CRT_HAVE__vfprintf_p_l */
