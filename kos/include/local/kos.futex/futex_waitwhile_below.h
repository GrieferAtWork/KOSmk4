...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_waitwhile_below))(__uintptr_t *__uaddr,
                                                                   __uintptr_t __below_value) {
#line 388 "kos/src/libc/magic/kos.futex.c"
	return __localdep_lfutex64(__uaddr, LFUTEX_WAIT_WHILE_BELOW, __below_value, (struct __timespec64 *)__NULLPTR);
}
