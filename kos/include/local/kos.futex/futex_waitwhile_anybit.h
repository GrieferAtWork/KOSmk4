...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_waitwhile_anybit))(__uintptr_t *__uaddr, __uintptr_t __bitmask) {
	return __localdep_lfutex64(__uaddr, LFUTEX_WAIT_UNTIL_BITMASK, __bitmask, (struct __timespec64 const *)__NULLPTR, 0);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_waitwhile_anybit_defined
#define __local___localdep_futex_waitwhile_anybit_defined 1
#define __localdep_futex_waitwhile_anybit __LIBC_LOCAL_NAME(futex_waitwhile_anybit)
#endif /* !__local___localdep_futex_waitwhile_anybit_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_waitwhile_anybit_defined
