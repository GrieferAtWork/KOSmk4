 ...
 */
#ifndef __local_futex_waitwhile_anybit_defined
#if (defined(__CRT_HAVE_lfutex64) || defined(__CRT_HAVE_lfutex))
#define __local_futex_waitwhile_anybit_defined 1
...
__LOCAL_LIBC(futex_waitwhile_anybit) __ATTR_NONNULL((1)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_waitwhile_anybit))(__uintptr_t *__uaddr,
                                                                    __uintptr_t __bitmask) {
#line 454 "kos/src/libc/magic/kos.futex.c"
	return __localdep_lfutex64(__uaddr, LFUTEX_WAIT_UNTIL_BITMASK, __bitmask, (struct __timespec64 *)__NULLPTR, 0);
}
__NAMESPACE_LOCAL_END
#endif /* (defined(__CRT_HAVE_lfutex64) || defined(__CRT_HAVE_lfutex)) */
#endif /* !__local_futex_waitwhile_anybit_defined */
