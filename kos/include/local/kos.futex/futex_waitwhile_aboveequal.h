...
#define __local___localdep_futex_waitwhile_aboveequal_defined 1
#define __localdep_futex_waitwhile_aboveequal __LIBC_LOCAL_NAME(futex_waitwhile_aboveequal)
#endif /* !__local___localdep_futex_waitwhile_aboveequal_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_waitwhile_aboveequal_defined
