...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_timedwaitwhile_anybit))(__uintptr_t *__uaddr,
                                                                         __uintptr_t __bitmask,
                                                                         struct __TM_TYPE(timespec) *__rel_timeout) {
#line 656 "kos/src/libc/magic/kos.futex.c"
