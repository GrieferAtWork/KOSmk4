...
#line 443 "kos/src/libc/magic/kos.futex.c"
	return __localdep_lfutex64(__uaddr, LFUTEX_WAIT_UNTIL_BITMASK, __bitmask, (struct __timespec64 *)__NULLPTR, __setmask);
}
