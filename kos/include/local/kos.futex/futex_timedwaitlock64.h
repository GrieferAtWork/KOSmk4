...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_timedwaitlock64))(__uintptr_t *__uaddr, struct __timespec64 const *__rel_timeout) {
	return __localdep_lfutex64(__uaddr, LFUTEX_WAIT_LOCK, 0, __rel_timeout);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_timedwaitlock64_defined
#define __local___localdep_futex_timedwaitlock64_defined 1
#define __localdep_futex_timedwaitlock64 __LIBC_LOCAL_NAME(futex_timedwaitlock64)
#endif /* !__local___localdep_futex_timedwaitlock64_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_timedwaitlock64_defined
