...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_waituntil_cmpxch))(__uintptr_t *__uaddr, __uintptr_t __old_value, __uintptr_t __new_value) {
	return __localdep_lfutex64(__uaddr, LFUTEX_WAIT_UNTIL_CMPXCH, __old_value, (struct __timespec64 const *)__NULLPTR, __new_value);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_waituntil_cmpxch_defined
#define __local___localdep_futex_waituntil_cmpxch_defined 1
#define __localdep_futex_waituntil_cmpxch __LIBC_LOCAL_NAME(futex_waituntil_cmpxch)
#endif /* !__local___localdep_futex_waituntil_cmpxch_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_waituntil_cmpxch_defined
