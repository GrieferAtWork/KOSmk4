...
__LOCAL_LIBC(futex_waitwhile_cmpxch) __ATTR_NONNULL((1)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_waitwhile_cmpxch))(__uintptr_t *__uaddr,
                                                                    __uintptr_t __old_value,
                                                                    __uintptr_t __new_value) {
#line 398 "kos/src/libc/magic/kos.futex.c"
	return __localdep_lfutex64(__uaddr, LFUTEX_WAIT_WHILE_CMPXCH, __old_value, (struct __timespec64 *)__NULLPTR, __new_value);
}
