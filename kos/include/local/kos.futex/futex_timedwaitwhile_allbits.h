 ...
 */
#ifndef __local_futex_timedwaitwhile_allbits_defined
#if (defined(__CRT_HAVE_lfutex) || defined(__CRT_HAVE_lfutex64))
#define __local_futex_timedwaitwhile_allbits_defined 1
...
__CREDIRECT(__ATTR_NONNULL((1)),__SSIZE_TYPE__,__NOTHROW_RPC,__localdep_lfutex,(__uintptr_t *__uaddr, __syscall_ulong_t __command, __uintptr_t __val, /*struct timespec const *timeout, lfutex_t val2*/...),lfutex64,(__uaddr,__command,__val,))
 ...
 * @return: -1:EINTR:     A blocking futex-wait operation was interrupted
 * @return: -1:ETIMEDOUT: A blocking futex-wait operation has timed out */
__CREDIRECT(__ATTR_NONNULL((1)),__SSIZE_TYPE__,__NOTHROW_RPC,__localdep_lfutex,(__uintptr_t *__uaddr, __syscall_ulong_t __command, __uintptr_t __val, /*struct timespec const *timeout, lfutex_t val2*/...),lfutex,(__uaddr,__command,__val,))
...
__LOCAL_LIBC(futex_timedwaitwhile_allbits) __ATTR_NONNULL((1)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_timedwaitwhile_allbits))(__uintptr_t *__uaddr,
                                                                          __uintptr_t __bitmask,
                                                                          struct __TM_TYPE(timespec) *__rel_timeout) {
#line 669 "kos/src/libc/magic/kos.futex.c"
	return __localdep_lfutex(__uaddr, LFUTEX_WAIT_WHILE_BITMASK, __bitmask, __rel_timeout, __bitmask);
}
__NAMESPACE_LOCAL_END
#endif /* (defined(__CRT_HAVE_lfutex) || defined(__CRT_HAVE_lfutex64)) */
#endif /* !__local_futex_timedwaitwhile_allbits_defined */
