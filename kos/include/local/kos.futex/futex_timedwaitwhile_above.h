 ...
 */
#ifndef __local_futex_timedwaitwhile_above_defined
#if (defined(__CRT_HAVE_lfutex) || defined(__CRT_HAVE_lfutex64))
#define __local_futex_timedwaitwhile_above_defined 1
...
__LOCAL_LIBC(futex_timedwaitwhile_above) __ATTR_NONNULL((1)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_timedwaitwhile_above))(__uintptr_t *__uaddr,
                                                                        __uintptr_t __above_value,
                                                                        struct __TM_TYPE(timespec) *__rel_timeout) {
#line 528 "kos/src/libc/magic/kos.futex.c"
	return __localdep_lfutex(__uaddr, LFUTEX_WAIT_WHILE_ABOVE, __above_value, __rel_timeout);
}
__NAMESPACE_LOCAL_END
#endif /* (defined(__CRT_HAVE_lfutex) || defined(__CRT_HAVE_lfutex64)) */
#endif /* !__local_futex_timedwaitwhile_above_defined */
