...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_timedwaitwhile_above_defined
#define __local___localdep_futex_timedwaitwhile_above_defined 1
#define __localdep_futex_timedwaitwhile_above __LIBC_LOCAL_NAME(futex_timedwaitwhile_above)
#endif /* !__local___localdep_futex_timedwaitwhile_above_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_timedwaitwhile_above_defined
