 ...
 */
#ifndef __local_futex_timedwaitwhile_cmpxch_defined
#if (defined(__CRT_HAVE_lfutex) || defined(__CRT_HAVE_lfutex64))
#define __local_futex_timedwaitwhile_cmpxch_defined 1
...
__LOCAL_LIBC(futex_timedwaitwhile_cmpxch) __ATTR_NONNULL((1)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_timedwaitwhile_cmpxch))(__uintptr_t *__uaddr,
                                                                         __uintptr_t __old_value,
                                                                         __uintptr_t __new_value,
                                                                         struct __TM_TYPE(timespec) *__rel_timeout) {
#line 588 "kos/src/libc/magic/kos.futex.c"
	return __localdep_lfutex(__uaddr, LFUTEX_WAIT_WHILE_CMPXCH, __old_value, __rel_timeout, __new_value);
}
__NAMESPACE_LOCAL_END
#endif /* (defined(__CRT_HAVE_lfutex) || defined(__CRT_HAVE_lfutex64)) */
#endif /* !__local_futex_timedwaitwhile_cmpxch_defined */
