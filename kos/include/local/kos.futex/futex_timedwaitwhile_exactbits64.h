...
#define __local___localdep_futex_timedwaitwhile_exactbits64_defined 1
#define __localdep_futex_timedwaitwhile_exactbits64 __LIBC_LOCAL_NAME(futex_timedwaitwhile_exactbits64)
#endif /* !__local___localdep_futex_timedwaitwhile_exactbits64_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_timedwaitwhile_exactbits64_defined
