...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_timedwaitwhile_aboveequal64))(__uintptr_t *__uaddr, __uintptr_t __above_equal_value, struct __timespec64 const *__rel_timeout) {
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_timedwaitwhile_aboveequal64_defined
#define __local___localdep_futex_timedwaitwhile_aboveequal64_defined 1
#define __localdep_futex_timedwaitwhile_aboveequal64 __LIBC_LOCAL_NAME(futex_timedwaitwhile_aboveequal64)
#endif /* !__local___localdep_futex_timedwaitwhile_aboveequal64_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_timedwaitwhile_aboveequal64_defined
