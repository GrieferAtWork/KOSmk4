...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_timedwaituntil_exactbits64))(__uintptr_t *__uaddr,
                                                                              __uintptr_t __bitmask,
                                                                              __uintptr_t __setmask,
                                                                              struct __timespec64 const *__rel_timeout) {
#line 849 "kos/src/libc/magic/kos.futex.c"
