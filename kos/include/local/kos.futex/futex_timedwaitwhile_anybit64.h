...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_timedwaitwhile_anybit64))(__uintptr_t *__uaddr,
                                                                           __uintptr_t __bitmask,
                                                                           struct __timespec64 const *__rel_timeout) {
#line 856 "kos/src/libc/magic/kos.futex.c"
