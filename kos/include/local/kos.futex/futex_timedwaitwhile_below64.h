...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_timedwaitwhile_below64))(__uintptr_t *__uaddr, __uintptr_t __below_value, struct __timespec64 const *__rel_timeout) {
	return __localdep_lfutex64(__uaddr, LFUTEX_WAIT_WHILE_BELOW, __below_value, __rel_timeout);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_timedwaitwhile_below64_defined
#define __local___localdep_futex_timedwaitwhile_below64_defined 1
#define __localdep_futex_timedwaitwhile_below64 __LIBC_LOCAL_NAME(futex_timedwaitwhile_below64)
#endif /* !__local___localdep_futex_timedwaitwhile_below64_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_timedwaitwhile_below64_defined
