...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(c32access))(__CHAR32_TYPE__ const *__file,
                                                       int __type) {
#line 681 "kos/src/libc/magic/unistd.c"
	return __localdep_c32faccessat(__CRT_AT_FDCWD, __file, __type, 0);
}
__NAMESPACE_LOCAL_END
#endif /* defined(__CRT_AT_FDCWD) && defined(__CRT_HAVE_wfaccessat) */
