...
#ifndef ____localdep_c32truncate64_defined
#define ____localdep_c32truncate64_defined 1
...
/* >> c32truncate(2)
 * Truncate the given file `FILE' to a length of `LENGTH' */
#define __localdep_c32truncate64(file, length) (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wtruncate64))((__WCHAR_TYPE__ const *)(file), length)
#else /* LIBC: c32truncate64 */
#include <local/parts.wchar.unistd/c32truncate64.h>
/* >> c32truncate(2)
 * Truncate the given file `FILE' to a length of `LENGTH' */
#define __localdep_c32truncate64 (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(c32truncate64))
#endif /* LIBC: c32truncate64 */
#else /* CUSTOM: wtruncate64 */
#undef ____localdep_c32truncate64_defined
#endif /* c32truncate64... */
#endif /* !____localdep_c32truncate64_defined */

/* Dependency: "wtruncate32" from "parts.wchar.unistd" */
#ifndef ____localdep_c32truncate32_defined
#define ____localdep_c32truncate32_defined 1
#if defined(__CRT_HAVE_wtruncate32) && (__SIZEOF_WCHAR_T__ == 4)
/* >> truncate(2)
 * Truncate the given file `FILE' to a length of `LENGTH' */
__CREDIRECT(,int,__NOTHROW_NCX,__localdep_c32truncate32,(__CHAR32_TYPE__ const *__file, __pos32_t __length),wtruncate32,(__file,__length))
#else /* LIBC: wtruncate32 */
#undef ____localdep_c32truncate32_defined
#endif /* c32truncate32... */
#endif /* !____localdep_c32truncate32_defined */
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(c32truncate))(__CHAR32_TYPE__ const *__file,
...
#else /* __USE_KOS */
	return __localdep_c32truncate32(__file, (__off32_t)__length);
#endif /* !__USE_KOS */
#else
	int __result;
	__fd_t __fd;
