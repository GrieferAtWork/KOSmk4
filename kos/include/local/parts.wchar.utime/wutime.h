...
__CREDIRECT_KOS(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,__localdep_wutime64,(__CHAR32_TYPE__ const *__filename, struct __utimbuf64 const *__file_times),wutime64,(__filename,__file_times))
#elif defined(__CRT_HAVE_DOS$_wutime64) && __SIZEOF_WCHAR_T__ == 2
__CREDIRECT_DOS(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,__localdep_wutime64,(__CHAR16_TYPE__ const *__filename, struct __utimbuf64 const *__file_times),_wutime64,(__filename,__file_times))
...
__CREDIRECT_KOS(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,__localdep_wutime64,(__CHAR32_TYPE__ const *__filename, struct __utimbuf64 const *__file_times),wutime,(__filename,__file_times))
#elif defined(__CRT_HAVE_DOS$wutime) && (__SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__) && __SIZEOF_WCHAR_T__ == 2
__CREDIRECT_DOS(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,__localdep_wutime64,(__CHAR16_TYPE__ const *__filename, struct __utimbuf64 const *__file_times),wutime,(__filename,__file_times))
...
__CREDIRECT_KOS(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,__localdep_crt_wutime32,(__CHAR32_TYPE__ const *__filename, struct __utimbuf32 const *__file_times),wutime,(__filename,__file_times))
#elif defined(__CRT_HAVE_DOS$wutime) && __SIZEOF_WCHAR_T__ == 2
__CREDIRECT_DOS(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,__localdep_crt_wutime32,(__CHAR16_TYPE__ const *__filename, struct __utimbuf32 const *__file_times),wutime,(__filename,__file_times))
...
__CREDIRECT_KOS(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,__localdep_crt_wutime32,(__CHAR32_TYPE__ const *__filename, struct __utimbuf32 const *__file_times),_wutime32,(__filename,__file_times))
#elif defined(__CRT_HAVE_DOS$_wutime32) && __SIZEOF_WCHAR_T__ == 2
__CREDIRECT_DOS(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,__localdep_crt_wutime32,(__CHAR16_TYPE__ const *__filename, struct __utimbuf32 const *__file_times),_wutime32,(__filename,__file_times))
#else /* ... */
...
#else /* __CRT_HAVE_wutime || (__CRT_HAVE_DOS$wutime && __SIZEOF_WCHAR_T__ == 4) || (__CRT_HAVE_DOS$wutime && __SIZEOF_WCHAR_T__ == 2) || __CRT_HAVE__wutime32 || (__CRT_HAVE_DOS$_wutime32 && __SIZEOF_WCHAR_T__ == 4) || (__CRT_HAVE_DOS$_wutime32 && __SIZEOF_WCHAR_T__ == 2) || __CRT_HAVE_wutime64 || (__CRT_HAVE_DOS$wutime64 && __SIZEOF_WCHAR_T__ == 4) || (__CRT_HAVE_DOS$wutime64 && __SIZEOF_WCHAR_T__ == 2) || __CRT_HAVE__wutime64 || (__CRT_HAVE_DOS$_wutime64 && __SIZEOF_WCHAR_T__ == 4) || (__CRT_HAVE_DOS$_wutime64 && __SIZEOF_WCHAR_T__ == 2) */
#undef __local_wutime_defined
#endif /* !__CRT_HAVE_wutime && (!__CRT_HAVE_DOS$wutime || !__SIZEOF_WCHAR_T__ == 4) && (!__CRT_HAVE_DOS$wutime || !__SIZEOF_WCHAR_T__ == 2) && !__CRT_HAVE__wutime32 && (!__CRT_HAVE_DOS$_wutime32 || !__SIZEOF_WCHAR_T__ == 4) && (!__CRT_HAVE_DOS$_wutime32 || !__SIZEOF_WCHAR_T__ == 2) && !__CRT_HAVE_wutime64 && (!__CRT_HAVE_DOS$wutime64 || !__SIZEOF_WCHAR_T__ == 4) && (!__CRT_HAVE_DOS$wutime64 || !__SIZEOF_WCHAR_T__ == 2) && !__CRT_HAVE__wutime64 && (!__CRT_HAVE_DOS$_wutime64 || !__SIZEOF_WCHAR_T__ == 4) && (!__CRT_HAVE_DOS$_wutime64 || !__SIZEOF_WCHAR_T__ == 2) */
