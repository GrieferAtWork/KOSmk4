...
#line 1319 "kos/src/libc/magic/stdlib.c"
	if (__localdep_fcvt_r(__val, __ndigit, __decptr, __sign, __NAMESPACE_LOCAL_SYM __qcvt_buffer, sizeof(__NAMESPACE_LOCAL_SYM __qcvt_buffer)))
		return __NULLPTR;
