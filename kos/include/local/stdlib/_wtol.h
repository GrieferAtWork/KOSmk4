 ...
 */
#ifndef __local__wtol_defined
#define __local__wtol_defined 1
...
__LOCAL_LIBC(_wtol) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1)) long
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_wtol))(__WCHAR_TYPE__ const *__nptr) {
