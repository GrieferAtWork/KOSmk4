...
__LOCAL_LIBC(_atol_l) __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)) long int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_atol_l))(char const *__restrict __nptr,
                                                     __locale_t __locale) {
