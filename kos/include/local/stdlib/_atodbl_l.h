...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_atodbl_l))(double *__restrict __result, char __KOS_FIXED_CONST *__restrict __nptr, __locale_t __locale) {
	*__result = __localdep_strtod_l(__nptr, __NULLPTR, __locale);
	return 0;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__atodbl_l_defined
#define __local___localdep__atodbl_l_defined 1
#define __localdep__atodbl_l __LIBC_LOCAL_NAME(_atodbl_l)
#endif /* !__local___localdep__atodbl_l_defined */
