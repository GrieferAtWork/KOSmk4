...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32stoll))(__CHAR32_TYPE__ const *__restrict __nptr, __CHAR32_TYPE__ **__endptr, __STDC_INT_AS_UINT_T __base) {
