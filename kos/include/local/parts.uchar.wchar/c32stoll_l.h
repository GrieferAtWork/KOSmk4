...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_c32stoll (*(__LONGLONG(__LIBKCALL *)(__CHAR32_TYPE__ const *__restrict, __CHAR32_TYPE__ **, __STDC_INT_AS_UINT_T))&__LIBC_LOCAL_NAME(wcstoll))
#else /* ... */
__NAMESPACE_LOCAL_END
