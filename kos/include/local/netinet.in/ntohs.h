...
#ifndef __local___localdep_ntohs_defined
#define __local___localdep_ntohs_defined 1
#define __localdep_ntohs __LIBC_LOCAL_NAME(ntohs)
#endif /* !__local___localdep_ntohs_defined */
