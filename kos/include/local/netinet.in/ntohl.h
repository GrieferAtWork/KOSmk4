...
#ifndef __local___localdep_ntohl_defined
#define __local___localdep_ntohl_defined 1
#define __localdep_ntohl __LIBC_LOCAL_NAME(ntohl)
#endif /* !__local___localdep_ntohl_defined */
