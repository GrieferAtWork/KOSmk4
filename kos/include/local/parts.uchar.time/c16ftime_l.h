...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1, 3, 4)),__SIZE_TYPE__,__NOTHROW_NCX,__LIBDCALL,__localdep_c16ftime,(__CHAR16_TYPE__ *__restrict __buf, __SIZE_TYPE__ __buflen, __CHAR16_TYPE__ const *__restrict __format, struct __NAMESPACE_STD_SYM tm const *__restrict __tp),wcsftime,(__buf,__buflen,__format,__tp))
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_c16ftime (*(__SIZE_TYPE__(__LIBDCALL *)(__CHAR16_TYPE__ *__restrict, __SIZE_TYPE__, __CHAR16_TYPE__ const *__restrict, struct __NAMESPACE_STD_SYM tm const *__restrict))&__LIBC_LOCAL_NAME(wcsftime))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16ftime_l))(__CHAR16_TYPE__ *__restrict __buf, __SIZE_TYPE__ __maxsize, __CHAR16_TYPE__ const *__restrict __format, __STRUCT_TM const *__restrict __tp, __locale_t __locale) {
	(void)__locale;
	return __localdep_c16ftime(__buf, __maxsize, __format, __tp);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c16ftime_l_defined
#define __local___localdep_c16ftime_l_defined 1
#define __localdep_c16ftime_l __LIBC_LOCAL_NAME(c16ftime_l)
#endif /* !__local___localdep_c16ftime_l_defined */
