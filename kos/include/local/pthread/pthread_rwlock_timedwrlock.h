...
#line 1047 "kos/src/libc/magic/pthread.c"
#ifdef __CRT_HAVE_pthread_rwlock_timedwrlock
	int __result;
...
#endif /* defined(__CRT_HAVE_pthread_rwlock_timedwrlock) || defined(__CRT_HAVE_pthread_rwlock_timedwrlock64) */
