...
__CEIREDIRECT(__ATTR_WUNUSED,long int,__NOTHROW,__localdep_lrint,(double __x),lrint,{ return __builtin_lrint(__x); })
...
#line 1618 "kos/src/libc/magic/math.c"
