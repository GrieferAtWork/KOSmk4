...
/* Absolute value of X */
__FORCELOCAL __ATTR_WUNUSED __ATTR_CONST float __NOTHROW(__LIBCCALL __localdep_fabsf)(float __x) { return __builtin_fabsf(__x); }
#elif defined(__CRT_HAVE_fabsf)
/* Absolute value of X */
__CREDIRECT(__ATTR_WUNUSED __ATTR_CONST,float,__NOTHROW,__localdep_fabsf,(float __x),fabsf,(__x))
#elif defined(__CRT_HAVE___fabsf)
/* Absolute value of X */
__CREDIRECT(__ATTR_WUNUSED __ATTR_CONST,float,__NOTHROW,__localdep_fabsf,(float __x),__fabsf,(__x))
#else /* LIBC: fabsf */
...
__LOCAL_LIBC(fdimf) __ATTR_WUNUSED __ATTR_CONST float
