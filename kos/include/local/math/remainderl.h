...
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(remainderl))(__LONGDOUBLE __x,
                                                    __LONGDOUBLE __p) {
#line 1462 "kos/src/libc/magic/math.c"
