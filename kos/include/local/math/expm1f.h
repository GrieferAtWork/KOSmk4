...
#if ((__has_builtin(__builtin_expm1) && defined(__LIBC_BIND_CRTBUILTINS) && defined(__CRT_HAVE_expm1)) || defined(__CRT_HAVE_expm1) || defined(__CRT_HAVE___expm1))
...
#line 276 "kos/src/libc/magic/math.c"
	return (float)__localdep_expm1((double)__x);
}
__NAMESPACE_LOCAL_END
#endif /* ((__has_builtin(__builtin_expm1) && defined(__LIBC_BIND_CRTBUILTINS) && defined(__CRT_HAVE_expm1)) || defined(__CRT_HAVE_expm1) || defined(__CRT_HAVE___expm1)) */
