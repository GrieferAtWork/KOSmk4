...
/* Arc cosine of X */
__EXTERNINLINE __ATTR_WUNUSED double __NOTHROW(__LIBCCALL __localdep_acos)(double __x) { return __builtin_acos(__x); }
...
#line 159 "kos/src/libc/magic/math.c"
