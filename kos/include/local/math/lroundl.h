...
__EXTERNINLINE __ATTR_CONST __ATTR_WUNUSED long double __NOTHROW(__LIBCCALL __localdep_roundl)(long double __x) { return __builtin_roundl(__x); }
...
#line 784 "kos/src/libc/magic/math.c"
