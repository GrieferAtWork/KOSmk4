...
__EXTERNINLINE __ATTR_CONST __ATTR_WUNUSED __LONGDOUBLE __NOTHROW(__LIBCCALL __localdep_roundl)(__LONGDOUBLE __x) { return __builtin_roundl(__x); }
...
#line 1080 "kos/src/libc/magic/math.c"
