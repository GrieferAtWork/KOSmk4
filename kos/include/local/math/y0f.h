...
__EXTERNINLINE __ATTR_WUNUSED double __NOTHROW(__LIBCCALL __localdep_y0)(double __x) { return __builtin_y0(__x); }
...
#line 1609 "kos/src/libc/magic/math.c"
