...
#if ((__has_builtin(__builtin_sincos) && defined(__LIBC_BIND_CRTBUILTINS) && defined(__CRT_HAVE_sincos)) || defined(__CRT_HAVE_sincos) || defined(__CRT_HAVE___sincos))
...
__FORCELOCAL __DECL_SIMD_sincos __ATTR_NONNULL((2, 3)) void __NOTHROW(__LIBCCALL __localdep_sincos)(double __x, double *__psinx, double *__pcosx) { return __builtin_sincos(__x, __psinx, __pcosx); }
...
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(sincosl))(long double __x,
                                                 long double *__psinx,
                                                 long double *__pcosx) {
#line 782 "kos/src/libc/magic/math.c"
...
#endif /* ((__has_builtin(__builtin_sincos) && defined(__LIBC_BIND_CRTBUILTINS) && defined(__CRT_HAVE_sincos)) || defined(__CRT_HAVE_sincos) || defined(__CRT_HAVE___sincos)) */
