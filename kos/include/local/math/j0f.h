...
#if ((__has_builtin(__builtin_j0) && defined(__LIBC_BIND_CRTBUILTINS) && defined(__CRT_HAVE_j0)) || defined(__CRT_HAVE_j0) || defined(__CRT_HAVE___j0))
...
__FORCELOCAL __ATTR_WUNUSED double __NOTHROW(__LIBCCALL __localdep_j0)(double __x) { return __builtin_j0(__x); }
...
#endif /* ((__has_builtin(__builtin_j0) && defined(__LIBC_BIND_CRTBUILTINS) && defined(__CRT_HAVE_j0)) || defined(__CRT_HAVE_j0) || defined(__CRT_HAVE___j0)) */
