...
__FORCELOCAL __ATTR_WUNUSED double __NOTHROW(__LIBCCALL __localdep_rint)(double __x) { return __builtin_rint(__x); }
...
#line 458 "kos/src/libc/magic/math.c"
