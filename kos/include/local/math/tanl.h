...
/* Tangent of X */
__EXTERNINLINE __ATTR_WUNUSED double __NOTHROW(__LIBCCALL __localdep_tan)(double __x) { return __builtin_tan(__x); }
...
#line 153 "kos/src/libc/magic/math.c"
