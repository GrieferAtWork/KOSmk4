...
__LOCAL_LIBC(y0l) __ATTR_WUNUSED long double
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(y0l))(long double __x) {
#line 1338 "kos/src/libc/magic/math.c"
	return (long double)__localdep_y0((double)__x);
}
