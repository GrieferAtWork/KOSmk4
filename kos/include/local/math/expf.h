...
__EXTERNINLINE __DECL_SIMD_exp __ATTR_WUNUSED double __NOTHROW(__LIBCCALL __localdep_exp)(double __x) { return __builtin_exp(__x); }
...
#line 341 "kos/src/libc/magic/math.c"
