...
__CEIREDIRECT(__DECL_SIMD_powf __ATTR_WUNUSED,float,__NOTHROW,__localdep_powf,(float __x, float __y),powf,{ return __builtin_powf(__x, __y); })
...
#line 1419 "kos/src/libc/magic/math.c"
