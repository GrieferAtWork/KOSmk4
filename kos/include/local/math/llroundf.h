...
__FORCELOCAL __ATTR_WUNUSED __ATTR_CONST float __NOTHROW(__LIBCCALL __localdep_roundf)(float __x) { return __builtin_roundf(__x); }
#elif defined(__CRT_HAVE_roundf)
/* Round X to nearest integral value, rounding halfway cases away from zero */
__CREDIRECT(__ATTR_WUNUSED __ATTR_CONST,float,__NOTHROW,__localdep_roundf,(float __x),roundf,(__x))
#elif defined(__CRT_HAVE___roundf)
/* Round X to nearest integral value, rounding halfway cases away from zero */
__CREDIRECT(__ATTR_WUNUSED __ATTR_CONST,float,__NOTHROW,__localdep_roundf,(float __x),__roundf,(__x))
#else /* LIBC: roundf */
...
/* Round X to nearest integral value, rounding halfway cases away from zero */
__LOCAL_LIBC(llroundf) __ATTR_WUNUSED __LONGLONG
