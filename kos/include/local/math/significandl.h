...
__FORCELOCAL __ATTR_WUNUSED double __NOTHROW(__LIBCCALL __localdep_significand)(double __x) { return __builtin_significand(__x); }
...
#line 848 "kos/src/libc/magic/math.c"
