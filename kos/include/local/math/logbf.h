...
__FORCELOCAL __ATTR_WUNUSED double __NOTHROW(__LIBCCALL __localdep_logb)(double __x) { return __builtin_logb(__x); }
...
#line 278 "kos/src/libc/magic/math.c"
