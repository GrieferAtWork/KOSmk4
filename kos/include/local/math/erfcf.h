...
__FORCELOCAL __ATTR_WUNUSED double __NOTHROW(__LIBCCALL __localdep_erfc)(double __x) { return __builtin_erfc(__x); }
...
#line 421 "kos/src/libc/magic/math.c"
