...
#if ((__has_builtin(__builtin_log10) && defined(__LIBC_BIND_CRTBUILTINS) && defined(__CRT_HAVE_log10)) || defined(__CRT_HAVE_log10) || defined(__CRT_HAVE___log10))
...
#endif /* ((__has_builtin(__builtin_log10) && defined(__LIBC_BIND_CRTBUILTINS) && defined(__CRT_HAVE_log10)) || defined(__CRT_HAVE_log10) || defined(__CRT_HAVE___log10)) */
