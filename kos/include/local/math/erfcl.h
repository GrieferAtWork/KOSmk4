...
__LOCAL_LIBC(erfcl) __ATTR_WUNUSED long double
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(erfcl))(long double __x) {
#line 605 "kos/src/libc/magic/math.c"
	return (long double)__localdep_erfc((double)__x);
}
