...
__EXTERNINLINE __ATTR_WUNUSED double __NOTHROW(__LIBCCALL __localdep_exp10)(double __x) { return __builtin_exp10(__x); }
...
#line 1943 "kos/src/libc/magic/math.c"
