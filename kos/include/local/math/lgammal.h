...
__LOCAL_LIBC(lgammal) __ATTR_WUNUSED long double
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(lgammal))(long double __x) {
#line 628 "kos/src/libc/magic/math.c"
