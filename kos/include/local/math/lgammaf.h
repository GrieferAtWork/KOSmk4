...
__EXTERNINLINE __ATTR_WUNUSED double __NOTHROW(__LIBCCALL __localdep_lgamma)(double __x) { return __builtin_lgamma(__x); }
...
#line 602 "kos/src/libc/magic/math.c"
