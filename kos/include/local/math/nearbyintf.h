...
__EXTERNINLINE __ATTR_WUNUSED double __NOTHROW(__LIBCCALL __localdep_nearbyint)(double __x) { return __builtin_nearbyint(__x); }
...
#line 565 "kos/src/libc/magic/math.c"
