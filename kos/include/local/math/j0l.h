...
__LOCAL_LIBC(j0l) __ATTR_WUNUSED long double
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(j0l))(long double __x) {
#line 1335 "kos/src/libc/magic/math.c"
	return (long double)__localdep_j0((double)__x);
}
