...
#if ((defined(__CRT_HAVE_wexecvpe) && __SIZEOF_WCHAR_T__ == 2) || (defined(__CRT_HAVE__wexecvpe) && __SIZEOF_WCHAR_T__ == 2) || defined(__CRT_HAVE_DOS$_wexecvpe) || defined(__CRT_HAVE_DOS$_wexecvpe))
...
__LOCAL_LIBC(c16execlpe) __ATTR_SENTINEL __ATTR_NONNULL((1)) int
...
#endif /* ((defined(__CRT_HAVE_wexecvpe) && __SIZEOF_WCHAR_T__ == 2) || (defined(__CRT_HAVE__wexecvpe) && __SIZEOF_WCHAR_T__ == 2) || defined(__CRT_HAVE_DOS$_wexecvpe) || defined(__CRT_HAVE_DOS$_wexecvpe)) */
