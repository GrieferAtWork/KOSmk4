...
#if ((defined(__CRT_HAVE_wspawnvpe) && __SIZEOF_WCHAR_T__ == 2) || (defined(__CRT_HAVE__wspawnvpe) && __SIZEOF_WCHAR_T__ == 2) || defined(__CRT_HAVE_DOS$_wspawnvpe) || defined(__CRT_HAVE_DOS$_wspawnvpe))
...
__LOCAL_LIBC(c16spawnlpe) __ATTR_SENTINEL __ATTR_NONNULL((2)) __pid_t
...
#endif /* ((defined(__CRT_HAVE_wspawnvpe) && __SIZEOF_WCHAR_T__ == 2) || (defined(__CRT_HAVE__wspawnvpe) && __SIZEOF_WCHAR_T__ == 2) || defined(__CRT_HAVE_DOS$_wspawnvpe) || defined(__CRT_HAVE_DOS$_wspawnvpe)) */
