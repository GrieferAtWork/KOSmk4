...
#include <__crt.h>
#if (defined(__CRT_HAVE_wexecve) && (__SIZEOF_WCHAR_T__ == 2) && defined(__LIBCCALL_IS_LIBDCALL)) || defined(__CRT_HAVE_DOS$_wexecve)
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1, 2, 3)),int,__NOTHROW_RPC,__LIBDCALL,__localdep_c16execve,(__CHAR16_TYPE__ const *__restrict __path, __T16ARGV, __T16ENVP),wexecve,(__path,___argv,___envp))
...
#else /* (__CRT_HAVE_wexecve && (__SIZEOF_WCHAR_T__ == 2) && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_DOS$_wexecve */
#undef __local_c16execle_defined
#endif /* (!__CRT_HAVE_wexecve || !(__SIZEOF_WCHAR_T__ == 2) || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$_wexecve */
