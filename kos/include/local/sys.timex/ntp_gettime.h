...
#include <__crt.h>
#if defined(__CRT_HAVE_ntp_gettimex) || defined(__CRT_HAVE_ntp_gettimex64) || (defined(__CRT_HAVE_ntp_gettime) && (__SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__))
...
#else /* __CRT_HAVE_ntp_gettimex || __CRT_HAVE_ntp_gettimex64 || (__CRT_HAVE_ntp_gettime && (__SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)) */
#undef __local_ntp_gettime_defined
#endif /* !__CRT_HAVE_ntp_gettimex && !__CRT_HAVE_ntp_gettimex64 && (!__CRT_HAVE_ntp_gettime || !(__SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)) */
