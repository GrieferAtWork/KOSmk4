...
#if (defined(__CRT_HAVE__pipe) || defined(__CRT_HAVE_pipe))
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(pipe2))(__fd_t __pipedes[2],
                                                   __oflag_t __flags) {
#line 1112 "kos/src/libc/magic/unistd.c"
	(void)__flags;
	return __localdep_pipe(__pipedes);
}
__NAMESPACE_LOCAL_END
#endif /* (defined(__CRT_HAVE__pipe) || defined(__CRT_HAVE_pipe)) */
