...
__EXTERNINLINE __ATTR_CONST __ATTR_WUNUSED int __NOTHROW(__LIBCCALL __localdep_isblank)(int __ch) { return __builtin_isblank(__ch); }
...
#line 202 "kos/src/libc/magic/wctype.c"
