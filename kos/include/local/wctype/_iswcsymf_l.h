...
__CREDIRECT(__ATTR_WUNUSED __ATTR_PURE,int,__NOTHROW_NCX,__localdep_iswalpha_l,(__WINT_TYPE__ __wc, __locale_t __locale),__iswalpha_l,(__wc,__locale))
