...
__EXTERNINLINE __ATTR_CONST __ATTR_WUNUSED int __NOTHROW(__LIBCCALL __localdep_iswalnum)(__WINT_TYPE__ __wc) { return __builtin_iswalnum(__wc); }
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(iswalnum_l))(__WINT_TYPE__ __wc,
                                                        __locale_t __locale) {
#line 230 "kos/src/libc/magic/wctype.c"
	(void)__locale;
	__COMPILER_IMPURE();
