...
__EXTERNINLINE __ATTR_CONST __ATTR_WUNUSED int __NOTHROW(__LIBCCALL __localdep_iswprint)(__WINT_TYPE__ __wc) { return __builtin_iswprint(__wc); }
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(iswprint_l))(__WINT_TYPE__ __wc,
                                                        __locale_t __locale) {
#line 272 "kos/src/libc/magic/wctype.c"
	(void)__locale;
	__COMPILER_IMPURE();
