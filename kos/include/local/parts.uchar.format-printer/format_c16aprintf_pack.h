...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(format_c16aprintf_pack))(struct format_c16aprintf_data *__restrict __self, __SIZE_TYPE__ *__pstrlen) {
...
#undef __local_format_c16aprintf_pack_defined
