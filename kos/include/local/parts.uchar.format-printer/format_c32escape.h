...
#define __local_format_c32escape_defined 1
#include <__crt.h>
#include <kos/anno.h>
...
#define __escape_tooct(__c) ('0' + (__CHAR32_TYPE__)(unsigned char)(__c))
...
#if 4 == 1
		__ch = __localdep_unicode_readutf8_n((__CHAR32_TYPE__ const **)&__text, __textend);
#elif 4 == 2
...
#if 4 == 1
						__next_ch = __localdep_unicode_readutf8_n((__CHAR32_TYPE__ const **)&__new_text, __textend);
#elif 4 == 2
