...
(__LIBKCALL __LIBC_LOCAL_NAME(format_c32repeat))(__pc32formatprinter __printer, void *__arg, char __ch, __SIZE_TYPE__ __num_repetitions) __THROWS(...) {
