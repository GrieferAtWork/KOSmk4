...
#if 2 == 1
		__ch = __localdep_unicode_readutf8_n((__CHAR16_TYPE__ const **)&__text, __textend);
#elif 2 == 2
...
#if 2 == 1
						__next_ch = __localdep_unicode_readutf8_n((__CHAR16_TYPE__ const **)&__new_text, __textend);
#elif 2 == 2
