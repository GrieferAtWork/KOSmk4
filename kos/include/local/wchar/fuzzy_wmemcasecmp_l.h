 ...
 */
#ifndef __local_fuzzy_wmemcasecmp_l_defined
#if !defined(__NO_MALLOCA)
#define __local_fuzzy_wmemcasecmp_l_defined 1
...
__LOCAL_LIBC(fuzzy_wmemcasecmp_l) __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1, 3)) __SIZE_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(fuzzy_wmemcasecmp_l))(__WCHAR_TYPE__ const *__s1,
                                                                 __SIZE_TYPE__ __s1_bytes,
                                                                 __WCHAR_TYPE__ const *__s2,
                                                                 __SIZE_TYPE__ __s2_bytes,
                                                                 __locale_t __locale) {
#line 3858 "kos/src/libc/magic/string.c"
...
#endif
	for (__i = 0; __i < __s2_bytes; ++__i) __v0[__i] = __i;
...
#endif /* !__local_fuzzy_wmemcasecmp_l_defined */
