...
#define __localdep_c16stof (*(float(__LIBCCALL*)(__CHAR16_TYPE__ const *__restrict, __CHAR16_TYPE__ **))&(__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wcstof)))
#else /* LIBC: c16stof */
...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16stof_l))(__CHAR16_TYPE__ const *__restrict __nptr,
