...
#define __local_c32casecmp_defined 1
...
__LOCAL_LIBC(c32casecmp) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(c32casecmp))(__CHAR32_TYPE__ const *__s1,
                                                        __CHAR32_TYPE__ const *__s2) {
#line 800 "kos/src/libc/magic/string.c"
