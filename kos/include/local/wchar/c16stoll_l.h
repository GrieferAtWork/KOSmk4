...
#ifndef ____localdep_c16stoll_defined
#define ____localdep_c16stoll_defined 1
...
#define __localdep_c16stoll (*(__LONGLONG(__LIBCCALL*)(__CHAR16_TYPE__ const *__restrict, __CHAR16_TYPE__ **, int))&(__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wcstoll)))
#else /* LIBC: c16stoll */
#include <local/wchar/c16stoll.h>
#define __localdep_c16stoll (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(c16stoll))
#endif /* c16stoll... */
#endif /* !____localdep_c16stoll_defined */

__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(c16stoll_l) __ATTR_NONNULL((1)) __LONGLONG
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16stoll_l))(__CHAR16_TYPE__ const *__restrict __nptr,
