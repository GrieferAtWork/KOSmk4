...
#define __localdep_c16coll (*(int(__LIBCCALL*)(__CHAR16_TYPE__ const *, __CHAR16_TYPE__ const *))&(__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wcscoll)))
#else /* LIBC: c16coll */
...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16coll_l))(__CHAR16_TYPE__ const *__s1,
                                                       __CHAR16_TYPE__ const *__s2,
                                                       __locale_t __locale) {
#line 503 "kos/src/libc/magic/string.c"
	(void)__locale;
