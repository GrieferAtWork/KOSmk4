...
__LOCAL_LIBC(c32upr_l) __ATTR_RETNONNULL __ATTR_NONNULL((1)) __CHAR32_TYPE__ *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(c32upr_l))(__CHAR32_TYPE__ *__restrict __str,
                                                      __locale_t __locale) {
