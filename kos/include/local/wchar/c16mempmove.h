...
/* Same as `memmovew', but return `DST+N_WORDS', rather than `DST' */
__CREDIRECT(__ATTR_RETNONNULL __ATTR_NONNULL((1, 2)),__UINT16_TYPE__ *,__NOTHROW_NCX,__localdep_mempmovew,(void *__restrict __dst, void const *__restrict __src, __SIZE_TYPE__ __n_words),mempmovew,(__dst,__src,__n_words))
#else /* LIBC: mempmovew */
...
/* Same as `memmovew', but return `DST+N_DWORDS', rather than `DST' */
__CREDIRECT(__ATTR_RETNONNULL __ATTR_NONNULL((1, 2)),__UINT32_TYPE__ *,__NOTHROW_NCX,__localdep_mempmovel,(void *__restrict __dst, void const *__restrict __src, __SIZE_TYPE__ __n_dwords),mempmovel,(__dst,__src,__n_dwords))
#else /* LIBC: mempmovel */
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(c16mempmove))(__CHAR16_TYPE__ *__dst,
                                                         __CHAR16_TYPE__ const *__src,
                                                         __SIZE_TYPE__ __num_chars) {
#line 827 "kos/src/libc/magic/wchar.c"
#if 2 == 2
