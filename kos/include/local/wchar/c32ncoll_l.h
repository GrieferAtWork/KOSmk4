...
#define __localdep_c32ncoll (*(int(__LIBCCALL*)(__CHAR32_TYPE__ const *, __CHAR32_TYPE__ const *, __SIZE_TYPE__))&(__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wcsncoll)))
#else /* LIBC: c32ncoll */
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(c32ncoll_l))(__CHAR32_TYPE__ const *__s1,
                                                        ...
                                                        __locale_t __locale) {
#line 4685 "kos/src/libc/magic/string.c"
	(void)__locale;
