...
#ifndef ____localdep__vsnwscanf_s_l_defined
#define ____localdep__vsnwscanf_s_l_defined 1
...
#else /* LIBC: _vsnwscanf_s_l */
#include <local/wchar/_vsnwscanf_s_l.h>
#define __localdep__vsnwscanf_s_l (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_vsnwscanf_s_l))
#endif /* _vsnwscanf_s_l... */
#endif /* !____localdep__vsnwscanf_s_l_defined */

__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_snwscanf_s_l) __ATTR_WUNUSED __ATTR_NONNULL((1, 3)) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__VLIBCCALL __LIBC_LOCAL_NAME(_snwscanf_s_l))(__WCHAR_TYPE__ const *__src,
                                                            __SIZE_TYPE__ __bufsize,
                                                            __WCHAR_TYPE__ const *__format,
                                                            __locale_t __locale,
                                                            ...) {
#line 2169 "kos/src/libc/magic/wchar.c"
