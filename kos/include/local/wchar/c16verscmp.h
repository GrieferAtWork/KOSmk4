...
__LOCAL_LIBC(c16verscmp) __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1, 2)) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(c16verscmp))(__CHAR16_TYPE__ const *__s1,
