...
/* Same as wmemset, but return a pointer after the last written character */
#define __localdep_c16mempset (*(__CHAR16_TYPE__ *(__LIBCCALL*)(__CHAR16_TYPE__ *, __CHAR16_TYPE__, __SIZE_TYPE__))&(__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wmempset)))
