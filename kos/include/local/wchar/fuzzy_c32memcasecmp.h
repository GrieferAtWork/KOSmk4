...
#line 3693 "kos/src/libc/magic/string.c"
	...
	if (__s2_bytes > __s1_bytes) {
		{ __CHAR32_TYPE__ const *__temp = __s1; __s1 = __s2; __s2 = __temp; }
	...
	for (__i = 0; __i < __s1_bytes; ++__i) {
		...
		for (__j = 0; __j < __s2_bytes; __j++) {
			...
			__cost  = __c1 != __c2 && (__CHAR32_TYPE__)__localdep_towlower(__c1) != (__CHAR32_TYPE__)__localdep_towlower(__c2);
			__cost += __v0[__j];
			__temp  = __v1[__j]+1;
