...
__LOCAL_LIBC(wcsstr) __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1, 2)) __WCHAR_TYPE__ *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(wcsstr))(__WCHAR_TYPE__ const *__haystack,
