...
__CREDIRECT(__ATTR_LIBC_WPRINTF(1, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SIZE_T,__NOTHROW_NCX,__localdep_vc32printf,(__CHAR32_TYPE__ const *__restrict __format, __builtin_va_list __args),vwprintf,(__format,__args))
...
#define __localdep_vc32printf (*(__STDC_INT_AS_SIZE_T(__LIBCCALL*)(__CHAR32_TYPE__ const *__restrict, __builtin_va_list))&(__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(vwprintf)))
...
(__VLIBCCALL __LIBC_LOCAL_NAME(c32printf))(__CHAR32_TYPE__ const *__restrict __format,
                                           ...) __THROWS(...) {
#line 654 "kos/src/libc/magic/wchar.c"
