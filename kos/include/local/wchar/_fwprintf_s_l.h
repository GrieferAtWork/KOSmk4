...
#ifdef ___vfwprintf_s_l_defined
__NAMESPACE_GLB_USING(_vfwprintf_s_l)
#define __localdep__vfwprintf_s_l _vfwprintf_s_l
#elif defined(__CRT_HAVE__vfwprintf_s_l)
