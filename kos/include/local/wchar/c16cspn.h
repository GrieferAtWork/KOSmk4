...
__LOCAL_LIBC(c16cspn) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)) __SIZE_TYPE__
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16cspn))(__CHAR16_TYPE__ const *__haystack,
