...
__LOCAL_LIBC(fc16printf_unlocked) __ATTR_NONNULL((1, 2)) __ATTR_LIBC_WPRINTF(2, 3) __STDC_INT_AS_SIZE_T
(__VLIBCCALL __LIBC_LOCAL_NAME(fc16printf_unlocked))(__FILE *__restrict __stream,
