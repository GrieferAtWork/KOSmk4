...
#define __local_swprintf_s_defined 1
/* Dependency: "vswprintf_s" */
...
#else /* LIBC: vswprintf_s */
#undef ____localdep_vswprintf_s_defined
#endif /* vswprintf_s... */
#endif /* !____localdep_vswprintf_s_defined */

__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(swprintf_s) __ATTR_NONNULL((1, 3)) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__VLIBCCALL __LIBC_LOCAL_NAME(swprintf_s))(__WCHAR_TYPE__ *__dst,
                                                         __SIZE_TYPE__ __wchar_count,
                                                         __WCHAR_TYPE__ const *__format,
                                                         ...) {
#line 1699 "kos/src/libc/magic/wchar.c"
	__STDC_INT_AS_SSIZE_T __result;
	__builtin_va_list __args;
	__builtin_va_start(__args, __format);
	__result = __localdep_vswprintf_s(__dst, __wchar_count, __format, __args);
	__builtin_va_end(__args);
	return __result;
}
__NAMESPACE_LOCAL_END
#endif /* defined(__CRT_HAVE_vswprintf_s) */
