...
__LOCAL_LIBC(fuzzy_c16memcasecmp_l) __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1, 3)) __SIZE_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(fuzzy_c16memcasecmp_l))(__CHAR16_TYPE__ const *__s1,
...
#line 3858 "kos/src/libc/magic/string.c"
	...
	if (__s2_bytes > __s1_bytes) {
		{ __CHAR16_TYPE__ const *__temp = __s1; __s1 = __s2; __s2 = __temp; }
