...
__LOCAL_LIBC(wcslwr_l) __ATTR_RETNONNULL __ATTR_NONNULL((1)) __WCHAR_TYPE__ *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(wcslwr_l))(__WCHAR_TYPE__ *__restrict __str,
                                                      __locale_t __locale) {
#line 4141 "kos/src/libc/magic/string.c"
