...
#define __localdep_c16stod (*(double(__LIBCCALL*)(__CHAR16_TYPE__ const *__restrict, __CHAR16_TYPE__ **))&(__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wcstod)))
#else /* LIBC: c16stod */
