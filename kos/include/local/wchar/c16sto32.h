...
__LOCAL_LIBC(c16sto32) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1)) __INT32_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(c16sto32))(__CHAR16_TYPE__ const *__restrict __nptr,
