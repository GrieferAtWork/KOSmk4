...
__LOCAL_LIBC(wcsnrchr) __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)) __WCHAR_TYPE__ *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(wcsnrchr))(__WCHAR_TYPE__ const *__restrict __haystack,
