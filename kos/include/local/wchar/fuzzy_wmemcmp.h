...
#define __local_fuzzy_wmemcmp_defined 1
...
__LOCAL_LIBC(fuzzy_wmemcmp) __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1, 3)) __SIZE_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(fuzzy_wmemcmp))(__WCHAR_TYPE__ const *__s1,
                                                           __SIZE_TYPE__ __s1_chars,
                                                           __WCHAR_TYPE__ const *__s2,
                                                           __SIZE_TYPE__ __s2_chars) {
#line 1323 "kos/src/libc/magic/wchar.c"
...
#else
	return __localdep_fuzzy_memcmp(__s1, __s1_chars * sizeof(__WCHAR_TYPE__), __s2, __s2_chars * sizeof(__WCHAR_TYPE__));
#endif
}
