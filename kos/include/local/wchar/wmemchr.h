...
#define __localdep_memchrl __LIBC_FAST_NAME(memchrl)
...
#define __localdep_memchrw __LIBC_FAST_NAME(memchrw)
...
#define __localdep_memchr __LIBC_FAST_NAME(memchr)
