...
#define __local_c16rchr_defined 1
__NAMESPACE_LOCAL_BEGIN
/* Return the pointer of the last instance of `NEEDLE', or `NULL' if `NEEDLE' wasn't found. */
__LOCAL_LIBC(c16rchr) __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)) __CHAR16_TYPE__ *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(c16rchr))(__CHAR16_TYPE__ const *__restrict __haystack,
