...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16nrchr))(__CHAR16_TYPE__ const *__restrict __haystack,
                                                      __CHAR16_TYPE__ __needle,
                                                      __SIZE_TYPE__ __maxlen) {
#line 2565 "kos/src/libc/magic/string.c"
