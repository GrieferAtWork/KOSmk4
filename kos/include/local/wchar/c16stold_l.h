...
#define __localdep_c16stold (*(__LONGDOUBLE(__LIBCCALL*)(__CHAR16_TYPE__ const *__restrict, __CHAR16_TYPE__ **))&(__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wcstold)))
#else /* LIBC: c16stold */
