...
#define __local_c16lwr_l_defined 1
...
__LOCAL_LIBC(c16lwr_l) __ATTR_RETNONNULL __ATTR_NONNULL((1)) __CHAR16_TYPE__ *
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16lwr_l))(__CHAR16_TYPE__ *__restrict __str,
                                                      __locale_t __locale) {
