...
#define __localdep_c16stou32 (*(__UINT32_TYPE__(__LIBCCALL*)(__CHAR16_TYPE__ const *__restrict, __CHAR16_TYPE__ **, int))&(__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wcstou32)))
#else /* LIBC: c16stou32 */
