...
#ifndef ____localdep_vc16printf_unlocked_defined
#define ____localdep_vc16printf_unlocked_defined 1
#if defined(__CRT_HAVE_vwprintf_unlocked) && (__SIZEOF_WCHAR_T__ == 2)
__CREDIRECT(__ATTR_NONNULL((1)) __ATTR_LIBC_WPRINTF(1, 0),__STDC_INT_AS_SIZE_T,__NOTHROW_NCX,__localdep_vc16printf_unlocked,(__CHAR16_TYPE__ const *__restrict __format, __builtin_va_list __args),vwprintf_unlocked,(__format,__args))
#elif defined(__CRT_HAVE_DOS$vwprintf_unlocked)
__CREDIRECT_DOS(__ATTR_NONNULL((1)) __ATTR_LIBC_WPRINTF(1, 0),__STDC_INT_AS_SIZE_T,__NOTHROW_NCX,__localdep_vc16printf_unlocked,(__CHAR16_TYPE__ const *__restrict __format, __builtin_va_list __args),vwprintf_unlocked,(__format,__args))
...
#undef ____localdep_vc16printf_unlocked_defined
#endif /* vc16printf_unlocked... */
#endif /* !____localdep_vc16printf_unlocked_defined */

__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(c16printf_unlocked) __ATTR_NONNULL((1)) __ATTR_LIBC_WPRINTF(1, 2) __STDC_INT_AS_SIZE_T
(__VLIBDCALL __LIBC_LOCAL_NAME(c16printf_unlocked))(__CHAR16_TYPE__ const *__restrict __format,
                                                    ...) __THROWS(...) {
#line 1192 "kos/src/libc/magic/wchar.c"
