...
__EXTERNINLINE __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_ALLOC_SIZE((1, 2)) void *__NOTHROW_NCX(__LIBCCALL __localdep_calloc)(__SIZE_TYPE__ __count, __SIZE_TYPE__ __num_bytes) { return __builtin_calloc(__count, __num_bytes); }
...
#line 330 "kos/src/libc/magic/search.c"
	typedef struct {
		unsigned int __used;
		ENTRY        __entry;
	} __entry_type;
