...
#include <__crt.h>
#if defined(__CRT_HAVE_hcreate_r) || defined(__CRT_HAVE_calloc) || defined(__CRT_HAVE_malloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE_memalign) || defined(__CRT_HAVE_aligned_alloc) || defined(__CRT_HAVE_posix_memalign)
...
#else /* __CRT_HAVE_hcreate_r || __CRT_HAVE_calloc || __CRT_HAVE_malloc || __CRT_HAVE_realloc || __CRT_HAVE_memalign || __CRT_HAVE_aligned_alloc || __CRT_HAVE_posix_memalign */
#undef __local_hcreate_defined
#endif /* !__CRT_HAVE_hcreate_r && !__CRT_HAVE_calloc && !__CRT_HAVE_malloc && !__CRT_HAVE_realloc && !__CRT_HAVE_memalign && !__CRT_HAVE_aligned_alloc && !__CRT_HAVE_posix_memalign */
