...
#if (defined(__CRT_HAVE_open) || defined(__CRT_HAVE__open))
...
__NOTHROW_RPC(__VLIBCCALL __LIBC_LOCAL_NAME(open64))(char const *__filename,
                                                     __oflag_t __oflags,
                                                     ...) {
#line 226 "kos/src/libc/magic/fcntl.c"
	__fd_t __result;
...
#endif /* (defined(__CRT_HAVE_open) || defined(__CRT_HAVE__open)) */
