...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(__memmovedownc_chk))(void *__dst,
                                                                void const *__src,
...
#line 69 "kos/src/libc/magic/ssp.string.c"
	(void)__dst_objsize;
	__ssp_chk_dstbuf("__memmovedownc_chk", __dst, __elem_count * __elem_size, __dst_objsize);
