...
#ifndef ____localdep_c32tou32_defined
#define ____localdep_c32tou32_defined 1
#if defined(__CRT_HAVE_wcstou32) && (__SIZEOF_WCHAR_T__ == 4)
__CREDIRECT(__ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1)),__UINT32_TYPE__,__NOTHROW_NCX,__localdep_c32tou32,(__CHAR32_TYPE__ const *__restrict __nptr, __CHAR32_TYPE__ **__endptr, int __base),wcstou32,(__nptr,__endptr,__base))
#elif __SIZEOF_WCHAR_T__ == 4
#include <local/wchar/wcstou32.h>
#define __localdep_c32tou32(nptr, endptr, base) (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wcstou32))((__WCHAR_TYPE__ const *)(nptr), (__WCHAR_TYPE__ **)(endptr), base)
#else /* LIBC: c32tou32 */
#include <local/wchar/c32tou32.h>
#define __localdep_c32tou32 (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(c32tou32))
#endif /* c32tou32... */
#endif /* !____localdep_c32tou32_defined */
...
__LOCAL_LIBC(c32toumax) __ATTR_PURE __ATTR_NONNULL((1)) __UINTMAX_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(c32toumax))(__CHAR32_TYPE__ const *__restrict __nptr,
                                                       __CHAR32_TYPE__ **__endptr,
                                                       int __base) {
#line 276 "kos/src/libc/magic/inttypes.c"
#if __SIZEOF_INTMAX_T__ <= 4
	return (__UINTMAX_TYPE__)__localdep_c32tou32(__nptr, __endptr, __base);
#else
	return (__UINTMAX_TYPE__)__localdep_c32tou64(__nptr, __endptr, __base);
#endif
}
