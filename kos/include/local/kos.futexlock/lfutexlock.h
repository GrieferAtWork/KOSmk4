...
__CREDIRECT(__ATTR_NONNULL((1, 2, 3)),__SSIZE_TYPE__,__NOTHROW_RPC,__localdep_lfutexlock32,(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, __uintptr_t *__uaddr, __syscall_ulong_t __command, __uintptr_t __val, /*struct timespec const *timeout, lfutex_t val2*/...),lfutexlock,(__ulockaddr,__uaddr,__uaddr,__command,__val,))
...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(lfutexlock))(__uintptr_t *__ulockaddr,
                                                        __uintptr_t *__uaddr,
                                                        __syscall_ulong_t __command,
                                                        __uintptr_t __val,
                                                        /*struct timespec const *timeout, lfutex_t val2*/...) {
#line 77 "kos/src/libc/magic/kos.futexlock.c"
	...
	if (!LFUTEX_USES_TIMEOUT(__command))
		return __localdep_lfutexlock32(__ulockaddr, __uaddr, __command, __val);
	...
	if (!__timeout)
		return __localdep_lfutexlock32(__ulockaddr, __uaddr, __command, __val, (struct __timespec32 *)__NULLPTR, __val2);
	__tms32.tv_sec  = (__time32_t)__timeout->tv_sec;
	__tms32.tv_nsec = __timeout->tv_nsec;
	return __localdep_lfutexlock32(__ulockaddr, __uaddr, __command, __val, &__tms32, __val2);
	...
	if (!LFUTEX_USES_TIMEOUT(__command))
		return __localdep_lfutexlock64(__ulockaddr, __uaddr, __command, __val);
	__builtin_va_start(__args, __val);
	__timeout = __builtin_va_arg(__args, struct __timespec32 *);
	__val2 = __builtin_va_arg(__args, __uintptr_t);
	__builtin_va_end(__args);
	if (!__timeout)
		return __localdep_lfutexlock64(__ulockaddr, __uaddr, __command, __val, (struct __timespec64 *)__NULLPTR, __val2);
	__tms64.tv_sec  = (__time64_t)__timeout->tv_sec;
	__tms64.tv_nsec = __timeout->tv_nsec;
	return __localdep_lfutexlock64(__ulockaddr, __uaddr, __command, __val, &__tms64, __val2);
