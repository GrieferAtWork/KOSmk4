...
#line 82 "kos/src/libc/magic/kos.futexlock.c"
	...
	__builtin_va_end(__args);
	if (!__timeout || !LFUTEX_USES_TIMEOUT(__futex_op))
		return __localdep_lfutexlock64(__ulockaddr, __uaddr, __futex_op, __val, (struct __timespec64 *)__NULLPTR, __val2);
