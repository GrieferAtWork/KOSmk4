...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaituntil64))(__uintptr_t *__ulockaddr,
                                                                        __uintptr_t *__uaddr,
                                                                        __uintptr_t __not_equal_to_value,
                                                                        struct __timespec64 const *__rel_timeout) {
#line 466 "kos/src/libc/magic/kos.futexlock.c"
