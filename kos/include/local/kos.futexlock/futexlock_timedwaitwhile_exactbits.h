...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_exactbits))(__uintptr_t *__ulockaddr,
                                                                                __uintptr_t *__uaddr,
                                                                                __uintptr_t __bitmask,
                                                                                __uintptr_t __setmask,
                                                                                struct __TM_TYPE(timespec) const *__rel_timeout) {
#line 353 "kos/src/libc/magic/kos.futexlock.c"
