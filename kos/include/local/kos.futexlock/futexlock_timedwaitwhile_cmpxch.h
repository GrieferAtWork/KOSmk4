...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_cmpxch))(__uintptr_t *__ulockaddr,
                                                                             __uintptr_t *__uaddr,
                                                                             __uintptr_t __old_value,
                                                                             __uintptr_t __new_value,
                                                                             struct timespec const *__rel_timeout) {
#line 380 "kos/src/libc/magic/kos.futexlock.c"
