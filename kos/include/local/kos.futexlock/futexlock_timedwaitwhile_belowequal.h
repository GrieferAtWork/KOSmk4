...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_belowequal))(__uintptr_t *__ulockaddr,
                                                                                 __uintptr_t *__uaddr,
                                                                                 __uintptr_t __below_equal_value,
                                                                                 struct timespec const *__rel_timeout) {
#line 368 "kos/src/libc/magic/kos.futexlock.c"
