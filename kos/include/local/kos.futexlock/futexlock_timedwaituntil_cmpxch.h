...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaituntil_cmpxch))(__uintptr_t *__ulockaddr,
                                                                             __uintptr_t *__uaddr,
                                                                             __uintptr_t __old_value,
                                                                             __uintptr_t __new_value,
                                                                             struct __TM_TYPE(timespec) const *__rel_timeout) {
#line 391 "kos/src/libc/magic/kos.futexlock.c"
