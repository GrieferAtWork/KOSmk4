...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_waitwhile_exactbits))(__uintptr_t *__ulockaddr,
                                                                           __uintptr_t *__uaddr,
                                                                           __uintptr_t __bitmask,
                                                                           __uintptr_t __setmask) {
#line 259 "kos/src/libc/magic/kos.futexlock.c"
