...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_allbits64))(__uintptr_t *__ulockaddr,
                                                                                __uintptr_t *__uaddr,
                                                                                __uintptr_t __bitmask,
                                                                                struct __timespec64 const *__rel_timeout) {
#line 574 "kos/src/libc/magic/kos.futexlock.c"
	return __localdep_lfutexlock64(__ulockaddr, __uaddr, LFUTEX_WAIT_WHILE_BITMASK, __bitmask, __rel_timeout, __bitmask);
}
