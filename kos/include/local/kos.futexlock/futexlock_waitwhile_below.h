...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_waitwhile_below))(__uintptr_t *__ulockaddr,
                                                                       __uintptr_t *__uaddr,
                                                                       __uintptr_t __below_value) {
#line 190 "kos/src/libc/magic/kos.futexlock.c"
