...
#line 144 "kos/src/libc/magic/kos.futexlock.c"
	if (__hybrid_atomic_xch(*__ulockaddr, 0, __ATOMIC_SEQ_CST) == 0)
		return 0; /* No waiting threads. */
	return __localdep_lfutex64(__ulockaddr, LFUTEX_WAKE, __max_wake);
}
