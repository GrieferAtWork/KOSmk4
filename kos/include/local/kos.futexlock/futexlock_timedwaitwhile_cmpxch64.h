...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_cmpxch64))(__uintptr_t *__ulockaddr,
                                                                               __uintptr_t *__uaddr,
                                                                               __uintptr_t __old_value,
                                                                               __uintptr_t __new_value,
                                                                               struct __timespec64 const *__rel_timeout) {
#line 523 "kos/src/libc/magic/kos.futexlock.c"
