...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_waitwhile_anybit))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, __uintptr_t __bitmask) {
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futexlock_waitwhile_anybit_defined
#define __local___localdep_futexlock_waitwhile_anybit_defined 1
#define __localdep_futexlock_waitwhile_anybit __LIBC_LOCAL_NAME(futexlock_waitwhile_anybit)
#endif /* !__local___localdep_futexlock_waitwhile_anybit_defined */
#else /* __CRT_HAVE_lfutexlock64 || __CRT_HAVE_lfutexlock */
#undef __local_futexlock_waitwhile_anybit_defined
