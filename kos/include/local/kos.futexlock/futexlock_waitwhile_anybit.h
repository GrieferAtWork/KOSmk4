 ...
 */
#ifndef __local_futexlock_waitwhile_anybit_defined
#if defined(__CRT_HAVE_lfutexlock) || defined(__CRT_HAVE_lfutexlock64)
#define __local_futexlock_waitwhile_anybit_defined 1
...
__LOCAL_LIBC(futexlock_waitwhile_anybit) __ATTR_NONNULL((1, 2)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_waitwhile_anybit))(__uintptr_t *__ulockaddr,
                                                                        __uintptr_t *__uaddr,
                                                                        __uintptr_t __bitmask) {
#line 272 "kos/src/libc/magic/kos.futexlock.c"
	return __localdep_lfutexlock64(__ulockaddr, __uaddr, LFUTEX_WAIT_UNTIL_BITMASK, __bitmask, (struct __timespec64 const *)__NULLPTR, 0);
}
__NAMESPACE_LOCAL_END
#endif /* __CRT_HAVE_lfutexlock || __CRT_HAVE_lfutexlock64 */
#endif /* !__local_futexlock_waitwhile_anybit_defined */
