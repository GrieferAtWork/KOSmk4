 ...
 */
#ifndef __local_futexlock_waituntil_defined
#if defined(__CRT_HAVE_lfutexlock64) || defined(__CRT_HAVE_lfutexlock)
#define __local_futexlock_waituntil_defined 1
...
__LOCAL_LIBC(futexlock_waituntil) __ATTR_NONNULL((1, 2)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_waituntil))(__uintptr_t *__ulockaddr,
                                                                 __uintptr_t *__uaddr,
                                                                 __uintptr_t __not_equal_to_value) {
#line 180 "kos/src/libc/magic/kos.futexlock.c"
	return __localdep_lfutexlock64(__ulockaddr, __uaddr, LFUTEX_WAIT_UNTIL, __not_equal_to_value, (struct __timespec64 const *)__NULLPTR);
}
__NAMESPACE_LOCAL_END
#endif /* defined(__CRT_HAVE_lfutexlock64) || defined(__CRT_HAVE_lfutexlock) */
#endif /* !__local_futexlock_waituntil_defined */
