...
#line 226 "kos/src/libc/magic/kos.futexlock.c"
	return __localdep_lfutexlock64(__ulockaddr, __uaddr, LFUTEX_WAIT_UNTIL_BITMASK, __bitmask, (struct __timespec64 *)__NULLPTR, __setmask);
}
