...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_waitwhile_belowequal))(__uintptr_t *__ulockaddr,
                                                                            __uintptr_t *__uaddr,
                                                                            __uintptr_t __below_equal_value) {
#line 195 "kos/src/libc/magic/kos.futexlock.c"
	...
	return __localdep_lfutexlock64(__ulockaddr, __uaddr, LFUTEX_WAIT_WHILE_BELOW, __below_equal_value + 1, (struct __timespec64 *)__NULLPTR);
}
