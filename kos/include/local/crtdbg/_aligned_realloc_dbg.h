...
__CREDIRECT(__ATTR_WUNUSED __ATTR_ALLOC_ALIGN(3) __ATTR_ALLOC_SIZE((2)),void *,__NOTHROW_NCX,__localdep__aligned_realloc,(void *__mptr, __SIZE_TYPE__ __newsize, __SIZE_TYPE__ __min_alignment),_aligned_realloc,(__mptr,__newsize,__min_alignment))
...
__LOCAL_LIBC(_aligned_realloc_dbg) __ATTR_ALLOC_SIZE((2)) __ATTR_ALLOC_ALIGN(3) __ATTR_WUNUSED void *
