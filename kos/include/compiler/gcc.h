...
#define __ATTR_ACCESS_ROS(ptr_index, size_index) __attribute__((__nonnull__(ptr_index)))
...
#define __ATTR_ACCESS_RO_OPT(ptr_index)          __attribute__((__nonnull__(ptr_index)))
#define __ATTR_ACCESS_WR_OPT(ptr_index)          __attribute__((__nonnull__(ptr_index)))
#define __ATTR_ACCESS_RW_OPT(ptr_index)          __attribute__((__nonnull__(ptr_index)))
