...
#define SYS_rtm_test                __NR_rtm_test                /* syscall_slong_t rtm_test(void) */
...
#define SYS_rtm_begin               __NR_rtm_begin               /* syscall_slong_t rtm_begin(void) */
