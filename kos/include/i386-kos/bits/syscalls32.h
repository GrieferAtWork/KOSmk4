...
#define SYS_utimes64                __NR_utimes64                /* errno_t utimes64(char const *filename, struct __timeval64 const[2] times) */
/* @param: flags: Set of `0 | AT_DOSPATH' */
...
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW|AT_CHANGE_CTIME|AT_DOSPATH' */
#define SYS_futimesat64             __NR_futimesat64             /* errno_t futimesat64(fd_t dirfd, const char *filename, struct __timeval64 const[2] times) */
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW|AT_DOSPATH' */
...
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW | AT_CHANGE_CTIME | AT_DOSPATH' */
#define SYS_utimensat64             __NR_utimensat64             /* errno_t utimensat64(fd_t dirfd, char const *filename, struct __timespec64 const[2] times, atflag_t flags) */
