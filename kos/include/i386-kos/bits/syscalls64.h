...
#define SYS_statfs                   __NR_statfs                   /* errno_t statfs(char const *file, struct statfsx64 *buf) */
#define SYS_fstatfs                  __NR_fstatfs                  /* errno_t fstatfs(fd_t file, struct statfsx64 *buf) */
...
#define SYS_coredump                 __NR_coredump                 /* errno_t coredump(struct ucpustate64 const *curr_state, struct ucpustate64 const *orig_state, __HYBRID_PTR64(void const) const *traceback_vector, size_t traceback_length, union coredump_info64 const *reason, unwind_errno_t unwind_error) */
