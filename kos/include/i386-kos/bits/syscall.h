...
#define SYS_lchown                  __NR_lchown                  /* errno_t lchown(char const *filename, uint32_t owner, uint32_t group) || errno_t lchown(char const *filename, uint16_t owner, uint16_t group) */
...
#define SYS_pipe                    __NR_pipe                    /* errno_t pipe([2]fd_t *pipedes) */
...
#define SYS_fchown                  __NR_fchown                  /* errno_t fchown(fd_t fd, uint32_t owner, uint32_t group) || errno_t fchown(fd_t fd, uint16_t owner, uint16_t group) */
...
#define SYS_clone                   __NR_clone                   /* pid_t clone(syscall_ulong_t flags, void *child_stack, pid_t *ptid, uintptr_t newtls, pid_t *ctid) || pid_t clone(syscall_ulong_t flags, void *child_stack, pid_t *ptid, pid_t *ctid, uintptr_t newtls) */
...
#define SYS_utimes                  __NR_utimes                  /* errno_t utimes(char const *filename, [2]struct __timeval32 const *times) */
/* @param: options: At least one of `WEXITED|WSTOPPED|WCONTINUED', optionally or'd with `WNOHANG|WNOWAIT' */
#define SYS_waitid                  __NR_waitid                  /* errno_t waitid(idtype_t idtype, id_t id, struct __siginfo_struct *infop, syscall_ulong_t options, struct rusage *ru) */
...
#define SYS_fchownat                __NR_fchownat                /* errno_t fchownat(fd_t dirfd, char const *filename, uint32_t owner, uint32_t group, atflag_t flags) */
#define SYS_futimesat               __NR_futimesat               /* errno_t futimesat(fd_t dirfd, const char *filename, [2]struct __timeval32 const *times) */
...
#define SYS_pipe2                   __NR_pipe2                   /* errno_t pipe2([2]fd_t *pipedes, oflag_t flags) */
...
#define SYS_socketpair              __NR_socketpair              /* errno_t socketpair(syscall_ulong_t domain, syscall_ulong_t type, syscall_ulong_t protocol, [2]fd_t *fds) */
...
#define SYS_lfutexexpr              __NR_lfutexexpr              /* errno_t lfutexexpr(uintptr_t *uaddr, void *base, struct lfutexexpr const *exprv, size_t exprc, struct __timespec64 const *timeout, syscall_ulong_t timeout_flags) */
#define SYS_lfutexlockexpr          __NR_lfutexlockexpr          /* errno_t lfutexlockexpr(uintptr_t *ulockaddr, void *base, struct lfutexexpr const *exprv, size_t exprc, struct __timespec64 const *timeout, syscall_ulong_t timeout_flags) */
...
#define SYS_gettimeofday64          __NR_gettimeofday64          /* errno_t gettimeofday64(struct __timeval64 *tv, struct timezone *tz) */
#define SYS_settimeofday64          __NR_settimeofday64          /* errno_t settimeofday64(struct __timeval64 const *tv, struct timezone const *tz) */
#define SYS_select64                __NR_select64                /* ssize_t select64(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct __timeval64 *timeout) */
...
#define SYS_utimes64                __NR_utimes64                /* errno_t utimes64(char const *filename, [2]struct __timeval64 const *times) */
/* @param: flags: Set of `0|AT_DOSPATH' */
...
/* @param: flags: Set of `0|AT_SYMLINK_NOFOLLOW|AT_CHANGE_CTIME|AT_DOSPATH' */
#define SYS_futimesat64             __NR_futimesat64             /* errno_t futimesat64(fd_t dirfd, const char *filename, [2-3]struct __timeval64 const *times) */
/* @param: flags: Set of `0|AT_SYMLINK_NOFOLLOW|AT_DOSPATH' */
...
#define SYS_fstatat                 __NR_fstatat                 /* errno_t fstatat(fd_t dirfd, char const *filename, struct linux64_stat32 *statbuf, atflag_t flags) */
#else /* __x86_64__ */
...
#define SYS_lseek                   __NR_lseek                   /* int32_t lseek(fd_t fd, int32_t offset, syscall_ulong_t whence) */
...
#define SYS_sigreturn               __NR_sigreturn               /* void sigreturn(struct fpustate const *restore_fpu, syscall_ulong_t unused1, syscall_ulong_t unused2, struct __sigset_struct const *restore_sigmask, struct rpc_syscall_info *sc_info, struct ucpustate const *restore_cpu) */
/* @param: how: One of `SIG_BLOCK', `SIG_UNBLOCK' or `SIG_SETMASK' */
...
#define SYS_sched_rr_get_interval64 __NR_sched_rr_get_interval64 /* errno_t sched_rr_get_interval64(pid_t pid, struct __timespec64 *tms) */
#define SYS_nanosleep64             __NR_nanosleep64             /* errno_t nanosleep64(struct __timespec64 const *req, struct __timespec64 *rem) */
#define SYS_rt_sigtimedwait64       __NR_rt_sigtimedwait64       /* syscall_slong_t rt_sigtimedwait64(struct __sigset_struct const *set, struct __siginfo_struct *info, struct __timespec64 const *timeout, size_t sigsetsize) */
#define SYS_timer_settime64         __NR_timer_settime64         /* errno_t timer_settime64(timer_t timerid, syscall_ulong_t flags, struct __itimerspec64 const *value, struct __itimerspec64 *ovalue) */
#define SYS_timer_gettime64         __NR_timer_gettime64         /* errno_t timer_gettime64(timer_t timerid, struct __itimerspec64 *value) */
#define SYS_clock_settime64         __NR_clock_settime64         /* errno_t clock_settime64(clockid_t clock_id, struct __timespec64 const *tp) */
#define SYS_clock_gettime64         __NR_clock_gettime64         /* errno_t clock_gettime64(clockid_t clock_id, struct __timespec64 *tp) */
#define SYS_clock_getres64          __NR_clock_getres64          /* errno_t clock_getres64(clockid_t clock_id, struct __timespec64 *res) */
#define SYS_clock_nanosleep64       __NR_clock_nanosleep64       /* errno_t clock_nanosleep64(clockid_t clock_id, syscall_ulong_t flags, struct __timespec64 const *requested_time, struct __timespec64 *remaining) */
#define SYS_pselect6_64             __NR_pselect6_64             /* ssize_t pselect6_64(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct __timespec64 const *timeout, void const *sigmask_sigset_and_len) */
#define SYS_ppoll64                 __NR_ppoll64                 /* ssize_t ppoll64(struct pollfd *fds, size_t nfds, struct __timespec64 const *timeout_ts, struct __sigset_struct const *sigmask, size_t sigsetsize) */
/* @param: flags: Set of `0|AT_SYMLINK_NOFOLLOW|AT_CHANGE_CTIME|AT_DOSPATH' */
#define SYS_utimensat64             __NR_utimensat64             /* errno_t utimensat64(fd_t dirfd, char const *filename, [2-3]struct __timespec64 const *times, atflag_t flags) */
/* Set next expiration time of interval timer source UFD to UTMR.
 * If FLAGS has the TFD_TIMER_ABSTIME flag set the timeout value
 * is absolute. Optionally return the old expiration time in OTMR */
#define SYS_timerfd_settime64       __NR_timerfd_settime64       /* errno_t timerfd_settime64(fd_t ufd, syscall_ulong_t flags, struct __itimerspec64 const *utmr, struct __itimerspec64 *otmr) */
/* Return the next expiration time of UFD */
#define SYS_timerfd_gettime64       __NR_timerfd_gettime64       /* errno_t timerfd_gettime64(fd_t ufd, struct __itimerspec64 *otmr) */
#define SYS_recvmmsg64              __NR_recvmmsg64              /* ssize_t recvmmsg64(fd_t sockfd, struct mmsghdr *vmessages, size_t vlen, syscall_ulong_t flags, struct __timespec64 *tmo) */
#endif /* !__x86_64__ */
