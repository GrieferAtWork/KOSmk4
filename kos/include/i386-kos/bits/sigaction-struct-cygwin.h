...
#define __OFFSET_SIGACTION_CYGWIN_MASK      4
#define __OFFSET_SIGACTION_CYGWIN_FLAGS     132
#define __SIZEOF_SIGACTION_CYGWIN           136
#define __ALIGNOF_SIGACTION_CYGWIN          4
