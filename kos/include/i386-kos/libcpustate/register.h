...
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PGETREG_SGREGS)(struct sgregs const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PSETREG_SGREGS)(struct sgregs *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PGETREG_COREGS)(struct coregs const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PSETREG_COREGS)(struct coregs *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PGETREG_DRREGS)(struct drregs const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PSETREG_DRREGS)(struct drregs *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PGETREG_UCPUSTATE)(struct ucpustate const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PSETREG_UCPUSTATE)(struct ucpustate *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PGETREG_LCPUSTATE)(struct lcpustate const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PSETREG_LCPUSTATE)(struct lcpustate *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PGETREG_KCPUSTATE)(struct kcpustate const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PSETREG_KCPUSTATE)(struct kcpustate *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PGETREG_FCPUSTATE)(struct fcpustate const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PSETREG_FCPUSTATE)(struct fcpustate *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PGETREG_SFPUENV)(struct sfpuenv const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PSETREG_SFPUENV)(struct sfpuenv *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PGETREG_SFPUSTATE)(struct sfpustate const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PSETREG_SFPUSTATE)(struct sfpustate *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PGETREG_XFPUSTATE)(struct xfpustate const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PSETREG_XFPUSTATE)(struct xfpustate *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen);
...
#ifdef __x86_64__
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PGETREG_GPREGSNSP)(struct gpregsnsp const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PSETREG_GPREGSNSP)(struct gpregsnsp *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PGETREG_SGBASE)(struct sgbase const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PSETREG_SGBASE)(struct sgbase *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen);
#ifdef LIBCPUSTATE_WANT_PROTOTYPES
...
#ifndef __KERNEL__
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PGETREG_MCONTEXT)(struct mcontext const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PSETREG_MCONTEXT)(struct mcontext *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PGETREG_UCONTEXT)(struct ucontext const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen);
typedef __ATTR_NONNULL((1)) __size_t /*__NOTHROW_NCX*/(LIBCPUSTATE_CC *PSETREG_UCONTEXT)(struct ucontext *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen);
#ifdef LIBCPUSTATE_WANT_PROTOTYPES
...
#ifdef LIBCPUSTATE_WANT_PROTOTYPES
extern "C++" {
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct gpregs const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_gpregs,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,setreg,(struct gpregs const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),setreg_gpregs,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct sgregs const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_sgregs,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,setreg,(struct sgregs *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen),setreg_sgregs,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct coregs const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_coregs,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,setreg,(struct coregs *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen),setreg_coregs,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct drregs const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_drregs,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,setreg,(struct drregs *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen),setreg_drregs,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct ucpustate const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_ucpustate,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,setreg,(struct ucpustate *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen),setreg_ucpustate,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct lcpustate const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_lcpustate,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,setreg,(struct lcpustate *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen),setreg_lcpustate,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct kcpustate const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_kcpustate,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,setreg,(struct kcpustate *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen),setreg_kcpustate,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct fcpustate const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_fcpustate,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,setreg,(struct fcpustate *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen),setreg_fcpustate,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct sfpuenv const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_sfpuenv,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,setreg,(struct sfpuenv *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen),setreg_sfpuenv,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct sfpustate const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_sfpustate,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,setreg,(struct sfpustate *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen),setreg_sfpustate,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct xfpustate const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_xfpustate,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,setreg,(struct xfpustate *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen),setreg_xfpustate,(__self,__regno,__buf,__buflen))
#ifdef __x86_64__
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct gpregsnsp const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_gpregsnsp,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,setreg,(struct gpregsnsp *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen),setreg_gpregsnsp,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct sgbase const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_sgbase,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,setreg,(struct sgbase *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen),setreg_sgbase,(__self,__regno,__buf,__buflen))
#endif /* __x86_64__ */
#ifndef __KERNEL__
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct mcontext const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_mcontext,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,setreg,(struct mcontext *__restrict __self, unsigned int __regno, void const *__restrict __buf, __size_t __buflen),setreg_mcontext,(__self,__regno,__buf,__buflen))
__REDIRECT(LIBCPUSTATE_DECL,__ATTR_NONNULL((1)),__size_t,__NOTHROW_NCX,LIBCPUSTATE_CC,getreg,(struct ucontext const *__restrict __self, unsigned int __regno, void *__restrict __buf, __size_t __buflen),getreg_ucontext,(__self,__regno,__buf,__buflen))
