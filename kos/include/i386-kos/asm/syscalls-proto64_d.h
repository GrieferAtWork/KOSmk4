...
#define __NR64RT_linux_stat64           (errno_t, __errno_t)
#define __NR64RT_linux_fstat64          (errno_t, __errno_t)
#define __NR64RT_linux_lstat64          (errno_t, __errno_t)
...
#define __NR64RT_ioprio_get             (errno_t, __errno_t)
...
#define __NR64RT_sysctl                 (syscall_slong_t, __syscall_slong_t)
...
#define __NR64AT0_linux_stat64           (char const *, char const *)
#define __NR64AT1_linux_stat64           (struct linux_stat64 *, struct linux_stat64 *)
#define __NR64AT0_linux_fstat64          (fd_t, __fd_t)
#define __NR64AT1_linux_fstat64          (struct linux_stat64 *, struct linux_stat64 *)
#define __NR64AT0_linux_lstat64          (char const *, char const *)
#define __NR64AT1_linux_lstat64          (struct linux_stat64 *, struct linux_stat64 *)
...
#define __NR64AT1_recvmsg                (struct msghdr *, struct msghdr *)
...
#define __NR64AT1_fcntl                  (syscall_ulong_t, __syscall_ulong_t)
...
#define __NR64AT1_getdents               (struct linux_dirent *, struct linux_dirent *)
...
#define __NR64AT1_sigaltstack            (struct sigaltstack *, struct sigaltstack *)
#define __NR64AT0_utime                  (char const *, char const *)
#define __NR64AT1_utime                  (struct __utimbuf32 const *, struct __utimbuf32 const *)
...
#define __NR64AT0_adjtimex               (int, int)
...
#define __NR64AT0_fremovexattr           (int, int)
...
#define __NR64AT3_faccessat              (atflag_t, __atflag_t)
...
#define __NR64AT4_name_to_handle_at      (syscall_ulong_t, __syscall_ulong_t)
#define __NR64AT0_open_by_handle_at      (fd_t, __fd_t)
#define __NR64AT1_open_by_handle_at      (struct file_handle *, struct file_handle *)
#define __NR64AT2_open_by_handle_at      (syscall_ulong_t, __syscall_ulong_t)
...
#define __NR64AT3_maplibrary             (void *, void *)
...
#define __NR64AM_adjtimex(a, b, c, d, e, f)               (int)a
...
#define __NR64AP_vserver(a)                               (__syscall_ulong_t)a
