...
#define __NR64AC_inotify_init             0
#define __NR64AC_inotify_add_watch        3
#define __NR64AC_inotify_rm_watch         2
...
#define __NR64AC_inotify_add_watch_at     5
...
#define __NR64RT_inotify_init             (fd_t, __fd_t)
#define __NR64RT_inotify_add_watch        (int, int)
...
#define __NR64RT_inotify_init1            (fd_t, __fd_t)
...
#define __NR64RT_inotify_add_watch_at     (int, int)
...
#define __NR64AT0_inotify_add_watch        (fd_t, __fd_t)
#define __NR64AT1_inotify_add_watch        (char const *, char const *)
#define __NR64AT2_inotify_add_watch        (uint32_t, __uint32_t)
#define __NR64AT0_inotify_rm_watch         (fd_t, __fd_t)
#define __NR64AT1_inotify_rm_watch         (int, int)
...
#define __NR64AT0_inotify_init1            (syscall_ulong_t, __syscall_ulong_t)
...
#define __NR64AT0_inotify_add_watch_at     (fd_t, __fd_t)
#define __NR64AT1_inotify_add_watch_at     (fd_t, __fd_t)
#define __NR64AT2_inotify_add_watch_at     (char const *, char const *)
#define __NR64AT3_inotify_add_watch_at     (atflag_t, __atflag_t)
#define __NR64AT4_inotify_add_watch_at     (uint32_t, __uint32_t)
...
#define __NR64AT5_coredump                 (unwind_errno_t, unwind_errno_t)
...
#define __NR64AM_inotify_init(a, b, c, d, e, f)             /* nothing */
#define __NR64AM_inotify_add_watch(a, b, c, d, e, f)        (__fd_t)a, (char const *)b, (__uint32_t)c
#define __NR64AM_inotify_rm_watch(a, b, c, d, e, f)         (__fd_t)a, (int)b
...
#define __NR64AM_inotify_init1(a, b, c, d, e, f)            (__syscall_ulong_t)a
...
#define __NR64AM_inotify_add_watch_at(a, b, c, d, e, f)     (__fd_t)a, (__fd_t)b, (char const *)c, (__atflag_t)d, (__uint32_t)e
...
#define __NR64AM_coredump(a, b, c, d, e, f)                 (struct ucpustate64 const *)a, (struct ucpustate64 const *)b, (__HYBRID_PTR64(void const) const *)c, (__size_t)d, (union coredump_info64 const *)e, (unwind_errno_t)f
...
#define __NR64AP_inotify_init()                             /* nothing */
#define __NR64AP_inotify_add_watch(a, b, c)                 (__syscall_ulong_t)a, (__syscall_ulong_t)b, (__syscall_ulong_t)c
#define __NR64AP_inotify_rm_watch(a, b)                     (__syscall_ulong_t)a, (__syscall_ulong_t)b
...
#define __NR64AP_inotify_add_watch_at(a, b, c, d, e)        (__syscall_ulong_t)a, (__syscall_ulong_t)b, (__syscall_ulong_t)c, (__syscall_ulong_t)d, (__syscall_ulong_t)e
