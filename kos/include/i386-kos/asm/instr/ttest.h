...
__ASM_L(		testb $(__ASM_ARG(\mask)), %\regname\()b)
__ASM_L(	.elseif (__ASM_ARG(\mask) <= 0xffff))
__ASM_L(		testw $(__ASM_ARG(\mask)), %\regname\()w)
__ASM_L(	.elseif (__ASM_ARG(\mask) <= 0xffffffff))
__ASM_L(		testl $(__ASM_ARG(\mask)), %\regname\()d)
__ASM_L(	.else)
...
#ifdef __x86_64__
__ASM_L(	.if (__ASM_ARG(\mask) <= 0xff))
__ASM_L(		testb $(__ASM_ARG(\mask)), %\regname\()l)
__ASM_L(	.elseif (__ASM_ARG(\mask) <= 0xffff))
#else /* __x86_64__ */
__ASM_L(	.if (__ASM_ARG(\mask) <= 0xffff))
#endif /* !__x86_64__ */
__ASM_L(		testw $(__ASM_ARG(\mask)), %\regname)
__ASM_L(	.elseif (__ASM_ARG(\mask) <= 0xffffffff))
__ASM_L(		testl $(__ASM_ARG(\mask)), %e\regname)
__ASM_L(	.else)
__ASM_L(		.error 'ttest: unsupported mask: \mask')
__ASM_L(	.endif)
__ASM_L(.else)
...
__ASM_L(			testb $((__ASM_ARG(\mask)) >> 8), %\regname\()h)
__ASM_L(		.else)
__ASM_L(			testw $(__ASM_ARG(\mask)), %\regname\()x)
__ASM_L(		.endif)
__ASM_L(	.elseif (__ASM_ARG(\mask) <= 0xffffffff))
__ASM_L(		testl $(__ASM_ARG(\mask)), %e\regname\()x)
__ASM_L(	.else)
__ASM_L(		.error 'ttest: unsupported mask: \mask')
__ASM_L(	.endif)
__ASM_L(.endif)
