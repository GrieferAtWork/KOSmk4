...
#define __NRRT_tuxcall                  (errno_t, __errno_t)
#define __NRRT_security                 (errno_t, __errno_t)
...
#define __NRAT1_stat                     (struct linux_statx64 *, struct linux_statx64 *)
#define __NRAT0_fstat                    (fd_t, __fd_t)
#define __NRAT1_fstat                    (struct linux_statx64 *, struct linux_statx64 *)
#define __NRAT0_lstat                    (char const *, char const *)
#define __NRAT1_lstat                    (struct linux_statx64 *, struct linux_statx64 *)
...
#define __NRAT1_readv                    (struct iovecx64 const *, struct __iovecx64 const *)
#define __NRAT2_readv                    (size_t, __size_t)
#define __NRAT0_writev                   (fd_t, __fd_t)
#define __NRAT1_writev                   (struct iovecx64 const *, struct __iovecx64 const *)
...
#define __NRAT4_select                   (struct timevalx64 *, struct __timevalx64 *)
...
#define __NRAT0_nanosleep                (struct timespecx64 const *, struct __timespecx64 const *)
#define __NRAT1_nanosleep                (struct timespecx64 *, struct __timespecx64 *)
#define __NRAT0_getitimer                (syscall_ulong_t, __syscall_ulong_t)
#define __NRAT1_getitimer                (struct __itimervalx64 *, struct __itimervalx64 *)
#define __NRAT0_alarm                    (syscall_ulong_t, __syscall_ulong_t)
#define __NRAT0_setitimer                (syscall_ulong_t, __syscall_ulong_t)
#define __NRAT1_setitimer                (struct __itimervalx64 const *, struct __itimervalx64 const *)
#define __NRAT2_setitimer                (struct __itimervalx64 *, struct __itimervalx64 *)
...
#define __NRAT1_sendmsg                  (struct msghdrx64 const *, struct __msghdrx64 const *)
#define __NRAT2_sendmsg                  (syscall_ulong_t, __syscall_ulong_t)
#define __NRAT0_recvmsg                  (fd_t, __fd_t)
#define __NRAT1_recvmsg                  (struct msghdrx64 *, struct __msghdrx64 *)
...
#define __NRAT3_wait4                    (struct rusagex64 *, struct __rusagex64 *)
...
#define __NRAT0_gettimeofday             (struct timevalx64 *, struct __timevalx64 *)
#define __NRAT1_gettimeofday             (struct timezone *, struct timezone *)
#define __NRAT0_getrlimit                (syscall_ulong_t, __syscall_ulong_t)
#define __NRAT1_getrlimit                (struct rlimitx64 *, struct __rlimitx64 *)
...
#define __NRAT1_rt_sigtimedwait          (struct __siginfox64_struct *, struct __siginfox64_struct *)
#define __NRAT2_rt_sigtimedwait          (struct timespecx64 const *, struct __timespecx64 const *)
...
#define __NRAT1_sched_rr_get_interval    (struct timespecx64 *, struct __timespecx64 *)
...
#define __NRAT1_setrlimit                (struct rlimitx64 const *, struct __rlimitx64 const *)
#define __NRAT0_chroot                   (char const *, char const *)
#define __NRAT0_acct                     (char const *, char const *)
#define __NRAT0_settimeofday             (struct timevalx64 const *, struct __timevalx64 const *)
...
#define __NRAT3_futex                    (struct timespecx64 const *, struct __timespecx64 const *)
...
#define __NRAT0_epoll_ctl_old            (fd_t, __fd_t)
#define __NRAT1_epoll_ctl_old            (syscall_ulong_t, __syscall_ulong_t)
#define __NRAT2_epoll_ctl_old            (fd_t, __fd_t)
...
#define __NRAT2_timer_settime            (struct itimerspecx64 const *, struct __itimerspecx64 const *)
#define __NRAT3_timer_settime            (struct itimerspecx64 *, struct __itimerspecx64 *)
#define __NRAT0_timer_gettime            (timer_t, __timer_t)
#define __NRAT1_timer_gettime            (struct itimerspecx64 *, struct __itimerspecx64 *)
...
#define __NRAT1_clock_settime            (struct timespecx64 const *, struct __timespecx64 const *)
#define __NRAT0_clock_gettime            (clockid_t, __clockid_t)
#define __NRAT1_clock_gettime            (struct timespecx64 *, struct __timespecx64 *)
#define __NRAT0_clock_getres             (clockid_t, __clockid_t)
#define __NRAT1_clock_getres             (struct timespecx64 *, struct __timespecx64 *)
#define __NRAT0_clock_nanosleep          (clockid_t, __clockid_t)
#define __NRAT1_clock_nanosleep          (syscall_ulong_t, __syscall_ulong_t)
#define __NRAT2_clock_nanosleep          (struct timespecx64 const *, struct __timespecx64 const *)
#define __NRAT3_clock_nanosleep          (struct timespecx64 *, struct __timespecx64 *)
...
#define __NRAT4_mq_timedsend             (struct timespecx64 const *, struct __timespecx64 const *)
...
#define __NRAT4_mq_timedreceive          (struct timespecx64 const *, struct __timespecx64 const *)
...
#define __NRAT2_waitid                   (struct __siginfox64_struct *, struct __siginfox64_struct *)
#define __NRAT3_waitid                   (syscall_ulong_t, __syscall_ulong_t)
#define __NRAT4_waitid                   (struct rusagex64 *, struct __rusagex64 *)
...
#define __NRAT1_vmsplice                 (struct iovecx64 const *, struct __iovecx64 const *)
...
#define __NRAT2_utimensat                (struct timespecx64 const *, struct __timespecx64 const *)
...
#define __NRAT2_timerfd_settime          (struct itimerspecx64 const *, struct __itimerspecx64 const *)
#define __NRAT3_timerfd_settime          (struct itimerspecx64 *, struct __itimerspecx64 *)
#define __NRAT0_timerfd_gettime          (fd_t, __fd_t)
#define __NRAT1_timerfd_gettime          (struct itimerspecx64 *, struct __itimerspecx64 *)
...
#define __NRAT1_preadv                   (struct iovecx64 const *, struct __iovecx64 const *)
#define __NRAT2_preadv                   (size_t, __size_t)
#define __NRAT3_preadv                   (uint64_t, __uint64_t)
#define __NRAT0_pwritev                  (fd_t, __fd_t)
#define __NRAT1_pwritev                  (struct iovecx64 const *, struct __iovecx64 const *)
...
#define __NRAT3_rt_tgsigqueueinfo        (struct __siginfox64_struct const *, struct __siginfox64_struct const *)
#define __NRAT0_perf_event_open          (int, int)
#define __NRAT0_recvmmsg                 (fd_t, __fd_t)
#define __NRAT1_recvmmsg                 (struct mmsghdrx64 *, struct __mmsghdrx64 *)
#define __NRAT2_recvmmsg                 (size_t, __size_t)
#define __NRAT3_recvmmsg                 (syscall_ulong_t, __syscall_ulong_t)
#define __NRAT4_recvmmsg                 (struct timespecx64 const *, struct __timespecx64 const *)
...
#define __NRAT2_prlimit64                (struct rlimitx64 const *, struct __rlimitx64 const *)
#define __NRAT3_prlimit64                (struct rlimitx64 *, struct __rlimitx64 *)
...
#define __NRAT1_sendmmsg                 (struct mmsghdrx64 *, struct __mmsghdrx64 *)
...
#define __NRAT1_process_vm_readv         (struct iovecx64 const *, struct __iovecx64 const *)
#define __NRAT2_process_vm_readv         (size_t, __size_t)
#define __NRAT3_process_vm_readv         (struct iovecx64 const *, struct __iovecx64 const *)
...
#define __NRAT1_process_vm_writev        (struct iovecx64 const *, struct __iovecx64 const *)
#define __NRAT2_process_vm_writev        (size_t, __size_t)
#define __NRAT3_process_vm_writev        (struct iovecx64 const *, struct __iovecx64 const *)
...
#define __NRAT2_pidfd_send_signal        (struct __siginfox64_struct const *, struct __siginfox64_struct const *)
...
#define __NRAT1_preadvf                  (struct iovecx64 const *, struct __iovecx64 const *)
...
#define __NRAT2_coredump                 (__HYBRID_PTR64(void const) const *, __HYBRID_PTR64(void const) const *)
...
#define __NRAT3_lfutex                   (struct timespecx64 const *, struct __timespecx64 const *)
...
#define __NRAT1_readvf                   (struct iovecx64 const *, struct __iovecx64 const *)
...
#define __NRAM_stat(a, b, c, d, e, f)                     (char const *)a, (struct linux_statx64 *)b
#define __NRAM_fstat(a, b, c, d, e, f)                    (__fd_t)a, (struct linux_statx64 *)b
#define __NRAM_lstat(a, b, c, d, e, f)                    (char const *)a, (struct linux_statx64 *)b
...
#define __NRAM_readv(a, b, c, d, e, f)                    (__fd_t)a, (struct __iovecx64 const *)b, (__size_t)c
#define __NRAM_writev(a, b, c, d, e, f)                   (__fd_t)a, (struct __iovecx64 const *)b, (__size_t)c
#define __NRAM_access(a, b, c, d, e, f)                   (char const *)a, (__syscall_ulong_t)b
#define __NRAM_pipe(a, b, c, d, e, f)                     (__fd_t *)a
#define __NRAM_select(a, b, c, d, e, f)                   (__size_t)a, (struct __fd_set_struct *)b, (struct __fd_set_struct *)c, (struct __fd_set_struct *)d, (struct __timevalx64 *)e
...
#define __NRAM_nanosleep(a, b, c, d, e, f)                (struct __timespecx64 const *)a, (struct __timespecx64 *)b
#define __NRAM_getitimer(a, b, c, d, e, f)                (__syscall_ulong_t)a, (struct __itimervalx64 *)b
#define __NRAM_alarm(a, b, c, d, e, f)                    (__syscall_ulong_t)a
#define __NRAM_setitimer(a, b, c, d, e, f)                (__syscall_ulong_t)a, (struct __itimervalx64 const *)b, (struct __itimervalx64 *)c
...
#define __NRAM_sendmsg(a, b, c, d, e, f)                  (__fd_t)a, (struct __msghdrx64 const *)b, (__syscall_ulong_t)c
#define __NRAM_recvmsg(a, b, c, d, e, f)                  (__fd_t)a, (struct __msghdrx64 *)b, (__syscall_ulong_t)c
...
#define __NRAM_chown(a, b, c, d, e, f)                    (char const *)a, (__uid_t)b, (__gid_t)c
#define __NRAM_fchown(a, b, c, d, e, f)                   (__fd_t)a, (__uid_t)b, (__gid_t)c
#define __NRAM_lchown(a, b, c, d, e, f)                   (char const *)a, (__uid_t)b, (__gid_t)c
#define __NRAM_umask(a, b, c, d, e, f)                    (__mode_t)a
#define __NRAM_gettimeofday(a, b, c, d, e, f)             (struct __timevalx64 *)a, (struct timezone *)b
#define __NRAM_getrlimit(a, b, c, d, e, f)                (__syscall_ulong_t)a, (struct __rlimitx64 *)b
...
#define __NRAM_setuid(a, b, c, d, e, f)                   (__uid_t)a
#define __NRAM_setgid(a, b, c, d, e, f)                   (__gid_t)a
...
#define __NRAM_setreuid(a, b, c, d, e, f)                 (__uid_t)a, (__uid_t)b
#define __NRAM_setregid(a, b, c, d, e, f)                 (__gid_t)a, (__gid_t)b
#define __NRAM_getgroups(a, b, c, d, e, f)                (__size_t)a, (__gid_t *)b
#define __NRAM_setgroups(a, b, c, d, e, f)                (__size_t)a, (__gid_t const *)b
#define __NRAM_setresuid(a, b, c, d, e, f)                (__uid_t)a, (__uid_t)b, (__uid_t)c
#define __NRAM_getresuid(a, b, c, d, e, f)                (__uid_t *)a, (__uid_t *)b, (__uid_t *)c
#define __NRAM_setresgid(a, b, c, d, e, f)                (__gid_t)a, (__gid_t)b, (__gid_t)c
#define __NRAM_getresgid(a, b, c, d, e, f)                (__gid_t *)a, (__gid_t *)b, (__gid_t *)c
#define __NRAM_getpgid(a, b, c, d, e, f)                  (__pid_t)a
#define __NRAM_setfsuid(a, b, c, d, e, f)                 (__uid_t)a
#define __NRAM_setfsgid(a, b, c, d, e, f)                 (__gid_t)a
...
#define __NRAM_rt_sigtimedwait(a, b, c, d, e, f)          (struct __sigset_struct const *)a, (struct __siginfox64_struct *)b, (struct __timespecx64 const *)c, (__size_t)d
#define __NRAM_rt_sigqueueinfo(a, b, c, d, e, f)          (__pid_t)a, (__signo_t)b, (struct __siginfox64_struct const *)c
#define __NRAM_rt_sigsuspend(a, b, c, d, e, f)            (struct __sigset_struct const *)a, (__size_t)b
#define __NRAM_sigaltstack(a, b, c, d, e, f)              (struct __sigaltstackx64 const *)a, (struct __sigaltstackx64 *)b
#define __NRAM_utime(a, b, c, d, e, f)                    (char const *)a, (struct __utimbufx64 const *)b
...
#define __NRAM_statfs(a, b, c, d, e, f)                   (char const *)a, (struct __statfsx64 *)b
#define __NRAM_fstatfs(a, b, c, d, e, f)                  (__fd_t)a, (struct __statfsx64 *)b
...
#define __NRAM_sched_rr_get_interval(a, b, c, d, e, f)    (__pid_t)a, (struct __timespecx64 *)b
...
#define __NRAM_setrlimit(a, b, c, d, e, f)                (__syscall_ulong_t)a, (struct __rlimitx64 const *)b
...
#define __NRAM_settimeofday(a, b, c, d, e, f)             (struct __timevalx64 const *)a, (struct timezone const *)b
...
#define __NRAM_timer_settime(a, b, c, d, e, f)            (__timer_t)a, (__syscall_ulong_t)b, (struct __itimerspecx64 const *)c, (struct __itimerspecx64 *)d
#define __NRAM_timer_gettime(a, b, c, d, e, f)            (__timer_t)a, (struct __itimerspecx64 *)b
#define __NRAM_timer_getoverrun(a, b, c, d, e, f)         (__timer_t)a
#define __NRAM_timer_delete(a, b, c, d, e, f)             (__timer_t)a
#define __NRAM_clock_settime(a, b, c, d, e, f)            (__clockid_t)a, (struct __timespecx64 const *)b
#define __NRAM_clock_gettime(a, b, c, d, e, f)            (__clockid_t)a, (struct __timespecx64 *)b
...
#define __NRAM_mq_timedsend(a, b, c, d, e, f)             (__fd_t)a, (char const *)b, (__size_t)c, (__uint32_t)d, (struct __timespecx64 const *)e
#define __NRAM_mq_timedreceive(a, b, c, d, e, f)          (__fd_t)a, (char *)b, (__size_t)c, (__uint32_t *)d, (struct __timespecx64 const *)e
...
#define __NRAM_waitid(a, b, c, d, e, f)                   (__syscall_ulong_t)a, (__id_t)b, (struct __siginfox64_struct *)c, (__syscall_ulong_t)d, (struct __rusagex64 *)e
...
#define __NRAM_newfstatat(a, b, c, d, e, f)               (__fd_t)a, (char const *)b, (struct linux64_stat32 *)c, (__atflag_t)d
...
#define __NRAM_timerfd_settime(a, b, c, d, e, f)          (__fd_t)a, (__syscall_ulong_t)b, (struct __itimerspecx64 const *)c, (struct __itimerspecx64 *)d
#define __NRAM_timerfd_gettime(a, b, c, d, e, f)          (__fd_t)a, (struct __itimerspecx64 *)b
...
#define __NRAM_preadv(a, b, c, d, e, f)                   (__fd_t)a, (struct __iovecx64 const *)b, (__size_t)c, (__uint64_t)d
#define __NRAM_pwritev(a, b, c, d, e, f)                  (__fd_t)a, (struct __iovecx64 const *)b, (__size_t)c, (__uint64_t)d
#define __NRAM_rt_tgsigqueueinfo(a, b, c, d, e, f)        (__pid_t)a, (__pid_t)b, (__signo_t)c, (struct __siginfox64_struct const *)d
#define __NRAM_perf_event_open(a, b, c, d, e, f)          (int)a
#define __NRAM_recvmmsg(a, b, c, d, e, f)                 (__fd_t)a, (struct __mmsghdrx64 *)b, (__size_t)c, (__syscall_ulong_t)d, (struct __timespecx64 const *)e
#define __NRAM_fanotify_init(a, b, c, d, e, f)            (int)a
#define __NRAM_fanotify_mark(a, b, c, d, e, f)            (int)a
#define __NRAM_prlimit64(a, b, c, d, e, f)                (__pid_t)a, (__syscall_ulong_t)b, (struct __rlimitx64 const *)c, (struct __rlimitx64 *)d
...
#define __NRAM_pidfd_send_signal(a, b, c, d, e, f)        (__fd_t)a, (__signo_t)b, (struct __siginfox64_struct const *)c, (__syscall_ulong_t)d
...
#define __NRAM_coredump(a, b, c, d, e, f)                 (struct ucpustate64 const *)a, (struct ucpustate64 const *)b, (__HYBRID_PTR64(void const) const *)c, (__size_t)d, (union coredump_info64 const *)e, (unwind_errno_t)f
