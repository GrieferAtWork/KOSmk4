...
#define __NR64_linux_stat             0x4                            /* errno_t linux_stat(char const *filename, struct linux_statx64 *statbuf) */
...
/* @param: msg_flags: Set of `MSG_CONFIRM | MSG_DONTROUTE | MSG_DONTWAIT |
 *                            MSG_EOR | MSG_MORE | MSG_NOSIGNAL | MSG_OOB' */
#define __NR64_sendmsg                0x2e                           /* ssize_t sendmsg(fd_t sockfd, struct msghdr64 const *message, syscall_ulong_t msg_flags) */
/* @param: msg_flags: Set of `MSG_CMSG_CLOEXEC | MSG_CMSG_CLOFORK |
 *                            MSG_DONTWAIT | MSG_ERRQUEUE | MSG_OOB |
 *                            MSG_PEEK | MSG_TRUNC | MSG_WAITALL' */
#define __NR64_recvmsg                0x2f                           /* ssize_t recvmsg(fd_t sockfd, struct msghdr64 *message, syscall_ulong_t msg_flags) */
...
#define __NR64_rt_sigtimedwait        0x80                           /* syscall_slong_t rt_sigtimedwait(struct __sigset_struct const *set, struct __siginfo64_struct *info, struct timespecx64 const *timeout, size_t sigsetsize) */
/* @param: signo: One of `SIG*' */
...
#define __NR64_sched_rr_get_interval  0x94                           /* errno_t sched_rr_get_interval(pid_t pid, struct timespecx64 *tms) */
...
#define __NR64_waitid                 0xf7                           /* errno_t waitid(syscall_ulong_t idtype, id_t id, struct __siginfo64_struct *infop, syscall_ulong_t options, struct rusagex64 *ru) */
...
#define __NR64_futimesat              0x105                          /* errno_t futimesat(fd_t dirfd, const char *filename, struct timevalx64 const[2] times) */
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW | AT_DOSPATH' */
#define __NR64_linux_fstatat          0x106                          /* errno_t linux_fstatat(fd_t dirfd, char const *filename, struct linux_statx64 *statbuf, atflag_t flags) */
...
#define __NR64_timerfd_settime        0x11e                          /* errno_t timerfd_settime(fd_t ufd, syscall_ulong_t flags, struct itimerspecx64 const *utmr, struct itimerspecx64 *otmr) */
/* Return the next expiration time of UFD */
#define __NR64_timerfd_gettime        0x11f                          /* errno_t timerfd_gettime(fd_t ufd, struct itimerspecx64 *otmr) */
...
#define __NR64_recvmmsg               0x12b                          /* ssize_t recvmmsg(fd_t sockfd, struct mmsghdrx64 *vmessages, size_t vlen, syscall_ulong_t flags, struct timespecx64 const *tmo) */
...
#define __NR64_sendmmsg               0x133                          /* ssize_t sendmmsg(fd_t sockfd, struct mmsghdrx64 *vmessages, size_t vlen, syscall_ulong_t flags) */
...
#define __NR64_pwritevf               __UINT64_C(0xfffffffffffffed8) /* ssize_t pwritevf(fd_t fd, struct iovec64 const *iovec, size_t count, uint64_t offset, iomode_t mode) */
#define __NR64_preadvf                __UINT64_C(0xfffffffffffffed9) /* ssize_t preadvf(fd_t fd, struct iovec64 const *iovec, size_t count, uint64_t offset, iomode_t mode) */
...
/* @param: flags: Set of `0 | AT_DOSPATH' */
#define __NR64_frenameat              __UINT64_C(0xfffffffffffffef8) /* errno_t frenameat(fd_t oldfd, char const *oldname, fd_t newfd, char const *newname_or_path, atflag_t flags) */
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW | AT_DOSPATH' */
#define __NR64_kfstatat               __UINT64_C(0xfffffffffffffefa) /* errno_t kfstatat(fd_t dirfd, char const *filename, struct __kos_statx64 *statbuf, atflag_t flags) */
/* @param: flags: Set of `0 | AT_DOSPATH' */
...
#define __NR64_ksysctl                __UINT64_C(0xffffffffffffff64) /* syscall_slong_t ksysctl(syscall_ulong_t command, void *arg) */
...
#define __NR64_maplibrary             __UINT64_C(0xffffffffffffff7a) /* void *maplibrary(void *addr, syscall_ulong_t flags, fd_t fd, struct elf64_phdr *hdrv, size_t hdrc) */
...
#define __NR64_coredump               __UINT64_C(0xffffffffffffffe3) /* errno_t coredump(struct ucpustate64 const *curr_state, struct ucpustate64 const *orig_state, __HYBRID_PTR64(void) const *traceback_vector, size_t traceback_length, struct exception_data64 const *exception, syscall_ulong_t unwind_error) */
...
#define __NR64_raiseat                __UINT64_C(0xffffffffffffffe4) /* errno_t raiseat(struct ucpustate64 const *state, struct __siginfo64_struct const *si) */
...
#define __NR64_lfutexlockexpr         __UINT64_C(0xffffffffffffffe6) /* errno_t lfutexlockexpr(uint64_t *ulockaddr, void *base, size_t exprc, struct lfutexexprx64 const *exprv, struct timespecx64 const *timeout, syscall_ulong_t timeout_flags) */
/* >> lfutexexpr(2)
 ...
 * @return: -1:EINTR:     A blocking futex-wait operation was interrupted
 * @return: -1:ETIMEDOUT: A blocking futex-wait operation has timed out */
#define __NR64_lfutexexpr             __UINT64_C(0xffffffffffffffe7) /* errno_t lfutexexpr(void *base, size_t exprc, struct lfutexexprx64 const *exprv, struct timespecx64 const *timeout, syscall_ulong_t timeout_flags) */
/* >> lfutex(2)
...
#define __NR64_rpc_service            __UINT64_C(0xffffffffffffffe9) /* syscall_slong_t rpc_service(void) */
...
#define __NR64_writevf                __UINT64_C(0xffffffffffffffec) /* ssize_t writevf(fd_t fd, struct iovec64 const *iovec, size_t count, iomode_t mode) */
#define __NR64_readvf                 __UINT64_C(0xffffffffffffffed) /* ssize_t readvf(fd_t fd, struct iovec64 const *iovec, size_t count, iomode_t mode) */
...
#define __NR64_ioctlf                 __UINT64_C(0xfffffffffffffff0) /* syscall_slong_t ioctlf(fd_t fd, syscall_ulong_t command, iomode_t mode, void *arg) */
...
#define __NR64_set_exception_handler  __UINT64_C(0xfffffffffffffff1) /* errno_t set_exception_handler(syscall_ulong_t mode, except_handler_t handler, void *handler_sp) */
...
#define __NR64_rpc_schedule           __UINT64_C(0xfffffffffffffff4) /* syscall_slong_t rpc_schedule(pid_t target, syscall_ulong_t flags, uint8_t const *program, __HYBRID_PTR64(void) *arguments) */
