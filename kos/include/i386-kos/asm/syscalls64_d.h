...
#define __NR64_statfs                   0x89                           /* errno_t statfs(char const *file, struct statfsx64 *buf) */
#define __NR64_fstatfs                  0x8a                           /* errno_t fstatfs(fd_t file, struct statfsx64 *buf) */
...
#define __NR64_coredump                 __UINT64_C(0xffffffffffffffe3) /* errno_t coredump(struct ucpustate64 const *curr_state, struct ucpustate64 const *orig_state, __HYBRID_PTR64(void const) const *traceback_vector, size_t traceback_length, union coredump_info64 const *reason, unwind_errno_t unwind_error) */
...
#define __NR64RM_inotify_add_watch_at     0
...
#define __NR64RC_inotify_init             0
#define __NR64RC_inotify_add_watch        3
#define __NR64RC_inotify_rm_watch         2
...
#define __NR64RC_inotify_add_watch_at     5
