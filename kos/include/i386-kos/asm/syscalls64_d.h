 ...
 * @throw: E_INVALID_ARGUMENT_BAD_VALUE:E_INVALID_ARGUMENT_CONTEXT_RAISE_SIGINFO_BADCODE:  [...]
 * @throw: E_ILLEGAL_OPERATION:                                                            [...] */
#define __NR64_rt_tgsigqueueinfo        0x129                          /* errno_t rt_tgsigqueueinfo(pid_t tgid, pid_t tid, signo_t usigno, struct __siginfox64_struct const *uinfo) */
...
#define __NR64_sigmask_check            __UINT64_C(0xffffffffffffffdb) /* errno_t sigmask_check(void) */
...
#define __NR64RM_sigmask_check            2
...
#define __NR64RC_sigmask_check            0
