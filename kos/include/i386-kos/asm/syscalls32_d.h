...
#define __NR32_ioctl                   0x36                   /* syscall_slong_t ioctl(fd_t fd, syscall_ulong_t command, void *arg) */
#define __NR32_fcntl                   0x37                   /* syscall_slong_t fcntl(fd_t fd, syscall_ulong_t command, void *arg) */
...
#define __NR32_getgroups               0x50                   /* errno_t getgroups(size_t count, uint16_t[] list) */
...
#define __NR32_rt_sigreturn            0xad                   /* void rt_sigreturn(struct fpustate const *restore_fpu, struct __sigset_struct const *restore_sigmask, struct rpc_syscall_info const *sc_info, struct ucpustate const *restore_cpu) */
...
#define __NR32_getgroups32             0xcd                   /* errno_t getgroups32(size_t count, uint32_t[] list) */
 ...
 *                            MSG_DONTWAIT | MSG_ERRQUEUE | MSG_OOB |
 *                            MSG_PEEK | MSG_TRUNC | MSG_WAITALL' */
#define __NR32_recvmmsg64              __UINT32_C(0xfffffeaf) /* ssize_t recvmmsg64(fd_t sockfd, struct mmsghdrx32 *vmessages, size_t vlen, syscall_ulong_t msg_flags, struct timespecx32_64 const *tmo) */
