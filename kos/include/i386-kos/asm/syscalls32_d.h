...
#define __NR32_sgetmask                     0x44                   /* uint32_t sgetmask(void) */
#define __NR32_ssetmask                     0x45                   /* uint32_t ssetmask(uint32_t sigmask) */
/* >> setreuid(2)
...
#define __NR32_statfs                       0x63                   /* errno_t statfs(char const *file, struct statfsx32 *buf) */
#define __NR32_fstatfs                      0x64                   /* errno_t fstatfs(fd_t file, struct statfsx32 *buf) */
...
#define __NR32_statfs64                     0x10c                  /* errno_t statfs64(char const *file, struct statfsx32_64 *buf) */
#define __NR32_fstatfs64                    0x10d                  /* errno_t fstatfs64(fd_t file, struct statfsx32_64 *buf) */
...
#define __NR32_inotify_init                 0x123                  /* fd_t inotify_init(void) */
/* @param: mask: Set of `IN_ALL_EVENTS | ...' */
#define __NR32_inotify_add_watch            0x124                  /* int inotify_add_watch(fd_t notify_fd, char const *pathname, uint32_t mask) */
/* @param: wd: Watch fd (as returned by `inotify_add_watch{_at}') */
#define __NR32_inotify_rm_watch             0x125                  /* errno_t inotify_rm_watch(fd_t notify_fd, int wd) */
...
#define __NR32_inotify_init1                0x14c                  /* fd_t inotify_init1(syscall_ulong_t flags) */
 ...
 * @param: mask:    Set of `IN_ALL_EVENTS | ...' */
#define __NR32_inotify_add_watch_at         __UINT32_C(0xfffffedc) /* int inotify_add_watch_at(fd_t notify_fd, fd_t dirfd, char const *pathname, atflag_t atflags, uint32_t mask) */
/* @param: idtype:  One of `P_ALL', `P_PID', `P_PGID'
 * @param: options: At least one of `WEXITED', `WSTOPPED', `WCONTINUED', optionally or'd with `WNOHANG | WNOWAIT' */
...
#define __NR32RC_inotify_init                 0
#define __NR32RC_inotify_add_watch            3
#define __NR32RC_inotify_rm_watch             2
