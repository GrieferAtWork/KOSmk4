...
#define __NR32_rtm_test                __UINT32_C(0xffffffcd) /* syscall_slong_t rtm_test(void) */
...
#define __NR32_rtm_begin               __UINT32_C(0xffffffd0) /* syscall_slong_t rtm_begin(void) */
