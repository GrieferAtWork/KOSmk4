...
#define __NR32_exit                    0x1                    /* void exit(syscall_ulong_t status) */
...
#define __NR32_execve                  0xb                    /* errno_t execve(char const *path, char const *const *argv, char const *const *envp) */
#define __NR32_chdir                   0xc                    /* errno_t chdir(char const *path) */
#define __NR32_time                    0xd                    /* time32_t time(time32_t *timer) */
...
#define __NR32_mount                   0x15                   /* errno_t mount(char const *special_file, char const *dir, char const *fstype, syscall_ulong_t rwflag, void const *data) */
...
#define __NR32_utime                   0x1e                   /* errno_t utime(char const *filename, struct __utimbuf32 const *times) */
...
#define __NR32_ftime                   0x23                   /* errno_t ftime(struct timeb *tp) */
...
#define __NR32_times                   0x2b                   /* clock_t times(struct tms *buf) */
...
#define __NR32_ioctl                   0x36                   /* syscall_slong_t ioctl(fd_t fd, syscall_ulong_t request, void *arg) */
#define __NR32_fcntl                   0x37                   /* syscall_slong_t fcntl(fd_t fd, syscall_ulong_t cmd, void *arg) */
...
#define __NR32_getrusage               0x4d                   /* errno_t getrusage(syscall_slong_t who, struct rusage *usage) */
#define __NR32_gettimeofday            0x4e                   /* errno_t gettimeofday(struct __timeval32 *tv, struct timezone *tz) */
#define __NR32_settimeofday            0x4f                   /* errno_t settimeofday(struct __timeval32 const *tv, struct timezone const *tz) */
#define __NR32_getgroups               0x50                   /* errno_t getgroups(size_t size, uint16_t[] list) */
#define __NR32_setgroups               0x51                   /* errno_t setgroups(size_t count, uint16_t const *groups) */
#define __NR32_select                  0x52                   /* ssize_t select(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct __timeval32 *timeout) */
...
#define __NR32_profil                  0x62                   /* errno_t profil(uint16_t *sample_buffer, size_t size, size_t offset, syscall_ulong_t scale) */
#define __NR32_statfs                  0x63                   /* errno_t statfs(char const *file, struct __statfs32 *buf) */
#define __NR32_fstatfs                 0x64                   /* errno_t fstatfs(fd_t file, struct __statfs32 *buf) */
#define __NR32_ioperm                  0x65                   /* errno_t ioperm(syscall_ulong_t from, syscall_ulong_t num, syscall_ulong_t turn_on) */
#define __NR32_socketcall              0x66                   /* errno_t socketcall(int call, unsigned long *args) */
 ...
 * @param: options: Set of `WNOHANG|WUNTRACED|WCONTINUED' (as a KOS extension, `WNOWAIT' is also accepted) */
#define __NR32_wait4                   0x72                   /* pid_t wait4(pid_t pid, int32_t *stat_loc, syscall_ulong_t options, struct rusage *usage) */
#define __NR32_swapoff                 0x73                   /* errno_t swapoff(char const *pathname) */
#define __NR32_sysinfo                 0x74                   /* errno_t sysinfo(struct sysinfo *info) */
...
#define __NR32_sigreturn               0x77                   /* void sigreturn(struct fpustate const *restore_fpu, syscall_ulong_t unused1, syscall_ulong_t unused2, struct __sigset_struct const *restore_sigmask, struct rpc_syscall_info *sc_info, struct ucpustate const *restore_cpu) */
...
#define __NR32_adjtimex                0x7c                   /* errno_t adjtimex(int TODO_PROTOTYPE) */
/* @param: prot: Either `PROT_NONE', or set of `PROT_EXEC|PROT_WRITE|PROT_READ|PROT_SEM|PROT_LOOSE|PROT_SHARED' */
...
#define __NR32_afs_syscall             0x89                   /* errno_t afs_syscall(int TODO_PROTOTYPE) */
...
#define __NR32_readv                   0x91                   /* ssize_t readv(fd_t fd, struct iovec const *iovec, size_t count) */
#define __NR32_writev                  0x92                   /* ssize_t writev(fd_t fd, struct iovec const *iovec, size_t count) */
...
#define __NR32_sched_rr_get_interval   0xa1                   /* errno_t sched_rr_get_interval(pid_t pid, struct __timespec32 *tms) */
#define __NR32_nanosleep               0xa2                   /* errno_t nanosleep(struct __timespec32 const *req, struct __timespec32 *rem) */
...
#define __NR32_rt_sigtimedwait         0xb1                   /* syscall_slong_t rt_sigtimedwait(struct __sigset_struct const *set, struct __siginfo_struct *info, struct __timespec32 const *timeout, size_t sigsetsize) */
/* @param: signo: One of `SIG*' */
#define __NR32_rt_sigqueueinfo         0xb2                   /* errno_t rt_sigqueueinfo(pid_t tgid, syscall_ulong_t signo, struct __siginfo_struct const *uinfo) */
...
#define __NR32_getgroups32             0xcd                   /* errno_t getgroups32(size_t size, uint32_t[] list) */
...
#define __NR32_futex                   0xf0                   /* syscall_slong_t futex(uint32_t *uaddr, syscall_ulong_t futex_op, uint32_t val, struct __timespec32 const *timeout_or_val2, uint32_t *uaddr2, uint32_t val3) */
...
#define __NR32_epoll_ctl               0xff                   /* errno_t epoll_ctl(fd_t epfd, syscall_ulong_t op, fd_t fd, struct epoll_event *event) */
#define __NR32_epoll_wait              0x100                  /* errno_t epoll_wait(fd_t epfd, struct epoll_event *events, syscall_ulong_t maxevents, syscall_slong_t timeout) */
...
#define __NR32_timer_settime           0x104                  /* errno_t timer_settime(timer_t timerid, syscall_ulong_t flags, struct __itimerspec32 const *value, struct __itimerspec32 *ovalue) */
#define __NR32_timer_gettime           0x105                  /* errno_t timer_gettime(timer_t timerid, struct __itimerspec32 *value) */
...
#define __NR32_clock_settime           0x108                  /* errno_t clock_settime(clockid_t clock_id, struct __timespec32 const *tp) */
#define __NR32_clock_gettime           0x109                  /* errno_t clock_gettime(clockid_t clock_id, struct __timespec32 *tp) */
#define __NR32_clock_getres            0x10a                  /* errno_t clock_getres(clockid_t clock_id, struct __timespec32 *res) */
#define __NR32_clock_nanosleep         0x10b                  /* errno_t clock_nanosleep(clockid_t clock_id, syscall_ulong_t flags, struct __timespec32 const *requested_time, struct __timespec32 *remaining) */
#define __NR32_statfs64                0x10c                  /* errno_t statfs64(char const *file, struct statfs64 *buf) */
#define __NR32_fstatfs64               0x10d                  /* errno_t fstatfs64(fd_t file, struct statfs64 *buf) */
#define __NR32_tgkill                  0x10e                  /* errno_t tgkill(pid_t tgid, pid_t tid, syscall_ulong_t signo) */
#define __NR32_utimes                  0x10f                  /* errno_t utimes(char const *filename, struct __timeval32 const[2] times) */
...
#define __NR32_mq_open                 0x115                  /* errno_t mq_open(int TODO_PROTOTYPE) */
#define __NR32_mq_unlink               0x116                  /* errno_t mq_unlink(int TODO_PROTOTYPE) */
#define __NR32_mq_timedsend            0x117                  /* errno_t mq_timedsend(int TODO_PROTOTYPE) */
#define __NR32_mq_timedreceive         0x118                  /* errno_t mq_timedreceive(int TODO_PROTOTYPE) */
#define __NR32_mq_notify               0x119                  /* errno_t mq_notify(int TODO_PROTOTYPE) */
#define __NR32_mq_getsetattr           0x11a                  /* errno_t mq_getsetattr(int TODO_PROTOTYPE) */
#define __NR32_kexec_load              0x11b                  /* errno_t kexec_load(int TODO_PROTOTYPE) */
/* @param: options: At least one of `WEXITED | WSTOPPED | WCONTINUED', optionally or'd with `WNOHANG | WNOWAIT' */
#define __NR32_waitid                  0x11c                  /* errno_t waitid(syscall_ulong_t idtype, id_t id, struct __siginfo_struct *infop, syscall_ulong_t options, struct rusage *ru) */
...
#define __NR32_ioprio_set              0x121                  /* errno_t ioprio_set(syscall_ulong_t which, syscall_ulong_t who, syscall_ulong_t ioprio) */
#define __NR32_ioprio_get              0x122                  /* errno_t ioprio_get(syscall_ulong_t which, syscall_ulong_t who) */
...
#define __NR32_futimesat               0x12b                  /* errno_t futimesat(fd_t dirfd, const char *filename, struct __timeval32 const[2] times) */
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW|AT_DOSPATH' */
...
#define __NR32_faccessat               0x133                  /* errno_t faccessat(fd_t dirfd, char const *filename, syscall_ulong_t type, atflag_t flags) */
#define __NR32_pselect6                0x134                  /* ssize_t pselect6(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct __timespec32 const *timeout, void const *sigmask_sigset_and_len) */
#define __NR32_ppoll                   0x135                  /* ssize_t ppoll(struct pollfd *fds, size_t nfds, struct __timespec32 const *timeout_ts, struct __sigset_struct const *sigmask, size_t sigsetsize) */
/* param flags: Set of `CLONE_*' */
#define __NR32_unshare                 0x136                  /* errno_t unshare(syscall_ulong_t flags) */
...
#define __NR32_vmsplice                0x13c                  /* ssize_t vmsplice(fd_t fdout, struct iovec const *iov, size_t count, syscall_ulong_t flags) */
...
#define __NR32_utimensat               0x140                  /* errno_t utimensat(fd_t dirfd, char const *filename, struct __timespec32 const[2] times, atflag_t flags) */
#define __NR32_signalfd                0x141                  /* errno_t signalfd(fd_t fd, struct __sigset_struct const *sigmask, size_t sigsetsize) */
...
#define __NR32_timerfd_settime         0x145                  /* errno_t timerfd_settime(fd_t ufd, syscall_ulong_t flags, struct __itimerspec32 const *utmr, struct __itimerspec32 *otmr) */
/* Return the next expiration time of UFD */
#define __NR32_timerfd_gettime         0x146                  /* errno_t timerfd_gettime(fd_t ufd, struct __itimerspec32 *otmr) */
#define __NR32_signalfd4               0x147                  /* errno_t signalfd4(fd_t fd, struct __sigset_struct const *sigmask, size_t sigsetsize, syscall_ulong_t flags) */
...
#define __NR32_preadv                  0x14d                  /* ssize_t preadv(fd_t fd, struct iovec const *iovec, size_t count, uint64_t offset) */
#define __NR32_pwritev                 0x14e                  /* ssize_t pwritev(fd_t fd, struct iovec const *iovec, size_t count, uint64_t offset) */
/* @param: signo: One of `SIG*' */
#define __NR32_rt_tgsigqueueinfo       0x14f                  /* errno_t rt_tgsigqueueinfo(pid_t tgid, pid_t tid, syscall_ulong_t signo, struct __siginfo_struct const *uinfo) */
#define __NR32_perf_event_open         0x150                  /* errno_t perf_event_open(int TODO_PROTOTYPE) */
#define __NR32_recvmmsg                0x151                  /* ssize_t recvmmsg(fd_t sockfd, struct mmsghdr *vmessages, size_t vlen, syscall_ulong_t flags, struct __timespec32 *tmo) */
...
#define __NR32_name_to_handle_at       0x155                  /* errno_t name_to_handle_at(fd_t dirfd, char const *name, struct file_handle *handle, int32_t *mnt_id, syscall_ulong_t flags) */
#define __NR32_open_by_handle_at       0x156                  /* fd_t open_by_handle_at(fd_t mountdirfd, struct file_handle *handle, syscall_ulong_t flags) */
...
#define __NR32_sendmmsg                0x159                  /* ssize_t sendmmsg(fd_t sockfd, struct mmsghdr *vmessages, size_t vlen, syscall_ulong_t flags) */
#define __NR32_setns                   0x15a                  /* errno_t setns(fd_t fd, syscall_ulong_t nstype) */
#define __NR32_process_vm_readv        0x15b                  /* ssize_t process_vm_readv(pid_t pid, struct iovec const *lvec, size_t liovcnt, struct iovec const *rvec, size_t riovcnt, syscall_ulong_t flags) */
#define __NR32_process_vm_writev       0x15c                  /* ssize_t process_vm_writev(pid_t pid, struct iovec const *lvec, size_t liovcnt, struct iovec const *rvec, size_t riovcnt, syscall_ulong_t flags) */
...
#define __NR32_execveat                0x166                  /* errno_t execveat(fd_t dirfd, char const *pathname, char const *const *argv, char const *const *envp, atflag_t flags) */
...
#define __NR32_accept4                 0x16c                  /* fd_t accept4(fd_t sockfd, struct sockaddr *addr, socklen_t *addr_len, syscall_ulong_t flags) */
...
#define __NR32_sendto                  0x171                  /* ssize_t sendto(fd_t sockfd, void const *buf, size_t bufsize, syscall_ulong_t flags, struct sockaddr const *addr, socklen_t addr_len) */
#define __NR32_sendmsg                 0x172                  /* ssize_t sendmsg(fd_t sockfd, struct msghdr const *message, syscall_ulong_t flags) */
#define __NR32_recvfrom                0x173                  /* ssize_t recvfrom(fd_t sockfd, void *buf, size_t bufsize, syscall_ulong_t flags, struct sockaddr *addr, socklen_t *addr_len) */
#define __NR32_recvmsg                 0x174                  /* ssize_t recvmsg(fd_t sockfd, struct msghdr *message, syscall_ulong_t flags) */
...
#define __NR32_hop                     __UINT32_C(0x80000001) /* syscall_slong_t hop(fd_t fd, syscall_ulong_t command, void *arg) */
#define __NR32_hopf                    __UINT32_C(0x80000002) /* syscall_slong_t hopf(fd_t fd, syscall_ulong_t command, iomode_t mode, void *arg) */
#define __NR32_readf                   __UINT32_C(0x80000003) /* ssize_t readf(fd_t fd, void *buf, size_t bufsize, iomode_t mode) */
#define __NR32_writef                  __UINT32_C(0x80000004) /* ssize_t writef(fd_t fd, void const *buf, size_t bufsize, iomode_t mode) */
/* >> detach(2)
...
#define __NR32_detach                  __UINT32_C(0x80000005) /* errno_t detach(pid_t pid) */
/* Returns a bitset of all of the currently mounted dos-drives */
#define __NR32_getdrives               __UINT32_C(0x80000006) /* syscall_slong_t getdrives(void) */
...
#define __NR32_frealpath4              __UINT32_C(0x80000007) /* ssize_t frealpath4(fd_t fd, char *buf, size_t buflen, atflag_t flags) */
...
#define __NR32_frealpathat             __UINT32_C(0x80000008) /* ssize_t frealpathat(fd_t dirfd, char const *filename, char *buf, size_t buflen, atflag_t flags) */
...
#define __NR32_rpc_schedule            __UINT32_C(0x80000009) /* syscall_slong_t rpc_schedule(pid_t target, syscall_ulong_t flags, uint8_t const *program, void **arguments) */
...
#define __NR32_fchdirat                __UINT32_C(0x8000000c) /* errno_t fchdirat(fd_t dirfd, char const *path, atflag_t flags) */
#define __NR32_time64                  __UINT32_C(0x8000000d) /* time64_t time64(time64_t *timer) */
...
#define __NR32_get_exception_handler   __UINT32_C(0x8000000f) /* errno_t get_exception_handler(syscall_ulong_t *pmode, except_handler_t *phandler, void **phandler_sp) */
/* Set per-vm meta-data for allowing the kernel to enumerate loaded code modules */
#define __NR32_set_library_listdef     __UINT32_C(0x80000010) /* errno_t set_library_listdef(struct library_listdef const *listdef) */
...
#define __NR32_debugtrap               __UINT32_C(0x80000011) /* errno_t debugtrap(struct ucpustate const *state, struct debugtrap_reason const *reason) */
/* >> lfutex(2)
...
#define __NR32_lfutex                  __UINT32_C(0x80000012) /* syscall_slong_t lfutex(uintptr_t *uaddr, syscall_ulong_t futex_op, uintptr_t val, struct __timespec64 const *timeout, uintptr_t val2) */
#define __NR32_lseek64                 __UINT32_C(0x80000013) /* int64_t lseek64(fd_t fd, int64_t offset, syscall_ulong_t whence) */
/* >> lfutexexpr(2)
...
#define __NR32_lfutexexpr              __UINT32_C(0x80000014) /* errno_t lfutexexpr(void *base, size_t exprc, struct lfutexexpr const *exprv, struct __timespec64 const *timeout, syscall_ulong_t timeout_flags) */
/* >> lfutexlockexpr(2)
 ...
 * @return: -1:EINTR:     A blocking futex-wait operation was interrupted
 * @return: -1:ETIMEDOUT: A blocking futex-wait operation has timed out */
#define __NR32_lfutexlockexpr          __UINT32_C(0x80000015) /* errno_t lfutexlockexpr(uintptr_t *ulockaddr, void *base, size_t exprc, struct lfutexexpr const *exprv, struct __timespec64 const *timeout, syscall_ulong_t timeout_flags) */
...
#define __NR32_mktty                   __UINT32_C(0x80000016) /* fd_t mktty(fd_t keyboard, fd_t display, char const *name, syscall_ulong_t rsvd) */
...
#define __NR32_raiseat                 __UINT32_C(0x80000017) /* errno_t raiseat(struct ucpustate const *state, struct __siginfo_struct const *si) */
...
#define __NR32_coredump                __UINT32_C(0x80000018) /* errno_t coredump(struct ucpustate const *curr_state, struct ucpustate const *orig_state, void const *const *traceback_vector, size_t traceback_length, struct exception_data const *exception, syscall_ulong_t unwind_error) */
#define __NR32_stime64                 __UINT32_C(0x80000019) /* errno_t stime64(time64_t const *t) */
#define __NR32_utime64                 __UINT32_C(0x8000001e) /* errno_t utime64(char const *filename, struct __utimbuf64 const *times) */
#define __NR32_ioctlf                  __UINT32_C(0x80000036) /* syscall_slong_t ioctlf(fd_t fd, syscall_ulong_t command, iomode_t mode, void *arg) */
#define __NR32_fsmode                  __UINT32_C(0x8000003c) /* uint64_t fsmode(uint64_t mode) */
#define __NR32_gettimeofday64          __UINT32_C(0x8000004e) /* errno_t gettimeofday64(struct __timeval64 *tv, struct timezone *tz) */
#define __NR32_settimeofday64          __UINT32_C(0x8000004f) /* errno_t settimeofday64(struct __timeval64 const *tv, struct timezone const *tz) */
#define __NR32_select64                __UINT32_C(0x80000052) /* ssize_t select64(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct __timeval64 *timeout) */
...
#define __NR32_maplibrary              __UINT32_C(0x80000056) /* void *maplibrary(void *addr, syscall_ulong_t flags, fd_t fd, void *hdrv, size_t hdrc) */
#define __NR32_setitimer64             __UINT32_C(0x80000068) /* errno_t setitimer64(syscall_ulong_t which, struct __itimerval64 const *newval, struct __itimerval64 *oldval) */
#define __NR32_getitimer64             __UINT32_C(0x80000069) /* errno_t getitimer64(syscall_ulong_t which, struct __itimerval64 *curr_value) */
#define __NR32_kreaddir                __UINT32_C(0x8000008d) /* ssize_t kreaddir(fd_t fd, struct dirent *buf, size_t bufsize, syscall_ulong_t mode) */
#define __NR32_readvf                  __UINT32_C(0x80000091) /* ssize_t readvf(fd_t fd, struct iovec const *iovec, size_t count, iomode_t mode) */
#define __NR32_writevf                 __UINT32_C(0x80000092) /* ssize_t writevf(fd_t fd, struct iovec const *iovec, size_t count, iomode_t mode) */
#define __NR32_rpc_service             __UINT32_C(0x8000009e) /* syscall_slong_t rpc_service(void) */
#define __NR32_sched_rr_get_interval64 __UINT32_C(0x800000a1) /* errno_t sched_rr_get_interval64(pid_t pid, struct __timespec64 *tms) */
#define __NR32_nanosleep64             __UINT32_C(0x800000a2) /* errno_t nanosleep64(struct __timespec64 const *req, struct __timespec64 *rem) */
#define __NR32_rt_sigtimedwait64       __UINT32_C(0x800000b1) /* syscall_slong_t rt_sigtimedwait64(struct __sigset_struct const *set, struct __siginfo_struct *info, struct __timespec64 const *timeout, size_t sigsetsize) */
#define __NR32_pread64f                __UINT32_C(0x800000b4) /* ssize_t pread64f(fd_t fd, void *buf, size_t bufsize, uint64_t offset, iomode_t mode) */
#define __NR32_pwrite64f               __UINT32_C(0x800000b5) /* ssize_t pwrite64f(fd_t fd, void const *buf, size_t bufsize, uint64_t offset, iomode_t mode) */
#define __NR32_kstat                   __UINT32_C(0x800000c3) /* errno_t kstat(char const *filename, struct stat *statbuf) */
#define __NR32_klstat                  __UINT32_C(0x800000c4) /* errno_t klstat(char const *filename, struct stat *statbuf) */
#define __NR32_kfstat                  __UINT32_C(0x800000c5) /* errno_t kfstat(fd_t fd, struct stat *statbuf) */
#define __NR32_kreaddirf               __UINT32_C(0x800000dc) /* ssize_t kreaddirf(fd_t fd, struct dirent *buf, size_t bufsize, syscall_ulong_t mode, iomode_t iomode) */
#define __NR32_timer_settime64         __UINT32_C(0x80000104) /* errno_t timer_settime64(timer_t timerid, syscall_ulong_t flags, struct __itimerspec64 const *value, struct __itimerspec64 *ovalue) */
#define __NR32_timer_gettime64         __UINT32_C(0x80000105) /* errno_t timer_gettime64(timer_t timerid, struct __itimerspec64 *value) */
#define __NR32_clock_settime64         __UINT32_C(0x80000108) /* errno_t clock_settime64(clockid_t clock_id, struct __timespec64 const *tp) */
#define __NR32_clock_gettime64         __UINT32_C(0x80000109) /* errno_t clock_gettime64(clockid_t clock_id, struct __timespec64 *tp) */
#define __NR32_clock_getres64          __UINT32_C(0x8000010a) /* errno_t clock_getres64(clockid_t clock_id, struct __timespec64 *res) */
#define __NR32_clock_nanosleep64       __UINT32_C(0x8000010b) /* errno_t clock_nanosleep64(clockid_t clock_id, syscall_ulong_t flags, struct __timespec64 const *requested_time, struct __timespec64 *remaining) */
#define __NR32_utimes64                __UINT32_C(0x8000010f) /* errno_t utimes64(char const *filename, struct __timeval64 const[2] times) */
/* @param: flags: Set of `0 | AT_DOSPATH' */
#define __NR32_fmkdirat                __UINT32_C(0x80000128) /* errno_t fmkdirat(fd_t dirfd, char const *pathname, mode_t mode, atflag_t flags) */
/* @param: flags: Set of `0 | AT_DOSPATH' */
#define __NR32_fmknodat                __UINT32_C(0x80000129) /* errno_t fmknodat(fd_t dirfd, char const *nodename, mode_t mode, dev_t dev, atflag_t flags) */
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW|AT_CHANGE_CTIME|AT_DOSPATH' */
#define __NR32_futimesat64             __UINT32_C(0x8000012b) /* errno_t futimesat64(fd_t dirfd, const char *filename, struct __timeval64 const[2] times) */
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW|AT_DOSPATH' */
#define __NR32_kfstatat                __UINT32_C(0x8000012c) /* errno_t kfstatat(fd_t dirfd, char const *filename, struct stat *statbuf, atflag_t flags) */
/* @param: flags: Set of `0 | AT_DOSPATH' */
#define __NR32_frenameat               __UINT32_C(0x8000012e) /* errno_t frenameat(fd_t oldfd, char const *oldname, fd_t newfd, char const *newname_or_path, atflag_t flags) */
/* @param: flags: Set of `0 | AT_DOSPATH' */
#define __NR32_fsymlinkat              __UINT32_C(0x80000130) /* errno_t fsymlinkat(char const *link_text, fd_t tofd, char const *target_path, atflag_t flags) */
/* @param: flags: Set of `0 | AT_READLINK_REQSIZE|AT_DOSPATH' */
#define __NR32_freadlinkat             __UINT32_C(0x80000131) /* ssize_t freadlinkat(fd_t dirfd, char const *path, char *buf, size_t buflen, atflag_t flags) */
#define __NR32_pselect6_64             __UINT32_C(0x80000134) /* ssize_t pselect6_64(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct __timespec64 const *timeout, void const *sigmask_sigset_and_len) */
#define __NR32_ppoll64                 __UINT32_C(0x80000135) /* ssize_t ppoll64(struct pollfd *fds, size_t nfds, struct __timespec64 const *timeout_ts, struct __sigset_struct const *sigmask, size_t sigsetsize) */
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW | AT_CHANGE_CTIME | AT_DOSPATH' */
#define __NR32_utimensat64             __UINT32_C(0x80000140) /* errno_t utimensat64(fd_t dirfd, char const *filename, struct __timespec64 const[2] times, atflag_t flags) */
#define __NR32_fallocate64             __UINT32_C(0x80000144) /* errno_t fallocate64(fd_t fd, syscall_ulong_t mode, uint64_t offset, uint64_t length) */
/* Set next expiration time of interval timer source UFD to UTMR.
 * If FLAGS has the TFD_TIMER_ABSTIME flag set the timeout value
 * is absolute. Optionally return the old expiration time in OTMR */
#define __NR32_timerfd_settime64       __UINT32_C(0x80000145) /* errno_t timerfd_settime64(fd_t ufd, syscall_ulong_t flags, struct __itimerspec64 const *utmr, struct __itimerspec64 *otmr) */
/* Return the next expiration time of UFD */
#define __NR32_timerfd_gettime64       __UINT32_C(0x80000146) /* errno_t timerfd_gettime64(fd_t ufd, struct __itimerspec64 *otmr) */
#define __NR32_preadvf                 __UINT32_C(0x8000014d) /* ssize_t preadvf(fd_t fd, struct iovec const *iovec, size_t count, uint64_t offset, iomode_t mode) */
#define __NR32_pwritevf                __UINT32_C(0x8000014e) /* ssize_t pwritevf(fd_t fd, struct iovec const *iovec, size_t count, uint64_t offset, iomode_t mode) */
#define __NR32_recvmmsg64              __UINT32_C(0x80000151) /* ssize_t recvmmsg64(fd_t sockfd, struct mmsghdr *vmessages, size_t vlen, syscall_ulong_t flags, struct __timespec64 *tmo) */
...
#define __NR32_syscall1_min __UINT32_C(0x80000001)
#define __NR32_syscall1_max __UINT32_C(0x80000151)
...
#define __NR32RC_prctl                   1
#define __NR32RC_rt_sigreturn            4
...
#define __NR32RC_getpmsg                 1
#define __NR32RC_putpmsg                 1
...
#define __NR32RC_vserver                 1
#define __NR32RC_mbind                   1
#define __NR32RC_get_mempolicy           1
#define __NR32RC_set_mempolicy           1
#define __NR32RC_mq_open                 1
#define __NR32RC_mq_unlink               1
#define __NR32RC_mq_timedsend            1
#define __NR32RC_mq_timedreceive         1
#define __NR32RC_mq_notify               1
#define __NR32RC_mq_getsetattr           1
...
#define __NR32RC_rpc_service             0
#define __NR32RC_sched_rr_get_interval64 2
#define __NR32RC_nanosleep64             2
#define __NR32RC_rt_sigtimedwait64       4
