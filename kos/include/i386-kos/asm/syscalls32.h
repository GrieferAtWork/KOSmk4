...
#define __NR_lfutexexpr                   __UINT32_C(0xffffffeb) /* errno_t lfutexexpr(uint32_t *ulockaddr, void *base, struct lfutexexprx32 const *expr, struct timespecx32_64 const *timeout, syscall_ulong_t timeout_flags) */
