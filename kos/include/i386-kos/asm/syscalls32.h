...
#define __NR_signal                       0x30                   /* __sigactionx32_sa_handler_t signal(signo_t signo, __sigactionx32_sa_handler_t handler) */
/* >> geteuid(2)
...
#define __NR_sigaction                    0x43                   /* errno_t sigaction(signo_t signo, struct __old_kernel_sigactionx32 const *act, struct __old_kernel_sigactionx32 *oact) */
#define __NR_sgetmask                     0x44                   /* uint32_t sgetmask(void) */
#define __NR_ssetmask                     0x45                   /* uint32_t ssetmask(uint32_t sigmask) */
/* >> setreuid(2)
...
#define __NR_setrlimit                    0x4b                   /* errno_t setrlimit(syscall_ulong_t resource, struct rlimitx32 const *rlimits) */
/* @param: resource: One of `RLIMIT_*' from <sys/resource.h> */
#define __NR_getrlimit                    0x4c                   /* errno_t getrlimit(syscall_ulong_t resource, struct rlimitx32 *rlimits) */
...
#define __NR_statfs                       0x63                   /* errno_t statfs(char const *file, struct statfsx32 *buf) */
#define __NR_fstatfs                      0x64                   /* errno_t fstatfs(fd_t file, struct statfsx32 *buf) */
#define __NR_ioperm                       0x65                   /* errno_t ioperm(syscall_ulong_t from, syscall_ulong_t num, syscall_ulong_t turn_on) */
#define __NR_socketcall                   0x66                   /* __LONG32_TYPE__ socketcall(__ULONG32_TYPE__ call, __ULONG32_TYPE__ *args) */
...
#define __NR_sysinfo                      0x74                   /* errno_t sysinfo(struct __sysinfox32 *info) */
...
#define __NR_create_module                0x7f                   /* errno_t create_module(void) */
...
#define __NR_get_kernel_syms              0x82                   /* errno_t get_kernel_syms(void) */
...
#define __NR_query_module                 0xa7                   /* errno_t query_module(void) */
...
#define __NR_rt_sigaction                 0xae                   /* errno_t rt_sigaction(signo_t signo, struct __kernel_sigactionx32 const *act, struct __kernel_sigactionx32 *oact, size_t sigsetsize) */
/* @param: how: One of `SIG_BLOCK', `SIG_UNBLOCK' or `SIG_SETMASK' */
...
#define __NR_rt_sigqueueinfo              0xb2                   /* errno_t rt_sigqueueinfo(pid_t pid, signo_t usigno, struct __siginfox32_struct const *uinfo) */
/* >> sigsuspend(2), rt_sigsuspend(2)
 * Atomically save and  set the caller's  signal mask to  `set', then wait  for
 * one of the unmasked (iow: `!sigismember')-signals to arrive before restoring
 * the old signal mask.
...
#define __NR_sendfile                     0xbb                   /* ssize_t sendfile(fd_t outfd, fd_t infd, __ULONG32_TYPE__ *pin_offset, size_t num_bytes) */
...
#define __NR_epoll_ctl                    0xff                   /* errno_t epoll_ctl(fd_t epfd, syscall_ulong_t op, fd_t fd, struct epoll_event *info) */
/* >> epoll_wait(2)
 ...
 * @return: -1:       Error (s.a. `errno') */
#define __NR_epoll_wait                   0x100                  /* ssize_t epoll_wait(fd_t epfd, struct epoll_event *events, size_t maxevents, syscall_slong_t timeout) */
...
#define __NR_statfs64                     0x10c                  /* errno_t statfs64(char const *file, struct statfsx32_64 *buf) */
#define __NR_fstatfs64                    0x10d                  /* errno_t fstatfs64(fd_t file, struct statfsx32_64 *buf) */
#define __NR_tgkill                       0x10e                  /* errno_t tgkill(pid_t pid, pid_t tid, signo_t signo) */
/* @param: times:    When NULL, set the current time
...
/* @param: type: Set of `R_OK | W_OK | X_OK' or `F_OK' */
#define __NR_faccessat                    0x133                  /* errno_t faccessat(fd_t dirfd, char const *filename, syscall_ulong_t type) */
#define __NR_pselect6                     0x134                  /* ssize_t pselect6(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct timespecx32 const *timeout, struct __sigset_with_sizex32 const *sigmask_sigset_with_size) */
 ...
 * @return: 0:        No events happened before `timeout' expired.
 * @return: -1:       Error (s.a. `errno') */
#define __NR_epoll_pwait                  0x13f                  /* ssize_t epoll_pwait(fd_t epfd, struct epoll_event *events, size_t maxevents, syscall_slong_t timeout, struct __sigset_struct const *ss, size_t sigsetsize) */
 ...
 * @throw: E_INVALID_ARGUMENT_BAD_VALUE:E_INVALID_ARGUMENT_CONTEXT_RAISE_SIGINFO_BADCODE:  [...]
 * @throw: E_ILLEGAL_OPERATION:                                                            [...] */
#define __NR_rt_tgsigqueueinfo            0x14f                  /* errno_t rt_tgsigqueueinfo(pid_t pid, pid_t tid, signo_t usigno, struct __siginfox32_struct const *uinfo) */
...
/* @param: resource: One of `RLIMIT_*' from <sys/resource.h> */
#define __NR_prlimit64                    0x154                  /* errno_t prlimit64(pid_t pid, syscall_ulong_t resource, struct rlimitx32_64 const *new_limit, struct rlimitx32_64 *old_limit) */
/* @param: flags: Set of `0 | AT_EMPTY_PATH | AT_SYMLINK_FOLLOW | AT_DOSPATH' */
 ...
 * @return: * :  Return value depends on `command' */
#define __NR_arch_prctl                   0x180                  /* syscall_slong_t arch_prctl(unsigned int command, uint32_t *addr) */
...
#define __NR_pselect6_time64              0x19d                  /* ssize_t pselect6_time64(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct timespecx32_64 const *timeout, struct __sigset_with_sizex32 const *sigmask_sigset_with_size) */
...
#define __NR_set_userprocmask_address     __UINT32_C(0xfffffefe) /* errno_t set_userprocmask_address(struct userprocmask *ctl) */
/* >> lfutexexpr(2)
...
#define __NR_lfutexexpr                   __UINT32_C(0xffffff0f) /* errno_t lfutexexpr(uint32_t *futexaddr, void *base, struct lfutexexprx32 const *expr, struct timespecx32_64 const *timeout, syscall_ulong_t flags) */
/* >> lfutex(2)
...
#define __NR_lfutex                       __UINT32_C(0xffffff10) /* syscall_slong_t lfutex(uint32_t *uaddr, syscall_ulong_t futex_op, uint32_t val, struct timespecx32_64 const *timeout, uint32_t val2) */
...
#define __NR_kreaddirf                    __UINT32_C(0xffffff23) /* ssize_t kreaddirf(fd_t fd, struct dirent *buf, size_t bufsize, syscall_ulong_t mode, iomode_t iomode) */
/* @param: mode: One of `READDIR_DEFAULT', `READDIR_CONTINUE', `READDIR_PEEK' or `READDIR_MULTIPLE',
 *               optionally     or'd     with     any     of     `READDIR_SKIPREL | READDIR_WANTEOF' */
#define __NR_kreaddir                     __UINT32_C(0xffffff24) /* ssize_t kreaddir(fd_t fd, struct dirent *buf, size_t bufsize, syscall_ulong_t mode) */
 ...
 * handler functions. */
#define __NR_ksigreturn                   __UINT32_C(0xffffff53) /* void ksigreturn(struct fpustate32 const *restore_fpu, syscall_ulong_t unused1, syscall_ulong_t unused2, struct __sigset_with_sizex32 const *restore_sigmask, struct rpc_syscall_info32 const *sc_info, struct ucpustate32 const *restore_cpu) */
...
#define __NR_rpc_serve_sysret             __UINT32_C(0xffffff61) /* errno_t rpc_serve_sysret(void) */
/* >> rpc_serve(2)
...
#define __NR_select64                     __UINT32_C(0xffffff72) /* ssize_t select64(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct timevalx32_64 *timeout) */
/* Same as `waitpid(pid, STAT_LOC, OPTIONS)', though also fills in `USAGE' when non-NULL
 * @param: options: Set of `WNOHANG | WUNTRACED | WCONTINUED' (as a KOS extension, `WNOWAIT' is also accepted) */
...
#define __NR_userviofd                    __UINT32_C(0xffffffec) /* fd_t userviofd(size_t initial_size, syscall_ulong_t flags) */
...
#define __NR_coredump                     __UINT32_C(0xffffffee) /* errno_t coredump(struct ucpustate32 const *curr_state, struct ucpustate32 const *orig_state, __HYBRID_PTR32(void const) const *traceback_vector, size_t traceback_length, union coredump_info32 const *reason, unwind_errno_t unwind_error) */
...
#define __NR_get_exception_handler        __UINT32_C(0xfffffff0) /* errno_t get_exception_handler(__ULONG32_TYPE__ *pmode, __except_handler32_t *phandler, __HYBRID_PTR32(void) *phandler_sp) */
...
#define __NR_set_exception_handler        __UINT32_C(0xfffffff1) /* errno_t set_exception_handler(syscall_ulong_t mode, except_handler_t handler, void *handler_sp) */
...
#define __NR_mktty                        __UINT32_C(0xfffffff2) /* fd_t mktty(char const *name, fd_t keyboard, fd_t display, syscall_ulong_t rsvd) */
...
#define __NR_rpc_schedule                 __UINT32_C(0xfffffff7) /* errno_t rpc_schedule(pid_t target_tid, syscall_ulong_t mode, void const *program, __HYBRID_PTR32(void const) const *params, size_t max_param_count) */
...
#define __NR_detach                       __UINT32_C(0xfffffff9) /* errno_t detach(pid_t pid) */
/* You may pass `AT_READLINK_REQSIZE' to always have the function return
 * the   required   buffer   size,   rather   than   the   used    size.
 * @param: flags: Set of `0 | AT_ALTPATH | AT_READLINK_REQSIZE | AT_DOSPATH' */
#define __NR_frealpath4                   __UINT32_C(0xfffffffa) /* ssize_t frealpath4(fd_t fd, char *resolved, size_t buflen, atflag_t flags) */
/* Returns a bitset of all of the currently mounted dos-drives */
#define __NR_getdrives                    __UINT32_C(0xfffffffb) /* syscall_slong_t getdrives(void) */
/* Write up to `bufsize' bytes from `buf' into `fd'
 * When `fd' has the `O_NONBLOCK' flag set, only write as much data as
 * possible at the time the call was made, and throw `E_WOULDBLOCK' if
 * no data could be written at the time.
...
#define __NRCP_oldstat
#define __NRCP_lseek
#define __NRCP_mount
#define __NRCP_umount
#define __NRCP_oldfstat
#define __NRCP_pause
#define __NRCP_utime
