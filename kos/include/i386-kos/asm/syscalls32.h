...
#define __NR_recvmmsg64              __UINT32_C(0xfffffeaf) /* ssize_t recvmmsg64(fd_t sockfd, struct mmsghdr *vmessages, size_t vlen, syscall_ulong_t flags, struct __timespecx32_64 *tmo) */
#define __NR_pwritevf                __UINT32_C(0xfffffeb2) /* ssize_t pwritevf(fd_t fd, struct iovec32 const *iovec, size_t count, uint64_t offset, iomode_t mode) */
#define __NR_preadvf                 __UINT32_C(0xfffffeb3) /* ssize_t preadvf(fd_t fd, struct iovec32 const *iovec, size_t count, uint64_t offset, iomode_t mode) */
/* Return the next expiration time of UFD */
#define __NR_timerfd_gettime64       __UINT32_C(0xfffffeba) /* errno_t timerfd_gettime64(fd_t ufd, struct __itimerspecx32_64 *otmr) */
/* Set next expiration time of interval timer source UFD to UTMR.
 * If FLAGS has the TFD_TIMER_ABSTIME flag set the timeout value
 * is absolute. Optionally return the old expiration time in OTMR */
#define __NR_timerfd_settime64       __UINT32_C(0xfffffebb) /* errno_t timerfd_settime64(fd_t ufd, syscall_ulong_t flags, struct __itimerspecx32_64 const *utmr, struct __itimerspecx32_64 *otmr) */
...
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW | AT_CHANGE_CTIME | AT_DOSPATH' */
#define __NR_utimensat64             __UINT32_C(0xfffffec0) /* errno_t utimensat64(fd_t dirfd, char const *filename, struct __timespecx32_64 const[2] times, atflag_t flags) */
#define __NR_ppoll64                 __UINT32_C(0xfffffecb) /* ssize_t ppoll64(struct pollfd *fds, size_t nfds, struct __timespecx32_64 const *timeout_ts, struct __sigset_struct const *sigmask, size_t sigsetsize) */
#define __NR_pselect6_64             __UINT32_C(0xfffffecc) /* ssize_t pselect6_64(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct __timespecx32_64 const *timeout, void const *sigmask_sigset_and_len) */
...
#define __NR_futimesat64             __UINT32_C(0xfffffed5) /* errno_t futimesat64(fd_t dirfd, const char *filename, struct __timevalx32_64 const[2] times) */
/* @param: flags: Set of `0 | AT_DOSPATH' */
...
/* @param: options: At least one of `WEXITED | WSTOPPED | WCONTINUED', optionally or'd with `WNOHANG | WNOWAIT' */
#define __NR_waitid64                __UINT32_C(0xfffffee4) /* errno_t waitid64(syscall_ulong_t idtype, id_t id, struct __siginfo32_struct *infop, syscall_ulong_t options, struct __rusagex32_64 *ru) */
#define __NR_mq_timedreceive64       __UINT32_C(0xfffffee8) /* ssize_t mq_timedreceive64(fd_t mqdes, char *msg_ptr, size_t msg_len, uint32_t *pmsg_prio, struct __timespecx32_64 const *abs_timeout) */
#define __NR_mq_timedsend64          __UINT32_C(0xfffffee9) /* errno_t mq_timedsend64(fd_t mqdes, char const *msg_ptr, size_t msg_len, uint32_t msg_prio, struct __timespecx32_64 const *abs_timeout) */
#define __NR_utimes64                __UINT32_C(0xfffffef1) /* errno_t utimes64(char const *filename, struct __timevalx32_64 const[2] times) */
#define __NR_clock_nanosleep64       __UINT32_C(0xfffffef5) /* errno_t clock_nanosleep64(clockid_t clock_id, syscall_ulong_t flags, struct __timespecx32_64 const *requested_time, struct __timespecx32_64 *remaining) */
#define __NR_clock_getres64          __UINT32_C(0xfffffef6) /* errno_t clock_getres64(clockid_t clock_id, struct __timespecx32_64 *res) */
#define __NR_clock_gettime64         __UINT32_C(0xfffffef7) /* errno_t clock_gettime64(clockid_t clock_id, struct __timespecx32_64 *tp) */
#define __NR_clock_settime64         __UINT32_C(0xfffffef8) /* errno_t clock_settime64(clockid_t clock_id, struct __timespecx32_64 const *tp) */
#define __NR_timer_gettime64         __UINT32_C(0xfffffefb) /* errno_t timer_gettime64(timer_t timerid, struct __itimerspecx32_64 *value) */
#define __NR_timer_settime64         __UINT32_C(0xfffffefc) /* errno_t timer_settime64(timer_t timerid, syscall_ulong_t flags, struct __itimerspecx32_64 const *value, struct __itimerspecx32_64 *ovalue) */
...
#define __NR_rt_sigtimedwait64       __UINT32_C(0xffffff4f) /* syscall_slong_t rt_sigtimedwait64(struct __sigset_struct const *set, struct __siginfo32_struct *info, struct __timespecx32_64 const *timeout, size_t sigsetsize) */
#define __NR_nanosleep64             __UINT32_C(0xffffff5e) /* errno_t nanosleep64(struct __timespecx32_64 const *req, struct __timespecx32_64 *rem) */
#define __NR_sched_rr_get_interval64 __UINT32_C(0xffffff5f) /* errno_t sched_rr_get_interval64(pid_t pid, struct __timespecx32_64 *tms) */
...
#define __NR_writevf                 __UINT32_C(0xffffff6e) /* ssize_t writevf(fd_t fd, struct iovec32 const *iovec, size_t count, iomode_t mode) */
#define __NR_readvf                  __UINT32_C(0xffffff6f) /* ssize_t readvf(fd_t fd, struct iovec32 const *iovec, size_t count, iomode_t mode) */
...
/* Same as `waitpid(pid,STAT_LOC,OPTIONS)', though also fills in `USAGE' when non-NULL
 * @param: options: Set of `WNOHANG|WUNTRACED|WCONTINUED' (as a KOS extension, `WNOWAIT' is also accepted) */
#define __NR_wait4_64                __UINT32_C(0xffffff8e) /* pid_t wait4_64(pid_t pid, int32_t *stat_loc, syscall_ulong_t options, struct __rusagex32_64 *usage) */
#define __NR_getitimer64             __UINT32_C(0xffffff97) /* errno_t getitimer64(syscall_ulong_t which, struct __itimerval64 *curr_value) */
#define __NR_setitimer64             __UINT32_C(0xffffff98) /* errno_t setitimer64(syscall_ulong_t which, struct __itimerval64 const *newval, struct __itimerval64 *oldval) */
...
#define __NR_maplibrary              __UINT32_C(0xffffffaa) /* void *maplibrary(void *addr, syscall_ulong_t flags, fd_t fd, struct elf32_phdr *hdrv, size_t hdrc) */
#define __NR_select64                __UINT32_C(0xffffffae) /* ssize_t select64(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct __timevalx32_64 *timeout) */
#define __NR_settimeofday64          __UINT32_C(0xffffffb1) /* errno_t settimeofday64(struct __timevalx32_64 const *tv, struct timezone const *tz) */
#define __NR_gettimeofday64          __UINT32_C(0xffffffb2) /* errno_t gettimeofday64(struct __timevalx32_64 *tv, struct timezone *tz) */
#define __NR_getrusage64             __UINT32_C(0xffffffb3) /* errno_t getrusage64(syscall_slong_t who, struct __rusagex32_64 *tv) */
...
#define __NR_coredump                __UINT32_C(0xffffffe8) /* errno_t coredump(struct ucpustate32 const *curr_state, struct ucpustate32 const *orig_state, __HYBRID_PTR32(void) const *traceback_vector, size_t traceback_length, struct exception_data32 const *exception, syscall_ulong_t unwind_error) */
...
#define __NR_raiseat                 __UINT32_C(0xffffffe9) /* errno_t raiseat(struct ucpustate32 const *state, struct __siginfo32_struct const *si) */
...
#define __NR_mktty                   __UINT32_C(0xffffffea) /* fd_t mktty(fd_t keyboard, fd_t display, char const *name, syscall_ulong_t rsvd) */
/* >> lfutexlockexpr(2)
...
#define __NR_lfutexlockexpr          __UINT32_C(0xffffffeb) /* errno_t lfutexlockexpr(uint32_t *ulockaddr, void *base, size_t exprc, struct lfutexexpr32 const *exprv, struct __timespecx32_64 const *timeout, syscall_ulong_t timeout_flags) */
/* >> lfutexexpr(2)
 ...
 * @return: -1:EINTR:     A blocking futex-wait operation was interrupted
 * @return: -1:ETIMEDOUT: A blocking futex-wait operation has timed out */
#define __NR_lfutexexpr              __UINT32_C(0xffffffec) /* errno_t lfutexexpr(void *base, size_t exprc, struct lfutexexpr32 const *exprv, struct __timespecx32_64 const *timeout, syscall_ulong_t timeout_flags) */
...
#define __NR_lfutex                  __UINT32_C(0xffffffee) /* syscall_slong_t lfutex(uint32_t *uaddr, syscall_ulong_t futex_op, uint32_t val, struct __timespecx32_64 const *timeout, uint32_t val2) */
...
#define __NR_set_library_listdef     __UINT32_C(0xfffffff0) /* errno_t set_library_listdef(struct library_listdef32 const *listdef) */
...
#define __NR_frealpath4              __UINT32_C(0xfffffff9) /* ssize_t frealpath4(fd_t fd, char *buf, size_t buflen, atflag_t flags) */
