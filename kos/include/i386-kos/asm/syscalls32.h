...
#define __NR_waitid                  0x11c                  /* errno_t waitid(syscall_ulong_t idtype, id_t id, struct __siginfo32_struct *infop, syscall_ulong_t options, struct rusagex32 *ru) */
...
#define __NR_futimesat               0x12b                  /* errno_t futimesat(fd_t dirfd, const char *filename, struct timevalx32 const[2] times) */
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW | AT_DOSPATH' */
...
#define __NR_futimesat64             __UINT32_C(0xfffffed5) /* errno_t futimesat64(fd_t dirfd, const char *filename, struct timevalx32_64 const[2] times) */
/* @param: flags: Set of `0 | AT_DOSPATH' */
...
/* @param: options: At least one of `WEXITED | WSTOPPED | WCONTINUED', optionally or'd with `WNOHANG | WNOWAIT' */
#define __NR_waitid64                __UINT32_C(0xfffffee4) /* errno_t waitid64(syscall_ulong_t idtype, id_t id, struct __siginfo32_struct *infop, syscall_ulong_t options, struct rusagex32_64 *ru) */
