...
#define __NR_ioctl                  0x10                           /* syscall_slong_t ioctl(fd_t fd, syscall_ulong_t command, void *arg) */
...
#define __NR_fcntl                  0x48                           /* syscall_slong_t fcntl(fd_t fd, syscall_ulong_t command, void *arg) */
...
#define __NR_getgroups              0x73                           /* errno_t getgroups(size_t count, gid_t[] list) */
