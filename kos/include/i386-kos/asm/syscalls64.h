...
#define __NR_sigmask_check            __UINT64_C(0xffffffffffffffdb) /* errno_t sigmask_check(void) */
...
#define __NR_coredump                 __UINT64_C(0xffffffffffffffe3) /* errno_t coredump(struct ucpustate64 const *curr_state, struct ucpustate64 const *orig_state, __HYBRID_PTR64(void) const *traceback_vector, size_t traceback_length, struct __exception_data64 const *exception, syscall_ulong_t unwind_error) */
