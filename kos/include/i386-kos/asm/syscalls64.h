...
#define __NR_lfutexexpr               __UINT64_C(0xffffffffffffffe6) /* errno_t lfutexexpr(uint64_t *ulockaddr, void *base, struct lfutexexprx64 const *expr, struct timespecx64 const *timeout, syscall_ulong_t timeout_flags) */
/* >> lfutex(2)
