...
#define __NR_read                      0          /* ssize_t read(fd_t fd, void *buf, size_t bufsize) */
#define __NR_write                     1          /* ssize_t write(fd_t fd, void const *buf, size_t bufsize) */
#define __NR_open                      2          /* fd_t open(char const *filename, oflag_t oflags, mode_t mode) */
/* Close a given file descriptor/handle `FD' */
#define __NR_close                     3          /* errno_t close(fd_t fd) */
#define __NR_linux_stat64              4          /* errno_t linux_stat64(char const *filename, struct linux_stat64 *statbuf) */
#define __NR_linux_fstat64             5          /* errno_t linux_fstat64(fd_t fd, struct linux_stat64 *statbuf) */
#define __NR_linux_lstat64             6          /* errno_t linux_lstat64(char const *filename, struct linux_stat64 *statbuf) */
#define __NR_poll                      7          /* ssize_t poll(struct pollfd *fds, size_t nfds, syscall_slong_t timeout) */
#define __NR_lseek64                   8          /* int64_t lseek64(fd_t fd, int64_t offset, syscall_ulong_t whence) */
/* @param: prot:  Either `PROT_NONE', or set of `PROT_EXEC|PROT_WRITE|PROT_READ|PROT_SEM|PROT_LOOSE|PROT_SHARED'
 * @param: flags: One of `MAP_SHARED`, 'MAP_SHARED_VALIDATE' or `MAP_PRIVATE', optionally or'd
 *               with a set of `MAP_ANONYMOUS|MAP_FIXED|MAP_GROWSDOWN|MAP_LOCKED|
 *               MAP_NONBLOCK|MAP_NORESERVE|MAP_POPULATE|MAP_STACK|MAP_SYNC|
 *               MAP_UNINITIALIZED|MAP_DONT_MAP|MAP_DONT_OVERRIDE' */
#define __NR_mmap                      9          /* void * mmap(void *addr, size_t len, syscall_ulong_t prot, syscall_ulong_t flags, fd_t fd, syscall_ulong_t offset) */
/* @param: prot: Either `PROT_NONE', or set of `PROT_EXEC|PROT_WRITE|PROT_READ|PROT_SEM|PROT_LOOSE|PROT_SHARED' */
#define __NR_mprotect                  10         /* errno_t mprotect(void *addr, size_t len, syscall_ulong_t prot) */
#define __NR_munmap                    11         /* errno_t munmap(void *addr, size_t len) */
#define __NR_brk                       12         /* errno_t brk(void *addr) */
/* @param: signo: One of `SIG*' */
#define __NR_rt_sigaction              13         /* errno_t rt_sigaction(syscall_ulong_t signo, struct sigaction const *act, struct sigaction *oact, size_t sigsetsize) */
/* @param: how: One of `SIG_BLOCK', `SIG_UNBLOCK' or `SIG_SETMASK' */
#define __NR_rt_sigprocmask            14         /* errno_t rt_sigprocmask(syscall_ulong_t how, struct __sigset_struct const *set, struct __sigset_struct *oset, size_t sigsetsize) */
#define __NR_rt_sigreturn              15         /* void rt_sigreturn(void) */
#define __NR_ioctl                     16         /* syscall_slong_t ioctl(fd_t fd, syscall_ulong_t request, void *arg) */
#define __NR_pread64                   17         /* ssize_t pread64(fd_t fd, void *buf, size_t bufsize, uint64_t offset) */
#define __NR_pwrite64                  18         /* ssize_t pwrite64(fd_t fd, void const *buf, size_t bufsize, uint64_t offset) */
#define __NR_readv                     19         /* ssize_t readv(fd_t fd, struct iovec const *iovec, size_t count) */
#define __NR_writev                    20         /* ssize_t writev(fd_t fd, struct iovec const *iovec, size_t count) */
/* @param: type: Set of `R_OK|W_OK|X_OK' or `F_OK' */
#define __NR_access                    21         /* errno_t access(char const *filename, syscall_ulong_t type) */
#define __NR_pipe                      22         /* errno_t pipe([2]fd_t *pipedes) */
#define __NR_select                    23         /* ssize_t select(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct __timeval32 *timeout) */
#define __NR_sched_yield               24         /* errno_t sched_yield(void) */
/* @param: flags: Set of `MREMAP_MAYMOVE|MREMAP_FIXED' */
#define __NR_mremap                    25         /* void * mremap(void *addr, size_t old_len, size_t new_len, syscall_ulong_t flags, void *new_address) */
#define __NR_msync                     26         /* errno_t msync(void *addr, size_t len, syscall_ulong_t flags) */
#define __NR_mincore                   27         /* errno_t mincore(void *start, size_t len, uint8_t *vec) */
#define __NR_madvise                   28         /* errno_t madvise(void *addr, size_t len, syscall_ulong_t advice) */
#define __NR_dup                       32         /* fd_t dup(fd_t fd) */
#define __NR_dup2                      33         /* fd_t dup2(fd_t oldfd, fd_t newfd) */
#define __NR_pause                     34         /* errno_t pause(void) */
#define __NR_nanosleep                 35         /* errno_t nanosleep(struct __timespec32 const *req, struct __timespec32 *rem) */
#define __NR_getitimer                 36         /* errno_t getitimer(syscall_ulong_t which, struct __itimerval32 *curr_value) */
#define __NR_alarm                     37         /* syscall_ulong_t alarm(syscall_ulong_t seconds) */
#define __NR_setitimer                 38         /* errno_t setitimer(syscall_ulong_t which, struct __itimerval32 const *newval, struct __itimerval32 *oldval) */
#define __NR_getpid                    39         /* pid_t getpid(void) */
#define __NR_sendfile                  40         /* ssize_t sendfile(fd_t out_fd, fd_t in_fd, syscall_ulong_t *offset, size_t count) */
#define __NR_socket                    41         /* fd_t socket(syscall_ulong_t domain, syscall_ulong_t type, syscall_ulong_t protocol) */
#define __NR_connect                   42         /* errno_t connect(fd_t sockfd, struct sockaddr const *addr, socklen_t addr_len) */
/* param flags: Set of `MSG_CONFIRM|MSG_DONTROUTE|MSG_DONTWAIT|MSG_EOR|MSG_MORE|MSG_NOSIGNAL|MSG_OOB' */
#define __NR_sendto                    44         /* ssize_t sendto(fd_t sockfd, void const *buf, size_t bufsize, syscall_ulong_t flags, struct sockaddr const *addr, socklen_t addr_len) */
#define __NR_recvfrom                  45         /* ssize_t recvfrom(fd_t sockfd, void *buf, size_t bufsize, syscall_ulong_t flags, struct sockaddr *addr, socklen_t *addr_len) */
#define __NR_sendmsg                   46         /* ssize_t sendmsg(fd_t sockfd, struct msghdr const *message, syscall_ulong_t flags) */
#define __NR_recvmsg                   47         /* ssize_t recvmsg(fd_t sockfd, struct msghdr *message, syscall_ulong_t flags) */
/* @param: how: One of `SHUT_RD', `SHUT_WR' or `SHUT_RDWR' */
#define __NR_shutdown                  48         /* errno_t shutdown(fd_t sockfd, syscall_ulong_t how) */
#define __NR_bind                      49         /* errno_t bind(fd_t sockfd, struct sockaddr const *addr, socklen_t addr_len) */
#define __NR_listen                    50         /* errno_t listen(fd_t sockfd, syscall_ulong_t max_backlog) */
#define __NR_getsockname               51         /* errno_t getsockname(fd_t sockfd, struct sockaddr *addr, socklen_t *addr_len) */
#define __NR_getpeername               52         /* errno_t getpeername(fd_t sockfd, struct sockaddr *addr, socklen_t *addr_len) */
#define __NR_socketpair                53         /* errno_t socketpair(syscall_ulong_t domain, syscall_ulong_t type, syscall_ulong_t protocol, [2]fd_t *fds) */
/* @param: level:   One of `SOL_*' (e.g.: `SOL_SOCKET')
 * @param: optname: Dependent on `level' */
#define __NR_setsockopt                54         /* errno_t setsockopt(fd_t sockfd, syscall_ulong_t level, syscall_ulong_t optname, void const *optval, socklen_t optlen) */
/* @param: level:   One of `SOL_*' (e.g.: `SOL_SOCKET')
 * @param: optname: Dependent on `level' */
#define __NR_getsockopt                55         /* errno_t getsockopt(fd_t sockfd, syscall_ulong_t level, syscall_ulong_t optname, void *optval, socklen_t *optlen) */
#define __NR_clone                     56         /* pid_t clone(syscall_ulong_t flags, void *child_stack, pid_t *ptid, pid_t *ctid, uintptr_t newtls) */
#define __NR_fork                      57         /* pid_t fork(void) */
#define __NR_vfork                     58         /* pid_t vfork(void) */
#define __NR_execve                    59         /* errno_t execve(char const *path, char const *const *argv, char const *const *envp) */
#define __NR_exit                      60         /* void exit(syscall_ulong_t status) */
/* Same as `waitpid(pid,STAT_LOC,OPTIONS)', though also fills in `USAGE' when non-NULL
 * @param: options: Set of `WNOHANG|WUNTRACED|WCONTINUED' (as a KOS extension, `WNOWAIT' is also accepted) */
#define __NR_wait4                     61         /* pid_t wait4(pid_t pid, int32_t *stat_loc, syscall_ulong_t options, struct rusage *usage) */
/* @param: signo: One of `SIG*' */
#define __NR_kill                      62         /* errno_t kill(pid_t pid, syscall_ulong_t signo) */
#define __NR_uname                     63         /* errno_t uname(struct utsname *name) */
#define __NR_fcntl                     72         /* syscall_slong_t fcntl(fd_t fd, syscall_ulong_t cmd, void *arg) */
#define __NR_flock                     73         /* errno_t flock(fd_t fd, syscall_ulong_t operation) */
#define __NR_fsync                     74         /* errno_t fsync(fd_t fd) */
#define __NR_fdatasync                 75         /* errno_t fdatasync(fd_t fd) */
#define __NR_truncate                  76         /* errno_t truncate(char const *filename, syscall_ulong_t length) */
#define __NR_ftruncate                 77         /* errno_t ftruncate(fd_t fd, syscall_ulong_t length) */
#define __NR_getdents                  78         /* ssize_t getdents(fd_t fd, struct linux_dirent *dirp, size_t count) */
#define __NR_getcwd                    79         /* ssize_t getcwd(char *buf, size_t size) */
#define __NR_chdir                     80         /* errno_t chdir(char const *path) */
#define __NR_fchdir                    81         /* errno_t fchdir(fd_t fd) */
#define __NR_rename                    82         /* errno_t rename(char const *oldname, char const *newname_or_path) */
#define __NR_mkdir                     83         /* errno_t mkdir(char const *pathname, mode_t mode) */
#define __NR_rmdir                     84         /* errno_t rmdir(char const *path) */
#define __NR_creat                     85         /* fd_t creat(char const *filename, mode_t mode) */
#define __NR_link                      86         /* errno_t link(char const *existing_file, char const *link_file) */
#define __NR_unlink                    87         /* errno_t unlink(char const *filename) */
#define __NR_symlink                   88         /* errno_t symlink(char const *link_text, char const *target_path) */
#define __NR_readlink                  89         /* ssize_t readlink(char const *path, char *buf, size_t buflen) */
#define __NR_chmod                     90         /* errno_t chmod(char const *filename, mode_t mode) */
#define __NR_fchmod                    91         /* errno_t fchmod(fd_t fd, mode_t mode) */
#define __NR_chown                     92         /* errno_t chown(char const *filename, uint32_t owner, uint32_t group) */
#define __NR_fchown                    93         /* errno_t fchown(fd_t fd, uint32_t owner, uint32_t group) */
#define __NR_lchown                    94         /* errno_t lchown(char const *filename, uint32_t owner, uint32_t group) */
#define __NR_umask                     95         /* mode_t umask(mode_t mode) */
#define __NR_gettimeofday              96         /* errno_t gettimeofday(struct __timeval32 *tv, struct timezone *tz) */
#define __NR_getrlimit                 97         /* errno_t getrlimit(syscall_ulong_t resource, struct rlimit *rlimits) */
#define __NR_getrusage                 98         /* errno_t getrusage(syscall_slong_t who, struct rusage *usage) */
#define __NR_sysinfo                   99         /* errno_t sysinfo(struct sysinfo *info) */
#define __NR_times                     100        /* clock_t times(struct tms *buf) */
#define __NR_ptrace                    101        /* syscall_slong_t ptrace(syscall_ulong_t request, pid_t pid, void *addr, void *data) */
#define __NR_getuid32                  102        /* uint32_t getuid32(void) */
#define __NR_syslog                    103        /* ssize_t syslog(syscall_ulong_t level, char const *str, size_t len) */
#define __NR_getgid32                  104        /* uint32_t getgid32(void) */
#define __NR_setuid32                  105        /* errno_t setuid32(uint32_t uid) */
#define __NR_setgid32                  106        /* errno_t setgid32(uint32_t gid) */
#define __NR_geteuid32                 107        /* uint32_t geteuid32(void) */
#define __NR_getegid32                 108        /* uint32_t getegid32(void) */
#define __NR_setpgid                   109        /* errno_t setpgid(pid_t pid, pid_t pgid) */
#define __NR_getppid                   110        /* pid_t getppid(void) */
#define __NR_getpgrp                   111        /* pid_t getpgrp(void) */
#define __NR_setsid                    112        /* pid_t setsid(void) */
#define __NR_setreuid32                113        /* errno_t setreuid32(uint32_t ruid, uint32_t euid) */
#define __NR_setregid32                114        /* errno_t setregid32(uint32_t rgid, uint32_t egid) */
#define __NR_getgroups32               115        /* errno_t getgroups32(size_t size, []uint32_t *list) */
#define __NR_setgroups32               116        /* errno_t setgroups32(size_t count, uint32_t const *groups) */
#define __NR_setresuid32               117        /* errno_t setresuid32(uint32_t ruid, uint32_t euid, uint32_t suid) */
#define __NR_getresuid32               118        /* errno_t getresuid32(uint32_t *ruid, uint32_t *euid, uint32_t *suid) */
#define __NR_setresgid32               119        /* errno_t setresgid32(uint32_t rgid, uint32_t egid, uint32_t sgid) */
#define __NR_getresgid32               120        /* errno_t getresgid32(uint32_t *rgid, uint32_t *egid, uint32_t *sgid) */
#define __NR_getpgid                   121        /* pid_t getpgid(pid_t pid) */
#define __NR_setfsuid32                122        /* errno_t setfsuid32(uint32_t uid) */
#define __NR_setfsgid32                123        /* errno_t setfsgid32(uint32_t gid) */
#define __NR_getsid                    124        /* pid_t getsid(pid_t pid) */
#define __NR_rt_sigpending             127        /* errno_t rt_sigpending(struct __sigset_struct *set, size_t sigsetsize) */
#define __NR_rt_sigtimedwait           128        /* syscall_slong_t rt_sigtimedwait(struct __sigset_struct const *set, struct __siginfo_struct *info, struct __timespec32 const *timeout, size_t sigsetsize) */
/* @param: signo: One of `SIG*' */
#define __NR_rt_sigqueueinfo           129        /* errno_t rt_sigqueueinfo(pid_t tgid, syscall_ulong_t signo, struct __siginfo_struct const *uinfo) */
#define __NR_rt_sigsuspend             130        /* errno_t rt_sigsuspend(struct __sigset_struct const *set, size_t sigsetsize) */
#define __NR_sigaltstack               131        /* errno_t sigaltstack(struct sigaltstack const *ss, struct sigaltstack *oss) */
#define __NR_utime                     132        /* errno_t utime(char const *filename, struct __utimbuf32 const *times) */
#define __NR_mknod                     133        /* errno_t mknod(char const *nodename, mode_t mode, dev_t dev) */
#define __NR_ustat                     136        /* errno_t ustat(dev_t dev, struct ustat *ubuf) */
#define __NR_statfs                    137        /* errno_t statfs(char const *file, struct __statfs32 *buf) */
#define __NR_fstatfs                   138        /* errno_t fstatfs(fd_t file, struct __statfs32 *buf) */
#define __NR_getpriority               140        /* syscall_slong_t getpriority(syscall_ulong_t which, id_t who) */
#define __NR_setpriority               141        /* errno_t setpriority(syscall_ulong_t which, id_t who, syscall_ulong_t value) */
#define __NR_sched_setparam            142        /* errno_t sched_setparam(pid_t pid, struct sched_param const *param) */
#define __NR_sched_getparam            143        /* errno_t sched_getparam(pid_t pid, struct sched_param *param) */
#define __NR_sched_setscheduler        144        /* errno_t sched_setscheduler(pid_t pid, syscall_ulong_t policy, struct sched_param const *param) */
#define __NR_sched_getscheduler        145        /* syscall_slong_t sched_getscheduler(pid_t pid) */
#define __NR_sched_get_priority_max    146        /* syscall_slong_t sched_get_priority_max(syscall_ulong_t algorithm) */
#define __NR_sched_get_priority_min    147        /* syscall_slong_t sched_get_priority_min(syscall_ulong_t algorithm) */
#define __NR_sched_rr_get_interval     148        /* errno_t sched_rr_get_interval(pid_t pid, struct __timespec32 *tms) */
#define __NR_mlock                     149        /* errno_t mlock(void const *addr, size_t len) */
#define __NR_munlock                   150        /* errno_t munlock(void const *addr, size_t len) */
#define __NR_mlockall                  151        /* errno_t mlockall(syscall_ulong_t flags) */
#define __NR_munlockall                152        /* errno_t munlockall(void) */
#define __NR_vhangup                   153        /* errno_t vhangup(void) */
#define __NR_modify_ldt                154        /* syscall_slong_t modify_ldt(syscall_ulong_t func, void *ptr, syscall_ulong_t bytecount) */
#define __NR_setrlimit                 160        /* errno_t setrlimit(syscall_ulong_t resource, struct rlimit const *rlimits) */
#define __NR_chroot                    161        /* errno_t chroot(char const *path) */
#define __NR_sync                      162        /* errno_t sync(void) */
#define __NR_acct                      163        /* errno_t acct(char const *filename) */
#define __NR_settimeofday              164        /* errno_t settimeofday(struct __timeval32 const *tv, struct timezone const *tz) */
#define __NR_mount                     165        /* errno_t mount(char const *special_file, char const *dir, char const *fstype, syscall_ulong_t rwflag, void const *data) */
#define __NR_umount2                   166        /* errno_t umount2(char const *special_file, syscall_ulong_t flags) */
/* @param: swapflags: Set of `SWAP_FLAG_*' */
#define __NR_swapon                    167        /* errno_t swapon(char const *pathname, syscall_ulong_t swapflags) */
#define __NR_swapoff                   168        /* errno_t swapoff(char const *pathname) */
/* @param: howto: One of the `RB_*' constants from <sys/reboot.h> */
#define __NR_reboot                    169        /* errno_t reboot(syscall_ulong_t how) */
#define __NR_sethostname               170        /* errno_t sethostname(char const *name, size_t len) */
#define __NR_setdomainname             171        /* errno_t setdomainname(char const *name, size_t len) */
#define __NR_iopl                      172        /* errno_t iopl(syscall_ulong_t level) */
#define __NR_ioperm                    173        /* errno_t ioperm(syscall_ulong_t from, syscall_ulong_t num, syscall_ulong_t turn_on) */
#define __NR_gettid                    186        /* pid_t gettid(void) */
#define __NR_readahead                 187        /* ssize_t readahead(fd_t fd, uint64_t offset, size_t count) */
#define __NR_setxattr                  188        /* errno_t setxattr(char const *path, char const *name, void const *buf, size_t bufsize, syscall_ulong_t flags) */
#define __NR_lsetxattr                 189        /* errno_t lsetxattr(char const *path, char const *name, void const *buf, size_t bufsize, syscall_ulong_t flags) */
#define __NR_fsetxattr                 190        /* errno_t fsetxattr(fd_t fd, char const *name, void const *buf, size_t bufsize, syscall_ulong_t flags) */
#define __NR_getxattr                  191        /* ssize_t getxattr(char const *path, char const *name, void *buf, size_t bufsize) */
#define __NR_lgetxattr                 192        /* ssize_t lgetxattr(char const *path, char const *name, void *buf, size_t bufsize) */
#define __NR_fgetxattr                 193        /* ssize_t fgetxattr(fd_t fd, char const *name, void *buf, size_t bufsize) */
#define __NR_listxattr                 194        /* ssize_t listxattr(char const *path, char *listbuf, size_t listbufsize) */
#define __NR_llistxattr                195        /* ssize_t llistxattr(char const *path, char *listbuf, size_t listbufsize) */
#define __NR_flistxattr                196        /* ssize_t flistxattr(fd_t fd, char *listbuf, size_t listbufsize) */
#define __NR_removexattr               197        /* errno_t removexattr(char const *path, char const *name) */
#define __NR_lremovexattr              198        /* errno_t lremovexattr(char const *path, char const *name) */
#define __NR_fremovexattr              199        /* errno_t fremovexattr(int fd, char const *name) */
/* @param: signo: One of `SIG*' */
#define __NR_tkill                     200        /* errno_t tkill(pid_t tid, syscall_ulong_t signo) */
#define __NR_time                      201        /* time32_t time(time32_t *timer) */
#define __NR_futex                     202        /* syscall_slong_t futex(uint32_t *uaddr, syscall_ulong_t futex_op, uint32_t val, struct __timespec32 const *timeout_or_val2, uint32_t *uaddr2, uint32_t val3) */
#define __NR_sched_setaffinity         203        /* errno_t sched_setaffinity(pid_t pid, size_t cpusetsize, struct __cpu_set_struct const *cpuset) */
#define __NR_sched_getaffinity         204        /* errno_t sched_getaffinity(pid_t pid, size_t cpusetsize, struct __cpu_set_struct *cpuset) */
#define __NR_epoll_create              213        /* fd_t epoll_create(syscall_ulong_t size) */
#define __NR_epoll_ctl_old             214        /* errno_t epoll_ctl_old(fd_t epfd, syscall_ulong_t op, fd_t fd, struct epoll_event *event) */
#define __NR_epoll_wait_old            215        /* errno_t epoll_wait_old(fd_t epfd, struct epoll_event *events, syscall_ulong_t maxevents, syscall_slong_t timeout) */
#define __NR_remap_file_pages          216        /* errno_t remap_file_pages(void *start, size_t size, syscall_ulong_t prot, size_t pgoff, syscall_ulong_t flags) */
#define __NR_getdents64                217        /* ssize_t getdents64(fd_t fd, struct linux_dirent64 *dirp, size_t count) */
#define __NR_set_tid_address           218        /* pid_t set_tid_address(pid_t *tidptr) */
#define __NR_timer_create              222        /* errno_t timer_create(clockid_t clock_id, struct sigevent *evp, timer_t *timerid) */
#define __NR_timer_settime             223        /* errno_t timer_settime(timer_t timerid, syscall_ulong_t flags, struct __itimerspec32 const *value, struct __itimerspec32 *ovalue) */
#define __NR_timer_gettime             224        /* errno_t timer_gettime(timer_t timerid, struct __itimerspec32 *value) */
#define __NR_timer_getoverrun          225        /* syscall_slong_t timer_getoverrun(timer_t timerid) */
#define __NR_timer_delete              226        /* errno_t timer_delete(timer_t timerid) */
#define __NR_clock_settime             227        /* errno_t clock_settime(clockid_t clock_id, struct __timespec32 const *tp) */
#define __NR_clock_gettime             228        /* errno_t clock_gettime(clockid_t clock_id, struct __timespec32 *tp) */
#define __NR_clock_getres              229        /* errno_t clock_getres(clockid_t clock_id, struct __timespec32 *res) */
#define __NR_clock_nanosleep           230        /* errno_t clock_nanosleep(clockid_t clock_id, syscall_ulong_t flags, struct __timespec32 const *requested_time, struct __timespec32 *remaining) */
#define __NR_exit_group                231        /* void exit_group(syscall_ulong_t exit_code) */
#define __NR_epoll_wait                232        /* errno_t epoll_wait(fd_t epfd, struct epoll_event *events, syscall_ulong_t maxevents, syscall_slong_t timeout) */
#define __NR_epoll_ctl                 233        /* errno_t epoll_ctl(fd_t epfd, syscall_ulong_t op, fd_t fd, struct epoll_event *event) */
/* @param: signo: One of `SIG*' */
#define __NR_tgkill                    234        /* errno_t tgkill(pid_t tgid, pid_t tid, syscall_ulong_t signo) */
#define __NR_utimes                    235        /* errno_t utimes(char const *filename, [2]struct __timeval32 const *times) */
/* @param: options: At least one of `WEXITED|WSTOPPED|WCONTINUED', optionally or'd with `WNOHANG|WNOWAIT' */
#define __NR_waitid                    247        /* errno_t waitid(idtype_t idtype, id_t id, struct __siginfo_struct *infop, syscall_ulong_t options, struct rusage *ru) */
#define __NR_ioprio_set                251        /* errno_t ioprio_set(syscall_ulong_t which, syscall_ulong_t who, syscall_ulong_t ioprio) */
#define __NR_ioprio_get                252        /* errno_t ioprio_get(syscall_ulong_t which, syscall_ulong_t who) */
#define __NR_openat                    257        /* fd_t openat(fd_t dirfd, char const *filename, oflag_t oflags, mode_t mode) */
#define __NR_mkdirat                   258        /* errno_t mkdirat(fd_t dirfd, char const *pathname, mode_t mode) */
#define __NR_mknodat                   259        /* errno_t mknodat(fd_t dirfd, char const *nodename, mode_t mode, dev_t dev) */
/* @param: flags: Set of `0|AT_SYMLINK_NOFOLLOW|AT_DOSPATH' */
#define __NR_fchownat                  260        /* errno_t fchownat(fd_t dirfd, char const *filename, uint32_t owner, uint32_t group, atflag_t flags) */
#define __NR_futimesat                 261        /* errno_t futimesat(fd_t dirfd, const char *filename, [2]struct __timeval32 const *times) */
#define __NR_fstatat                   262        /* errno_t fstatat(fd_t dirfd, char const *filename, struct linux64_stat32 *statbuf, atflag_t flags) */
/* @param: flags: Set of `0|AT_REMOVEDIR|AT_REMOVEREG|AT_DOSPATH' */
#define __NR_unlinkat                  263        /* errno_t unlinkat(fd_t dirfd, char const *name, atflag_t flags) */
#define __NR_renameat                  264        /* errno_t renameat(fd_t oldfd, char const *oldname, fd_t newfd, char const *newname_or_path) */
/* @param: flags: Set of `0|AT_EMPTY_PATH|AT_SYMLINK_FOLLOW|AT_DOSPATH' */
#define __NR_linkat                    265        /* errno_t linkat(fd_t fromfd, char const *existing_file, fd_t tofd, char const *target_path, atflag_t flags) */
#define __NR_symlinkat                 266        /* errno_t symlinkat(char const *link_text, fd_t tofd, char const *target_path) */
#define __NR_readlinkat                267        /* ssize_t readlinkat(fd_t dirfd, char const *path, char *buf, size_t buflen) */
/* @param: flags: Set of `0|AT_SYMLINK_NOFOLLOW|AT_DOSPATH' */
#define __NR_fchmodat                  268        /* errno_t fchmodat(fd_t dirfd, char const *filename, mode_t mode, atflag_t flags) */
/* @param: type: Set of `R_OK|W_OK|X_OK' or `F_OK'
 * @param: flags: Set of `0|AT_SYMLINK_NOFOLLOW|AT_EACCESS|AT_DOSPATH' */
#define __NR_faccessat                 269        /* errno_t faccessat(fd_t dirfd, char const *filename, syscall_ulong_t type, atflag_t flags) */
#define __NR_pselect6                  270        /* ssize_t pselect6(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct __timespec32 const *timeout, void const *sigmask_sigset_and_len) */
#define __NR_ppoll                     271        /* ssize_t ppoll(struct pollfd *fds, size_t nfds, struct __timespec32 const *timeout_ts, struct __sigset_struct const *sigmask, size_t sigsetsize) */
/* param flags: Set of `CLONE_*' */
#define __NR_unshare                   272        /* errno_t unshare(syscall_ulong_t flags) */
#define __NR_splice                    275        /* ssize_t splice(fd_t fdin, uint64_t *offin, fd_t fdout, uint64_t *offout, size_t length, syscall_ulong_t flags) */
#define __NR_tee                       276        /* ssize_t tee(fd_t fdin, fd_t fdout, size_t length, syscall_ulong_t flags) */
#define __NR_sync_file_range           277        /* errno_t sync_file_range(fd_t fd, uint64_t offset, uint64_t count, syscall_ulong_t flags) */
#define __NR_vmsplice                  278        /* ssize_t vmsplice(fd_t fdout, struct iovec const *iov, size_t count, syscall_ulong_t flags) */
/* @param: flags: Set of `0|AT_SYMLINK_NOFOLLOW|AT_CHANGE_CTIME|AT_DOSPATH' */
#define __NR_utimensat                 280        /* errno_t utimensat(fd_t dirfd, char const *filename, [2-3]struct __timespec32 const *times, atflag_t flags) */
#define __NR_epoll_pwait               281        /* errno_t epoll_pwait(fd_t epfd, struct epoll_event *events, syscall_ulong_t maxevents, syscall_slong_t timeout, struct __sigset_struct const *ss) */
#define __NR_signalfd                  282        /* errno_t signalfd(fd_t fd, struct __sigset_struct const *sigmask, size_t sigsetsize) */
/* Return file descriptor for new interval timer source */
#define __NR_timerfd_create            283        /* fd_t timerfd_create(clockid_t clock_id, syscall_ulong_t flags) */
#define __NR_eventfd                   284        /* fd_t eventfd(syscall_ulong_t initval) */
#define __NR_fallocate                 285        /* errno_t fallocate(fd_t fd, syscall_ulong_t mode, uint32_t offset, uint32_t length) */
...
#define __NR_timerfd_settime           286        /* errno_t timerfd_settime(fd_t ufd, syscall_ulong_t flags, struct __itimerspec32 const *utmr, struct __itimerspec32 *otmr) */
/* Return the next expiration time of UFD */
#define __NR_timerfd_gettime           287        /* errno_t timerfd_gettime(fd_t ufd, struct __itimerspec32 *otmr) */
#define __NR_accept4                   288        /* fd_t accept4(fd_t sockfd, struct sockaddr *addr, socklen_t *addr_len, syscall_ulong_t flags) */
#define __NR_signalfd4                 289        /* errno_t signalfd4(fd_t fd, struct __sigset_struct const *sigmask, size_t sigsetsize, syscall_ulong_t flags) */
#define __NR_eventfd2                  290        /* fd_t eventfd2(syscall_ulong_t initval, syscall_ulong_t flags) */
#define __NR_epoll_create1             291        /* fd_t epoll_create1(syscall_ulong_t flags) */
/* @param: flags:  Set of `O_CLOEXEC|O_CLOFORK' */
#define __NR_dup3                      292        /* fd_t dup3(fd_t oldfd, fd_t newfd, oflag_t flags) */
#define __NR_pipe2                     293        /* errno_t pipe2([2]fd_t *pipedes, oflag_t flags) */
#define __NR_preadv                    295        /* ssize_t preadv(fd_t fd, struct iovec const *iovec, size_t count, uint64_t offset) */
#define __NR_pwritev                   296        /* ssize_t pwritev(fd_t fd, struct iovec const *iovec, size_t count, uint64_t offset) */
/* @param: signo: One of `SIG*' */
#define __NR_rt_tgsigqueueinfo         297        /* errno_t rt_tgsigqueueinfo(pid_t tgid, pid_t tid, syscall_ulong_t signo, struct __siginfo_struct const *uinfo) */
#define __NR_recvmmsg                  299        /* ssize_t recvmmsg(fd_t sockfd, struct mmsghdr *vmessages, size_t vlen, syscall_ulong_t flags, struct __timespec32 *tmo) */
/* @param: resource: One of `RLIMIT_*' from <bits/resource.h> */
#define __NR_prlimit64                 302        /* errno_t prlimit64(pid_t pid, syscall_ulong_t resource, struct rlimit64 const *new_limit, struct rlimit64 *old_limit) */
#define __NR_name_to_handle_at         303        /* errno_t name_to_handle_at(fd_t dirfd, char const *name, struct file_handle *handle, int32_t *mnt_id, syscall_ulong_t flags) */
#define __NR_open_by_handle_at         304        /* fd_t open_by_handle_at(fd_t mountdirfd, struct file_handle *handle, syscall_ulong_t flags) */
#define __NR_syncfs                    306        /* errno_t syncfs(fd_t fd) */
#define __NR_sendmmsg                  307        /* ssize_t sendmmsg(fd_t sockfd, struct mmsghdr *vmessages, size_t vlen, syscall_ulong_t flags) */
#define __NR_setns                     308        /* errno_t setns(fd_t fd, syscall_ulong_t nstype) */
#define __NR_getcpu                    309        /* errno_t getcpu(uint32_t *cpu, uint32_t *node, struct getcpu_cache *tcache) */
#define __NR_process_vm_readv          310        /* ssize_t process_vm_readv(pid_t pid, struct iovec const *lvec, size_t liovcnt, struct iovec const *rvec, size_t riovcnt, syscall_ulong_t flags) */
#define __NR_process_vm_writev         311        /* ssize_t process_vm_writev(pid_t pid, struct iovec const *lvec, size_t liovcnt, struct iovec const *rvec, size_t riovcnt, syscall_ulong_t flags) */
#define __NR_kcmp                      312        /* syscall_slong_t kcmp(pid_t pid1, pid_t pid2, syscall_ulong_t type, syscall_ulong_t idx1, syscall_ulong_t idx2) */
/* @param: flags: Set of `RENAME_EXCHANGE,RENAME_NOREPLACE,RENAME_WHITEOUT' */
#define __NR_renameat2                 316        /* errno_t renameat2(fd_t olddirfd, char const *oldpath, fd_t newdirfd, char const *newpath, syscall_ulong_t flags) */
/* @param: flags: Set of `0|AT_EMPTY_PATH|AT_SYMLINK_NOFOLLOW|AT_DOSPATH' */
#define __NR_execveat                  322        /* errno_t execveat(fd_t dirfd, char const *pathname, char const *const *argv, char const *const *envp, atflag_t flags) */
#define __NR_readf                     0x80000000 /* ssize_t readf(fd_t fd, void *buf, size_t bufsize, iomode_t mode) */
#define __NR_writef                    0x80000001 /* ssize_t writef(fd_t fd, void const *buf, size_t bufsize, iomode_t mode) */
#define __NR_hop                       0x80000002 /* syscall_slong_t hop(fd_t fd, syscall_ulong_t command, void *arg) */
#define __NR_hopf                      0x80000003 /* syscall_slong_t hopf(fd_t fd, syscall_ulong_t command, iomode_t mode, void *arg) */
#define __NR_kstat                     0x80000004 /* errno_t kstat(char const *filename, struct stat *statbuf) */
#define __NR_kfstat                    0x80000005 /* errno_t kfstat(fd_t fd, struct stat *statbuf) */
#define __NR_klstat                    0x80000006 /* errno_t klstat(char const *filename, struct stat *statbuf) */
/* >> detach(2)
...
#define __NR_detach                    0x80000007 /* errno_t detach(pid_t pid) */
/* Returns a bitset of all of the currently mounted dos-drives */
#define __NR_getdrives                 0x80000008 /* syscall_slong_t getdrives(void) */
...
#define __NR_frealpath4                0x80000009 /* ssize_t frealpath4(fd_t fd, char *buf, size_t buflen, atflag_t flags) */
...
#define __NR_frealpathat               0x8000000a /* ssize_t frealpathat(fd_t dirfd, char const *filename, char *buf, size_t buflen, atflag_t flags) */
...
#define __NR_rpc_schedule              0x8000000b /* syscall_slong_t rpc_schedule(pid_t target, syscall_ulong_t flags, uint8_t const *program, void **arguments) */
#define __NR_sysctl                    0x8000000c /* syscall_slong_t sysctl(syscall_ulong_t command, void *arg) */
...
#define __NR_openpty                   0x8000000d /* errno_t openpty(fd_t *amaster, fd_t *aslave, char *name, struct termios const *termp, struct winsize const *winp) */
...
#define __NR_ioctlf                    0x80000010 /* syscall_slong_t ioctlf(fd_t fd, syscall_ulong_t command, iomode_t mode, void *arg) */
#define __NR_pread64f                  0x80000011 /* ssize_t pread64f(fd_t fd, void *buf, size_t bufsize, uint64_t offset, iomode_t mode) */
#define __NR_pwrite64f                 0x80000012 /* ssize_t pwrite64f(fd_t fd, void const *buf, size_t bufsize, uint64_t offset, iomode_t mode) */
#define __NR_readvf                    0x80000013 /* ssize_t readvf(fd_t fd, struct iovec const *iovec, size_t count, iomode_t mode) */
#define __NR_writevf                   0x80000014 /* ssize_t writevf(fd_t fd, struct iovec const *iovec, size_t count, iomode_t mode) */
/* Set per-vm meta-data for allowing the kernel to enumerate loaded code modules */
#define __NR_set_library_listdef       0x80000015 /* errno_t set_library_listdef(struct library_listdef const *listdef) */
...
#define __NR_debugtrap                 0x80000016 /* errno_t debugtrap(struct ucpustate const *state, struct debugtrap_reason const *reason) */
#define __NR_select64                  0x80000017 /* ssize_t select64(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct __timeval64 *timeout) */
#define __NR_rpc_service               0x80000018 /* syscall_slong_t rpc_service(void) */
/* >> lfutex(2)
...
#define __NR_lfutex                    0x80000019 /* syscall_slong_t lfutex(uintptr_t *uaddr, syscall_ulong_t futex_op, uintptr_t val, struct __timespec64 const *timeout, uintptr_t val2) */
/* >> lfutexexpr(2)
...
#define __NR_lfutexexpr                0x8000001a /* errno_t lfutexexpr(void *base, size_t exprc, struct lfutexexpr const *exprv, struct __timespec64 const *timeout, syscall_ulong_t timeout_flags) */
/* >> lfutexlockexpr(2)
 ...
 * @return: -1:EINTR:     A blocking futex-wait operation was interrupted
 * @return: -1:ETIMEDOUT: A blocking futex-wait operation has timed out */
#define __NR_lfutexlockexpr            0x8000001b /* errno_t lfutexlockexpr(uintptr_t *ulockaddr, void *base, size_t exprc, struct lfutexexpr const *exprv, struct __timespec64 const *timeout, syscall_ulong_t timeout_flags) */
...
#define __NR_mktty                     0x8000001c /* fd_t mktty(fd_t keyboard, fd_t display, char const *name, syscall_ulong_t rsvd) */
...
#define __NR_raiseat                   0x8000001d /* errno_t raiseat(struct ucpustate const *state, struct __siginfo_struct const *si) */
...
#define __NR_coredump                  0x8000001e /* errno_t coredump(struct ucpustate const *curr_state, struct ucpustate const *orig_state, void const *const *traceback_vector, size_t traceback_length, struct exception_data const *exception, syscall_ulong_t unwind_error) */
#define __NR_getitimer64               0x80000024 /* errno_t getitimer64(syscall_ulong_t which, struct __itimerval64 *curr_value) */
#define __NR_setitimer64               0x80000026 /* errno_t setitimer64(syscall_ulong_t which, struct __itimerval64 const *newval, struct __itimerval64 *oldval) */
#define __NR_kreaddir                  0x8000004e /* ssize_t kreaddir(fd_t fd, struct dirent *buf, size_t bufsize, syscall_ulong_t mode) */
/* @param: flags: Set of `0|AT_DOSPATH' */
#define __NR_fchdirat                  0x80000050 /* errno_t fchdirat(fd_t dirfd, char const *path, atflag_t flags) */
#define __NR_fsmode                    0x8000005f /* uint64_t fsmode(uint64_t mode) */
#define __NR_gettimeofday64            0x80000060 /* errno_t gettimeofday64(struct __timeval64 *tv, struct timezone *tz) */
#define __NR_utime64                   0x80000084 /* errno_t utime64(char const *filename, struct utimbuf64 const *times) */
...
#define __NR_maplibrary                0x80000086 /* void * maplibrary(void *addr, syscall_ulong_t flags, fd_t fd, void *hdrv, size_t hdrc) */
#define __NR_settimeofday64            0x800000a4 /* errno_t settimeofday64(struct __timeval64 const *tv, struct timezone const *tz) */
#define __NR_time64                    0x800000c9 /* time64_t time64(time64_t *timer) */
#define __NR_kreaddirf                 0x800000d9 /* ssize_t kreaddirf(fd_t fd, struct dirent *buf, size_t bufsize, syscall_ulong_t mode, iomode_t iomode) */
#define __NR_utimes64                  0x800000eb /* errno_t utimes64(char const *filename, [2]struct __timeval64 const *times) */
/* @param: flags: Set of `0|AT_DOSPATH' */
#define __NR_fmkdirat                  0x80000102 /* errno_t fmkdirat(fd_t dirfd, char const *pathname, mode_t mode, atflag_t flags) */
/* @param: flags: Set of `0|AT_DOSPATH' */
#define __NR_fmknodat                  0x80000103 /* errno_t fmknodat(fd_t dirfd, char const *nodename, mode_t mode, dev_t dev, atflag_t flags) */
/* @param: flags: Set of `0|AT_SYMLINK_NOFOLLOW|AT_CHANGE_CTIME|AT_DOSPATH' */
#define __NR_futimesat64               0x80000105 /* errno_t futimesat64(fd_t dirfd, const char *filename, [2-3]struct __timeval64 const *times) */
/* @param: flags: Set of `0|AT_SYMLINK_NOFOLLOW|AT_DOSPATH' */
#define __NR_kfstatat                  0x80000106 /* errno_t kfstatat(fd_t dirfd, char const *filename, struct stat *statbuf, atflag_t flags) */
/* @param: flags: Set of `0|AT_DOSPATH' */
#define __NR_frenameat                 0x80000108 /* errno_t frenameat(fd_t oldfd, char const *oldname, fd_t newfd, char const *newname_or_path, atflag_t flags) */
/* @param: flags: Set of `0|AT_DOSPATH' */
#define __NR_fsymlinkat                0x8000010a /* errno_t fsymlinkat(char const *link_text, fd_t tofd, char const *target_path, atflag_t flags) */
/* @param: flags: Set of `0|AT_READLINK_REQSIZE|AT_DOSPATH' */
#define __NR_freadlinkat               0x8000010b /* ssize_t freadlinkat(fd_t dirfd, char const *path, char *buf, size_t buflen, atflag_t flags) */
#define __NR_fallocate64               0x8000011d /* errno_t fallocate64(fd_t fd, syscall_ulong_t mode, uint64_t offset, uint64_t length) */
#define __NR_preadvf                   0x80000127 /* ssize_t preadvf(fd_t fd, struct iovec const *iovec, size_t count, uint64_t offset, iomode_t mode) */
#define __NR_pwritevf                  0x80000128 /* ssize_t pwritevf(fd_t fd, struct iovec const *iovec, size_t count, uint64_t offset, iomode_t mode) */

#define __NR_syscall_min   0
#define __NR_syscall_max   322
#define __NR_exsyscall_min 0x80000000
#define __NR_exsyscall_max 0x80000128
...
#define __NRRT_rt_sigreturn              void
...
#define __NRRT_epoll_ctl_old             errno_t
#define __NRRT_epoll_wait_old            errno_t
...
#define __NRRT_signalfd                  errno_t
...
#define __NRRT_signalfd4                 errno_t
...
#define __NRAT3_clone                     pid_t *
#define __NRAT4_clone                     uintptr_t
...
#define __NRAT1_chown                     uint32_t
#define __NRAT2_chown                     uint32_t
#define __NRAT0_fchown                    fd_t
#define __NRAT1_fchown                    uint32_t
#define __NRAT2_fchown                    uint32_t
#define __NRAT0_lchown                    char const *
#define __NRAT1_lchown                    uint32_t
#define __NRAT2_lchown                    uint32_t
...
#define __NRAT0_epoll_ctl_old             fd_t
#define __NRAT1_epoll_ctl_old             syscall_ulong_t
#define __NRAT2_epoll_ctl_old             fd_t
#define __NRAT3_epoll_ctl_old             struct epoll_event *
#define __NRAT0_epoll_wait_old            fd_t
#define __NRAT1_epoll_wait_old            struct epoll_event *
#define __NRAT2_epoll_wait_old            syscall_ulong_t
#define __NRAT3_epoll_wait_old            syscall_slong_t
...
#define __NRAT0_fstatat                   fd_t
#define __NRAT1_fstatat                   char const *
#define __NRAT2_fstatat                   struct linux64_stat32 *
#define __NRAT3_fstatat                   atflag_t
...
#define __NRAT0_signalfd                  fd_t
#define __NRAT1_signalfd                  struct __sigset_struct const *
#define __NRAT2_signalfd                  size_t
...
#define __NRAT0_signalfd4                 fd_t
#define __NRAT1_signalfd4                 struct __sigset_struct const *
#define __NRAT2_signalfd4                 size_t
#define __NRAT3_signalfd4                 syscall_ulong_t
...
#define __NRAT0_lfutexexpr                void *
#define __NRAT1_lfutexexpr                size_t
#define __NRAT2_lfutexexpr                struct lfutexexpr const *
#define __NRAT3_lfutexexpr                struct __timespec64 const *
#define __NRAT4_lfutexexpr                syscall_ulong_t
#define __NRAT0_lfutexlockexpr            uintptr_t *
#define __NRAT1_lfutexlockexpr            void *
#define __NRAT2_lfutexlockexpr            size_t
#define __NRAT3_lfutexlockexpr            struct lfutexexpr const *
...
#define __NRAN0_fstatat                   "dirfd"
#define __NRAN1_fstatat                   "filename"
#define __NRAN2_fstatat                   "statbuf"
#define __NRAN3_fstatat                   "flags"
...
#define __NRATRF3_mmap                      "%#Ix=%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s"
...
#define __NRATRF1_lchown                    "%I32u"
#define __NRATRA1_lchown(filename, owner, group) ,owner
#define __NRATRF2_lchown                    "%I32u"
...
#define __NRATRF0_fstatat                   "%d"
#define __NRATRA0_fstatat(dirfd, filename, statbuf, flags) ,(int)(dirfd)
#define __NRATRF1_fstatat                   "%q"
...
#define __NRATRF3_fstatat                   "%#Ix=%s%s%s"
...
#define __NRATRF1_lfutexexpr                "%Iu"
...
#define __NRATRF4_lfutexexpr                "%#Ix"
...
#define __NRATRF2_lfutexlockexpr            "%Iu"
...
#define __NRAC_epoll_ctl_old             4
#define __NRAC_epoll_wait_old            4
...
#define __NRAM_pread64(a, b, c, d, e, f)                   (__fd_t)a, (void *)b, (__size_t)c, (__uint64_t)d
#define __NRAM_pwrite64(a, b, c, d, e, f)                  (__fd_t)a, (void const *)b, (__size_t)c, (__uint64_t)d
...
#define __NRAM_chown(a, b, c, d, e, f)                     (char const *)a, (__uint32_t)b, (__uint32_t)c
#define __NRAM_fchown(a, b, c, d, e, f)                    (__fd_t)a, (__uint32_t)b, (__uint32_t)c
#define __NRAM_lchown(a, b, c, d, e, f)                    (char const *)a, (__uint32_t)b, (__uint32_t)c
...
#define __NRAM_fstatat(a, b, c, d, e, f)                   (__fd_t)a, (char const *)b, (struct linux64_stat32 *)c, (__atflag_t)d
...
#define __NRAM_sync_file_range(a, b, c, d, e, f)           (__fd_t)a, (__uint64_t)b, (__uint64_t)c, (__syscall_ulong_t)d
...
#define __NRAM_preadv(a, b, c, d, e, f)                    (__fd_t)a, (struct iovec const *)b, (__size_t)c, (__uint64_t)d
#define __NRAM_pwritev(a, b, c, d, e, f)                   (__fd_t)a, (struct iovec const *)b, (__size_t)c, (__uint64_t)d
...
#define __NRAM_fallocate64(a, b, c, d, e, f)               (__fd_t)a, (__syscall_ulong_t)b, (__uint64_t)c, (__uint64_t)d
#define __NRAM_preadvf(a, b, c, d, e, f)                   (__fd_t)a, (struct iovec const *)b, (__size_t)c, (__uint64_t)d, (__iomode_t)e
#define __NRAM_pwritevf(a, b, c, d, e, f)                  (__fd_t)a, (struct iovec const *)b, (__size_t)c, (__uint64_t)d, (__iomode_t)e
...
#define __NRAP_epoll_ctl_old(a, b, c, d)                   (__syscall_ulong_t)a, (__syscall_ulong_t)b, (__syscall_ulong_t)c, (__syscall_ulong_t)d
#define __NRAP_epoll_wait_old(a, b, c, d)                  (__syscall_ulong_t)a, (__syscall_ulong_t)b, (__syscall_ulong_t)c, (__syscall_ulong_t)d
...
#define __NRAP_fstatat(a, b, c, d)                         (__syscall_ulong_t)a, (__syscall_ulong_t)b, (__syscall_ulong_t)c, (__syscall_ulong_t)d
...
#define __NRAP_fsmode(a)                                   (__syscall_ulong_t)a
...
#define __NRAP_fallocate64(a, b, c, d)                     (__syscall_ulong_t)a, (__syscall_ulong_t)b, (__syscall_ulong_t)c, (__syscall_ulong_t)d
