...
#define __NRAC_mq_timedreceive64       5
#define __NRAC_mq_timedsend64          5
...
#define __NRRT_linux_oldstat           (errno_t, __errno_t)
...
#define __NRRT_linux_oldfstat          (errno_t, __errno_t)
...
#define __NRRT_linux_oldlstat          (errno_t, __errno_t)
...
#define __NRRT__newselect              (errno_t, __errno_t)
...
#define __NRRT_linux_fstatat64         (errno_t, __errno_t)
...
#define __NRRT_recvmmsg64              (ssize_t, __ssize_t)
...
#define __NRRT_utimensat64             (errno_t, __errno_t)
#define __NRRT_ppoll64                 (ssize_t, __ssize_t)
#define __NRRT_pselect6_64             (ssize_t, __ssize_t)
...
#define __NRRT_mq_timedreceive64       (ssize_t, __ssize_t)
#define __NRRT_mq_timedsend64          (errno_t, __errno_t)
#define __NRRT_utimes64                (errno_t, __errno_t)
#define __NRRT_clock_nanosleep64       (errno_t, __errno_t)
#define __NRRT_clock_getres64          (errno_t, __errno_t)
...
#define __NRRT_rt_sigtimedwait64       (syscall_slong_t, __syscall_slong_t)
#define __NRRT_nanosleep64             (errno_t, __errno_t)
#define __NRRT_sched_rr_get_interval64 (errno_t, __errno_t)
...
#define __NRAT0_linux_oldstat           (char const *, char const *)
#define __NRAT1_linux_oldstat           (struct linux_oldstat *, struct linux_oldstat *)
...
#define __NRAT0_signal                  (syscall_ulong_t, __syscall_ulong_t)
...
#define __NRAT0_sigaction               (syscall_ulong_t, __syscall_ulong_t)
#define __NRAT1_sigaction               (struct sigaction32 const *, struct sigaction32 const *)
#define __NRAT2_sigaction               (struct sigaction32 *, struct sigaction32 *)
...
#define __NRAT0_sigsuspend              (struct __sigset_struct const *, struct __sigset_struct const *)
#define __NRAT0_sigpending              (struct __sigset_struct *, struct __sigset_struct *)
...
#define __NRAT1_linux_oldlstat          (struct linux_oldstat *, struct linux_oldstat *)
...
#define __NRAT0_socketcall              (int, int)
#define __NRAT1_socketcall              (unsigned long *, unsigned long *)
...
#define __NRAT1_linux_lstat             (struct linux_statx32 *, struct linux_statx32 *)
#define __NRAT0_linux_fstat             (fd_t, __fd_t)
#define __NRAT1_linux_fstat             (struct linux_statx32 *, struct linux_statx32 *)
...
#define __NRAT1_sigprocmask             (struct __sigset_struct const *, struct __sigset_struct const *)
#define __NRAT2_sigprocmask             (struct __sigset_struct *, struct __sigset_struct *)
...
#define __NRAT0__newselect              (int, int)
...
#define __NRAT1_rt_sigaction            (struct sigaction32 const *, struct sigaction32 const *)
#define __NRAT2_rt_sigaction            (struct sigaction32 *, struct sigaction32 *)
...
#define __NRAT1_linux_stat64            (struct linux_statx32_64 *, struct linux_statx32_64 *)
#define __NRAT0_linux_lstat64           (char const *, char const *)
#define __NRAT1_linux_lstat64           (struct linux_statx32_64 *, struct linux_statx32_64 *)
#define __NRAT0_linux_fstat64           (fd_t, __fd_t)
#define __NRAT1_linux_fstat64           (struct linux_statx32_64 *, struct linux_statx32_64 *)
...
#define __NRAT3_linux_fstatat64         (atflag_t, __atflag_t)
...
#define __NRAT1_sendmsg                 (struct msghdr32 const *, struct msghdr32 const *)
...
#define __NRAT1_recvmsg                 (struct msghdr32 *, struct msghdr32 *)
...
#define __NRAT0_recvmmsg64              (fd_t, __fd_t)
#define __NRAT1_recvmmsg64              (struct mmsghdrx32 *, struct __mmsghdrx32 *)
#define __NRAT2_recvmmsg64              (size_t, __size_t)
#define __NRAT3_recvmmsg64              (syscall_ulong_t, __syscall_ulong_t)
#define __NRAT4_recvmmsg64              (struct timespecx32_64 const *, struct __timespecx32_64 const *)
...
#define __NRAT2_utimensat64             (struct timespecx32_64 const *, struct __timespecx32_64 const *)
...
#define __NRAT2_ppoll64                 (struct timespecx32_64 const *, struct __timespecx32_64 const *)
#define __NRAT3_ppoll64                 (struct __sigset_struct const *, struct __sigset_struct const *)
#define __NRAT4_ppoll64                 (size_t, __size_t)
#define __NRAT0_pselect6_64             (size_t, __size_t)
...
#define __NRAT4_pselect6_64             (struct timespecx32_64 const *, struct __timespecx32_64 const *)
...
#define __NRAT3_mq_timedreceive64       (uint32_t *, __uint32_t *)
#define __NRAT4_mq_timedreceive64       (struct timespecx32_64 const *, struct __timespecx32_64 const *)
#define __NRAT0_mq_timedsend64          (fd_t, __fd_t)
#define __NRAT1_mq_timedsend64          (char const *, char const *)
#define __NRAT2_mq_timedsend64          (size_t, __size_t)
...
#define __NRAT3_clock_nanosleep64       (struct timespecx32_64 *, struct __timespecx32_64 *)
#define __NRAT0_clock_getres64          (clockid_t, __clockid_t)
#define __NRAT1_clock_getres64          (struct timespecx32_64 *, struct __timespecx32_64 *)
...
#define __NRAT2_rt_sigtimedwait64       (struct timespecx32_64 const *, struct __timespecx32_64 const *)
...
#define __NRAT1_sched_rr_get_interval64 (struct timespecx32_64 *, struct __timespecx32_64 *)
...
#define __NRAT3_maplibrary              (struct elf32_phdr *, struct elf32_phdr *)
...
#define __NRAM_sigaction(a, b, c, d, e, f)               (__syscall_ulong_t)a, (struct sigaction32 const *)b, (struct sigaction32 *)c
...
#define __NRAM_rt_sigaction(a, b, c, d, e, f)            (__syscall_ulong_t)a, (struct sigaction32 const *)b, (struct sigaction32 *)c, (__size_t)d
...
#define __NRAM_linux_stat64(a, b, c, d, e, f)            (char const *)a, (struct linux_statx32_64 *)b
#define __NRAM_linux_lstat64(a, b, c, d, e, f)           (char const *)a, (struct linux_statx32_64 *)b
#define __NRAM_linux_fstat64(a, b, c, d, e, f)           (__fd_t)a, (struct linux_statx32_64 *)b
...
#define __NRAM_waitid(a, b, c, d, e, f)                  (__syscall_ulong_t)a, (__id_t)b, (struct __siginfo32_struct *)c, (__syscall_ulong_t)d, (struct __rusagex32 *)e
...
#define __NRAM_linux_fstatat64(a, b, c, d, e, f)         (__fd_t)a, (char const *)b, (struct linux_statx32_64 *)c, (__atflag_t)d
...
#define __NRAM_sendmsg(a, b, c, d, e, f)                 (__fd_t)a, (struct msghdr32 const *)b, (__syscall_ulong_t)c
#define __NRAM_recvfrom(a, b, c, d, e, f)                (__fd_t)a, (void *)b, (__size_t)c, (__syscall_ulong_t)d, (struct sockaddr *)e, (__socklen_t *)f
#define __NRAM_recvmsg(a, b, c, d, e, f)                 (__fd_t)a, (struct msghdr32 *)b, (__syscall_ulong_t)c
...
#define __NRAM_recvmmsg64(a, b, c, d, e, f)              (__fd_t)a, (struct __mmsghdrx32 *)b, (__size_t)c, (__syscall_ulong_t)d, (struct __timespecx32_64 const *)e
...
#define __NRAM_waitid64(a, b, c, d, e, f)                (__syscall_ulong_t)a, (__id_t)b, (struct __siginfo32_struct *)c, (__syscall_ulong_t)d, (struct __rusagex32_64 *)e
#define __NRAM_mq_timedreceive64(a, b, c, d, e, f)       (__fd_t)a, (char *)b, (__size_t)c, (__uint32_t *)d, (struct __timespecx32_64 const *)e
#define __NRAM_mq_timedsend64(a, b, c, d, e, f)          (__fd_t)a, (char const *)b, (__size_t)c, (__uint32_t)d, (struct __timespecx32_64 const *)e
...
#define __NRAP__newselect(a)                             (__syscall_ulong_t)a
...
#define __NRAP_mq_timedreceive64(a, b, c, d, e)          (__syscall_ulong_t)a, (__syscall_ulong_t)b, (__syscall_ulong_t)c, (__syscall_ulong_t)d, (__syscall_ulong_t)e
#define __NRAP_mq_timedsend64(a, b, c, d, e)             (__syscall_ulong_t)a, (__syscall_ulong_t)b, (__syscall_ulong_t)c, (__syscall_ulong_t)d, (__syscall_ulong_t)e
