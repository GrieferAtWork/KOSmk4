...
#define __NRAM_coredump(a, b, c, d, e, f)                     (struct ucpustate32 const *)a, (struct ucpustate32 const *)b, (__HYBRID_PTR32(void) const *)c, (__size_t)d, (union coredump_info32 const *)e, (__syscall_ulong_t)f
