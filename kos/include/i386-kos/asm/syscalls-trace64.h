...
#define __NRAN0_accept                 TODO_PROTOTYPE
...
#define __NRATRA0_accept(TODO_PROTOTYPE) ,TODO_PROTOTYPE
...
#define __NRATRA1_clone(flags, child_stack, ptid, ctid, newtls) ,child_stack
#define __NRATRF2_clone                  "%p"
#define __NRATRA2_clone(flags, child_stack, ptid, ctid, newtls) ,ptid
#define __NRATRF3_clone                  "%p"
#define __NRATRA3_clone(flags, child_stack, ptid, ctid, newtls) ,ctid
#define __NRATRF4_clone                  "%p"
#define __NRATRA4_clone(flags, child_stack, ptid, ctid, newtls) ,newtls
...
#define __NRATRF0_arch_prctl             "%d"
#define __NRATRA0_arch_prctl(TODO_PROTOTYPE) ,TODO_PROTOTYPE
...
#define __NRATRF0_tuxcall                "%d"
#define __NRATRA0_tuxcall(TODO_PROTOTYPE) ,TODO_PROTOTYPE
#define __NRATRF0_security               "%d"
#define __NRATRA0_security(TODO_PROTOTYPE) ,TODO_PROTOTYPE
...
#define __NRATRF1_epoll_ctl_old          "%#Ix=%s"
#define __NRATRA1_epoll_ctl_old(epfd, op, fd, event) ,(op),(op) == EPOLL_CTL_ADD ? "EPOLL_CTL_ADD" : (op) == EPOLL_CTL_DEL ? "EPOLL_CTL_DEL" : (op) == EPOLL_CTL_MOD ? "EPOLL_CTL_MOD" : "?"
#define __NRATRF2_epoll_ctl_old          "%d"
#define __NRATRA2_epoll_ctl_old(epfd, op, fd, event) ,(int)(fd)
#define __NRATRF3_epoll_ctl_old          "%p"
#define __NRATRA3_epoll_ctl_old(epfd, op, fd, event) ,event
#define __NRATRF0_epoll_wait_old         "%d"
...
#define __NRATRF0_linux_fstatat          "%d"
#define __NRATRA0_linux_fstatat(dirfd, filename, statbuf, flags) ,(int)(dirfd)
#define __NRATRF1_linux_fstatat          "%q"
#define __NRATRA1_linux_fstatat(dirfd, filename, statbuf, flags) ,(validate_readable_opt(filename,1),filename)
#define __NRATRF2_linux_fstatat          "%p"
#define __NRATRA2_linux_fstatat(dirfd, filename, statbuf, flags) ,statbuf
#define __NRATRF3_linux_fstatat          "%#" PRIxSIZ "=%s%s%s"
#define __NRATRA3_linux_fstatat(dirfd, filename, statbuf, flags) ,(uintptr_t)(flags),(flags) & AT_SYMLINK_NOFOLLOW ? "AT_SYMLINK_NOFOLLOW" : "" \
                                                                 ,((flags) & AT_DOSPATH) && ((flags) & (AT_SYMLINK_NOFOLLOW)) ? "|" : "",(flags) & AT_DOSPATH ? "AT_DOSPATH" : ""
...
#define __NRATRF0_kexec_file_load        "%d"
#define __NRATRA0_kexec_file_load(TODO_PROTOTYPE) ,TODO_PROTOTYPE
