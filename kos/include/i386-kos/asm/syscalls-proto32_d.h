...
#define __NR32AT0_sigaltstack             (struct sigaltstack const *, struct sigaltstack const *)
#define __NR32AT1_sigaltstack             (struct sigaltstack *, struct sigaltstack *)
