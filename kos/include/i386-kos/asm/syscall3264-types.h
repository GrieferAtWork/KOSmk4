...
#define HAVE_SC_REPR_STRUCT_SIGMASK_SIGSET_WITH_SIZE_X32
#define HAVE_SC_REPR_STRUCT_SIGMASK_SIGSET_WITH_SIZE_X64
...
__SYSCALL_REPR(SC_REPR_STRUCT_SIGMASK_SIGSET_WITH_SIZE_X32)
__SYSCALL_REPR(SC_REPR_STRUCT_SIGMASK_SIGSET_WITH_SIZE_X64)
