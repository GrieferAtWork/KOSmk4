 ...
 */
#ifndef _I386_KOS_KOS_COMPAT_LINUX_DIRENT_H
#define _I386_KOS_KOS_COMPAT_LINUX_DIRENT_H 1
...
#define linux_direntx32 linux_dirent
#endif /* ... */
...
struct linux_direntx32 {
	...
	__ULONG32_TYPE__                d_off;    /* Offset of next directory entry in containing directory. */
#else /* __USE_KOS_ALTERATIONS */
	__LONG32_TYPE__                 d_off;    /* Offset of next directory entry in containing directory. */
#endif /* !__USE_KOS_ALTERATIONS */
	__UINT16_TYPE__                 d_reclen; /* Record length (`== CEIL_ALIGN(offsetof(struct linux_dirent, d_name) +
	                                           *                               strlen(d_name) + 2, sizeof(void *))') */
	__COMPILER_FLEXIBLE_ARRAY(char, d_name);  /* Entry file name. */
	/*__UINT8_TYPE__               _d_pad;     * Set to ZERO */
	/*__UINT8_TYPE__                d_type;    * File type (One of `DT_*') (offset is `d_reclen - 1') */
};
...
#endif /* !_I386_KOS_KOS_COMPAT_LINUX_DIRENT_H */
