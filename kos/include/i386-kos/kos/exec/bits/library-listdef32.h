 ...
 */
#ifndef _I386_KOS_KOS_EXEC_BITS_LIBRARY_LISTDEF32_H
#define _I386_KOS_KOS_EXEC_BITS_LIBRARY_LISTDEF32_H 1
...
struct library_listdef32 /*[prefix(lld_)]*/ {
	...
	__HYBRID_PTR32(void) lld_count;               /* [0..1] Optional: Number of loaded modules. (the size of this field is `lld_sizeof_pointer')
...
#endif /* !_I386_KOS_KOS_EXEC_BITS_LIBRARY_LISTDEF32_H */
