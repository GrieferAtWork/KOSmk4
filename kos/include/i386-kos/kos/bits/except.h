...
#define __except_register_state_get_unwind_switch(x)           ((__BYTE_TYPE__ const *)(x)->kcs_gpregs.gp_edx)
#define __except_register_state_set_unwind_switch(x, value)    (void)((x)->kcs_gpregs.gp_edx = (__u32)(value))
#endif /* !__x86_64__ */
