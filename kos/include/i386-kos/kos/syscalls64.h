...
__CDECLARE_SC(,__errno_t,rpc_schedule,(__pid_t __target_tid, __syscall_ulong_t __mode, void const *__program, __HYBRID_PTR64(void const) const *__params),(__target_tid,__mode,__program,__params))
 ...
 *                             for why it  may terminate immediately  after
 *                             the RPC program finished. */
__CDECLARE_XSC(,__errno_t,rpc_schedule,(__pid_t __target_tid, __syscall_ulong_t __mode, void const *__program, __HYBRID_PTR64(void const) const *__params),(__target_tid,__mode,__program,__params))
