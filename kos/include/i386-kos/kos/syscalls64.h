...
__CDECLARE_SC(,__errno_t,lfutexexpr,(__uint64_t *__ulockaddr, void *__base, struct lfutexexprx64 const *__expr, struct __timespecx64 const *__timeout, __syscall_ulong_t __timeout_flags),(__ulockaddr,__base,__expr,__timeout,__timeout_flags))
 ...
 * @return: -1:EINTR:     A blocking futex-wait operation was interrupted
 * @return: -1:ETIMEDOUT: A blocking futex-wait operation has timed out */
__CDECLARE_XSC(,__errno_t,lfutexexpr,(__uint64_t *__ulockaddr, void *__base, struct lfutexexprx64 const *__expr, struct __timespecx64 const *__timeout, __syscall_ulong_t __timeout_flags),(__ulockaddr,__base,__expr,__timeout,__timeout_flags))
