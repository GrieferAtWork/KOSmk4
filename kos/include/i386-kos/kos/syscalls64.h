 ...
 *                                   forms a loop with `epfd', or has too many nested.
 * @throw: E_INVALID_ARGUMENT_UNKNOWN_COMMAND:E_INVALID_ARGUMENT_CONTEXT_EPOLL_CTL_OP: [...] */
__CDECLARE_SC(,__errno_t,epoll_ctl_old,(__fd_t __epfd, __syscall_ulong_t __op, __fd_t __fd, struct epoll_event *__info),(__epfd,__op,__fd,__info))
 ...
 * @return: 0:        No events happened before `timeout' expired.
 * @return: -1:       Error (s.a. `errno') */
__CDECLARE_SC(,__ssize_t,epoll_wait_old,(__fd_t __epfd, struct epoll_event *__events, __size_t __maxevents, __syscall_slong_t __timeout),(__epfd,__events,__maxevents,__timeout))
...
__CDECLARE_SC(,__errno_t,futimesat,(__fd_t __dirfd, char const *__filename, struct __timevalx64 const *__times),(__dirfd,__filename,__times))
...
__CDECLARE_SC(,int,inotify_add_watch_at,(__fd_t __notify_fd, __fd_t __dfd, char const *__pathname, __atflag_t __atflags, __uint32_t __mask),(__notify_fd,__dfd,__pathname,__atflags,__mask))
...
__CDECLARE_SC(,__errno_t,lfutexexpr,(__uint64_t *__futexaddr, void *__base, struct lfutexexprx64 const *__expr, struct __timespecx64 const *__timeout, __syscall_ulong_t __flags),(__futexaddr,__base,__expr,__timeout,__flags))
...
__CDECLARE_SC(,__errno_t,lstat,(char const *__filename, struct linux_statx64 *__statbuf),(__filename,__statbuf))
...
__CDECLARE_SC(,void *,maplibrary,(void *__addr, __syscall_ulong_t __flags, __fd_t __fd, struct elf64_phdr const *__hdrv, __size_t __hdrc),(__addr,__flags,__fd,__hdrv,__hdrc))
...
__CDECLARE_SC(,__ssize_t,recvmmsg,(__fd_t __sockfd, struct __mmsghdrx64 *__vmessages, __size_t __vlen, __syscall_ulong_t __msg_flags, struct __timespecx64 const *__tmo),(__sockfd,__vmessages,__vlen,__msg_flags,__tmo))
...
__CDECLARE_SC(,__errno_t,rpc_schedule,(__pid_t __target_tid, __syscall_ulong_t __mode, void const *__program, __HYBRID_PTR64(void const) const *__params, __size_t __max_param_count),(__target_tid,__mode,__program,__params,__max_param_count))
...
__CDECLARE_SC(,__ssize_t,sendmmsg,(__fd_t __sockfd, struct __mmsghdrx64 *__vmessages, __size_t __vlen, __syscall_ulong_t __msg_flags),(__sockfd,__vmessages,__vlen,__msg_flags))
...
__CDECLARE_SC(,__errno_t,stat,(char const *__filename, struct linux_statx64 *__statbuf),(__filename,__statbuf))
...
__CDECLARE_SC(,__errno_t,timerfd_gettime,(__fd_t __timerfd, struct __itimerspecx64 *__otmr),(__timerfd,__otmr))
 ...
 *                           was  never  actually  performed,  and   `reason'  is  actually  a   `siginfo_t *'
 *                           Ignored when `reason == NULL', in which case `UNWIND_SUCCESS' is assumed instead. */
__CDECLARE_XSC(,__errno_t,coredump,(struct ucpustate64 const *__curr_state, struct ucpustate64 const *__orig_state, __HYBRID_PTR64(void const) const *__traceback_vector, __size_t __traceback_length, union coredump_info64 const *__reason, __syscall_ulong_t __unwind_error),(__curr_state,__orig_state,__traceback_vector,__traceback_length,__reason,__unwind_error))
 ...
 *                                   forms a loop with `epfd', or has too many nested.
 * @throw: E_INVALID_ARGUMENT_UNKNOWN_COMMAND:E_INVALID_ARGUMENT_CONTEXT_EPOLL_CTL_OP: [...] */
__CDECLARE_XSC(,__errno_t,epoll_ctl_old,(__fd_t __epfd, __syscall_ulong_t __op, __fd_t __fd, struct epoll_event *__info),(__epfd,__op,__fd,__info))
 ...
 * @return: 0:        No events happened before `timeout' expired.
 * @return: -1:       Error (s.a. `errno') */
__CDECLARE_XSC(,__ssize_t,epoll_wait_old,(__fd_t __epfd, struct epoll_event *__events, __size_t __maxevents, __syscall_slong_t __timeout),(__epfd,__events,__maxevents,__timeout))
...
__CDECLARE_XSC(,__errno_t,futimesat,(__fd_t __dirfd, char const *__filename, struct __timevalx64 const *__times),(__dirfd,__filename,__times))
...
__CDECLARE_XSC(,int,inotify_add_watch_at,(__fd_t __notify_fd, __fd_t __dfd, char const *__pathname, __atflag_t __atflags, __uint32_t __mask),(__notify_fd,__dfd,__pathname,__atflags,__mask))
 ...
 * @return: -1:EINTR:     A blocking futex-wait operation was interrupted
 * @return: -1:ETIMEDOUT: A blocking futex-wait operation has timed out */
__CDECLARE_XSC(,__errno_t,lfutexexpr,(__uint64_t *__futexaddr, void *__base, struct lfutexexprx64 const *__expr, struct __timespecx64 const *__timeout, __syscall_ulong_t __flags),(__futexaddr,__base,__expr,__timeout,__flags))
...
__CDECLARE_XSC(,__errno_t,lstat,(char const *__filename, struct linux_statx64 *__statbuf),(__filename,__statbuf))
 ...
 *                (depending on the caller running in 32- or 64-bit mode)
 * @param: hdrc:  The number of program headers */
__CDECLARE_XSC(,void *,maplibrary,(void *__addr, __syscall_ulong_t __flags, __fd_t __fd, struct elf64_phdr const *__hdrv, __size_t __hdrc),(__addr,__flags,__fd,__hdrv,__hdrc))
 ...
 * @throw: Error (s.a. `recvmsg(2)')
 * @return: * : The # of datagrams successfully received. */
__CDECLARE_XSC(,__ssize_t,recvmmsg,(__fd_t __sockfd, struct __mmsghdrx64 *__vmessages, __size_t __vlen, __syscall_ulong_t __msg_flags, struct __timespecx64 const *__tmo),(__sockfd,__vmessages,__vlen,__msg_flags,__tmo))
 ...
 *                             for why it  may terminate immediately  after
 *                             the RPC program finished. */
__CDECLARE_XSC(,__errno_t,rpc_schedule,(__pid_t __target_tid, __syscall_ulong_t __mode, void const *__program, __HYBRID_PTR64(void const) const *__params, __size_t __max_param_count),(__target_tid,__mode,__program,__params,__max_param_count))
 ...
 * @throw: ... Same as `sendmsg(2)'
 * @return: * : The # of datagrams successfully sent. */
__CDECLARE_XSC(,__ssize_t,sendmmsg,(__fd_t __sockfd, struct __mmsghdrx64 *__vmessages, __size_t __vlen, __syscall_ulong_t __msg_flags),(__sockfd,__vmessages,__vlen,__msg_flags))
...
__CDECLARE_XSC(,__errno_t,stat,(char const *__filename, struct linux_statx64 *__statbuf),(__filename,__statbuf))
...
/* Return the next expiration time of UFD */
__CDECLARE_XSC(,__errno_t,timerfd_gettime,(__fd_t __timerfd, struct __itimerspecx64 *__otmr),(__timerfd,__otmr))
