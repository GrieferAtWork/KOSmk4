...
#   define VGA_CRA_FCURSOR_DISABLE 0x20 /* Disable the text-mode cursor (Added by GrieferAtWork) */
#   define VGA_CRA_FRESERVED       0xc0 /* Mask of reserved registers (Added by GrieferAtWork). */
#define VGA_CRTC_CURSOR_END    0x0b
#   define VGA_CRB_FRESERVED       0x80 /* Mask of reserved registers (Added by GrieferAtWork). */
