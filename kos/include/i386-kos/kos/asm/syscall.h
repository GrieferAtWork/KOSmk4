...
__FORCELOCAL __ATTR_ARTIFICIAL __syscall_ulong_t (__LIBKCALL __x86_syscall0)(__syscall_ulong_t __sysno) { __register __syscall_ulong_t __res; __asm__ __volatile__(__X86_SYSCALL_ASSEMBLY : "=a" (__res) : "0" (__sysno) : "memory", "cc"); return __res; }
__FORCELOCAL __ATTR_ARTIFICIAL __syscall_ulong_t (__LIBKCALL __x86_Xsyscall0)(__syscall_ulong_t __sysno) { __register __syscall_ulong_t __res; __asm__ __volatile__(__X86_XSYSCALL_ASSEMBLY : "=a" (__res) : "0" (__sysno) : "memory", "cc"); return __res; }
__FORCELOCAL __ATTR_ARTIFICIAL __uint64_t (__LIBKCALL __x86_syscall0_dw)(__syscall_ulong_t __sysno) { __register __uint64_t __res; __asm__ __volatile__(__X86_SYSCALL_ASSEMBLY : "=A" (__res) : "a" (__sysno) : "memory", "cc"); return __res; }
__FORCELOCAL __ATTR_ARTIFICIAL __uint64_t (__LIBKCALL __x86_Xsyscall0_dw)(__syscall_ulong_t __sysno) { __register __uint64_t __res; __asm__ __volatile__(__X86_XSYSCALL_ASSEMBLY : "=A" (__res) : "a" (__sysno) : "memory", "cc"); return __res; }
__FORCELOCAL __ATTR_ARTIFICIAL __syscall_ulong_t (__LIBKCALL __x86_syscall1)(__syscall_ulong_t __sysno, __syscall_ulong_t __arg0) { __register __syscall_ulong_t __res; __asm__ __volatile__(__X86_SYSCALL_ASSEMBLY : "=a" (__res) : "0" (__sysno), "b" (__arg0) : "memory", "cc"); return __res; }
__FORCELOCAL __ATTR_ARTIFICIAL __syscall_ulong_t (__LIBKCALL __x86_Xsyscall1)(__syscall_ulong_t __sysno, __syscall_ulong_t __arg0) { __register __syscall_ulong_t __res; __asm__ __volatile__(__X86_XSYSCALL_ASSEMBLY : "=a" (__res) : "0" (__sysno), "b" (__arg0) : "memory", "cc"); return __res; }
__FORCELOCAL __ATTR_ARTIFICIAL __uint64_t (__LIBKCALL __x86_syscall1_dw)(__syscall_ulong_t __sysno, __syscall_ulong_t __arg0) { __register __uint64_t __res; __asm__ __volatile__(__X86_SYSCALL_ASSEMBLY : "=A" (__res) : "a" (__sysno), "b" (__arg0) : "memory", "cc"); return __res; }
__FORCELOCAL __ATTR_ARTIFICIAL __uint64_t (__LIBKCALL __x86_Xsyscall1_dw)(__syscall_ulong_t __sysno, __syscall_ulong_t __arg0) { __register __uint64_t __res; __asm__ __volatile__(__X86_XSYSCALL_ASSEMBLY : "=A" (__res) : "a" (__sysno), "b" (__arg0) : "memory", "cc"); return __res; }
