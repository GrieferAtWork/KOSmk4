...
#endif /* !__x86_64__ || __GLIBC_VERSION__ >= 22600 */
#if defined(_REENTRANT) ? __GLIBC_VERSION__ <= 22900 : __GLIBC_VERSION__ <= 20890
#define __CRT_HAVE___pthread_clock_gettime
#define __CRT_HAVE___pthread_clock_settime
#endif /* _REENTRANT ? __GLIBC_VERSION__ <= 22900 : __GLIBC_VERSION__ <= 20890 */
#if defined(_REENTRANT) ? __GLIBC_VERSION__ >= 20305 : ((__GLIBC_VERSION__ >= 20305 && __GLIBC_VERSION__ <= 22100) || __GLIBC_VERSION__ >= 23400)
#define __CRT_HAVE_pthread_barrier_init
#define __CRT_HAVE_pthread_barrier_wait
#endif /* _REENTRANT ? __GLIBC_VERSION__ >= 20305 : ((__GLIBC_VERSION__ >= 20305 && __GLIBC_VERSION__ <= 22100) || __GLIBC_VERSION__ >= 23400) */
#if defined(_REENTRANT) ? __GLIBC_VERSION__ >= 20305 : __GLIBC_VERSION__ >= 23200
...
#endif /* _REENTRANT ? __GLIBC_VERSION__ >= 20305 : __GLIBC_VERSION__ >= 23200 */
...
#if defined(__x86_64__) ? defined(_REENTRANT) ? __GLIBC_VERSION__ >= 20305 : (__GLIBC_VERSION__ <= 20305 || __GLIBC_VERSION__ >= 23400) : defined(_REENTRANT) ? __GLIBC_VERSION__ >= 20305 : __GLIBC_VERSION__ >= 23400
...
#endif /* __x86_64__ ? _REENTRANT ? __GLIBC_VERSION__ >= 20305 : (__GLIBC_VERSION__ <= 20305 || __GLIBC_VERSION__ >= 23400) : _REENTRANT ? __GLIBC_VERSION__ >= 20305 : __GLIBC_VERSION__ >= 23400 */
...
#if __GLIBC_VERSION__ == 20302 || __GLIBC_VERSION__ >= 22300
#define __CRT_HAVE___libc_pread
#endif /* __GLIBC_VERSION__ == 20302 || __GLIBC_VERSION__ >= 22300 */
...
#if __GLIBC_VERSION__ == 20302 || __GLIBC_VERSION__ >= 23400
#define __CRT_HAVE___libc_sigaction
#endif /* __GLIBC_VERSION__ == 20302 || __GLIBC_VERSION__ >= 23400 */
#if __GLIBC_VERSION__ == 23300
