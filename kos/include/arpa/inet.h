...
#if defined(__CRT_HAVE_inet_addr)
...
#endif /* inet_pton... */
#if defined(__CRT_HAVE_inet_ntop)
...
#endif /* inet_neta... */
#if defined(__CRT_HAVE_inet_net_ntop)
...
#endif /* inet_net_ntop... */
#if defined(__CRT_HAVE_inet_net_pton)
...
#endif /* inet_net_pton... */
#if defined(__CRT_HAVE_inet_nsap_addr)
...
#if defined(__CRT_HAVE_inet_nsap_ntoa)
