...
#ifdef __USE_GNU
/* >> crypt(3), crypt_r(3) */
__CDECLARE_OPT(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2) __ATTR_NONNULL((3)),char *,__NOTHROW_NCX,crypt_r,(char const *__key, char const *__salt, struct crypt_data *__restrict __data),(__key,__salt,__data))
/* >> setkey(3), setkey_r(3) */
__CDECLARE_VOID_OPT(__ATTR_ACCESS_RO(1) __ATTR_NONNULL((2)),__NOTHROW_NCX,setkey_r,(char const *__key, struct crypt_data *__restrict __data),(__key,__data))
/* >> encrypt(3), encrypt_r(3) */
