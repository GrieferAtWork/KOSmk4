...
__CDECLARE(__ATTR_IN(1) __ATTR_INOUT(2),int,__THROWING,putspent,(struct spwd const *__restrict __ent, __FILE *__restrict __stream),(__ent,__stream))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(putspent, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(1) __ATTR_INOUT(2) int (__LIBCCALL putspent)(struct spwd const *__restrict __ent, __FILE *__restrict __stream) __THROWS(...) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(putspent))(__ent, __stream); })
#endif /* ... */
