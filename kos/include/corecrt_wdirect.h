...
__CREDIRECT(__ATTR_ACCESS_WRS(2, 3),wchar_t *,__NOTHROW_RPC,_wgetdcwd,(int __drive, wchar_t *__buf, size_t __size),_wgetdcwd_nolock,(__drive,__buf,__size))
#else /* ... */
...
__NAMESPACE_LOCAL_USING_OR_IMPL(_wgetdcwd, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_WRS(2, 3) wchar_t *__NOTHROW_RPC(__LIBCCALL _wgetdcwd)(int __drive, wchar_t *__buf, size_t __size) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_wgetdcwd))(__drive, __buf, __size); })
...
__NAMESPACE_LOCAL_USING_OR_IMPL(_wmkdir, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) int __NOTHROW_RPC(__LIBCCALL _wmkdir)(wchar_t const *__path) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_wmkdir))(__path); })
#endif /* ... */
