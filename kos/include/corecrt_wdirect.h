...
__CDECLARE(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,_wmkdir,(wchar_t const *__path),(__path))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(_wmkdir, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_NONNULL((1)) int __NOTHROW_RPC(__LIBCCALL _wmkdir)(wchar_t const *__path) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_wmkdir))(__path); })
#endif /* ... */
