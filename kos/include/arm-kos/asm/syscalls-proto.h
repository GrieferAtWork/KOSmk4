...
#define __NRAC_arm_fadvise64_64             1
#define __NRAC_pciconfig_iobase             1
#define __NRAC_pciconfig_read               1
#define __NRAC_pciconfig_write              1
...
#define __NRRT_socketcall                   (syscall_slong_t, __syscall_slong_t)
...
#define __NRRT_syscall                      (errno_t, __errno_t)
...
#define __NRRT_arm_fadvise64_64             (errno_t, __errno_t)
#define __NRRT_pciconfig_iobase             (errno_t, __errno_t)
#define __NRRT_pciconfig_read               (errno_t, __errno_t)
#define __NRRT_pciconfig_write              (errno_t, __errno_t)
...
#define __NRRT_vserve                       (errno_t, __errno_t)
...
#define __NRAT1_utime                        (struct utimbuf32 const *, struct __utimbuf32 const *)
...
#define __NRAT1_sigaction                    (struct __old_kernel_sigaction const *, struct __old_kernel_sigaction const *)
#define __NRAT2_sigaction                    (struct __old_kernel_sigaction *, struct __old_kernel_sigaction *)
...
#define __NRAT0_select                       (struct sel_arg_struct const *, struct sel_arg_struct const *)
...
#define __NRAT0_syscall                      (int, int)
...
#define __NRAT0_adjtimex                     (struct timex32 *, struct timex32 *)
...
#define __NRAT4__newselect                   (struct timeval32 *, struct __timeval32 *)
...
#define __NRAT1_sched_rr_get_interval        (struct timespec32 *, struct __timespec32 *)
#define __NRAT0_nanosleep                    (struct timespec32 const *, struct __timespec32 const *)
#define __NRAT1_nanosleep                    (struct timespec32 *, struct __timespec32 *)
...
#define __NRAT2_rt_sigtimedwait              (struct timespec32 const *, struct __timespec32 const *)
...
#define __NRAT1_stat64                       (struct linux_stat64 *, struct linux_stat64 *)
#define __NRAT0_lstat64                      (char const *, char const *)
#define __NRAT1_lstat64                      (struct linux_stat64 *, struct linux_stat64 *)
#define __NRAT0_fstat64                      (fd_t, __fd_t)
#define __NRAT1_fstat64                      (struct linux_stat64 *, struct linux_stat64 *)
...
#define __NRAT3_futex                        (struct timespec32 const *, struct __timespec32 const *)
...
#define __NRAT2_timer_settime                (struct itimerspec32 const *, struct __itimerspec32 const *)
#define __NRAT3_timer_settime                (struct itimerspec32 *, struct __itimerspec32 *)
#define __NRAT0_timer_gettime                (timer_t, __timer_t)
#define __NRAT1_timer_gettime                (struct itimerspec32 *, struct __itimerspec32 *)
...
#define __NRAT1_clock_settime                (struct timespec32 const *, struct __timespec32 const *)
#define __NRAT0_clock_gettime                (clockid_t, __clockid_t)
#define __NRAT1_clock_gettime                (struct timespec32 *, struct __timespec32 *)
#define __NRAT0_clock_getres                 (clockid_t, __clockid_t)
#define __NRAT1_clock_getres                 (struct timespec32 *, struct __timespec32 *)
...
#define __NRAT1_utimes                       (struct timeval32 const *, struct __timeval32 const *)
#define __NRAT0_arm_fadvise64_64             (int, int)
#define __NRAT0_pciconfig_iobase             (int, int)
#define __NRAT0_pciconfig_read               (int, int)
#define __NRAT0_pciconfig_write              (int, int)
...
#define __NRAT4_mq_timedsend                 (struct timespec32 const *, struct __timespec32 const *)
...
#define __NRAT4_mq_timedreceive              (struct timespec32 const *, struct __timespec32 const *)
...
#define __NRAT2_futimesat                    (struct timeval32 const *, struct __timeval32 const *)
#define __NRAT0_fstatat64                    (fd_t, __fd_t)
#define __NRAT1_fstatat64                    (char const *, char const *)
#define __NRAT2_fstatat64                    (struct linux_stat64 *, struct linux_stat64 *)
...
#define __NRAT4_pselect6                     (struct timespec32 const *, struct __timespec32 const *)
...
#define __NRAT2_ppoll                        (struct timespec32 const *, struct __timespec32 const *)
...
#define __NRAT2_utimensat                    (struct timespec32 const *, struct __timespec32 const *)
...
#define __NRAT2_timerfd_settime              (struct itimerspec32 const *, struct __itimerspec32 const *)
#define __NRAT3_timerfd_settime              (struct itimerspec32 *, struct __itimerspec32 *)
#define __NRAT0_timerfd_gettime              (fd_t, __fd_t)
#define __NRAT1_timerfd_gettime              (struct itimerspec32 *, struct __itimerspec32 *)
...
#define __NRAT1_clock_gettime64              (struct timespec64 *, struct __timespec64 *)
#define __NRAT0_clock_settime64              (clockid_t, __clockid_t)
#define __NRAT1_clock_settime64              (struct timespec64 const *, struct __timespec64 const *)
#define __NRAT0_clock_adjtime64              (int, int)
#define __NRAT0_clock_getres_time64          (clockid_t, __clockid_t)
#define __NRAT1_clock_getres_time64          (struct timespec64 *, struct __timespec64 *)
...
#define __NRAT2_clock_nanosleep_time64       (struct timespec64 const *, struct __timespec64 const *)
#define __NRAT3_clock_nanosleep_time64       (struct timespec64 *, struct __timespec64 *)
#define __NRAT0_timer_gettime64              (timer_t, __timer_t)
#define __NRAT1_timer_gettime64              (struct itimerspec64 *, struct __itimerspec64 *)
#define __NRAT0_timer_settime64              (timer_t, __timer_t)
#define __NRAT1_timer_settime64              (syscall_ulong_t, __syscall_ulong_t)
#define __NRAT2_timer_settime64              (struct itimerspec64 const *, struct __itimerspec64 const *)
#define __NRAT3_timer_settime64              (struct itimerspec64 *, struct __itimerspec64 *)
#define __NRAT0_timerfd_gettime64            (fd_t, __fd_t)
#define __NRAT1_timerfd_gettime64            (struct itimerspec64 *, struct __itimerspec64 *)
#define __NRAT0_timerfd_settime64            (fd_t, __fd_t)
#define __NRAT1_timerfd_settime64            (syscall_ulong_t, __syscall_ulong_t)
#define __NRAT2_timerfd_settime64            (struct itimerspec64 const *, struct __itimerspec64 const *)
#define __NRAT3_timerfd_settime64            (struct itimerspec64 *, struct __itimerspec64 *)
#define __NRAT0_utimensat_time64             (fd_t, __fd_t)
#define __NRAT1_utimensat_time64             (char const *, char const *)
#define __NRAT2_utimensat_time64             (struct timespec64 const *, struct __timespec64 const *)
...
#define __NRAT4_pselect6_time64              (struct timespec64 const *, struct __timespec64 const *)
#define __NRAT5_pselect6_time64              (struct sigset_with_size const *, struct sigset_with_size const *)
#define __NRAT0_ppoll_time64                 (struct pollfd *, struct pollfd *)
#define __NRAT1_ppoll_time64                 (size_t, __size_t)
#define __NRAT2_ppoll_time64                 (struct timespec64 const *, struct __timespec64 const *)
...
#define __NRAT4_mq_timedsend_time64          (struct timespec64 const *, struct __timespec64 const *)
...
#define __NRAT4_mq_timedreceive_time64       (struct timespec64 const *, struct __timespec64 const *)
...
#define __NRAT1_rt_sigtimedwait_time64       (struct __siginfo_struct *, struct __siginfo_struct *)
#define __NRAT2_rt_sigtimedwait_time64       (struct timespec64 const *, struct __timespec64 const *)
...
#define __NRAT3_futex_time64                 (struct timespec64 const *, struct __timespec64 const *)
...
#define __NRAT1_sched_rr_get_interval_time64 (struct timespec64 *, struct __timespec64 *)
#define __NRAT0_pidfd_send_signal            (fd_t, __fd_t)
#define __NRAT1_pidfd_send_signal            (signo_t, __signo_t)
#define __NRAT2_pidfd_send_signal            (struct __siginfo_struct const *, struct __siginfo_struct const *)
