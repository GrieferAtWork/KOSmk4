...
#define __NR_fallocate64                  __UINT32_C(0xfffffea0) /* errno_t fallocate64(fd_t fd, syscall_ulong_t mode, uint64_t offset, uint64_t length) */
/* Same as  `writev(2)', but  write data  to a  file at  a
 * specific `offset', rather than the current R/W position
 * @return: <= SUM(iov[*].iov_len): The actual amount of written bytes */
#define __NR_pwritevf                     __UINT32_C(0xfffffeb2) /* ssize_t pwritevf(fd_t fd, struct iovec const *iovec, size_t count, uint64_t offset, iomode_t mode) */
/* Same as  `readv(2)', but  read data  from a  file at  a
 * specific `offset', rather than the current R/W position
 * @return: <= SUM(iov[*].iov_len): The actual amount of read bytes */
#define __NR_preadvf                      __UINT32_C(0xfffffeb3) /* ssize_t preadvf(fd_t fd, struct iovec const *iovec, size_t count, uint64_t offset, iomode_t mode) */
/* @param: flags: Set of `0 | AT_READLINK_REQSIZE | AT_DOSPATH' */
#define __NR_freadlinkat                  __UINT32_C(0xfffffeb4) /* ssize_t freadlinkat(fd_t dirfd, char const *path, char *buf, size_t buflen, atflag_t flags) */
/* @param: flags: Set of `0 | AT_DOSPATH' */
#define __NR_fsymlinkat                   __UINT32_C(0xfffffeb5) /* errno_t fsymlinkat(char const *link_text, fd_t tofd, char const *target_path, atflag_t flags) */
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW | AT_DOSPATH' */
#define __NR_kfstatat                     __UINT32_C(0xfffffeb9) /* errno_t kfstatat(fd_t dirfd, char const *filename, struct __kos_stat *statbuf, atflag_t flags) */
#define __NR_futimesat64                  __UINT32_C(0xfffffeba) /* errno_t futimesat64(fd_t dirfd, char const *filename, struct timeval64 const[2] times) */
/* @param: flags: Set of `0 | AT_DOSPATH' */
#define __NR_fmknodat                     __UINT32_C(0xfffffebc) /* errno_t fmknodat(fd_t dirfd, char const *nodename, mode_t mode, dev_t dev, atflag_t flags) */
/* @param: flags: Set of `0 | AT_DOSPATH' */
#define __NR_fmkdirat                     __UINT32_C(0xfffffebd) /* errno_t fmkdirat(fd_t dirfd, char const *pathname, mode_t mode, atflag_t flags) */
/* @param: atflags: Set of `AT_SYMLINK_NOFOLLOW | AT_DOSPATH'
 * @param: mask:    Set of `IN_ALL_EVENTS | ...' */
#define __NR_inotify_add_watch_at         __UINT32_C(0xfffffec3) /* int inotify_add_watch_at(fd_t notify_fd, fd_t dirfd, char const *pathname, atflag_t atflags, uint32_t mask) */
/* @param: idtype:  One of `P_ALL', `P_PID', `P_PGID'
 * @param: options: At least one of `WEXITED', `WSTOPPED', `WCONTINUED', optionally or'd with `WNOHANG | WNOWAIT' */
#define __NR_waitid64                     __UINT32_C(0xfffffee8) /* errno_t waitid64(syscall_ulong_t idtype, id_t id, struct __siginfo_struct *infop, syscall_ulong_t options, struct rusage64 *ru) */
/* @param: times:    When NULL, set the current time
 * @param: times[0]: New access time
 * @param: times[1]: New last-modified time */
#define __NR_utimes64                     __UINT32_C(0xfffffef3) /* errno_t utimes64(char const *filename, struct timeval64 const[2] times) */
...
#define __NR_set_userprocmask_address     __UINT32_C(0xffffff00) /* errno_t set_userprocmask_address(struct userprocmask *ctl) */
/* >> lfutexexpr(2)
...
#define __NR_lfutexexpr                   __UINT32_C(0xffffff0f) /* errno_t lfutexexpr(uintptr_t *futexaddr, void *base, struct lfutexexpr const *expr, struct timespec const *timeout, syscall_ulong_t flags) */
/* >> lfutex(2)
...
#define __NR_lfutex                       __UINT32_C(0xffffff10) /* syscall_slong_t lfutex(uintptr_t *uaddr, syscall_ulong_t futex_op, uintptr_t val, struct timespec64 const *timeout, uintptr_t val2) */
...
#define __NR_kreaddirf                    __UINT32_C(0xffffff26) /* ssize_t kreaddirf(fd_t fd, struct dirent *buf, size_t bufsize, syscall_ulong_t mode, iomode_t iomode) */
/* @param: mode: One of `READDIR_DEFAULT', `READDIR_CONTINUE', `READDIR_PEEK' or `READDIR_MULTIPLE',
 *               optionally     or'd     with     any     of     `READDIR_SKIPREL | READDIR_WANTEOF' */
#define __NR_kreaddir                     __UINT32_C(0xffffff27) /* ssize_t kreaddir(fd_t fd, struct dirent *buf, size_t bufsize, syscall_ulong_t mode) */
 ...
 * @return: <= SUM(iov[*].iov_len): The actual amount of written bytes
 * @return: 0                     : No more data can be written */
#define __NR_writevf                      __UINT32_C(0xffffff6e) /* ssize_t writevf(fd_t fd, struct iovec const *iovec, size_t count, iomode_t mode) */
/* Same as `read(2)', but rather than specifying a single, continuous buffer,
 * read  data into `count'  separate buffers, though  still return the actual
 * number of read bytes.
 * When `fd' has the `O_NONBLOCK' flag set, only read as much data as was
 ...
 * @return: <= SUM(iov[*].iov_len): The actual amount of read bytes
 * @return: 0                     : EOF */
#define __NR_readvf                       __UINT32_C(0xffffff6f) /* ssize_t readvf(fd_t fd, struct iovec const *iovec, size_t count, iomode_t mode) */
#define __NR_select64                     __UINT32_C(0xffffff72) /* ssize_t select64(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct timeval64 *timeout) */
/* Same as `waitpid(pid, STAT_LOC, OPTIONS)', though also fills in `USAGE' when non-NULL
 * @param: options: Set of `WNOHANG | WUNTRACED | WCONTINUED' (as a KOS extension, `WNOWAIT' is also accepted) */
#define __NR_wait4_64                     __UINT32_C(0xffffff8e) /* pid_t wait4_64(pid_t pid, int32_t *stat_loc, syscall_ulong_t options, struct rusage64 *usage) */
/* @param: which: One of `ITIMER_REAL', `ITIMER_VIRTUAL' or `ITIMER_PROF' */
...
/* @param: who: One of `RUSAGE_SELF', `RUSAGE_CHILDREN' or `RUSAGE_THREAD' */
#define __NR_getrusage64                  __UINT32_C(0xffffffb3) /* errno_t getrusage64(syscall_slong_t who, struct rusage64 *tv) */
...
#define __NR_ftime64                      __UINT32_C(0xffffffdd) /* errno_t ftime64(struct timeb64 *tp) */
/* @param: times: When NULL, set the current time */
#define __NR_utime64                      __UINT32_C(0xffffffe2) /* errno_t utime64(char const *filename, struct utimbuf64 const *times) */
...
#define __NR_coredump                     __UINT32_C(0xffffffee) /* errno_t coredump(struct ucpustate const *curr_state, struct ucpustate const *orig_state, void const *const *traceback_vector, size_t traceback_length, union coredump_info const *reason, syscall_ulong_t unwind_error) */
...
#define __NR_debugtrap                    __UINT32_C(0xffffffef) /* errno_t debugtrap(struct ucpustate const *state, struct debugtrap_reason const *reason) */
...
#define __NR_get_exception_handler        __UINT32_C(0xfffffff0) /* errno_t get_exception_handler(syscall_ulong_t *pmode, except_handler_t *phandler, void **phandler_sp) */
...
#define __NR_time64                       __UINT32_C(0xfffffff3) /* time64_t time64(time64_t *timer) */
/* @param: flags: Set of `0 | AT_DOSPATH' */
...
#define __NR_rpc_schedule                 __UINT32_C(0xfffffff7) /* errno_t rpc_schedule(pid_t target_tid, syscall_ulong_t mode, void const *program, void const *const *params, size_t max_param_count) */
...
#define __NR_syscall1_min __UINT32_C(0xfffffea0)
#define __NR_syscall1_max __UINT32_C(0xffffffff)
#define __NR_syscall1_cnt 0x160
