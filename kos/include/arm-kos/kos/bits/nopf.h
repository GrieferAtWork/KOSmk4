...
__NOTHROW(__arch_writeb_nopf)(void __USER __CHECKED const *__addr, __uint8_t __val) {
	__BOOL __error;
...
#define __arch_writew_nopf __arch_writew_nopf
__FORCELOCAL __NOBLOCK __ATTR_ARTIFICIAL __ATTR_WUNUSED __BOOL
__NOTHROW(__arch_writew_nopf)(void __USER __CHECKED const *__addr, __uint16_t __val) {
	__BOOL __error;
	__register_var(__uint32_t, __r0, "r0") = (__uint32_t)__val;
	__register_var(__uint32_t, __r1, "r1") = (__uint32_t)__addr;
...
#define __arch_writel_nopf __arch_writel_nopf
__FORCELOCAL __NOBLOCK __ATTR_ARTIFICIAL __ATTR_WUNUSED __BOOL
__NOTHROW(__arch_writel_nopf)(void __USER __CHECKED const *__addr, __uint32_t __val) {
	__BOOL __error;
	__register_var(__uint32_t, __r0, "r0") = (__uint32_t)__val;
	__register_var(__uint32_t, __r1, "r1") = (__uint32_t)__addr;
...
#define __arch_writeq_nopf __arch_writeq_nopf
__FORCELOCAL __NOBLOCK __ATTR_ARTIFICIAL __ATTR_WUNUSED __BOOL
__NOTHROW(__arch_writeq_nopf)(void __USER __CHECKED const *__addr, __uint64_t __val) {
	__BOOL __error;
	__register_var(__uint32_t, __r0, "r0") = (__uint32_t)__val;
