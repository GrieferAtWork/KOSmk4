 ...
 */
#ifndef _ARM_KOS_KOS_SYSCALLS_H
#define _ARM_KOS_KOS_SYSCALLS_H 1
...
__CDECLARE_SC(,__ssize_t,_newselect,(__size_t __nfds, struct __fd_set_struct *__readfds, struct __fd_set_struct *__writefds, struct __fd_set_struct *__exceptfds, struct __timeval32 *__timeout),(__nfds,__readfds,__writefds,__exceptfds,__timeout))
...
__CDECLARE_SC(,__errno_t,adjtimex,(struct timex32 *__ntx),(__ntx))
...
__CDECLARE_SC(,__errno_t,clock_getres_time64,(__clockid_t __clock_id, struct __timespec64 *__res),(__clock_id,__res))
...
__CDECLARE_SC(,__errno_t,clock_nanosleep_time64,(__clockid_t __clock_id, __syscall_ulong_t __flags, struct __timespec64 const *__requested_time, struct __timespec64 *__remaining),(__clock_id,__flags,__requested_time,__remaining))
...
__CDECLARE_SC(,__errno_t,fstat64,(__fd_t __fd, struct linux_stat64 *__statbuf),(__fd,__statbuf))
...
__CDECLARE_SC(,__errno_t,ftime64,(struct __timeb64 *__tp),(__tp))
...
/* @param: futex_op: One of `FUTEX_*' from <linux/futex.h> */
__CDECLARE_SC(,__syscall_slong_t,futex_time64,(__uint32_t *__uaddr, __syscall_ulong_t __futex_op, __uint32_t __val, struct __timespec64 const *__timeout_or_val2, __uint32_t *__uaddr2, __uint32_t __val3),(__uaddr,__futex_op,__val,__timeout_or_val2,__uaddr2,__val3))
#endif /* __CRT_HAVE_SC(futex_time64) */
#if __CRT_HAVE_SC(futimesat)
__CDECLARE_SC(,__errno_t,futimesat,(__fd_t __dirfd, char const *__filename, struct __timeval32 const *__times),(__dirfd,__filename,__times))
#endif /* __CRT_HAVE_SC(futimesat) */
#if __CRT_HAVE_SC(futimesat64)
__CDECLARE_SC(,__errno_t,futimesat64,(__fd_t __dirfd, char const *__filename, struct __timeval64 const *__times),(__dirfd,__filename,__times))
...
/* @param: who: One of `RUSAGE_SELF', `RUSAGE_CHILDREN' or `RUSAGE_THREAD' */
__CDECLARE_SC(,__errno_t,getrusage64,(__syscall_slong_t __who, struct __rusage64 *__tv),(__who,__tv))
...
__CDECLARE_SC(,__errno_t,lstat64,(char const *__filename, struct linux_stat64 *__statbuf),(__filename,__statbuf))
...
__CDECLARE_SC(,__ssize_t,mq_timedreceive,(__fd_t __mqdes, char *__msg_ptr, __size_t __msg_len, __uint32_t *__pmsg_prio, struct __timespec32 const *__abs_timeout),(__mqdes,__msg_ptr,__msg_len,__pmsg_prio,__abs_timeout))
#endif /* __CRT_HAVE_SC(mq_timedreceive) */
#if __CRT_HAVE_SC(mq_timedreceive_time64)
__CDECLARE_SC(,__ssize_t,mq_timedreceive_time64,(__fd_t __mqdes, char *__msg_ptr, __size_t __msg_len, __uint32_t *__pmsg_prio, struct __timespec64 const *__abs_timeout),(__mqdes,__msg_ptr,__msg_len,__pmsg_prio,__abs_timeout))
#endif /* __CRT_HAVE_SC(mq_timedreceive_time64) */
#if __CRT_HAVE_SC(mq_timedsend)
__CDECLARE_SC(,__errno_t,mq_timedsend,(__fd_t __mqdes, char const *__msg_ptr, __size_t __msg_len, __uint32_t __msg_prio, struct __timespec32 const *__abs_timeout),(__mqdes,__msg_ptr,__msg_len,__msg_prio,__abs_timeout))
#endif /* __CRT_HAVE_SC(mq_timedsend) */
#if __CRT_HAVE_SC(mq_timedsend_time64)
__CDECLARE_SC(,__errno_t,mq_timedsend_time64,(__fd_t __mqdes, char const *__msg_ptr, __size_t __msg_len, __uint32_t __msg_prio, struct __timespec64 const *__abs_timeout),(__mqdes,__msg_ptr,__msg_len,__msg_prio,__abs_timeout))
...
#if __CRT_HAVE_SC(pciconfig_iobase)
__CDECLARE_SC(,__errno_t,pciconfig_iobase,(int __TODO_PROTOTYPE),(__TODO_PROTOTYPE))
#endif /* __CRT_HAVE_SC(pciconfig_iobase) */
#if __CRT_HAVE_SC(pciconfig_read)
__CDECLARE_SC(,__errno_t,pciconfig_read,(int __TODO_PROTOTYPE),(__TODO_PROTOTYPE))
#endif /* __CRT_HAVE_SC(pciconfig_read) */
#if __CRT_HAVE_SC(pciconfig_write)
__CDECLARE_SC(,__errno_t,pciconfig_write,(int __TODO_PROTOTYPE),(__TODO_PROTOTYPE))
#endif /* __CRT_HAVE_SC(pciconfig_write) */
 ...
 * @throw: E_INVALID_HANDLE_FILE:                                                             [...]
 * @throw: E_ILLEGAL_OPERATION:                                                               [...] */
__CDECLARE_SC(,__errno_t,pidfd_send_signal,(__fd_t __pidfd, __signo_t __usigno, struct __siginfo_struct const *__uinfo, __syscall_ulong_t __flags),(__pidfd,__usigno,__uinfo,__flags))
...
__CDECLARE_SC(,__ssize_t,ppoll_time64,(struct pollfd *__fds, __size_t __nfds, struct __timespec64 const *__timeout_ts, struct __sigset_struct const *__sigmask, __size_t __sigsetsize),(__fds,__nfds,__timeout_ts,__sigmask,__sigsetsize))
...
#if __CRT_HAVE_SC(process_madvise)
__CDECLARE_SC(,__errno_t,process_madvise,(int __TODO_PROTOTYPE),(__TODO_PROTOTYPE))
#endif /* __CRT_HAVE_SC(process_madvise) */
...
__CDECLARE_SC(,__ssize_t,pselect6,(__size_t __nfds, struct __fd_set_struct *__readfds, struct __fd_set_struct *__writefds, struct __fd_set_struct *__exceptfds, struct __timespec32 const *__timeout, struct sigset_with_size const *__sigmask_sigset_with_size),(__nfds,__readfds,__writefds,__exceptfds,__timeout,__sigmask_sigset_with_size))
#endif /* __CRT_HAVE_SC(pselect6) */
#if __CRT_HAVE_SC(pselect6_time64)
__CDECLARE_SC(,__ssize_t,pselect6_time64,(__size_t __nfds, struct __fd_set_struct *__readfds, struct __fd_set_struct *__writefds, struct __fd_set_struct *__exceptfds, struct __timespec64 const *__timeout, struct sigset_with_size const *__sigmask_sigset_with_size),(__nfds,__readfds,__writefds,__exceptfds,__timeout,__sigmask_sigset_with_size))
 ...
 * @return: 0 : End-of-directory */
__CDECLARE_SC(,__syscall_slong_t,readdir,(__fd_t __fd, struct old_linux_dirent *__buf),(__fd,__buf))
...
__CDECLARE_SC(,__errno_t,rpc_schedule,(__pid_t __target_tid, __syscall_ulong_t __mode, void const *__program, void const *const *__params, __size_t __max_param_count),(__target_tid,__mode,__program,__params,__max_param_count))
...
__CDECLARE_SC(,__syscall_slong_t,rt_sigtimedwait_time64,(struct __sigset_struct const *__set, struct __siginfo_struct *__info, struct __timespec64 const *__timeout, __size_t __sigsetsize),(__set,__info,__timeout,__sigsetsize))
...
__CDECLARE_SC(,__errno_t,sched_rr_get_interval,(__pid_t __pid, struct __timespec32 *__ts),(__pid,__ts))
#endif /* __CRT_HAVE_SC(sched_rr_get_interval) */
#if __CRT_HAVE_SC(sched_rr_get_interval_time64)
__CDECLARE_SC(,__errno_t,sched_rr_get_interval_time64,(__pid_t __pid, struct __timespec64 *__ts),(__pid,__ts))
...
__CDECLARE_SC(,__ssize_t,select,(struct sel_arg_struct const *__arg),(__arg))
...
__CDECLARE_SC(,__errno_t,sigaction,(__signo_t __signo, struct __old_kernel_sigaction const *__act, struct __old_kernel_sigaction *__oact),(__signo,__act,__oact))
...
__CDECLARE_SC(,__syscall_slong_t,socketcall,(__syscall_ulong_t __call, __syscall_ulong_t *__args),(__call,__args))
...
#if __CRT_HAVE_SC(syscall)
/* Syscall to call a syscall */
__CDECLARE_SC(,__errno_t,syscall,(int __TODO_PROTOTYPE),(__TODO_PROTOTYPE))
#endif /* __CRT_HAVE_SC(syscall) */
...
__CDECLARE_SC(,__errno_t,timerfd_gettime,(__fd_t __timerfd, struct __itimerspec32 *__otmr),(__timerfd,__otmr))
#endif /* __CRT_HAVE_SC(timerfd_gettime) */
#if __CRT_HAVE_SC(timerfd_gettime64)
/* Return the next expiration time of UFD */
__CDECLARE_SC(,__errno_t,timerfd_gettime64,(__fd_t __timerfd, struct __itimerspec64 *__otmr),(__timerfd,__otmr))
...
__CDECLARE_SC(,__errno_t,timerfd_settime,(__fd_t __timerfd, __syscall_ulong_t __flags, struct __itimerspec32 const *__utmr, struct __itimerspec32 *__otmr),(__timerfd,__flags,__utmr,__otmr))
 ...
 * is absolute. Optionally return the old expiration time in `otmr'
 * @param: flags: Set of `0 | TFD_TIMER_ABSTIME' */
__CDECLARE_SC(,__errno_t,timerfd_settime64,(__fd_t __timerfd, __syscall_ulong_t __flags, struct __itimerspec64 const *__utmr, struct __itimerspec64 *__otmr),(__timerfd,__flags,__utmr,__otmr))
...
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW | AT_CHANGE_BTIME | AT_DOSPATH' */
__CDECLARE_SC(,__errno_t,utimensat_time64,(__fd_t __dirfd, char const *__filename, struct __timespec64 const *__times, __atflag_t __flags),(__dirfd,__filename,__times,__flags))
...
#if __CRT_HAVE_SC(vserve)
__CDECLARE_SC(,__errno_t,vserve,(int __TODO_PROTOTYPE),(__TODO_PROTOTYPE))
#endif /* __CRT_HAVE_SC(vserve) */
#if __CRT_HAVE_SC(wait4)
/* Same as `waitpid(pid, STAT_LOC, OPTIONS)', though also fills in `USAGE' when non-NULL
 * @param: options: Set of `WNOHANG | WUNTRACED | WCONTINUED' (as a KOS extension, `WNOWAIT' is also accepted) */
__CDECLARE_SC(,__pid_t,wait4,(__pid_t __pid, __int32_t *__stat_loc, __syscall_ulong_t __options, struct __rusage32 *__usage),(__pid,__stat_loc,__options,__usage))
#endif /* __CRT_HAVE_SC(wait4) */
#if __CRT_HAVE_SC(wait4_64)
/* Same as `waitpid(pid, STAT_LOC, OPTIONS)', though also fills in `USAGE' when non-NULL
 * @param: options: Set of `WNOHANG | WUNTRACED | WCONTINUED' (as a KOS extension, `WNOWAIT' is also accepted) */
__CDECLARE_SC(,__pid_t,wait4_64,(__pid_t __pid, __int32_t *__stat_loc, __syscall_ulong_t __options, struct __rusage64 *__usage),(__pid,__stat_loc,__options,__usage))
...
/* @param: idtype:  One of `P_ALL', `P_PID', `P_PGID'
 * @param: options: At least one of `WEXITED', `WSTOPPED', `WCONTINUED', optionally or'd with `WNOHANG | WNOWAIT' */
__CDECLARE_SC(,__errno_t,waitid64,(__syscall_ulong_t __idtype, __id_t __id, struct __siginfo_struct *__infop, __syscall_ulong_t __options, struct __rusage64 *__ru),(__idtype,__id,__infop,__options,__ru))
...
__CDECLARE_XSC(,__ssize_t,_newselect,(__size_t __nfds, struct __fd_set_struct *__readfds, struct __fd_set_struct *__writefds, struct __fd_set_struct *__exceptfds, struct __timeval32 *__timeout),(__nfds,__readfds,__writefds,__exceptfds,__timeout))
...
__CDECLARE_XSC(,__errno_t,adjtimex,(struct timex32 *__ntx),(__ntx))
...
__CDECLARE_XSC(,__errno_t,clock_getres_time64,(__clockid_t __clock_id, struct __timespec64 *__res),(__clock_id,__res))
...
__CDECLARE_XSC(,__errno_t,clock_nanosleep_time64,(__clockid_t __clock_id, __syscall_ulong_t __flags, struct __timespec64 const *__requested_time, struct __timespec64 *__remaining),(__clock_id,__flags,__requested_time,__remaining))
...
__CDECLARE_XSC(,__errno_t,fstat64,(__fd_t __fd, struct linux_stat64 *__statbuf),(__fd,__statbuf))
...
__CDECLARE_XSC(,__errno_t,ftime64,(struct __timeb64 *__tp),(__tp))
...
/* @param: futex_op: One of `FUTEX_*' from <linux/futex.h> */
__CDECLARE_XSC(,__syscall_slong_t,futex_time64,(__uint32_t *__uaddr, __syscall_ulong_t __futex_op, __uint32_t __val, struct __timespec64 const *__timeout_or_val2, __uint32_t *__uaddr2, __uint32_t __val3),(__uaddr,__futex_op,__val,__timeout_or_val2,__uaddr2,__val3))
#endif /* __CRT_HAVE_XSC(futex_time64) */
#if __CRT_HAVE_XSC(futimesat)
__CDECLARE_XSC(,__errno_t,futimesat,(__fd_t __dirfd, char const *__filename, struct __timeval32 const *__times),(__dirfd,__filename,__times))
#endif /* __CRT_HAVE_XSC(futimesat) */
#if __CRT_HAVE_XSC(futimesat64)
__CDECLARE_XSC(,__errno_t,futimesat64,(__fd_t __dirfd, char const *__filename, struct __timeval64 const *__times),(__dirfd,__filename,__times))
...
/* @param: who: One of `RUSAGE_SELF', `RUSAGE_CHILDREN' or `RUSAGE_THREAD' */
__CDECLARE_XSC(,__errno_t,getrusage64,(__syscall_slong_t __who, struct __rusage64 *__tv),(__who,__tv))
...
__CDECLARE_XSC(,__errno_t,lstat64,(char const *__filename, struct linux_stat64 *__statbuf),(__filename,__statbuf))
...
__CDECLARE_XSC(,__ssize_t,mq_timedreceive,(__fd_t __mqdes, char *__msg_ptr, __size_t __msg_len, __uint32_t *__pmsg_prio, struct __timespec32 const *__abs_timeout),(__mqdes,__msg_ptr,__msg_len,__pmsg_prio,__abs_timeout))
#endif /* __CRT_HAVE_XSC(mq_timedreceive) */
#if __CRT_HAVE_XSC(mq_timedreceive_time64)
__CDECLARE_XSC(,__ssize_t,mq_timedreceive_time64,(__fd_t __mqdes, char *__msg_ptr, __size_t __msg_len, __uint32_t *__pmsg_prio, struct __timespec64 const *__abs_timeout),(__mqdes,__msg_ptr,__msg_len,__pmsg_prio,__abs_timeout))
#endif /* __CRT_HAVE_XSC(mq_timedreceive_time64) */
#if __CRT_HAVE_XSC(mq_timedsend)
__CDECLARE_XSC(,__errno_t,mq_timedsend,(__fd_t __mqdes, char const *__msg_ptr, __size_t __msg_len, __uint32_t __msg_prio, struct __timespec32 const *__abs_timeout),(__mqdes,__msg_ptr,__msg_len,__msg_prio,__abs_timeout))
#endif /* __CRT_HAVE_XSC(mq_timedsend) */
#if __CRT_HAVE_XSC(mq_timedsend_time64)
__CDECLARE_XSC(,__errno_t,mq_timedsend_time64,(__fd_t __mqdes, char const *__msg_ptr, __size_t __msg_len, __uint32_t __msg_prio, struct __timespec64 const *__abs_timeout),(__mqdes,__msg_ptr,__msg_len,__msg_prio,__abs_timeout))
...
#if __CRT_HAVE_XSC(pciconfig_iobase)
__CDECLARE_XSC(,__errno_t,pciconfig_iobase,(int __TODO_PROTOTYPE),(__TODO_PROTOTYPE))
#endif /* __CRT_HAVE_XSC(pciconfig_iobase) */
#if __CRT_HAVE_XSC(pciconfig_read)
__CDECLARE_XSC(,__errno_t,pciconfig_read,(int __TODO_PROTOTYPE),(__TODO_PROTOTYPE))
#endif /* __CRT_HAVE_XSC(pciconfig_read) */
#if __CRT_HAVE_XSC(pciconfig_write)
__CDECLARE_XSC(,__errno_t,pciconfig_write,(int __TODO_PROTOTYPE),(__TODO_PROTOTYPE))
#endif /* __CRT_HAVE_XSC(pciconfig_write) */
 ...
 * @throw: E_INVALID_HANDLE_FILE:                                                             [...]
 * @throw: E_ILLEGAL_OPERATION:                                                               [...] */
__CDECLARE_XSC(,__errno_t,pidfd_send_signal,(__fd_t __pidfd, __signo_t __usigno, struct __siginfo_struct const *__uinfo, __syscall_ulong_t __flags),(__pidfd,__usigno,__uinfo,__flags))
...
__CDECLARE_XSC(,__ssize_t,ppoll_time64,(struct pollfd *__fds, __size_t __nfds, struct __timespec64 const *__timeout_ts, struct __sigset_struct const *__sigmask, __size_t __sigsetsize),(__fds,__nfds,__timeout_ts,__sigmask,__sigsetsize))
...
#if __CRT_HAVE_XSC(process_madvise)
__CDECLARE_XSC(,__errno_t,process_madvise,(int __TODO_PROTOTYPE),(__TODO_PROTOTYPE))
#endif /* __CRT_HAVE_XSC(process_madvise) */
...
__CDECLARE_XSC(,__ssize_t,pselect6,(__size_t __nfds, struct __fd_set_struct *__readfds, struct __fd_set_struct *__writefds, struct __fd_set_struct *__exceptfds, struct __timespec32 const *__timeout, struct sigset_with_size const *__sigmask_sigset_with_size),(__nfds,__readfds,__writefds,__exceptfds,__timeout,__sigmask_sigset_with_size))
#endif /* __CRT_HAVE_XSC(pselect6) */
#if __CRT_HAVE_XSC(pselect6_time64)
__CDECLARE_XSC(,__ssize_t,pselect6_time64,(__size_t __nfds, struct __fd_set_struct *__readfds, struct __fd_set_struct *__writefds, struct __fd_set_struct *__exceptfds, struct __timespec64 const *__timeout, struct sigset_with_size const *__sigmask_sigset_with_size),(__nfds,__readfds,__writefds,__exceptfds,__timeout,__sigmask_sigset_with_size))
 ...
 * @return: 1 : Read on directory entry
 * @return: 0 : End-of-directory */
__CDECLARE_XSC(,__syscall_slong_t,readdir,(__fd_t __fd, struct old_linux_dirent *__buf),(__fd,__buf))
 ...
 *                             for why it  may terminate immediately  after
 *                             the RPC program finished. */
__CDECLARE_XSC(,__errno_t,rpc_schedule,(__pid_t __target_tid, __syscall_ulong_t __mode, void const *__program, void const *const *__params, __size_t __max_param_count),(__target_tid,__mode,__program,__params,__max_param_count))
...
__CDECLARE_XSC(,__syscall_slong_t,rt_sigtimedwait_time64,(struct __sigset_struct const *__set, struct __siginfo_struct *__info, struct __timespec64 const *__timeout, __size_t __sigsetsize),(__set,__info,__timeout,__sigsetsize))
...
__CDECLARE_XSC(,__errno_t,sched_rr_get_interval,(__pid_t __pid, struct __timespec32 *__ts),(__pid,__ts))
#endif /* __CRT_HAVE_XSC(sched_rr_get_interval) */
#if __CRT_HAVE_XSC(sched_rr_get_interval_time64)
__CDECLARE_XSC(,__errno_t,sched_rr_get_interval_time64,(__pid_t __pid, struct __timespec64 *__ts),(__pid,__ts))
...
__CDECLARE_XSC(,__ssize_t,select,(struct sel_arg_struct const *__arg),(__arg))
...
__CDECLARE_XSC(,__errno_t,sigaction,(__signo_t __signo, struct __old_kernel_sigaction const *__act, struct __old_kernel_sigaction *__oact),(__signo,__act,__oact))
...
__CDECLARE_XSC(,__syscall_slong_t,socketcall,(__syscall_ulong_t __call, __syscall_ulong_t *__args),(__call,__args))
...
#if __CRT_HAVE_XSC(syscall)
/* Syscall to call a syscall */
__CDECLARE_XSC(,__errno_t,syscall,(int __TODO_PROTOTYPE),(__TODO_PROTOTYPE))
#endif /* __CRT_HAVE_XSC(syscall) */
...
/* Return the next expiration time of UFD */
__CDECLARE_XSC(,__errno_t,timerfd_gettime,(__fd_t __timerfd, struct __itimerspec32 *__otmr),(__timerfd,__otmr))
#endif /* __CRT_HAVE_XSC(timerfd_gettime) */
#if __CRT_HAVE_XSC(timerfd_gettime64)
/* Return the next expiration time of UFD */
__CDECLARE_XSC(,__errno_t,timerfd_gettime64,(__fd_t __timerfd, struct __itimerspec64 *__otmr),(__timerfd,__otmr))
 ...
 * is absolute. Optionally return the old expiration time in `otmr'
 * @param: flags: Set of `0 | TFD_TIMER_ABSTIME' */
__CDECLARE_XSC(,__errno_t,timerfd_settime,(__fd_t __timerfd, __syscall_ulong_t __flags, struct __itimerspec32 const *__utmr, struct __itimerspec32 *__otmr),(__timerfd,__flags,__utmr,__otmr))
 ...
 * is absolute. Optionally return the old expiration time in `otmr'
 * @param: flags: Set of `0 | TFD_TIMER_ABSTIME' */
__CDECLARE_XSC(,__errno_t,timerfd_settime64,(__fd_t __timerfd, __syscall_ulong_t __flags, struct __itimerspec64 const *__utmr, struct __itimerspec64 *__otmr),(__timerfd,__flags,__utmr,__otmr))
...
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW | AT_CHANGE_BTIME | AT_DOSPATH' */
__CDECLARE_XSC(,__errno_t,utimensat_time64,(__fd_t __dirfd, char const *__filename, struct __timespec64 const *__times, __atflag_t __flags),(__dirfd,__filename,__times,__flags))
...
#if __CRT_HAVE_XSC(vserve)
__CDECLARE_XSC(,__errno_t,vserve,(int __TODO_PROTOTYPE),(__TODO_PROTOTYPE))
#endif /* __CRT_HAVE_XSC(vserve) */
#if __CRT_HAVE_XSC(wait4)
/* Same as `waitpid(pid, STAT_LOC, OPTIONS)', though also fills in `USAGE' when non-NULL
 * @param: options: Set of `WNOHANG | WUNTRACED | WCONTINUED' (as a KOS extension, `WNOWAIT' is also accepted) */
__CDECLARE_XSC(,__pid_t,wait4,(__pid_t __pid, __int32_t *__stat_loc, __syscall_ulong_t __options, struct __rusage32 *__usage),(__pid,__stat_loc,__options,__usage))
#endif /* __CRT_HAVE_XSC(wait4) */
#if __CRT_HAVE_XSC(wait4_64)
/* Same as `waitpid(pid, STAT_LOC, OPTIONS)', though also fills in `USAGE' when non-NULL
 * @param: options: Set of `WNOHANG | WUNTRACED | WCONTINUED' (as a KOS extension, `WNOWAIT' is also accepted) */
__CDECLARE_XSC(,__pid_t,wait4_64,(__pid_t __pid, __int32_t *__stat_loc, __syscall_ulong_t __options, struct __rusage64 *__usage),(__pid,__stat_loc,__options,__usage))
...
/* @param: idtype:  One of `P_ALL', `P_PID', `P_PGID'
 * @param: options: At least one of `WEXITED', `WSTOPPED', `WCONTINUED', optionally or'd with `WNOHANG | WNOWAIT' */
__CDECLARE_XSC(,__errno_t,waitid64,(__syscall_ulong_t __idtype, __id_t __id, struct __siginfo_struct *__infop, __syscall_ulong_t __options, struct __rusage64 *__ru),(__idtype,__id,__infop,__options,__ru))
