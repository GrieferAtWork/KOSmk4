...
#ifndef _ARM_KOS_BITS_SYSCALLS_H
#define _ARM_KOS_BITS_SYSCALLS_H 1
...
#define SYS_utime                        __NR_utime                        /* errno_t utime(char const *filename, struct utimbuf32 const *times) */
...
#define SYS_sigaction                    __NR_sigaction                    /* errno_t sigaction(signo_t signo, struct __old_kernel_sigaction const *act, struct __old_kernel_sigaction *oact) */
/* >> setreuid(2)
...
#define SYS_setrlimit                    __NR_setrlimit                    /* errno_t setrlimit(syscall_ulong_t resource, struct rlimit32 const *rlimits) */
/* @param: resource: One of `RLIMIT_*' from <sys/resource.h> */
...
#define SYS_getgroups                    __NR_getgroups                    /* ssize_t getgroups(size_t count, uint16_t[] list) */
#define SYS_setgroups                    __NR_setgroups                    /* errno_t setgroups(size_t count, uint16_t const *groups) */
#define SYS_select                       __NR_select                       /* ssize_t select(struct sel_arg_struct const *arg) */
...
#define SYS_readdir                      __NR_readdir                      /* syscall_slong_t readdir(fd_t fd, struct old_linux_dirent *buf) */
...
#define SYS_syscall                      __NR_syscall                      /* errno_t syscall(int TODO_PROTOTYPE) */
/* Same as `waitpid(pid, STAT_LOC, OPTIONS)', though also fills in `USAGE' when non-NULL
 * @param: options: Set of `WNOHANG | WUNTRACED | WCONTINUED' (as a KOS extension, `WNOWAIT' is also accepted) */
#define SYS_wait4                        __NR_wait4                        /* pid_t wait4(pid_t pid, int32_t *stat_loc, syscall_ulong_t options, struct rusage32 *usage) */
...
#define SYS_adjtimex                     __NR_adjtimex                     /* errno_t adjtimex(struct timex32 *ntx) */
/* @param: prot: Either `PROT_NONE', or set of `PROT_EXEC | PROT_WRITE | PROT_READ | PROT_SEM | PROT_SHARED' */
...
#define SYS__newselect                   __NR__newselect                   /* ssize_t _newselect(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct timeval32 *timeout) */
...
#define SYS_sched_rr_get_interval        __NR_sched_rr_get_interval        /* errno_t sched_rr_get_interval(pid_t pid, struct timespec32 *ts) */
#define SYS_nanosleep                    __NR_nanosleep                    /* errno_t nanosleep(struct timespec32 const *req, struct timespec32 *rem) */
...
#define SYS_rt_sigtimedwait              __NR_rt_sigtimedwait              /* syscall_slong_t rt_sigtimedwait(struct __sigset_struct const *set, struct __siginfo_struct *info, struct timespec32 const *timeout, size_t sigsetsize) */
...
#define SYS_stat64                       __NR_stat64                       /* errno_t stat64(char const *filename, struct linux_stat64 *statbuf) */
#define SYS_lstat64                      __NR_lstat64                      /* errno_t lstat64(char const *filename, struct linux_stat64 *statbuf) */
#define SYS_fstat64                      __NR_fstat64                      /* errno_t fstat64(fd_t fd, struct linux_stat64 *statbuf) */
 ...
 * @return: * :     [count != 0] The number of groups that were actually returned
 * @throw: -EINVAL: [count != 0] There are more than `count' groups (NOTE: No exception is thrown for this case!) */
#define SYS_getgroups32                  __NR_getgroups32                  /* ssize_t getgroups32(size_t count, uint32_t[] list) */
 ...
 * @param: num_bytes:  The max number of bytes to transfer
 * @return: * :        The actual number of bytes transferred */
#define SYS_sendfile64                   __NR_sendfile64                   /* ssize_t sendfile64(fd_t outfd, fd_t infd, __ULONG64_TYPE__ *pin_offset, size_t num_bytes) */
/* @param: futex_op: One of `FUTEX_*' from <linux/futex.h> */
#define SYS_futex                        __NR_futex                        /* syscall_slong_t futex(uint32_t *uaddr, syscall_ulong_t futex_op, uint32_t val, struct timespec32 const *timeout_or_val2, uint32_t *uaddr2, uint32_t val3) */
...
#define SYS_timer_settime                __NR_timer_settime                /* errno_t timer_settime(timer_t timerid, syscall_ulong_t flags, struct itimerspec32 const *value, struct itimerspec32 *ovalue) */
#define SYS_timer_gettime                __NR_timer_gettime                /* errno_t timer_gettime(timer_t timerid, struct itimerspec32 *value) */
...
#define SYS_clock_settime                __NR_clock_settime                /* errno_t clock_settime(clockid_t clock_id, struct timespec32 const *tp) */
...
#define SYS_utimes                       __NR_utimes                       /* errno_t utimes(char const *filename, struct timeval32 const[2] times) */
#define SYS_arm_fadvise64_64             __NR_arm_fadvise64_64             /* errno_t arm_fadvise64_64(int TODO_PROTOTYPE) */
#define SYS_pciconfig_iobase             __NR_pciconfig_iobase             /* errno_t pciconfig_iobase(int TODO_PROTOTYPE) */
#define SYS_pciconfig_read               __NR_pciconfig_read               /* errno_t pciconfig_read(int TODO_PROTOTYPE) */
#define SYS_pciconfig_write              __NR_pciconfig_write              /* errno_t pciconfig_write(int TODO_PROTOTYPE) */
...
#define SYS_mq_timedsend                 __NR_mq_timedsend                 /* errno_t mq_timedsend(fd_t mqdes, char const *msg_ptr, size_t msg_len, uint32_t msg_prio, struct timespec32 const *abs_timeout) */
#define SYS_mq_timedreceive              __NR_mq_timedreceive              /* ssize_t mq_timedreceive(fd_t mqdes, char *msg_ptr, size_t msg_len, uint32_t *pmsg_prio, struct timespec32 const *abs_timeout) */
...
#define SYS_vserve                       __NR_vserve                       /* errno_t vserve(int TODO_PROTOTYPE) */
...
#define SYS_futimesat                    __NR_futimesat                    /* errno_t futimesat(fd_t dirfd, char const *filename, struct timeval32 const[2] times) */
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW | AT_DOSPATH' */
#define SYS_fstatat64                    __NR_fstatat64                    /* errno_t fstatat64(fd_t dirfd, char const *filename, struct linux_stat64 *statbuf, atflag_t flags) */
...
#define SYS_pselect6                     __NR_pselect6                     /* ssize_t pselect6(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct timespec32 const *timeout, struct sigset_with_size const *sigmask_sigset_with_size) */
#define SYS_ppoll                        __NR_ppoll                        /* ssize_t ppoll(struct pollfd *fds, size_t nfds, struct timespec32 const *timeout_ts, struct __sigset_struct const *sigmask, size_t sigsetsize) */
...
#define SYS_utimensat                    __NR_utimensat                    /* errno_t utimensat(fd_t dirfd, char const *filename, struct timespec32 const[2] times, atflag_t flags) */
...
#define SYS_timerfd_settime              __NR_timerfd_settime              /* errno_t timerfd_settime(fd_t timerfd, syscall_ulong_t flags, struct itimerspec32 const *utmr, struct itimerspec32 *otmr) */
/* Return the next expiration time of UFD */
#define SYS_timerfd_gettime              __NR_timerfd_gettime              /* errno_t timerfd_gettime(fd_t timerfd, struct itimerspec32 *otmr) */
/* Create a poll(2)-able file descriptor which can be used to wait for the
 * delivery of signals masked by `sigmask' to the waiting  thread/process.
...
#define SYS_clock_gettime64              __NR_clock_gettime64              /* errno_t clock_gettime64(clockid_t clock_id, struct timespec64 *tp) */
#define SYS_clock_settime64              __NR_clock_settime64              /* errno_t clock_settime64(clockid_t clock_id, struct timespec64 const *tp) */
#define SYS_clock_adjtime64              __NR_clock_adjtime64              /* errno_t clock_adjtime64(int TODO_PROTOTYPE) */
#define SYS_clock_getres_time64          __NR_clock_getres_time64          /* errno_t clock_getres_time64(clockid_t clock_id, struct timespec64 *res) */
#define SYS_clock_nanosleep_time64       __NR_clock_nanosleep_time64       /* errno_t clock_nanosleep_time64(clockid_t clock_id, syscall_ulong_t flags, struct timespec64 const *requested_time, struct timespec64 *remaining) */
#define SYS_timer_gettime64              __NR_timer_gettime64              /* errno_t timer_gettime64(timer_t timerid, struct itimerspec64 *value) */
/* @param: flags: Set of `0 | TIMER_ABSTIME' */
#define SYS_timer_settime64              __NR_timer_settime64              /* errno_t timer_settime64(timer_t timerid, syscall_ulong_t flags, struct itimerspec64 const *value, struct itimerspec64 *ovalue) */
/* Return the next expiration time of UFD */
#define SYS_timerfd_gettime64            __NR_timerfd_gettime64            /* errno_t timerfd_gettime64(fd_t timerfd, struct itimerspec64 *otmr) */
/* Set next expiration time of interval timer source `timerfd' to `utmr'.
 * If `flags'  has the  `TFD_TIMER_ABSTIME' flag  set the  timeout  value
 * is absolute. Optionally return the old expiration time in `otmr'
 * @param: flags: Set of `0 | TFD_TIMER_ABSTIME' */
#define SYS_timerfd_settime64            __NR_timerfd_settime64            /* errno_t timerfd_settime64(fd_t timerfd, syscall_ulong_t flags, struct itimerspec64 const *utmr, struct itimerspec64 *otmr) */
/* @param: flags: Set of `0 | AT_SYMLINK_NOFOLLOW | AT_CHANGE_BTIME | AT_DOSPATH' */
#define SYS_utimensat_time64             __NR_utimensat_time64             /* errno_t utimensat_time64(fd_t dirfd, char const *filename, struct timespec64 const[2] times, atflag_t flags) */
#define SYS_pselect6_time64              __NR_pselect6_time64              /* ssize_t pselect6_time64(size_t nfds, struct __fd_set_struct *readfds, struct __fd_set_struct *writefds, struct __fd_set_struct *exceptfds, struct timespec64 const *timeout, struct sigset_with_size const *sigmask_sigset_with_size) */
#define SYS_ppoll_time64                 __NR_ppoll_time64                 /* ssize_t ppoll_time64(struct pollfd *fds, size_t nfds, struct timespec64 const *timeout_ts, struct __sigset_struct const *sigmask, size_t sigsetsize) */
...
#define SYS_rt_sigtimedwait_time64       __NR_rt_sigtimedwait_time64       /* syscall_slong_t rt_sigtimedwait_time64(struct __sigset_struct const *set, struct __siginfo_struct *info, struct timespec64 const *timeout, size_t sigsetsize) */
/* @param: futex_op: One of `FUTEX_*' from <linux/futex.h> */
#define SYS_futex_time64                 __NR_futex_time64                 /* syscall_slong_t futex_time64(uint32_t *uaddr, syscall_ulong_t futex_op, uint32_t val, struct timespec64 const *timeout_or_val2, uint32_t *uaddr2, uint32_t val3) */
#define SYS_sched_rr_get_interval_time64 __NR_sched_rr_get_interval_time64 /* errno_t sched_rr_get_interval_time64(pid_t pid, struct timespec64 *ts) */
 ...
 * @throw: E_ILLEGAL_OPERATION:                                                               [...] */
#define SYS_pidfd_send_signal            __NR_pidfd_send_signal            /* errno_t pidfd_send_signal(fd_t pidfd, signo_t usigno, struct __siginfo_struct const *uinfo, syscall_ulong_t flags) */
