...
#define _SC_IPV6                         (_SC_LEVEL1_ICACHE_SIZE + 50) /* [== _POSIX_IPV6, unlimited] */
#define _SC_RAW_SOCKETS                  (_SC_LEVEL1_ICACHE_SIZE + 51) /* [== _POSIX_RAW_SOCKETS, unlimited] */
...
#define _SC_SS_REPL_MAX                  (_SC_LEVEL1_ICACHE_SIZE + 56) /* [== _POSIX_SS_REPL_MAX, unlimited] */
#define _SC_TRACE_EVENT_NAME_MAX         (_SC_LEVEL1_ICACHE_SIZE + 57) /* [== unlimited] */
#define _SC_TRACE_NAME_MAX               (_SC_LEVEL1_ICACHE_SIZE + 58) /* [== unlimited] */
#define _SC_TRACE_SYS_MAX                (_SC_LEVEL1_ICACHE_SIZE + 59) /* [== unlimited] */
#define _SC_TRACE_USER_EVENT_MAX         (_SC_LEVEL1_ICACHE_SIZE + 60) /* [== unlimited] */
#define _SC_XOPEN_STREAMS                (_SC_LEVEL1_ICACHE_SIZE + 61) /* [== unlimited] */
#define _SC_THREAD_ROBUST_PRIO_INHERIT   (_SC_LEVEL1_ICACHE_SIZE + 62) /* [== _POSIX_THREAD_ROBUST_PRIO_INHERIT, unlimited] */
#define _SC_THREAD_ROBUST_PRIO_PROTECT   (_SC_LEVEL1_ICACHE_SIZE + 63) /* [== _POSIX_THREAD_ROBUST_PRIO_PROTECT, unlimited] */
#ifdef __USE_KOS
