 ...
 */
#ifndef _ASM_ULIMIT_H
#define _ASM_ULIMIT_H 1

#include <__stdinc.h>
#include <__crt.h>

#if defined(__KOS__) || defined(__linux__) || defined(__CRT_KOS) || defined(__CRT_KOS_KERNEL) || defined(__CRT_GLC)
#define __UL_GETFSIZE   1 /* Return limit on the size of a file, in units of 512 bytes. */
#define __UL_SETFSIZE   2 /* Set limit on the size of a file to second argument. */
