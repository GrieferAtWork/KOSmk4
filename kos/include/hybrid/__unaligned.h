...
__LOCAL __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)) __UINT16_TYPE__
...
__LOCAL __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)) __UINT32_TYPE__
...
__LOCAL __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)) __UINT64_TYPE__
...
__LOCAL __ATTR_WUNUSED __ATTR_PURE __ATTR_NONNULL((1)) __UINT128_TYPE__
...
__NOTHROW_NCX(__IMPL_HYBRID_UNALIGNED_GETTER(16))(__UINT16_TYPE__ const *__restrict __ptr) {
	...
	if (!((__UINTPTR_TYPE__)__ptr & 1))
		return *__ptr;
	__res.__v8[0] = ((__UINT8_TYPE__ *)__ptr)[0];
...
__NOTHROW_NCX(__IMPL_HYBRID_UNALIGNED_GETTER_SWAP(16))(__UINT16_TYPE__ const *__restrict __ptr) {
	...
	__res.__v8[1] = ((__UINT8_TYPE__ *)__ptr)[0];
...
__NOTHROW_NCX(__IMPL_HYBRID_UNALIGNED_GETTER(32))(__UINT32_TYPE__ const *__restrict __ptr) {
	...
	if (!((__UINTPTR_TYPE__)__ptr & 3))
		return *__ptr;
	if (!((__UINTPTR_TYPE__)__ptr & 1)) {
	__res.__v16[0] = ((__UINT16_TYPE__ *)__ptr)[0];
	__res.__v16[1] = ((__UINT16_TYPE__ *)__ptr)[1];
	} else {
		__res.__v8[0] = ((__UINT8_TYPE__ *)__ptr)[0];
		__res.__v8[1] = ((__UINT8_TYPE__ *)__ptr)[1];
		__res.__v8[2] = ((__UINT8_TYPE__ *)__ptr)[2];
		__res.__v8[3] = ((__UINT8_TYPE__ *)__ptr)[3];
	}
	return __res.__v32;
}
__LOCAL __ATTR_NONNULL((1)) void
...
__NOTHROW_NCX(__IMPL_HYBRID_UNALIGNED_GETTER_SWAP(32))(__UINT32_TYPE__ const *__restrict __ptr) {
	...
	if (!((__UINTPTR_TYPE__)__ptr & 1)) {
		__res.__v16[1] = __hybrid_bswap16(((__UINT16_TYPE__ *)__ptr)[0]);
		__res.__v16[0] = __hybrid_bswap16(((__UINT16_TYPE__ *)__ptr)[1]);
	} else {
		__res.__v8[3] = ((__UINT8_TYPE__ *)__ptr)[0];
		__res.__v8[2] = ((__UINT8_TYPE__ *)__ptr)[1];
		__res.__v8[1] = ((__UINT8_TYPE__ *)__ptr)[2];
		__res.__v8[0] = ((__UINT8_TYPE__ *)__ptr)[3];
	}
	return __res.__v32;
}
__LOCAL __ATTR_NONNULL((1)) void
...
__NOTHROW_NCX(__IMPL_HYBRID_UNALIGNED_GETTER(64))(__UINT64_TYPE__ const *__restrict __ptr) {
	...
	if (!((__UINTPTR_TYPE__)__ptr & 7))
		return *__ptr;
	if (!((__UINTPTR_TYPE__)__ptr & 3)) {
		__res.__v32[0] = ((__UINT32_TYPE__ *)__ptr)[0];
		__res.__v32[1] = ((__UINT32_TYPE__ *)__ptr)[1];
	} else if (!((__UINTPTR_TYPE__)__ptr & 1)) {
		__res.__v16[0] = ((__UINT16_TYPE__ *)__ptr)[0];
		__res.__v16[1] = ((__UINT16_TYPE__ *)__ptr)[1];
		__res.__v16[2] = ((__UINT16_TYPE__ *)__ptr)[2];
		__res.__v16[3] = ((__UINT16_TYPE__ *)__ptr)[3];
	} else {
		__res.__v8[0] = ((__UINT8_TYPE__ *)__ptr)[0];
		__res.__v8[1] = ((__UINT8_TYPE__ *)__ptr)[1];
		__res.__v8[2] = ((__UINT8_TYPE__ *)__ptr)[2];
		__res.__v8[3] = ((__UINT8_TYPE__ *)__ptr)[3];
		__res.__v8[4] = ((__UINT8_TYPE__ *)__ptr)[4];
		__res.__v8[5] = ((__UINT8_TYPE__ *)__ptr)[5];
		__res.__v8[6] = ((__UINT8_TYPE__ *)__ptr)[6];
		__res.__v8[7] = ((__UINT8_TYPE__ *)__ptr)[7];
	}
	return __res.__v64;
}
__LOCAL __ATTR_NONNULL((1)) void
...
__NOTHROW_NCX(__IMPL_HYBRID_UNALIGNED_GETTER_SWAP(64))(__UINT64_TYPE__ const *__restrict __ptr) {
	...
	if (!((__UINTPTR_TYPE__)__ptr & 3)) {
		__res.__v32[1] = __hybrid_bswap32(((__UINT32_TYPE__ *)__ptr)[0]);
		__res.__v32[0] = __hybrid_bswap32(((__UINT32_TYPE__ *)__ptr)[1]);
	} else if (!((__UINTPTR_TYPE__)__ptr & 1)) {
		__res.__v16[3] = __hybrid_bswap16(((__UINT16_TYPE__ *)__ptr)[0]);
		__res.__v16[2] = __hybrid_bswap16(((__UINT16_TYPE__ *)__ptr)[1]);
		__res.__v16[1] = __hybrid_bswap16(((__UINT16_TYPE__ *)__ptr)[2]);
		__res.__v16[0] = __hybrid_bswap16(((__UINT16_TYPE__ *)__ptr)[3]);
	} else {
		__res.__v8[7] = ((__UINT8_TYPE__ *)__ptr)[0];
		__res.__v8[6] = ((__UINT8_TYPE__ *)__ptr)[1];
		__res.__v8[5] = ((__UINT8_TYPE__ *)__ptr)[2];
		__res.__v8[4] = ((__UINT8_TYPE__ *)__ptr)[3];
		__res.__v8[3] = ((__UINT8_TYPE__ *)__ptr)[4];
		__res.__v8[2] = ((__UINT8_TYPE__ *)__ptr)[5];
		__res.__v8[1] = ((__UINT8_TYPE__ *)__ptr)[6];
		__res.__v8[0] = ((__UINT8_TYPE__ *)__ptr)[7];
	}
	return __res.__v64;
}
__LOCAL __ATTR_NONNULL((1)) void
...
__NOTHROW_NCX(__IMPL_HYBRID_UNALIGNED_GETTER(128))(__UINT128_TYPE__ const *__restrict __ptr) {
	...
	if (!((__UINTPTR_TYPE__)__ptr & 15))
		return *__ptr;
	if (!((__UINTPTR_TYPE__)__ptr & 7)) {
		__res.__v64[0] = ((__UINT64_TYPE__ *)__ptr)[0];
		__res.__v64[1] = ((__UINT64_TYPE__ *)__ptr)[1];
	} else if (!((__UINTPTR_TYPE__)__ptr & 3)) {
		__res.__v32[0] = ((__UINT32_TYPE__ *)__ptr)[0];
		__res.__v32[1] = ((__UINT32_TYPE__ *)__ptr)[1];
		__res.__v32[2] = ((__UINT32_TYPE__ *)__ptr)[2];
		__res.__v32[3] = ((__UINT32_TYPE__ *)__ptr)[3];
	} else if (!((__UINTPTR_TYPE__)__ptr & 1)) {
		__res.__v16[0] = ((__UINT16_TYPE__ *)__ptr)[0];
		__res.__v16[1] = ((__UINT16_TYPE__ *)__ptr)[1];
		__res.__v16[2] = ((__UINT16_TYPE__ *)__ptr)[2];
		__res.__v16[3] = ((__UINT16_TYPE__ *)__ptr)[3];
		__res.__v16[4] = ((__UINT16_TYPE__ *)__ptr)[4];
		__res.__v16[5] = ((__UINT16_TYPE__ *)__ptr)[5];
		__res.__v16[6] = ((__UINT16_TYPE__ *)__ptr)[6];
		__res.__v16[7] = ((__UINT16_TYPE__ *)__ptr)[7];
	} else {
		__res.__v8[0x0] = ((__UINT8_TYPE__ *)__ptr)[0x0];
		__res.__v8[0x1] = ((__UINT8_TYPE__ *)__ptr)[0x1];
		__res.__v8[0x2] = ((__UINT8_TYPE__ *)__ptr)[0x2];
		__res.__v8[0x3] = ((__UINT8_TYPE__ *)__ptr)[0x3];
		__res.__v8[0x4] = ((__UINT8_TYPE__ *)__ptr)[0x4];
		__res.__v8[0x5] = ((__UINT8_TYPE__ *)__ptr)[0x5];
		__res.__v8[0x6] = ((__UINT8_TYPE__ *)__ptr)[0x6];
		__res.__v8[0x7] = ((__UINT8_TYPE__ *)__ptr)[0x7];
		__res.__v8[0x8] = ((__UINT8_TYPE__ *)__ptr)[0x8];
		__res.__v8[0x9] = ((__UINT8_TYPE__ *)__ptr)[0x9];
		__res.__v8[0xa] = ((__UINT8_TYPE__ *)__ptr)[0xa];
		__res.__v8[0xb] = ((__UINT8_TYPE__ *)__ptr)[0xb];
		__res.__v8[0xc] = ((__UINT8_TYPE__ *)__ptr)[0xc];
		__res.__v8[0xd] = ((__UINT8_TYPE__ *)__ptr)[0xd];
		__res.__v8[0xe] = ((__UINT8_TYPE__ *)__ptr)[0xe];
		__res.__v8[0xf] = ((__UINT8_TYPE__ *)__ptr)[0xf];
	}
	return __res.__v128;
}
__LOCAL __ATTR_NONNULL((1)) void
...
__NOTHROW_NCX(__IMPL_HYBRID_UNALIGNED_GETTER_SWAP(128))(__UINT128_TYPE__ const *__restrict __ptr) {
	...
	if (!((__UINTPTR_TYPE__)__ptr & 15))
		return *__ptr;
	if (!((__UINTPTR_TYPE__)__ptr & 7)) {
		__res.__v64[1] = __hybrid_bswap64(((__UINT64_TYPE__ *)__ptr)[0]);
		__res.__v64[0] = __hybrid_bswap64(((__UINT64_TYPE__ *)__ptr)[1]);
	} else if (!((__UINTPTR_TYPE__)__ptr & 3)) {
		__res.__v32[3] = __hybrid_bswap32(((__UINT32_TYPE__ *)__ptr)[0]);
		__res.__v32[2] = __hybrid_bswap32(((__UINT32_TYPE__ *)__ptr)[1]);
		__res.__v32[1] = __hybrid_bswap32(((__UINT32_TYPE__ *)__ptr)[2]);
		__res.__v32[0] = __hybrid_bswap32(((__UINT32_TYPE__ *)__ptr)[3]);
	} else if (!((__UINTPTR_TYPE__)__ptr & 1)) {
		__res.__v16[7] = __hybrid_bswap16(((__UINT16_TYPE__ *)__ptr)[0]);
		__res.__v16[6] = __hybrid_bswap16(((__UINT16_TYPE__ *)__ptr)[1]);
		__res.__v16[5] = __hybrid_bswap16(((__UINT16_TYPE__ *)__ptr)[2]);
		__res.__v16[4] = __hybrid_bswap16(((__UINT16_TYPE__ *)__ptr)[3]);
		__res.__v16[3] = __hybrid_bswap16(((__UINT16_TYPE__ *)__ptr)[4]);
		__res.__v16[2] = __hybrid_bswap16(((__UINT16_TYPE__ *)__ptr)[5]);
		__res.__v16[1] = __hybrid_bswap16(((__UINT16_TYPE__ *)__ptr)[6]);
		__res.__v16[0] = __hybrid_bswap16(((__UINT16_TYPE__ *)__ptr)[7]);
	} else {
		__res.__v8[0xf] = ((__UINT8_TYPE__ *)__ptr)[0x0];
		__res.__v8[0xe] = ((__UINT8_TYPE__ *)__ptr)[0x1];
		__res.__v8[0xd] = ((__UINT8_TYPE__ *)__ptr)[0x2];
		__res.__v8[0xc] = ((__UINT8_TYPE__ *)__ptr)[0x3];
		__res.__v8[0xb] = ((__UINT8_TYPE__ *)__ptr)[0x4];
		__res.__v8[0xa] = ((__UINT8_TYPE__ *)__ptr)[0x5];
		__res.__v8[0x9] = ((__UINT8_TYPE__ *)__ptr)[0x6];
		__res.__v8[0x8] = ((__UINT8_TYPE__ *)__ptr)[0x7];
		__res.__v8[0x7] = ((__UINT8_TYPE__ *)__ptr)[0x8];
		__res.__v8[0x6] = ((__UINT8_TYPE__ *)__ptr)[0x9];
		__res.__v8[0x5] = ((__UINT8_TYPE__ *)__ptr)[0xa];
		__res.__v8[0x4] = ((__UINT8_TYPE__ *)__ptr)[0xb];
		__res.__v8[0x3] = ((__UINT8_TYPE__ *)__ptr)[0xc];
		__res.__v8[0x2] = ((__UINT8_TYPE__ *)__ptr)[0xd];
		__res.__v8[0x1] = ((__UINT8_TYPE__ *)__ptr)[0xe];
		__res.__v8[0x0] = ((__UINT8_TYPE__ *)__ptr)[0xf];
	}
	return __res.__v128;
}
__LOCAL __ATTR_NONNULL((1)) void
