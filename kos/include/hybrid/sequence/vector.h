...
#define __HYBRID_SEQ_VECTOR_IMPL6(T, f)                                                 \
	struct {                                                                            \
		__SIZE_TYPE__ v_size;  /* Used number of items. */                              \
...
#define __HYBRID_SEQ_VECTOR_FINI_P_IMPL4(l, T, fini_elem, f)         \
	__HYBRID_SEQ_VECTOR_SELECT(__HYBRID_SEQ_VECTOR_FINI_P_IMPL4_, f)(l, T, fini_elem, f)
...
#define __HYBRID_SEQ_VECTOR_CLEAR_P_IMPL4(l, T, clear_elem, f)        \
	__HYBRID_SEQ_VECTOR_SELECT(__HYBRID_SEQ_VECTOR_CLEAR_P_IMPL4_, f)(l, T, clear_elem, f)
#define __HYBRID_SEQ_VECTOR_CLEAR_P_IMPL4_4(l, T, clear_elem, f)         \
	__HYBRID_SEQ_VECTOR_XSELECT(__HYBRID_SEQ_VECTOR_CLEAR_P_IMPL4_4_, f)(l, T, clear_elem, f)
...
#define __HYBRID_SEQ_VECTOR_TRUNC_IMPL2_4_0(l, f)                                              \
	do {                                                                                       \
		if ((l).v_alloc > (l).v_size) {                                                        \
			...
			__vector_trunc_newvec = __HYBRID_PP_BUBBLE_GET(f, 2)((void *)(l).v_elem,           \
			                                                     (l).v_size *                  \
...
#define __HYBRID_SEQ_VECTOR_TRUNC_IMPL2_6(l, f)                                                \
	do {                                                                                       \
		if ((l).v_alloc > (l).v_size) {                                                        \
			void *__vector_trunc_newvec;                                                       \
			__vector_trunc_newvec = __HYBRID_PP_BUBBLE_GET(f, 4)((void *)(l).v_elem,           \
			                                                     (l).v_size *                  \
			                                                     __HYBRID_VECTOR_ELEMSIZE(l)); \
			if __likely(__vector_trunc_newvec) {                                               \
				*(void **)&(l).v_elem = __vector_trunc_newvec;                                 \
...
#define __HYBRID_VECTOR_REQUIRE1_IMPL_4_0(l, err, f)                                            \
	do {                                                                                        \
		...
		__v_new_vector = (void *)__HYBRID_PP_BUBBLE_GET(f, 2)((void *)(l).v_elem,               \
		                                                      __v_new_alloc *                   \
		                                                      __HYBRID_VECTOR_ELEMSIZE(l));     \
...
#define __HYBRID_VECTOR_REQUIRE1_IMPL_5_0(l, err, f)                                                     \
	do {                                                                                                 \
		void *__v_new_vector;                                                                            \
		__v_new_vector = (void *)__HYBRID_PP_BUBBLE_GET(f, 2)((void *)(l).v_elem,                        \
		                                                      __HYBRID_VECTOR_REQUIRE1_ALLOCSIZE(l, f) * \
		                                                      __HYBRID_VECTOR_ELEMSIZE(l));              \
		if __unlikely(!__v_new_vector) {                                                                 \
			__v_new_vector = (void *)__HYBRID_PP_BUBBLE_GET(f, 2)((void *)(l).v_elem,                    \
			                                                      (VECTOR_SIZE(l) + 1) *                 \
...
#define __HYBRID_VECTOR_REQUIRE1_IMPL_6_0(l, err, f)                                            \
	do {                                                                                        \
		...
		void *__v_new_vector;                                                                   \
		__v_new_alloc  = __HYBRID_VECTOR_REQUIRE1_ALLOCSIZE(l, f);                              \
		__v_new_vector = (void *)__HYBRID_PP_BUBBLE_GET(f, 4)((void *)(l).v_elem,               \
		                                                      __v_new_alloc *                   \
		                                                      __HYBRID_VECTOR_ELEMSIZE(l));     \
		if __unlikely(!__v_new_vector) {                                                        \
			__v_new_alloc  = VECTOR_SIZE(l) + 1;                                                \
			__v_new_vector = (void *)__HYBRID_PP_BUBBLE_GET(f, 3)((void *)(l).v_elem,           \
			                                                      __v_new_alloc *               \
			                                                      __HYBRID_VECTOR_ELEMSIZE(l)); \
			if __unlikely(!__v_new_vector)                                                      \
				goto err;                                                                       \
