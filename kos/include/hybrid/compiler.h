...
#define ATTR_ACCESS_RD          __ATTR_ACCESS_RD
#define ATTR_ACCESS_RD_T        __ATTR_ACCESS_RD_T
#define ATTR_ACCESS_RDS         __ATTR_ACCESS_RDS
#define ATTR_ACCESS_RDS_T       __ATTR_ACCESS_RDS_T
