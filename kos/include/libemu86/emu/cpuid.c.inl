		...
		case 1: {
			enum {
				ECX_FEATURES = CPUID_1C_MOVBE |
				               CPUID_1C_POPCNT |
#if CONFIG_LIBEMU86_WANT_64BIT && EMU86_EMULATE_CONFIG_WANT_CMPXCHG16B && defined(EMU86_MEM_ATOMIC_CMPXCHX)
				               CPUID_1C_CX16 |
#endif /* CONFIG_LIBEMU86_WANT_64BIT && EMU86_EMULATE_CONFIG_WANT_CMPXCHG16B && EMU86_MEM_ATOMIC_CMPXCHX */
				               0,
