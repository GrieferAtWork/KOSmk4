...
#if EMU86_EMULATE_CONFIG_CHECKERROR || EMU86_EMULATE_CONFIG_WANT_MOVMOFFS
case EMU86_OPCODE_ENCODE(0xa0): {
	/* A0      MOV AL,moffs8*      Move byte at (seg:offset) to AL */
	byte_t *addr;
	u32 offset;
#if EMU86_EMULATE_CONFIG_WANT_MOVMOFFS
	u8 value;
#endif /* EMU86_EMULATE_CONFIG_WANT_MOVMOFFS */
	...
	EMU86_SETAL(value);
	goto done;
#else /* EMU86_EMULATE_CONFIG_WANT_MOVMOFFS */
	EMU86_UNSUPPORTED_MEMACCESS(addr, 1, true, false);
	goto return_unsupported_instruction;
#define NEED_return_unsupported_instruction
#endif /* !EMU86_EMULATE_CONFIG_WANT_MOVMOFFS */
}
#endif /* EMU86_EMULATE_CONFIG_CHECKERROR || EMU86_EMULATE_CONFIG_WANT_MOVMOFFS */
