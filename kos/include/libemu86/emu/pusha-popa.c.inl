...
#else /* EMU86_EMULATE_CONFIG_WANT_PUSHA && (CONFIG_LIBEMU86_WANT_32BIT || CONFIG_LIBEMU86_WANT_16BIT) */
...
#define NEED_return_unsupported_instruction
	goto return_unsupported_instruction;
#endif /* !EMU86_EMULATE_CONFIG_WANT_PUSHA || (!CONFIG_LIBEMU86_WANT_32BIT && !CONFIG_LIBEMU86_WANT_16BIT) */
}
#endif /* ... */
...
#else /* EMU86_EMULATE_CONFIG_WANT_POPA && (CONFIG_LIBEMU86_WANT_32BIT || CONFIG_LIBEMU86_WANT_16BIT) */
#if CONFIG_LIBEMU86_WANT_32BIT || CONFIG_LIBEMU86_WANT_16BIT
	IF_64BIT(if (!EMU86_F_IS64(op_flags))) {
		byte_t *sp;
		sp = EMU86_GETSTACKPTR();
...
#define NEED_return_unsupported_instruction
	goto return_unsupported_instruction;
#endif /* !EMU86_EMULATE_CONFIG_WANT_POPA || (!CONFIG_LIBEMU86_WANT_32BIT && !CONFIG_LIBEMU86_WANT_16BIT) */
}
#endif /* ... */
