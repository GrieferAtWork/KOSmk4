...
typedef __ATTR_RETNONNULL __ATTR_NONNULL((1, 2, 3)) __byte_t const *
...
LIBEMU86_DECL __ATTR_RETNONNULL __ATTR_NONNULL((1, 2, 3)) __byte_t const *
...
typedef __ATTR_RETNONNULL __ATTR_NONNULL((1, 2)) __byte_t const *
...
#ifdef LIBEMU86_WANT_PROTOTYPES
LIBEMU86_DECL __ATTR_RETNONNULL __ATTR_NONNULL((1, 2)) __byte_t const *
