...
/* Since `__VA_SIZE >= sizeof(int)', and `sizeof(int) != 0',  we
 * also know that `__VA_SIZE >= 1', meaning that any 8-bit  data
 * word  will _always_ be  promoted to an  int, meaning in order
