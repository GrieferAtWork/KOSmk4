...
#endif /* LIBVIO_CONFIG_HAVE_QWORD */
#ifdef LIBVIO_WANT_PROTOTYPES
__REDIRECT(LIBVIO_DECL,__ATTR_NONNULL((1)),__uint8_t,__THROWING,LIBVIO_CC,vio_readb_aligned,(struct vio_args *__restrict args, vio_addr_t addr),vio_readb,(args,addr))
...
__REDIRECT_VOID(LIBVIO_DECL,__ATTR_NONNULL((1)),__THROWING,LIBVIO_CC,vio_writeb_aligned,(struct vio_args *__restrict args, vio_addr_t addr, __uint8_t value),vio_writeb,(args,addr,value))
