...
#endif /* __KERNEL__ */
#ifdef LIBVIO_WANT_PROTOTYPES
LIBVIO_DECL __ATTR_NONNULL((1)) void LIBVIO_CC vio_xchwithvio(struct vioargs *__restrict args, vio_addr_t offset, __NCX void *oldbuf, __NCX void const *newbuf, __size_t num_bytes, __BOOL atomic) __THROWS(E_SEGFAULT, ...);
LIBVIO_DECL __ATTR_NONNULL((1)) void LIBVIO_CC vio_copyfromvio(struct vioargs *__restrict args, vio_addr_t offset, __NCX void *buf, __size_t num_bytes) __THROWS(E_SEGFAULT, ...);
LIBVIO_DECL __ATTR_NONNULL((1)) void LIBVIO_CC vio_copytovio(struct vioargs *__restrict args, vio_addr_t offset, __NCX void const *buf, __size_t num_bytes) __THROWS(E_SEGFAULT, ...);
