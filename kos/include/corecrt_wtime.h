...
__CDECLARE(__ATTR_WUNUSED __ATTR_ACCESS_RO(1),wchar_t *,__NOTHROW_NCX,_wasctime,(struct __NAMESPACE_STD_SYM tm const *__tp),(__tp))
#else /* __CRT_HAVE__wasctime */
#include <libc/local/corecrt_wtime/_wasctime.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(_wasctime, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_WUNUSED __ATTR_ACCESS_RO(1) wchar_t *__NOTHROW_NCX(__LIBCCALL _wasctime)(struct __NAMESPACE_STD_SYM tm const *__tp) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_wasctime))(__tp); })
#endif /* !__CRT_HAVE__wasctime */
#ifdef __CRT_HAVE__wasctime_s
__CDECLARE(__ATTR_ACCESS_RO(3) __ATTR_ACCESS_WRS(1, 2),errno_t,__NOTHROW_NCX,_wasctime_s,(wchar_t *__buf, size_t __buflen, struct __NAMESPACE_STD_SYM tm const *__tp),(__buf,__buflen,__tp))
#else /* __CRT_HAVE__wasctime_s */
#include <libc/local/corecrt_wtime/_wasctime_s.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(_wasctime_s, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(3) __ATTR_ACCESS_WRS(1, 2) errno_t __NOTHROW_NCX(__LIBCCALL _wasctime_s)(wchar_t *__buf, size_t __buflen, struct __NAMESPACE_STD_SYM tm const *__tp) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_wasctime_s))(__buf, __buflen, __tp); })
...
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(1),wchar_t *,__NOTHROW_NCX,_wctime32,(__time32_t const *__timer),_wctime,(__timer))
#else /* ... */
#include <libc/local/corecrt_wtime/_wctime32.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(_wctime32, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_WUNUSED __ATTR_ACCESS_RO(1) wchar_t *__NOTHROW_NCX(__LIBCCALL _wctime32)(__time32_t const *__timer) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_wctime32))(__timer); })
#endif /* !... */
#ifdef __CRT_HAVE__wctime64
__CDECLARE(__ATTR_WUNUSED __ATTR_ACCESS_RO(1),wchar_t *,__NOTHROW_NCX,_wctime64,(__time64_t const *__timer),(__timer))
#else /* __CRT_HAVE__wctime64 */
#include <libc/local/corecrt_wtime/_wctime64.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(_wctime64, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_WUNUSED __ATTR_ACCESS_RO(1) wchar_t *__NOTHROW_NCX(__LIBCCALL _wctime64)(__time64_t const *__timer) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_wctime64))(__timer); })
#endif /* !__CRT_HAVE__wctime64 */
#ifdef __CRT_HAVE__wctime32_s
__CDECLARE(__ATTR_ACCESS_RO(3) __ATTR_ACCESS_WRS(1, 2),errno_t,__NOTHROW_NCX,_wctime32_s,(wchar_t *__buf, size_t __buflen, __time32_t const *__timer),(__buf,__buflen,__timer))
#else /* __CRT_HAVE__wctime32_s */
#include <libc/local/corecrt_wtime/_wctime32_s.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(_wctime32_s, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(3) __ATTR_ACCESS_WRS(1, 2) errno_t __NOTHROW_NCX(__LIBCCALL _wctime32_s)(wchar_t *__buf, size_t __buflen, __time32_t const *__timer) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_wctime32_s))(__buf, __buflen, __timer); })
#endif /* !__CRT_HAVE__wctime32_s */
#ifdef __CRT_HAVE__wctime64_s
__CDECLARE(__ATTR_ACCESS_RO(3) __ATTR_ACCESS_WRS(1, 2),errno_t,__NOTHROW_NCX,_wctime64_s,(wchar_t *__buf, size_t __buflen, __time64_t const *__timer),(__buf,__buflen,__timer))
#else /* __CRT_HAVE__wctime64_s */
#include <libc/local/corecrt_wtime/_wctime64_s.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(_wctime64_s, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(3) __ATTR_ACCESS_WRS(1, 2) errno_t __NOTHROW_NCX(__LIBCCALL _wctime64_s)(wchar_t *__buf, size_t __buflen, __time64_t const *__timer) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_wctime64_s))(__buf, __buflen, __timer); })
#endif /* !__CRT_HAVE__wctime64_s */
#ifdef __CRT_HAVE__wstrtime
__CDECLARE(__ATTR_ACCESS_WR(1),wchar_t *,__NOTHROW_NCX,_wstrtime,(wchar_t __buf[9]),(__buf))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(_wstrtime, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_WR(1) wchar_t *__NOTHROW_NCX(__LIBCCALL _wstrtime)(wchar_t __buf[9]) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_wstrtime))(__buf); })
#endif /* ... */
#ifdef __CRT_HAVE__wstrdate
__CDECLARE(__ATTR_ACCESS_WR(1),wchar_t *,__NOTHROW_NCX,_wstrdate,(wchar_t __buf[9]),(__buf))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(_wstrdate, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_WR(1) wchar_t *__NOTHROW_NCX(__LIBCCALL _wstrdate)(wchar_t __buf[9]) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_wstrdate))(__buf); })
#endif /* ... */
#ifdef __CRT_HAVE__wstrtime_s
__CDECLARE(__ATTR_ACCESS_WRS(1, 2),errno_t,__NOTHROW_NCX,_wstrtime_s,(wchar_t *__buf, size_t __buflen),(__buf,__buflen))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(_wstrtime_s, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_WRS(1, 2) errno_t __NOTHROW_NCX(__LIBCCALL _wstrtime_s)(wchar_t *__buf, size_t __buflen) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_wstrtime_s))(__buf, __buflen); })
#endif /* ... */
#ifdef __CRT_HAVE__wstrdate_s
__CDECLARE(__ATTR_ACCESS_WRS(1, 2),errno_t,__NOTHROW_NCX,_wstrdate_s,(wchar_t *__buf, size_t __buflen),(__buf,__buflen))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(_wstrdate_s, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_WRS(1, 2) errno_t __NOTHROW_NCX(__LIBCCALL _wstrdate_s)(wchar_t *__buf, size_t __buflen) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_wstrdate_s))(__buf, __buflen); })
#endif /* ... */
