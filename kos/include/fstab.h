 ...
 * @return: NULL: [errno = *] Error */
__CDECLARE(__ATTR_WUNUSED __ATTR_IN(1),struct fstab *,__NOTHROW_NCX,getfsspec,(char const *__special_file),(__special_file))
 ...
 * @return: NULL: [errno = <unchanged>] No entry exists matching `special_file'
 * @return: NULL: [errno = *] Error */
__NAMESPACE_LOCAL_USING_OR_IMPL(getfsspec, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_WUNUSED __ATTR_IN(1) struct fstab *__NOTHROW_NCX(__LIBCCALL getfsspec)(char const *__special_file) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(getfsspec))(__special_file); })
#endif /* ... */
 ...
 * @return: NULL: [errno = *] Error */
__CDECLARE(__ATTR_WUNUSED __ATTR_IN(1),struct fstab *,__NOTHROW_NCX,getfsfile,(char const *__mount_point),(__mount_point))
#elif defined(__CRT_HAVE_getfsent) && defined(__CRT_HAVE_setfsent)
 ...
 * @return: NULL: [errno = <unchanged>] No entry exists matching `mount_point'
 * @return: NULL: [errno = *] Error */
__NAMESPACE_LOCAL_USING_OR_IMPL(getfsfile, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_WUNUSED __ATTR_IN(1) struct fstab *__NOTHROW_NCX(__LIBCCALL getfsfile)(char const *__mount_point) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(getfsfile))(__mount_point); })
#endif /* ... */
