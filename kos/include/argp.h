...
__CDECLARE(__ATTR_IN(1) __ATTR_INS(3, 2) __ATTR_OUT(5),error_t,__NOTHROW_NCX,argp_parse,(struct argp const *__restrict __argp, int ___argc, char **__restrict ___argv, unsigned int __flags, int *__restrict __arg_index, void *__restrict __input),(__argp,___argc,___argv,__flags,__arg_index,__input))
#elif defined(__CRT_HAVE___argp_parse)
__CREDIRECT(__ATTR_IN(1) __ATTR_INS(3, 2) __ATTR_OUT(5),error_t,__NOTHROW_NCX,argp_parse,(struct argp const *__restrict __argp, int ___argc, char **__restrict ___argv, unsigned int __flags, int *__restrict __arg_index, void *__restrict __input),__argp_parse,(__argp,___argc,___argv,__flags,__arg_index,__input))
#endif /* ... */
#ifdef __CRT_HAVE_argp_help
__CDECLARE_VOID(__ATTR_IN(1) __ATTR_IN(4) __ATTR_INOUT(2),__NOTHROW_NCX,argp_help,(struct argp const *__restrict __argp, __FILE *__restrict __stream, unsigned int __flags, char __KOS_FIXED_CONST *__restrict __name),(__argp,__stream,__flags,__name))
#elif defined(__CRT_HAVE___argp_parse)
__CREDIRECT_VOID(__ATTR_IN(1) __ATTR_IN(4) __ATTR_INOUT(2),__NOTHROW_NCX,argp_help,(struct argp const *__restrict __argp, __FILE *__restrict __stream, unsigned int __flags, char __KOS_FIXED_CONST *__restrict __name),__argp_parse,(__argp,__stream,__flags,__name))
#endif /* ... */
#ifdef __CRT_HAVE_argp_state_help
__CDECLARE_VOID(__ATTR_IN(1) __ATTR_INOUT(2),__NOTHROW_NCX,argp_state_help,(struct argp_state const *__restrict __state, __FILE *__restrict __stream, unsigned int __flags),(__state,__stream,__flags))
#elif defined(__CRT_HAVE___argp_state_help)
__CREDIRECT_VOID(__ATTR_IN(1) __ATTR_INOUT(2),__NOTHROW_NCX,argp_state_help,(struct argp_state const *__restrict __state, __FILE *__restrict __stream, unsigned int __flags),__argp_state_help,(__state,__stream,__flags))
#endif /* ... */
...
__LIBC __ATTR_IN(1) __ATTR_IN(2) __ATTR_LIBC_PRINTF(2, 3) void __NOTHROW_NCX(__VLIBCCALL argp_error)(struct argp_state const *__restrict __state, char const *__restrict __format, ...) __CASMNAME_SAME("argp_error");
#elif defined(__CRT_HAVE___argp_error)
__LIBC __ATTR_IN(1) __ATTR_IN(2) __ATTR_LIBC_PRINTF(2, 3) void __NOTHROW_NCX(__VLIBCCALL argp_error)(struct argp_state const *__restrict __state, char const *__restrict __format, ...) __CASMNAME("__argp_error");
#endif /* ... */
#ifdef __CRT_HAVE_argp_failure
__LIBC __ATTR_IN(1) __ATTR_IN(4) __ATTR_LIBC_PRINTF(4, 5) void __NOTHROW_NCX(__VLIBCCALL argp_failure)(struct argp_state const *__restrict __state, int __status, __errno_t __errnum, char const *__restrict __format, ...) __CASMNAME_SAME("argp_failure");
#elif defined(__CRT_HAVE___argp_failure)
__LIBC __ATTR_IN(1) __ATTR_IN(4) __ATTR_LIBC_PRINTF(4, 5) void __NOTHROW_NCX(__VLIBCCALL argp_failure)(struct argp_state const *__restrict __state, int __status, __errno_t __errnum, char const *__restrict __format, ...) __CASMNAME("__argp_failure");
#endif /* ... */
...
__CDECLARE(__ATTR_IN_OPT(1) __ATTR_IN_OPT(2),void *,__NOTHROW_NCX,_argp_input,(struct argp const *__restrict __argp, struct argp_state const *__restrict __state),(__argp,__state))
#elif defined(__CRT_HAVE___argp_input)
__CREDIRECT(__ATTR_IN_OPT(1) __ATTR_IN_OPT(2),void *,__NOTHROW_NCX,_argp_input,(struct argp const *__restrict __argp, struct argp_state const *__restrict __state),__argp_input,(__argp,__state))
#endif /* ... */
#ifdef __CRT_HAVE_argp_parse
__CREDIRECT(__ATTR_IN(1) __ATTR_INS(3, 2) __ATTR_OUT(5),error_t,__NOTHROW_NCX,__argp_parse,(struct argp const *__restrict __argp, int ___argc, char **__restrict ___argv, unsigned int __flags, int *__restrict __arg_index, void *__restrict __input),argp_parse,(__argp,___argc,___argv,__flags,__arg_index,__input))
#elif defined(__CRT_HAVE___argp_parse)
__CDECLARE(__ATTR_IN(1) __ATTR_INS(3, 2) __ATTR_OUT(5),error_t,__NOTHROW_NCX,__argp_parse,(struct argp const *__restrict __argp, int ___argc, char **__restrict ___argv, unsigned int __flags, int *__restrict __arg_index, void *__restrict __input),(__argp,___argc,___argv,__flags,__arg_index,__input))
#endif /* ... */
#ifdef __CRT_HAVE_argp_help
__CREDIRECT_VOID(__ATTR_IN(1) __ATTR_IN(4) __ATTR_INOUT(2),__NOTHROW_NCX,__argp_help,(struct argp const *__restrict __argp, __FILE *__restrict __stream, unsigned int __flags, char __KOS_FIXED_CONST *__restrict __name),argp_help,(__argp,__stream,__flags,__name))
#elif defined(__CRT_HAVE___argp_parse)
__CREDIRECT_VOID(__ATTR_IN(1) __ATTR_IN(4) __ATTR_INOUT(2),__NOTHROW_NCX,__argp_help,(struct argp const *__restrict __argp, __FILE *__restrict __stream, unsigned int __flags, char __KOS_FIXED_CONST *__restrict __name),__argp_parse,(__argp,__stream,__flags,__name))
#endif /* ... */
#ifdef __CRT_HAVE_argp_state_help
__CREDIRECT_VOID(__ATTR_IN(1) __ATTR_INOUT(2),__NOTHROW_NCX,__argp_state_help,(struct argp_state const *__restrict __state, __FILE *__restrict __stream, unsigned int __flags),argp_state_help,(__state,__stream,__flags))
#elif defined(__CRT_HAVE___argp_state_help)
__CDECLARE_VOID(__ATTR_IN(1) __ATTR_INOUT(2),__NOTHROW_NCX,__argp_state_help,(struct argp_state const *__restrict __state, __FILE *__restrict __stream, unsigned int __flags),(__state,__stream,__flags))
#endif /* ... */
#ifdef __CRT_HAVE_argp_usage
...
#endif /* !... */
#ifdef __CRT_HAVE_argp_error
__LIBC __ATTR_IN(1) __ATTR_IN(2) __ATTR_LIBC_PRINTF(2, 3) void __NOTHROW_NCX(__VLIBCCALL __argp_error)(struct argp_state const *__restrict __state, char const *__restrict __format, ...) __CASMNAME("argp_error");
#elif defined(__CRT_HAVE___argp_error)
__LIBC __ATTR_IN(1) __ATTR_IN(2) __ATTR_LIBC_PRINTF(2, 3) void __NOTHROW_NCX(__VLIBCCALL __argp_error)(struct argp_state const *__restrict __state, char const *__restrict __format, ...) __CASMNAME_SAME("__argp_error");
#endif /* ... */
#ifdef __CRT_HAVE_argp_failure
__LIBC __ATTR_IN(1) __ATTR_IN(4) __ATTR_LIBC_PRINTF(4, 5) void __NOTHROW_NCX(__VLIBCCALL __argp_failure)(struct argp_state const *__restrict __state, int __status, __errno_t __errnum, char const *__restrict __format, ...) __CASMNAME("argp_failure");
#elif defined(__CRT_HAVE___argp_failure)
__LIBC __ATTR_IN(1) __ATTR_IN(4) __ATTR_LIBC_PRINTF(4, 5) void __NOTHROW_NCX(__VLIBCCALL __argp_failure)(struct argp_state const *__restrict __state, int __status, __errno_t __errnum, char const *__restrict __format, ...) __CASMNAME_SAME("__argp_failure");
#endif /* ... */
#ifdef __CRT_HAVE__option_is_short
...
#endif /* !... */
#ifdef __CRT_HAVE__argp_input
__CREDIRECT(__ATTR_IN_OPT(1) __ATTR_IN_OPT(2),void *,__NOTHROW_NCX,__argp_input,(struct argp const *__restrict __argp, struct argp_state const *__restrict __state),_argp_input,(__argp,__state))
#elif defined(__CRT_HAVE___argp_input)
__CDECLARE(__ATTR_IN_OPT(1) __ATTR_IN_OPT(2),void *,__NOTHROW_NCX,__argp_input,(struct argp const *__restrict __argp, struct argp_state const *__restrict __state),(__argp,__state))
#endif /* ... */
