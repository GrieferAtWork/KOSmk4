...
/* >> getmntent(3), getmntent_r(3) */
__CDECLARE(__ATTR_ACCESS_RW(1) __ATTR_NONNULL((2, 3)),struct mntent *,__NOTHROW_RPC,getmntent_r,(__FILE *__restrict __stream, struct mntent *__restrict __result, char *__restrict __buffer, __STDC_INT_AS_SIZE_T __bufsize),(__stream,__result,__buffer,__bufsize))
#elif defined(__CRT_HAVE___getmntent_r)
/* >> getmntent(3), getmntent_r(3) */
__CREDIRECT(__ATTR_ACCESS_RW(1) __ATTR_NONNULL((2, 3)),struct mntent *,__NOTHROW_RPC,getmntent_r,(__FILE *__restrict __stream, struct mntent *__restrict __result, char *__restrict __buffer, __STDC_INT_AS_SIZE_T __bufsize),__getmntent_r,(__stream,__result,__buffer,__bufsize))
...
__CDECLARE(__ATTR_ACCESS_RW(1) __ATTR_NONNULL((2)),int,__THROWING,addmntent,(__FILE *__restrict __stream, struct mntent const *__restrict __mnt),(__stream,__mnt))
 ...
 * @return: 0: Success
 * @return: 1: Error (WARNING: `errno' is left undefined) */
__NAMESPACE_LOCAL_USING_OR_IMPL(addmntent, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(1) __ATTR_NONNULL((2)) int (__LIBCCALL addmntent)(__FILE *__restrict __stream, struct mntent const *__restrict __mnt) __THROWS(...) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(addmntent))(__stream, __mnt); })
