...
/* >> setmntent(3) */
__CDECLARE(__ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2),__FILE *,__NOTHROW_RPC,setmntent,(char const *__file, char const *__mode),(__file,__mode))
#elif defined(__CRT_HAVE___setmntent)
/* >> setmntent(3) */
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2),__FILE *,__NOTHROW_RPC,setmntent,(char const *__file, char const *__mode),__setmntent,(__file,__mode))
#elif defined(__CRT_HAVE_fopen)
/* >> setmntent(3) */
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2),__FILE *,__NOTHROW_RPC,setmntent,(char const *__file, char const *__mode),fopen,(__file,__mode))
#elif defined(__CRT_HAVE__IO_fopen)
/* >> setmntent(3) */
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2),__FILE *,__NOTHROW_RPC,setmntent,(char const *__file, char const *__mode),_IO_fopen,(__file,__mode))
#elif defined(__CRT_HAVE_fopen64)
/* >> setmntent(3) */
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2),__FILE *,__NOTHROW_RPC,setmntent,(char const *__file, char const *__mode),fopen64,(__file,__mode))
#endif /* ... */
#ifdef __CRT_HAVE_endmntent
/* >> endmntent(3) */
__CDECLARE(__ATTR_ACCESS_RW(1),int,__NOTHROW_RPC_NOKOS,endmntent,(__FILE *__stream),(__stream))
#elif defined(__CRT_HAVE___endmntent)
/* >> endmntent(3) */
__CREDIRECT(__ATTR_ACCESS_RW(1),int,__NOTHROW_RPC_NOKOS,endmntent,(__FILE *__stream),__endmntent,(__stream))
...
/* >> endmntent(3) */
__NAMESPACE_LOCAL_USING_OR_IMPL(endmntent, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(1) int __NOTHROW_RPC_NOKOS(__LIBCCALL endmntent)(__FILE *__stream) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(endmntent))(__stream); })
#endif /* ... */
#ifdef __CRT_HAVE_getmntent
/* >> getmntent(3), getmntent_r(3) */
__CDECLARE(__ATTR_ACCESS_RW(1),struct mntent *,__NOTHROW_RPC,getmntent,(__FILE *__stream),(__stream))
...
/* >> getmntent(3), getmntent_r(3) */
__NAMESPACE_LOCAL_USING_OR_IMPL(getmntent, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(1) struct mntent *__NOTHROW_RPC(__LIBCCALL getmntent)(__FILE *__stream) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(getmntent))(__stream); })
#endif /* ... */

#ifdef __USE_MISC
#ifdef __CRT_HAVE_getmntent_r
/* >> getmntent(3), getmntent_r(3) */
__CDECLARE(__ATTR_ACCESS_RW(1) __ATTR_ACCESS_WR(2) __ATTR_ACCESS_WRS(3, 4),struct mntent *,__NOTHROW_RPC,getmntent_r,(__FILE *__restrict __stream, struct mntent *__restrict __result, char *__restrict __buffer, __STDC_INT_AS_SIZE_T __bufsize),(__stream,__result,__buffer,__bufsize))
#elif defined(__CRT_HAVE___getmntent_r)
/* >> getmntent(3), getmntent_r(3) */
__CREDIRECT(__ATTR_ACCESS_RW(1) __ATTR_ACCESS_WR(2) __ATTR_ACCESS_WRS(3, 4),struct mntent *,__NOTHROW_RPC,getmntent_r,(__FILE *__restrict __stream, struct mntent *__restrict __result, char *__restrict __buffer, __STDC_INT_AS_SIZE_T __bufsize),__getmntent_r,(__stream,__result,__buffer,__bufsize))
...
/* >> getmntent(3), getmntent_r(3) */
__NAMESPACE_LOCAL_USING_OR_IMPL(getmntent_r, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(1) __ATTR_ACCESS_WR(2) __ATTR_ACCESS_WRS(3, 4) struct mntent *__NOTHROW_RPC(__LIBCCALL getmntent_r)(__FILE *__restrict __stream, struct mntent *__restrict __result, char *__restrict __buffer, __STDC_INT_AS_SIZE_T __bufsize) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(getmntent_r))(__stream, __result, __buffer, __bufsize); })
#endif /* ... */
#endif /* __USE_MISC */
...
__CDECLARE(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1),int,__THROWING,addmntent,(__FILE *__restrict __stream, struct mntent const *__restrict __mnt),(__stream,__mnt))
 ...
 * @return: 0: Success
 * @return: 1: Error (WARNING: `errno' is left undefined) */
__NAMESPACE_LOCAL_USING_OR_IMPL(addmntent, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1) int (__LIBCCALL addmntent)(__FILE *__restrict __stream, struct mntent const *__restrict __mnt) __THROWS(...) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(addmntent))(__stream, __mnt); })
...
__CDECLARE(__ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RO_OPT(1) __ATTR_ACCESS_RO_OPT(2),char *,__NOTHROW_NCX,hasmntopt,(struct mntent const *__mnt, char const *__opt),(__mnt,__opt))
 ...
 * @return: * :   Address of the `opt'-string in `mnt->mnt_opts'
 * @return: NULL: No option `opt' found in `mnt->mnt_opts' */
__NAMESPACE_LOCAL_USING_OR_IMPL(hasmntopt, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RO_OPT(1) __ATTR_ACCESS_RO_OPT(2) char *__NOTHROW_NCX(__LIBCCALL hasmntopt)(struct mntent const *__mnt, char const *__opt) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(hasmntopt))(__mnt, __opt); })
