...
__CREDIRECT_VOID(__ATTR_NORETURN __ATTR_IN_OPT(2) __ATTR_LIBC_PRINTF(2, 0),__THROWING,__localdep_verrx,(int __status, char const *__format, __builtin_va_list __args),verrx,(__status,__format,__args))
