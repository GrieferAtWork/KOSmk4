...
__LOCAL_LIBC(warnc) __ATTR_IN_OPT(2) __ATTR_LIBC_PRINTF(2, 3) void
__NOTHROW_CB_NCX(__VLIBCCALL __LIBC_LOCAL_NAME(warnc))(__errno_t __used_errno, char const *__format, ...) {
...
#define __local___localdep_warnc_defined
