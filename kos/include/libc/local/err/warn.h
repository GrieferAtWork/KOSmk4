...
__CREDIRECT_VOID(__ATTR_IN_OPT(1) __ATTR_LIBC_PRINTF(1, 0),__THROWING,__localdep_vwarn,(char const *__format, __builtin_va_list __args),vwarn,(__format,__args))
