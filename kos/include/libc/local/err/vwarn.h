...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT_VOID(__ATTR_ACCESS_RO_OPT(2) __ATTR_LIBC_PRINTF(2, 0),__THROWING,__localdep_vwarnc,(__errno_t __used_errno, char const *__format, __builtin_va_list __args),vwarnc,(__used_errno,__format,__args))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(vwarn) __ATTR_ACCESS_RO_OPT(1) __ATTR_LIBC_PRINTF(1, 0) void
