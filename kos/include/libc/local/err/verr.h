...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT_VOID(__ATTR_NORETURN __ATTR_ACCESS_RO_OPT(3) __ATTR_LIBC_PRINTF(3, 0),__THROWING,__localdep_verrc,(int __status, __errno_t __used_errno, char const *__format, __builtin_va_list __args),verrc,(__status,__used_errno,__format,__args))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(verr) __ATTR_NORETURN __ATTR_ACCESS_RO_OPT(2) __ATTR_LIBC_PRINTF(2, 0) void
