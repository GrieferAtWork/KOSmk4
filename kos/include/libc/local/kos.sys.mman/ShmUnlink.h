...
__CREDIRECT_VOID(__ATTR_ACCESS_RO(1),__THROWING,__localdep_Unlink,(char const *__file),Unlink,(__file))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(ShmUnlink) __ATTR_ACCESS_RO(1) void
