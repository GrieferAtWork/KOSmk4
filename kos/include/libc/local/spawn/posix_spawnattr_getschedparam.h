...
#define __local_posix_spawnattr_getschedparam_defined
#include <__crt.h>
...
__LOCAL_LIBC(posix_spawnattr_getschedparam) __ATTR_IN(1) __ATTR_OUT(2) __errno_t
...
#define __local___localdep_posix_spawnattr_getschedparam_defined
