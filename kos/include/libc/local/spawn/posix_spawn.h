...
__LOCAL_LIBC(posix_spawn) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(5) __ATTR_ACCESS_RO(6) __ATTR_ACCESS_RO_OPT(3) __ATTR_ACCESS_RO_OPT(4) __ATTR_ACCESS_WR(1) __errno_t
