...
#define __local_posix_spawn_file_actions_addclosefrom_np_defined 1
#include <__crt.h>
#include <asm/crt/posix_spawn.h>
#include <bits/crt/posix_spawn.h>
#if defined(__POSIX_SPAWN_ACTION_CLOSEFROM) && defined(__POSIX_SPAWN_USE_KOS) && defined(__CRT_HAVE_realloc)
...
#define __local___localdep_posix_spawn_file_actions_addclosefrom_np_defined 1
...
#else /* __POSIX_SPAWN_ACTION_CLOSEFROM && __POSIX_SPAWN_USE_KOS && __CRT_HAVE_realloc */
#undef __local_posix_spawn_file_actions_addclosefrom_np_defined
#endif /* !__POSIX_SPAWN_ACTION_CLOSEFROM || !__POSIX_SPAWN_USE_KOS || !__CRT_HAVE_realloc */
