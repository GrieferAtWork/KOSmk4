...
#define __local_posix_spawn_file_actions_alloc_defined 1
#include <__crt.h>
...
#undef __allocated
	...
	if ((unsigned int)__file_actions->__used >= (unsigned int)__file_actions->__allocated) {
		...
		__result   = (struct __spawn_action *)__localdep_realloc(__result, __newalloc * sizeof(struct __spawn_action));
