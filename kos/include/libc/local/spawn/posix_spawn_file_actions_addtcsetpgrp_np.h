 ...
 */
#ifndef __local_posix_spawn_file_actions_addtcsetpgrp_np_defined
#define __local_posix_spawn_file_actions_addtcsetpgrp_np_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(posix_spawn_file_actions_addtcsetpgrp_np) __ATTR_NONNULL((1)) __errno_t
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(posix_spawn_file_actions_addtcsetpgrp_np))(struct __posix_spawn_file_actions *__restrict __file_actions, __fd_t __fd) {
	...
	__action->__sa_tag = __POSIX_SPAWN_ACTION_TCSETPGRP;
	__action->__sa_action.__sa_tcsetpgrp_action.__sa_fd = __fd;
	return 0;
__err:
#ifdef __ENOMEM
	return __ENOMEM;
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_posix_spawn_file_actions_addtcsetpgrp_np_defined
#define __local___localdep_posix_spawn_file_actions_addtcsetpgrp_np_defined 1
