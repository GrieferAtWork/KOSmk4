...
#define __local_posix_spawn_file_actions_addtcsetpgrp_np_defined
#include <__crt.h>
...
__LOCAL_LIBC(posix_spawn_file_actions_addtcsetpgrp_np) __ATTR_FDARG(2) __ATTR_INOUT(1) __errno_t
