...
__LOCAL_LIBC(posix_spawn_file_actions_addfchdir_np) __ATTR_FDARG(2) __ATTR_INOUT(1) __errno_t
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(posix_spawn_file_actions_addfchdir_np))(struct __posix_spawn_file_actions *__restrict __file_actions, __fd_t __dfd) {
	...
	__action->__sa_tag = __POSIX_SPAWN_ACTION_FCHDIR;
	__action->__sa_action.__sa_fchdir_action.__sa_fd = __dfd;
	return 0;
__err:
#ifdef __ENOMEM
	return __ENOMEM;
...
#undef __local_posix_spawn_file_actions_addfchdir_np_defined
#endif /* !__POSIX_SPAWN_USE_KOS || (!__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) */
#endif /* !__local_posix_spawn_file_actions_addfchdir_np_defined */
