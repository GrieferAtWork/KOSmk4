...
#define __local_posix_spawnattr_destroy_defined 1
#include <__crt.h>
...
#ifndef __NDEBUG
	__localdep_memset(__attr, 0xcc, sizeof(*__attr));
#endif /* !__NDEBUG */
	return 0;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_posix_spawnattr_destroy_defined
#define __local___localdep_posix_spawnattr_destroy_defined 1
