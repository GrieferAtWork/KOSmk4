...
#define __local_signalnext_defined
#include <__crt.h>
#include <bits/types.h>
#include <asm/os/signal.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(signalnext) __ATTR_CONST __ATTR_WUNUSED __signo_t
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(signalnext))(__signo_t __signo) {
	if (__signo >= (__NSIG - 1))
		return 0;
	return __signo + 1;
}
...
#define __local___localdep_signalnext_defined
