...
#define __local_sigandset_defined
#include <__crt.h>
#include <bits/os/sigset.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(sigandset) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(3) __ATTR_ACCESS_WR(1) int
...
#define __local___localdep_sigandset_defined
