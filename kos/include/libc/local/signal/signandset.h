...
#define __local_signandset_defined
#include <__crt.h>
#include <bits/os/sigset.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(signandset) __ATTR_IN(2) __ATTR_IN(3) __ATTR_OUT(1) int
...
#define __local___localdep_signandset_defined
