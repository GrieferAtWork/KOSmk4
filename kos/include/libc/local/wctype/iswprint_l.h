...
#define __local_iswprint_l_defined
#include <__crt.h>
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(iswprint_l))(__WINT_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return (__NAMESPACE_LOCAL_SYM __localdep_iswprint)(__ch);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_iswprint_l_defined
#define __local___localdep_iswprint_l_defined
