...
#define __local_iswsymcont_defined 1
#include <__crt.h>
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(iswsymcont))(__WINT_TYPE__ __wc) {
...
#define __local___localdep_iswsymcont_defined 1
