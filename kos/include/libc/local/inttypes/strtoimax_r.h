 ...
 */
#ifndef __local_strtoimax_r_defined
#define __local_strtoimax_r_defined
#include <__crt.h>
#include <features.h>
...
__CREDIRECT(__ATTR_LEAF __ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR_OPT(2) __ATTR_ACCESS_WR_OPT(4),__INT32_TYPE__,__NOTHROW_NCX,__localdep_strto32_r,(char const *__restrict __nptr, char **__endptr, __STDC_INT_AS_UINT_T __base, __errno_t *__error),strto32_r,(__nptr,__endptr,__base,__error))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(strtoimax_r) __ATTR_LEAF __ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR_OPT(2) __ATTR_ACCESS_WR_OPT(4) __INTMAX_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(strtoimax_r))(char const *__restrict __nptr, char **__endptr, __STDC_INT_AS_UINT_T __base, __errno_t *__error) {
#if __SIZEOF_INTMAX_T__ >= 8
	return (__INTMAX_TYPE__)(__NAMESPACE_LOCAL_SYM __localdep_strto64_r)(__nptr, __endptr, __base, __error);
#elif __SIZEOF_INTMAX_T__ >= 4
	return (__INTMAX_TYPE__)(__NAMESPACE_LOCAL_SYM __localdep_strto32_r)(__nptr, __endptr, __base, __error);
#else /* ... */
...
#endif /* !__local_strtoimax_r_defined */
