...
#define __local_strtoimax_r_defined 1
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(strtoimax_r) __ATTR_LEAF __ATTR_NONNULL((1)) __INTMAX_TYPE__
...
#define __local___localdep_strtoimax_r_defined 1
