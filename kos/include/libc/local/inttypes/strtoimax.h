...
#define __local_strtoimax_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(strtoimax) __ATTR_LEAF __ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR_OPT(2) __INTMAX_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(strtoimax))(char const *__restrict __nptr, char **__endptr, __STDC_INT_AS_UINT_T __base) {
	...
	return (__INTMAX_TYPE__)(__NAMESPACE_LOCAL_SYM __localdep_strto32)(__nptr, __endptr, __base);
#else /* __SIZEOF_INTMAX_T__ <= 4 */
	return (__INTMAX_TYPE__)(__NAMESPACE_LOCAL_SYM __localdep_strto64)(__nptr, __endptr, __base);
