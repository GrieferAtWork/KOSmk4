...
__COMPILER_CVREDIRECT(__LIBC,__ATTR_WUNUSED __ATTR_NONNULL((2)),__fd_t,__NOTHROW_RPC,__VLIBDCALL,__localdep_c16openat32,(__fd_t __dirfd, __CHAR16_TYPE__ const *__filename, __oflag_t __oflags),wopenat,(__dirfd,__filename,__oflags),__oflags,1,(__mode_t))
...
__LOCAL_LIBC(c16openat64) __ATTR_WUNUSED __ATTR_NONNULL((2)) __fd_t
