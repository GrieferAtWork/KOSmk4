...
#include <features.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1, 3)),int,__NOTHROW_NCX,__localdep_dyn_string_insert_cstr,(struct dyn_string *__dst, __STDC_INT_AS_SIZE_T __index, char const *__src),dyn_string_insert_cstr,(__dst,__index,__src))
...
__LOCAL_LIBC(dyn_string_prepend_cstr) __ATTR_NONNULL((1, 2)) int
