 ...
 */
#ifndef __local_dyn_string_append_defined
#define __local_dyn_string_append_defined
#include <__crt.h>
...
__LOCAL_LIBC(dyn_string_append) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(dyn_string_append))(struct dyn_string *__dst, struct dyn_string __KOS_FIXED_CONST *__src) {
	return (__NAMESPACE_LOCAL_SYM __localdep_dyn_string_insert)(__dst, __dst->length, __src);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_dyn_string_append_defined
#define __local___localdep_dyn_string_append_defined
#define __localdep_dyn_string_append __LIBC_LOCAL_NAME(dyn_string_append)
#endif /* !__local___localdep_dyn_string_append_defined */
...
#undef __local_dyn_string_append_defined
...
#endif /* !__local_dyn_string_append_defined */
