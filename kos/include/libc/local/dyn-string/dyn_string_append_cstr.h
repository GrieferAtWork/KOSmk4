 ...
 */
#ifndef __local_dyn_string_append_cstr_defined
#define __local_dyn_string_append_cstr_defined
#include <__crt.h>
...
__LOCAL_LIBC(dyn_string_append_cstr) __ATTR_NONNULL((1, 2)) int
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_dyn_string_append_cstr_defined
#define __local___localdep_dyn_string_append_cstr_defined
#define __localdep_dyn_string_append_cstr __LIBC_LOCAL_NAME(dyn_string_append_cstr)
#endif /* !__local___localdep_dyn_string_append_cstr_defined */
...
#undef __local_dyn_string_append_cstr_defined
...
#endif /* !__local_dyn_string_append_cstr_defined */
