...
#include <__crt.h>
#if defined(__CRT_HAVE_pthread_mutex_init) || defined(__CRT_HAVE___pthread_mutex_init)
#include <features.h>
...
#include <bits/crt/pthreadtypes.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_OUT(1),__errno_t,__NOTHROW_NCX,__localdep_pthread_mutex_init,(__pthread_mutex_t *__self, __pthread_mutexattr_t const *__mutexattr),__pthread_mutex_init,(__self,__mutexattr))
#else /* ... */
#undef __local___localdep_pthread_mutex_init_defined
#endif /* !... */
#endif /* !__local___localdep_pthread_mutex_init_defined */
#ifndef __local___localdep_pthread_mutexattr_destroy_defined
...
#include <bits/crt/pthreadtypes.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_INOUT(1),__errno_t,__NOTHROW_NCX,__localdep_pthread_mutexattr_destroy,(__pthread_mutexattr_t *__self),__pthread_mutexattr_destroy,(__self))
#else /* ... */
#undef __local___localdep_pthread_mutexattr_destroy_defined
#endif /* !... */
#endif /* !__local___localdep_pthread_mutexattr_destroy_defined */
#ifndef __local___localdep_pthread_mutexattr_init_defined
...
#include <bits/crt/pthreadtypes.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_OUT(1),__errno_t,__NOTHROW_NCX,__localdep_pthread_mutexattr_init,(__pthread_mutexattr_t *__self),__pthread_mutexattr_init,(__self))
#else /* ... */
#undef __local___localdep_pthread_mutexattr_init_defined
#endif /* !... */
#endif /* !__local___localdep_pthread_mutexattr_init_defined */
...
#include <bits/crt/pthreadtypes.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_INOUT(1),__errno_t,__NOTHROW_NCX,__localdep_pthread_mutexattr_settype,(__pthread_mutexattr_t *__self, int __kind),__pthread_mutexattr_settype,(__self,__kind))
#else /* ... */
...
#else /* __CRT_HAVE_pthread_mutex_init || __CRT_HAVE___pthread_mutex_init */
#undef __local_mtx_init_defined
#endif /* !__CRT_HAVE_pthread_mutex_init && !__CRT_HAVE___pthread_mutex_init */
