...
#define __local___memmovedownl_chk_defined
#include <__crt.h>
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(__memmovedownl_chk))(void *__dst, void const *__src, __SIZE_TYPE__ __n_dwords, __SIZE_TYPE__ __dst_objsize) {
	__ssp_chk_dstbuf("memmovedownl", __dst, __n_dwords * 4, __dst_objsize);
	return (__NAMESPACE_LOCAL_SYM __localdep_memmovedownl)(__dst, __src, __n_dwords);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep___memmovedownl_chk_defined
#define __local___localdep___memmovedownl_chk_defined
#define __localdep___memmovedownl_chk __LIBC_LOCAL_NAME(__memmovedownl_chk)
#endif /* !__local___localdep___memmovedownl_chk_defined */
