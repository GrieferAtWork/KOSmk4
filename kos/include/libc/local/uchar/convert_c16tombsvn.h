 ...
 */
#ifndef __local_convert_c16tombsvn_defined
#define __local_convert_c16tombsvn_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(convert_c16tombsvn) __ATTR_MALLOC __ATTR_WUNUSED __ATTR_ACCESS_ROS(1, 2) char **
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(convert_c16tombsvn))(__CHAR16_TYPE__ const *const *__restrict __vector, __SIZE_TYPE__ __count) {
	__SIZE_TYPE__ __i;
	char **__result;
	__result = (char **)(__NAMESPACE_LOCAL_SYM __localdep_malloc)((__count + 1) * sizeof(char *));
	if __likely(__result) {
		for (__i = 0; __i < __count; ++__i) {
			char *__temp;
			__temp = (__NAMESPACE_LOCAL_SYM __localdep_convert_c16tombs)(__vector[__i]);
...
#undef __local_convert_c16tombsvn_defined
#endif /* (!__CRT_HAVE_malloc && !__CRT_HAVE___libc_malloc && !__CRT_HAVE_calloc && !__CRT_HAVE___libc_calloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc && !__CRT_HAVE_memalign && !__CRT_HAVE_aligned_alloc && !__CRT_HAVE___libc_memalign && !__CRT_HAVE_posix_memalign) || ((!__CRT_HAVE_convert_wcstombs || __SIZEOF_WCHAR_T__ != 2 || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$convert_wcstombs && (!__CRT_HAVE_convert_wcstombsn || __SIZEOF_WCHAR_T__ != 2) && !__CRT_HAVE_DOS$convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) */
#endif /* !__local_convert_c16tombsvn_defined */
