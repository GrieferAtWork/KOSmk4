...
__CREDIRECT(__ATTR_MALLOC __ATTR_WUNUSED __ATTR_INS(1, 2),char **,__NOTHROW_NCX,__localdep_convert_c16tombsvn,(__CHAR16_TYPE__ const *const *__restrict __vector, __SIZE_TYPE__ __count),convert_wcstombsvn,(__vector,__count))
#elif defined(__CRT_HAVE_DOS$convert_wcstombsvn)
__CREDIRECT_DOS(__ATTR_MALLOC __ATTR_WUNUSED __ATTR_INS(1, 2),char **,__NOTHROW_NCX,__localdep_convert_c16tombsvn,(__CHAR16_TYPE__ const *const *__restrict __vector, __SIZE_TYPE__ __count),convert_wcstombsvn,(__vector,__count))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(convert_c16tombsv) __ATTR_MALLOC __ATTR_WUNUSED __ATTR_IN_OPT(1) char **
