...
__CREDIRECT(__ATTR_MALLOC __ATTR_WUNUSED,__CHAR32_TYPE__ *,__NOTHROW_NCX,__localdep_convert_mbstoc32n,(char const *__restrict __str, __SIZE_TYPE__ __len, __SIZE_TYPE__ *__preslen),convert_mbstowcsn,(__str,__len,__preslen))
#elif defined(__CRT_HAVE_KOS$convert_mbstowcsn)
__CREDIRECT_KOS(__ATTR_MALLOC __ATTR_WUNUSED,__CHAR32_TYPE__ *,__NOTHROW_NCX,__localdep_convert_mbstoc32n,(char const *__restrict __str, __SIZE_TYPE__ __len, __SIZE_TYPE__ *__preslen),convert_mbstowcsn,(__str,__len,__preslen))
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_convert_mbstoc32n __NAMESPACE_LOCAL_TYPEHAX(__CHAR32_TYPE__ *(__LIBKCALL*)(char const *__restrict,__SIZE_TYPE__,__SIZE_TYPE__ *),__CHAR32_TYPE__ *(__LIBKCALL&)(char const *__restrict,__SIZE_TYPE__,__SIZE_TYPE__ *),convert_mbstowcsn)
...
#else /* ... */
#undef __local___localdep_convert_mbstoc32n_defined
#endif /* !... */
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(convert_mbstoc32) __ATTR_MALLOC __ATTR_WUNUSED __CHAR32_TYPE__ *
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(convert_mbstoc32))(char const *__restrict __str) {
	...
	return (__NAMESPACE_LOCAL_SYM __localdep_convert_mbstoc32n)(__str, (__NAMESPACE_LOCAL_SYM __localdep_strlen)(__str), __NULLPTR);
}
__NAMESPACE_LOCAL_END
