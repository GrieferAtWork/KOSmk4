...
__CREDIRECT(__ATTR_MALLOC __ATTR_WUNUSED,__CHAR32_TYPE__ **,__NOTHROW_NCX,__localdep_convert_mbstoc32vn,(char const *const *__restrict __vector, __SIZE_TYPE__ __count),convert_mbstowcsvn,(__vector,__count))
#elif defined(__CRT_HAVE_KOS$convert_mbstowcsvn)
__CREDIRECT_KOS(__ATTR_MALLOC __ATTR_WUNUSED,__CHAR32_TYPE__ **,__NOTHROW_NCX,__localdep_convert_mbstoc32vn,(char const *const *__restrict __vector, __SIZE_TYPE__ __count),convert_mbstowcsvn,(__vector,__count))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(convert_mbstoc32v) __ATTR_MALLOC __ATTR_WUNUSED __CHAR32_TYPE__ **
