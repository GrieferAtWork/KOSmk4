...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(convert_freevn))(char **__ptr, __SIZE_TYPE__ __count) {
	__SIZE_TYPE__ __i;
	if __unlikely(!__ptr)
		return;
	for (__i = 0; __i < __count; ++__i) {
		(__NAMESPACE_LOCAL_SYM __localdep_free)(__ptr[__i]);
	}
