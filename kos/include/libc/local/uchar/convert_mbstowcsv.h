...
__CREDIRECT(__ATTR_MALLOC __ATTR_WUNUSED,__WCHAR_TYPE__ **,__NOTHROW_NCX,__localdep_convert_mbstowcsvn,(char const *const *__restrict __vector, __SIZE_TYPE__ __count),convert_mbstowcsvn,(__vector,__count))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(convert_mbstowcsv) __ATTR_MALLOC __ATTR_WUNUSED __WCHAR_TYPE__ **
