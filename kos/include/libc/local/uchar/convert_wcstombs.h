 ...
 */
#ifndef __local_convert_wcstombs_defined
#define __local_convert_wcstombs_defined
#include <__crt.h>
#if defined(__CRT_HAVE_convert_wcstombsn) || defined(__CRT_HAVE_format_aprintf_printer) || defined(__CRT_HAVE_format_aprintf_alloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc)
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(convert_wcstombs) __ATTR_MALLOC __ATTR_WUNUSED __ATTR_ACCESS_RO_OPT(1) char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(convert_wcstombs))(__WCHAR_TYPE__ const *__str) {
	if __unlikely(!__str) {
#ifdef __EINVAL
	...
	return (__NAMESPACE_LOCAL_SYM __localdep_convert_wcstombsn)(__str, (__NAMESPACE_LOCAL_SYM __localdep_wcslen)(__str), __NULLPTR);
}
__NAMESPACE_LOCAL_END
...
#else /* __CRT_HAVE_convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc */
#undef __local_convert_wcstombs_defined
#endif /* !__CRT_HAVE_convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc */
#endif /* !__local_convert_wcstombs_defined */
