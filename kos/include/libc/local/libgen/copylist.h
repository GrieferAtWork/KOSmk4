...
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1, 2)),char *,__NOTHROW_RPC,__localdep_copylist64,(char const *__filename, __PIO_OFFSET64 *__p_filesize),copylist,(__filename,__p_filesize))
#elif defined(__CRT_HAVE_copylist64)
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1, 2)),char *,__NOTHROW_RPC,__localdep_copylist64,(char const *__filename, __PIO_OFFSET64 *__p_filesize),copylist64,(__filename,__p_filesize))
...
__LOCAL_LIBC(copylist) __ATTR_WUNUSED __ATTR_NONNULL((1, 2)) char *
