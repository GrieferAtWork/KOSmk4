...
__CREDIRECT(__ATTR_RETNONNULL __ATTR_IN(2) __ATTR_IN_OPT(3) __ATTR_OUT(1),char *,__NOTHROW_NCX,__localdep_streadd,(char *__dstbuf, char const *__string, char const *__dont_encode),streadd,(__dstbuf,__string,__dont_encode))
...
__LOCAL_LIBC(strecpy) __ATTR_RETNONNULL __ATTR_IN(2) __ATTR_IN_OPT(3) __ATTR_OUT(1) char *
