...
__CREDIRECT(__ATTR_RETNONNULL __ATTR_NONNULL((1, 2)),char *,__NOTHROW_NCX,__localdep_strcadd,(char *__dstbuf, char const *__string),strcadd,(__dstbuf,__string))
...
__LOCAL_LIBC(strccpy) __ATTR_RETNONNULL __ATTR_NONNULL((1, 2)) char *
