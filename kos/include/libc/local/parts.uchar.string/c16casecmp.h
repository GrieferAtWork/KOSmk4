 ...
 */
#ifndef __local_c16casecmp_defined
#define __local_c16casecmp_defined
#include <__crt.h>
...
__LOCAL_LIBC(c16casecmp) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2) int
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16casecmp))(__CHAR16_TYPE__ const *__s1, __CHAR16_TYPE__ const *__s2) {
...
#endif /* !__local_c16casecmp_defined */
