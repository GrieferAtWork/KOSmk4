...
#define __local_c32ndup_defined
#include <__crt.h>
...
__LOCAL_LIBC(c32ndup) __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_ACCESS_ROS(1, 2) __CHAR32_TYPE__ *
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32ndup))(__CHAR32_TYPE__ const *__restrict __str, __SIZE_TYPE__ __max_chars) {
	__SIZE_TYPE__ __resultsize = (__NAMESPACE_LOCAL_SYM __localdep_c32nlen)(__str, __max_chars) * sizeof(__CHAR32_TYPE__);
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c32ndup_defined
#define __local___localdep_c32ndup_defined
#define __localdep_c32ndup __LIBC_LOCAL_NAME(c32ndup)
#endif /* !__local___localdep_c32ndup_defined */
