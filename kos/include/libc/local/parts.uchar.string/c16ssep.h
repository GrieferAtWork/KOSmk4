...
#define __local_c16ssep_defined
#include <__crt.h>
...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16ssep))(__CHAR16_TYPE__ **__restrict __stringp, __CHAR16_TYPE__ const *__restrict __delim) {
	...
	if ((__result = *__stringp) == __NULLPTR || !*__result)
		return __NULLPTR;
	for (__iter = __result; *__iter && !(__NAMESPACE_LOCAL_SYM __localdep_c16schr)(__delim, *__iter); ++__iter)
		;
	if (*__iter)
		*__iter++ = '\0';
	*__stringp = __iter;
...
#define __local___localdep_c16ssep_defined
