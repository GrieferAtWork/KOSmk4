...
__LOCAL_LIBC(c32rev) __ATTR_RETNONNULL __ATTR_ACCESS_RW(1) __CHAR32_TYPE__ *
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32rev))(__CHAR32_TYPE__ *__restrict __str) {



	return (__CHAR32_TYPE__ *)(__NAMESPACE_LOCAL_SYM __localdep_memrevl)(__str, (__NAMESPACE_LOCAL_SYM __localdep_c32len)(__str));
...
#define __local___localdep_c32rev_defined
