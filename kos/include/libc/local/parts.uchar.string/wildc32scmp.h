 ...
 */
#ifndef __local_wildc32scmp_defined
#define __local_wildc32scmp_defined
#include <__crt.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(wildc32scmp) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)) int
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(wildc32scmp))(__CHAR32_TYPE__ const *__pattern, __CHAR32_TYPE__ const *__string) {
...
#ifndef __local___localdep_wildc32scmp_defined
#define __local___localdep_wildc32scmp_defined
#define __localdep_wildc32scmp __LIBC_LOCAL_NAME(wildc32scmp)
#endif /* !__local___localdep_wildc32scmp_defined */
#endif /* !__local_wildc32scmp_defined */
