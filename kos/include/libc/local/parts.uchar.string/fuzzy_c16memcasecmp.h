 ...
 */
#ifndef __local_fuzzy_c16memcasecmp_defined
#define __local_fuzzy_c16memcasecmp_defined
#include <__crt.h>
...
__LOCAL_LIBC(fuzzy_c16memcasecmp) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_ROS(1, 2) __ATTR_ACCESS_ROS(3, 4) __ATTR_NONNULL((1, 3)) __SIZE_TYPE__
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(fuzzy_c16memcasecmp))(__CHAR16_TYPE__ const *__s1, __SIZE_TYPE__ __s1_bytes, __CHAR16_TYPE__ const *__s2, __SIZE_TYPE__ __s2_bytes) {
	...
	for (__i = 0; __i < __s1_bytes; ++__i) {
		...
		for (__j = 0; __j < __s2_bytes; __j++) {
			...
			__cost  = __c1 != __c2 && ((__NAMESPACE_LOCAL_SYM __localdep_tolower16)((__CHAR16_TYPE__)__c1) !=
			                     (__NAMESPACE_LOCAL_SYM __localdep_tolower16)((__CHAR16_TYPE__)__c2));
			__cost += __v0[__j];
			__temp  = __v1[__j] + 1;
			if (__cost > __temp)
				__cost = __temp;
...
#else /* !__NO_MALLOCA */
#undef __local_fuzzy_c16memcasecmp_defined
#endif /* __NO_MALLOCA */
#endif /* !__local_fuzzy_c16memcasecmp_defined */
