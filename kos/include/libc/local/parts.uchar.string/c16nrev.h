...
#define __local_c16nrev_defined
#include <__crt.h>
...
__LOCAL_LIBC(c16nrev) __ATTR_LEAF __ATTR_RETNONNULL __ATTR_ACCESS_RWS(1, 2) __ATTR_NONNULL((1)) __CHAR16_TYPE__ *
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16nrev))(__CHAR16_TYPE__ *__restrict __str, __SIZE_TYPE__ __maxlen) {

	return (__CHAR16_TYPE__ *)(__NAMESPACE_LOCAL_SYM __localdep_memrevw)(__str, (__NAMESPACE_LOCAL_SYM __localdep_c16nlen)(__str, __maxlen));
...
#define __local___localdep_c16nrev_defined
