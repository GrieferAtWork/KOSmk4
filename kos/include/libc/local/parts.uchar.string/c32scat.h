...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32scat))(__CHAR32_TYPE__ *__restrict __buf, __CHAR32_TYPE__ const *__restrict __src) {
	(__CHAR32_TYPE__ *)__NAMESPACE_LOCAL_SYM __localdep_memcpyl(__NAMESPACE_LOCAL_SYM __localdep_c32send(__buf), __src, __NAMESPACE_LOCAL_SYM __localdep_c32slen(__src) + 1);
	return __buf;
}
__NAMESPACE_LOCAL_END
