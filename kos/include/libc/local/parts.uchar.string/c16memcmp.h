...
#define __local_c16memcmp_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(c16memcmp) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)) int
...
#define __local___localdep_c16memcmp_defined 1
