...
__LOCAL_LIBC(c32xfrm) __ATTR_ACCESS_ROS(2, 3) __ATTR_ACCESS_WRS(1, 3) __SIZE_TYPE__
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32xfrm))(__CHAR32_TYPE__ *__dst, __CHAR32_TYPE__ const *__restrict __src, __SIZE_TYPE__ __buflen) {
	/* XXX: Implement properly? */
	__SIZE_TYPE__ __n = (__NAMESPACE_LOCAL_SYM __localdep_c32nlen)(__src, __buflen);
