...
#define __local_c16slen_defined
#include <__crt.h>
...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16slen))(__CHAR16_TYPE__ const *__restrict __str) {
	return (__SIZE_TYPE__)((__NAMESPACE_LOCAL_SYM __localdep_c16send)(__str) - __str);
}
__NAMESPACE_LOCAL_END
