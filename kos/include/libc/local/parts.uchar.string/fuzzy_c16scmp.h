...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(fuzzy_c16scmp))(__CHAR16_TYPE__ const *__s1, __CHAR16_TYPE__ const *__s2) {
	return (__NAMESPACE_LOCAL_SYM __localdep_fuzzy_memcmpw)(__s1, (__NAMESPACE_LOCAL_SYM __localdep_c16slen)(__s1), __s2, (__NAMESPACE_LOCAL_SYM __localdep_c16slen)(__s2));
}
__NAMESPACE_LOCAL_END
