 ...
 */
#ifndef __local_c32lstrip_defined
#define __local_c32lstrip_defined
#include <__crt.h>
...
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(c32lstrip) __ATTR_PURE __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_IN(1) __CHAR32_TYPE__ *
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32lstrip))(__CHAR32_TYPE__ const *__str) {
	...
	while ((__NAMESPACE_LOCAL_SYM __localdep_isspace32)((__CHAR32_TYPE__)*__str))
		++__str;
...
#endif /* !__local_c32lstrip_defined */
