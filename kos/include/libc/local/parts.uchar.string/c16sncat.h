 ...
 */
#ifndef __local_c16sncat_defined
#define __local_c16sncat_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(c16sncat) __ATTR_RETNONNULL __ATTR_NONNULL((1, 2)) __CHAR16_TYPE__ *
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16sncat))(__CHAR16_TYPE__ *__restrict __buf, __CHAR16_TYPE__ const *__restrict __src, __SIZE_TYPE__ __buflen) {
	__SIZE_TYPE__ __srclen = __localdep_c16snlen(__src, __buflen);
	__CHAR16_TYPE__ *__dst = __localdep_c16send(__buf);
	(__CHAR16_TYPE__ *)__localdep_memcpyw(__dst, __src, __srclen);
	__dst[__srclen] = '\0';
	return __buf;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c16sncat_defined
#define __local___localdep_c16sncat_defined 1
#define __localdep_c16sncat __LIBC_LOCAL_NAME(c16sncat)
#endif /* !__local___localdep_c16sncat_defined */
#endif /* !__local_c16sncat_defined */
