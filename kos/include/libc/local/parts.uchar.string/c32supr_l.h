 ...
 */
#ifndef __local_c32supr_l_defined
#define __local_c32supr_l_defined
#include <__crt.h>
...
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
__COMPILER_EIREDIRECT(__ATTR_PURE __ATTR_WUNUSED,__WINT32_TYPE__,__NOTHROW_NCX,__LIBKCALL,__localdep_toupper32_l,(__WINT32_TYPE__ __ch, __locale_t __locale),_towupper_l,{ return __crt_towupper_l(__ch, __locale); })
...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32supr_l))(__CHAR32_TYPE__ *__restrict __str, __locale_t __locale) {
	...
	for (__iter = __str; (__ch = *__iter) != '\0'; ++__iter)
		*__iter = (__NAMESPACE_LOCAL_SYM __localdep_toupper32_l)(__ch, __locale);
	return __str;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c32supr_l_defined
#define __local___localdep_c32supr_l_defined
#define __localdep_c32supr_l __LIBC_LOCAL_NAME(c32supr_l)
#endif /* !__local___localdep_c32supr_l_defined */
#endif /* !__local_c32supr_l_defined */
