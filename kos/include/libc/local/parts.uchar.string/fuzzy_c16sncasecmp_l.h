...
#define __local_fuzzy_c16sncasecmp_l_defined
#include <__crt.h>
...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(fuzzy_c16sncasecmp_l))(__CHAR16_TYPE__ const *__s1, __SIZE_TYPE__ __s1_maxlen, __CHAR16_TYPE__ const *__s2, __SIZE_TYPE__ __s2_maxlen, __locale_t __locale) {
	return (__NAMESPACE_LOCAL_SYM __localdep_fuzzy_c16memcasecmp_l)(__s1, (__NAMESPACE_LOCAL_SYM __localdep_c16snlen)(__s1, __s1_maxlen), __s2, (__NAMESPACE_LOCAL_SYM __localdep_c16snlen)(__s2, __s2_maxlen), __locale);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_fuzzy_c16sncasecmp_l_defined
#define __local___localdep_fuzzy_c16sncasecmp_l_defined
