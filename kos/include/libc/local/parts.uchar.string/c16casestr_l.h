...
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_PURE __ATTR_WUNUSED __ATTR_INS(1, 3) __ATTR_INS(2, 3) __ATTR_NONNULL((1, 2)),int,__NOTHROW_NCX,__localdep_c16memcasecmp_l,(void const *__s1, void const *__s2, __SIZE_TYPE__ __num_chars, __locale_t __locale),wmemcasecmp_l,(__s1,__s2,__num_chars,__locale))
#elif defined(__CRT_HAVE_DOS$wmemcasecmp_l)
__NAMESPACE_LOCAL_END
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT_DOS(__ATTR_PURE __ATTR_WUNUSED __ATTR_INS(1, 3) __ATTR_INS(2, 3) __ATTR_NONNULL((1, 2)),int,__NOTHROW_NCX,__localdep_c16memcasecmp_l,(void const *__s1, void const *__s2, __SIZE_TYPE__ __num_chars, __locale_t __locale),wmemcasecmp_l,(__s1,__s2,__num_chars,__locale))
#elif __SIZEOF_WCHAR_T__ == 2
__NAMESPACE_LOCAL_END
#include <libc/local/wchar/wmemcasecmp_l.h>
__NAMESPACE_LOCAL_BEGIN
#define __localdep_c16memcasecmp_l __NAMESPACE_LOCAL_TYPEHAX(int(__LIBDCALL*)(void const *,void const *,__SIZE_TYPE__,__locale_t),int(__LIBDCALL&)(void const *,void const *,__SIZE_TYPE__,__locale_t),wmemcasecmp_l)
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16casestr_l))(__CHAR16_TYPE__ const *__haystack, __CHAR16_TYPE__ const *__needle, __locale_t __locale) {
	...
	for (; *__haystack; ++__haystack) {
		if ((__NAMESPACE_LOCAL_SYM __localdep_c16memcasecmp_l)(__haystack, __needle, __needle_len * sizeof(__CHAR16_TYPE__), __locale) == 0)
