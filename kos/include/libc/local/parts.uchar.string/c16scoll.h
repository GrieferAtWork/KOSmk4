...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_c16scmp __NAMESPACE_LOCAL_TYPEHAX(int(__LIBDCALL*)(__CHAR16_TYPE__ const *,__CHAR16_TYPE__ const *),int(__LIBDCALL&)(__CHAR16_TYPE__ const *,__CHAR16_TYPE__ const *),wcscmp)
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16scoll))(__CHAR16_TYPE__ const *__s1, __CHAR16_TYPE__ const *__s2) {
	return (__NAMESPACE_LOCAL_SYM __localdep_c16scmp)(__s1, __s2);
}
__NAMESPACE_LOCAL_END
