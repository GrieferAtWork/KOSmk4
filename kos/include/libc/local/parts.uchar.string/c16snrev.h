...
#define __local_c16snrev_defined
#include <__crt.h>
...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16snrev))(__CHAR16_TYPE__ *__restrict __str, __SIZE_TYPE__ __maxlen) {
	...
	return (__CHAR16_TYPE__ *)(__NAMESPACE_LOCAL_SYM __localdep_memrevw)(__str, (__NAMESPACE_LOCAL_SYM __localdep_c16snlen)(__str, __maxlen));
...
#define __local___localdep_c16snrev_defined
