...
#define __local_fuzzy_c32memcmp_defined
#include <__crt.h>
...
__LOCAL_LIBC(fuzzy_c32memcmp) __ATTR_PURE __ATTR_WUNUSED __ATTR_INS(1, 2) __ATTR_INS(3, 4) __ATTR_NONNULL((1, 3)) __SIZE_TYPE__
...
#define __local___localdep_fuzzy_c32memcmp_defined
