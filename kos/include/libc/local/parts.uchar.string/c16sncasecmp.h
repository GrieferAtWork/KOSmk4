 ...
 */
#ifndef __local_c16sncasecmp_defined
#define __local_c16sncasecmp_defined
#include <__crt.h>
...
__LOCAL_LIBC(c16sncasecmp) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)) int
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16sncasecmp))(__CHAR16_TYPE__ const *__s1, __CHAR16_TYPE__ const *__s2, __SIZE_TYPE__ __maxlen) {
...
#endif /* !__local_c16sncasecmp_defined */
