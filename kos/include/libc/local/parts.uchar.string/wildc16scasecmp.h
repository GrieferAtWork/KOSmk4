 ...
 */
#ifndef __local_wildc16scasecmp_defined
#define __local_wildc16scasecmp_defined
#include <__crt.h>
		...
		if (*__pattern == '*') {
			...
			for (;;) {
				...
				if (__card_post == __ch || __card_post == (__CHAR16_TYPE__)(__NAMESPACE_LOCAL_SYM __localdep_tolower16)((__CHAR16_TYPE__)__ch)) {
					...
					if (!(__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wildc16scasecmp))(__string, __pattern))
						return 0;
				} else if (!__ch) {
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_wildc16scasecmp_defined
#define __local___localdep_wildc16scasecmp_defined
#define __localdep_wildc16scasecmp __LIBC_LOCAL_NAME(wildc16scasecmp)
#endif /* !__local___localdep_wildc16scasecmp_defined */
#endif /* !__local_wildc16scasecmp_defined */
