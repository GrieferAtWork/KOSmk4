...
#define __local_c32memset_defined
#include <__crt.h>
...
__LOCAL_LIBC(c32memset) __ATTR_RETNONNULL __ATTR_ACCESS_WRS(1, 3) __CHAR32_TYPE__ *
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32memset))(__CHAR32_TYPE__ *__dst, __CHAR32_TYPE__ __filler, __SIZE_TYPE__ __num_chars) {
	...
	return (__CHAR32_TYPE__ *)(__NAMESPACE_LOCAL_SYM __localdep_memsetl)(__dst, (__UINT32_TYPE__)__filler, __num_chars);
...
#define __local___localdep_c32memset_defined
