...
#define __local_c16set_defined
#include <__crt.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(c16set) __ATTR_LEAF __ATTR_ACCESS_RW(1) __CHAR16_TYPE__ *
...
#define __local___localdep_c16set_defined
