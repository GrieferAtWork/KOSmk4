...
__LOCAL_LIBC(c32ncpy) __ATTR_RETNONNULL __ATTR_ACCESS_ROS(2, 3) __ATTR_ACCESS_WRS(1, 3) __CHAR32_TYPE__ *
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32ncpy))(__CHAR32_TYPE__ *__restrict __buf, __CHAR32_TYPE__ const *__restrict __src, __SIZE_TYPE__ __buflen) {
	...
	(__CHAR32_TYPE__ *)(__NAMESPACE_LOCAL_SYM __localdep_memsetl)(__buf + __srclen, (__CHAR32_TYPE__)'\0', __buflen - __srclen);
	return __buf;
}
__NAMESPACE_LOCAL_END
