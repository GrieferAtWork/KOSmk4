...
#define __local_c32ncpy_defined
#include <__crt.h>
...
__LOCAL_LIBC(c32ncpy) __ATTR_RETNONNULL __ATTR_INS(2, 3) __ATTR_OUTS(1, 3) __CHAR32_TYPE__ *
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32ncpy))(__CHAR32_TYPE__ *__restrict __buf, __CHAR32_TYPE__ const *__restrict __src, __SIZE_TYPE__ __buflen) {
	__CHAR32_TYPE__ *__ptr;
	__SIZE_TYPE__ __srclen = (__NAMESPACE_LOCAL_SYM __localdep_c32nlen)(__src, __buflen);
	__ptr = (__CHAR32_TYPE__ *)(__NAMESPACE_LOCAL_SYM __localdep_mempcpyl)(__buf, __src, __srclen);
	(void)(__CHAR32_TYPE__ *)(__NAMESPACE_LOCAL_SYM __localdep_memsetl)(__ptr, (__CHAR32_TYPE__)'\0', __buflen - __srclen);
	return __buf;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c32ncpy_defined
#define __local___localdep_c32ncpy_defined
