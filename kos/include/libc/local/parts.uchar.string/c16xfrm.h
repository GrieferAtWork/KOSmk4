...
#define __local_c16xfrm_defined
#include <__crt.h>
...
__LOCAL_LIBC(c16xfrm) __ATTR_ACCESS_ROS(2, 3) __ATTR_ACCESS_WRS(1, 3) __SIZE_TYPE__
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16xfrm))(__CHAR16_TYPE__ *__dst, __CHAR16_TYPE__ const *__restrict __src, __SIZE_TYPE__ __buflen) {
	/* XXX: Implement properly? */
	__SIZE_TYPE__ __n = (__NAMESPACE_LOCAL_SYM __localdep_c16nlen)(__src, __buflen);
	(__NAMESPACE_LOCAL_SYM __localdep_memcpy)(__dst, __src, __n * sizeof(__CHAR16_TYPE__));
	return __n;
}
__NAMESPACE_LOCAL_END
