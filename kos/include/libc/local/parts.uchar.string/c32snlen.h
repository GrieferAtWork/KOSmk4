...
#define __local_c32snlen_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_c32snend __NAMESPACE_LOCAL_TYPEHAX(__CHAR32_TYPE__ *(__LIBKCALL*)(__CHAR32_TYPE__ const *__restrict,__SIZE_TYPE__),__CHAR32_TYPE__ *(__LIBKCALL&)(__CHAR32_TYPE__ const *__restrict,__SIZE_TYPE__),wcsnend)
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32snlen))(__CHAR32_TYPE__ const *__restrict __str, __SIZE_TYPE__ __maxlen) {
	return (__SIZE_TYPE__)((__NAMESPACE_LOCAL_SYM __localdep_c32snend)(__str, __maxlen) - __str);
}
__NAMESPACE_LOCAL_END
