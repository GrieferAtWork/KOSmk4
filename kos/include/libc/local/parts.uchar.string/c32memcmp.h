...
#define __local_c32memcmp_defined
#include <__crt.h>
...
__LOCAL_LIBC(c32memcmp) __ATTR_PURE __ATTR_WUNUSED __ATTR_INS(1, 3) __ATTR_INS(2, 3) __ATTR_NONNULL((1, 2)) int
...
#define __local___localdep_c32memcmp_defined
