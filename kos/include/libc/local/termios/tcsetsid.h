...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(tcsetsid) __ATTR_FDARG(1) int
...
#else /* (__CRT_HAVE_ioctl || __CRT_HAVE___ioctl || __CRT_HAVE___libc_ioctl || __CRT_HAVE___ioctl_time64) && __TIOCSCTTY */
