 ...
 */
#ifndef __local_tcsetwinsize_defined
#define __local_tcsetwinsize_defined
#include <__crt.h>
...
__LOCAL_LIBC(tcsetwinsize) __ATTR_FDARG(1) __ATTR_IN(2) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(tcsetwinsize))(__fd_t __fd, struct winsize const *__winsize_p) {
	return (__NAMESPACE_LOCAL_SYM __localdep_ioctl)(__fd, __TIOCSWINSZ, __winsize_p);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_tcsetwinsize_defined
#define __local___localdep_tcsetwinsize_defined
#define __localdep_tcsetwinsize __LIBC_LOCAL_NAME(tcsetwinsize)
#endif /* !__local___localdep_tcsetwinsize_defined */
#else /* (__CRT_HAVE_ioctl || __CRT_HAVE___ioctl || __CRT_HAVE___libc_ioctl || __CRT_HAVE___ioctl_time64) && __TIOCSWINSZ */
#undef __local_tcsetwinsize_defined
#endif /* (!__CRT_HAVE_ioctl && !__CRT_HAVE___ioctl && !__CRT_HAVE___libc_ioctl && !__CRT_HAVE___ioctl_time64) || !__TIOCSWINSZ */
#endif /* !__local_tcsetwinsize_defined */
