...
#if defined(__CRT_HAVE_mmap64) || defined(__CRT_HAVE_mmap) || defined(__CRT_HAVE___mmap)
#include <features.h>
#ifndef __PIO_OFFSET
...
#else /* __CRT_HAVE_mmap64 || __CRT_HAVE_mmap || __CRT_HAVE___mmap */
#undef __local_mmap_defined
#endif /* !__CRT_HAVE_mmap64 && !__CRT_HAVE_mmap && !__CRT_HAVE___mmap */
