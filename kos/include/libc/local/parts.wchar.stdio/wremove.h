...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_IN(2),int,__NOTHROW_RPC,__localdep_wremoveat,(__fd_t __dirfd, __WCHAR_TYPE__ const *__filename),wremoveat,(__dirfd,__filename))
...
__LOCAL_LIBC(wremove) __ATTR_IN(1) int
