 ...
 */
#ifndef __local_wfreopen_defined
#define __local_wfreopen_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(wfreopen) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(3) __FILE *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(wfreopen))(__WCHAR_TYPE__ const *__filename, __WCHAR_TYPE__ const *__mode, __FILE *__stream) {
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_wfreopen_defined
#define __local___localdep_wfreopen_defined
#define __localdep_wfreopen __LIBC_LOCAL_NAME(wfreopen)
#endif /* !__local___localdep_wfreopen_defined */
...
#undef __local_wfreopen_defined
...
#endif /* !__local_wfreopen_defined */
