 ...
 */
#ifndef __local_wfopen_defined
#define __local_wfopen_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(wfopen) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2) __FILE *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(wfopen))(__WCHAR_TYPE__ const *__filename, __WCHAR_TYPE__ const *__mode) {
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_wfopen_defined
#define __local___localdep_wfopen_defined
#define __localdep_wfopen __LIBC_LOCAL_NAME(wfopen)
#endif /* !__local___localdep_wfopen_defined */
