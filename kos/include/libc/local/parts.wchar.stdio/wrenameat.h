...
__CREDIRECT(__ATTR_IN(2) __ATTR_IN(4),int,__NOTHROW_RPC,__localdep_wrenameat2,(__fd_t __oldfd, __WCHAR_TYPE__ const *__oldname, __fd_t __newfd, __WCHAR_TYPE__ const *__newname_or_path, __atflag_t __flags),wrenameat2,(__oldfd,__oldname,__newfd,__newname_or_path,__flags))
...
__LOCAL_LIBC(wrenameat) __ATTR_IN(2) __ATTR_IN(4) int
