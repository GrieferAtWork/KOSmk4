...
__CREDIRECT(__ATTR_ACCESS_RO(2) __ATTR_LIBC_WPRINTF(2, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vswprintf,(__WCHAR_TYPE__ *__buf, __WCHAR_TYPE__ const *__format, __builtin_va_list __args),_vswprintf,(__buf,__format,__args))
...
__LOCAL_LIBC(_swprintf) __ATTR_ACCESS_RO(2) __ATTR_LIBC_WPRINTF(2, 3) __ATTR_NONNULL((1)) __STDC_INT_AS_SSIZE_T
