 ...
 */
#ifndef __local__wfopen_s_defined
#define __local__wfopen_s_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_wfopen_s) __ATTR_IN(2) __ATTR_IN(3) __ATTR_OUT(1) __errno_t
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_wfopen_s))(__FILE **__pstream, __WCHAR_TYPE__ const *__filename, __WCHAR_TYPE__ const *__mode) {
	__errno_t __result;
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__wfopen_s_defined
#define __local___localdep__wfopen_s_defined
#define __localdep__wfopen_s __LIBC_LOCAL_NAME(_wfopen_s)
#endif /* !__local___localdep__wfopen_s_defined */
...
#undef __local__wfopen_s_defined
...
#endif /* !__local__wfopen_s_defined */
