...
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(2) __ATTR_LIBC_WSCANF(2, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep_vswscanf_s,(__WCHAR_TYPE__ const *__buf, __WCHAR_TYPE__ const *__format, __builtin_va_list __args),vswscanf_s,(__buf,__format,__args))
...
__LOCAL_LIBC(swscanf_s) __ATTR_WUNUSED __ATTR_IN(2) __ATTR_LIBC_WSCANF(2, 3) __ATTR_NONNULL((1)) __STDC_INT_AS_SSIZE_T
