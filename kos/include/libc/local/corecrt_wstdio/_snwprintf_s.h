...
__CREDIRECT(__ATTR_LIBC_WPRINTF(4, 0) __ATTR_NONNULL((4)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vsnwprintf_s,(__WCHAR_TYPE__ *__buf, __SIZE_TYPE__ __bufsize, __SIZE_TYPE__ __maxsize, __WCHAR_TYPE__ const *__format, __builtin_va_list __args),_vsnwprintf_s,(__buf,__bufsize,__maxsize,__format,__args))
...
__LOCAL_LIBC(_snwprintf_s) __ATTR_LIBC_WPRINTF(4, 5) __ATTR_NONNULL((4)) __STDC_INT_AS_SSIZE_T
