 ...
 */
#ifndef __local___stdio_common_vswprintf_s_defined
#define __local___stdio_common_vswprintf_s_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(__stdio_common_vswprintf_s) __ATTR_IN(4) __ATTR_LIBC_WPRINTF(4, 0) __STDC_INT_AS_SSIZE_T
...
#endif /* !__local___stdio_common_vswprintf_s_defined */
