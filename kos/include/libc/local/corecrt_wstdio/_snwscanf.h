...
__CREDIRECT(__ATTR_LIBC_WSCANF(3, 0) __ATTR_NONNULL((3)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vsnwscanf,(__WCHAR_TYPE__ const *__buf, __SIZE_TYPE__ __bufsize, __WCHAR_TYPE__ const *__format, __builtin_va_list __args),_vsnwscanf,(__buf,__bufsize,__format,__args))
...
__LOCAL_LIBC(_snwscanf) __ATTR_WUNUSED __ATTR_LIBC_WSCANF(3, 4) __ATTR_NONNULL((3)) __STDC_INT_AS_SSIZE_T
