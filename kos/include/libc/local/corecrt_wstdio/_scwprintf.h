...
__CREDIRECT(__ATTR_ACCESS_RO(1) __ATTR_LIBC_WPRINTF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vscwprintf,(__WCHAR_TYPE__ const *__format, __builtin_va_list __args),_vscwprintf,(__format,__args))
...
__LOCAL_LIBC(_scwprintf) __ATTR_ACCESS_RO(1) __ATTR_LIBC_WPRINTF(1, 2) __STDC_INT_AS_SSIZE_T
