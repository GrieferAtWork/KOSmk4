 ...
 */
#ifndef __local__wfsopen_defined
#define __local__wfsopen_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(_wfsopen) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2) __FILE *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_wfsopen))(__WCHAR_TYPE__ const *__filename, __WCHAR_TYPE__ const *__mode, __STDC_INT_AS_UINT_T __sh_flag) {
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__wfsopen_defined
#define __local___localdep__wfsopen_defined
#define __localdep__wfsopen __LIBC_LOCAL_NAME(_wfsopen)
#endif /* !__local___localdep__wfsopen_defined */
...
#undef __local__wfsopen_defined
...
#endif /* !__local__wfsopen_defined */
