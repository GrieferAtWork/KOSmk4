...
#define __local__vsnwprintf_s_defined
#include <__crt.h>
#include <features.h>
...
__CREDIRECT(__ATTR_IN(4) __ATTR_LIBC_WPRINTF(4, 0) __ATTR_OUTS(1, 2),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vsnwprintf_s_l,(__WCHAR_TYPE__ *__buf, __SIZE_TYPE__ __bufsize, __SIZE_TYPE__ __maxsize, __WCHAR_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args),_vsnwprintf_s_l,(__buf,__bufsize,__maxsize,__format,__locale,__args))
...
__LOCAL_LIBC(_vsnwprintf_s) __ATTR_IN(4) __ATTR_LIBC_WPRINTF(4, 0) __ATTR_OUTS(1, 2) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_vsnwprintf_s))(__WCHAR_TYPE__ *__buf, __SIZE_TYPE__ __bufsize, __SIZE_TYPE__ __maxsize, __WCHAR_TYPE__ const *__format, __builtin_va_list __args) {
	return (__NAMESPACE_LOCAL_SYM __localdep__vsnwprintf_s_l)(__buf, __bufsize, __maxsize, __format, __NULLPTR, __args);
}
__NAMESPACE_LOCAL_END
