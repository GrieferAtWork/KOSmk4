...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_vsnwprintf_l) __ATTR_NONNULL((3)) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_vsnwprintf_l))(__WCHAR_TYPE__ *__buf, __SIZE_TYPE__ __bufsize, __WCHAR_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args) {
	int __result = (__NAMESPACE_LOCAL_SYM __localdep___stdio_common_vswprintf)(_CRT_INTERNAL_LOCAL_PRINTF_OPTIONS | 1, __buf, __bufsize, __format, __locale, __args);
