...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep_vwprintf_s,(__WCHAR_TYPE__ const *__format, __builtin_va_list __args),vwprintf_s,(__format,__args))
...
__LOCAL_LIBC(wprintf_s) __ATTR_NONNULL((1)) __STDC_INT_AS_SSIZE_T
