...
#define __local__vsnwscanf_s_l_defined
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_vsnwscanf_s_l) __ATTR_WUNUSED __ATTR_LIBC_WSCANF(3, 0) __ATTR_NONNULL((3)) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_vsnwscanf_s_l))(__WCHAR_TYPE__ const *__buf, __SIZE_TYPE__ __bufsize, __WCHAR_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args) {
	return (__NAMESPACE_LOCAL_SYM __localdep___stdio_common_vswscanf)(_CRT_INTERNAL_LOCAL_SCANF_OPTIONS | 1, __buf, __bufsize, __format, __locale, __args);
}
__NAMESPACE_LOCAL_END
