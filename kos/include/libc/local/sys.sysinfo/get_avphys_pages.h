...
#define __local_get_avphys_pages_defined
#include <__crt.h>
...
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(get_avphys_pages))(void) {
	...
	__result = (__UINTPTR_TYPE__)__info.freeram *
...
#define __local___localdep_get_avphys_pages_defined
