 ...
 */
#ifndef __local_c32frealpathat_defined
#define __local_c32frealpathat_defined
#include <__crt.h>
...
__LOCAL_LIBC(c32frealpathat) __ATTR_WUNUSED __ATTR_IN(2) __ATTR_OUTS(3, 4) __CHAR32_TYPE__ *
