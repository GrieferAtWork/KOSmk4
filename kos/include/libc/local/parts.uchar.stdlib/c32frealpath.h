...
__CREDIRECT(__ATTR_WUNUSED __ATTR_FDARG(1) __ATTR_OUTS(2, 3),__CHAR32_TYPE__ *,__NOTHROW_RPC,__localdep_c32frealpath4,(__fd_t __fd, __CHAR32_TYPE__ *__resolved, __SIZE_TYPE__ __buflen, __atflag_t __flags),wfrealpath4,(__fd,__resolved,__buflen,__flags))
#elif defined(__CRT_HAVE_KOS$wfrealpath4)
__CREDIRECT_KOS(__ATTR_WUNUSED __ATTR_FDARG(1) __ATTR_OUTS(2, 3),__CHAR32_TYPE__ *,__NOTHROW_RPC,__localdep_c32frealpath4,(__fd_t __fd, __CHAR32_TYPE__ *__resolved, __SIZE_TYPE__ __buflen, __atflag_t __flags),wfrealpath4,(__fd,__resolved,__buflen,__flags))
...
__LOCAL_LIBC(c32frealpath) __ATTR_WUNUSED __ATTR_FDARG(1) __ATTR_OUTS(2, 3) __CHAR32_TYPE__ *
