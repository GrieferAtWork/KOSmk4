...
__CREDIRECT(__ATTR_ACCESS_RO_OPT(1),int,__NOTHROW_RPC,__localdep_system,(char const *__command),system,(__command))
#elif defined(__CRT_HAVE___libc_system)
__CREDIRECT(__ATTR_ACCESS_RO_OPT(1),int,__NOTHROW_RPC,__localdep_system,(char const *__command),__libc_system,(__command))
