 ...
 */
#ifndef __local_c16system_defined
#define __local_c16system_defined
#include <__crt.h>
...
__CREDIRECT(,int,__NOTHROW_RPC,__localdep_system,(char const *__command),system,(__command))
...
__LOCAL_LIBC(c16system) int
__NOTHROW_RPC(__LIBDCALL __LIBC_LOCAL_NAME(c16system))(__CHAR16_TYPE__ const *__cmd) {
	int __result;
	char *__used_cmd;
	if (!__cmd) {
		__result = (__NAMESPACE_LOCAL_SYM __localdep_system)(__NULLPTR);
	} else {
		__used_cmd = (__NAMESPACE_LOCAL_SYM __localdep_convert_c16tombs)(__cmd);
...
#endif /* !__local_c16system_defined */
