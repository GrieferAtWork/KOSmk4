...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((2)),__CHAR32_TYPE__ *,__NOTHROW_RPC,__localdep_c32frealpathat,(__fd_t __dirfd, __CHAR32_TYPE__ const *__filename, __CHAR32_TYPE__ *__resolved, __SIZE_TYPE__ __buflen, __atflag_t __flags),wfrealpathat,(__dirfd,__filename,__resolved,__buflen,__flags))
#elif defined(__CRT_HAVE_KOS$wfrealpathat)
__NAMESPACE_LOCAL_END
#include <bits/types.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT_KOS(__ATTR_WUNUSED __ATTR_NONNULL((2)),__CHAR32_TYPE__ *,__NOTHROW_RPC,__localdep_c32frealpathat,(__fd_t __dirfd, __CHAR32_TYPE__ const *__filename, __CHAR32_TYPE__ *__resolved, __SIZE_TYPE__ __buflen, __atflag_t __flags),wfrealpathat,(__dirfd,__filename,__resolved,__buflen,__flags))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(c32realpath) __ATTR_WUNUSED __ATTR_NONNULL((1)) __CHAR32_TYPE__ *
