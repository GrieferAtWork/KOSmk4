...
__LOCAL_LIBC(xvasprintf) __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_LIBC_PRINTF(1, 0) char *
