 ...
 */
#ifndef __local_physmem_available_defined
#define __local_physmem_available_defined
#include <__crt.h>
...
__LOCAL_LIBC(physmem_available) __ATTR_PURE __ATTR_WUNUSED double
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(physmem_available))(void) {
	__SIZE_TYPE__ __pages    = (__NAMESPACE_LOCAL_SYM __localdep_sysconf)(_SC_AVPHYS_PAGES);
	__SIZE_TYPE__ __pagesize = (__NAMESPACE_LOCAL_SYM __localdep_getpagesize)();
	return (double)__pages * (double)__pagesize;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_physmem_available_defined
#define __local___localdep_physmem_available_defined
#define __localdep_physmem_available __LIBC_LOCAL_NAME(physmem_available)
#endif /* !__local___localdep_physmem_available_defined */
#else /* (__CRT_HAVE_getpagesize || __CRT_HAVE___getpagesize || __ARCH_PAGESIZE) && (__CRT_HAVE_sysconf || __CRT_HAVE___sysconf) && _SC_AVPHYS_PAGES */
#undef __local_physmem_available_defined
...
#endif /* !__local_physmem_available_defined */
