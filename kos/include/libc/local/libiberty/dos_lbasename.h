 ...
 */
#ifndef __local_dos_lbasename_defined
#define __local_dos_lbasename_defined
#include <__crt.h>
...
__LOCAL_LIBC(dos_lbasename) __ATTR_PURE __ATTR_RETNONNULL __ATTR_WUNUSED char const *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(dos_lbasename))(char const *__filename) {
#ifdef _WIN32
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_dos_lbasename_defined
#define __local___localdep_dos_lbasename_defined
#define __localdep_dos_lbasename __LIBC_LOCAL_NAME(dos_lbasename)
#endif /* !__local___localdep_dos_lbasename_defined */
#endif /* !__local_dos_lbasename_defined */
