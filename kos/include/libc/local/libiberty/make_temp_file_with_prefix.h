...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(make_temp_file_with_prefix) __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_ACCESS_RO_OPT(1) __ATTR_ACCESS_RO_OPT(2) char *
