...
__LOCAL_LIBC(unix_lbasename) __ATTR_PURE __ATTR_RETNONNULL __ATTR_WUNUSED const char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(unix_lbasename))(const char *__filename) {
#ifndef _WIN32
