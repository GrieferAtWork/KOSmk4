 ...
 */
#ifndef __local__wsopen_defined
#define __local__wsopen_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(_wsopen) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __fd_t
__NOTHROW_RPC(__VLIBCCALL __LIBC_LOCAL_NAME(_wsopen))(__WCHAR_TYPE__ const *__filename, __oflag_t __oflags, int __sflags, ...) {
	__fd_t __result;
	__builtin_va_list __args;
	__builtin_va_start(__args, __sflags);
	(void)__sflags;
	__result = (__NAMESPACE_LOCAL_SYM __localdep_wopen)(__filename, __oflags, __builtin_va_arg(__args, __mode_t));
