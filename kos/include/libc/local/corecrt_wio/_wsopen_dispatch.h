...
__CREDIRECT(__ATTR_NONNULL((1, 2)),__errno_t,__NOTHROW_RPC,__localdep__wsopen_s,(__fd_t *__fd, __WCHAR_TYPE__ const *__filename, __oflag_t __oflags, int __sflags, __mode_t __mode),_wsopen_s,(__fd,__filename,__oflags,__sflags,__mode))
...
__LOCAL_LIBC(_wsopen_dispatch) __ATTR_WUNUSED __ATTR_NONNULL((1, 5)) __errno_t
