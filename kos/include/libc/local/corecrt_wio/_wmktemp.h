 ...
 */
#ifndef __local__wmktemp_defined
#define __local__wmktemp_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(_wmktemp) __ATTR_RETNONNULL __ATTR_INOUT(1) __WCHAR_TYPE__ *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_wmktemp))(__WCHAR_TYPE__ *__template_) {
	char *__utf8_template, *__rand;
	__WCHAR_TYPE__ *__rand_dst;
	__SIZE_TYPE__ __i;
	__utf8_template = (__NAMESPACE_LOCAL_SYM __localdep_convert_wcstombs)(__template_);
	...
	__rand_dst = (__NAMESPACE_LOCAL_SYM __localdep_wcsend)(__template_) - 6;
	for (__i = 0; __i < 6; ++__i)
		__rand_dst[__i] = (__WCHAR_TYPE__)(unsigned char)__rand[__i];
...
#endif /* !__local__wmktemp_defined */
