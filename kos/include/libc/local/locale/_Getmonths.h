 ...
 */
#ifndef __local__Getmonths_defined
#define __local__Getmonths_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_Getmonths) __ATTR_WUNUSED char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_Getmonths))(void) {
	/* Essentially, we do:
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__Getmonths_defined
#define __local___localdep__Getmonths_defined
#define __localdep__Getmonths __LIBC_LOCAL_NAME(_Getmonths)
#endif /* !__local___localdep__Getmonths_defined */
...
#undef __local__Getmonths_defined
...
#endif /* !__local__Getmonths_defined */
