...
__LOCAL_LIBC(format_wscanf) __ATTR_ACCESS_RO(4) __ATTR_LIBC_WSCANF(4, 0) __ATTR_NONNULL((1, 2)) __SSIZE_TYPE__
(__LIBCCALL __LIBC_LOCAL_NAME(format_wscanf))(__pformatgetc __pgetc, __pformatungetc __pungetc, void *__arg, __WCHAR_TYPE__ const *__restrict __format, ...) __THROWS(...) {
	...
	__result = (__NAMESPACE_LOCAL_SYM __localdep_format_vwscanf)(__pgetc, __pungetc, __arg, __format, __args);
	__builtin_va_end(__args);
	return __result;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_format_wscanf_defined
#define __local___localdep_format_wscanf_defined
#define __localdep_format_wscanf __LIBC_LOCAL_NAME(format_wscanf)
#endif /* !__local___localdep_format_wscanf_defined */
#endif /* !__local_format_wscanf_defined */
