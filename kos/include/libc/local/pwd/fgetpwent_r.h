...
#define __local_fgetpwent_r_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(fgetpwent_r) __ATTR_ACCESS_RW(1) __ATTR_ACCESS_WR(2) __ATTR_ACCESS_WR(5) __ATTR_ACCESS_WRS(3, 4) __errno_t
...
#define __local___localdep_fgetpwent_r_defined
