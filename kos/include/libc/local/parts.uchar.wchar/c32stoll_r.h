...
#define __local_c32stoll_r_defined 1
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(c32stoll_r) __ATTR_LEAF __ATTR_NONNULL((1)) __LONGLONG
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32stoll_r))(__CHAR32_TYPE__ const *__restrict __nptr, __CHAR32_TYPE__ **__endptr, __STDC_INT_AS_UINT_T __base, __errno_t *__error) {
	...
	return (__LONGLONG)__localdep_c32sto64_r(__nptr, __endptr, __base, __error);
#elif __SIZEOF_LONG_LONG__ >= 4
	return (__LONGLONG)__localdep_c32sto32_r(__nptr, __endptr, __base, __error);
#else /* ... */
...
#define __local___localdep_c32stoll_r_defined 1
