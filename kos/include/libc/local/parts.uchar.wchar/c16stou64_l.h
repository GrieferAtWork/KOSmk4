...
#define __local_c16stou64_l_defined 1
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(c16stou64_l) __ATTR_LEAF __ATTR_NONNULL((1)) __UINT64_TYPE__
...
#define __local___localdep_c16stou64_l_defined 1
