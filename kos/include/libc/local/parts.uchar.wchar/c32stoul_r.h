...
#define __local_c32stoul_r_defined 1
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(c32stoul_r) __ATTR_LEAF __ATTR_NONNULL((1)) unsigned long
...
#define __local___localdep_c32stoul_r_defined 1
