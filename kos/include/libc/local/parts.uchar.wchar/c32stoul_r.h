...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32stoul_r))(__CHAR32_TYPE__ const *__restrict __nptr, __CHAR32_TYPE__ **__endptr, __STDC_INT_AS_UINT_T __base, __errno_t *__error) {
	...
	return (unsigned long)__localdep_c32stou64_r(__nptr, __endptr, __base, __error);
#elif __SIZEOF_LONG__ >= 4
	return (unsigned long)__localdep_c32stou32_r(__nptr, __endptr, __base, __error);
#else /* ... */
