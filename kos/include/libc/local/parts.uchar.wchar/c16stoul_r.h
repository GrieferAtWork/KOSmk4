...
#define __local_c16stoul_r_defined 1
#include <__crt.h>
#include <features.h>
...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16stoul_r))(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, __STDC_INT_AS_UINT_T __base, __errno_t *__error) {
	...
	return (unsigned long)__localdep_c16stou64_r(__nptr, __endptr, __base, __error);
#elif __SIZEOF_LONG__ >= 4
	return (unsigned long)__localdep_c16stou32_r(__nptr, __endptr, __base, __error);
#else /* ... */
...
#define __local___localdep_c16stoul_r_defined 1
