...
#define __local_c32sto32_l_defined 1
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(c32sto32_l) __ATTR_LEAF __ATTR_NONNULL((1)) __INT32_TYPE__
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32sto32_l))(__CHAR32_TYPE__ const *__restrict __nptr, __CHAR32_TYPE__ **__endptr, __STDC_INT_AS_UINT_T __base, __locale_t __locale) {
	(void)__locale;
	return __localdep_c32sto32(__nptr, __endptr, __base);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c32sto32_l_defined
#define __local___localdep_c32sto32_l_defined 1
