...
#define __local_c16lcpy_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(c16lcpy) __ATTR_LEAF __ATTR_NONNULL((1, 2)) __SIZE_TYPE__
...
#define __local___localdep_c16lcpy_defined 1
