...
#define __local_c32lcpy_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(c32lcpy) __ATTR_LEAF __ATTR_NONNULL((1, 2)) __SIZE_TYPE__
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32lcpy))(__CHAR32_TYPE__ *__restrict __dst, __CHAR32_TYPE__ const *__restrict __src, __SIZE_TYPE__ __bufsize) {
	...
	__localdep_memcpy(__dst, __src, __copy_size*sizeof(__CHAR32_TYPE__));
	__dst[__copy_size] = '\0';
	return __result;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c32lcpy_defined
#define __local___localdep_c32lcpy_defined 1
