...
__LOCAL_LIBC(c16sto32) __ATTR_LEAF __ATTR_NONNULL((1)) __INT32_TYPE__
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16sto32))(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, __STDC_INT_AS_UINT_T __base) {
	...
	__errno_t __error;
	__result = __localdep_c16sto32_r(__nptr, __endptr, __base, &__error);
	if (__error == __ERANGE)
		__libc_seterrno(__ERANGE);
	return __result;
#else /* __libc_geterrno && __ERANGE */
	return __localdep_c16sto32_r(__nptr, __endptr, __base, __NULLPTR);
