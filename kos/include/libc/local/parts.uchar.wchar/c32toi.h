...
#if __SIZEOF_INT__ <= 4
	return (int)(__NAMESPACE_LOCAL_SYM __localdep_c32sto32)(__nptr, __NULLPTR, 10);
#else /* __SIZEOF_INT__ <= 4 */
	return (int)(__NAMESPACE_LOCAL_SYM __localdep_c32sto64)(__nptr, __NULLPTR, 10);
#endif /* __SIZEOF_INT__ > 4 */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c32toi_defined
#define __local___localdep_c32toi_defined
