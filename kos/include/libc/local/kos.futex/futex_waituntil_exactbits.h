...
#define __local_futex_waituntil_exactbits_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futex_waituntil_exactbits) __ATTR_ACCESS_RO(1) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_waituntil_exactbits))(__uintptr_t *__uaddr, __uintptr_t __bitmask, __uintptr_t __setmask) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutex64)(__uaddr, LFUTEX_WAIT_UNTIL_BITMASK, __bitmask, (struct __timespec64 const *)__NULLPTR, __setmask);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_waituntil_exactbits_defined
#define __local___localdep_futex_waituntil_exactbits_defined
#define __localdep_futex_waituntil_exactbits __LIBC_LOCAL_NAME(futex_waituntil_exactbits)
#endif /* !__local___localdep_futex_waituntil_exactbits_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_waituntil_exactbits_defined
