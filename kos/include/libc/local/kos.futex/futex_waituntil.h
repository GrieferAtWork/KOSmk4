...
#define __local_futex_waituntil_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futex_waituntil) __ATTR_ACCESS_RO(1) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_waituntil))(__uintptr_t *__uaddr, __uintptr_t __not_equal_to_value) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutex64)(__uaddr, LFUTEX_WAIT_UNTIL, __not_equal_to_value, (struct __timespec64 const *)__NULLPTR);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_waituntil_defined
#define __local___localdep_futex_waituntil_defined
#define __localdep_futex_waituntil __LIBC_LOCAL_NAME(futex_waituntil)
#endif /* !__local___localdep_futex_waituntil_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_waituntil_defined
#endif /* !__CRT_HAVE_lfutex64 && !__CRT_HAVE_lfutex */
#endif /* !__local_futex_waituntil_defined */
