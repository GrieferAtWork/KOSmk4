 ...
 */
#ifndef __local_futex_timedwaitwhile_anybit64_defined
#define __local_futex_timedwaitwhile_anybit64_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futex_timedwaitwhile_anybit64) __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO_OPT(3) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_timedwaitwhile_anybit64))(__uintptr_t *__uaddr, __uintptr_t __bitmask, struct __timespec64 const *__rel_timeout) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutex64)(__uaddr, LFUTEX_WAIT_UNTIL_BITMASK, __bitmask, __rel_timeout, 0);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_timedwaitwhile_anybit64_defined
#define __local___localdep_futex_timedwaitwhile_anybit64_defined
#define __localdep_futex_timedwaitwhile_anybit64 __LIBC_LOCAL_NAME(futex_timedwaitwhile_anybit64)
#endif /* !__local___localdep_futex_timedwaitwhile_anybit64_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_timedwaitwhile_anybit64_defined
#endif /* !__CRT_HAVE_lfutex64 && !__CRT_HAVE_lfutex */
#endif /* !__local_futex_timedwaitwhile_anybit64_defined */
