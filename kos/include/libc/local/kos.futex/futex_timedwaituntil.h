 ...
 */
#ifndef __local_futex_timedwaituntil_defined
#define __local_futex_timedwaituntil_defined
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futex_timedwaituntil) __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO_OPT(3) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_timedwaituntil))(__uintptr_t *__uaddr, __uintptr_t __not_equal_to_value, struct timespec const *__rel_timeout) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutex)(__uaddr, LFUTEX_WAIT_UNTIL, __not_equal_to_value, __rel_timeout);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_timedwaituntil_defined
#define __local___localdep_futex_timedwaituntil_defined
#define __localdep_futex_timedwaituntil __LIBC_LOCAL_NAME(futex_timedwaituntil)
#endif /* !__local___localdep_futex_timedwaituntil_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_timedwaituntil_defined
#endif /* !__CRT_HAVE_lfutex64 && !__CRT_HAVE_lfutex */
#endif /* !__local_futex_timedwaituntil_defined */
