 ...
 */
#ifndef __local_futex_timedwaitlock_defined
#define __local_futex_timedwaitlock_defined 1
#include <__crt.h>
#include <features.h>
...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_timedwaitlock))(__uintptr_t *__uaddr, struct timespec const *__rel_timeout) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutex)(__uaddr, LFUTEX_WAIT_LOCK, 0, __rel_timeout);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_timedwaitlock_defined
#define __local___localdep_futex_timedwaitlock_defined 1
#define __localdep_futex_timedwaitlock __LIBC_LOCAL_NAME(futex_timedwaitlock)
#endif /* !__local___localdep_futex_timedwaitlock_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_timedwaitlock_defined
#endif /* !__CRT_HAVE_lfutex64 && !__CRT_HAVE_lfutex */
#endif /* !__local_futex_timedwaitlock_defined */
