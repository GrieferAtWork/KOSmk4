...
#define __local_futex_waitwhile_anybit_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futex_waitwhile_anybit) __ATTR_ACCESS_RO(1) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_waitwhile_anybit))(__uintptr_t *__uaddr, __uintptr_t __bitmask) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutex64)(__uaddr, LFUTEX_WAIT_UNTIL_BITMASK, __bitmask, (struct __timespec64 const *)__NULLPTR, 0);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_waitwhile_anybit_defined
#define __local___localdep_futex_waitwhile_anybit_defined
