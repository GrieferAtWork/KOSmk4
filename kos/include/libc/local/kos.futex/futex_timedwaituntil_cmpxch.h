 ...
 */
#ifndef __local_futex_timedwaituntil_cmpxch_defined
#define __local_futex_timedwaituntil_cmpxch_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futex_timedwaituntil_cmpxch) __ATTR_NONNULL((1)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_timedwaituntil_cmpxch))(__uintptr_t *__uaddr, __uintptr_t __old_value, __uintptr_t __new_value, struct timespec const *__rel_timeout) {
	return __NAMESPACE_LOCAL_SYM __localdep_lfutex(__uaddr, LFUTEX_WAIT_UNTIL_CMPXCH, __old_value, __rel_timeout, __new_value);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_timedwaituntil_cmpxch_defined
#define __local___localdep_futex_timedwaituntil_cmpxch_defined 1
#define __localdep_futex_timedwaituntil_cmpxch __LIBC_LOCAL_NAME(futex_timedwaituntil_cmpxch)
#endif /* !__local___localdep_futex_timedwaituntil_cmpxch_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_timedwaituntil_cmpxch_defined
#endif /* !__CRT_HAVE_lfutex64 && !__CRT_HAVE_lfutex */
#endif /* !__local_futex_timedwaituntil_cmpxch_defined */
