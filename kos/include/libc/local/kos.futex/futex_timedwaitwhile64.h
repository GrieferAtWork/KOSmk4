...
#define __local_futex_timedwaitwhile64_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(futex_timedwaitwhile64) __ATTR_NONNULL((1)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_timedwaitwhile64))(__uintptr_t *__uaddr, __uintptr_t __equal_to_value, struct __timespec64 const *__rel_timeout) {
	return __localdep_lfutex64(__uaddr, LFUTEX_WAIT_WHILE, __equal_to_value, __rel_timeout);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_timedwaitwhile64_defined
#define __local___localdep_futex_timedwaitwhile64_defined 1
