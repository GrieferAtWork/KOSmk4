 ...
 */
#ifndef __local_futex_waitwhile_belowequal_defined
#define __local_futex_waitwhile_belowequal_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futex_waitwhile_belowequal) __ATTR_ACCESS_RO(1) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_waitwhile_belowequal))(__uintptr_t *__uaddr, __uintptr_t __below_or_equal_value) {
	__hybrid_assert(__above_or_equal_value != (__uintptr_t)-1);
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutex64)(__uaddr, LFUTEX_WAIT_WHILE_BELOW, __below_or_equal_value + 1, (struct __timespec64 const *)__NULLPTR);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_waitwhile_belowequal_defined
#define __local___localdep_futex_waitwhile_belowequal_defined
#define __localdep_futex_waitwhile_belowequal __LIBC_LOCAL_NAME(futex_waitwhile_belowequal)
#endif /* !__local___localdep_futex_waitwhile_belowequal_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_waitwhile_belowequal_defined
#endif /* !__CRT_HAVE_lfutex64 && !__CRT_HAVE_lfutex */
#endif /* !__local_futex_waitwhile_belowequal_defined */
