...
#define __local_futex_waitwhile_exactbits_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futex_waitwhile_exactbits) __ATTR_ACCESS_RO(1) int
...
#define __local___localdep_futex_waitwhile_exactbits_defined
