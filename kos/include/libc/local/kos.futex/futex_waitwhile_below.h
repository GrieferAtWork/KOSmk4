 ...
 */
#ifndef __local_futex_waitwhile_below_defined
#define __local_futex_waitwhile_below_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futex_waitwhile_below) __ATTR_NONNULL((1)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_waitwhile_below))(__uintptr_t *__uaddr, __uintptr_t __below_value) {
	return __NAMESPACE_LOCAL_SYM __localdep_lfutex64(__uaddr, LFUTEX_WAIT_WHILE_BELOW, __below_value, (struct __timespec64 const *)__NULLPTR);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_waitwhile_below_defined
#define __local___localdep_futex_waitwhile_below_defined 1
#define __localdep_futex_waitwhile_below __LIBC_LOCAL_NAME(futex_waitwhile_below)
#endif /* !__local___localdep_futex_waitwhile_below_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_waitwhile_below_defined
#endif /* !__CRT_HAVE_lfutex64 && !__CRT_HAVE_lfutex */
#endif /* !__local_futex_waitwhile_below_defined */
