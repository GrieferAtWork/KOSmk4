...
#define __local_futex_waitwhile_allbits_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futex_waitwhile_allbits) __ATTR_ACCESS_RO(1) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_waitwhile_allbits))(__uintptr_t *__uaddr, __uintptr_t __bitmask) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutex64)(__uaddr, LFUTEX_WAIT_WHILE_BITMASK, __bitmask, (struct __timespec64 const *)__NULLPTR, __bitmask);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_waitwhile_allbits_defined
#define __local___localdep_futex_waitwhile_allbits_defined
#define __localdep_futex_waitwhile_allbits __LIBC_LOCAL_NAME(futex_waitwhile_allbits)
#endif /* !__local___localdep_futex_waitwhile_allbits_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_waitwhile_allbits_defined
#endif /* !__CRT_HAVE_lfutex64 && !__CRT_HAVE_lfutex */
#endif /* !__local_futex_waitwhile_allbits_defined */
