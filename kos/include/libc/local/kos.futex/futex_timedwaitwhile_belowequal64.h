...
#define __local_futex_timedwaitwhile_belowequal64_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futex_timedwaitwhile_belowequal64) __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO_OPT(3) int
...
#define __local___localdep_futex_timedwaitwhile_belowequal64_defined
