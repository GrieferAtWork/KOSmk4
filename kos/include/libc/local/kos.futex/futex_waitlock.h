...
#define __local_futex_waitlock_defined
#include <__crt.h>
...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futex_waitlock))(__uintptr_t *__uaddr) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutex64)(__uaddr, LFUTEX_WAIT_LOCK, 0, (struct __timespec64 const *)__NULLPTR);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futex_waitlock_defined
#define __local___localdep_futex_waitlock_defined
#define __localdep_futex_waitlock __LIBC_LOCAL_NAME(futex_waitlock)
#endif /* !__local___localdep_futex_waitlock_defined */
#else /* __CRT_HAVE_lfutex64 || __CRT_HAVE_lfutex */
#undef __local_futex_waitlock_defined
