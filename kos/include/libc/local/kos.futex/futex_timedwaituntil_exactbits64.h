...
#define __local_futex_timedwaituntil_exactbits64_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futex_timedwaituntil_exactbits64) __ATTR_NONNULL((1)) int
...
#define __local___localdep_futex_timedwaituntil_exactbits64_defined 1
