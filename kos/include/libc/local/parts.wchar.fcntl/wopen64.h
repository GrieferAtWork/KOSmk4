 ...
 */
#ifndef __local_wopen64_defined
#define __local_wopen64_defined
#include <__crt.h>
...
#ifndef __local___localdep_wopen32_defined
#define __local___localdep_wopen32_defined
#ifdef __CRT_HAVE_wopen
__CVREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(1),__fd_t,__NOTHROW_RPC,__localdep_wopen32,(__WCHAR_TYPE__ const *__filename, __oflag_t __oflags),wopen,(__filename,__oflags),__oflags,1,(__mode_t))
#elif defined(__CRT_HAVE__wopen)
__CVREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(1),__fd_t,__NOTHROW_RPC,__localdep_wopen32,(__WCHAR_TYPE__ const *__filename, __oflag_t __oflags),_wopen,(__filename,__oflags),__oflags,1,(__mode_t))
#else /* ... */
#undef __local___localdep_wopen32_defined
#endif /* !... */
#endif /* !__local___localdep_wopen32_defined */
__LOCAL_LIBC(wopen64) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __fd_t
__NOTHROW_RPC(__VLIBCCALL __LIBC_LOCAL_NAME(wopen64))(__WCHAR_TYPE__ const *__filename, __oflag_t __oflags, ...) {
	__fd_t __result;
...
#if defined(__CRT_HAVE_wopen) || defined(__CRT_HAVE__wopen)
#ifdef __O_LARGEFILE
	__result = (__NAMESPACE_LOCAL_SYM __localdep_wopen32)(__filename, __oflags | __O_LARGEFILE, __mode);
#else /* __O_LARGEFILE */
	__result = (__NAMESPACE_LOCAL_SYM __localdep_wopen32)(__filename, __oflags, __mode);
#endif /* !__O_LARGEFILE */
#else /* __CRT_HAVE_wopen || __CRT_HAVE__wopen */
	{
...
#endif /* !__CRT_HAVE_wopen && !__CRT_HAVE__wopen */
	return __result;
}
__NAMESPACE_LOCAL_END
...
#else /* __CRT_HAVE_wopen || __CRT_HAVE__wopen || ((__CRT_HAVE_open64 || __CRT_HAVE___open64 || __CRT_HAVE_open || __CRT_HAVE__open || __CRT_HAVE___open || __CRT_HAVE___libc_open) && (__CRT_HAVE_convert_wcstombs || __CRT_HAVE_convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc)) */
#undef __local_wopen64_defined
#endif /* !__CRT_HAVE_wopen && !__CRT_HAVE__wopen && ((!__CRT_HAVE_open64 && !__CRT_HAVE___open64 && !__CRT_HAVE_open && !__CRT_HAVE__open && !__CRT_HAVE___open && !__CRT_HAVE___libc_open) || (!__CRT_HAVE_convert_wcstombs && !__CRT_HAVE_convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc)) */
#endif /* !__local_wopen64_defined */
