 ...
 */
#ifndef __local__c16strdate_defined
#define __local__c16strdate_defined
#include <__crt.h>
...
__LOCAL_LIBC(_c16strdate) __ATTR_ACCESS_WR(1) __CHAR16_TYPE__ *
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(_c16strdate))(__CHAR16_TYPE__ __buf[9]) {
	unsigned int __i;
	char __abuf[9], *__ptr;
...
#undef __local__c16strdate_defined
...
#endif /* !__local__c16strdate_defined */
