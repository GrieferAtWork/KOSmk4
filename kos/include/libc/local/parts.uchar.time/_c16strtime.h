...
__CREDIRECT(__ATTR_ACCESS_WR(1),char *,__NOTHROW_NCX,__localdep__strtime,(char __buf[9]),_strtime,(__buf))
...
__LOCAL_LIBC(_c16strtime) __ATTR_ACCESS_WR(1) __CHAR16_TYPE__ *
