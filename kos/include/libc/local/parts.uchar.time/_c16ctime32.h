...
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(1),__CHAR16_TYPE__ *,__NOTHROW_NCX,__localdep__c16ctime64,(__time64_t const *__timer),_wctime64,(__timer))
#elif defined(__CRT_HAVE_DOS$_wctime64)
__CREDIRECT_DOS(__ATTR_WUNUSED __ATTR_ACCESS_RO(1),__CHAR16_TYPE__ *,__NOTHROW_NCX,__localdep__c16ctime64,(__time64_t const *__timer),_wctime64,(__timer))
...
__LOCAL_LIBC(_c16ctime32) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __CHAR16_TYPE__ *
