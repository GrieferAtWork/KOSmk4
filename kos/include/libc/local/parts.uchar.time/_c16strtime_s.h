...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1)),__CHAR16_TYPE__ *,__NOTHROW_NCX,__localdep__c16strtime,(__CHAR16_TYPE__ __buf[9]),_wstrtime,(__buf))
#elif defined(__CRT_HAVE_DOS$_wstrtime)
__NAMESPACE_LOCAL_END
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT_DOS(__ATTR_NONNULL((1)),__CHAR16_TYPE__ *,__NOTHROW_NCX,__localdep__c16strtime,(__CHAR16_TYPE__ __buf[9]),_wstrtime,(__buf))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_c16strtime_s) __ATTR_NONNULL((1)) __errno_t
...
#else /* (__CRT_HAVE__wstrtime && __SIZEOF_WCHAR_T__ == 2 && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_DOS$_wstrtime || __CRT_HAVE__strtime || __CRT_HAVE_time64 || __CRT_HAVE__time64 || __CRT_HAVE_time || __CRT_HAVE___time || __CRT_HAVE___libc_time || __CRT_HAVE__time32 */
#undef __local__c16strtime_s_defined
#endif /* (!__CRT_HAVE__wstrtime || __SIZEOF_WCHAR_T__ != 2 || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$_wstrtime && !__CRT_HAVE__strtime && !__CRT_HAVE_time64 && !__CRT_HAVE__time64 && !__CRT_HAVE_time && !__CRT_HAVE___time && !__CRT_HAVE___libc_time && !__CRT_HAVE__time32 */
