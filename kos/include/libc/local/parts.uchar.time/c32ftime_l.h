...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_c32ftime __NAMESPACE_LOCAL_TYPEHAX(__SIZE_TYPE__(__LIBKCALL*)(__CHAR32_TYPE__ *__restrict,__SIZE_TYPE__,__CHAR32_TYPE__ const *__restrict,struct __NAMESPACE_STD_SYM tm const *__restrict),__SIZE_TYPE__(__LIBKCALL&)(__CHAR32_TYPE__ *__restrict,__SIZE_TYPE__,__CHAR32_TYPE__ const *__restrict,struct __NAMESPACE_STD_SYM tm const *__restrict),wcsftime)
#else /* ... */
__NAMESPACE_LOCAL_END
...
__LOCAL_LIBC(c32ftime_l) __ATTR_IN(3) __ATTR_IN(4) __ATTR_LIBC_C32FTIME(3, 0) __ATTR_OUTS(1, 2) __SIZE_TYPE__
