...
__LOCAL_LIBC(_c16ctime64) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __CHAR16_TYPE__ *
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(_c16ctime64))(__time64_t const *__timer) {
	static __CHAR16_TYPE__ __wctime64_retbuf[26];




	return (__NAMESPACE_LOCAL_SYM __localdep__c16ctime64_s)(__wctime64_retbuf, 26, __timer) ? __NULLPTR : __wctime64_retbuf;
