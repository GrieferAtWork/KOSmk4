...
__CREDIRECT(__ATTR_NONNULL((1, 3)),__errno_t,__NOTHROW_NCX,__localdep__c16ctime64_s,(__CHAR16_TYPE__ *__buf, __SIZE_TYPE__ __buflen, __time64_t const *__timer),_wctime64_s,(__buf,__buflen,__timer))
#elif defined(__CRT_HAVE_DOS$_wctime64_s)
__CREDIRECT_DOS(__ATTR_NONNULL((1, 3)),__errno_t,__NOTHROW_NCX,__localdep__c16ctime64_s,(__CHAR16_TYPE__ *__buf, __SIZE_TYPE__ __buflen, __time64_t const *__timer),_wctime64_s,(__buf,__buflen,__timer))
...
__LOCAL_LIBC(_c16ctime32_s) __ATTR_NONNULL((1, 3)) __errno_t
