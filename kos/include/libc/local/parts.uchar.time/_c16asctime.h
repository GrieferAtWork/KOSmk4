...
__CREDIRECT(__ATTR_ACCESS_RO(3) __ATTR_ACCESS_WRS(1, 2),__errno_t,__NOTHROW_NCX,__localdep__c16asctime_s,(__CHAR16_TYPE__ *__buf, __SIZE_TYPE__ __buflen, struct __NAMESPACE_STD_SYM tm const *__tp),_wasctime_s,(__buf,__buflen,__tp))
#elif defined(__CRT_HAVE_DOS$_wasctime_s)
__CREDIRECT_DOS(__ATTR_ACCESS_RO(3) __ATTR_ACCESS_WRS(1, 2),__errno_t,__NOTHROW_NCX,__localdep__c16asctime_s,(__CHAR16_TYPE__ *__buf, __SIZE_TYPE__ __buflen, struct __NAMESPACE_STD_SYM tm const *__tp),_wasctime_s,(__buf,__buflen,__tp))
...
__LOCAL_LIBC(_c16asctime) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __CHAR16_TYPE__ *
