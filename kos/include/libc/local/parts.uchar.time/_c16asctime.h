...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(_c16asctime))(struct __NAMESPACE_STD_SYM tm const *__tp) {
	...
	static __CHAR16_TYPE__ __wctime_buf[26] = {0};




	return (__NAMESPACE_LOCAL_SYM __localdep__c16asctime_s)(__wctime_buf, 26, __tp) ? __NULLPTR : __wctime_buf;
