 ...
 */
#ifndef __local__c32strtime_defined
#define __local__c32strtime_defined
#include <__crt.h>
...
__LOCAL_LIBC(_c32strtime) __ATTR_ACCESS_WR(1) __CHAR32_TYPE__ *
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(_c32strtime))(__CHAR32_TYPE__ __buf[9]) {
	unsigned int __i;
	char __abuf[9], *__ptr;
...
#undef __local__c32strtime_defined
...
#endif /* !__local__c32strtime_defined */
