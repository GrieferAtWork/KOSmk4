 ...
 */
#ifndef __local__c32asctime_s_defined
#define __local__c32asctime_s_defined
#include <__crt.h>
...
__LOCAL_LIBC(_c32asctime_s) __ATTR_ACCESS_RO(3) __ATTR_ACCESS_WRS(1, 2) __errno_t
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(_c32asctime_s))(__CHAR32_TYPE__ *__buf, __SIZE_TYPE__ __buflen, struct __NAMESPACE_STD_SYM tm const *__tp) {
	...
	for (__i = 0; __i < 26; ++__i)
		__buf[__i] = (__CHAR32_TYPE__)__ptr[__i];
	return 0;
}
__NAMESPACE_LOCAL_END
...
#endif /* !__local__c32asctime_s_defined */
