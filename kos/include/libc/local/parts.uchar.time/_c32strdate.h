 ...
 */
#ifndef __local__c32strdate_defined
#define __local__c32strdate_defined
#include <__crt.h>
...
__LOCAL_LIBC(_c32strdate) __ATTR_NONNULL((1)) __CHAR32_TYPE__ *
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(_c32strdate))(__CHAR32_TYPE__ __buf[9]) {
	unsigned int __i;
	char __abuf[9], *__ptr;
...
#undef __local__c32strdate_defined
...
#endif /* !__local__c32strdate_defined */
