 ...
 */
#ifndef __local__c32ctime64_defined
#define __local__c32ctime64_defined
#include <__crt.h>
...
__LOCAL_LIBC(_c32ctime64) __ATTR_WUNUSED __ATTR_IN(1) __CHAR32_TYPE__ *
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(_c32ctime64))(__time64_t const *__timer) {
	...
	static __CHAR32_TYPE__ __wctime_buf[26];




	return (__NAMESPACE_LOCAL_SYM __localdep__c32ctime64_s)(__wctime_buf, 26, __timer) ? __NULLPTR : __wctime_buf;
...
#endif /* !__local__c32ctime64_defined */
