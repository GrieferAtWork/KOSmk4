 ...
 */
#ifndef __local_ether_aton_p_defined
#define __local_ether_aton_p_defined
#include <__crt.h>
struct ether_addr;
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(ether_aton_p) __ATTR_WUNUSED __ATTR_INOUT(1) __ATTR_OUT(2) char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(ether_aton_p))(char const *__restrict __asc, struct ether_addr *__restrict __addr) {
	unsigned int __i;
	for (__i = 0; __i < 6; ++__i) {
...
#endif /* !__local_ether_aton_p_defined */
