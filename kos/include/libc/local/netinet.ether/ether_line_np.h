 ...
 */
#ifndef __local_ether_line_np_defined
#define __local_ether_line_np_defined
#include <__crt.h>
struct ether_addr;
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(ether_line_np) __ATTR_WUNUSED __ATTR_IN(1) __ATTR_OUT(2) char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(ether_line_np))(char *__line, struct ether_addr *__addr) {
...
#endif /* !__local_ether_line_np_defined */
