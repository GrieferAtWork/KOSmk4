...
#define __local_ether_paton_r_defined
#include <__crt.h>
struct ether_addr;
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(ether_paton_r) __ATTR_WUNUSED __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1) struct ether_addr *
