...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(pthread_attr_setstackaddr))(__pthread_attr_t *__self, void *__stackaddr) {
	__errno_t __result;
	...
	__result = (__NAMESPACE_LOCAL_SYM __localdep_pthread_attr_getstack)(__self, &___old_stackaddr, &__stacksize);
