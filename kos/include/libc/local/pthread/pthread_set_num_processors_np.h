...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_IN_OPT(3),int,__NOTHROW_NCX,__localdep_sched_setaffinity,(__pid_t __pid, __SIZE_TYPE__ __cpusetsize, struct __cpu_set_struct const *__cpuset),sched_setaffinity,(__pid,__cpusetsize,__cpuset))
