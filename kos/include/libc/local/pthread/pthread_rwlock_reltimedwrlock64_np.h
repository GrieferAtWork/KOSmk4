...
#define __local_pthread_rwlock_reltimedwrlock64_np_defined
#include <__crt.h>
...
__LOCAL_LIBC(pthread_rwlock_reltimedwrlock64_np) __ATTR_WUNUSED __ATTR_IN(2) __ATTR_INOUT(1) __errno_t
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(pthread_rwlock_reltimedwrlock64_np))(__pthread_rwlock_t *__restrict __self, struct __timespec64 const *__restrict __reltime) {
	__errno_t __result;
