 ...
 */
#ifndef __local_pthread_get_stacksize_np_defined
#define __local_pthread_get_stacksize_np_defined
#include <__crt.h>
#if (defined(__CRT_HAVE_pthread_getattr_np) || defined(__CRT_HAVE_pthread_attr_get_np)) && (defined(__CRT_HAVE_pthread_attr_getstacksize) || defined(__CRT_HAVE_pthread_attr_getstack))
...
#include <bits/types.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_IN(1) __ATTR_OUT(2),__errno_t,__NOTHROW_NCX,__localdep_pthread_attr_getstacksize,(__pthread_attr_t const *__restrict __self, __SIZE_TYPE__ *__restrict __stacksize),pthread_attr_getstacksize,(__self,__stacksize))
...
#else /* ... */
#undef __local___localdep_pthread_attr_getstacksize_defined
#endif /* !... */
...
__LOCAL_LIBC(pthread_get_stacksize_np) __SIZE_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(pthread_get_stacksize_np))(__pthread_t __self) {
	__SIZE_TYPE__ __result = 0;
	__pthread_attr_t __attr;
	if ((__NAMESPACE_LOCAL_SYM __localdep_pthread_getattr_np)(__self, &__attr) == 0) {
		if ((__NAMESPACE_LOCAL_SYM __localdep_pthread_attr_getstacksize)(&__attr, &__result) != 0)
			__result = 0;
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_pthread_get_stacksize_np_defined
#define __local___localdep_pthread_get_stacksize_np_defined
#define __localdep_pthread_get_stacksize_np __LIBC_LOCAL_NAME(pthread_get_stacksize_np)
#endif /* !__local___localdep_pthread_get_stacksize_np_defined */
#else /* (__CRT_HAVE_pthread_getattr_np || __CRT_HAVE_pthread_attr_get_np) && (__CRT_HAVE_pthread_attr_getstacksize || __CRT_HAVE_pthread_attr_getstack) */
#undef __local_pthread_get_stacksize_np_defined
#endif /* (!__CRT_HAVE_pthread_getattr_np && !__CRT_HAVE_pthread_attr_get_np) || (!__CRT_HAVE_pthread_attr_getstacksize && !__CRT_HAVE_pthread_attr_getstack) */
#endif /* !__local_pthread_get_stacksize_np_defined */
