...
#define __local_pthread_rwlock_reltimedwrlock_np_defined 1
#include <__crt.h>
...
/* Dependency: pthread_rwlock_reltimedwrlock64_np from pthread */
...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(pthread_rwlock_reltimedwrlock_np))(__pthread_rwlock_t *__restrict __rwlock, struct timespec const *__restrict __reltime) {
	...
	__result = __localdep_pthread_rwlock_reltimedwrlock64_np(__rwlock, &__reltime32);
	return __result;
#endif /* !__CRT_HAVE_pthread_rwlock_reltimedwrlock_np */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_pthread_rwlock_reltimedwrlock_np_defined
#define __local___localdep_pthread_rwlock_reltimedwrlock_np_defined 1
