...
#include <__crt.h>
#if (defined(__CRT_HAVE_gettid) || defined(__CRT_HAVE___threadid)) && (defined(__CRT_HAVE_getpid) || defined(__CRT_HAVE__getpid) || defined(__CRT_HAVE___getpid) || defined(__CRT_HAVE___libc_getpid))
...
#else /* (__CRT_HAVE_gettid || __CRT_HAVE___threadid) && (__CRT_HAVE_getpid || __CRT_HAVE__getpid || __CRT_HAVE___getpid || __CRT_HAVE___libc_getpid) */
#undef __local_pthread_main_np_defined
#endif /* (!__CRT_HAVE_gettid && !__CRT_HAVE___threadid) || (!__CRT_HAVE_getpid && !__CRT_HAVE__getpid && !__CRT_HAVE___getpid && !__CRT_HAVE___libc_getpid) */
