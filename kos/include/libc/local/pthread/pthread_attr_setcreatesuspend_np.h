...
#include <__crt.h>
#ifdef __CRT_HAVE_pthread_attr_setstartsuspend_np
#include <bits/types.h>
#include <bits/crt/pthreadtypes.h>
__NAMESPACE_LOCAL_BEGIN
#ifndef __local___localdep_pthread_attr_setstartsuspend_np_defined
#define __local___localdep_pthread_attr_setstartsuspend_np_defined
__CREDIRECT(__ATTR_INOUT(1),__errno_t,__NOTHROW_NCX,__localdep_pthread_attr_setstartsuspend_np,(__pthread_attr_t *__restrict __self, int __start_suspended),pthread_attr_setstartsuspend_np,(__self,__start_suspended))
#endif /* !__local___localdep_pthread_attr_setstartsuspend_np_defined */
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(pthread_attr_setcreatesuspend_np))(__pthread_attr_t *__restrict __self) {
	return (__NAMESPACE_LOCAL_SYM __localdep_pthread_attr_setstartsuspend_np)(__self, 1);
}
...
#else /* __CRT_HAVE_pthread_attr_setstartsuspend_np */
#undef __local_pthread_attr_setcreatesuspend_np_defined
#endif /* !__CRT_HAVE_pthread_attr_setstartsuspend_np */
