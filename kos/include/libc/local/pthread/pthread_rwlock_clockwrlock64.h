 ...
 */
#ifndef __local_pthread_rwlock_clockwrlock64_defined
#define __local_pthread_rwlock_clockwrlock64_defined
#include <__crt.h>
...
#ifndef __local___localdep_crt_pthread_rwlock_clockwrlock32_defined
...
#endif /* !__local___localdep_crt_pthread_rwlock_clockwrlock32_defined */
__LOCAL_LIBC(pthread_rwlock_clockwrlock64) __ATTR_WUNUSED __ATTR_IN(3) __ATTR_INOUT(1) __errno_t
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(pthread_rwlock_clockwrlock64))(__pthread_rwlock_t *__restrict __self, __clockid_t __clock_id, struct __timespec64 const *__restrict __abstime) {
	__errno_t __result;
...
#undef __local_pthread_rwlock_clockwrlock64_defined
#endif /* !__CRT_HAVE_pthread_rwlock_clockwrlock */
#endif /* !__local_pthread_rwlock_clockwrlock64_defined */
