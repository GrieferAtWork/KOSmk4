...
__CREDIRECT(__ATTR_INOUT(1),__errno_t,__NOTHROW_NCX,__localdep_crt_pthread_attr_setstack,(__pthread_attr_t *__self, void *__stackaddr, __SIZE_TYPE__ __stacksize),pthread_attr_setstack,(__self,__stackaddr,__stacksize))
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(pthread_attr_setstacksize))(__pthread_attr_t *__self, __SIZE_TYPE__ __stacksize) {
	__errno_t __result;
	void *__stackaddr;
	...
	__result = (__NAMESPACE_LOCAL_SYM __localdep_pthread_attr_getstack)(__self, &__stackaddr, &___old_stacksize);
#endif /* !__CRT_HAVE_pthread_attr_getstackaddr */
	if __likely(__result == 0)
		__result = (__NAMESPACE_LOCAL_SYM __localdep_crt_pthread_attr_setstack)(__self, __stackaddr, __stacksize);
	return __result;
}
__NAMESPACE_LOCAL_END
