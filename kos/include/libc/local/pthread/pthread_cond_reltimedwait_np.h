...
#if !defined(__local___localdep_crt_pthread_cond_reltimedwait32_np_defined) && defined(__CRT_HAVE_pthread_cond_reltimedwait_np)
#define __local___localdep_crt_pthread_cond_reltimedwait32_np_defined
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1, 2, 3)),__errno_t,__NOTHROW_RPC,__localdep_crt_pthread_cond_reltimedwait32_np,(__pthread_cond_t *__restrict __cond, __pthread_mutex_t *__restrict __mutex, struct __timespec32 const *__restrict __reltime),pthread_cond_reltimedwait_np,(__cond,__mutex,__reltime))
#endif /* !__local___localdep_crt_pthread_cond_reltimedwait32_np_defined && __CRT_HAVE_pthread_cond_reltimedwait_np */
...
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1, 2, 3)),__errno_t,__NOTHROW_RPC,__localdep_pthread_cond_reltimedwait64_np,(__pthread_cond_t *__restrict __cond, __pthread_mutex_t *__restrict __mutex, struct __timespec64 const *__restrict __reltime),pthread_cond_reltimedwait64_np,(__cond,__mutex,__reltime))
...
__LOCAL_LIBC(pthread_cond_reltimedwait_np) __ATTR_WUNUSED __ATTR_NONNULL((1, 2, 3)) __errno_t
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(pthread_cond_reltimedwait_np))(__pthread_cond_t *__restrict __cond, __pthread_mutex_t *__restrict __mutex, struct timespec const *__restrict __reltime) {
	...
	__result = (__NAMESPACE_LOCAL_SYM __localdep_crt_pthread_cond_reltimedwait32_np)(__cond, __mutex, &__reltime32);
	return __result;
	...
	__result = (__NAMESPACE_LOCAL_SYM __localdep_pthread_cond_reltimedwait64_np)(__cond, __mutex, &__reltime64);
	return __result;
#endif /* !__CRT_HAVE_pthread_cond_reltimedwait_np */
}
__NAMESPACE_LOCAL_END
...
#endif /* !__CRT_HAVE_pthread_cond_reltimedwait64_np && !__CRT_HAVE_pthread_cond_reltimedwait_np */
