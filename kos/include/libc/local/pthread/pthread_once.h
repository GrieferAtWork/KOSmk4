...
__CREDIRECT(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,__localdep_futex_waitwhile,(__uintptr_t *__uaddr, __uintptr_t __equal_to_value),futex_waitwhile,(__uaddr,__equal_to_value))
