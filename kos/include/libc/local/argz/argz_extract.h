...
#define __local_argz_extract_defined
#include <__crt.h>
...
__LOCAL_LIBC(argz_extract) __ATTR_ACCESS_ROS(1, 2) __ATTR_NONNULL((3)) void
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_argz_extract_defined
#define __local___localdep_argz_extract_defined
#define __localdep_argz_extract __LIBC_LOCAL_NAME(argz_extract)
#endif /* !__local___localdep_argz_extract_defined */
