 ...
 */
#ifndef __local_wfrealpath_defined
#define __local_wfrealpath_defined
#include <__crt.h>
#if defined(__CRT_HAVE_wfrealpath4) || (defined(__CRT_HAVE_frealpath4) && (defined(__CRT_HAVE_convert_mbstowcs) || defined(__CRT_HAVE_convert_mbstowcsn) || ((defined(__CRT_HAVE_format_waprintf_printer) || defined(__CRT_HAVE_format_waprintf_alloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc)) && (defined(__CRT_HAVE_format_waprintf_pack) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc))))) || ((defined(__CRT_HAVE_frealpath) || defined(__CRT_HAVE_frealpath4)) && (defined(__CRT_HAVE_convert_mbstowcs) || defined(__CRT_HAVE_convert_mbstowcsn) || ((defined(__CRT_HAVE_format_waprintf_printer) || defined(__CRT_HAVE_format_waprintf_alloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc)) && (defined(__CRT_HAVE_format_waprintf_pack) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc)))))
...
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_WR_OPT(2),char *,__NOTHROW_RPC,__localdep_frealpath,(__fd_t __fd, char *__resolved, __SIZE_TYPE__ __buflen),frealpath,(__fd,__resolved,__buflen))
...
#else /* ... */
#undef __local___localdep_frealpath_defined
#endif /* !... */
...
__LOCAL_LIBC(wfrealpath) __ATTR_WUNUSED __ATTR_ACCESS_WRS(2, 3) __WCHAR_TYPE__ *
...
#else /* __CRT_HAVE_wfrealpath4 || (__CRT_HAVE_frealpath4 && (__CRT_HAVE_convert_mbstowcs || __CRT_HAVE_convert_mbstowcsn || ((__CRT_HAVE_format_waprintf_printer || __CRT_HAVE_format_waprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc) && (__CRT_HAVE_format_waprintf_pack || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc)))) */
	char *__utf8_resolved;
	__WCHAR_TYPE__ *__wcs_resolved;
	__SIZE_TYPE__ __resolved_length;
	__utf8_resolved = (__NAMESPACE_LOCAL_SYM __localdep_frealpath)(__fd, __NULLPTR, 0);
...
#endif /* __CRT_HAVE_free || __CRT_HAVE_cfree || __CRT_HAVE___libc_free */
	return __resolved;
#endif /* !__CRT_HAVE_wfrealpath4 && (!__CRT_HAVE_frealpath4 || (!__CRT_HAVE_convert_mbstowcs && !__CRT_HAVE_convert_mbstowcsn && ((!__CRT_HAVE_format_waprintf_printer && !__CRT_HAVE_format_waprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) || (!__CRT_HAVE_format_waprintf_pack && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc)))) */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_wfrealpath_defined
#define __local___localdep_wfrealpath_defined
#define __localdep_wfrealpath __LIBC_LOCAL_NAME(wfrealpath)
#endif /* !__local___localdep_wfrealpath_defined */
#else /* __CRT_HAVE_wfrealpath4 || (__CRT_HAVE_frealpath4 && (__CRT_HAVE_convert_mbstowcs || __CRT_HAVE_convert_mbstowcsn || ((__CRT_HAVE_format_waprintf_printer || __CRT_HAVE_format_waprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc) && (__CRT_HAVE_format_waprintf_pack || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc)))) || ((__CRT_HAVE_frealpath || __CRT_HAVE_frealpath4) && (__CRT_HAVE_convert_mbstowcs || __CRT_HAVE_convert_mbstowcsn || ((__CRT_HAVE_format_waprintf_printer || __CRT_HAVE_format_waprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc) && (__CRT_HAVE_format_waprintf_pack || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc)))) */
#undef __local_wfrealpath_defined
...
#endif /* !__local_wfrealpath_defined */
