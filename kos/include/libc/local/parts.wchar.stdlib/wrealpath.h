...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(2) __ATTR_OUTS(3, 4),__WCHAR_TYPE__ *,__NOTHROW_RPC,__localdep_wfrealpathat,(__fd_t __dirfd, __WCHAR_TYPE__ const *__filename, __WCHAR_TYPE__ *__resolved, __SIZE_TYPE__ __buflen, __atflag_t __flags),wfrealpathat,(__dirfd,__filename,__resolved,__buflen,__flags))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(wrealpath) __ATTR_WUNUSED __ATTR_IN(1) __ATTR_OUT_OPT(2) __WCHAR_TYPE__ *
