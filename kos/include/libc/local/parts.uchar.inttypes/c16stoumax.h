 ...
 */
#ifndef __local_c16stoumax_defined
#define __local_c16stoumax_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(c16stoumax) __ATTR_LEAF __ATTR_IN(1) __ATTR_OUT_OPT(2) __UINTMAX_TYPE__
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16stoumax))(__CHAR16_TYPE__ const *__restrict __nptr, __CHAR16_TYPE__ **__endptr, __STDC_INT_AS_UINT_T __base) {
#if __SIZEOF_INTMAX_T__ <= 4
	return (__UINTMAX_TYPE__)(__NAMESPACE_LOCAL_SYM __localdep_c16stou32)(__nptr, __endptr, __base);
#else /* __SIZEOF_INTMAX_T__ <= 4 */
	return (__UINTMAX_TYPE__)(__NAMESPACE_LOCAL_SYM __localdep_c16stou64)(__nptr, __endptr, __base);
#endif /* __SIZEOF_INTMAX_T__ > 4 */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c16stoumax_defined
#define __local___localdep_c16stoumax_defined
#define __localdep_c16stoumax __LIBC_LOCAL_NAME(c16stoumax)
#endif /* !__local___localdep_c16stoumax_defined */
#endif /* !__local_c16stoumax_defined */
