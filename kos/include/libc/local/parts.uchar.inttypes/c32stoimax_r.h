 ...
 */
#ifndef __local_c32stoimax_r_defined
#define __local_c32stoimax_r_defined
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(c32stoimax_r) __ATTR_LEAF __ATTR_IN(1) __ATTR_OUT_OPT(2) __ATTR_OUT_OPT(4) __INTMAX_TYPE__
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32stoimax_r))(__CHAR32_TYPE__ const *__restrict __nptr, __CHAR32_TYPE__ **__endptr, __STDC_INT_AS_UINT_T __base, __errno_t *__error) {
#if __SIZEOF_INTMAX_T__ >= 8
	return (__INTMAX_TYPE__)(__NAMESPACE_LOCAL_SYM __localdep_c32sto64_r)(__nptr, __endptr, __base, __error);
#elif __SIZEOF_INTMAX_T__ >= 4
	return (__INTMAX_TYPE__)(__NAMESPACE_LOCAL_SYM __localdep_c32sto32_r)(__nptr, __endptr, __base, __error);
#else /* ... */
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c32stoimax_r_defined
#define __local___localdep_c32stoimax_r_defined
#define __localdep_c32stoimax_r __LIBC_LOCAL_NAME(c32stoimax_r)
#endif /* !__local___localdep_c32stoimax_r_defined */
#endif /* !__local_c32stoimax_r_defined */
