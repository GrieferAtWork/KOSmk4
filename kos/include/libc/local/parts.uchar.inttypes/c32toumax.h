...
__LOCAL_LIBC(c32toumax) __ATTR_LEAF __ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR_OPT(2) __UINTMAX_TYPE__
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32toumax))(__CHAR32_TYPE__ const *__restrict __nptr, __CHAR32_TYPE__ **__endptr, __STDC_INT_AS_UINT_T __base) {
	...
	return (__UINTMAX_TYPE__)(__NAMESPACE_LOCAL_SYM __localdep_c32stou64)(__nptr, __endptr, __base);
