...
#define __local_inet_network_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(inet_network) __ATTR_PURE __ATTR_ACCESS_RO(1) __UINT32_TYPE__
...
#define __local___localdep_inet_network_defined
