...
#define __local_error_subclass_defined
#include <__crt.h>
...
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(error_subclass))(void) {
	...
	return ERROR_SUBCLASS((__NAMESPACE_LOCAL_SYM __localdep_error_code)());
#endif /* !__arch_error_subclass */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_error_subclass_defined
#define __local___localdep_error_subclass_defined
