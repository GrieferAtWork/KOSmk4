 ...
 */
#ifndef __local_getopt_long_defined
#define __local_getopt_long_defined
#include <__crt.h>
...
__LOCAL_LIBC(getopt_long) __ATTR_WUNUSED __ATTR_NONNULL((2, 3)) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(getopt_long))(int ___argc, char *const ___argv[], char const *__optstring, struct option const *__longopts, int *__longindex) {
	return (__NAMESPACE_LOCAL_SYM __localdep_getopt_impl)((unsigned int)___argc, (char const **)___argv, __optstring,
	                   __longopts, (unsigned int *)__longindex, 0);
}
__NAMESPACE_LOCAL_END
...
#undef __local_getopt_long_defined
#endif /* !__LOCAL_optarg || !__LOCAL_optind */
#endif /* !__local_getopt_long_defined */
