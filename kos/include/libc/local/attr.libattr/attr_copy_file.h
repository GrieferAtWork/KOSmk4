 ...
 */
#ifndef __local_attr_copy_file_defined
#define __local_attr_copy_file_defined
#include <__crt.h>
...
__LOCAL_LIBC(attr_copy_file) __ATTR_IN(1) __ATTR_IN(2) __ATTR_INOUT_OPT(4) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(attr_copy_file))(char const *__src_path, char const *__dst_path, int (__LIBKCALL *__check)(char const *__attr_name, struct error_context *__ctx), struct error_context *__ctx) {
	return (__NAMESPACE_LOCAL_SYM __localdep_attr_copy_impl)(__src_path, -1, __dst_path, -1, __check, __ctx);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_attr_copy_file_defined
#define __local___localdep_attr_copy_file_defined
#define __localdep_attr_copy_file __LIBC_LOCAL_NAME(attr_copy_file)
#endif /* !__local___localdep_attr_copy_file_defined */
...
#undef __local_attr_copy_file_defined
...
#endif /* !__local_attr_copy_file_defined */
