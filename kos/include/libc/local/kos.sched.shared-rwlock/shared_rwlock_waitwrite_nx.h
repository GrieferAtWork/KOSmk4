...
__LOCAL_LIBC(shared_rwlock_waitwrite_nx) __ATTR_WUNUSED __BLOCKING __ATTR_INOUT(1) __BOOL
(__FCALL __LIBC_LOCAL_NAME(shared_rwlock_waitwrite_nx))(struct shared_rwlock *__restrict __self) __THROWS(E_WOULDBLOCK, ...) {
