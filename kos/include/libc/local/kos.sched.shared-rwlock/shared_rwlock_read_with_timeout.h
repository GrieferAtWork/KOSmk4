...
(__FCALL __LIBC_LOCAL_NAME(shared_rwlock_read_with_timeout))(struct shared_rwlock *__restrict __self, __shared_rwlock_timespec __abs_timeout) __THROWS(E_WOULDBLOCK, ...) {
#ifdef __KERNEL__
