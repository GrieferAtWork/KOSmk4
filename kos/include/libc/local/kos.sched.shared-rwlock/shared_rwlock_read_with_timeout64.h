...
(__FCALL __LIBC_LOCAL_NAME(shared_rwlock_read_with_timeout64))(struct shared_rwlock *__restrict __self, struct __timespec64 const *__abs_timeout) __THROWS(E_WOULDBLOCK, ...) {
