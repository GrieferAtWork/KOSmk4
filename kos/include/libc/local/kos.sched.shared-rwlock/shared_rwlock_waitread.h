...
#endif /* !__KERNEL__ */
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(shared_rwlock_waitread) __BLOCKING __ATTR_NONNULL((1)) void
...
__success:
	...
	while (__hybrid_atomic_load(__self->sl_lock, __ATOMIC_ACQUIRE) == (__UINTPTR_TYPE__)-1) {
		...
		(__NAMESPACE_LOCAL_SYM __localdep_LFutexExpr64_except)(&__self->sl_rdwait, __self, __NAMESPACE_LOCAL_SYM __shared_rwlock_waitreadexpr,
