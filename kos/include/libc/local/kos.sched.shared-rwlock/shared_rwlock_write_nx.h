...
#include <sched/sig.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(shared_rwlock_write_nx) __ATTR_WUNUSED __BLOCKING __ATTR_INOUT(1) __BOOL
(__FCALL __LIBC_LOCAL_NAME(shared_rwlock_write_nx))(struct shared_rwlock *__restrict __self) __THROWS(E_WOULDBLOCK, ...) {
