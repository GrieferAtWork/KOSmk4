 ...
 */
#ifndef __local_shared_rwlock_write_with_timeout_nx_defined
#define __local_shared_rwlock_write_with_timeout_nx_defined
#include <__crt.h>
#ifdef __KERNEL__
#include <kos/anno.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(shared_rwlock_write_with_timeout_nx) __ATTR_WUNUSED __BLOCKING __NOCONNECT __ATTR_NONNULL((1)) __BOOL
(__FCALL __LIBC_LOCAL_NAME(shared_rwlock_write_with_timeout_nx))(struct shared_rwlock *__restrict __self, __shared_rwlock_timespec __abs_timeout) __THROWS(__E_WOULDBLOCK, ...) {
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_shared_rwlock_write_with_timeout_nx_defined
#define __local___localdep_shared_rwlock_write_with_timeout_nx_defined
#define __localdep_shared_rwlock_write_with_timeout_nx __LIBC_LOCAL_NAME(shared_rwlock_write_with_timeout_nx)
#endif /* !__local___localdep_shared_rwlock_write_with_timeout_nx_defined */
#else /* __KERNEL__ */
#undef __local_shared_rwlock_write_with_timeout_nx_defined
#endif /* !__KERNEL__ */
#endif /* !__local_shared_rwlock_write_with_timeout_nx_defined */
