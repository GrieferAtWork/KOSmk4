...
__success:
	...
	while (__hybrid_atomic_load(__self->sl_lock, __ATOMIC_ACQUIRE) != 0) {
		...
		(__NAMESPACE_LOCAL_SYM __localdep_LFutexExpr64_except)(&__self->sl_wrwait, __self, __NAMESPACE_LOCAL_SYM __shared_rwlock_waitwriteexpr,
