 ...
 */
#ifndef __local_shared_rwlock_waitwrite_defined
#define __local_shared_rwlock_waitwrite_defined
#include <__crt.h>
...
#endif /* !__KERNEL__ */
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(shared_rwlock_waitwrite) __BLOCKING __NOCONNECT __ATTR_NONNULL((1)) void
...
__success:
	...
	while (__hybrid_atomic_load(__self->sl_lock, __ATOMIC_ACQUIRE) != 0) {
		...
		(__NAMESPACE_LOCAL_SYM __localdep_LFutexExpr64_except)(&__self->sl_wrwait, __self, 1, __NAMESPACE_LOCAL_SYM __shared_rwlock_waitwriteexpr,
...
#undef __local_shared_rwlock_waitwrite_defined
#endif /* !__KERNEL__ && !__CRT_HAVE_LFutexExpr64 && !__CRT_HAVE_LFutexExpr */
#endif /* !__local_shared_rwlock_waitwrite_defined */
