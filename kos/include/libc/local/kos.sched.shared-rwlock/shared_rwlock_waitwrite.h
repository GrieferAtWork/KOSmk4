...
#endif /* !__KERNEL__ */
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(shared_rwlock_waitwrite) __BLOCKING __ATTR_INOUT(1) void
(__FCALL __LIBC_LOCAL_NAME(shared_rwlock_waitwrite))(struct shared_rwlock *__restrict __self) __THROWS(E_WOULDBLOCK, ...) {
#ifdef __KERNEL__
