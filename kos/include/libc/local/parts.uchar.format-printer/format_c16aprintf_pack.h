...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(format_c16aprintf_pack) __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_INOUT(1) __ATTR_OUT_OPT(2) __CHAR16_TYPE__ *
