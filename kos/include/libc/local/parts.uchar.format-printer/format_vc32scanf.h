...
__NOTHROW_CB(__LIBKCALL __LIBC_LOCAL_NAME(format_vc32scanf))(__pformatgetc __pgetc, __pformatungetc __pungetc, void *__arg, __CHAR32_TYPE__ const *__restrict __format, __builtin_va_list __args) {
