...
#define __local_format_c32snprintf_printer_defined
#include <__crt.h>
...
__LOCAL_LIBC(format_c32snprintf_printer) __ATTR_ACCESS_ROS(2, 3) __ATTR_NONNULL((1)) __SSIZE_TYPE__
__NOTHROW_NCX(__C32FORMATPRINTER_CC __LIBC_LOCAL_NAME(format_c32snprintf_printer))(void *__arg, __CHAR32_TYPE__ const *__restrict __data, __SIZE_TYPE__ __datalen) {
	...
	(__NAMESPACE_LOCAL_SYM __localdep_memcpyc)(__ctrl->__sd_buffer, __data, __result, sizeof(__CHAR32_TYPE__));
