...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(format_c32aprintf_pack) __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_INOUT(1) __ATTR_OUT_OPT(2) __CHAR32_TYPE__ *
