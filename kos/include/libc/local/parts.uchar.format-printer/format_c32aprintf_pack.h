...
#define __local_format_c32aprintf_pack_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(format_c32aprintf_pack) __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_ACCESS_RW(1) __ATTR_ACCESS_WR_OPT(2) __CHAR32_TYPE__ *
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(format_c32aprintf_pack))(struct format_c32aprintf_data *__restrict __self, __SIZE_TYPE__ *__pstrlen) {
	...
	if (__self->ap_avail != 0) {
		...
		__newbuf = (__CHAR32_TYPE__ *)(__NAMESPACE_LOCAL_SYM __localdep_realloc)(__self->ap_base,
		...
		if __unlikely(!__self->ap_used) {
			...
			__self->ap_base = (__CHAR32_TYPE__ *)(__NAMESPACE_LOCAL_SYM __localdep_malloc)(1 * sizeof(__CHAR32_TYPE__));
...
#undef __local_format_c32aprintf_pack_defined
