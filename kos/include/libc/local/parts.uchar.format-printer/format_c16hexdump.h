...
#define __local___localdep_isprint16_defined 1
__NAMESPACE_LOCAL_END
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_isprint16 (*(int(__LIBDCALL *)(__WINT16_TYPE__))&__LIBC_LOCAL_NAME(iswprint))
#else /* ... */
__NAMESPACE_LOCAL_END
