...
__NOTHROW_CB(__LIBKCALL __LIBC_LOCAL_NAME(file_c32printer_unlocked))(void *__arg, __CHAR32_TYPE__ const *__restrict __data, __SIZE_TYPE__ __datalen) {
	__SIZE_TYPE__ __i;
