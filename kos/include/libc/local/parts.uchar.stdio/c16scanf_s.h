...
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_C16SCANF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep_vc16scanf_s,(__CHAR16_TYPE__ const *__format, __builtin_va_list __args),vwscanf_s,(__format,__args))
#elif defined(__CRT_HAVE_DOS$vwscanf_s)
__CREDIRECT_DOS(__ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_C16SCANF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep_vc16scanf_s,(__CHAR16_TYPE__ const *__format, __builtin_va_list __args),vwscanf_s,(__format,__args))
...
__LOCAL_LIBC(c16scanf_s) __ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_C16SCANF(1, 2) __STDC_INT_AS_SSIZE_T
