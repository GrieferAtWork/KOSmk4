...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(vfc16scanf_unlocked) __ATTR_WUNUSED __ATTR_ACCESS_RW(1) __ATTR_LIBC_C16SCANF(2, 0) __ATTR_NONNULL((2)) __STDC_INT_AS_SIZE_T
