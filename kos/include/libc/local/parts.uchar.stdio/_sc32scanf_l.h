...
__CREDIRECT(__ATTR_ACCESS_RO(2) __ATTR_LIBC_C32SCANF(2, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vsc32scanf_l,(__CHAR32_TYPE__ const *__buf, __CHAR32_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args),_vswscanf_l,(__buf,__format,__locale,__args))
#elif defined(__CRT_HAVE_KOS$_vswscanf_l)
__CREDIRECT_KOS(__ATTR_ACCESS_RO(2) __ATTR_LIBC_C32SCANF(2, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vsc32scanf_l,(__CHAR32_TYPE__ const *__buf, __CHAR32_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args),_vswscanf_l,(__buf,__format,__locale,__args))
...
__LOCAL_LIBC(_sc32scanf_l) __ATTR_WUNUSED __ATTR_ACCESS_RO(2) __ATTR_LIBC_C32SCANF(2, 4) __ATTR_NONNULL((1)) __STDC_INT_AS_SSIZE_T
