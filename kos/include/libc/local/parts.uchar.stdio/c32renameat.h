...
__CREDIRECT(__ATTR_IN(2) __ATTR_IN(4),int,__NOTHROW_RPC,__localdep_c32renameat2,(__fd_t __oldfd, __CHAR32_TYPE__ const *__oldname, __fd_t __newfd, __CHAR32_TYPE__ const *__newname_or_path, __atflag_t __flags),wrenameat2,(__oldfd,__oldname,__newfd,__newname_or_path,__flags))
#elif defined(__CRT_HAVE_KOS$wrenameat2)
__CREDIRECT_KOS(__ATTR_IN(2) __ATTR_IN(4),int,__NOTHROW_RPC,__localdep_c32renameat2,(__fd_t __oldfd, __CHAR32_TYPE__ const *__oldname, __fd_t __newfd, __CHAR32_TYPE__ const *__newname_or_path, __atflag_t __flags),wrenameat2,(__oldfd,__oldname,__newfd,__newname_or_path,__flags))
...
__LOCAL_LIBC(c32renameat) __ATTR_IN(2) __ATTR_IN(4) int
