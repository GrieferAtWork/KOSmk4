...
__NAMESPACE_LOCAL_BEGIN
#define __localdep___stdio_common_vfc32printf_s __LIBC_LOCAL_NAME(__stdio_common_vfc32printf_s)
#else /* ... */
#undef __local___localdep___stdio_common_vfc32printf_s_defined
#endif /* !... */
#endif /* !__local___localdep___stdio_common_vfc32printf_s_defined */
__NAMESPACE_LOCAL_END
#include <corecrt_stdio_config.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_vfc32printf_s_l) __ATTR_NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(_vfc32printf_s_l))(__FILE *__stream, __CHAR32_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args) {
	return (__NAMESPACE_LOCAL_SYM __localdep___stdio_common_vfc32printf_s)(_CRT_INTERNAL_LOCAL_PRINTF_OPTIONS, __stream, __format, __locale, __args);
}
__NAMESPACE_LOCAL_END
