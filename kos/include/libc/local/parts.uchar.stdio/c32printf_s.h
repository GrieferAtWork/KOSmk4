...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_LIBC_C32PRINTF(1, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep_vc32printf_s,(__CHAR32_TYPE__ const *__format, __builtin_va_list __args),vwprintf_s,(__format,__args))
#elif defined(__CRT_HAVE_KOS$vwprintf_s)
__NAMESPACE_LOCAL_END
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT_KOS(__ATTR_LIBC_C32PRINTF(1, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep_vc32printf_s,(__CHAR32_TYPE__ const *__format, __builtin_va_list __args),vwprintf_s,(__format,__args))
...
__LOCAL_LIBC(c32printf_s) __ATTR_LIBC_C32PRINTF(1, 2) __ATTR_NONNULL((1)) __STDC_INT_AS_SSIZE_T
