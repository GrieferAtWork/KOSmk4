 ...
 */
#ifndef __local__c32fopen_s_defined
#define __local__c32fopen_s_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_c32fopen_s) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(3) __ATTR_ACCESS_WR(1) __errno_t
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(_c32fopen_s))(__FILE **__pstream, __CHAR32_TYPE__ const *__filename, __CHAR32_TYPE__ const *__mode) {
	__errno_t __result;
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__c32fopen_s_defined
#define __local___localdep__c32fopen_s_defined
#define __localdep__c32fopen_s __LIBC_LOCAL_NAME(_c32fopen_s)
#endif /* !__local___localdep__c32fopen_s_defined */
#else /* (__CRT_HAVE_fopen_s || (__CRT_HAVE_fopen && (!__O_LARGEFILE || !__O_LARGEFILE)) || __CRT_HAVE_fopen64) && ((__CRT_HAVE_convert_wcstombs && __SIZEOF_WCHAR_T__ == 4 && __LIBCCALL_IS_LIBKCALL) || __CRT_HAVE_KOS$convert_wcstombs || (__CRT_HAVE_convert_wcstombsn && __SIZEOF_WCHAR_T__ == 4) || __CRT_HAVE_KOS$convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc) */
#undef __local__c32fopen_s_defined
#endif /* (!__CRT_HAVE_fopen_s && (!__CRT_HAVE_fopen || (__O_LARGEFILE && __O_LARGEFILE)) && !__CRT_HAVE_fopen64) || ((!__CRT_HAVE_convert_wcstombs || __SIZEOF_WCHAR_T__ != 4 || !__LIBCCALL_IS_LIBKCALL) && !__CRT_HAVE_KOS$convert_wcstombs && (!__CRT_HAVE_convert_wcstombsn || __SIZEOF_WCHAR_T__ != 4) && !__CRT_HAVE_KOS$convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) */
#endif /* !__local__c32fopen_s_defined */
