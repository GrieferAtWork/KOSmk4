...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_c32perror) __ATTR_COLD __ATTR_ACCESS_RO_OPT(1) void
(__LIBKCALL __LIBC_LOCAL_NAME(_c32perror))(__CHAR32_TYPE__ const *__restrict __message) __THROWS(...) {
