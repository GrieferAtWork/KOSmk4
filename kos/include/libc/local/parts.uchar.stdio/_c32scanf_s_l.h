...
__CREDIRECT(__ATTR_ACCESS_RO(1) __ATTR_LIBC_C32SCANF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vc32scanf_s_l,(__CHAR32_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args),_vwscanf_s_l,(__format,__locale,__args))
#elif defined(__CRT_HAVE_KOS$_vwscanf_s_l)
__CREDIRECT_KOS(__ATTR_ACCESS_RO(1) __ATTR_LIBC_C32SCANF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vc32scanf_s_l,(__CHAR32_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args),_vwscanf_s_l,(__format,__locale,__args))
...
__LOCAL_LIBC(_c32scanf_s_l) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_LIBC_C32SCANF(1, 3) __STDC_INT_AS_SSIZE_T
