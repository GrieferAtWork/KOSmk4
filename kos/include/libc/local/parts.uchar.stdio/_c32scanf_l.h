...
__CREDIRECT(__ATTR_WUNUSED __ATTR_LIBC_C32SCANF(1, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vc32scanf_l,(__CHAR32_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args),_vwscanf_l,(__format,__locale,__args))
#elif defined(__CRT_HAVE_KOS$_vwscanf_l)
__CREDIRECT_KOS(__ATTR_WUNUSED __ATTR_LIBC_C32SCANF(1, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vc32scanf_l,(__CHAR32_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args),_vwscanf_l,(__format,__locale,__args))
#elif (defined(__CRT_HAVE_vwscanf) || (defined(__LOCAL_stdin) && defined(__CRT_HAVE_vfwscanf))) && __SIZEOF_WCHAR_T__ == 4
...
__LOCAL_LIBC(_c32scanf_l) __ATTR_WUNUSED __ATTR_LIBC_C32SCANF(1, 3) __ATTR_NONNULL((1)) __STDC_INT_AS_SSIZE_T
...
#else /* (__CRT_HAVE__vwscanf_l && __SIZEOF_WCHAR_T__ == 4 && __LIBCCALL_IS_LIBKCALL) || __CRT_HAVE_KOS$_vwscanf_l || ((__CRT_HAVE_vwscanf || (__LOCAL_stdin && __CRT_HAVE_vfwscanf)) && __SIZEOF_WCHAR_T__ == 4) || (__CRT_HAVE_vwscanf && __SIZEOF_WCHAR_T__ == 4 && __LIBCCALL_IS_LIBKCALL) || __CRT_HAVE_KOS$vwscanf || (__LOCAL_stdin && __CRT_HAVE_vfwscanf && __SIZEOF_WCHAR_T__ == 4) || (__LOCAL_stdin && ((__CRT_HAVE_vfwscanf && __SIZEOF_WCHAR_T__ == 4 && __LIBCCALL_IS_LIBKCALL) || __CRT_HAVE_KOS$vfwscanf)) */
