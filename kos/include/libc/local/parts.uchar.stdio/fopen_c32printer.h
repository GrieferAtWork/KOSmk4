 ...
 */
#ifndef __local_fopen_c32printer_defined
#define __local_fopen_c32printer_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(fopen_c32printer) __ATTR_WUNUSED __ATTR_NONNULL((1)) __FILE *
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(fopen_c32printer))(__pc32formatprinter __printer, void *__arg) {
	__FILE *__result;
	struct __local_format_8tow_data {   /* == `struct format_8tow_data' */
	...
	__result = (__NAMESPACE_LOCAL_SYM __localdep_funopen2_64)(__cookie, __NULLPTR, (__SSIZE_TYPE__ (__LIBKCALL *)(void *, void const *, __SIZE_TYPE__))&(__NAMESPACE_LOCAL_SYM __localdep_format_8to32), __NULLPTR,
	...
	__result = (__NAMESPACE_LOCAL_SYM __localdep_funopen2_64)(__cookie, __NULLPTR, (__SSIZE_TYPE__ (__LIBKCALL *)(void *, void const *, __SIZE_TYPE__))&(__NAMESPACE_LOCAL_SYM __localdep_format_8to32),
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_fopen_c32printer_defined
#define __local___localdep_fopen_c32printer_defined
#define __localdep_fopen_c32printer __LIBC_LOCAL_NAME(fopen_c32printer)
#endif /* !__local___localdep_fopen_c32printer_defined */
...
#undef __local_fopen_c32printer_defined
...
#endif /* !__local_fopen_c32printer_defined */
