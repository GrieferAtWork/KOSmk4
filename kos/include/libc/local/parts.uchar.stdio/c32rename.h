...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_IN(2) __ATTR_IN(4),int,__NOTHROW_RPC,__localdep_c32renameat,(__fd_t __oldfd, __CHAR32_TYPE__ const *__oldname, __fd_t __newfd, __CHAR32_TYPE__ const *__newname_or_path),wrenameat,(__oldfd,__oldname,__newfd,__newname_or_path))
#elif defined(__CRT_HAVE_KOS$wrenameat)
__NAMESPACE_LOCAL_END
#include <bits/types.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT_KOS(__ATTR_IN(2) __ATTR_IN(4),int,__NOTHROW_RPC,__localdep_c32renameat,(__fd_t __oldfd, __CHAR32_TYPE__ const *__oldname, __fd_t __newfd, __CHAR32_TYPE__ const *__newname_or_path),wrenameat,(__oldfd,__oldname,__newfd,__newname_or_path))
...
__LOCAL_LIBC(c32rename) __ATTR_IN(1) __ATTR_IN(2) int
