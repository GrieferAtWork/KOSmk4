 ...
 */
#ifndef __local___stdio_common_vsnc32printf_s_defined
#define __local___stdio_common_vsnc32printf_s_defined
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(__stdio_common_vsnc32printf_s) __ATTR_ACCESS_RO(5) __ATTR_LIBC_C32PRINTF(5, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(__stdio_common_vsnc32printf_s))(__UINT64_TYPE__ __options, __CHAR32_TYPE__ *__buf, __SIZE_TYPE__ __bufsize, __SIZE_TYPE__ __maxsize, __CHAR32_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args) {
...
#endif /* !__local___stdio_common_vsnc32printf_s_defined */
