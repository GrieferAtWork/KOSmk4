 ...
 */
#ifndef __local_vfc16printf_s_defined
#define __local_vfc16printf_s_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(vfc16printf_s) __ATTR_LIBC_C16PRINTF(2, 0) __ATTR_NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(vfc16printf_s))(__FILE *__stream, __CHAR16_TYPE__ const *__format, __builtin_va_list __args) {
	return (__NAMESPACE_LOCAL_SYM __localdep__vfc16printf_s_l)(__stream, __format, __NULLPTR, __args);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_vfc16printf_s_defined
#define __local___localdep_vfc16printf_s_defined
#define __localdep_vfc16printf_s __LIBC_LOCAL_NAME(vfc16printf_s)
