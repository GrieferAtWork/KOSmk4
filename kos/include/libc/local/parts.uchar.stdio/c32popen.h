...
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1, 2)),__FILE *,__NOTHROW_RPC,__localdep_popen,(char const *__command, char const *__modes),popen,(__command,__modes))
#elif defined(__CRT_HAVE__popen)
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1, 2)),__FILE *,__NOTHROW_RPC,__localdep_popen,(char const *__command, char const *__modes),_popen,(__command,__modes))
#elif defined(__CRT_HAVE__IO_popen)
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1, 2)),__FILE *,__NOTHROW_RPC,__localdep_popen,(char const *__command, char const *__modes),_IO_popen,(__command,__modes))
#else /* ... */
#undef __local___localdep_popen_defined
#endif /* !... */
#endif /* !__local___localdep_popen_defined */
__LOCAL_LIBC(c32popen) __ATTR_WUNUSED __ATTR_NONNULL((1, 2)) __FILE *
