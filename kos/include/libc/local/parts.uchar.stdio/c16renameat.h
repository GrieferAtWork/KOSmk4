...
__CREDIRECT(__ATTR_NONNULL((2, 4)),int,__NOTHROW_RPC,__localdep_c16renameat2,(__fd_t __oldfd, __CHAR16_TYPE__ const *__oldname, __fd_t __newfd, __CHAR16_TYPE__ const *__newname_or_path, __atflag_t __flags),wrenameat2,(__oldfd,__oldname,__newfd,__newname_or_path,__flags))
#elif defined(__CRT_HAVE_DOS$wrenameat2)
__CREDIRECT_DOS(__ATTR_NONNULL((2, 4)),int,__NOTHROW_RPC,__localdep_c16renameat2,(__fd_t __oldfd, __CHAR16_TYPE__ const *__oldname, __fd_t __newfd, __CHAR16_TYPE__ const *__newname_or_path, __atflag_t __flags),wrenameat2,(__oldfd,__oldname,__newfd,__newname_or_path,__flags))
...
__LOCAL_LIBC(c16renameat) __ATTR_NONNULL((2, 4)) int
