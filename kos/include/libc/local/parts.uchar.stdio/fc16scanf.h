...
__LOCAL_LIBC(fc16scanf) __ATTR_IN(2) __ATTR_INOUT(1) __ATTR_LIBC_C16SCANF(2, 3) __STDC_INT_AS_SIZE_T
__NOTHROW_CB(__VLIBDCALL __LIBC_LOCAL_NAME(fc16scanf))(__FILE *__restrict __stream, __CHAR16_TYPE__ const *__restrict __format, ...) {
