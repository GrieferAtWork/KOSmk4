...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((2, 4)),int,__NOTHROW_RPC,__localdep_c16renameat,(__fd_t __oldfd, __CHAR16_TYPE__ const *__oldname, __fd_t __newfd, __CHAR16_TYPE__ const *__newname_or_path),wrenameat,(__oldfd,__oldname,__newfd,__newname_or_path))
#elif defined(__CRT_HAVE_DOS$wrenameat)
__NAMESPACE_LOCAL_END
#include <bits/types.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT_DOS(__ATTR_NONNULL((2, 4)),int,__NOTHROW_RPC,__localdep_c16renameat,(__fd_t __oldfd, __CHAR16_TYPE__ const *__oldname, __fd_t __newfd, __CHAR16_TYPE__ const *__newname_or_path),wrenameat,(__oldfd,__oldname,__newfd,__newname_or_path))
...
__CREDIRECT(__ATTR_NONNULL((1, 2)),int,__NOTHROW_RPC,__localdep_rename,(char const *__oldname, char const *__newname_or_path),rename,(__oldname,__newname_or_path))
#elif defined(__CRT_HAVE___rename)
__CREDIRECT(__ATTR_NONNULL((1, 2)),int,__NOTHROW_RPC,__localdep_rename,(char const *__oldname, char const *__newname_or_path),__rename,(__oldname,__newname_or_path))
#elif defined(__CRT_HAVE___libc_rename)
__CREDIRECT(__ATTR_NONNULL((1, 2)),int,__NOTHROW_RPC,__localdep_rename,(char const *__oldname, char const *__newname_or_path),__libc_rename,(__oldname,__newname_or_path))
...
__LOCAL_LIBC(c16rename) __ATTR_NONNULL((1, 2)) int
