 ...
 */
#ifndef __local_vc32printf_s_defined
#define __local_vc32printf_s_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(vc32printf_s) __ATTR_LIBC_C32PRINTF(1, 0) __ATTR_NONNULL((1)) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(vc32printf_s))(__CHAR32_TYPE__ const *__format, __builtin_va_list __args) {
	return (__NAMESPACE_LOCAL_SYM __localdep__vfc32printf_s_l)(__LOCAL_stdout, __format, __NULLPTR, __args);
}
__NAMESPACE_LOCAL_END
...
#undef __local_vc32printf_s_defined
...
#endif /* !__local_vc32printf_s_defined */
