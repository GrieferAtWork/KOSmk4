...
__LOCAL_LIBC(vc16printf) __ATTR_IN(1) __ATTR_LIBC_C16PRINTF(1, 0) __STDC_INT_AS_SIZE_T
__NOTHROW_CB_NCX(__LIBDCALL __LIBC_LOCAL_NAME(vc16printf))(__CHAR16_TYPE__ const *__restrict __format, __builtin_va_list __args) {
