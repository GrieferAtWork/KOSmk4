...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_c16perror) __ATTR_COLD __ATTR_IN_OPT(1) void
__NOTHROW_CB_NCX(__LIBDCALL __LIBC_LOCAL_NAME(_c16perror))(__CHAR16_TYPE__ const *__restrict __message) {
