...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(vfc32scanf_unlocked) __ATTR_WUNUSED __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1) __ATTR_LIBC_C32SCANF(2, 0) __STDC_INT_AS_SIZE_T
