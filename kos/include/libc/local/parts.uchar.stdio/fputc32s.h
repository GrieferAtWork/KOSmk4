...
#define __local_fputc32s_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(fputc32s) __ATTR_IN(1) __ATTR_INOUT(2) __STDC_INT_AS_SIZE_T
__NOTHROW_CB_NCX(__LIBKCALL __LIBC_LOCAL_NAME(fputc32s))(__CHAR32_TYPE__ const *__restrict __str, __FILE *__restrict __stream) {
	__STDC_INT_AS_SIZE_T __result;
	__result = (__NAMESPACE_LOCAL_SYM __localdep_file_c32printer)(__stream, __str, (__NAMESPACE_LOCAL_SYM __localdep_c32len)(__str));
	return __result;
}
__NAMESPACE_LOCAL_END
