 ...
 */
#ifndef __local__fc32printf_s_l_defined
#define __local__fc32printf_s_l_defined
#include <__crt.h>
#include <features.h>
...
__CREDIRECT(__ATTR_LIBC_C32PRINTF(2, 0) __ATTR_NONNULL((1, 2)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vfc32printf_s_l,(__FILE *__stream, __CHAR32_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args),_vfwprintf_s_l,(__stream,__format,__locale,__args))
#elif defined(__CRT_HAVE_KOS$_vfwprintf_s_l)
__CREDIRECT_KOS(__ATTR_LIBC_C32PRINTF(2, 0) __ATTR_NONNULL((1, 2)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vfc32printf_s_l,(__FILE *__stream, __CHAR32_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args),_vfwprintf_s_l,(__stream,__format,__locale,__args))
...
__LOCAL_LIBC(_fc32printf_s_l) __ATTR_LIBC_C32PRINTF(2, 4) __ATTR_NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__VLIBKCALL __LIBC_LOCAL_NAME(_fc32printf_s_l))(__FILE *__stream, __CHAR32_TYPE__ const *__format, __locale_t __locale, ...) {
	__STDC_INT_AS_SSIZE_T __result;
	__builtin_va_list __args;
	__builtin_va_start(__args, __locale);
	__result = (__NAMESPACE_LOCAL_SYM __localdep__vfc32printf_s_l)(__stream, __format, __locale, __args);
	__builtin_va_end(__args);
	return __result;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__fc32printf_s_l_defined
#define __local___localdep__fc32printf_s_l_defined
#define __localdep__fc32printf_s_l __LIBC_LOCAL_NAME(_fc32printf_s_l)
#endif /* !__local___localdep__fc32printf_s_l_defined */
...
#undef __local__fc32printf_s_l_defined
...
#endif /* !__local__fc32printf_s_l_defined */
