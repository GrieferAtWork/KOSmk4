...
__CREDIRECT(,__CHAR32_TYPE__ *,__NOTHROW_NCX,__localdep__getc32s_s,(__CHAR32_TYPE__ *__buf, __SIZE_TYPE__ __buflen),_getws_s,(__buf,__buflen))
#elif defined(__CRT_HAVE_KOS$_getws_s)
__CREDIRECT_KOS(,__CHAR32_TYPE__ *,__NOTHROW_NCX,__localdep__getc32s_s,(__CHAR32_TYPE__ *__buf, __SIZE_TYPE__ __buflen),_getws_s,(__buf,__buflen))
...
__LOCAL_LIBC(_getc32s) __CHAR32_TYPE__ *
