 ...
 */
#ifndef __local___stdio_common_vsc32printf_defined
#define __local___stdio_common_vsc32printf_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(__stdio_common_vsc32printf) __ATTR_ACCESS_RO(4) __ATTR_LIBC_C32PRINTF(4, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(__stdio_common_vsc32printf))(__UINT64_TYPE__ __options, __CHAR32_TYPE__ *__buf, __SIZE_TYPE__ __bufsize, __CHAR32_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args) {
...
#endif /* !__local___stdio_common_vsc32printf_defined */
