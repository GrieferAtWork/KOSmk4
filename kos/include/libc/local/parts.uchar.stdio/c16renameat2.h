...
__LOCAL_LIBC(c16renameat2) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(4) int
__NOTHROW_RPC(__LIBDCALL __LIBC_LOCAL_NAME(c16renameat2))(__fd_t __oldfd, __CHAR16_TYPE__ const *__oldname, __fd_t __newfd, __CHAR16_TYPE__ const *__newname_or_path, __atflag_t __flags) {
	char *__utf8_oldname;
...
#else /* __CRT_HAVE_renameat2 && ((__CRT_HAVE_convert_wcstombs && __SIZEOF_WCHAR_T__ == 2 && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_DOS$convert_wcstombs || (__CRT_HAVE_convert_wcstombsn && __SIZEOF_WCHAR_T__ == 2) || __CRT_HAVE_DOS$convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc) */
#undef __local_c16renameat2_defined
...
#endif /* !__local_c16renameat2_defined */
