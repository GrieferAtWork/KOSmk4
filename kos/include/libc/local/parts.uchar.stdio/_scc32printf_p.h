...
__CREDIRECT(__ATTR_LIBC_C32PRINTF_P(1, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vscc32printf_p,(__CHAR32_TYPE__ const *__format, __builtin_va_list __args),_vscwprintf_p,(__format,__args))
#elif defined(__CRT_HAVE_KOS$_vscwprintf_p)
__CREDIRECT_KOS(__ATTR_LIBC_C32PRINTF_P(1, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vscc32printf_p,(__CHAR32_TYPE__ const *__format, __builtin_va_list __args),_vscwprintf_p,(__format,__args))
...
__LOCAL_LIBC(_scc32printf_p) __ATTR_LIBC_C32PRINTF_P(1, 2) __ATTR_NONNULL((1)) __STDC_INT_AS_SSIZE_T
