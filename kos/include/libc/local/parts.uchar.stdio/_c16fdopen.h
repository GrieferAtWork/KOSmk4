 ...
 */
#ifndef __local__c16fdopen_defined
#define __local__c16fdopen_defined
#include <__crt.h>
...
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(2),__FILE *,__NOTHROW_NCX,__localdep_fdopen,(__fd_t __fd, char const *__restrict __modes),fdopen,(__fd,__modes))
#elif defined(__CRT_HAVE__fdopen)
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(2),__FILE *,__NOTHROW_NCX,__localdep_fdopen,(__fd_t __fd, char const *__restrict __modes),_fdopen,(__fd,__modes))
#elif defined(__CRT_HAVE__IO_fdopen)
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(2),__FILE *,__NOTHROW_NCX,__localdep_fdopen,(__fd_t __fd, char const *__restrict __modes),_IO_fdopen,(__fd,__modes))
#else /* ... */
...
__LOCAL_LIBC(_c16fdopen) __ATTR_WUNUSED __ATTR_ACCESS_RO(2) __FILE *
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__c16fdopen_defined
#define __local___localdep__c16fdopen_defined
#define __localdep__c16fdopen __LIBC_LOCAL_NAME(_c16fdopen)
#endif /* !__local___localdep__c16fdopen_defined */
...
#undef __local__c16fdopen_defined
#endif /* (!__CRT_HAVE_fdopen && !__CRT_HAVE__fdopen && !__CRT_HAVE__IO_fdopen) || ((!__CRT_HAVE_convert_wcstombs || __SIZEOF_WCHAR_T__ != 2 || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$convert_wcstombs && (!__CRT_HAVE_convert_wcstombsn || __SIZEOF_WCHAR_T__ != 2) && !__CRT_HAVE_DOS$convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) */
#endif /* !__local__c16fdopen_defined */
