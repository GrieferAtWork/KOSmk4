...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_vfc16printf_s __NAMESPACE_LOCAL_TYPEHAX(__STDC_INT_AS_SSIZE_T(__LIBDCALL*)(__FILE *,__CHAR16_TYPE__ const *,__builtin_va_list),__STDC_INT_AS_SSIZE_T(__LIBDCALL&)(__FILE *,__CHAR16_TYPE__ const *,__builtin_va_list),vfwprintf_s)
