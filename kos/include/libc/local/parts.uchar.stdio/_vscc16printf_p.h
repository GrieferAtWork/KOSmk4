 ...
 */
#ifndef __local__vscc16printf_p_defined
#define __local__vscc16printf_p_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(_vscc16printf_p) __ATTR_ACCESS_RO(1) __ATTR_LIBC_C16PRINTF_P(1, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(_vscc16printf_p))(__CHAR16_TYPE__ const *__format, __builtin_va_list __args) {
	return (__NAMESPACE_LOCAL_SYM __localdep__vscc16printf_p_l)(__format, __NULLPTR, __args);
}
__NAMESPACE_LOCAL_END
...
#endif /* !__local__vscc16printf_p_defined */
