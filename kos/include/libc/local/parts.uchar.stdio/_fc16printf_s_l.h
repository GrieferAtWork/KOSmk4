 ...
 */
#ifndef __local__fc16printf_s_l_defined
#define __local__fc16printf_s_l_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(_fc16printf_s_l) __ATTR_NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__VLIBDCALL __LIBC_LOCAL_NAME(_fc16printf_s_l))(__FILE *__stream, __CHAR16_TYPE__ const *__format, __locale_t __locale, ...) {
	...
	__result = (__NAMESPACE_LOCAL_SYM __localdep__vfc16printf_s_l)(__stream, __format, __locale, __args);
	__builtin_va_end(__args);
	return __result;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__fc16printf_s_l_defined
#define __local___localdep__fc16printf_s_l_defined
#define __localdep__fc16printf_s_l __LIBC_LOCAL_NAME(_fc16printf_s_l)
#endif /* !__local___localdep__fc16printf_s_l_defined */
