...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_IN(2),int,__NOTHROW_RPC,__localdep_c32removeat,(__fd_t __dirfd, __CHAR32_TYPE__ const *__filename),wremoveat,(__dirfd,__filename))
#elif defined(__CRT_HAVE_KOS$wremoveat)
__NAMESPACE_LOCAL_END
#include <bits/types.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT_KOS(__ATTR_IN(2),int,__NOTHROW_RPC,__localdep_c32removeat,(__fd_t __dirfd, __CHAR32_TYPE__ const *__filename),wremoveat,(__dirfd,__filename))
...
__LOCAL_LIBC(c32remove) __ATTR_IN(1) int
