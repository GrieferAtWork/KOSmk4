 ...
 */
#ifndef __local__vc16scanf_s_l_defined
#define __local__vc16scanf_s_l_defined
#include <__crt.h>
...
__LOCAL_LIBC(_vc16scanf_s_l) __ATTR_LIBC_C16SCANF(1, 0) __ATTR_NONNULL((1)) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(_vc16scanf_s_l))(__CHAR16_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args) {
	return (__NAMESPACE_LOCAL_SYM __localdep__vfc16scanf_s_l)(__LOCAL_stdin, __format, __locale, __args);
}
__NAMESPACE_LOCAL_END
