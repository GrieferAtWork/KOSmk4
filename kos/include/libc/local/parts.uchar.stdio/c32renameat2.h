 ...
 */
#ifndef __local_c32renameat2_defined
#define __local_c32renameat2_defined
#include <__crt.h>
...
__LOCAL_LIBC(c32renameat2) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(4) int
__NOTHROW_RPC(__LIBKCALL __LIBC_LOCAL_NAME(c32renameat2))(__fd_t __oldfd, __CHAR32_TYPE__ const *__oldname, __fd_t __newfd, __CHAR32_TYPE__ const *__newname_or_path, __atflag_t __flags) {
	char *__utf8_oldname;
...
#endif /* !__local_c32renameat2_defined */
