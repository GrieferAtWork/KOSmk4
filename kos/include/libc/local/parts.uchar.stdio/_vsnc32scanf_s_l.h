...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_vsnc32scanf_s_l) __ATTR_WUNUSED __ATTR_ACCESS_RO(3) __ATTR_ACCESS_ROS(1, 2) __ATTR_LIBC_C32SCANF(3, 0) __STDC_INT_AS_SSIZE_T
