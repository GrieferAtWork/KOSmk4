...
__CREDIRECT(__ATTR_IN(2) __ATTR_LIBC_C16PRINTF(2, 0) __ATTR_OUT(1),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep___vsc16printf_l,(__CHAR16_TYPE__ *__buf, __CHAR16_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args),__vswprintf_l,(__buf,__format,__locale,__args))
#elif defined(__CRT_HAVE_DOS$__vswprintf_l)
__CREDIRECT_DOS(__ATTR_IN(2) __ATTR_LIBC_C16PRINTF(2, 0) __ATTR_OUT(1),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep___vsc16printf_l,(__CHAR16_TYPE__ *__buf, __CHAR16_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args),__vswprintf_l,(__buf,__format,__locale,__args))
...
__LOCAL_LIBC(__sc16printf_l) __ATTR_IN(2) __ATTR_LIBC_C16PRINTF(2, 4) __ATTR_OUT(1) __STDC_INT_AS_SSIZE_T
