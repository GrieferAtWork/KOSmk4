...
__NOTHROW_CB_NCX(__LIBKCALL __LIBC_LOCAL_NAME(vfc32scanf))(__FILE *__restrict __stream, __CHAR32_TYPE__ const *__restrict __format, __builtin_va_list __args) {
#if defined(__LIBKCALL_IS_FORMATPRINTER_CC) && __SIZEOF_FORMAT_WORD_T__ == 4
