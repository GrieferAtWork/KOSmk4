 ...
 */
#ifndef __local__c16fopen_s_defined
#define __local__c16fopen_s_defined
#include <__crt.h>
...
__CREDIRECT(__ATTR_IN(2) __ATTR_IN(3) __ATTR_OUT(1),__errno_t,__NOTHROW_RPC,__localdep_fopen_s,(__FILE **__pstream, char const *__filename, char const *__modes),fopen_s,(__pstream,__filename,__modes))
...
#else /* ... */
#undef __local___localdep_fopen_s_defined
#endif /* !... */
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_c16fopen_s) __ATTR_IN(2) __ATTR_IN(3) __ATTR_OUT(1) __errno_t
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(_c16fopen_s))(__FILE **__pstream, __CHAR16_TYPE__ const *__filename, __CHAR16_TYPE__ const *__mode) {
	...
	__result = (__NAMESPACE_LOCAL_SYM __localdep_fopen_s)(__pstream, __utf8_filename, __utf8_mode);
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__c16fopen_s_defined
#define __local___localdep__c16fopen_s_defined
#define __localdep__c16fopen_s __LIBC_LOCAL_NAME(_c16fopen_s)
#endif /* !__local___localdep__c16fopen_s_defined */
#else /* (__CRT_HAVE_fopen_s || (__CRT_HAVE_fopen && (!__O_LARGEFILE || !__O_LARGEFILE)) || __CRT_HAVE_fopen64) && ((__CRT_HAVE_convert_wcstombs && __SIZEOF_WCHAR_T__ == 2 && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_DOS$convert_wcstombs || (__CRT_HAVE_convert_wcstombsn && __SIZEOF_WCHAR_T__ == 2) || __CRT_HAVE_DOS$convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc) */
#undef __local__c16fopen_s_defined
#endif /* (!__CRT_HAVE_fopen_s && (!__CRT_HAVE_fopen || (__O_LARGEFILE && __O_LARGEFILE)) && !__CRT_HAVE_fopen64) || ((!__CRT_HAVE_convert_wcstombs || __SIZEOF_WCHAR_T__ != 2 || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$convert_wcstombs && (!__CRT_HAVE_convert_wcstombsn || __SIZEOF_WCHAR_T__ != 2) && !__CRT_HAVE_DOS$convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) */
#endif /* !__local__c16fopen_s_defined */
