...
__CREDIRECT(__ATTR_WUNUSED __ATTR_INOUT(3) __ATTR_OUTS(1, 2),__CHAR32_TYPE__ *,__NOTHROW_CB_NCX,__localdep_fgetc32s,(__CHAR32_TYPE__ *__restrict __buf, __STDC_INT_AS_SIZE_T __bufsize, __FILE *__restrict __stream),fgetws_unlocked,(__buf,__bufsize,__stream))
#elif defined(__CRT_HAVE_KOS$fgetws_unlocked) && defined(__USE_STDIO_UNLOCKED)
__CREDIRECT_KOS(__ATTR_WUNUSED __ATTR_INOUT(3) __ATTR_OUTS(1, 2),__CHAR32_TYPE__ *,__NOTHROW_CB_NCX,__localdep_fgetc32s,(__CHAR32_TYPE__ *__restrict __buf, __STDC_INT_AS_SIZE_T __bufsize, __FILE *__restrict __stream),fgetws_unlocked,(__buf,__bufsize,__stream))
#elif defined(__CRT_HAVE__fgetws_nolock) && defined(__USE_STDIO_UNLOCKED) && __SIZEOF_WCHAR_T__ == 4 && defined(__LIBCCALL_IS_LIBKCALL)
__CREDIRECT(__ATTR_WUNUSED __ATTR_INOUT(3) __ATTR_OUTS(1, 2),__CHAR32_TYPE__ *,__NOTHROW_CB_NCX,__localdep_fgetc32s,(__CHAR32_TYPE__ *__restrict __buf, __STDC_INT_AS_SIZE_T __bufsize, __FILE *__restrict __stream),_fgetws_nolock,(__buf,__bufsize,__stream))
#elif defined(__CRT_HAVE_KOS$_fgetws_nolock) && defined(__USE_STDIO_UNLOCKED)
__CREDIRECT_KOS(__ATTR_WUNUSED __ATTR_INOUT(3) __ATTR_OUTS(1, 2),__CHAR32_TYPE__ *,__NOTHROW_CB_NCX,__localdep_fgetc32s,(__CHAR32_TYPE__ *__restrict __buf, __STDC_INT_AS_SIZE_T __bufsize, __FILE *__restrict __stream),_fgetws_nolock,(__buf,__bufsize,__stream))
#elif defined(__CRT_HAVE_fgetws) && __SIZEOF_WCHAR_T__ == 4 && defined(__LIBCCALL_IS_LIBKCALL)
__CREDIRECT(__ATTR_WUNUSED __ATTR_INOUT(3) __ATTR_OUTS(1, 2),__CHAR32_TYPE__ *,__NOTHROW_CB_NCX,__localdep_fgetc32s,(__CHAR32_TYPE__ *__restrict __buf, __STDC_INT_AS_SIZE_T __bufsize, __FILE *__restrict __stream),fgetws,(__buf,__bufsize,__stream))
#elif defined(__CRT_HAVE_KOS$fgetws)
__CREDIRECT_KOS(__ATTR_WUNUSED __ATTR_INOUT(3) __ATTR_OUTS(1, 2),__CHAR32_TYPE__ *,__NOTHROW_CB_NCX,__localdep_fgetc32s,(__CHAR32_TYPE__ *__restrict __buf, __STDC_INT_AS_SIZE_T __bufsize, __FILE *__restrict __stream),fgetws,(__buf,__bufsize,__stream))
...
__LOCAL_LIBC(_getc32s_s) __ATTR_OUTS(1, 2) __CHAR32_TYPE__ *
