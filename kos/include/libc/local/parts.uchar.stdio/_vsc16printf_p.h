 ...
 */
#ifndef __local__vsc16printf_p_defined
#define __local__vsc16printf_p_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(_vsc16printf_p) __ATTR_ACCESS_RO(3) __ATTR_ACCESS_WRS(1, 2) __ATTR_LIBC_C16PRINTF_P(3, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(_vsc16printf_p))(__CHAR16_TYPE__ *__buf, __SIZE_TYPE__ __bufsize, __CHAR16_TYPE__ const *__format, __builtin_va_list __args) {
	return (__NAMESPACE_LOCAL_SYM __localdep__vsc16printf_p_l)(__buf, __bufsize, __format, __NULLPTR, __args);
}
__NAMESPACE_LOCAL_END
...
#endif /* !__local__vsc16printf_p_defined */
