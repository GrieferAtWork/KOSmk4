...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_ACCESS_RO(2),int,__NOTHROW_RPC,__localdep_c16removeat,(__fd_t __dirfd, __CHAR16_TYPE__ const *__filename),wremoveat,(__dirfd,__filename))
#elif defined(__CRT_HAVE_DOS$wremoveat)
__NAMESPACE_LOCAL_END
#include <bits/types.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT_DOS(__ATTR_ACCESS_RO(2),int,__NOTHROW_RPC,__localdep_c16removeat,(__fd_t __dirfd, __CHAR16_TYPE__ const *__filename),wremoveat,(__dirfd,__filename))
...
__LOCAL_LIBC(c16remove) __ATTR_ACCESS_RO(1) int
