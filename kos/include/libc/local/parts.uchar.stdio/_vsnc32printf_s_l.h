...
__CREDIRECT(__ATTR_ACCESS_RO(5) __ATTR_LIBC_C32PRINTF(5, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep___stdio_common_vsnc32printf_s,(__UINT64_TYPE__ __options, __CHAR32_TYPE__ *__buf, __SIZE_TYPE__ __bufsize, __SIZE_TYPE__ __maxsize, __CHAR32_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args),__stdio_common_vsnwprintf_s,(__options,__buf,__bufsize,__maxsize,__format,__locale,__args))
#elif defined(__CRT_HAVE_KOS$__stdio_common_vsnwprintf_s)
__CREDIRECT_KOS(__ATTR_ACCESS_RO(5) __ATTR_LIBC_C32PRINTF(5, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep___stdio_common_vsnc32printf_s,(__UINT64_TYPE__ __options, __CHAR32_TYPE__ *__buf, __SIZE_TYPE__ __bufsize, __SIZE_TYPE__ __maxsize, __CHAR32_TYPE__ const *__format, __locale_t __locale, __builtin_va_list __args),__stdio_common_vsnwprintf_s,(__options,__buf,__bufsize,__maxsize,__format,__locale,__args))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_vsnc32printf_s_l) __ATTR_ACCESS_RO(4) __ATTR_ACCESS_WRS(1, 2) __ATTR_LIBC_C32PRINTF(4, 0) __STDC_INT_AS_SSIZE_T
