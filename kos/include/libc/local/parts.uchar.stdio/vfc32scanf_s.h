 ...
 */
#ifndef __local_vfc32scanf_s_defined
#define __local_vfc32scanf_s_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(vfc32scanf_s) __ATTR_WUNUSED __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1) __ATTR_LIBC_C32SCANF(2, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(vfc32scanf_s))(__FILE *__stream, __CHAR32_TYPE__ const *__format, __builtin_va_list __args) {
	return (__NAMESPACE_LOCAL_SYM __localdep__vfc32scanf_s_l)(__stream, __format, __NULLPTR, __args);
}
__NAMESPACE_LOCAL_END
...
#undef __local_vfc32scanf_s_defined
...
#endif /* !__local_vfc32scanf_s_defined */
