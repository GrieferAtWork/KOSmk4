 ...
 */
#ifndef __local_argp_verror_defined
#define __local_argp_verror_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(argp_verror) __ATTR_IN(2) __ATTR_IN_OPT(1) __ATTR_LIBC_PRINTF(2, 0) void
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(argp_verror))(struct argp_state const *__restrict __state, char const *__restrict __format, __builtin_va_list __args) {
	__FILE *___out;
...
#undef __local_argp_verror_defined
...
#endif /* !__local_argp_verror_defined */
