 ...
 */
#ifndef __local__mbsnbcmp_l_defined
#define __local__mbsnbcmp_l_defined
#include <__crt.h>
...
__LOCAL_LIBC(_mbsnbcmp_l) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_ROS(1, 3) __ATTR_ACCESS_ROS(2, 3) __ATTR_NONNULL((1, 2)) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_mbsnbcmp_l))(unsigned char const *__lhs, unsigned char const *__rhs, __SIZE_TYPE__ __max_bytes, __locale_t __locale) {
