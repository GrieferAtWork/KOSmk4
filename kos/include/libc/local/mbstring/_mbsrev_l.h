...
__CREDIRECT(__ATTR_LEAF __ATTR_INOUT(1),char *,__NOTHROW_NCX,__localdep_strrev,(char *__restrict __str),strrev,(__str))
#elif defined(__CRT_HAVE__strrev)
__CREDIRECT(__ATTR_LEAF __ATTR_INOUT(1),char *,__NOTHROW_NCX,__localdep_strrev,(char *__restrict __str),_strrev,(__str))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__LOCAL_LIBC(_mbsrev_l) __ATTR_RETNONNULL __ATTR_INOUT(1) unsigned char *
