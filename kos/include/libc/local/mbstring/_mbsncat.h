...
#include <__crt.h>
#if defined(__CRT_HAVE__mbsncat_l) || defined(__CRT_HAVE__ismbblead_l) || defined(__CRT_HAVE__mbctype) || defined(__CRT_HAVE___p__mbctype)
...
__CREDIRECT(__ATTR_IN(2) __ATTR_INOUT(1),unsigned char *,__NOTHROW_NCX,__localdep__mbsncat_l,(unsigned char *__buf, unsigned char const *__src, __SIZE_TYPE__ __max_chars, __locale_t __locale),_mbsncat_l,(__buf,__src,__max_chars,__locale))
...
__LOCAL_LIBC(_mbsncat) __ATTR_IN(2) __ATTR_INOUT(1) unsigned char *
...
#else /* __CRT_HAVE__mbsncat_l || __CRT_HAVE__ismbblead_l || __CRT_HAVE__mbctype || __CRT_HAVE___p__mbctype */
#undef __local__mbsncat_defined
#endif /* !__CRT_HAVE__mbsncat_l && !__CRT_HAVE__ismbblead_l && !__CRT_HAVE__mbctype && !__CRT_HAVE___p__mbctype */
