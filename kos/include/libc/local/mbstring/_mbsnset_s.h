...
#include <__crt.h>
#if defined(__CRT_HAVE__mbsnset_s_l) || defined(__CRT_HAVE__mbsnset_l) || defined(__CRT_HAVE__ismbblead_l)
...
#elif defined(__CRT_HAVE__mbsnset_l) || defined(__CRT_HAVE__ismbblead_l)
...
#else /* __CRT_HAVE__mbsnset_s_l || __CRT_HAVE__mbsnset_l || __CRT_HAVE__ismbblead_l */
#undef __local__mbsnset_s_defined
#endif /* !__CRT_HAVE__mbsnset_s_l && !__CRT_HAVE__mbsnset_l && !__CRT_HAVE__ismbblead_l */
