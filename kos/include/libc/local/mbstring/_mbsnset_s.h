...
__CREDIRECT(__ATTR_INOUTS(1, 2),__errno_t,__NOTHROW_NCX,__localdep__mbsnset_s_l,(unsigned char *__buf, __SIZE_TYPE__ __true_bufsize, unsigned int __ch, __SIZE_TYPE__ __max_chars, __locale_t __locale),_mbsnset_s_l,(__buf,__true_bufsize,__ch,__max_chars,__locale))
...
__LOCAL_LIBC(_mbsnset_s) __ATTR_INOUTS(1, 2) __errno_t
