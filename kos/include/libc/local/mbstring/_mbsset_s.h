...
#include <__crt.h>
#if defined(__CRT_HAVE__mbsset_s_l) || defined(__CRT_HAVE__mbsset_l) || defined(__CRT_HAVE__ismbblead_l)
...
__CREDIRECT(__ATTR_NONNULL((1)),__errno_t,__NOTHROW_NCX,__localdep__mbsset_s_l,(unsigned char *__buf, __SIZE_TYPE__ __true_bufsize, unsigned int __ch, __locale_t __locale),_mbsset_s_l,(__buf,__true_bufsize,__ch,__locale))
...
#else /* __CRT_HAVE__mbsset_s_l || __CRT_HAVE__mbsset_l || __CRT_HAVE__ismbblead_l */
#undef __local__mbsset_s_defined
#endif /* !__CRT_HAVE__mbsset_s_l && !__CRT_HAVE__mbsset_l && !__CRT_HAVE__ismbblead_l */
