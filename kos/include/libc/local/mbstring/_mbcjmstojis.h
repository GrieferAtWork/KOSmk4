...
__CREDIRECT(__ATTR_WUNUSED,unsigned int,__NOTHROW_NCX,__localdep__mbcjmstojis_l,(unsigned int __ch, __locale_t __locale),_mbcjmstojis_l,(__ch,__locale))
#endif /* !__local___localdep__mbcjmstojis_l_defined */
__LOCAL_LIBC(_mbcjmstojis) __ATTR_WUNUSED unsigned int
...
#else /* __CRT_HAVE__mbcjmstojis_l */
#undef __local__mbcjmstojis_defined
#endif /* !__CRT_HAVE__mbcjmstojis_l */
