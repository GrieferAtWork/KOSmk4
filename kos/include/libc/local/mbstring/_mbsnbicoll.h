...
__CREDIRECT(__ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)),int,__NOTHROW_NCX,__localdep__mbsnbicoll_l,(unsigned char const *__lhs, unsigned char const *__rhs, __SIZE_TYPE__ __max_bytes, __locale_t __locale),_mbsnbicoll_l,(__lhs,__rhs,__max_bytes,__locale))
...
__LOCAL_LIBC(_mbsnbicoll) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)) int
