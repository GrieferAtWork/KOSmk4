...
__CREDIRECT(__ATTR_LEAF __ATTR_INOUT(1),char *,__NOTHROW_NCX,__localdep_strset,(char *__restrict __str, int __ch),strset,(__str,__ch))
#elif defined(__CRT_HAVE__strset)
__CREDIRECT(__ATTR_LEAF __ATTR_INOUT(1),char *,__NOTHROW_NCX,__localdep_strset,(char *__restrict __str, int __ch),_strset,(__str,__ch))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__LOCAL_LIBC(_mbsset_l) __ATTR_RETNONNULL __ATTR_IN(1) unsigned char *
