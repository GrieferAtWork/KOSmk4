...
__LOCAL_LIBC(_mbsncat_l) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1) unsigned char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_mbsncat_l))(unsigned char *__buf, unsigned char const *__src, __SIZE_TYPE__ __max_chars, __locale_t __locale) {
	if (__max_chars) {
		unsigned char *__dst;
