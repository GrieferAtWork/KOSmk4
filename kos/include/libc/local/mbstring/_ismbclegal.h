...
__CREDIRECT(__ATTR_WUNUSED,int,__NOTHROW_NCX,__localdep__ismbclegal_l,(unsigned int __ch, __locale_t __locale),_ismbclegal_l,(__ch,__locale))
#endif /* !__local___localdep__ismbclegal_l_defined */
__LOCAL_LIBC(_ismbclegal) __ATTR_WUNUSED int
...
#else /* __CRT_HAVE__ismbclegal_l */
#undef __local__ismbclegal_defined
#endif /* !__CRT_HAVE__ismbclegal_l */
