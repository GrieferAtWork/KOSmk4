...
#include <__crt.h>
#if defined(__CRT_HAVE__ismbblead_l) && defined(__CRT_HAVE__mbctoupper_l)
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_mbsupr_l) __ATTR_RETNONNULL __ATTR_NONNULL((1)) unsigned char *
...
#else /* __CRT_HAVE__ismbblead_l && __CRT_HAVE__mbctoupper_l */
#undef __local__mbsupr_l_defined
#endif /* !__CRT_HAVE__ismbblead_l || !__CRT_HAVE__mbctoupper_l */
