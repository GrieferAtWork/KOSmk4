...
__CREDIRECT(__ATTR_INOUTS(1, 2) __ATTR_INS(3, 4),__errno_t,__NOTHROW_NCX,__localdep__mbsnbcat_s_l,(unsigned char *__buf, __SIZE_TYPE__ __true_bufsize, unsigned char const *__src, __SIZE_TYPE__ __max_bytes, __locale_t __locale),_mbsnbcat_s_l,(__buf,__true_bufsize,__src,__max_bytes,__locale))
...
__LOCAL_LIBC(_mbsnbcat_s) __ATTR_INOUTS(1, 2) __ATTR_INS(3, 4) __errno_t
