...
__CREDIRECT(__ATTR_ACCESS_RO(3) __ATTR_ACCESS_RWS(1, 2),__errno_t,__NOTHROW_NCX,__localdep__mbscat_s_l,(unsigned char *__buf, __SIZE_TYPE__ __true_bufsize, unsigned char const *__src, __locale_t __locale),_mbscat_s_l,(__buf,__true_bufsize,__src,__locale))
...
__LOCAL_LIBC(_mbscat_s) __ATTR_ACCESS_RO(3) __ATTR_ACCESS_RWS(1, 2) __errno_t
