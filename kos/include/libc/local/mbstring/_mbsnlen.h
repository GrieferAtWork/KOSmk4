...
__CREDIRECT(__ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_ROS(1, 2) __ATTR_NONNULL((1)),__SIZE_TYPE__,__NOTHROW_NCX,__localdep__mbsnlen_l,(unsigned char const *__str, __SIZE_TYPE__ __max_bytes, __locale_t __locale),_mbsnlen_l,(__str,__max_bytes,__locale))
...
__LOCAL_LIBC(_mbsnlen) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_ROS(1, 2) __ATTR_NONNULL((1)) __SIZE_TYPE__
