...
#include <__crt.h>
#if defined(__CRT_HAVE__ismbchira_l) || defined(__CRT_HAVE__getmbcp)
...
__CREDIRECT(__ATTR_PURE __ATTR_WUNUSED,int,__NOTHROW_NCX,__localdep__ismbchira_l,(unsigned int __ch, __locale_t __locale),_ismbchira_l,(__ch,__locale))
...
#else /* ... */
#undef __local___localdep__ismbchira_l_defined
#endif /* !... */
#endif /* !__local___localdep__ismbchira_l_defined */
__LOCAL_LIBC(_ismbchira) __ATTR_PURE __ATTR_WUNUSED int
...
#else /* __CRT_HAVE__ismbchira_l || __CRT_HAVE__getmbcp */
#undef __local__ismbchira_defined
#endif /* !__CRT_HAVE__ismbchira_l && !__CRT_HAVE__getmbcp */
