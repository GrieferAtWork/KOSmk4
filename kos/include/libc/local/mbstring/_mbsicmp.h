...
__CREDIRECT(__ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)),int,__NOTHROW_NCX,__localdep__mbsicmp_l,(unsigned char const *__lhs, unsigned char const *__rhs, __locale_t __locale),_mbsicmp_l,(__lhs,__rhs,__locale))
...
__LOCAL_LIBC(_mbsicmp) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)) int
