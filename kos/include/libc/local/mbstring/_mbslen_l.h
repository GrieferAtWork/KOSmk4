 ...
 */
#ifndef __local__mbslen_l_defined
#define __local__mbslen_l_defined
#include <__crt.h>
...
__LOCAL_LIBC(_mbslen_l) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __SIZE_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_mbslen_l))(unsigned char const *__str, __locale_t __locale) {
	__SIZE_TYPE__ __result;
	for (__result = 0;; ++__result) {
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__mbslen_l_defined
#define __local___localdep__mbslen_l_defined
#define __localdep__mbslen_l __LIBC_LOCAL_NAME(_mbslen_l)
#endif /* !__local___localdep__mbslen_l_defined */
#else /* __CRT_HAVE__ismbblead_l || __CRT_HAVE__mbctype || __CRT_HAVE___p__mbctype */
#undef __local__mbslen_l_defined
#endif /* !__CRT_HAVE__ismbblead_l && !__CRT_HAVE__mbctype && !__CRT_HAVE___p__mbctype */
#endif /* !__local__mbslen_l_defined */
