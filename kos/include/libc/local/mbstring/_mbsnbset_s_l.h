...
#include <__crt.h>
#if defined(__CRT_HAVE__mbsnbset_l) || defined(__CRT_HAVE__ismbblead_l) || defined(__CRT_HAVE__mbctype) || defined(__CRT_HAVE___p__mbctype)
...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_ACCESS_RWS(1, 3),unsigned char *,__NOTHROW_NCX,__localdep__mbsnbset_l,(unsigned char *__buf, unsigned int __ch, __SIZE_TYPE__ __max_bytes, __locale_t __locale),_mbsnbset_l,(__buf,__ch,__max_bytes,__locale))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_mbsnbset_s_l) __ATTR_ACCESS_RWS(1, 2) __errno_t
...
#else /* __CRT_HAVE__mbsnbset_l || __CRT_HAVE__ismbblead_l || __CRT_HAVE__mbctype || __CRT_HAVE___p__mbctype */
#undef __local__mbsnbset_s_l_defined
#endif /* !__CRT_HAVE__mbsnbset_l && !__CRT_HAVE__ismbblead_l && !__CRT_HAVE__mbctype && !__CRT_HAVE___p__mbctype */
