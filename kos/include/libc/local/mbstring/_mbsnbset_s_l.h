...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_INOUTS(1, 3),unsigned char *,__NOTHROW_NCX,__localdep__mbsnbset_l,(unsigned char *__buf, unsigned int __ch, __SIZE_TYPE__ __max_bytes, __locale_t __locale),_mbsnbset_l,(__buf,__ch,__max_bytes,__locale))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_mbsnbset_s_l) __ATTR_INOUTS(1, 2) __errno_t
