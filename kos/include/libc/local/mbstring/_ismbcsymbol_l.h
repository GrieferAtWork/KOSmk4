 ...
 */
#ifndef __local__ismbcsymbol_l_defined
#define __local__ismbcsymbol_l_defined
#include <__crt.h>
...
__LOCAL_LIBC(_ismbcsymbol_l) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_ismbcsymbol_l))(unsigned int __ch, __locale_t __locale) {
	/* Extrapolated from reverse engineering. */
	if ((__NAMESPACE_LOCAL_SYM __localdep__getmbcp_l)(__locale) != 932)
		return 0;
	if (__ch > 0x8140 && __ch < 0x81ad && __ch != 0x817f)
		return 1;
	return 0;
}
__NAMESPACE_LOCAL_END
...
#undef __local__ismbcsymbol_l_defined
#endif /* !__CRT_HAVE__getmbcp */
#endif /* !__local__ismbcsymbol_l_defined */
