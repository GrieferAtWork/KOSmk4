...
#include <__crt.h>
#if defined(__CRT_HAVE__mbsnbcoll_l) || defined(__CRT_HAVE__mbsnbcmp_l) || defined(__CRT_HAVE__ismbblead_l) || defined(__CRT_HAVE__mbctype) || defined(__CRT_HAVE___p__mbctype)
...
__CREDIRECT(__ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_ROS(1, 3) __ATTR_ACCESS_ROS(2, 3) __ATTR_NONNULL((1, 2)),int,__NOTHROW_NCX,__localdep__mbsnbcoll_l,(unsigned char const *__lhs, unsigned char const *__rhs, __SIZE_TYPE__ __max_bytes, __locale_t __locale),_mbsnbcoll_l,(__lhs,__rhs,__max_bytes,__locale))
...
__LOCAL_LIBC(_mbsnbcoll) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_ROS(1, 3) __ATTR_ACCESS_ROS(2, 3) __ATTR_NONNULL((1, 2)) int
...
#else /* __CRT_HAVE__mbsnbcoll_l || __CRT_HAVE__mbsnbcmp_l || __CRT_HAVE__ismbblead_l || __CRT_HAVE__mbctype || __CRT_HAVE___p__mbctype */
#undef __local__mbsnbcoll_defined
#endif /* !__CRT_HAVE__mbsnbcoll_l && !__CRT_HAVE__mbsnbcmp_l && !__CRT_HAVE__ismbblead_l && !__CRT_HAVE__mbctype && !__CRT_HAVE___p__mbctype */
