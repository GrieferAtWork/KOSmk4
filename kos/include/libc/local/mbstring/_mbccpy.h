...
__CREDIRECT_VOID(__ATTR_NONNULL((1, 2)),__NOTHROW_NCX,__localdep__mbccpy_l,(unsigned char *__buf, unsigned char const *__src, __locale_t __locale),_mbccpy_l,(__buf,__src,__locale))
#endif /* !__local___localdep__mbccpy_l_defined */
__LOCAL_LIBC(_mbccpy) __ATTR_NONNULL((1, 2)) void
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_mbccpy))(unsigned char *__buf, unsigned char const *__src) {
	(__NAMESPACE_LOCAL_SYM __localdep__mbccpy_l)(__buf, __src, __NULLPTR);
}
...
#else /* __CRT_HAVE__mbccpy_l */
#undef __local__mbccpy_defined
#endif /* !__CRT_HAVE__mbccpy_l */
