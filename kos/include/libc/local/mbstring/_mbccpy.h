...
__CREDIRECT_VOID(__ATTR_IN(2) __ATTR_OUT(1),__NOTHROW_NCX,__localdep__mbccpy_l,(unsigned char *__dst, unsigned char const *__src, __locale_t __locale),_mbccpy_l,(__dst,__src,__locale))
...
__LOCAL_LIBC(_mbccpy) __ATTR_IN(2) __ATTR_OUT(1) void
