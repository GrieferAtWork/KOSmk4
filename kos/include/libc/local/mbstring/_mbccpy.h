...
#include <__crt.h>
#if defined(__CRT_HAVE__mbccpy_l) || defined(__CRT_HAVE__ismbblead_l)
...
#else /* __CRT_HAVE__mbccpy_l || __CRT_HAVE__ismbblead_l */
#undef __local__mbccpy_defined
#endif /* !__CRT_HAVE__mbccpy_l && !__CRT_HAVE__ismbblead_l */
