...
#include <__crt.h>
#if defined(__CRT_HAVE__mbstok_l) || defined(__CRT_HAVE__mbstok_s_l)
...
__LOCAL_LIBC(_mbstok) __ATTR_WUNUSED __ATTR_NONNULL((2)) unsigned char *
...
#endif /* !__CRT_HAVE__mbstok_l && !__CRT_HAVE__mbstok_s_l */
