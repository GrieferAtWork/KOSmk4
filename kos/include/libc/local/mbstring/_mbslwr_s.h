...
__CREDIRECT(__ATTR_ACCESS_RWS(1, 2),__errno_t,__NOTHROW_NCX,__localdep__mbslwr_s_l,(unsigned char *__buf, __SIZE_TYPE__ __true_bufsize, __locale_t __locale),_mbslwr_s_l,(__buf,__true_bufsize,__locale))
...
__LOCAL_LIBC(_mbslwr_s) __ATTR_ACCESS_RWS(1, 2) __errno_t
