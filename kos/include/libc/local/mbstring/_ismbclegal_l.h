 ...
 */
#ifndef __local__ismbclegal_l_defined
#define __local__ismbclegal_l_defined
#include <__crt.h>
#if (defined(__CRT_HAVE__ismbblead_l) || defined(__CRT_HAVE__mbctype) || defined(__CRT_HAVE___p__mbctype)) && (defined(__CRT_HAVE__ismbbtrail_l) || defined(__CRT_HAVE__mbctype) || defined(__CRT_HAVE___p__mbctype))
...
__LOCAL_LIBC(_ismbclegal_l) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_ismbclegal_l))(unsigned int __ch, __locale_t __locale) {
	if (!(__NAMESPACE_LOCAL_SYM __localdep__ismbblead_l)((__ch >> 8) & 0xff, __locale))
		return 0;
	if (!(__NAMESPACE_LOCAL_SYM __localdep__ismbbtrail_l)(__ch & 0xff, __locale))
		return 0;
	return 1;
}
__NAMESPACE_LOCAL_END
...
#else /* (__CRT_HAVE__ismbblead_l || __CRT_HAVE__mbctype || __CRT_HAVE___p__mbctype) && (__CRT_HAVE__ismbbtrail_l || __CRT_HAVE__mbctype || __CRT_HAVE___p__mbctype) */
#undef __local__ismbclegal_l_defined
#endif /* (!__CRT_HAVE__ismbblead_l && !__CRT_HAVE__mbctype && !__CRT_HAVE___p__mbctype) || (!__CRT_HAVE__ismbbtrail_l && !__CRT_HAVE__mbctype && !__CRT_HAVE___p__mbctype) */
#endif /* !__local__ismbclegal_l_defined */
