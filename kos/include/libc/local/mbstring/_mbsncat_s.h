...
__CREDIRECT(__ATTR_ACCESS_RO(3) __ATTR_ACCESS_RWS(1, 2),__errno_t,__NOTHROW_NCX,__localdep__mbsncat_s_l,(unsigned char *__buf, __SIZE_TYPE__ __true_bufsize, unsigned char const *__src, __SIZE_TYPE__ __max_chars, __locale_t __locale),_mbsncat_s_l,(__buf,__true_bufsize,__src,__max_chars,__locale))
...
__LOCAL_LIBC(_mbsncat_s) __ATTR_ACCESS_RO(3) __ATTR_ACCESS_RWS(1, 2) __errno_t
