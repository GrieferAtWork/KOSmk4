...
#include <__crt.h>
#if defined(__CRT_HAVE__mbsncat_s_l) || ((defined(__CRT_HAVE__mbsncat_l) || defined(__CRT_HAVE__ismbblead_l)) && (defined(__CRT_HAVE__mbsnbcnt_l) || defined(__CRT_HAVE__ismbblead_l)))
...
__CREDIRECT(__ATTR_NONNULL((1, 3)),__errno_t,__NOTHROW_NCX,__localdep__mbsncat_s_l,(unsigned char *__buf, __SIZE_TYPE__ __true_bufsize, unsigned char const *__src, __SIZE_TYPE__ __max_chars, __locale_t __locale),_mbsncat_s_l,(__buf,__true_bufsize,__src,__max_chars,__locale))
#elif (defined(__CRT_HAVE__mbsncat_l) || defined(__CRT_HAVE__ismbblead_l)) && (defined(__CRT_HAVE__mbsnbcnt_l) || defined(__CRT_HAVE__ismbblead_l))
...
__LOCAL_LIBC(_mbsncat_s) __ATTR_NONNULL((1, 3)) __errno_t
...
#else /* __CRT_HAVE__mbsncat_s_l || ((__CRT_HAVE__mbsncat_l || __CRT_HAVE__ismbblead_l) && (__CRT_HAVE__mbsnbcnt_l || __CRT_HAVE__ismbblead_l)) */
#undef __local__mbsncat_s_defined
#endif /* !__CRT_HAVE__mbsncat_s_l && ((!__CRT_HAVE__mbsncat_l && !__CRT_HAVE__ismbblead_l) || (!__CRT_HAVE__mbsnbcnt_l && !__CRT_HAVE__ismbblead_l)) */
