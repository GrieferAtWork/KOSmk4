 ...
 */
#ifndef __local__mbsset_s_l_defined
#define __local__mbsset_s_l_defined
#include <__crt.h>
#if defined(__CRT_HAVE__mbsset_l) || defined(__CRT_HAVE__ismbblead_l)
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_mbsset_s_l))(unsigned char *__buf, __SIZE_TYPE__ __true_bufsize, unsigned int __ch, __locale_t __locale) {
	if (!__buf || __true_bufsize == (__NAMESPACE_LOCAL_SYM __localdep_strnlen)((char const *)__buf, __true_bufsize))
		return 22;
	(__NAMESPACE_LOCAL_SYM __localdep__mbsset_l)(__buf, __ch, __locale);
	return 0;
}
__NAMESPACE_LOCAL_END
...
#else /* __CRT_HAVE__mbsset_l || __CRT_HAVE__ismbblead_l */
#undef __local__mbsset_s_l_defined
#endif /* !__CRT_HAVE__mbsset_l && !__CRT_HAVE__ismbblead_l */
#endif /* !__local__mbsset_s_l_defined */
