 ...
 */
#ifndef __local__ismbcl1_l_defined
#define __local__ismbcl1_l_defined
#include <__crt.h>
...
__LOCAL_LIBC(_ismbcl1_l) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_ismbcl1_l))(unsigned int __ch, __locale_t __locale) {
...
#undef __local__ismbcl1_l_defined
...
#endif /* !__local__ismbcl1_l_defined */
