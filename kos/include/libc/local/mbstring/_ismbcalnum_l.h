 ...
 */
#ifndef __local__ismbcalnum_l_defined
#define __local__ismbcalnum_l_defined
#include <__crt.h>
#if (defined(__CRT_HAVE__mbctouni_l) && defined(__CRT_HAVE___unicode_descriptor)) || defined(__CRT_HAVE__ismbbalnum_l) || defined(__CRT_HAVE__ismbbkalnum_l) || defined(__CRT_HAVE__mbctype) || defined(__CRT_HAVE___p__mbctype)
...
__CREDIRECT(__ATTR_PURE __ATTR_WUNUSED,int,__NOTHROW_NCX,__localdep__ismbbalnum_l,(unsigned int __ch, __locale_t __locale),_ismbbalnum_l,(__ch,__locale))
...
#else /* ... */
#undef __local___localdep__ismbbalnum_l_defined
#endif /* !... */
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_ismbcalnum_l) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_ismbcalnum_l))(unsigned int __ch, __locale_t __locale) {
	...
	return __libc_unicode_isalnum(__uni);
#else /* __CRT_HAVE__mbctouni_l && __CRT_HAVE___unicode_descriptor */
	if (__ch <= 0xff)
		return (__NAMESPACE_LOCAL_SYM __localdep__ismbbalnum_l)(__ch, __locale);
	return 0;
...
#else /* (__CRT_HAVE__mbctouni_l && __CRT_HAVE___unicode_descriptor) || __CRT_HAVE__ismbbalnum_l || __CRT_HAVE__ismbbkalnum_l || __CRT_HAVE__mbctype || __CRT_HAVE___p__mbctype */
#undef __local__ismbcalnum_l_defined
#endif /* (!__CRT_HAVE__mbctouni_l || !__CRT_HAVE___unicode_descriptor) && !__CRT_HAVE__ismbbalnum_l && !__CRT_HAVE__ismbbkalnum_l && !__CRT_HAVE__mbctype && !__CRT_HAVE___p__mbctype */
#endif /* !__local__ismbcalnum_l_defined */
