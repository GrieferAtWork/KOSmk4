...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1)),unsigned char *,__NOTHROW_NCX,__localdep__mbsnbset_l,(unsigned char *__buf, unsigned int __ch, __SIZE_TYPE__ __buflen, __locale_t __locale),_mbsnbset_l,(__buf,__ch,__buflen,__locale))
#endif /* !__local___localdep__mbsnbset_l_defined */
__LOCAL_LIBC(_mbsnbset) __ATTR_NONNULL((1)) unsigned char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_mbsnbset))(unsigned char *__buf, unsigned int __ch, __SIZE_TYPE__ __buflen) {
	return (__NAMESPACE_LOCAL_SYM __localdep__mbsnbset_l)(__buf, __ch, __buflen, __NULLPTR);
}
__NAMESPACE_LOCAL_END
...
#else /* __CRT_HAVE__mbsnbset_l */
#undef __local__mbsnbset_defined
#endif /* !__CRT_HAVE__mbsnbset_l */
