...
__CREDIRECT(__ATTR_RETNONNULL __ATTR_INOUT(1),unsigned char *,__NOTHROW_NCX,__localdep__mbsrev_l,(unsigned char *__buf, __locale_t __locale),_mbsrev_l,(__buf,__locale))
...
__LOCAL_LIBC(_mbsrev) __ATTR_RETNONNULL __ATTR_INOUT(1) unsigned char *
