...
__CREDIRECT(__ATTR_RETNONNULL __ATTR_ACCESS_RW(1),unsigned char *,__NOTHROW_NCX,__localdep__mbsrev_l,(unsigned char *__buf, __locale_t __locale),_mbsrev_l,(__buf,__locale))
...
#else /* ... */
#undef __local___localdep__mbsrev_l_defined
#endif /* !... */
#endif /* !__local___localdep__mbsrev_l_defined */
__LOCAL_LIBC(_mbsrev) __ATTR_RETNONNULL __ATTR_ACCESS_RW(1) unsigned char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_mbsrev))(unsigned char *__buf) {
	return (__NAMESPACE_LOCAL_SYM __localdep__mbsrev_l)(__buf, __NULLPTR);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__mbsrev_defined
