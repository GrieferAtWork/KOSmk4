 ...
 */
#ifndef __local__ismbcupper_l_defined
#define __local__ismbcupper_l_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_ismbcupper_l) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_ismbcupper_l))(unsigned int __ch, __locale_t __locale) {
	...
	return __libc_unicode_isupper(__uni);
#else /* __CRT_HAVE__mbctouni_l && __CRT_HAVE___unicode_descriptor */
	if (__ch <= 0xff)
		return (__NAMESPACE_LOCAL_SYM __localdep__get_mbbtype_l)(__ch, __locale) & 0x10;
	return 0;
