...
__CREDIRECT(__ATTR_PURE __ATTR_WUNUSED __ATTR_IN(1),int,__NOTHROW_NCX,__localdep__mbsbtype_l,(unsigned char const *__str, __SIZE_TYPE__ __byte_index, __locale_t __locale),_mbsbtype_l,(__str,__byte_index,__locale))
...
__LOCAL_LIBC(_mbsbtype) __ATTR_PURE __ATTR_WUNUSED __ATTR_IN(1) int
