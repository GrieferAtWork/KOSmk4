...
#include <__crt.h>
#if defined(__CRT_HAVE__ismbslead_l) || defined(__CRT_HAVE__ismbblead_l) || defined(__CRT_HAVE__mbctype) || defined(__CRT_HAVE___p__mbctype)
...
__CREDIRECT(__ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)),int,__NOTHROW_NCX,__localdep__ismbslead_l,(unsigned char const *__str, unsigned char const *__pos, __locale_t __locale),_ismbslead_l,(__str,__pos,__locale))
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep__ismbslead_l __LIBC_LOCAL_NAME(_ismbslead_l)
#else /* ... */
#undef __local___localdep__ismbslead_l_defined
#endif /* !... */
#endif /* !__local___localdep__ismbslead_l_defined */
__LOCAL_LIBC(_ismbslead) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 2)) int
...
#else /* __CRT_HAVE__ismbslead_l || __CRT_HAVE__ismbblead_l || __CRT_HAVE__mbctype || __CRT_HAVE___p__mbctype */
#undef __local__ismbslead_defined
#endif /* !__CRT_HAVE__ismbslead_l && !__CRT_HAVE__ismbblead_l && !__CRT_HAVE__mbctype && !__CRT_HAVE___p__mbctype */
