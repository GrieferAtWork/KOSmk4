...
__LOCAL_LIBC(_mbsnbcnt) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __SIZE_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_mbsnbcnt))(unsigned char const *__str, __SIZE_TYPE__ __max_chars) {
	return (__NAMESPACE_LOCAL_SYM __localdep__mbsnbcnt_l)(__str, __max_chars, __NULLPTR);
}
__NAMESPACE_LOCAL_END
