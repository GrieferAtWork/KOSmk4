 ...
 */
#ifndef __local__ismbcl0_l_defined
#define __local__ismbcl0_l_defined
#include <__crt.h>
...
__LOCAL_LIBC(_ismbcl0_l) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_ismbcl0_l))(unsigned int __ch, __locale_t __locale) {
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__ismbcl0_l_defined
#define __local___localdep__ismbcl0_l_defined
#define __localdep__ismbcl0_l __LIBC_LOCAL_NAME(_ismbcl0_l)
#endif /* !__local___localdep__ismbcl0_l_defined */
...
#undef __local__ismbcl0_l_defined
...
#endif /* !__local__ismbcl0_l_defined */
