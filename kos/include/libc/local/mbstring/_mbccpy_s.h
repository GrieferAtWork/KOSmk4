...
__CREDIRECT(__ATTR_ACCESS_RO(4) __ATTR_ACCESS_WRS(1, 2),__errno_t,__NOTHROW_NCX,__localdep__mbccpy_s_l,(unsigned char *__dst, __SIZE_TYPE__ __true_dstsize, int *__p_copied, unsigned char const *__src, __locale_t __locale),_mbccpy_s_l,(__dst,__true_dstsize,__p_copied,__src,__locale))
...
__LOCAL_LIBC(_mbccpy_s) __ATTR_ACCESS_RO(4) __ATTR_ACCESS_WRS(1, 2) __ATTR_ACCESS_WR_OPT(3) __errno_t
