...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_PURE __ATTR_WUNUSED __ATTR_IN(1) __ATTR_IN(2),__SIZE_TYPE__,__NOTHROW_NCX,__localdep__mbscspn_l,(unsigned char const *__haystack, unsigned char const *__reject, __locale_t __locale),_mbscspn_l,(__haystack,__reject,__locale))
...
__LOCAL_LIBC(_mbstok_s_l) __ATTR_WUNUSED __ATTR_IN(2) __ATTR_INOUT(3) __ATTR_INOUT_OPT(1) unsigned char *
