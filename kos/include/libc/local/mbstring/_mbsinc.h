...
__CREDIRECT(__ATTR_PURE __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_IN(1),unsigned char *,__NOTHROW_NCX,__localdep__mbsinc_l,(unsigned char const *__ptr, __locale_t __locale),_mbsinc_l,(__ptr,__locale))
...
__LOCAL_LIBC(_mbsinc) __ATTR_PURE __ATTR_WUNUSED __ATTR_IN(1) unsigned char *
