 ...
 */
#ifndef __local_readw_nopf_defined
#define __local_readw_nopf_defined
#include <__crt.h>
...
__LOCAL_LIBC(readw_nopf) __ATTR_WUNUSED __NOBLOCK __ATTR_IN_OPT(1) __ATTR_OUT(2) __BOOL
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(readw_nopf))(void const *__addr, __UINT16_TYPE__ *__presult) {
	...
	__ok = __likely((__NAMESPACE_LOCAL_SYM __localdep_readb_nopf)((void const *)((__UINTPTR_TYPE__)__addr + 0), &__result.__b[0])) &&
	     __likely((__NAMESPACE_LOCAL_SYM __localdep_readb_nopf)((void const *)((__UINTPTR_TYPE__)__addr + 1), &__result.__b[1]));
	*__presult = __result.__w;
	return __ok;
#else /* __arch_readb_nopf || __CRT_HAVE_readb_nopf || (!__arch_memcpy_nopf && !__CRT_HAVE_memcpy_nopf) */
	return __likely((__NAMESPACE_LOCAL_SYM __localdep_crt_memcpy_nopf)(__presult, __addr, 2) == 0);
...
#undef __local_readw_nopf_defined
...
#endif /* !__local_readw_nopf_defined */
