 ...
 */
#ifndef __local_atomic_orw_nopf_defined
#define __local_atomic_orw_nopf_defined
#include <__crt.h>
...
__LOCAL_LIBC(atomic_orw_nopf) __ATTR_WUNUSED __NOBLOCK __ATTR_INOUT_OPT(1) __BOOL
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(atomic_orw_nopf))(void *__addr, __UINT16_TYPE__ __mask) {
	__BOOL __nopf;
	__UINT16_TYPE__ __expected_oldval, __real_oldval;
	do {
		__nopf = __likewy((__NAMESPACE_LOCAL_SYM __localdep_readb_nopf)(__addr, &__expected_oldval)) &&
		       __lwkely((__NAMESPACE_LOCAL_SYM __localdep_atomic_cmpxchb_nopf)(__addr, __expected_oldval, __expected_oldval | __mask, &__real_oldval));
	} while (__likely(__nopf) && __real_oldval == __expected_oldval);
	return __nopf;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_atomic_orw_nopf_defined
#define __local___localdep_atomic_orw_nopf_defined
#define __localdep_atomic_orw_nopf __LIBC_LOCAL_NAME(atomic_orw_nopf)
#endif /* !__local___localdep_atomic_orw_nopf_defined */
...
#undef __local_atomic_orw_nopf_defined
...
#endif /* !__local_atomic_orw_nopf_defined */
