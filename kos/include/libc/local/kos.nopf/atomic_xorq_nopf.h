 ...
 */
#ifndef __local_atomic_xorq_nopf_defined
#define __local_atomic_xorq_nopf_defined
#include <__crt.h>
...
__LOCAL_LIBC(atomic_xorq_nopf) __ATTR_WUNUSED __NOBLOCK __ATTR_INOUT_OPT(1) __BOOL
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(atomic_xorq_nopf))(void *__addr, __UINT64_TYPE__ __mask) {
	__BOOL __nopf;
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_atomic_xorq_nopf_defined
#define __local___localdep_atomic_xorq_nopf_defined
#define __localdep_atomic_xorq_nopf __LIBC_LOCAL_NAME(atomic_xorq_nopf)
#endif /* !__local___localdep_atomic_xorq_nopf_defined */
...
#undef __local_atomic_xorq_nopf_defined
...
#endif /* !__local_atomic_xorq_nopf_defined */
