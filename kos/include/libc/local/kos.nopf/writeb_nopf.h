 ...
 */
#ifndef __local_writeb_nopf_defined
#define __local_writeb_nopf_defined
#include <__crt.h>
...
__LOCAL_LIBC(writeb_nopf) __ATTR_WUNUSED __NOBLOCK __ATTR_OUT_OPT(1) __BOOL
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(writeb_nopf))(void *__addr, __UINT8_TYPE__ __val) {
	return __likely((__NAMESPACE_LOCAL_SYM __localdep_crt_memcpy_nopf)(__addr, &__val, 1) == 0);
}
...
#else /* __arch_memcpy_nopf || __CRT_HAVE_memcpy_nopf */
#undef __local_writeb_nopf_defined
#endif /* !__arch_memcpy_nopf && !__CRT_HAVE_memcpy_nopf */
#endif /* !__local_writeb_nopf_defined */
