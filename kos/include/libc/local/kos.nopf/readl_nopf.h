 ...
 */
#ifndef __local_readl_nopf_defined
#define __local_readl_nopf_defined
#include <__crt.h>
...
__LOCAL_LIBC(readl_nopf) __ATTR_WUNUSED __NOBLOCK __ATTR_IN_OPT(1) __ATTR_OUT(2) __BOOL
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(readl_nopf))(void const *__addr, __UINT32_TYPE__ *__presult) {
#if defined(__arch_readw_nopf) || defined(__CRT_HAVE_readw_nopf) || (!defined(__arch_memcpy_nopf) && !defined(__CRT_HAVE_memcpy_nopf))
	__BOOL __ok;
	union { __UINT32_TYPE__ __l; __UINT16_TYPE__ __w[2]; } __result;
	__ok = __likely((__NAMESPACE_LOCAL_SYM __localdep_readw_nopf)((void const *)((__UINTPTR_TYPE__)__addr + 0), &__result.__w[0])) &&
	     __likely((__NAMESPACE_LOCAL_SYM __localdep_readw_nopf)((void const *)((__UINTPTR_TYPE__)__addr + 2), &__result.__w[1]));
	*__presult = __result.__l;
	return __ok;
#else /* __arch_readw_nopf || __CRT_HAVE_readw_nopf || (!__arch_memcpy_nopf && !__CRT_HAVE_memcpy_nopf) */
	return __likely((__NAMESPACE_LOCAL_SYM __localdep_crt_memcpy_nopf)(__presult, __addr, 4) == 0);
...
#undef __local_readl_nopf_defined
...
#endif /* !__local_readl_nopf_defined */
