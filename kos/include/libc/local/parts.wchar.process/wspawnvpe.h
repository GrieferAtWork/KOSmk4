 ...
 */
#ifndef __local_wspawnvpe_defined
#define __local_wspawnvpe_defined
#include <__crt.h>
...
__LOCAL_LIBC(wspawnvpe) __ATTR_NONNULL((2, 3, 4)) __pid_t
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(wspawnvpe))(__STDC_INT_AS_UINT_T __mode, __WCHAR_TYPE__ const *__restrict __file, __TWARGV, __TWENVP) {
	int __result = -1;
