 ...
 */
#ifndef __local_wspawnve_defined
#define __local_wspawnve_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(wspawnve) __ATTR_NONNULL((2, 3, 4)) __pid_t
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(wspawnve))(__STDC_INT_AS_UINT_T __mode, __WCHAR_TYPE__ const *__restrict __path, __TWARGV, __TWENVP) {
	int __result = -1;
...
#define __local___localdep_wspawnve_defined
#define __localdep_wspawnve __LIBC_LOCAL_NAME(wspawnve)
...
#undef __local_wspawnve_defined
...
#endif /* !__local_wspawnve_defined */
