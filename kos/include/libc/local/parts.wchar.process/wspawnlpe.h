...
#endif /* !__TARGV */
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(3) __ATTR_ACCESS_RO(4),__pid_t,__NOTHROW_RPC,__localdep_wspawnvpe,(__STDC_INT_AS_UINT_T __mode, __WCHAR_TYPE__ const *__restrict __file, __TWARGV, __TWENVP),wspawnvpe,(__mode,__file,___argv,___envp))
...
#endif /* !__TARGV */
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(3) __ATTR_ACCESS_RO(4),__pid_t,__NOTHROW_RPC,__localdep_wspawnvpe,(__STDC_INT_AS_UINT_T __mode, __WCHAR_TYPE__ const *__restrict __file, __TWARGV, __TWENVP),_wspawnvpe,(__mode,__file,___argv,___envp))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(wspawnlpe) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO_OPT(3) __ATTR_SENTINEL_O(1) __pid_t
