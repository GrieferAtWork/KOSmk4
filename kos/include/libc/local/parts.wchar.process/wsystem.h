 ...
 */
#ifndef __local_wsystem_defined
#define __local_wsystem_defined
#include <__crt.h>
...
__LOCAL_LIBC(wsystem) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(wsystem))(__WCHAR_TYPE__ const *__cmd) {
	int __result;
	char *__used_cmd;
	if (!__cmd) {
		__result = (__NAMESPACE_LOCAL_SYM __localdep_system)(__NULLPTR);
	} else {
		__used_cmd = (__NAMESPACE_LOCAL_SYM __localdep_convert_wcstombs)(__cmd);
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_wsystem_defined
#define __local___localdep_wsystem_defined
#define __localdep_wsystem __LIBC_LOCAL_NAME(wsystem)
#endif /* !__local___localdep_wsystem_defined */
