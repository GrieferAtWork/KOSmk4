...
__CREDIRECT(__ATTR_ACCESS_RO(5) __ATTR_ACCESS_ROS(2, 3),int,__NOTHROW_RPC,__localdep_mq_timedsend64,(__mqd_t __mqdes, char const *__msg_ptr, __SIZE_TYPE__ __msg_len, unsigned int __msg_prio, struct __timespec64 const *__abs_timeout),mq_timedsend,(__mqdes,__msg_ptr,__msg_len,__msg_prio,__abs_timeout))
#elif defined(__CRT_HAVE_mq_timedsend64)
__CREDIRECT(__ATTR_ACCESS_RO(5) __ATTR_ACCESS_ROS(2, 3),int,__NOTHROW_RPC,__localdep_mq_timedsend64,(__mqd_t __mqdes, char const *__msg_ptr, __SIZE_TYPE__ __msg_len, unsigned int __msg_prio, struct __timespec64 const *__abs_timeout),mq_timedsend64,(__mqdes,__msg_ptr,__msg_len,__msg_prio,__abs_timeout))
...
__LOCAL_LIBC(mq_timedsend) __ATTR_ACCESS_RO(5) __ATTR_ACCESS_ROS(2, 3) int
