...
__LOCAL_LIBC(mq_timedreceive64) __ATTR_ACCESS_RO(5) __ATTR_ACCESS_WRS(2, 3) __SSIZE_TYPE__
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(mq_timedreceive64))(__mqd_t __mqdes, char *__restrict __msg_ptr, __SIZE_TYPE__ __msg_len, unsigned int *__pmsg_prio, struct __timespec64 const *__restrict __abs_timeout) {
...
#undef __local_mq_timedreceive64_defined
#endif /* !__CRT_HAVE_mq_timedreceive */
#endif /* !__local_mq_timedreceive64_defined */
