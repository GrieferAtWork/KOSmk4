...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(memcasecmp_l))(void const *__s1, void const *__s2, __SIZE_TYPE__ __num_chars, __locale_t __locale) {
	(void)__locale;
	return (__NAMESPACE_LOCAL_SYM __localdep_memcasecmp)(__s1, __s2, __num_chars);
}
__NAMESPACE_LOCAL_END
