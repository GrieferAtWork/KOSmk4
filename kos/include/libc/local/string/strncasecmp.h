...
#define __local_strncasecmp_defined
#include <__crt.h>
...
__LOCAL_LIBC(strncasecmp) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_ROS(1, 3) __ATTR_ACCESS_ROS(2, 3) __ATTR_NONNULL((1, 2)) int
