...
#define __local_fuzzy_strncasecmp_l_defined
#include <__crt.h>
...
__LOCAL_LIBC(fuzzy_strncasecmp_l) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_ROS(1, 2) __ATTR_ACCESS_ROS(3, 4) __ATTR_NONNULL((1, 3)) __SIZE_TYPE__
...
#define __local___localdep_fuzzy_strncasecmp_l_defined
