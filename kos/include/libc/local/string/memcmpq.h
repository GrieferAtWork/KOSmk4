...
__LOCAL_LIBC(memcmpq) __ATTR_PURE __ATTR_WUNUSED __ATTR_IN(1) __ATTR_IN(2) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(memcmpq))(void const *__s1, void const *__s2, __SIZE_TYPE__ __n_dwords) {
	__UINT64_TYPE__ const *__p1 = (__UINT64_TYPE__ const *)__s1;
	__UINT64_TYPE__ const *__p2 = (__UINT64_TYPE__ const *)__s2;
	while (__n_dwords--) {
		__UINT64_TYPE__ __v1, __v2;
