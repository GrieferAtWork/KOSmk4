...
#define __local_memcmpl_defined
#include <__crt.h>
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(memcmpl) __ATTR_PURE __ATTR_WUNUSED __ATTR_IN(1) __ATTR_IN(2) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(memcmpl))(void const *__s1, void const *__s2, __SIZE_TYPE__ __n_dwords) {
	__UINT32_TYPE__ const *__p1 = (__UINT32_TYPE__ const *)__s1;
	__UINT32_TYPE__ const *__p2 = (__UINT32_TYPE__ const *)__s2;
	while (__n_dwords--) {
		__UINT32_TYPE__ __v1, __v2;
