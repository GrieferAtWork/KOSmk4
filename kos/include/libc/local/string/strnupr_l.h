...
#define __local_strnupr_l_defined
#include <__crt.h>
...
__LOCAL_LIBC(strnupr_l) __ATTR_LEAF __ATTR_RETNONNULL __ATTR_ACCESS_RWS(1, 2) __ATTR_NONNULL((1)) char *
...
#define __local___localdep_strnupr_l_defined
