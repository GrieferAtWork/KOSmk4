...
#define __local_mempsetw_defined
#include <__crt.h>
...
__LOCAL_LIBC(mempsetw) __ATTR_LEAF __ATTR_ACCESS_WR(1) __UINT16_TYPE__ *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(mempsetw))(void *__restrict __dst, __UINT16_TYPE__ __word, __SIZE_TYPE__ __n_words) {
	return (__UINT16_TYPE__ *)(__NAMESPACE_LOCAL_SYM __localdep_memsetw)(__dst, __word, __n_words) + __n_words;
}
__NAMESPACE_LOCAL_END
