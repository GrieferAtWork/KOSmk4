...
#define __local_strlcpy_defined
#include <__crt.h>
...
__LOCAL_LIBC(strlcpy) __ATTR_LEAF __ATTR_ACCESS_RO(2) __ATTR_ACCESS_WRS(1, 3) __ATTR_NONNULL((1)) __SIZE_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(strlcpy))(char *__restrict __dst, char const *__restrict __src, __SIZE_TYPE__ __bufsize) {
	...
	(__NAMESPACE_LOCAL_SYM __localdep_memcpy)(__dst, __src, __copy_size * sizeof(char));
	__dst[__copy_size] = '\0';
	return __result;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_strlcpy_defined
#define __local___localdep_strlcpy_defined
