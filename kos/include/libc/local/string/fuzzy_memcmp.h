...
#define __local_fuzzy_memcmp_defined
#include <__crt.h>
...
__LOCAL_LIBC(fuzzy_memcmp) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_ROS(1, 2) __ATTR_ACCESS_ROS(3, 4) __ATTR_NONNULL((1, 3)) __SIZE_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(fuzzy_memcmp))(void const *__s1, __SIZE_TYPE__ __s1_bytes, void const *__s2, __SIZE_TYPE__ __s2_bytes) {
...
#else /* !__NO_MALLOCA */
#undef __local_fuzzy_memcmp_defined
#endif /* __NO_MALLOCA */
