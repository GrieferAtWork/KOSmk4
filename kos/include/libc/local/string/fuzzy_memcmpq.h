...
#define __local_fuzzy_memcmpq_defined
#include <__crt.h>
...
__LOCAL_LIBC(fuzzy_memcmpq) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(3) __SIZE_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(fuzzy_memcmpq))(void const *__s1, __SIZE_TYPE__ __s1_qwords, void const *__s2, __SIZE_TYPE__ __s2_qwords) {
	...
	for (__i = 0; __i < __s1_qwords; ++__i) {
		...
		(__NAMESPACE_LOCAL_SYM __localdep_memcpyc)(__v0, __v1, __s2_qwords, sizeof(__SIZE_TYPE__));
	}
...
#define __local___localdep_fuzzy_memcmpq_defined
