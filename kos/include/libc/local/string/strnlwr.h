...
#define __local_strnlwr_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(strnlwr) __ATTR_LEAF __ATTR_RETNONNULL __ATTR_NONNULL((1)) char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(strnlwr))(char *__restrict __str, __SIZE_TYPE__ __maxlen) {
	...
	for (__iter = __str; __maxlen-- && (__ch = *__iter) != '\0'; ++__iter)
		*__iter = (char)__localdep_tolower((unsigned char)__ch);
	return __str;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_strnlwr_defined
#define __local___localdep_strnlwr_defined 1
