...
#define __local__strupr_s_defined
#include <__crt.h>
...
__LOCAL_LIBC(_strupr_s) __ATTR_ACCESS_RW_OPT(1) __errno_t
...
#define __local___localdep__strupr_s_defined
