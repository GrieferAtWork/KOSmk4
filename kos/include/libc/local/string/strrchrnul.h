...
#define __local_strrchrnul_defined
#include <__crt.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(strrchrnul) __ATTR_PURE __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_ACCESS_RO(1) char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(strrchrnul))(char const *__restrict __haystack, int __needle) {
...
#endif /* !__local_strrchrnul_defined */
