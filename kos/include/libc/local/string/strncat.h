...
#define __local_strncat_defined
#include <__crt.h>
...
__LOCAL_LIBC(strncat) __ATTR_LEAF __ATTR_RETNONNULL __ATTR_ACCESS_ROS(2, 3) __ATTR_ACCESS_RW(1) __ATTR_NONNULL((2)) char *
