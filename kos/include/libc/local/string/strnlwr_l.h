...
#define __local_strnlwr_l_defined
#include <__crt.h>
...
__LOCAL_LIBC(strnlwr_l) __ATTR_LEAF __ATTR_RETNONNULL __ATTR_NONNULL((1)) char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(strnlwr_l))(char *__restrict __str, __SIZE_TYPE__ __maxlen, __locale_t __locale) {
	char *__iter, __ch;
	for (__iter = __str; __maxlen-- && (__ch = *__iter) != '\0'; ++__iter)
		*__iter = (__NAMESPACE_LOCAL_SYM __localdep_tolower_l)(__ch, __locale);
	return __str;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_strnlwr_l_defined
#define __local___localdep_strnlwr_l_defined
#define __localdep_strnlwr_l __LIBC_LOCAL_NAME(strnlwr_l)
#endif /* !__local___localdep_strnlwr_l_defined */
