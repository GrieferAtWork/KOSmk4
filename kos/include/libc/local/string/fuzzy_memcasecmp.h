...
#define __local_fuzzy_memcasecmp_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(fuzzy_memcasecmp) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1, 3)) __SIZE_TYPE__
