...
#if defined(__CRT_HAVE_ntp_gettimex64) || defined(__CRT_HAVE___ntp_gettimex64) || defined(__CRT_HAVE_ntp_gettimex)
...
__CREDIRECT(__ATTR_OUT(1),int,__NOTHROW_NCX,__localdep_ntp_gettime64,(struct __ntptimeval64 *__restrict __ntv),__ntp_gettimex64,(__ntv))
...
#else /* __CRT_HAVE_ntp_gettimex64 || __CRT_HAVE___ntp_gettimex64 || __CRT_HAVE_ntp_gettimex */
#undef __local_ntp_gettime_defined
#endif /* !__CRT_HAVE_ntp_gettimex64 && !__CRT_HAVE___ntp_gettimex64 && !__CRT_HAVE_ntp_gettimex */
