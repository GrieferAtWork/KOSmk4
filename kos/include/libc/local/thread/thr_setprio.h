...
#include <bits/os/sched.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((3)),__errno_t,__NOTHROW_NCX,__localdep_pthread_setschedparam,(__pthread_t __target_thread, int __policy, struct sched_param const *__param),pthread_setschedparam,(__target_thread,__policy,__param))
