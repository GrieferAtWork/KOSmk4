...
print("	}");
	...
	static __BYTE_TYPE__ const __byteblob[1762] = {
	...
	switch(_NL_ITEM_CATEGORY(__item)) {

	case __LC_NAME: {
		static __UINT16_TYPE__ const __offtab_LC_NAME[7] = {
#if __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
			1342,1,1,1,1,1,1626
#else /* __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__ */
			1342,0,0,0,0,0,1626
		...
		if __likely(__idx < 7) {
			__UINT16_TYPE__ __offset = __offtab_LC_NAME[__idx];
			__result = (char const *)(__byteblob + __offset);
		}
	}	break;

	case __LC_MEASUREMENT: {
		static __UINT16_TYPE__ const __offtab_LC_MEASUREMENT[2] = {
			1760,1626
		};
		if (__idx == 0xffff) {
			__result = "LC_MEASUREMENT";
			break;
		}
		if __likely(__idx < 2) {
			__UINT16_TYPE__ __offset = __offtab_LC_MEASUREMENT[__idx];
			__result = (char const *)(__byteblob + __offset);
		}
	}	break;

	case __LC_MONETARY: {
		static __INT16_TYPE__ const __offtab_LC_MONETARY[46] = {
#if __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
		...
		if (__idx == 0xffff) {
			__result = "LC_MONETARY";
			break;
		}
		if (__idx == 39) { /* _NL_MONETARY_UNO_VALID_TO */
			__result = (char const *)(__UINTPTR_TYPE__)__UINTPTR_C(99991231);
			break;
		}
		if (__idx == 41) { /* _NL_MONETARY_DUO_VALID_TO */
			__result = (char const *)(__UINTPTR_TYPE__)__UINTPTR_C(99991231);
			break;
		}
		if __likely(__idx < 46) {
			__INT16_TYPE__ __offset = __offtab_LC_MONETARY[__idx];
			if (__offset < 0) {
				__result = (char const *)(__UINTPTR_TYPE__)~__offset;
				break;
			}
			__result = (char const *)(__byteblob + __offset);
		}
	...
	case __LC_TIME: {
		static __UINT16_TYPE__ const __offtab_LC_TIME[159] = {
#if __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
		...
		if (__idx == 102) { /* _NL_TIME_WEEK_1STDAY */
			__result = (char const *)(__UINTPTR_TYPE__)__UINTPTR_C(19971130);
			break;
		}
		if __likely(__idx < 159) {
			__UINT16_TYPE__ __offset = __offtab_LC_TIME[__idx];
			__result = (char const *)(__byteblob + __offset);
		}
	}	break;

	case __LC_PAPER: {
		static __INT16_TYPE__ const __offtab_LC_PAPER[3] = {
			~297,~210,1626
		};
		if (__idx == 0xffff) {
			__result = "LC_PAPER";
		...
		if __likely(__idx < 3) {
			__INT16_TYPE__ __offset = __offtab_LC_PAPER[__idx];
			if (__offset < 0) {
				__result = (char const *)(__UINTPTR_TYPE__)~__offset;
				break;
			}
	...
	case __LC_IDENTIFICATION: {
		static __UINT16_TYPE__ const __offtab_LC_IDENTIFICATION[16] = {
#if __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
		...
		if (__idx == 0xffff) {
			__result = "LC_IDENTIFICATION";
			break;
		}
		if __likely(__idx < 16) {
			__UINT16_TYPE__ __offset = __offtab_LC_IDENTIFICATION[__idx];
			__result = (char const *)(__byteblob + __offset);
		}
	}	break;

	case __LC_NUMERIC: {
		static __INT16_TYPE__ const __offtab_LC_NUMERIC[6] = {
#if __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
			1750,1,1,~46,~0,1626
#else /* __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__ */
			1750,0,0,~46,~0,1626
		...
		if __likely(__idx < 6) {
			__INT16_TYPE__ __offset = __offtab_LC_NUMERIC[__idx];
			if (__offset < 0) {
				__result = (char const *)(__UINTPTR_TYPE__)~__offset;
				break;
			}
	...
	case __LC_MESSAGES: {
		static __UINT16_TYPE__ const __offtab_LC_MESSAGES[5] = {
#if __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
			1632,1638,1,1,1626
#else /* __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__ */
			1632,1638,0,0,1626
		...
		if (__idx == 0xffff) {
			__result = "LC_MESSAGES";
			break;
		}
		if __likely(__idx < 5) {
			__UINT16_TYPE__ __offset = __offtab_LC_MESSAGES[__idx];
			__result = (char const *)(__byteblob + __offset);
		}
	}	break;

	case __LC_ADDRESS: {
		static __INT16_TYPE__ const __offtab_LC_ADDRESS[13] = {
#if __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
		...
		if __likely(__idx < 13) {
			__INT16_TYPE__ __offset = __offtab_LC_ADDRESS[__idx];
			if (__offset < 0) {
				__result = (char const *)(__UINTPTR_TYPE__)~__offset;
				break;
			}
	...
	case __LC_COLLATE: {
		static __INT16_TYPE__ const __offtab_LC_COLLATE[19] = {
#if __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
		...
		if __likely(__idx < 19) {
			__INT16_TYPE__ __offset = __offtab_LC_COLLATE[__idx];
			if (__offset < 0) {
				__result = (char const *)(__UINTPTR_TYPE__)~__offset;
				break;
			}
	...
	case __LC_CTYPE: {
		static __INT16_TYPE__ const __offtab_LC_CTYPE[86] = {
#if __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
		...
		if __likely(__idx < 86) {
			__INT16_TYPE__ __offset = __offtab_LC_CTYPE[__idx];
			if (__offset < 0) {
				__result = (char const *)(__UINTPTR_TYPE__)~__offset;
				break;
			}
	...
	case __LC_TELEPHONE: {
		static __UINT16_TYPE__ const __offtab_LC_TELEPHONE[5] = {
#if __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
			1413,1,1,1,1626
#else /* __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__ */
			1413,0,0,0,1626
		...
		if (__idx == 0xffff) {
			__result = "LC_TELEPHONE";
			break;
		}
		if __likely(__idx < 5) {
			__UINT16_TYPE__ __offset = __offtab_LC_TELEPHONE[__idx];
			__result = (char const *)(__byteblob + __offset);
		}
	}	break;
...
#endif /* !__local_nl_langinfo_defined */
