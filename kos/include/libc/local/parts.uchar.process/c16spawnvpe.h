 ...
 */
#ifndef __local_c16spawnvpe_defined
#define __local_c16spawnvpe_defined
#include <__crt.h>
...
__LOCAL_LIBC(c16spawnvpe) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(3) __ATTR_ACCESS_RO(4) __pid_t
__NOTHROW_RPC(__LIBDCALL __LIBC_LOCAL_NAME(c16spawnvpe))(__STDC_INT_AS_UINT_T __mode, __CHAR16_TYPE__ const *__restrict __file, __T16ARGV, __T16ENVP) {
	int __result = -1;
