 ...
 */
#ifndef __local_c16spawnvp_defined
#define __local_c16spawnvp_defined
#include <__crt.h>
...
__LOCAL_LIBC(c16spawnvp) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(3) __pid_t
__NOTHROW_RPC(__LIBDCALL __LIBC_LOCAL_NAME(c16spawnvp))(__STDC_INT_AS_UINT_T __mode, __CHAR16_TYPE__ const *__restrict __file, __T16ARGV) {
	int __result = -1;
...
#define __localdep_c16spawnvp __LIBC_LOCAL_NAME(c16spawnvp)
...
#undef __local_c16spawnvp_defined
...
#endif /* !__local_c16spawnvp_defined */
