 ...
 */
#ifndef __local_c16spawnve_defined
#define __local_c16spawnve_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(c16spawnve) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(3) __ATTR_ACCESS_RO(4) __pid_t
__NOTHROW_RPC(__LIBDCALL __LIBC_LOCAL_NAME(c16spawnve))(__STDC_INT_AS_UINT_T __mode, __CHAR16_TYPE__ const *__restrict __path, __T16ARGV, __T16ENVP) {
	int __result = -1;
...
#undef __local_c16spawnve_defined
...
#endif /* !__local_c16spawnve_defined */
