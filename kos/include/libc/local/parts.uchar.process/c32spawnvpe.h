 ...
 */
#ifndef __local_c32spawnvpe_defined
#define __local_c32spawnvpe_defined
#include <__crt.h>
...
__LOCAL_LIBC(c32spawnvpe) __ATTR_NONNULL((2, 3, 4)) __pid_t
__NOTHROW_RPC(__LIBKCALL __LIBC_LOCAL_NAME(c32spawnvpe))(__STDC_INT_AS_UINT_T __mode, __CHAR32_TYPE__ const *__restrict __file, __T32ARGV, __T32ENVP) {
	int __result = -1;
	...
	if __unlikely(___envp && (__utf8_envp = (__NAMESPACE_LOCAL_SYM __localdep_convert_c32tombsv)(___envp)) == __NULLPTR)
		goto __done_argv;
	__result = (__NAMESPACE_LOCAL_SYM __localdep_spawnvpe)(__mode, __utf8_file, __utf8_argv, __utf8_envp);
