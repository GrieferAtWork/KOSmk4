...
#define __local_c32spawnlp_defined
#include <__crt.h>
...
#define __local___localdep_c32spawnvp_defined
...
#endif /* !__TARGV */
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((2, 3)),__pid_t,__NOTHROW_RPC,__localdep_c32spawnvp,(__STDC_INT_AS_UINT_T __mode, __CHAR32_TYPE__ const *__restrict __file, __T32ARGV),wspawnvp,(__mode,__file,___argv))
...
#endif /* !__TARGV */
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT_KOS(__ATTR_NONNULL((2, 3)),__pid_t,__NOTHROW_RPC,__localdep_c32spawnvp,(__STDC_INT_AS_UINT_T __mode, __CHAR32_TYPE__ const *__restrict __file, __T32ARGV),wspawnvp,(__mode,__file,___argv))
...
#endif /* !__TARGV */
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((2, 3)),__pid_t,__NOTHROW_RPC,__localdep_c32spawnvp,(__STDC_INT_AS_UINT_T __mode, __CHAR32_TYPE__ const *__restrict __file, __T32ARGV),_wspawnvp,(__mode,__file,___argv))
...
#endif /* !__TARGV */
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT_KOS(__ATTR_NONNULL((2, 3)),__pid_t,__NOTHROW_RPC,__localdep_c32spawnvp,(__STDC_INT_AS_UINT_T __mode, __CHAR32_TYPE__ const *__restrict __file, __T32ARGV),_wspawnvp,(__mode,__file,___argv))
#else /* ... */
...
__NOTHROW_RPC(__VLIBKCALL __LIBC_LOCAL_NAME(c32spawnlp))(__STDC_INT_AS_UINT_T __mode, __CHAR32_TYPE__ const *__restrict __file, __CHAR32_TYPE__ const *__args, ...) {
	__REDIRECT_SPAWNL(__CHAR32_TYPE__, (__NAMESPACE_LOCAL_SYM __localdep_c32spawnvp), __mode, __file, __args)
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c32spawnlp_defined
#define __local___localdep_c32spawnlp_defined
