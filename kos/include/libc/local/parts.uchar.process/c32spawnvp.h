 ...
 */
#ifndef __local_c32spawnvp_defined
#define __local_c32spawnvp_defined
#include <__crt.h>
...
__CREDIRECT(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(3),__pid_t,__NOTHROW_RPC,__localdep_spawnvp,(__STDC_INT_AS_UINT_T __mode, char const *__restrict __file, __TARGV),spawnvp,(__mode,__file,___argv))
#elif defined(__CRT_HAVE__spawnvp)
__CREDIRECT(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(3),__pid_t,__NOTHROW_RPC,__localdep_spawnvp,(__STDC_INT_AS_UINT_T __mode, char const *__restrict __file, __TARGV),_spawnvp,(__mode,__file,___argv))
...
__LOCAL_LIBC(c32spawnvp) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(3) __pid_t
__NOTHROW_RPC(__LIBKCALL __LIBC_LOCAL_NAME(c32spawnvp))(__STDC_INT_AS_UINT_T __mode, __CHAR32_TYPE__ const *__restrict __file, __T32ARGV) {
	int __result = -1;
	...
	if __unlikely(!__utf8_argv)
		goto __done_file;
	__result = (__NAMESPACE_LOCAL_SYM __localdep_spawnvp)(__mode, __utf8_file, __utf8_argv);
...
#define __localdep_c32spawnvp __LIBC_LOCAL_NAME(c32spawnvp)
...
#undef __local_c32spawnvp_defined
...
#endif /* !__local_c32spawnvp_defined */
