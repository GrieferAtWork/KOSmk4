...
__CREDIRECT(__ATTR_IN(2) __ATTR_IN(3),__pid_t,__NOTHROW_RPC,__localdep_spawnv,(__STDC_INT_AS_UINT_T __mode, char const *__restrict __path, __TARGV),spawnv,(__mode,__path,___argv))
#elif defined(__CRT_HAVE__spawnv)
__CREDIRECT(__ATTR_IN(2) __ATTR_IN(3),__pid_t,__NOTHROW_RPC,__localdep_spawnv,(__STDC_INT_AS_UINT_T __mode, char const *__restrict __path, __TARGV),_spawnv,(__mode,__path,___argv))
...
__LOCAL_LIBC(c32spawnv) __ATTR_IN(2) __ATTR_IN(3) __pid_t
