 ...
 */
#ifndef __local_c32spawnv_defined
#define __local_c32spawnv_defined
#include <__crt.h>
...
__CREDIRECT(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(3),__pid_t,__NOTHROW_RPC,__localdep_spawnv,(__STDC_INT_AS_UINT_T __mode, char const *__restrict __path, __TARGV),spawnv,(__mode,__path,___argv))
#elif defined(__CRT_HAVE__spawnv)
__CREDIRECT(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(3),__pid_t,__NOTHROW_RPC,__localdep_spawnv,(__STDC_INT_AS_UINT_T __mode, char const *__restrict __path, __TARGV),_spawnv,(__mode,__path,___argv))
...
__LOCAL_LIBC(c32spawnv) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(3) __pid_t
__NOTHROW_RPC(__LIBKCALL __LIBC_LOCAL_NAME(c32spawnv))(__STDC_INT_AS_UINT_T __mode, __CHAR32_TYPE__ const *__restrict __path, __T32ARGV) {
	int __result = -1;
...
#undef __local_c32spawnv_defined
...
#endif /* !__local_c32spawnv_defined */
