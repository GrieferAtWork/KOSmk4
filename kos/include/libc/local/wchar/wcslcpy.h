...
#define __local_wcslcpy_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(wcslcpy) __ATTR_LEAF __ATTR_NONNULL((1, 2)) __SIZE_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(wcslcpy))(__WCHAR_TYPE__ *__restrict __dst, __WCHAR_TYPE__ const *__restrict __src, __SIZE_TYPE__ __bufsize) {
	...
	__localdep_memcpy(__dst, __src, __copy_size*sizeof(__WCHAR_TYPE__));
	__dst[__copy_size] = '\0';
	return __result;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_wcslcpy_defined
#define __local___localdep_wcslcpy_defined 1
