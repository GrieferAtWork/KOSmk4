...
__NOTHROW_NCX(__VLIBCCALL __LIBC_LOCAL_NAME(_swprintf_p_l))(__WCHAR_TYPE__ *__dst, __SIZE_TYPE__ __bufsize, __WCHAR_TYPE__ const *__format, __locale_t __locale, ...) {
	__STDC_INT_AS_SSIZE_T __result;
	__builtin_va_list __args;
	__builtin_va_start(__args, __locale);
	__result = (__NAMESPACE_LOCAL_SYM __localdep__vswprintf_p_l)(__dst, __bufsize, __format, __locale, __args);
