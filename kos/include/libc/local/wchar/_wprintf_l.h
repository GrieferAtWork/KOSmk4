...
#define __local__wprintf_l_defined
#include <__crt.h>
#include <features.h>
...
(__VLIBCCALL __LIBC_LOCAL_NAME(_wprintf_l))(__WCHAR_TYPE__ const *__format, __locale_t __locale, ...) __THROWS(...) {
	...
	__result = (__NAMESPACE_LOCAL_SYM __localdep__vwprintf_l)(__format, __locale, __args);
	__builtin_va_end(__args);
	return __result;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__wprintf_l_defined
#define __local___localdep__wprintf_l_defined
