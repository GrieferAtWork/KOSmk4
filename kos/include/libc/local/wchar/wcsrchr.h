...
#define __local_wcsrchr_defined
#include <__crt.h>
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(wcsrchr) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __WCHAR_TYPE__ *
...
#define __local___localdep_wcsrchr_defined
