...
#define __local__snwprintf_s_l_defined
#include <__crt.h>
#include <features.h>
...
__NOTHROW_NCX(__VLIBCCALL __LIBC_LOCAL_NAME(_snwprintf_s_l))(__WCHAR_TYPE__ *__dst, __SIZE_TYPE__ __wchar_count, __SIZE_TYPE__ __bufsize, __WCHAR_TYPE__ const *__format, __locale_t __locale, ...) {
	...
	__result = (__NAMESPACE_LOCAL_SYM __localdep__vsnwprintf_s_l)(__dst, __wchar_count, __bufsize, __format, __locale, __args);
	__builtin_va_end(__args);
	return __result;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__snwprintf_s_l_defined
#define __local___localdep__snwprintf_s_l_defined
