...
__NOTHROW_CB(__LIBCCALL __LIBC_LOCAL_NAME(vfwprintf))(__FILE *__restrict __stream, __WCHAR_TYPE__ const *__restrict __format, __builtin_va_list __args) {
