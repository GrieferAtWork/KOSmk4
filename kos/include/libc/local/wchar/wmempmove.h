...
#define __local_wmempmove_defined
#include <__crt.h>
...
__LOCAL_LIBC(wmempmove) __ATTR_RETNONNULL __ATTR_ACCESS_ROS(2, 3) __ATTR_ACCESS_WRS(1, 3) __WCHAR_TYPE__ *
...
#define __local___localdep_wmempmove_defined
