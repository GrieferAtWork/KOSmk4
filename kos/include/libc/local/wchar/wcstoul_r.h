...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(wcstoul_r))(__WCHAR_TYPE__ const *__restrict __nptr, __WCHAR_TYPE__ **__endptr, __STDC_INT_AS_UINT_T __base, __errno_t *__error) {
	...
	return (unsigned long)__localdep_wcstou64_r(__nptr, __endptr, __base, __error);
#elif __SIZEOF_LONG__ >= 4
	return (unsigned long)__localdep_wcstou32_r(__nptr, __endptr, __base, __error);
#else /* ... */
