...
__LOCAL_LIBC(wcstol) __ATTR_LEAF __ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR_OPT(2) long
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(wcstol))(__WCHAR_TYPE__ const *__restrict __nptr, __WCHAR_TYPE__ **__endptr, __STDC_INT_AS_UINT_T __base) {
	...
	return (long)(__NAMESPACE_LOCAL_SYM __localdep_wcsto32)(__nptr, __endptr, __base);
#else /* __SIZEOF_LONG__ <= 4 */
	return (long)(__NAMESPACE_LOCAL_SYM __localdep_wcsto64)(__nptr, __endptr, __base);
