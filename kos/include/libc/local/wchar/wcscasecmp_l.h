...
#define __local_wcscasecmp_l_defined
#include <__crt.h>
...
__LOCAL_LIBC(wcscasecmp_l) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2) int
