...
#define __local_wcsnlwr_l_defined
#include <__crt.h>
...
__LOCAL_LIBC(wcsnlwr_l) __ATTR_LEAF __ATTR_RETNONNULL __ATTR_ACCESS_RWS(1, 2) __ATTR_NONNULL((1)) __WCHAR_TYPE__ *
...
#define __local___localdep_wcsnlwr_l_defined
