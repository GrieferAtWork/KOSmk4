...
__LOCAL_LIBC(fputws_unlocked) __ATTR_IN(1) __ATTR_INOUT(2) __STDC_INT_AS_SIZE_T
__NOTHROW_CB_NCX(__LIBCCALL __LIBC_LOCAL_NAME(fputws_unlocked))(__WCHAR_TYPE__ const *__restrict __str, __FILE *__restrict __stream) {
