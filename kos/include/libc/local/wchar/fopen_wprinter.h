 ...
 */
#ifndef __local_fopen_wprinter_defined
#define __local_fopen_wprinter_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(fopen_wprinter) __ATTR_WUNUSED __ATTR_NONNULL((1)) __FILE *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(fopen_wprinter))(__pwformatprinter __printer, void *__arg) {
	__FILE *__result;
	struct __local_format_8tow_data {   /* == `struct format_8tow_data' */
		__pwformatprinter __fd_printer;    /* [1..1] Inner printer */
		void            *__fd_arg;        /* Argument for `fd_printer' */
	...
	__result = (__NAMESPACE_LOCAL_SYM __localdep_funopen2_64)(__cookie, __NULLPTR, (__SSIZE_TYPE__ (__LIBKCALL *)(void *, void const *, __SIZE_TYPE__))&(__NAMESPACE_LOCAL_SYM __localdep_format_8tow), __NULLPTR,
	...
	__result = (__NAMESPACE_LOCAL_SYM __localdep_funopen2_64)(__cookie, __NULLPTR, (__SSIZE_TYPE__ (__LIBKCALL *)(void *, void const *, __SIZE_TYPE__))&(__NAMESPACE_LOCAL_SYM __localdep_format_8tow),
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_fopen_wprinter_defined
#define __local___localdep_fopen_wprinter_defined
#define __localdep_fopen_wprinter __LIBC_LOCAL_NAME(fopen_wprinter)
#endif /* !__local___localdep_fopen_wprinter_defined */
...
#undef __local_fopen_wprinter_defined
...
#endif /* !__local_fopen_wprinter_defined */
