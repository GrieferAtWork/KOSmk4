...
__NOTHROW_CB_NCX(__LIBCCALL __LIBC_LOCAL_NAME(vfwscanf_unlocked))(__FILE *__restrict __stream, __WCHAR_TYPE__ const *__restrict __format, __builtin_va_list __args) {
#if defined(__LIBCCALL_IS_FORMATPRINTER_CC) && __SIZEOF_FORMAT_WORD_T__ == __SIZEOF_WINT_T__
