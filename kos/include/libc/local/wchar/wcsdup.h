...
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(wcsdup) __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_IN(1) __WCHAR_TYPE__ *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(wcsdup))(__WCHAR_TYPE__ const *__restrict __string) {
	...
	if __likely(__result)
		__result = (__WCHAR_TYPE__ *)(__NAMESPACE_LOCAL_SYM __localdep_memcpy)(__result, __string, __resultsize);
	return __result;
}
__NAMESPACE_LOCAL_END
