...
__LOCAL_LIBC(wcsncpy) __ATTR_RETNONNULL __ATTR_INS(2, 3) __ATTR_OUTS(1, 3) __WCHAR_TYPE__ *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(wcsncpy))(__WCHAR_TYPE__ *__restrict __buf, __WCHAR_TYPE__ const *__restrict __src, __SIZE_TYPE__ __buflen) {
	__WCHAR_TYPE__ *__ptr;
	__SIZE_TYPE__ __srclen = (__NAMESPACE_LOCAL_SYM __localdep_wcsnlen)(__src, __buflen);
	__ptr = (__NAMESPACE_LOCAL_SYM __localdep_wmempcpy)(__buf, __src, __srclen);
	(void)(__NAMESPACE_LOCAL_SYM __localdep_wmemset)(__ptr, (__WCHAR_TYPE__)'\0', __buflen - __srclen);
	return __buf;
}
__NAMESPACE_LOCAL_END
