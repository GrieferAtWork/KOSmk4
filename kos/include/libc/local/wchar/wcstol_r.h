...
#define __local_wcstol_r_defined 1
#include <__crt.h>
#include <features.h>
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(wcstol_r))(__WCHAR_TYPE__ const *__restrict __nptr, __WCHAR_TYPE__ **__endptr, __STDC_INT_AS_UINT_T __base, __errno_t *__error) {
	...
	return (long)__localdep_wcsto64_r(__nptr, __endptr, __base, __error);
#elif __SIZEOF_LONG__ >= 4
	return (long)__localdep_wcsto32_r(__nptr, __endptr, __base, __error);
#else /* ... */
...
#define __local___localdep_wcstol_r_defined 1
