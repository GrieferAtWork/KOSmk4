...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_wcsoff_defined
#define __local___localdep_wcsoff_defined
#define __localdep_wcsoff __LIBC_LOCAL_NAME(wcsoff)
#endif /* !__local___localdep_wcsoff_defined */
