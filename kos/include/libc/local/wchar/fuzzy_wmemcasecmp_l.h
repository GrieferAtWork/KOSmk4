...
#define __local_fuzzy_wmemcasecmp_l_defined
#include <__crt.h>
...
__LOCAL_LIBC(fuzzy_wmemcasecmp_l) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_ROS(1, 2) __ATTR_ACCESS_ROS(3, 4) __ATTR_NONNULL((1, 3)) __SIZE_TYPE__
...
#else /* !__NO_MALLOCA */
#undef __local_fuzzy_wmemcasecmp_l_defined
#endif /* __NO_MALLOCA */
