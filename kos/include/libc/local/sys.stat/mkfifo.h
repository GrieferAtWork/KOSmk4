 ...
 */
#ifndef __local_mkfifo_defined
#define __local_mkfifo_defined
#include <__crt.h>
...
__LOCAL_LIBC(mkfifo) __ATTR_NONNULL((1)) int
...
#else /* (__CRT_HAVE_mknod || ((__CRT_HAVE_mknodat || __CRT_HAVE_fmknodat) && __AT_FDCWD)) && __S_IFIFO */
#undef __local_mkfifo_defined
#endif /* (!__CRT_HAVE_mknod && ((!__CRT_HAVE_mknodat && !__CRT_HAVE_fmknodat) || !__AT_FDCWD)) || !__S_IFIFO */
#endif /* !__local_mkfifo_defined */
