 ...
 */
#ifndef __local_fstat_defined
#define __local_fstat_defined
#include <__crt.h>
#include <features.h>
...
#include <bits/types.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(fstat) __ATTR_FDARG(1) __ATTR_OUT(2) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(fstat))(__fd_t __fd, struct stat *__restrict __buf) {


	struct stat64 __st;
	int __result = (__NAMESPACE_LOCAL_SYM __localdep_fstat64)(__fd, &__st);
...
#else /* (__CRT_HAVE_kfstat && __CRT_KOS_PRIMARY) || (__CRT_HAVE_kfstat64 && __CRT_KOS_PRIMARY) || __CRT_HAVE_fstat || __CRT_HAVE_fstat64 || __CRT_HAVE___fstat64_time64 || __CRT_HAVE__fstat || __CRT_HAVE__fstat32 || __CRT_HAVE__fstati64 || __CRT_HAVE__fstat32i64 || __CRT_HAVE__fstat64 || __CRT_HAVE__fstat64i32 */
#undef __local_fstat_defined
