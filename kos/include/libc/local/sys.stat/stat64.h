 ...
 */
#ifndef __local_stat64_defined
#define __local_stat64_defined
#include <__crt.h>
#include <features.h>
...
#include <bits/types.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(stat64) __ATTR_IN(1) __ATTR_OUT(2) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(stat64))(char const *__restrict __filename, struct __stat64 *__restrict __buf) {
	...
	return (__NAMESPACE_LOCAL_SYM __localdep_fstatat64)(__AT_FDCWD, __filename, __buf, 0);
#elif defined(__CRT_HAVE_stat) || defined(__CRT_HAVE_stat64) || defined(__CRT_HAVE___stat64_time64)
#ifdef __CRT_HAVE___stat64_time64
	struct __glc_stat64_time64 __st;
	int __result = (__NAMESPACE_LOCAL_SYM __localdep_glibc_stat64_time64)(__filename, &__st);
#elif defined(__CRT_HAVE_stat64)
	struct __glc_stat64 __st;
	int __result = (__NAMESPACE_LOCAL_SYM __localdep_glibc_stat64)(__filename, &__st);
#else /* ... */
...
#if defined(__CRT_HAVE__stat64) || defined(__CRT_HAVE__stat64i32)
	struct __dos_stat64i32 __st;
	int __result = (__NAMESPACE_LOCAL_SYM __localdep_dos_stat64i32)(__filename, &__st);
#elif defined(__CRT_HAVE__stati64) || defined(__CRT_HAVE__stat32i64)
	struct __dos_stat32i64 __st;
	int __result = (__NAMESPACE_LOCAL_SYM __localdep_dos_stat32i64)(__filename, &__st);
#else /* ... */
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_stat64_defined
#define __local___localdep_stat64_defined
#define __localdep_stat64 __LIBC_LOCAL_NAME(stat64)
#endif /* !__local___localdep_stat64_defined */
...
#undef __local_stat64_defined
#endif /* (!__AT_FDCWD || ((!__CRT_HAVE_kfstatat || !__CRT_KOS_PRIMARY) && (!__CRT_HAVE_kfstatat64 || !__CRT_KOS_PRIMARY) && !__CRT_HAVE_fstatat && !__CRT_HAVE_fstatat64 && !__CRT_HAVE___fstatat64_time64)) && !__CRT_HAVE_stat && !__CRT_HAVE_stat64 && !__CRT_HAVE___stat64_time64 && !__CRT_HAVE__stat && !__CRT_HAVE__stat32 && !__CRT_HAVE__stati64 && !__CRT_HAVE__stat32i64 && !__CRT_HAVE__stat64 && !__CRT_HAVE__stat64i32 */
#endif /* !__local_stat64_defined */
