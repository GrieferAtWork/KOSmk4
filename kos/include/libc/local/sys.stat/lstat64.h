 ...
 */
#ifndef __local_lstat64_defined
#define __local_lstat64_defined
#include <__crt.h>
...
#include <bits/types.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(lstat64) __ATTR_IN(1) __ATTR_OUT(2) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(lstat64))(char const *__restrict __filename, struct __stat64 *__restrict __buf) {
	...
	return (__NAMESPACE_LOCAL_SYM __localdep_fstatat64)(__AT_FDCWD, __filename, __buf, __AT_SYMLINK_NOFOLLOW);
	...
	struct stat64 __st;
	int __result = (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(lstat64))(__filename, &__st);
