...
__CREDIRECT(__ATTR_FDREAD(2) __ATTR_FDWRITE(1) __ATTR_INOUT_OPT(3),__SSIZE_TYPE__,__NOTHROW_NCX,__localdep_sendfile32,(__fd_t __out_fd, __fd_t __in_fd, __off32_t *__offset, __SIZE_TYPE__ __count),sendfile,(__out_fd,__in_fd,__offset,__count))
...
__CREDIRECT(__ATTR_FDREAD(2) __ATTR_FDWRITE(1) __ATTR_INOUT_OPT(3),__SSIZE_TYPE__,__NOTHROW_NCX,__localdep_sendfile64,(__fd_t __out_fd, __fd_t __in_fd, __off64_t *__offset, __SIZE_TYPE__ __count),sendfile,(__out_fd,__in_fd,__offset,__count))
#elif defined(__CRT_HAVE_sendfile64)
__CREDIRECT(__ATTR_FDREAD(2) __ATTR_FDWRITE(1) __ATTR_INOUT_OPT(3),__SSIZE_TYPE__,__NOTHROW_NCX,__localdep_sendfile64,(__fd_t __out_fd, __fd_t __in_fd, __off64_t *__offset, __SIZE_TYPE__ __count),sendfile64,(__out_fd,__in_fd,__offset,__count))
...
__LOCAL_LIBC(sendfile) __ATTR_FDREAD(2) __ATTR_FDWRITE(1) __ATTR_INOUT_OPT(3) __SSIZE_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(sendfile))(__fd_t __out_fd, __fd_t __in_fd, __off_t *__offset, __SIZE_TYPE__ __count) {
