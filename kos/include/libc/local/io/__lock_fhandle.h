...
#define __local___lock_fhandle_defined
#include <__crt.h>
#include <bits/types.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(__lock_fhandle) __ATTR_FDARG(1) int
...
#define __local___localdep___lock_fhandle_defined
