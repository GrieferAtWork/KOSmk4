...
__LOCAL_LIBC(sopen) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __fd_t
__NOTHROW_RPC(__VLIBCCALL __LIBC_LOCAL_NAME(sopen))(char const *__filename, __oflag_t __oflags, int __sflags, ...) {
	...
	(void)__sflags;
	__result = (__NAMESPACE_LOCAL_SYM __localdep_open)(__filename, __oflags, __builtin_va_arg(__args, __mode_t));
