...
__CREDIRECT(__ATTR_OUT_OPT(1),__TM_TYPE(time),__NOTHROW_NCX,__localdep_time,(__TM_TYPE(time) *__timer),time,(__timer))
#elif defined(__CRT_HAVE___time) && (!defined(__USE_TIME_BITS64) || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)
__CREDIRECT(__ATTR_OUT_OPT(1),__TM_TYPE(time),__NOTHROW_NCX,__localdep_time,(__TM_TYPE(time) *__timer),__time,(__timer))
#elif defined(__CRT_HAVE___libc_time) && (!defined(__USE_TIME_BITS64) || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)
__CREDIRECT(__ATTR_OUT_OPT(1),__TM_TYPE(time),__NOTHROW_NCX,__localdep_time,(__TM_TYPE(time) *__timer),__libc_time,(__timer))
#elif defined(__CRT_HAVE__time32) && (!defined(__USE_TIME_BITS64) || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)
__CREDIRECT(__ATTR_OUT_OPT(1),__TM_TYPE(time),__NOTHROW_NCX,__localdep_time,(__TM_TYPE(time) *__timer),_time32,(__timer))
#elif defined(__CRT_HAVE_time64) && (defined(__USE_TIME_BITS64) || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)
__CREDIRECT(__ATTR_OUT_OPT(1),__TM_TYPE(time),__NOTHROW_NCX,__localdep_time,(__TM_TYPE(time) *__timer),time64,(__timer))
#elif defined(__CRT_HAVE__time64) && (defined(__USE_TIME_BITS64) || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)
__CREDIRECT(__ATTR_OUT_OPT(1),__TM_TYPE(time),__NOTHROW_NCX,__localdep_time,(__TM_TYPE(time) *__timer),_time64,(__timer))
#else /* ... */
