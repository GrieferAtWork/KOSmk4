...
__CREDIRECT(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR(2),__errno_t,__NOTHROW_NCX,__localdep_crt_localtime32_r,(__time32_t const *__restrict __timer, struct __NAMESPACE_STD_SYM tm *__restrict __tp),localtime_r,(__timer,__tp))
...
__CREDIRECT(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_WR(1),__errno_t,__NOTHROW_NCX,__localdep_crt_localtime32_s,(struct __NAMESPACE_STD_SYM tm *__restrict __tp, __time32_t const *__restrict __timer),_localtime32_s,(__tp,__timer))
...
__LOCAL_LIBC(localtime_r) __ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR(2) struct __NAMESPACE_STD_SYM tm *
