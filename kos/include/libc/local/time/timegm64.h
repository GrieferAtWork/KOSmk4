...
#include <features.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RW(1),__time32_t,__NOTHROW_NCX,__localdep_crt_timegm32,(struct __NAMESPACE_STD_SYM tm *__tp),timegm,(__tp))
#elif defined(__CRT_HAVE__mkgmtime)
__NAMESPACE_LOCAL_END
#include <features.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RW(1),__time32_t,__NOTHROW_NCX,__localdep_crt_timegm32,(struct __NAMESPACE_STD_SYM tm *__tp),_mkgmtime,(__tp))
#elif defined(__CRT_HAVE__mkgmtime32)
__NAMESPACE_LOCAL_END
#include <features.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RW(1),__time32_t,__NOTHROW_NCX,__localdep_crt_timegm32,(struct __NAMESPACE_STD_SYM tm *__tp),_mkgmtime32,(__tp))
#else /* ... */
...
#endif /* !__yearstodays */
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(timegm64) __ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RW(1) __time64_t
