...
__CREDIRECT(__ATTR_IN(3) __ATTR_OUT(1) __ATTR_OUT(2),__errno_t,__NOTHROW_NCX,__localdep__dupenv_s,(char **__restrict __pbuf, __SIZE_TYPE__ *__pbuflen, char const *__varname),_dupenv_s,(__pbuf,__pbuflen,__varname))
...
__LOCAL_LIBC(_dupenv_s_dbg) _Check_return_wat_ __ATTR_IN(3) __ATTR_OUT(1) __ATTR_OUT(2) __errno_t
