 ...
 */
#ifndef __local_getttynam_defined
#define __local_getttynam_defined
#include <__crt.h>
#if defined(__CRT_HAVE_setttyent) && defined(__CRT_HAVE_getttyent)
...
__LOCAL_LIBC(getttynam) __ATTR_IN(1) struct ttyent *
__NOTHROW_RPC_KOS(__LIBCCALL __LIBC_LOCAL_NAME(getttynam))(char const *__tty) {
	struct ttyent *__result;
	if (!(__NAMESPACE_LOCAL_SYM __localdep_setttyent)())
		return __NULLPTR;
	while ((__result = (__NAMESPACE_LOCAL_SYM __localdep_getttyent)()) != __NULLPTR) {
		if ((__NAMESPACE_LOCAL_SYM __localdep_strcmp)(__result->ty_name, __tty) == 0)
			break;
	}
	return __result;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_getttynam_defined
#define __local___localdep_getttynam_defined
#define __localdep_getttynam __LIBC_LOCAL_NAME(getttynam)
#endif /* !__local___localdep_getttynam_defined */
#else /* __CRT_HAVE_setttyent && __CRT_HAVE_getttyent */
#undef __local_getttynam_defined
#endif /* !__CRT_HAVE_setttyent || !__CRT_HAVE_getttyent */
#endif /* !__local_getttynam_defined */
