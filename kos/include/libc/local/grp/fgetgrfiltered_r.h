...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(fgetgrfiltered_r) __ATTR_ACCESS_RO_OPT(7) __ATTR_ACCESS_RW(1) __ATTR_ACCESS_WR(2) __ATTR_ACCESS_WR(5) __ATTR_ACCESS_WRS(3, 4) __errno_t
