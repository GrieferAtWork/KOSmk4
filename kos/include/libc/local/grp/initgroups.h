...
#include <features.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1, 3, 4)),__STDC_INT_AS_SSIZE_T,__NOTHROW_RPC,__localdep_getgrouplist,(char const *__user, __gid_t __group, __gid_t *__groups, __STDC_INT_AS_SIZE_T *__ngroups),getgrouplist,(__user,__group,__groups,__ngroups))
...
__CREDIRECT(,int,__NOTHROW_RPC,__localdep_setgroups,(__SIZE_TYPE__ __count, __gid_t const *__groups),setgroups,(__count,__groups))
#elif defined(__CRT_HAVE___setgroups)
__CREDIRECT(,int,__NOTHROW_RPC,__localdep_setgroups,(__SIZE_TYPE__ __count, __gid_t const *__groups),__setgroups,(__count,__groups))
#elif defined(__CRT_HAVE___libc_setgroups)
__CREDIRECT(,int,__NOTHROW_RPC,__localdep_setgroups,(__SIZE_TYPE__ __count, __gid_t const *__groups),__libc_setgroups,(__count,__groups))
#else /* ... */
#undef __local___localdep_setgroups_defined
#endif /* !... */
#endif /* !__local___localdep_setgroups_defined */
__LOCAL_LIBC(initgroups) __ATTR_NONNULL((1)) int
