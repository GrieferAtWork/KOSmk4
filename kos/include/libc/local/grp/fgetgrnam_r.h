...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(fgetgrnam_r) __ATTR_IN(2) __ATTR_INOUT(1) __ATTR_OUT(3) __ATTR_OUT(6) __ATTR_OUTS(4, 5) __errno_t
__NOTHROW_CB_NCX(__LIBCCALL __LIBC_LOCAL_NAME(fgetgrnam_r))(__FILE *__restrict __stream, char const *__restrict __name, struct group *__restrict __resultbuf, char *__restrict __buffer, __SIZE_TYPE__ __buflen, struct group **__restrict __result) {
	__errno_t __error;
