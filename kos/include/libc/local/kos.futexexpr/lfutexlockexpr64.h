...
#define __local_lfutexlockexpr64_defined
#include <__crt.h>
...
#define __local___localdep_lfutexlockexpr32_defined
...
#define __local___localdep_lfutexlockexpr64_defined
