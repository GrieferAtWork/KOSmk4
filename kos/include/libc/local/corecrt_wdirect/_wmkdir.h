...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,__localdep_wmkdir,(__WCHAR_TYPE__ const *__pathname, __mode_t __mode),wmkdir,(__pathname,__mode))
