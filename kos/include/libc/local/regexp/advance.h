 ...
 */
#ifndef __local_advance_defined
#define __local_advance_defined
#include <__crt.h>
...
__LOCAL_LIBC(advance) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(advance))(char const *__string, char const *__expbuf) {
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_advance_defined
#define __local___localdep_advance_defined
#define __localdep_advance __LIBC_LOCAL_NAME(advance)
#endif /* !__local___localdep_advance_defined */
#else /* __LOCAL_loc2 && __REG_NOTEOL && __CRT_HAVE_regexec */
#undef __local_advance_defined
#endif /* !__LOCAL_loc2 || !__REG_NOTEOL || !__CRT_HAVE_regexec */
#endif /* !__local_advance_defined */
