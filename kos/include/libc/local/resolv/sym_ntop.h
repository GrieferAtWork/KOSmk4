...
__CREDIRECT(__ATTR_RETNONNULL __ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR_OPT(3),char const *,__NOTHROW_NCX,__localdep_sym_ntos,(struct res_sym const *__symbols, int __wanted_number, int *__p_success),sym_ntos,(__symbols,__wanted_number,__p_success))
#elif defined(__CRT_HAVE___sym_ntos)
__CREDIRECT(__ATTR_RETNONNULL __ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR_OPT(3),char const *,__NOTHROW_NCX,__localdep_sym_ntos,(struct res_sym const *__symbols, int __wanted_number, int *__p_success),__sym_ntos,(__symbols,__wanted_number,__p_success))
#else /* ... */
...
__LOCAL_LIBC(sym_ntop) __ATTR_RETNONNULL __ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR_OPT(3) char const *
