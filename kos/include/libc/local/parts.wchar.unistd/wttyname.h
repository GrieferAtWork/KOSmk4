...
__CREDIRECT(__ATTR_OUTS(2, 3),int,__NOTHROW_RPC,__localdep_wttyname_r,(__fd_t __fd, __WCHAR_TYPE__ *__buf, __SIZE_TYPE__ __buflen),wttyname_r,(__fd,__buf,__buflen))
