...
__err:
	...
	static __WCHAR_TYPE__ __ttyname_buf[32];
	if __likely((__NAMESPACE_LOCAL_SYM __localdep_wttyname_r)(__fd, __ttyname_buf, __COMPILER_LENOF(__ttyname_buf)) == 0)
