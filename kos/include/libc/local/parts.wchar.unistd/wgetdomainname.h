 ...
 */
#ifndef __local_wgetdomainname_defined
#define __local_wgetdomainname_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(wgetdomainname) __ATTR_OUTS(1, 2) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(wgetdomainname))(__WCHAR_TYPE__ *__name, __SIZE_TYPE__ __buflen) {
	...
	if __likely(__result == 0) {
		...
		__width = (__NAMESPACE_LOCAL_SYM __localdep_format_8tow)(&__convert_data, __uts.__PRIVATE_UTSNAME_DOMAINNAME, __len);
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_wgetdomainname_defined
#define __local___localdep_wgetdomainname_defined
#define __localdep_wgetdomainname __LIBC_LOCAL_NAME(wgetdomainname)
#endif /* !__local___localdep_wgetdomainname_defined */
#else /* __CRT_HAVE_uname || __CRT_HAVE___uname || __CRT_HAVE___libc_uname */
#undef __local_wgetdomainname_defined
#endif /* !__CRT_HAVE_uname && !__CRT_HAVE___uname && !__CRT_HAVE___libc_uname */
#endif /* !__local_wgetdomainname_defined */
