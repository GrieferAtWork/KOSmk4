...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_ACCESS_WRS(2, 3),__errno_t,__NOTHROW_NCX,__localdep__ultow_s,(unsigned long __val, __WCHAR_TYPE__ *__buf, __SIZE_TYPE__ __buflen, int __radix),_ultow_s,(__val,__buf,__buflen,__radix))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_ultow) __ATTR_ACCESS_WR(2) __WCHAR_TYPE__ *
