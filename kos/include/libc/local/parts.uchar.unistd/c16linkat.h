 ...
 */
#ifndef __local_c16linkat_defined
#define __local_c16linkat_defined
#include <__crt.h>
...
__LOCAL_LIBC(c16linkat) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(4) int
__NOTHROW_RPC(__LIBDCALL __LIBC_LOCAL_NAME(c16linkat))(__fd_t __fromfd, __CHAR16_TYPE__ const *__from, __fd_t __tofd, __CHAR16_TYPE__ const *__to, __atflag_t __flags) {
	int __result = -1;
...
#undef __local_c16linkat_defined
...
#endif /* !__local_c16linkat_defined */
