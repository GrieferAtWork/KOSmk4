...
__LOCAL_LIBC(c16unlinkat) __ATTR_ACCESS_RO(2) int
__NOTHROW_RPC(__LIBDCALL __LIBC_LOCAL_NAME(c16unlinkat))(__fd_t __dfd, __CHAR16_TYPE__ const *__file, __atflag_t __flags) {
	int __result;
	char *__utf8_file;
...
#else /* __CRT_HAVE_unlinkat && ((__CRT_HAVE_convert_wcstombs && __SIZEOF_WCHAR_T__ == 2 && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_DOS$convert_wcstombs || (__CRT_HAVE_convert_wcstombsn && __SIZEOF_WCHAR_T__ == 2) || __CRT_HAVE_DOS$convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc) */
#undef __local_c16unlinkat_defined
...
#endif /* !__local_c16unlinkat_defined */
