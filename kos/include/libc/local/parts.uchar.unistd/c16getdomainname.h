 ...
 */
#ifndef __local_c16getdomainname_defined
#define __local_c16getdomainname_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__COMPILER_CREDIRECT(__LIBC,__ATTR_ACCESS_ROS(2, 3) __ATTR_NONNULL((1)),__SSIZE_TYPE__,__NOTHROW_NCX,__C16FORMATPRINTER_CC,__localdep_format_c16snprintf_printer,(void *__arg, __CHAR16_TYPE__ const *__restrict __data, __SIZE_TYPE__ __datalen),format_wsnprintf_printer,(__arg,__data,__datalen))
#elif defined(__CRT_HAVE_DOS$format_wsnprintf_printer)
__NAMESPACE_LOCAL_END
#include <bits/crt/uformat-printer.h>
__NAMESPACE_LOCAL_BEGIN
__COMPILER_CREDIRECT(__LIBC,__ATTR_ACCESS_ROS(2, 3) __ATTR_NONNULL((1)),__SSIZE_TYPE__,__NOTHROW_NCX,__C16FORMATPRINTER_CC,__localdep_format_c16snprintf_printer,(void *__arg, __CHAR16_TYPE__ const *__restrict __data, __SIZE_TYPE__ __datalen),DOS$format_wsnprintf_printer,(__arg,__data,__datalen))
#elif __SIZEOF_WCHAR_T__ == 2
__NAMESPACE_LOCAL_END
#include <bits/crt/uformat-printer.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(c16getdomainname) __ATTR_ACCESS_WRS(1, 2) int
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16getdomainname))(__CHAR16_TYPE__ *__name, __SIZE_TYPE__ __buflen) {
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c16getdomainname_defined
#define __local___localdep_c16getdomainname_defined
#define __localdep_c16getdomainname __LIBC_LOCAL_NAME(c16getdomainname)
#endif /* !__local___localdep_c16getdomainname_defined */
#else /* __CRT_HAVE_uname || __CRT_HAVE___uname || __CRT_HAVE___libc_uname */
#undef __local_c16getdomainname_defined
#endif /* !__CRT_HAVE_uname && !__CRT_HAVE___uname && !__CRT_HAVE___libc_uname */
#endif /* !__local_c16getdomainname_defined */
