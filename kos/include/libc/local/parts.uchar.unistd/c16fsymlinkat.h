...
__LOCAL_LIBC(c16fsymlinkat) __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(3) int
__NOTHROW_RPC(__LIBDCALL __LIBC_LOCAL_NAME(c16fsymlinkat))(__CHAR16_TYPE__ const *__link_text, __fd_t __tofd, __CHAR16_TYPE__ const *__target_path, __atflag_t __flags) {
	int __result = -1;
...
#else /* __CRT_HAVE_fsymlinkat && ((__CRT_HAVE_convert_wcstombs && __SIZEOF_WCHAR_T__ == 2 && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_DOS$convert_wcstombs || (__CRT_HAVE_convert_wcstombsn && __SIZEOF_WCHAR_T__ == 2) || __CRT_HAVE_DOS$convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc) */
#undef __local_c16fsymlinkat_defined
#endif /* !__CRT_HAVE_fsymlinkat || ((!__CRT_HAVE_convert_wcstombs || __SIZEOF_WCHAR_T__ != 2 || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$convert_wcstombs && (!__CRT_HAVE_convert_wcstombsn || __SIZEOF_WCHAR_T__ != 2) && !__CRT_HAVE_DOS$convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) */
#endif /* !__local_c16fsymlinkat_defined */
