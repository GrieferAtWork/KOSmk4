...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(4),int,__NOTHROW_RPC,__localdep_c16linkat,(__fd_t __fromfd, __CHAR16_TYPE__ const *__from, __fd_t __tofd, __CHAR16_TYPE__ const *__to, __atflag_t __flags),wlinkat,(__fromfd,__from,__tofd,__to,__flags))
#elif defined(__CRT_HAVE_DOS$wlinkat)
__NAMESPACE_LOCAL_END
#include <bits/types.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT_DOS(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(4),int,__NOTHROW_RPC,__localdep_c16linkat,(__fd_t __fromfd, __CHAR16_TYPE__ const *__from, __fd_t __tofd, __CHAR16_TYPE__ const *__to, __atflag_t __flags),wlinkat,(__fromfd,__from,__tofd,__to,__flags))
...
__LOCAL_LIBC(c16link) __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2) int
