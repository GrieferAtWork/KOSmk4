 ...
 */
#ifndef __local_c32freadlinkat_defined
#define __local_c32freadlinkat_defined
#include <__crt.h>
...
__LOCAL_LIBC(c32freadlinkat) __ATTR_IN(2) __ATTR_OUTS(3, 4) __SSIZE_TYPE__
__NOTHROW_RPC(__LIBKCALL __LIBC_LOCAL_NAME(c32freadlinkat))(__fd_t __dfd, __CHAR32_TYPE__ const *__path, __CHAR32_TYPE__ *__buf, __SIZE_TYPE__ __buflen, __atflag_t __flags) {
	char *__utf8_path;
...
#undef __local_c32freadlinkat_defined
#endif /* (!__CRT_HAVE_malloc && !__CRT_HAVE___libc_malloc && !__CRT_HAVE_calloc && !__CRT_HAVE___libc_calloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc && !__CRT_HAVE_memalign && !__CRT_HAVE_aligned_alloc && !__CRT_HAVE___libc_memalign && !__CRT_HAVE_posix_memalign) || !__CRT_HAVE_freadlinkat || ((!__CRT_HAVE_convert_wcstombs || __SIZEOF_WCHAR_T__ != 4 || !__LIBCCALL_IS_LIBKCALL) && !__CRT_HAVE_KOS$convert_wcstombs && (!__CRT_HAVE_convert_wcstombsn || __SIZEOF_WCHAR_T__ != 4) && !__CRT_HAVE_KOS$convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) */
#endif /* !__local_c32freadlinkat_defined */
