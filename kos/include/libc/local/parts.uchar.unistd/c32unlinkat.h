 ...
 */
#ifndef __local_c32unlinkat_defined
#define __local_c32unlinkat_defined
#include <__crt.h>
...
__LOCAL_LIBC(c32unlinkat) __ATTR_ACCESS_RO(2) int
__NOTHROW_RPC(__LIBKCALL __LIBC_LOCAL_NAME(c32unlinkat))(__fd_t __dfd, __CHAR32_TYPE__ const *__file, __atflag_t __flags) {
	int __result;
	char *__utf8_file;
...
#endif /* !__local_c32unlinkat_defined */
