 ...
 */
#ifndef __local_c16setlogin_defined
#define __local_c16setlogin_defined
#include <__crt.h>
...
__CREDIRECT(__ATTR_IN(1),int,__NOTHROW_NCX,__localdep_setlogin,(char const *__name),setlogin,(__name))
#endif /* !__local___localdep_setlogin_defined */
__LOCAL_LIBC(c16setlogin) __ATTR_IN(1) int
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(c16setlogin))(__CHAR16_TYPE__ const *__name) {
	int __result;
	char *__utf8_name;
	__utf8_name = (__NAMESPACE_LOCAL_SYM __localdep_convert_c16tombs)(__name);
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c16setlogin_defined
#define __local___localdep_c16setlogin_defined
#define __localdep_c16setlogin __LIBC_LOCAL_NAME(c16setlogin)
#endif /* !__local___localdep_c16setlogin_defined */
#else /* __CRT_HAVE_setlogin && ((__CRT_HAVE_convert_wcstombs && __SIZEOF_WCHAR_T__ == 2 && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_DOS$convert_wcstombs || (__CRT_HAVE_convert_wcstombsn && __SIZEOF_WCHAR_T__ == 2) || __CRT_HAVE_DOS$convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc) */
#undef __local_c16setlogin_defined
#endif /* !__CRT_HAVE_setlogin || ((!__CRT_HAVE_convert_wcstombs || __SIZEOF_WCHAR_T__ != 2 || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$convert_wcstombs && (!__CRT_HAVE_convert_wcstombsn || __SIZEOF_WCHAR_T__ != 2) && !__CRT_HAVE_DOS$convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) */
#endif /* !__local_c16setlogin_defined */
