 ...
 */
#ifndef __local_c32setlogin_defined
#define __local_c32setlogin_defined
#include <__crt.h>
...
__LOCAL_LIBC(c32setlogin) __ATTR_IN(1) int
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32setlogin))(__CHAR32_TYPE__ const *__name) {
	int __result;
	char *__utf8_name;
	__utf8_name = (__NAMESPACE_LOCAL_SYM __localdep_convert_c32tombs)(__name);
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c32setlogin_defined
#define __local___localdep_c32setlogin_defined
#define __localdep_c32setlogin __LIBC_LOCAL_NAME(c32setlogin)
#endif /* !__local___localdep_c32setlogin_defined */
#else /* __CRT_HAVE_setlogin && ((__CRT_HAVE_convert_wcstombs && __SIZEOF_WCHAR_T__ == 4 && __LIBCCALL_IS_LIBKCALL) || __CRT_HAVE_KOS$convert_wcstombs || (__CRT_HAVE_convert_wcstombsn && __SIZEOF_WCHAR_T__ == 4) || __CRT_HAVE_KOS$convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc) */
#undef __local_c32setlogin_defined
#endif /* !__CRT_HAVE_setlogin || ((!__CRT_HAVE_convert_wcstombs || __SIZEOF_WCHAR_T__ != 4 || !__LIBCCALL_IS_LIBKCALL) && !__CRT_HAVE_KOS$convert_wcstombs && (!__CRT_HAVE_convert_wcstombsn || __SIZEOF_WCHAR_T__ != 4) && !__CRT_HAVE_KOS$convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) */
#endif /* !__local_c32setlogin_defined */
