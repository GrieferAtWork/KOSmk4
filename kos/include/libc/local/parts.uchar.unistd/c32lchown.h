...
__CREDIRECT(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,__localdep_lchown,(char const *__file, __uid_t __owner, __gid_t __group),lchown,(__file,__owner,__group))
