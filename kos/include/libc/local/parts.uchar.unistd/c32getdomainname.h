...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(c32getdomainname) __ATTR_OUTS(1, 2) int
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32getdomainname))(__CHAR32_TYPE__ *__name, __SIZE_TYPE__ __buflen) {
	...
	if __likely(__result == 0) {
		...
		__width = (__NAMESPACE_LOCAL_SYM __localdep_format_8to32)(&__convert_data, __uts.__PRIVATE_UTSNAME_DOMAINNAME, __len);
