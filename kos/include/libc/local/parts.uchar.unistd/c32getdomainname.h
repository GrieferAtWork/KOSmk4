 ...
 */
#ifndef __local_c32getdomainname_defined
#define __local_c32getdomainname_defined
#include <__crt.h>
...
__CREDIRECT(__ATTR_NONNULL((1, 2)),__SSIZE_TYPE__,__NOTHROW_NCX,__localdep_format_c32snprintf_printer,(void *__arg, __CHAR32_TYPE__ const *__restrict __data, __SIZE_TYPE__ __datalen),format_wsnprintf_printer,(__arg,__data,__datalen))
#elif defined(__CRT_HAVE_KOS$format_wsnprintf_printer)
__CREDIRECT_KOS(__ATTR_NONNULL((1, 2)),__SSIZE_TYPE__,__NOTHROW_NCX,__localdep_format_c32snprintf_printer,(void *__arg, __CHAR32_TYPE__ const *__restrict __data, __SIZE_TYPE__ __datalen),format_wsnprintf_printer,(__arg,__data,__datalen))
#elif __SIZEOF_WCHAR_T__ == 4
__NAMESPACE_LOCAL_END
#include <libc/local/parts.wchar.format-printer/format_wsnprintf_printer.h>
__NAMESPACE_LOCAL_BEGIN
#define __localdep_format_c32snprintf_printer __NAMESPACE_LOCAL_TYPEHAX(__SSIZE_TYPE__(__LIBKCALL*)(void *,__CHAR32_TYPE__ const *__restrict,__SIZE_TYPE__),__SSIZE_TYPE__(__LIBKCALL&)(void *,__CHAR32_TYPE__ const *__restrict,__SIZE_TYPE__),format_wsnprintf_printer)
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(c32getdomainname) __ATTR_NONNULL((1)) int
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(c32getdomainname))(__CHAR32_TYPE__ *__name, __SIZE_TYPE__ __buflen) {
	...
	if __likely(__result == 0) {
		...
		__convert_data.__fd_printer = &(__NAMESPACE_LOCAL_SYM __localdep_format_c32snprintf_printer);
		__mbstate_init(&__convert_data.__fd_incomplete);
		__width = (__NAMESPACE_LOCAL_SYM __localdep_format_8to32)(&__convert_data, __uts.domainname, __len);
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c32getdomainname_defined
#define __local___localdep_c32getdomainname_defined
#define __localdep_c32getdomainname __LIBC_LOCAL_NAME(c32getdomainname)
#endif /* !__local___localdep_c32getdomainname_defined */
#else /* __CRT_HAVE_uname || __CRT_HAVE___uname || __CRT_HAVE___libc_uname */
#undef __local_c32getdomainname_defined
#endif /* !__CRT_HAVE_uname && !__CRT_HAVE___uname && !__CRT_HAVE___libc_uname */
#endif /* !__local_c32getdomainname_defined */
