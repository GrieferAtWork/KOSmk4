 ...
 */
#ifndef __local_c16ttyname_r_defined
#define __local_c16ttyname_r_defined
#include <__crt.h>
#include <paths.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(c16ttyname_r) __ATTR_FDARG(1) __ATTR_OUTS(2, 3) __errno_t
__NOTHROW_RPC(__LIBDCALL __LIBC_LOCAL_NAME(c16ttyname_r))(__fd_t __fd, __CHAR16_TYPE__ *__buf, __SIZE_TYPE__ __buflen) {
	__errno_t __result;
	...
	if (__result == 0) {
		...
		if (__reqlen > __buflen) {
			...
			__buf = (__CHAR16_TYPE__ *)(__NAMESPACE_LOCAL_SYM __localdep_unicode_8to16_n)((__CHAR16_TYPE__ *)__buf, __buflen, __utf8_buf, __reqlen);
...
#undef __local_c16ttyname_r_defined
...
#endif /* !__local_c16ttyname_r_defined */
