 ...
 */
#ifndef __local_c32chroot_defined
#define __local_c32chroot_defined
#include <__crt.h>
...
__LOCAL_LIBC(c32chroot) __ATTR_NONNULL((1)) int
...
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_c32chroot_defined
#define __local___localdep_c32chroot_defined
#define __localdep_c32chroot __LIBC_LOCAL_NAME(c32chroot)
#endif /* !__local___localdep_c32chroot_defined */
#else /* (__CRT_HAVE_chroot || __CRT_HAVE___chroot || __CRT_HAVE___libc_chroot) && ((__CRT_HAVE_convert_wcstombs && __SIZEOF_WCHAR_T__ == 4 && __LIBCCALL_IS_LIBKCALL) || __CRT_HAVE_KOS$convert_wcstombs || (__CRT_HAVE_convert_wcstombsn && __SIZEOF_WCHAR_T__ == 4) || __CRT_HAVE_KOS$convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc) */
#undef __local_c32chroot_defined
#endif /* (!__CRT_HAVE_chroot && !__CRT_HAVE___chroot && !__CRT_HAVE___libc_chroot) || ((!__CRT_HAVE_convert_wcstombs || __SIZEOF_WCHAR_T__ != 4 || !__LIBCCALL_IS_LIBKCALL) && !__CRT_HAVE_KOS$convert_wcstombs && (!__CRT_HAVE_convert_wcstombsn || __SIZEOF_WCHAR_T__ != 4) && !__CRT_HAVE_KOS$convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) */
#endif /* !__local_c32chroot_defined */
