...
__err:
	...
	static __CHAR32_TYPE__ __ttyname_buf[32];
	if __likely((__NAMESPACE_LOCAL_SYM __localdep_c32ttyname_r)(__fd, __ttyname_buf, __COMPILER_LENOF(__ttyname_buf)) == 0)
