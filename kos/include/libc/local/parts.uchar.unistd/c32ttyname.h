...
__CREDIRECT(__ATTR_ACCESS_WRS(2, 3),int,__NOTHROW_RPC,__localdep_c32ttyname_r,(__fd_t __fd, __CHAR32_TYPE__ *__buf, __SIZE_TYPE__ __buflen),wttyname_r,(__fd,__buf,__buflen))
#elif defined(__CRT_HAVE_KOS$wttyname_r)
__CREDIRECT_KOS(__ATTR_ACCESS_WRS(2, 3),int,__NOTHROW_RPC,__localdep_c32ttyname_r,(__fd_t __fd, __CHAR32_TYPE__ *__buf, __SIZE_TYPE__ __buflen),wttyname_r,(__fd,__buf,__buflen))
#else /* ... */
...
__NOTHROW_RPC(__LIBKCALL __LIBC_LOCAL_NAME(c32ttyname))(__fd_t __fd) {
	...
	if __likely((__NAMESPACE_LOCAL_SYM __localdep_c32ttyname_r)(__fd, __buf, __COMPILER_LENOF(__buf)) == 0)
		return __buf;
	return __NULLPTR;
}
