...
__CREDIRECT(__ATTR_WUNUSED,__WINT_TYPE__,__NOTHROW_RPC,__localdep__getwch_nolock,(void),_getwch_nolock,())
...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(_getwch))(void) {
