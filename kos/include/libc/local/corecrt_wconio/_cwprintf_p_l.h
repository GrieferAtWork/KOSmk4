 ...
 */
#ifndef __local__cwprintf_p_l_defined
#define __local__cwprintf_p_l_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(_cwprintf_p_l) __ATTR_ACCESS_RO(1) __ATTR_LIBC_WPRINTF_P(1, 3) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__VLIBCCALL __LIBC_LOCAL_NAME(_cwprintf_p_l))(__WCHAR_TYPE__ const *__format, __locale_t __locale, ...) {
	__STDC_INT_AS_SSIZE_T __result;
	__builtin_va_list __args;
	__builtin_va_start(__args, __locale);
	__result = (__NAMESPACE_LOCAL_SYM __localdep__vcwprintf_p_l)(__format, __locale, __args);
	__builtin_va_end(__args);
	return __result;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__cwprintf_p_l_defined
#define __local___localdep__cwprintf_p_l_defined
#define __localdep__cwprintf_p_l __LIBC_LOCAL_NAME(_cwprintf_p_l)
#endif /* !__local___localdep__cwprintf_p_l_defined */
...
#undef __local__cwprintf_p_l_defined
...
#endif /* !__local__cwprintf_p_l_defined */
