...
__LOCAL_LIBC(_vcwscanf) __ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_WSCANF(1, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(_vcwscanf))(__WCHAR_TYPE__ const *__format, __builtin_va_list __args) {
