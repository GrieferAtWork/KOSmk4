...
__CREDIRECT(__ATTR_IN(1) __ATTR_LIBC_WPRINTF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vcwprintf,(__WCHAR_TYPE__ const *__format, __builtin_va_list __args),_vcwprintf,(__format,__args))
