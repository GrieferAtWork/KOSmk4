...
__LOCAL_LIBC(_cwscanf_s_l) __ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_WSCANF(1, 3) __STDC_INT_AS_SSIZE_T
__NOTHROW_RPC(__VLIBCCALL __LIBC_LOCAL_NAME(_cwscanf_s_l))(__WCHAR_TYPE__ const *__format, __locale_t __locale, ...) {
