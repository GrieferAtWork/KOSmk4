...
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_LIBC_WSCANF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vcwscanf,(__WCHAR_TYPE__ const *__format, __builtin_va_list __args),_vcwscanf,(__format,__args))
...
__LOCAL_LIBC(_cwscanf) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_LIBC_WSCANF(1, 2) __STDC_INT_AS_SSIZE_T
