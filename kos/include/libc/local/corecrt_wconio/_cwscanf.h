...
#include <__crt.h>
#if defined(__CRT_HAVE__vcwscanf) || defined(__CRT_HAVE__vcwscanf_l) || defined(__CRT_HAVE___conio_common_vcwscanf)
#include <features.h>
__NAMESPACE_LOCAL_BEGIN
#ifndef __local___localdep__vcwscanf_defined
#define __local___localdep__vcwscanf_defined
#ifdef __CRT_HAVE__vcwscanf
__CREDIRECT(__ATTR_WUNUSED __ATTR_LIBC_WSCANF(1, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vcwscanf,(__WCHAR_TYPE__ const *__format, __builtin_va_list __args),_vcwscanf,(__format,__args))
#elif defined(__CRT_HAVE__vcwscanf_l) || defined(__CRT_HAVE___conio_common_vcwscanf)
...
__LOCAL_LIBC(_cwscanf) __ATTR_WUNUSED __ATTR_LIBC_WSCANF(1, 2) __ATTR_NONNULL((1)) __STDC_INT_AS_SSIZE_T
...
#else /* __CRT_HAVE__vcwscanf || __CRT_HAVE__vcwscanf_l || __CRT_HAVE___conio_common_vcwscanf */
#undef __local__cwscanf_defined
#endif /* !__CRT_HAVE__vcwscanf && !__CRT_HAVE__vcwscanf_l && !__CRT_HAVE___conio_common_vcwscanf */
