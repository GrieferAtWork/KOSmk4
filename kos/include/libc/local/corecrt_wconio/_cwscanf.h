...
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_WSCANF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_RPC,__localdep__vcwscanf,(__WCHAR_TYPE__ const *__format, __builtin_va_list __args),_vcwscanf,(__format,__args))
...
__NOTHROW_RPC(__VLIBCCALL __LIBC_LOCAL_NAME(_cwscanf))(__WCHAR_TYPE__ const *__format, ...) {
