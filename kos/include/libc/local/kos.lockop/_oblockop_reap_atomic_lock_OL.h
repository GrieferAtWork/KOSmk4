 ...
 */
#ifndef __local__oblockop_reap_atomic_lock_OL_defined
#define __local__oblockop_reap_atomic_lock_OL_defined
#include <__crt.h>
#include <kos/anno.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_oblockop_reap_atomic_lock_OL) __NOBLOCK __ATTR_NONNULL((1)) void
__NOTHROW(__LOCKOP_CC __LIBC_LOCAL_NAME(_oblockop_reap_atomic_lock_OL))(void *__restrict __obj, __PTRDIFF_TYPE__ __offsetof_lockop_slist) {
	struct __LOCAL_tobj {
		struct oblockop_slist __lto_self;
		struct atomic_lock    __lto_lock;
	} *__tobj = (struct __LOCAL_tobj *)((__BYTE_TYPE__ *)__obj + __offsetof_lockop_slist);
	(__NAMESPACE_LOCAL_SYM __localdep__oblockop_reap_atomic_lock)(&__tobj->__lto_self, &__tobj->__lto_lock, __obj);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__oblockop_reap_atomic_lock_OL_defined
#define __local___localdep__oblockop_reap_atomic_lock_OL_defined
#define __localdep__oblockop_reap_atomic_lock_OL __LIBC_LOCAL_NAME(_oblockop_reap_atomic_lock_OL)
#endif /* !__local___localdep__oblockop_reap_atomic_lock_OL_defined */
#endif /* !__local__oblockop_reap_atomic_lock_OL_defined */
