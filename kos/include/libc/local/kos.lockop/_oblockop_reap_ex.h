...
#define __local__oblockop_reap_ex_defined 1
#include <__crt.h>
#include <kos/anno.h>
#ifndef __LOCKOP_CC
...
__LOCAL_LIBC(_oblockop_reap_ex) __NOBLOCK __ATTR_NONNULL((1, 2, 3, 5)) void
...
#define __local___localdep__oblockop_reap_ex_defined 1
