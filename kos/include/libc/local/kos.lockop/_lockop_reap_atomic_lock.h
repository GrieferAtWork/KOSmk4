...
#define __local__lockop_reap_atomic_lock_defined 1
#include <__crt.h>
#include <kos/anno.h>
#ifndef __LOCKOP_CC
...
__LOCAL_LIBC(_lockop_reap_atomic_lock) __NOBLOCK __ATTR_NONNULL((1, 2)) void
...
#define __local___localdep__lockop_reap_atomic_lock_defined 1
