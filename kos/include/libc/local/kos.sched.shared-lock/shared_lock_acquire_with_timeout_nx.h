...
(__FCALL __LIBC_LOCAL_NAME(shared_lock_acquire_with_timeout_nx))(struct shared_lock *__restrict __self, __shared_rwlock_timespec __abs_timeout) __THROWS(__E_WOULDBLOCK, ...) {
