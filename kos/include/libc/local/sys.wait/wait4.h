...
struct __rusage64;
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_ACCESS_WR_OPT(4),__pid_t,__NOTHROW_NCX,__localdep_wait4_64,(__pid_t __pid, __WAIT_STATUS __stat_loc, __STDC_INT_AS_UINT_T __options, struct __rusage64 *__usage),wait4,(__pid,__stat_loc,__options,__usage))
#elif defined(__CRT_HAVE___wait4) && __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__
__NAMESPACE_LOCAL_END
struct __rusage64;
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_ACCESS_WR_OPT(4),__pid_t,__NOTHROW_NCX,__localdep_wait4_64,(__pid_t __pid, __WAIT_STATUS __stat_loc, __STDC_INT_AS_UINT_T __options, struct __rusage64 *__usage),__wait4,(__pid,__stat_loc,__options,__usage))
#elif defined(__CRT_HAVE___libc_wait4) && __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__
__NAMESPACE_LOCAL_END
struct __rusage64;
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_ACCESS_WR_OPT(4),__pid_t,__NOTHROW_NCX,__localdep_wait4_64,(__pid_t __pid, __WAIT_STATUS __stat_loc, __STDC_INT_AS_UINT_T __options, struct __rusage64 *__usage),__libc_wait4,(__pid,__stat_loc,__options,__usage))
#elif defined(__CRT_HAVE_wait4_64)
__NAMESPACE_LOCAL_END
struct __rusage64;
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_ACCESS_WR_OPT(4),__pid_t,__NOTHROW_NCX,__localdep_wait4_64,(__pid_t __pid, __WAIT_STATUS __stat_loc, __STDC_INT_AS_UINT_T __options, struct __rusage64 *__usage),wait4_64,(__pid,__stat_loc,__options,__usage))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(wait4) __ATTR_ACCESS_WR_OPT(4) __pid_t
