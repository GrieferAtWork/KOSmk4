 ...
 */
#ifndef __local_getfsspec_defined
#define __local_getfsspec_defined
#include <__crt.h>
...
__LOCAL_LIBC(getfsspec) __ATTR_WUNUSED __ATTR_NONNULL((1)) struct fstab *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(getfsspec))(const char *__special_file) {
	...
	while ((__result = (__NAMESPACE_LOCAL_SYM __localdep_getfsent)()) != __NULLPTR) {
		if ((__NAMESPACE_LOCAL_SYM __localdep_strcmp)(__result->fs_spec, __special_file) == 0)
			break;
	}
	return __result;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_getfsspec_defined
#define __local___localdep_getfsspec_defined
#define __localdep_getfsspec __LIBC_LOCAL_NAME(getfsspec)
#endif /* !__local___localdep_getfsspec_defined */
#else /* __CRT_HAVE_getfsent && __CRT_HAVE_setfsent */
#undef __local_getfsspec_defined
#endif /* !__CRT_HAVE_getfsent || !__CRT_HAVE_setfsent */
#endif /* !__local_getfsspec_defined */
