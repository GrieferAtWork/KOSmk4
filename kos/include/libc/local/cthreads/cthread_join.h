...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_OUT_OPT(2),__errno_t,__NOTHROW_RPC,__localdep_pthread_getresult_np,(__pthread_t __pthread, void **__thread_return),pthread_getresult_np,(__pthread,__thread_return))
