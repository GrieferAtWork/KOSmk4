...
#define __local_PathConf_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(PathConf) __ATTR_IN(1) __LONGPTR_TYPE__
(__LIBCCALL __LIBC_LOCAL_NAME(PathConf))(char const *__path, __STDC_INT_AS_UINT_T __name) __THROWS(...) {
	__fd_t __fd;
...
#else /* __CRT_HAVE_FPathConf && (__CRT_HAVE_Open64 || (__AT_FDCWD && (__CRT_HAVE_OpenAt64 || __CRT_HAVE_OpenAt)) || __CRT_HAVE_Open) && __O_RDONLY */
