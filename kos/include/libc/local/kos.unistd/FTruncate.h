...
__CREDIRECT_VOID(__ATTR_FDWRITE(1),__THROWING(...),__localdep_FTruncate64,(__fd_t __fd, __pos64_t __length),FTruncate,(__fd,__length))
#elif defined(__CRT_HAVE_FTruncate64)
__CREDIRECT_VOID(__ATTR_FDWRITE(1),__THROWING(...),__localdep_FTruncate64,(__fd_t __fd, __pos64_t __length),FTruncate64,(__fd,__length))
...
__CREDIRECT(__ATTR_FDWRITE(1),int,__THROWING(...),__localdep_crt_FTruncate32,(__fd_t __fd, __pos32_t __length),FTruncate,(__fd,__length))
#endif /* !__local___localdep_crt_FTruncate32_defined && __CRT_HAVE_FTruncate */
__LOCAL_LIBC(FTruncate) __ATTR_FDWRITE(1) void
