...
__CREDIRECT(,int,__NOTHROW_NCX,__localdep___fpclassifyl,(__LONGDOUBLE __x),__fpclassifyl,(__x))
#elif defined(__CRT_HAVE_fpclassifyl)
__CREDIRECT(,int,__NOTHROW_NCX,__localdep___fpclassifyl,(__LONGDOUBLE __x),fpclassifyl,(__x))
#elif defined(__CRT_HAVE__ldclass)
__CREDIRECT(,int,__NOTHROW_NCX,__localdep___fpclassifyl,(__LONGDOUBLE __x),_ldclass,(__x))
#else /* ... */
...
__LOCAL_LIBC(_ldtest) __ATTR_WUNUSED short
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_ldtest))(__LONGDOUBLE *__px) {
