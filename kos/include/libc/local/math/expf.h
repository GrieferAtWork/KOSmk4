...
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(expf))(float __x) {
	...
	if (__LIBM_LIB_VERSION != __LIBM_IEEE &&
	    (!__LIBM_MATHFUNIF(finite, __result) || __result == 0.0f) &&
	...
	return (float)(__NAMESPACE_LOCAL_SYM __localdep_exp)((double)__x);
