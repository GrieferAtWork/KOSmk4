 ...
 */
#ifndef __local_acos_defined
#define __local_acos_defined
#include <__crt.h>
#include <ieee754.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(acos) __ATTR_WUNUSED double
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(acos))(double __x) {
...
#undef __local_acos_defined
#endif /* !__IEEE754_DOUBLE_TYPE_IS_DOUBLE__ && !__IEEE754_FLOAT_TYPE_IS_DOUBLE__ && !__IEEE854_LONG_DOUBLE_TYPE_IS_DOUBLE__ */
#endif /* !__local_acos_defined */
