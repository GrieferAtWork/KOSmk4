...
__CREDIRECT(__ATTR_WUNUSED,long int,__NOTHROW_NCX,__localdep_llogb,(double __x),llogb,(__x))
#endif /* !__local___localdep_llogb_defined */
__LOCAL_LIBC(llogbl) __ATTR_WUNUSED long int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(llogbl))(__LONGDOUBLE __x) {
...
#else /* __CRT_HAVE_llogb */
#undef __local_llogbl_defined
#endif /* !__CRT_HAVE_llogb */
