...
#ifndef __local___localdep_ceill_defined
#define __local___localdep_ceill_defined
#define __localdep_ceill __LIBC_LOCAL_NAME(ceill)
#endif /* !__local___localdep_ceill_defined */
