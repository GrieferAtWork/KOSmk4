...
#define __local_nexttoward_defined
#include <__crt.h>
#include <ieee754.h>
...
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(nexttoward))(double __x, __LONGDOUBLE __y) {
	...
	return (double)(__NAMESPACE_LOCAL_SYM __localdep_nextafterl)((__LONGDOUBLE)__x, __y);
#endif /* !__IEEE854_LONG_DOUBLE_TYPE__ */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_nexttoward_defined
#define __local___localdep_nexttoward_defined
