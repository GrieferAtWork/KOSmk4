 ...
 */
#ifndef __local_y1_defined
#define __local_y1_defined
#include <__crt.h>
#include <ieee754.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(y1) __ATTR_WUNUSED double
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(y1))(double __x) {
	if (__LIBM_LIB_VERSION != __LIBM_IEEE &&
		...
		if (__x < 0.0) {
			...
			return __kernel_standard(__x, __x, -__HUGE_VAL, __LIBM_KMATHERR_Y1_MINUS);
		} else if (__x == 0.0) {
			return __kernel_standard(__x, __x, -__HUGE_VAL, __LIBM_KMATHERR_Y1_ZERO);
		} else if (__LIBM_LIB_VERSION != __LIBM_POSIX) {
			return __kernel_standard(__x, __x, 0.0f, __LIBM_KMATHERR_Y1_TLOSS);
		}
	}
	return __LIBM_MATHFUN(y1, __x);
}
__NAMESPACE_LOCAL_END
...
#undef __local_y1_defined
#endif /* !__IEEE754_DOUBLE_TYPE_IS_DOUBLE__ && !__IEEE754_FLOAT_TYPE_IS_DOUBLE__ && !__IEEE854_LONG_DOUBLE_TYPE_IS_DOUBLE__ */
#endif /* !__local_y1_defined */
