...
#define __local_nextafterf_defined
#include <__crt.h>
#include <ieee754.h>
...
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(nextafterf))(float __x, float __y) {
	...
	return (float)(__NAMESPACE_LOCAL_SYM __localdep_nextafter)((double)__x, (double)__y);
#endif /* !__IEEE754_DOUBLE_TYPE_IS_FLOAT__ && !__IEEE754_FLOAT_TYPE_IS_FLOAT__ && !__IEEE854_LONG_DOUBLE_TYPE_IS_FLOAT__ */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_nextafterf_defined
#define __local___localdep_nextafterf_defined
