...
#define __local_significandl_defined
#include <__crt.h>
#include <ieee754.h>
...
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(significandl))(__LONGDOUBLE __x) {
	...
	return (__LONGDOUBLE)(__NAMESPACE_LOCAL_SYM __localdep_significand)((double)__x);
#endif /* !__IEEE754_DOUBLE_TYPE_IS_LONG_DOUBLE__ && !__IEEE754_FLOAT_TYPE_IS_LONG_DOUBLE__ && !__IEEE854_LONG_DOUBLE_TYPE_IS_LONG_DOUBLE__ */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_significandl_defined
#define __local___localdep_significandl_defined
