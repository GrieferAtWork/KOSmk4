...
#define __local_scalblnf_defined
#include <__crt.h>
#include <ieee754.h>
...
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(scalblnf))(float __x, long int __n) {
	...
	return __LIBM_MATHFUN2IF(scalbln, __x, __n);
#else /* __IEEE754_DOUBLE_TYPE_IS_FLOAT__ || __IEEE754_FLOAT_TYPE_IS_FLOAT__ || __IEEE854_LONG_DOUBLE_TYPE_IS_FLOAT__ */
	return (float)(__NAMESPACE_LOCAL_SYM __localdep_scalbln)((double)__x, __n);
#endif /* !__IEEE754_DOUBLE_TYPE_IS_FLOAT__ && !__IEEE754_FLOAT_TYPE_IS_FLOAT__ && !__IEEE854_LONG_DOUBLE_TYPE_IS_FLOAT__ */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_scalblnf_defined
#define __local___localdep_scalblnf_defined
