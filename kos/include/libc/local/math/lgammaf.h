...
__CEIREDIRECT(__ATTR_WUNUSED __ATTR_OUT(2),float,__NOTHROW_NCX,__localdep_lgammaf_r,(float __x, int *__signgamp),lgammaf_r,{ return __builtin_lgammaf_r(__x, __signgamp); })
#elif defined(__CRT_HAVE_lgammaf_r)
__CREDIRECT(__ATTR_WUNUSED __ATTR_OUT(2),float,__NOTHROW_NCX,__localdep_lgammaf_r,(float __x, int *__signgamp),lgammaf_r,(__x,__signgamp))
#elif defined(__CRT_HAVE___lgammaf_r)
__CREDIRECT(__ATTR_WUNUSED __ATTR_OUT(2),float,__NOTHROW_NCX,__localdep_lgammaf_r,(float __x, int *__signgamp),__lgammaf_r,(__x,__signgamp))
...
#else /* ... */
#undef __local___localdep_lgammaf_r_defined
#endif /* !... */
...
__NOTHROW(__LIBCCALL __LIBC_LOCAL_NAME(lgammaf))(float __x) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lgammaf_r)(__x, &__LOCAL_signgam);
}
__NAMESPACE_LOCAL_END
