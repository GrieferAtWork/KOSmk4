...
__CEIREDIRECT(__ATTR_WUNUSED __ATTR_OUT(3),double,__NOTHROW,__localdep_remquo,(double __x, double __p, int *__pquo),remquo,{ return __builtin_remquo(__x, __p, __pquo); })
#elif defined(__CRT_HAVE_remquo)
__CREDIRECT(__ATTR_WUNUSED __ATTR_OUT(3),double,__NOTHROW,__localdep_remquo,(double __x, double __p, int *__pquo),remquo,(__x,__p,__pquo))
#elif defined(__CRT_HAVE___remquo)
__CREDIRECT(__ATTR_WUNUSED __ATTR_OUT(3),double,__NOTHROW,__localdep_remquo,(double __x, double __p, int *__pquo),__remquo,(__x,__p,__pquo))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(remquof) __ATTR_WUNUSED __ATTR_OUT(3) float
