 ...
 */
#ifndef __local_futexlock_timedwaitwhile_anybit64_defined
#define __local_futexlock_timedwaitwhile_anybit64_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futexlock_timedwaitwhile_anybit64) __ATTR_NONNULL((1, 2)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_anybit64))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, __uintptr_t __bitmask, struct __timespec64 const *__rel_timeout) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutexlock64)(__ulockaddr, __uaddr, LFUTEX_WAIT_UNTIL_BITMASK, __bitmask, __rel_timeout, 0);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futexlock_timedwaitwhile_anybit64_defined
#define __local___localdep_futexlock_timedwaitwhile_anybit64_defined 1
#define __localdep_futexlock_timedwaitwhile_anybit64 __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_anybit64)
#endif /* !__local___localdep_futexlock_timedwaitwhile_anybit64_defined */
#else /* __CRT_HAVE_lfutexlock64 || __CRT_HAVE_lfutexlock */
#undef __local_futexlock_timedwaitwhile_anybit64_defined
#endif /* !__CRT_HAVE_lfutexlock64 && !__CRT_HAVE_lfutexlock */
#endif /* !__local_futexlock_timedwaitwhile_anybit64_defined */
