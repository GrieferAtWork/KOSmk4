...
#define __local_futexlock_timedwaitwhile64_defined
#include <__crt.h>
...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaitwhile64))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, __uintptr_t __equal_to_value, struct __timespec64 const *__rel_timeout) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutexlock64)(__ulockaddr, __uaddr, LFUTEX_WAIT_WHILE, __equal_to_value, __rel_timeout);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futexlock_timedwaitwhile64_defined
#define __local___localdep_futexlock_timedwaitwhile64_defined
