...
#define __local_futexlock_timedwaituntil_exactbits64_defined
#include <__crt.h>
...
#define __local___localdep_futexlock_timedwaituntil_exactbits64_defined
