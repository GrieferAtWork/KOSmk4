...
#define __local_futexlock_timedwaitlock_defined
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futexlock_timedwaitlock) __ATTR_NONNULL((1, 2)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaitlock))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, struct timespec const *__rel_timeout) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutexlock)(__ulockaddr, __uaddr, LFUTEX_WAIT_LOCK, 0, __rel_timeout);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futexlock_timedwaitlock_defined
#define __local___localdep_futexlock_timedwaitlock_defined
#define __localdep_futexlock_timedwaitlock __LIBC_LOCAL_NAME(futexlock_timedwaitlock)
#endif /* !__local___localdep_futexlock_timedwaitlock_defined */
#else /* __CRT_HAVE_lfutexlock64 || __CRT_HAVE_lfutexlock */
#undef __local_futexlock_timedwaitlock_defined
#endif /* !__CRT_HAVE_lfutexlock64 && !__CRT_HAVE_lfutexlock */
#endif /* !__local_futexlock_timedwaitlock_defined */
