 ...
 */
#ifndef __local_futexlock_waitwhile_below_defined
#define __local_futexlock_waitwhile_below_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futexlock_waitwhile_below) __ATTR_NONNULL((1, 2)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_waitwhile_below))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, __uintptr_t __below_value) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutexlock64)(__ulockaddr, __uaddr, LFUTEX_WAIT_WHILE_BELOW, __below_value, (struct __timespec64 const *)__NULLPTR);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futexlock_waitwhile_below_defined
#define __local___localdep_futexlock_waitwhile_below_defined 1
#define __localdep_futexlock_waitwhile_below __LIBC_LOCAL_NAME(futexlock_waitwhile_below)
#endif /* !__local___localdep_futexlock_waitwhile_below_defined */
#else /* __CRT_HAVE_lfutexlock64 || __CRT_HAVE_lfutexlock */
#undef __local_futexlock_waitwhile_below_defined
#endif /* !__CRT_HAVE_lfutexlock64 && !__CRT_HAVE_lfutexlock */
#endif /* !__local_futexlock_waitwhile_below_defined */
