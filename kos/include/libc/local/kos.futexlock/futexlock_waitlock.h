...
#define __local_futexlock_waitlock_defined
#include <__crt.h>
...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_waitlock))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutexlock64)(__ulockaddr, __uaddr, LFUTEX_WAIT_LOCK, 0, (struct __timespec64 const *)__NULLPTR);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futexlock_waitlock_defined
#define __local___localdep_futexlock_waitlock_defined
#define __localdep_futexlock_waitlock __LIBC_LOCAL_NAME(futexlock_waitlock)
#endif /* !__local___localdep_futexlock_waitlock_defined */
#else /* __CRT_HAVE_lfutexlock64 || __CRT_HAVE_lfutexlock */
#undef __local_futexlock_waitlock_defined
