...
#define __local_futexlock_timedwaitwhile_exactbits_defined
#include <__crt.h>
#include <features.h>
...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_exactbits))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, __uintptr_t __bitmask, __uintptr_t __setmask, struct timespec const *__rel_timeout) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutexlock)(__ulockaddr, __uaddr, LFUTEX_WAIT_WHILE_BITMASK, __bitmask, __rel_timeout, __setmask);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futexlock_timedwaitwhile_exactbits_defined
#define __local___localdep_futexlock_timedwaitwhile_exactbits_defined
