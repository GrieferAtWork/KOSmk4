 ...
 */
#ifndef __local_futexlock_timedwaituntil_cmpxch_defined
#define __local_futexlock_timedwaituntil_cmpxch_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futexlock_timedwaituntil_cmpxch) __ATTR_NONNULL((1, 2)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaituntil_cmpxch))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, __uintptr_t __old_value, __uintptr_t __new_value, struct timespec const *__rel_timeout) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutexlock)(__ulockaddr, __uaddr, LFUTEX_WAIT_UNTIL_CMPXCH, __old_value, __rel_timeout, __new_value);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futexlock_timedwaituntil_cmpxch_defined
#define __local___localdep_futexlock_timedwaituntil_cmpxch_defined 1
#define __localdep_futexlock_timedwaituntil_cmpxch __LIBC_LOCAL_NAME(futexlock_timedwaituntil_cmpxch)
#endif /* !__local___localdep_futexlock_timedwaituntil_cmpxch_defined */
#else /* __CRT_HAVE_lfutexlock64 || __CRT_HAVE_lfutexlock */
#undef __local_futexlock_timedwaituntil_cmpxch_defined
#endif /* !__CRT_HAVE_lfutexlock64 && !__CRT_HAVE_lfutexlock */
#endif /* !__local_futexlock_timedwaituntil_cmpxch_defined */
