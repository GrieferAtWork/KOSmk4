...
#define __local_futexlock_timedwaituntil_defined
#include <__crt.h>
#include <features.h>
...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaituntil))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, __uintptr_t __not_equal_to_value, struct timespec const *__rel_timeout) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutexlock)(__ulockaddr, __uaddr, LFUTEX_WAIT_UNTIL, __not_equal_to_value, __rel_timeout);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futexlock_timedwaituntil_defined
#define __local___localdep_futexlock_timedwaituntil_defined
#define __localdep_futexlock_timedwaituntil __LIBC_LOCAL_NAME(futexlock_timedwaituntil)
#endif /* !__local___localdep_futexlock_timedwaituntil_defined */
#else /* __CRT_HAVE_lfutexlock64 || __CRT_HAVE_lfutexlock */
#undef __local_futexlock_timedwaituntil_defined
