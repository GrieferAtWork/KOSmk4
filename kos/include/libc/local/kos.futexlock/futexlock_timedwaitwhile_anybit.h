 ...
 */
#ifndef __local_futexlock_timedwaitwhile_anybit_defined
#define __local_futexlock_timedwaitwhile_anybit_defined 1
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futexlock_timedwaitwhile_anybit) __ATTR_NONNULL((1, 2)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_anybit))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, __uintptr_t __bitmask, struct timespec const *__rel_timeout) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutexlock)(__ulockaddr, __uaddr, LFUTEX_WAIT_UNTIL_BITMASK, __bitmask, __rel_timeout, 0);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futexlock_timedwaitwhile_anybit_defined
#define __local___localdep_futexlock_timedwaitwhile_anybit_defined 1
#define __localdep_futexlock_timedwaitwhile_anybit __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_anybit)
#endif /* !__local___localdep_futexlock_timedwaitwhile_anybit_defined */
#else /* __CRT_HAVE_lfutexlock64 || __CRT_HAVE_lfutexlock */
#undef __local_futexlock_timedwaitwhile_anybit_defined
#endif /* !__CRT_HAVE_lfutexlock64 && !__CRT_HAVE_lfutexlock */
#endif /* !__local_futexlock_timedwaitwhile_anybit_defined */
