...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_waitwhile_above))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, __uintptr_t __above_value) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutexlock64)(__ulockaddr, __uaddr, LFUTEX_WAIT_WHILE_ABOVE, __above_value, (struct __timespec64 const *)__NULLPTR);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futexlock_waitwhile_above_defined
#define __local___localdep_futexlock_waitwhile_above_defined 1
#define __localdep_futexlock_waitwhile_above __LIBC_LOCAL_NAME(futexlock_waitwhile_above)
#endif /* !__local___localdep_futexlock_waitwhile_above_defined */
#else /* __CRT_HAVE_lfutexlock64 || __CRT_HAVE_lfutexlock */
#undef __local_futexlock_waitwhile_above_defined
