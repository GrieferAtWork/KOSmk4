...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_waituntil_cmpxch))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, __uintptr_t __old_value, __uintptr_t __new_value) {
	return __localdep_lfutexlock64(__ulockaddr, __uaddr, LFUTEX_WAIT_UNTIL_CMPXCH, __old_value, (struct __timespec64 const *)__NULLPTR, __new_value);
}
__NAMESPACE_LOCAL_END
