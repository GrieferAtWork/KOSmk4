...
#define __local_futexlock_timedwaitwhile_below_defined
#include <__crt.h>
#include <features.h>
...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_below))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, __uintptr_t __below_value, struct timespec const *__rel_timeout) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutexlock)(__ulockaddr, __uaddr, LFUTEX_WAIT_WHILE_BELOW, __below_value, __rel_timeout);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futexlock_timedwaitwhile_below_defined
#define __local___localdep_futexlock_timedwaitwhile_below_defined
