 ...
 */
#ifndef __local_futexlock_timedwaitwhile_aboveequal_defined
#define __local_futexlock_timedwaitwhile_aboveequal_defined 1
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(futexlock_timedwaitwhile_aboveequal) __ATTR_NONNULL((1, 2)) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_aboveequal))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, __uintptr_t __above_equal_value, struct timespec const *__rel_timeout) {
	...
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutexlock)(__ulockaddr, __uaddr, LFUTEX_WAIT_WHILE_ABOVE, __above_equal_value - 1, __rel_timeout);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futexlock_timedwaitwhile_aboveequal_defined
#define __local___localdep_futexlock_timedwaitwhile_aboveequal_defined 1
#define __localdep_futexlock_timedwaitwhile_aboveequal __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_aboveequal)
#endif /* !__local___localdep_futexlock_timedwaitwhile_aboveequal_defined */
#else /* __CRT_HAVE_lfutexlock64 || __CRT_HAVE_lfutexlock */
#undef __local_futexlock_timedwaitwhile_aboveequal_defined
#endif /* !__CRT_HAVE_lfutexlock64 && !__CRT_HAVE_lfutexlock */
#endif /* !__local_futexlock_timedwaitwhile_aboveequal_defined */
