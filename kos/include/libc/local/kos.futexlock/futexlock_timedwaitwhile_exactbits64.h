...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_exactbits64))(__uintptr_t *__ulockaddr, __uintptr_t *__uaddr, __uintptr_t __bitmask, __uintptr_t __setmask, struct __timespec64 const *__rel_timeout) {
	return (__NAMESPACE_LOCAL_SYM __localdep_lfutexlock64)(__ulockaddr, __uaddr, LFUTEX_WAIT_WHILE_BITMASK, __bitmask, __rel_timeout, __setmask);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_futexlock_timedwaitwhile_exactbits64_defined
#define __local___localdep_futexlock_timedwaitwhile_exactbits64_defined 1
#define __localdep_futexlock_timedwaitwhile_exactbits64 __LIBC_LOCAL_NAME(futexlock_timedwaitwhile_exactbits64)
#endif /* !__local___localdep_futexlock_timedwaitwhile_exactbits64_defined */
#else /* __CRT_HAVE_lfutexlock64 || __CRT_HAVE_lfutexlock */
#undef __local_futexlock_timedwaitwhile_exactbits64_defined
