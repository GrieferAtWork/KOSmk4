...
#define __local_spawnle_defined
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(spawnle) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO_OPT(3) __ATTR_SENTINEL_O(1) __pid_t
__NOTHROW_RPC(__VLIBCCALL __LIBC_LOCAL_NAME(spawnle))(__STDC_INT_AS_UINT_T __mode, char const *__restrict __path, char const *__args, ...) {
	__REDIRECT_SPAWNLE(char, (__NAMESPACE_LOCAL_SYM __localdep_spawnve), __mode, __path, __args)
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_spawnle_defined
#define __local___localdep_spawnle_defined
