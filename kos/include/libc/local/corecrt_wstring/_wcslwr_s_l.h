...
#define __local__wcslwr_s_l_defined
#include <__crt.h>
...
__LOCAL_LIBC(_wcslwr_s_l) __ATTR_ACCESS_RW_OPT(1) __errno_t
...
#define __local___localdep__wcslwr_s_l_defined
