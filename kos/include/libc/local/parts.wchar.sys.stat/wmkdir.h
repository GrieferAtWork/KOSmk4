...
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_ACCESS_RO(1),int,__NOTHROW_RPC,__localdep_dos_wmkdir,(__WCHAR_TYPE__ const *__pathname),_wmkdir,(__pathname))
...
__CREDIRECT(__ATTR_ACCESS_RO(2),int,__NOTHROW_RPC,__localdep_wmkdirat,(__fd_t __dirfd, __WCHAR_TYPE__ const *__pathname, __mode_t __mode),wmkdirat,(__dirfd,__pathname,__mode))
...
__LOCAL_LIBC(wmkdir) __ATTR_ACCESS_RO(1) int
