...
__CREDIRECT(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_wmkdirat,(__fd_t __dirfd, __WCHAR_TYPE__ const *__pathname, __mode_t __mode),wmkdirat,(__dirfd,__pathname,__mode))
...
__LOCAL_LIBC(wmkdir) __ATTR_NONNULL((1)) int
