...
__CREDIRECT(__ATTR_IN(1),int,__NOTHROW_RPC,__localdep_mkfifo,(char const *__fifoname, __mode_t __mode),mkfifo,(__fifoname,__mode))
...
__CREDIRECT(__ATTR_IN(1),int,__NOTHROW_RPC,__localdep_wmknod,(__WCHAR_TYPE__ const *__nodename, __mode_t __mode, __dev_t __dev),wmknod,(__nodename,__mode,__dev))
...
__LOCAL_LIBC(wmkfifo) __ATTR_IN(1) int
