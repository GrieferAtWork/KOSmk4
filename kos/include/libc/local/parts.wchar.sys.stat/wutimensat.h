...
__CREDIRECT(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_wutimensat64,(__fd_t __dirfd, __WCHAR_TYPE__ const *__filename, struct __timespec64 const __times[2 /*or:3*/], __atflag_t __flags),wutimensat,(__dirfd,__filename,__times,__flags))
#elif defined(__CRT_HAVE_wutimensat64)
__CREDIRECT(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_wutimensat64,(__fd_t __dirfd, __WCHAR_TYPE__ const *__filename, struct __timespec64 const __times[2 /*or:3*/], __atflag_t __flags),wutimensat64,(__dirfd,__filename,__times,__flags))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(wutimensat) __ATTR_NONNULL((2)) int
