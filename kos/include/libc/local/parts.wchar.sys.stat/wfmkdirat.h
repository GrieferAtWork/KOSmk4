 ...
 */
#ifndef __local_wfmkdirat_defined
#define __local_wfmkdirat_defined
#include <__crt.h>
#if defined(__CRT_HAVE_fmkdirat) && (defined(__CRT_HAVE_convert_wcstombs) || defined(__CRT_HAVE_convert_wcstombsn) || defined(__CRT_HAVE_format_aprintf_printer) || defined(__CRT_HAVE_format_aprintf_alloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc))
...
__LOCAL_LIBC(wfmkdirat) __ATTR_ACCESS_RO(2) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(wfmkdirat))(__fd_t __dirfd, __WCHAR_TYPE__ const *__pathname, __mode_t __mode, __atflag_t __flags) {
	int __result;
	...
	if __unlikely(!__utf8_pathname)
		return -1;
	__result = (__NAMESPACE_LOCAL_SYM __localdep_fmkdirat)(__dirfd, __utf8_pathname, __mode, __flags);
...
#else /* __CRT_HAVE_fmkdirat && (__CRT_HAVE_convert_wcstombs || __CRT_HAVE_convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc) */
#undef __local_wfmkdirat_defined
#endif /* !__CRT_HAVE_fmkdirat || (!__CRT_HAVE_convert_wcstombs && !__CRT_HAVE_convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) */
#endif /* !__local_wfmkdirat_defined */
