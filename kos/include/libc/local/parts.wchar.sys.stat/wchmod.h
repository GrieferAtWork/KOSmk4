 ...
 */
#ifndef __local_wchmod_defined
#define __local_wchmod_defined
#include <__crt.h>
...
__LOCAL_LIBC(wchmod) __ATTR_ACCESS_RO(1) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(wchmod))(__WCHAR_TYPE__ const *__filename, __mode_t __mode) {
#if defined(__AT_FDCWD) && (defined(__CRT_HAVE_wfchmodat) || (defined(__CRT_HAVE_fchmodat) && (defined(__CRT_HAVE_convert_wcstombs) || defined(__CRT_HAVE_convert_wcstombsn) || defined(__CRT_HAVE_format_aprintf_printer) || defined(__CRT_HAVE_format_aprintf_alloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc))))
	return (__NAMESPACE_LOCAL_SYM __localdep_wfchmodat)(__AT_FDCWD, __filename, __mode, 0);
#else /* __AT_FDCWD && (__CRT_HAVE_wfchmodat || (__CRT_HAVE_fchmodat && (__CRT_HAVE_convert_wcstombs || __CRT_HAVE_convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc))) */
	int __result;
	...
	return __result;
#endif /* !__AT_FDCWD || (!__CRT_HAVE_wfchmodat && (!__CRT_HAVE_fchmodat || (!__CRT_HAVE_convert_wcstombs && !__CRT_HAVE_convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc))) */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_wchmod_defined
#define __local___localdep_wchmod_defined
#define __localdep_wchmod __LIBC_LOCAL_NAME(wchmod)
#endif /* !__local___localdep_wchmod_defined */
...
#undef __local_wchmod_defined
#endif /* (!__AT_FDCWD || (!__CRT_HAVE_wfchmodat && (!__CRT_HAVE_fchmodat || (!__CRT_HAVE_convert_wcstombs && !__CRT_HAVE_convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc)))) && ((!__CRT_HAVE_chmod && !__CRT_HAVE__chmod && !__CRT_HAVE___chmod && !__CRT_HAVE___libc_chmod && (!__AT_FDCWD || !__CRT_HAVE_fchmodat)) || (!__CRT_HAVE_convert_wcstombs && !__CRT_HAVE_convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc)) */
#endif /* !__local_wchmod_defined */
