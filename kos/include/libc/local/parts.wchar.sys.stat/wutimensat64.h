...
__CREDIRECT(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_crt_wutimensat32,(__fd_t __dirfd, __WCHAR_TYPE__ const *__filename, struct timespec const __times[2 /*or:3*/], __atflag_t __flags),wutimensat,(__dirfd,__filename,__times,__flags))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(wutimensat64) __ATTR_NONNULL((2)) int
