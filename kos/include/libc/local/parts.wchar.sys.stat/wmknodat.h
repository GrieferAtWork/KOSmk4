...
__CREDIRECT(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_wfmknodat,(__fd_t __dirfd, __WCHAR_TYPE__ const *__nodename, __mode_t __mode, __dev_t __dev, __atflag_t __flags),wfmknodat,(__dirfd,__nodename,__mode,__dev,__flags))
...
__LOCAL_LIBC(wmknodat) __ATTR_NONNULL((2)) int
