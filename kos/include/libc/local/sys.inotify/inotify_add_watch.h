...
__CREDIRECT(,int,__NOTHROW_NCX,__localdep_inotify_add_watch_at,(__fd_t __notify_fd, __fd_t __dirfd, char const *__pathname, __atflag_t __atflags, __UINT32_TYPE__ __mask),inotify_add_watch_at,(__notify_fd,__dirfd,__pathname,__atflags,__mask))
#endif /* !__local___localdep_inotify_add_watch_at_defined */
__NAMESPACE_LOCAL_END
#include <linux/inotify.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(inotify_add_watch) int
