...
__LOCAL_LIBC(ulltostr) __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_NONNULL((2)) char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(ulltostr))(__ULONGLONG __value, char *__buf) {
	do {
		*--__buf = __LOCAL_itoa_decimal(__value % 10);
	} while ((__value /= 10) != 0);
	return __buf;
}
