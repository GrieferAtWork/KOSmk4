...
__LIBC __ATTR_NORETURN __ATTR_IN_OPT(2) __ATTR_LIBC_PRINTF(2, 3) void __NOTHROW_CB(__VLIBCCALL __localdep_errx)(int __status, char const *__format, ...) __CASMNAME("errx");
