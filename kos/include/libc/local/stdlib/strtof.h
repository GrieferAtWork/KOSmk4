...
#endif /* !... */
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(strtof) __ATTR_LEAF __ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR_OPT(2) float
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(strtof))(char const *__restrict __nptr, char **__endptr) {
	float __result;
