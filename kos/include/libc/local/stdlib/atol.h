 ...
 */
#ifndef __local_atol_defined
#define __local_atol_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(atol) __ATTR_PURE __ATTR_WUNUSED __ATTR_NONNULL((1)) long
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(atol))(char const *__restrict __nptr) {
#if __SIZEOF_LONG__ <= 4
	return (long)__NAMESPACE_LOCAL_SYM __localdep_strto32(__nptr, __NULLPTR, 10);
#else /* __SIZEOF_LONG__ <= 4 */
	return (long)__NAMESPACE_LOCAL_SYM __localdep_strto64(__nptr, __NULLPTR, 10);
#endif /* __SIZEOF_LONG__ > 4 */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_atol_defined
#define __local___localdep_atol_defined 1
#define __localdep_atol __LIBC_LOCAL_NAME(atol)
#endif /* !__local___localdep_atol_defined */
#endif /* !__local_atol_defined */
