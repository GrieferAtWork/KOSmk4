...
struct __dirstream;
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1)),int,__NOTHROW_NCX,__localdep_closedir,(struct __dirstream *__dirp),closedir,(__dirp))
#elif defined(__CRT_HAVE___libc_closedir)
__NAMESPACE_LOCAL_END
struct __dirstream;
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1)),int,__NOTHROW_NCX,__localdep_closedir,(struct __dirstream *__dirp),__libc_closedir,(__dirp))
...
struct __dirstream;
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1)),struct __dirstream *,__NOTHROW_RPC,__localdep_opendir,(char const *__name),opendir,(__name))
#elif defined(__CRT_HAVE___libc_opendir)
__NAMESPACE_LOCAL_END
struct __dirstream;
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1)),struct __dirstream *,__NOTHROW_RPC,__localdep_opendir,(char const *__name),__libc_opendir,(__name))
...
struct __dirstream;
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1)),struct dirent *,__NOTHROW_RPC,__localdep_readdir,(struct __dirstream *__restrict __dirp),readdirk,(__dirp))
#elif defined(__CRT_HAVE_readdirk64) && defined(__CRT_KOS) && (defined(__USE_FILE_OFFSET64) || defined(_DIRENT_MATCHES_DIRENT64))
__NAMESPACE_LOCAL_END
struct __dirstream;
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1)),struct dirent *,__NOTHROW_RPC,__localdep_readdir,(struct __dirstream *__restrict __dirp),readdirk64,(__dirp))
#elif defined(__CRT_HAVE_readdir) && !defined(__CRT_KOS) && (!defined(__USE_FILE_OFFSET64) || defined(_DIRENT_MATCHES_DIRENT64))
__NAMESPACE_LOCAL_END
struct __dirstream;
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1)),struct dirent *,__NOTHROW_RPC,__localdep_readdir,(struct __dirstream *__restrict __dirp),readdir,(__dirp))
#elif defined(__CRT_HAVE___libc_readdir) && !defined(__CRT_KOS) && (!defined(__USE_FILE_OFFSET64) || defined(_DIRENT_MATCHES_DIRENT64))
__NAMESPACE_LOCAL_END
struct __dirstream;
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1)),struct dirent *,__NOTHROW_RPC,__localdep_readdir,(struct __dirstream *__restrict __dirp),__libc_readdir,(__dirp))
#elif defined(__CRT_HAVE_readdir64) && !defined(__CRT_KOS) && (defined(__USE_FILE_OFFSET64) || defined(_DIRENT_MATCHES_DIRENT64))
__NAMESPACE_LOCAL_END
struct __dirstream;
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1)),struct dirent *,__NOTHROW_RPC,__localdep_readdir,(struct __dirstream *__restrict __dirp),readdir64,(__dirp))
#elif defined(__USE_DOS_DIRENT)
__NAMESPACE_LOCAL_END
