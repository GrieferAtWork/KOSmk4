...
__CEIREDIRECT(__ATTR_SENTINEL __ATTR_IN(1) __ATTR_IN_OPT(2),int,__NOTHROW_RPC,__localdep_execl,(char const *__restrict __path, char const *__args, ...),execl,{ return __builtin_execl(__path, __args, __builtin_va_arg_pack()); })
#elif defined(__CRT_HAVE_execl)
__LIBC __ATTR_SENTINEL __ATTR_IN(1) __ATTR_IN_OPT(2) int __NOTHROW_RPC(__VLIBCCALL __localdep_execl)(char const *__restrict __path, char const *__args, ...) __CASMNAME("execl");
#elif defined(__CRT_HAVE__execl)
__LIBC __ATTR_SENTINEL __ATTR_IN(1) __ATTR_IN_OPT(2) int __NOTHROW_RPC(__VLIBCCALL __localdep_execl)(char const *__restrict __path, char const *__args, ...) __CASMNAME("_execl");
...
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(1),char *,__NOTHROW_NCX,__localdep_secure_getenv,(char const *__varname),secure_getenv,(__varname))
#elif defined(__CRT_HAVE___secure_getenv)
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(1),char *,__NOTHROW_NCX,__localdep_secure_getenv,(char const *__varname),__secure_getenv,(__varname))
#elif defined(__CRT_HAVE___libc_secure_getenv)
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(1),char *,__NOTHROW_NCX,__localdep_secure_getenv,(char const *__varname),__libc_secure_getenv,(__varname))
#else /* ... */
__NAMESPACE_LOCAL_END
#include <libc/template/__libc_enable_secure.h>
__NAMESPACE_LOCAL_BEGIN
#if defined(__CRT_HAVE_getenv) && !defined(__LOCAL___libc_enable_secure)
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(1),char *,__NOTHROW_NCX,__localdep_secure_getenv,(char const *__varname),getenv,(__varname))
...
__LOCAL_LIBC(shexec) __ATTR_IN_OPT(1) int
