...
#define __local_strtoul_r_defined 1
#include <__crt.h>
#include <features.h>
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(strtoul_r))(char const *__restrict __nptr, char **__endptr, __STDC_INT_AS_UINT_T __base, __errno_t *__error) {
	...
	return (unsigned long)__localdep_strtou64_r(__nptr, __endptr, __base, __error);
#elif __SIZEOF_LONG__ >= 4
	return (unsigned long)__localdep_strtou32_r(__nptr, __endptr, __base, __error);
#else /* ... */
...
#define __local___localdep_strtoul_r_defined 1
