...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(qsort_s) __ATTR_INOUT_OPT(1) __ATTR_NONNULL((4)) void
__NOTHROW_CB_NCX(__LIBCCALL __LIBC_LOCAL_NAME(qsort_s))(void *__base, __SIZE_TYPE__ __elem_count, __SIZE_TYPE__ __elem_size, int (__LIBCCALL *__compar)(void *__arg, void const *__a, void const *__b), void *__arg) {
