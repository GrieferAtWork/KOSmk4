...
#define __local_strto64_defined
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(strto64) __ATTR_LEAF __ATTR_IN(1) __ATTR_OUT_OPT(2) __INT64_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(strto64))(char const *__restrict __nptr, char **__endptr, __STDC_INT_AS_UINT_T __base) {
	...
	__errno_t __error;
	__result = (__NAMESPACE_LOCAL_SYM __localdep_strto64_r)(__nptr, __endptr, __base, &__error);
	if (__error == __ERANGE)
		(void)__libc_seterrno(__ERANGE);
	return __result;
#else /* __libc_geterrno && __ERANGE */
	return (__NAMESPACE_LOCAL_SYM __localdep_strto64_r)(__nptr, __endptr, __base, __NULLPTR);
