...
(__LIBCCALL __LIBC_LOCAL_NAME(verror_at_line))(int __status, __errno_t __errnum, char const *__filename, unsigned int __line, char const *__format, __builtin_va_list __args) __THROWS(...) {
