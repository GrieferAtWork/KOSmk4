 ...
 */
#ifndef __local_isdigit_defined
...
#include <hybrid/byteorder.h>
	...
	return ((__localdep___locale_ctype_ptr() + 1)[__ch & 0xff] & 4) != 0;
#elif defined(__CRT_HAVE__isctype) && defined(__CRT_DOS)
	return __localdep__isctype(__ch, 0x0004);
#else /* ... */
	return (__UINT8_TYPE__)__ch >= 0x30 && (__UINT8_TYPE__)__ch <= 0x39;
#endif /* !... */
