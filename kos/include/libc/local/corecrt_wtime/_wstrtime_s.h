...
#if defined(__CRT_HAVE__wstrtime) || defined(__CRT_HAVE__strtime) || defined(__CRT_HAVE_time64) || defined(__CRT_HAVE__time64) || defined(__CRT_HAVE_time) || defined(__CRT_HAVE___time) || defined(__CRT_HAVE___libc_time) || defined(__CRT_HAVE__time32)
...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_ACCESS_WR(1),__WCHAR_TYPE__ *,__NOTHROW_NCX,__localdep__wstrtime,(__WCHAR_TYPE__ __buf[9]),_wstrtime,(__buf))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_wstrtime_s) __ATTR_ACCESS_WRS(1, 2) __errno_t
...
#else /* __CRT_HAVE__wstrtime || __CRT_HAVE__strtime || __CRT_HAVE_time64 || __CRT_HAVE__time64 || __CRT_HAVE_time || __CRT_HAVE___time || __CRT_HAVE___libc_time || __CRT_HAVE__time32 */
#undef __local__wstrtime_s_defined
#endif /* !__CRT_HAVE__wstrtime && !__CRT_HAVE__strtime && !__CRT_HAVE_time64 && !__CRT_HAVE__time64 && !__CRT_HAVE_time && !__CRT_HAVE___time && !__CRT_HAVE___libc_time && !__CRT_HAVE__time32 */
