...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1)),__WCHAR_TYPE__ *,__NOTHROW_NCX,__localdep__wstrtime,(__WCHAR_TYPE__ __buf[9]),_wstrtime,(__buf))
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_wstrtime_s) __ATTR_NONNULL((1)) __errno_t
