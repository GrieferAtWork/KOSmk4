 ...
 */
#ifndef __local_strnunvis_defined
#define __local_strnunvis_defined
#include <__crt.h>
...
__LOCAL_LIBC(strnunvis) __ATTR_IN(2) __ATTR_OUTS(1, 3) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(strnunvis))(char *__dst, char const *__src, __SIZE_TYPE__ __dstsize) {
...
#endif /* !__local_strnunvis_defined */
