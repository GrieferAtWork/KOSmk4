 ...
 */
#ifndef __local_strnvis_netbsd_defined
#define __local_strnvis_netbsd_defined
#include <__crt.h>
...
__LOCAL_LIBC(strnvis_netbsd) __ATTR_OUTS(1, 2) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(strnvis_netbsd))(char *__dst, __SIZE_TYPE__ __dstsize, char const *__src, int __flags) {
...
#endif /* !__local_strnvis_netbsd_defined */
