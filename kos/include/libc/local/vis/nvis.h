 ...
 */
#ifndef __local_nvis_defined
#define __local_nvis_defined
#include <__crt.h>
...
__LOCAL_LIBC(nvis) __ATTR_OUTS(1, 2) char *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(nvis))(char *__dst, __SIZE_TYPE__ __dstsize, int __c, int __flags, int __nextc) {
	return (__NAMESPACE_LOCAL_SYM __localdep_snvis)(__dst, __dstsize, __c, __flags, __nextc, "");
}
__NAMESPACE_LOCAL_END
