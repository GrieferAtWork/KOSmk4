 ...
 */
#ifndef __local__cscanf_defined
#define __local__cscanf_defined
#include <__crt.h>
#include <features.h>
...
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_SCANF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_RPC,__localdep__vcscanf,(char const *__format, __builtin_va_list __args),_vcscanf,(__format,__args))
...
__LOCAL_LIBC(_cscanf) __ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_SCANF(1, 2) __STDC_INT_AS_SSIZE_T
__NOTHROW_RPC(__VLIBCCALL __LIBC_LOCAL_NAME(_cscanf))(char const *__format, ...) {
	__STDC_INT_AS_SSIZE_T __result;
	__builtin_va_list __args;
	__builtin_va_start(__args, __format);
	__result = (__NAMESPACE_LOCAL_SYM __localdep__vcscanf)(__format, __args);
