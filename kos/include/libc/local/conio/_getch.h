...
__CREDIRECT(__ATTR_WUNUSED,int,__NOTHROW_RPC,__localdep__getch_nolock,(void),_getch_nolock,())
#elif defined(__CRT_HAVE__getch)
__CREDIRECT(__ATTR_WUNUSED,int,__NOTHROW_RPC,__localdep__getch_nolock,(void),_getch,())
...
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(_getch))(void) {
	int __result;
