...
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_SCANF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_RPC,__localdep__vcscanf_l,(char const *__format, __locale_t __locale, __builtin_va_list __args),_vcscanf_l,(__format,__locale,__args))
...
__LOCAL_LIBC(_vcscanf) __ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_SCANF(1, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(_vcscanf))(char const *__format, __builtin_va_list __args) {
