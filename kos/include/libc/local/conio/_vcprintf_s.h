...
__LOCAL_LIBC(_vcprintf_s) __ATTR_IN(1) __ATTR_LIBC_PRINTF(1, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(_vcprintf_s))(char const *__format, __builtin_va_list __args) {
