...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(__conio_common_vcprintf_s) __ATTR_IN(2) __ATTR_LIBC_PRINTF(2, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(__conio_common_vcprintf_s))(__UINT64_TYPE__ __options, char const *__format, __locale_t __locale, __builtin_va_list __args) {
