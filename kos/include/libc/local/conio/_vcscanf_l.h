 ...
 */
#ifndef __local__vcscanf_l_defined
#define __local__vcscanf_l_defined
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_vcscanf_l) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_LIBC_SCANF(1, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_vcscanf_l))(char const *__format, __locale_t __locale, __builtin_va_list __args) {
	return (__NAMESPACE_LOCAL_SYM __localdep___conio_common_vcscanf)(_CRT_INTERNAL_LOCAL_SCANF_OPTIONS, __format, __locale, __args);
}
__NAMESPACE_LOCAL_END
...
#undef __local__vcscanf_l_defined
...
#endif /* !__local__vcscanf_l_defined */
