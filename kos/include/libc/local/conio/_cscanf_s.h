...
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_SCANF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_RPC,__localdep__vcscanf_s,(char const *__format, __builtin_va_list __args),_vcscanf_s,(__format,__args))
...
__LOCAL_LIBC(_cscanf_s) __ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_SCANF(1, 2) __STDC_INT_AS_SSIZE_T
__NOTHROW_RPC(__VLIBCCALL __LIBC_LOCAL_NAME(_cscanf_s))(char const *__format, ...) {
