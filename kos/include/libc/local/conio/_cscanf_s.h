...
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_SCANF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vcscanf_s,(char const *__format, __builtin_va_list __args),_vcscanf_s,(__format,__args))
