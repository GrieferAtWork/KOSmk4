 ...
 */
#ifndef __local_normvideo_defined
#define __local_normvideo_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(normvideo) void
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(normvideo))(void) {
	(__NAMESPACE_LOCAL_SYM __localdep__cputs)("\033[m"); /* AC_DEFATTR */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_normvideo_defined
#define __local___localdep_normvideo_defined
#define __localdep_normvideo __LIBC_LOCAL_NAME(normvideo)
#endif /* !__local___localdep_normvideo_defined */
...
#undef __local_normvideo_defined
#endif /* !__CRT_HAVE__cputs && (!__CRT_HAVE__putch_nolock || !__USE_STDIO_UNLOCKED) && !__CRT_HAVE__putch && (!__CRT_HAVE_stdtty || (!__CRT_HAVE_putc && !__CRT_HAVE_fputc && !__CRT_HAVE__IO_putc && !__CRT_HAVE_putc_unlocked && !__CRT_HAVE_fputc_unlocked && !__CRT_HAVE__putc_nolock && !__CRT_HAVE__fputc_nolock && (!__CRT_DOS || (!__CRT_HAVE__flsbuf && !__CRT_HAVE___swbuf)) && !__CRT_HAVE_fwrite && !__CRT_HAVE__IO_fwrite && !__CRT_HAVE_fwrite_s && !__CRT_HAVE_fwrite_unlocked && !__CRT_HAVE__fwrite_nolock)) */
#endif /* !__local_normvideo_defined */
