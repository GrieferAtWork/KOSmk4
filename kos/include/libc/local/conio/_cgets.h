...
__CREDIRECT(__ATTR_OUT(3) __ATTR_OUTS(1, 2),__errno_t,__NOTHROW_NCX,__localdep__cgets_s,(char *__buf, __SIZE_TYPE__ __bufsize, __SIZE_TYPE__ *__restrict __p_readsize),_cgets_s,(__buf,__bufsize,__p_readsize))
