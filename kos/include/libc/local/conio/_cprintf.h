...
__CREDIRECT(__ATTR_IN(1) __ATTR_LIBC_PRINTF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vcprintf,(char const *__format, __builtin_va_list __args),_vcprintf,(__format,__args))
