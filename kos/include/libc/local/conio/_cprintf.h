...
__CREDIRECT(__ATTR_ACCESS_RO(1) __ATTR_LIBC_PRINTF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vcprintf,(char const *__format, __builtin_va_list __args),_vcprintf,(__format,__args))
...
__LOCAL_LIBC(_cprintf) __ATTR_ACCESS_RO(1) __ATTR_LIBC_PRINTF(1, 2) __STDC_INT_AS_SSIZE_T
