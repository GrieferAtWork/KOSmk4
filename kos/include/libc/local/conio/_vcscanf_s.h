 ...
 */
#ifndef __local__vcscanf_s_defined
#define __local__vcscanf_s_defined
#include <__crt.h>
#include <features.h>
...
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_SCANF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_RPC,__localdep__vcscanf_s_l,(char const *__format, __locale_t __locale, __builtin_va_list __args),_vcscanf_s_l,(__format,__locale,__args))
...
#else /* ... */
#undef __local___localdep__vcscanf_s_l_defined
#endif /* !... */
#endif /* !__local___localdep__vcscanf_s_l_defined */
__LOCAL_LIBC(_vcscanf_s) __ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_SCANF(1, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(_vcscanf_s))(char const *__format, __builtin_va_list __args) {
	return (__NAMESPACE_LOCAL_SYM __localdep__vcscanf_s_l)(__format, __NULLPTR, __args);
}
__NAMESPACE_LOCAL_END
...
#endif /* !__local__vcscanf_s_defined */
