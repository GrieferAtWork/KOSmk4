...
__LIBC __ATTR_ACCESS_RO(1) __ATTR_LIBC_PRINTF(1, 2) __STDC_INT_AS_SSIZE_T __NOTHROW_NCX(__VLIBCCALL __localdep__cprintf)(char const *__format, ...) __CASMNAME("_cprintf");
