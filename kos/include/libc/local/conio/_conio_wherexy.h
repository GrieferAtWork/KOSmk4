...
__LIBC __ATTR_WUNUSED __ATTR_LIBC_SCANF(1, 2) __ATTR_NONNULL((1)) __STDC_INT_AS_SSIZE_T __NOTHROW_NCX(__VLIBCCALL __localdep__cscanf)(char const *__format, ...) __CASMNAME("_cscanf");
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_conio_wherexy) int
