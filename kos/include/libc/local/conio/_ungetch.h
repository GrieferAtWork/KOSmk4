 ...
 */
#ifndef __local__ungetch_defined
#define __local__ungetch_defined
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_ungetch) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_ungetch))(int __ch) {
	return (__NAMESPACE_LOCAL_SYM __localdep_ungetc)(__ch, __LOCAL_stdtty);
}
__NAMESPACE_LOCAL_END
