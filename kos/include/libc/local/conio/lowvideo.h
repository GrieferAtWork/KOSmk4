 ...
 */
#ifndef __local_lowvideo_defined
#define __local_lowvideo_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(lowvideo) void
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(lowvideo))(void) {
	(__NAMESPACE_LOCAL_SYM __localdep__cputs)("\033[2m"); /* AC_FGDARK */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_lowvideo_defined
#define __local___localdep_lowvideo_defined
#define __localdep_lowvideo __LIBC_LOCAL_NAME(lowvideo)
#endif /* !__local___localdep_lowvideo_defined */
...
#undef __local_lowvideo_defined
#endif /* !__CRT_HAVE__cputs && (!__CRT_HAVE__putch_nolock || !__USE_STDIO_UNLOCKED) && !__CRT_HAVE__putch && (!__CRT_HAVE_stdtty || (!__CRT_HAVE_putc && !__CRT_HAVE_fputc && !__CRT_HAVE__IO_putc && !__CRT_HAVE_putc_unlocked && !__CRT_HAVE_fputc_unlocked && !__CRT_HAVE__putc_nolock && !__CRT_HAVE__fputc_nolock && (!__CRT_DOS || (!__CRT_HAVE__flsbuf && !__CRT_HAVE___swbuf)) && !__CRT_HAVE_fwrite && !__CRT_HAVE__IO_fwrite && !__CRT_HAVE_fwrite_s && !__CRT_HAVE_fwrite_unlocked && !__CRT_HAVE__fwrite_nolock)) */
#endif /* !__local_lowvideo_defined */
