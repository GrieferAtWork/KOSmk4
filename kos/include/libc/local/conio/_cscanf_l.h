...
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_LIBC_SCANF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vcscanf_l,(char const *__format, __locale_t __locale, __builtin_va_list __args),_vcscanf_l,(__format,__locale,__args))
...
__LOCAL_LIBC(_cscanf_l) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_LIBC_SCANF(1, 3) __STDC_INT_AS_SSIZE_T
