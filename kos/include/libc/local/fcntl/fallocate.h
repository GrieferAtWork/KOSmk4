...
__CREDIRECT(__ATTR_FDWRITE(1),int,__NOTHROW_NCX,__localdep_fallocate64,(__fd_t __fd, __STDC_INT_AS_UINT_T __mode, __PIO_OFFSET64 __offset, __PIO_OFFSET64 __length),fallocate,(__fd,__mode,__offset,__length))
#elif defined(__CRT_HAVE_fallocate64)
__CREDIRECT(__ATTR_FDWRITE(1),int,__NOTHROW_NCX,__localdep_fallocate64,(__fd_t __fd, __STDC_INT_AS_UINT_T __mode, __PIO_OFFSET64 __offset, __PIO_OFFSET64 __length),fallocate64,(__fd,__mode,__offset,__length))
#else /* ... */
...
__LOCAL_LIBC(fallocate) __ATTR_FDARG(1) int
