...
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RW(1) __ATTR_LIBC_SCANF(2, 0) __ATTR_NONNULL((2)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep_vfscanf_s,(__FILE *__stream, char const *__format, __builtin_va_list __args),vfscanf_s,(__stream,__format,__args))
...
__LOCAL_LIBC(fscanf_s) __ATTR_WUNUSED __ATTR_ACCESS_RW(1) __ATTR_LIBC_SCANF(2, 3) __ATTR_NONNULL((2)) __STDC_INT_AS_SSIZE_T
