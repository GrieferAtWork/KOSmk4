 ...
 */
#ifndef __local_tmpfile64_defined
#define __local_tmpfile64_defined
#include <__crt.h>
...
#include <bits/types.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_WUNUSED __ATTR_INOUT(1),__fd_t,__NOTHROW_RPC,__localdep_mkstemp64,(char *__template_),mkstemp,(__template_))
#elif defined(__CRT_HAVE_mkstemp64)
__NAMESPACE_LOCAL_END
#include <bits/types.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_WUNUSED __ATTR_INOUT(1),__fd_t,__NOTHROW_RPC,__localdep_mkstemp64,(char *__template_),mkstemp64,(__template_))
...
#else /* ... */
#undef __local___localdep_mkstemp64_defined
#endif /* !... */
...
#include <paths.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(tmpfile64) __ATTR_WUNUSED __FILE *
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(tmpfile64))(void) {
	__FILE *__result;
	__fd_t __tmpfd;
#ifndef _PATH_TMP
#define _PATH_TMP "/tmp/"
	...
	(void)(__NAMESPACE_LOCAL_SYM __localdep_memcpy)(__tmpfd_name_buf, _PATH_TMP "tmp.XXXXXX", sizeof(__tmpfd_name_buf));
	{
		...
		__tmpfd = (__NAMESPACE_LOCAL_SYM __localdep_mkstemp64)(__tmpfd_name_buf);
...
#undef __local_tmpfile64_defined
#endif /* (!__CRT_HAVE_fdopen && !__CRT_HAVE__fdopen && !__CRT_HAVE__IO_fdopen) || ((!__CRT_HAVE_mkstemp || (__O_LARGEFILE && __O_LARGEFILE)) && !__CRT_HAVE_mkstemp64 && (!__CRT_HAVE_mkstemps || (__O_LARGEFILE && __O_LARGEFILE)) && !__CRT_HAVE_mkstemps64 && (!__CRT_HAVE_mkostemps || (__O_LARGEFILE && __O_LARGEFILE)) && !__CRT_HAVE_mkostemps64 && !__CRT_HAVE_open64 && !__CRT_HAVE___open64 && !__CRT_HAVE_open && !__CRT_HAVE__open && !__CRT_HAVE___open && !__CRT_HAVE___libc_open && (!__AT_FDCWD || (!__CRT_HAVE_openat64 && !__CRT_HAVE_openat))) || (!__CRT_HAVE_sigprocmask && !__CRT_HAVE___sigprocmask && !__CRT_HAVE___libc_sigprocmask && !__CRT_HAVE_pthread_sigmask && !__CRT_HAVE_thr_sigsetmask) || (!__CRT_HAVE_unlink && !__CRT_HAVE__unlink && !__CRT_HAVE___unlink && !__CRT_HAVE___libc_unlink && (!__AT_FDCWD || !__CRT_HAVE_unlinkat)) || !__SIG_SETMASK */
#endif /* !__local_tmpfile64_defined */
