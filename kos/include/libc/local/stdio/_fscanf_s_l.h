...
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RW(1) __ATTR_LIBC_SCANF(2, 0) __ATTR_NONNULL((2)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vfscanf_s_l,(__FILE *__stream, char const *__format, __locale_t __locale, __builtin_va_list __args),_vfscanf_s_l,(__stream,__format,__locale,__args))
...
__LOCAL_LIBC(_fscanf_s_l) __ATTR_WUNUSED __ATTR_ACCESS_RW(1) __ATTR_LIBC_SCANF(2, 4) __ATTR_NONNULL((2)) __STDC_INT_AS_SSIZE_T
