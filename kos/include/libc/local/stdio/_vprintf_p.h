...
__LOCAL_LIBC(_vprintf_p) __ATTR_IN(1) __ATTR_LIBC_PRINTF_P(1, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_CB_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_vprintf_p))(char const *__format, __builtin_va_list __args) {
