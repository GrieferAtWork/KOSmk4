...
__NOTHROW_NCX(__VLIBCCALL __LIBC_LOCAL_NAME(_sprintf_p))(char *__restrict __buf, __SIZE_TYPE__ __bufsize, char const *__restrict __format, ...) {
...
#define __local___localdep__sprintf_p_defined 1
