...
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(2) __ATTR_INOUT(1) __ATTR_LIBC_SCANF(2, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_CB,__localdep__vfscanf_s_l,(__FILE *__stream, char const *__format, __locale_t __locale, __builtin_va_list __args),_vfscanf_s_l,(__stream,__format,__locale,__args))
...
__LOCAL_LIBC(_vscanf_s_l) __ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_SCANF(1, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_CB(__LIBCCALL __LIBC_LOCAL_NAME(_vscanf_s_l))(char const *__format, __locale_t __locale, __builtin_va_list __args) {
