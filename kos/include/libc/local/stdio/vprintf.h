...
__LOCAL_LIBC(vprintf) __ATTR_IN(1) __ATTR_LIBC_PRINTF(1, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_CB_NCX(__LIBCCALL __LIBC_LOCAL_NAME(vprintf))(char const *__restrict __format, __builtin_va_list __args) {
