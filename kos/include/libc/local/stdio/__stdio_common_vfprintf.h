...
__NOTHROW_CB(__LIBCCALL __LIBC_LOCAL_NAME(__stdio_common_vfprintf))(__UINT64_TYPE__ __options, __FILE *__stream, char const *__format, __locale_t __locale, __builtin_va_list __args) {
	(void)__locale;
	(void)__options;
