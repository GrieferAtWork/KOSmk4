...
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_PRINTF_P(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vscprintf_p,(char const *__format, __builtin_va_list __args),_vscprintf_p,(__format,__args))
...
__LOCAL_LIBC(_scprintf_p) __ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_PRINTF_P(1, 2) __STDC_INT_AS_SSIZE_T
