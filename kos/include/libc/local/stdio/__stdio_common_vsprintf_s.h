 ...
 */
#ifndef __local___stdio_common_vsprintf_s_defined
#define __local___stdio_common_vsprintf_s_defined
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(__stdio_common_vsprintf_s) __ATTR_ACCESS_RO(4) __ATTR_LIBC_PRINTF(4, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(__stdio_common_vsprintf_s))(__UINT64_TYPE__ __options, char *__buf, __SIZE_TYPE__ __bufsize, char const *__format, __locale_t __locale, __builtin_va_list __args) {
	__STDC_INT_AS_SSIZE_T __result;
	(void)__options;
	(void)__locale;
	__result = (__NAMESPACE_LOCAL_SYM __localdep_vsnprintf)(__buf, __bufsize, __format, __args);
	__hybrid_assert(((__SIZE_TYPE__)__result + 1) <= __bufsize);
	return __result;
}
__NAMESPACE_LOCAL_END
...
#endif /* !__local___stdio_common_vsprintf_s_defined */
