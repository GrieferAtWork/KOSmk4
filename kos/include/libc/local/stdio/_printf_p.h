...
__CREDIRECT(__ATTR_LIBC_PRINTF(1, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vprintf_p,(char const *__format, __builtin_va_list __args),_vprintf_p,(__format,__args))
...
__LOCAL_LIBC(_printf_p) __ATTR_LIBC_PRINTF(1, 2) __ATTR_NONNULL((1)) __STDC_INT_AS_SSIZE_T
