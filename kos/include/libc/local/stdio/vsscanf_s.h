...
__CREDIRECT(__ATTR_WUNUSED __ATTR_LIBC_SCANF(2, 0) __ATTR_NONNULL((1, 2)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vsscanf_s_l,(char const *__buf, char const *__format, __locale_t __locale, __builtin_va_list __args),_vsscanf_s_l,(__buf,__format,__locale,__args))
...
__LOCAL_LIBC(vsscanf_s) __ATTR_WUNUSED __ATTR_LIBC_SCANF(2, 0) __ATTR_NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T
