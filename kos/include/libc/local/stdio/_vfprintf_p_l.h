...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_IN(3) __ATTR_INOUT(2) __ATTR_LIBC_PRINTF_P(3, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_CB,__localdep___stdio_common_vfprintf_p,(__UINT64_TYPE__ __options, __FILE *__stream, char const *__format, __locale_t __locale, __builtin_va_list __args),__stdio_common_vfprintf_p,(__options,__stream,__format,__locale,__args))
...
__NOTHROW_CB(__LIBCCALL __LIBC_LOCAL_NAME(_vfprintf_p_l))(__FILE *__stream, char const *__format, __locale_t __locale, __builtin_va_list __args) {
