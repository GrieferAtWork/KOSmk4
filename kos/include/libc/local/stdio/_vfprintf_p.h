...
__LOCAL_LIBC(_vfprintf_p) __ATTR_IN(2) __ATTR_INOUT(1) __ATTR_LIBC_PRINTF_P(2, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_CB_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_vfprintf_p))(__FILE *__stream, char const *__format, __builtin_va_list __args) {
