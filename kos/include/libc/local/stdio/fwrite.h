...
__NOTHROW_CB_NCX(__LIBCCALL __LIBC_LOCAL_NAME(fwrite))(void const *__restrict __buf, __SIZE_TYPE__ __elemsize, __SIZE_TYPE__ __elemcount, __FILE *__restrict __stream) {
