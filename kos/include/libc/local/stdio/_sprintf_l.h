...
__NOTHROW_NCX(__VLIBCCALL __LIBC_LOCAL_NAME(_sprintf_l))(char *__restrict __buf, char const *__restrict __format, __locale_t __locale, ...) {
...
#define __local___localdep__sprintf_l_defined 1
