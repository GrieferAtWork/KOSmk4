...
__CREDIRECT(__ATTR_IN(1) __ATTR_LIBC_PRINTF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_CB,__localdep_vprintf_s,(char const *__format, __builtin_va_list __args),vprintf_s,(__format,__args))
...
__NOTHROW_CB(__VLIBCCALL __LIBC_LOCAL_NAME(printf_s))(char const *__format, ...) {
