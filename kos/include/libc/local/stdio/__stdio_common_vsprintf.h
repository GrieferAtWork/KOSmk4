 ...
 */
#ifndef __local___stdio_common_vsprintf_defined
#define __local___stdio_common_vsprintf_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(__stdio_common_vsprintf) __ATTR_ACCESS_RO(4) __ATTR_LIBC_PRINTF(4, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(__stdio_common_vsprintf))(__UINT64_TYPE__ __options, char *__buf, __SIZE_TYPE__ __bufsize, char const *__format, __locale_t __locale, __builtin_va_list __args) {
...
#endif /* !__local___stdio_common_vsprintf_defined */
