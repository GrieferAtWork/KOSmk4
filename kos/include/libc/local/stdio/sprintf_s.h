...
__CREDIRECT(__ATTR_ACCESS_RO(3) __ATTR_ACCESS_WRS(1, 2) __ATTR_LIBC_PRINTF(3, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep_vsprintf_s,(char *__buf, __SIZE_TYPE__ __bufsize, char const *__format, __builtin_va_list __args),vsprintf_s,(__buf,__bufsize,__format,__args))
...
__LOCAL_LIBC(sprintf_s) __ATTR_ACCESS_RO(3) __ATTR_ACCESS_WRS(1, 2) __ATTR_LIBC_PRINTF(3, 4) __STDC_INT_AS_SSIZE_T
