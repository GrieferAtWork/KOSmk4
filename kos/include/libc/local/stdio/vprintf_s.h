...
__CREDIRECT(__ATTR_LIBC_PRINTF(1, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vprintf_s_l,(char const *__format, __locale_t __locale, __builtin_va_list __args),_vprintf_s_l,(__format,__locale,__args))
...
__LOCAL_LIBC(vprintf_s) __ATTR_LIBC_PRINTF(1, 0) __ATTR_NONNULL((1)) __STDC_INT_AS_SSIZE_T
