...
__CEIREDIRECT(__ATTR_IN(1) __ATTR_INOUT(2),__STDC_INT_AS_SSIZE_T,__NOTHROW_CB_NCX,__localdep_fputs,(char const *__restrict __string, __FILE *__restrict __stream),fputs_unlocked,{ return __builtin_fputs_unlocked(__string, __stream); })
#elif defined(__CRT_HAVE_fputs_unlocked) && defined(__USE_STDIO_UNLOCKED)
__CREDIRECT(__ATTR_IN(1) __ATTR_INOUT(2),__STDC_INT_AS_SSIZE_T,__NOTHROW_CB_NCX,__localdep_fputs,(char const *__restrict __string, __FILE *__restrict __stream),fputs_unlocked,(__string,__stream))
#elif __has_builtin(__builtin_fputs) && defined(__LIBC_BIND_CRTBUILTINS) && defined(__CRT_HAVE_fputs)
__CEIREDIRECT(__ATTR_IN(1) __ATTR_INOUT(2),__STDC_INT_AS_SSIZE_T,__NOTHROW_CB_NCX,__localdep_fputs,(char const *__restrict __string, __FILE *__restrict __stream),fputs,{ return __builtin_fputs(__string, __stream); })
#elif defined(__CRT_HAVE_fputs)
__CREDIRECT(__ATTR_IN(1) __ATTR_INOUT(2),__STDC_INT_AS_SSIZE_T,__NOTHROW_CB_NCX,__localdep_fputs,(char const *__restrict __string, __FILE *__restrict __stream),fputs,(__string,__stream))
#elif defined(__CRT_HAVE__IO_fputs)
__CREDIRECT(__ATTR_IN(1) __ATTR_INOUT(2),__STDC_INT_AS_SSIZE_T,__NOTHROW_CB_NCX,__localdep_fputs,(char const *__restrict __string, __FILE *__restrict __stream),_IO_fputs,(__string,__stream))
...
__NOTHROW_CB_NCX(__LIBCCALL __LIBC_LOCAL_NAME(puts))(char const *__restrict __string) {
