...
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(3) __ATTR_ACCESS_ROS(1, 2) __ATTR_LIBC_SCANF(3, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vsnscanf_s,(char const *__buf, __SIZE_TYPE__ __bufsize, char const *__format, __builtin_va_list __args),_vsnscanf_s,(__buf,__bufsize,__format,__args))
...
__LOCAL_LIBC(_snscanf_s) __ATTR_WUNUSED __ATTR_ACCESS_RO(3) __ATTR_ACCESS_ROS(1, 2) __ATTR_LIBC_SCANF(3, 4) __STDC_INT_AS_SSIZE_T
