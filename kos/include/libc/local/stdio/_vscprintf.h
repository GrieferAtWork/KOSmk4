...
#define __local__vscprintf_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(_vscprintf) __ATTR_WUNUSED __ATTR_LIBC_PRINTF(1, 0) __ATTR_NONNULL((1)) __STDC_INT_AS_SSIZE_T
