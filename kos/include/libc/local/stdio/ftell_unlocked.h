...
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1)),long int,__THROWING,__localdep_ftell,(__FILE *__restrict __stream),ftell64_unlocked,(__stream))
...
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1)),long int,__THROWING,__localdep_ftell,(__FILE *__restrict __stream),ftell64,(__stream))
...
__LOCAL_LIBC(ftell_unlocked) __ATTR_WUNUSED __ATTR_NONNULL((1)) long int
