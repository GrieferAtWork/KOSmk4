...
#define __local_funopen_defined 1
#include <__crt.h>
#include <features.h>
...
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(funopen))(void const *__cookie, __funopen_readfn_t __readfn, __funopen_writefn_t __writefn, __funopen_seekfn_t __seekfn, __funopen_closefn_t __closefn) {
	__FILE *__result;
	struct __NAMESPACE_LOCAL_SYM __funopen_holder *__holder;

	if (!__seekfn)
		return __localdep_funopen64(__cookie, __readfn, __writefn, __NULLPTR, __closefn);

	__holder = (struct __NAMESPACE_LOCAL_SYM __funopen_holder *)__localdep_malloc(sizeof(struct __NAMESPACE_LOCAL_SYM __funopen_holder));
...
#if defined(__CRT_HAVE_funopen2_64) || defined(__CRT_HAVE_funopen2)
	__result = __localdep_funopen2(/* cookie:  */ __holder,
...
#else /* (__CRT_HAVE_malloc || __CRT_HAVE_calloc || __CRT_HAVE_realloc || __CRT_HAVE_memalign || __CRT_HAVE_aligned_alloc || __CRT_HAVE_posix_memalign) && (__CRT_HAVE_funopen2_64 || __CRT_HAVE_funopen2 || __CRT_HAVE_fopencookie || __CRT_HAVE_funopen64 || __CRT_HAVE_funopen) */
#undef __local_funopen_defined
#endif /* (!__CRT_HAVE_malloc && !__CRT_HAVE_calloc && !__CRT_HAVE_realloc && !__CRT_HAVE_memalign && !__CRT_HAVE_aligned_alloc && !__CRT_HAVE_posix_memalign) || (!__CRT_HAVE_funopen2_64 && !__CRT_HAVE_funopen2 && !__CRT_HAVE_fopencookie && !__CRT_HAVE_funopen64 && !__CRT_HAVE_funopen) */
