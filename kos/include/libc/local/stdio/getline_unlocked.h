...
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RW(4) __ATTR_NONNULL((1, 2)),__SSIZE_TYPE__,__THROWING,__localdep_getdelim_unlocked,(char **__restrict __lineptr, __SIZE_TYPE__ *__restrict __pcount, int __delimiter, __FILE *__restrict __stream),getdelim_unlocked,(__lineptr,__pcount,__delimiter,__stream))
#elif defined(__CRT_HAVE_getdelim)
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RW(4) __ATTR_NONNULL((1, 2)),__SSIZE_TYPE__,__THROWING,__localdep_getdelim_unlocked,(char **__restrict __lineptr, __SIZE_TYPE__ *__restrict __pcount, int __delimiter, __FILE *__restrict __stream),getdelim,(__lineptr,__pcount,__delimiter,__stream))
#elif defined(__CRT_HAVE___getdelim)
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RW(4) __ATTR_NONNULL((1, 2)),__SSIZE_TYPE__,__THROWING,__localdep_getdelim_unlocked,(char **__restrict __lineptr, __SIZE_TYPE__ *__restrict __pcount, int __delimiter, __FILE *__restrict __stream),__getdelim,(__lineptr,__pcount,__delimiter,__stream))
#elif defined(__CRT_HAVE__IO_getdelim)
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RW(4) __ATTR_NONNULL((1, 2)),__SSIZE_TYPE__,__THROWING,__localdep_getdelim_unlocked,(char **__restrict __lineptr, __SIZE_TYPE__ *__restrict __pcount, int __delimiter, __FILE *__restrict __stream),_IO_getdelim,(__lineptr,__pcount,__delimiter,__stream))
...
__LOCAL_LIBC(getline_unlocked) __ATTR_WUNUSED __ATTR_ACCESS_RW(3) __ATTR_NONNULL((1, 2)) __SSIZE_TYPE__
