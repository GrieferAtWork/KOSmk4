...
__CREDIRECT(__ATTR_IN(2) __ATTR_INOUT(1) __ATTR_LIBC_PRINTF_P(2, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vfprintf_p,(__FILE *__stream, char const *__format, __builtin_va_list __args),_vfprintf_p,(__stream,__format,__args))
