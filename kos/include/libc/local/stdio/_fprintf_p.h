...
__CREDIRECT(__ATTR_LIBC_PRINTF(2, 0) __ATTR_NONNULL((1, 2)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vfprintf_p,(__FILE *__stream, char const *__format, __builtin_va_list __args),_vfprintf_p,(__stream,__format,__args))
...
__LOCAL_LIBC(_fprintf_p) __ATTR_LIBC_PRINTF(2, 3) __ATTR_NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T
