...
__LOCAL_LIBC(vsnprintf_s) __ATTR_ACCESS_RO(4) __ATTR_ACCESS_WRS(1, 2) __ATTR_LIBC_PRINTF(4, 0) __STDC_INT_AS_SSIZE_T
...
#define __local___localdep_vsnprintf_s_defined
