...
__NOTHROW_CB_NCX(__LIBCCALL __LIBC_LOCAL_NAME(vfprintf_unlocked))(__FILE *__restrict __stream, char const *__restrict __format, __builtin_va_list __args) {
