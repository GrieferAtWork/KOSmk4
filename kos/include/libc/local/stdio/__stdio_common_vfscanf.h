...
__LOCAL_LIBC(__stdio_common_vfscanf) __ATTR_WUNUSED __ATTR_IN(3) __ATTR_INOUT(2) __ATTR_LIBC_SCANF(3, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_CB_NCX(__LIBCCALL __LIBC_LOCAL_NAME(__stdio_common_vfscanf))(__UINT64_TYPE__ __options, __FILE *__stream, char const *__format, __locale_t __locale, __builtin_va_list __args) {
	(void)__options;
	(void)__locale;
