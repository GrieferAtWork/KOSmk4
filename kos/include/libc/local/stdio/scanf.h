...
__LOCAL_LIBC(scanf) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) __ATTR_LIBC_SCANF(1, 2) __STDC_INT_AS_SIZE_T
(__VLIBCCALL __LIBC_LOCAL_NAME(scanf))(char const *__restrict __format, ...) __THROWS(...) {
