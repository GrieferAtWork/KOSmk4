...
__NOTHROW_CB(__LIBCCALL __LIBC_LOCAL_NAME(fread))(void *__restrict __buf, __SIZE_TYPE__ __elemsize, __SIZE_TYPE__ __elemcount, __FILE *__restrict __stream) {
