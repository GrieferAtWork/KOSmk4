...
__NAMESPACE_LOCAL_END
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(__stdio_common_vsscanf) __ATTR_WUNUSED __ATTR_ACCESS_RO(4) __ATTR_ACCESS_ROS(2, 3) __ATTR_LIBC_SCANF(4, 0) __STDC_INT_AS_SSIZE_T
