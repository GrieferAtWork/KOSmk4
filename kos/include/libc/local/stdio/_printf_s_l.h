...
#define __local___localdep__vprintf_s_l_defined 1
#ifdef __CRT_HAVE__vprintf_l
__CREDIRECT(__ATTR_LIBC_PRINTF(1, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SIZE_T,__THROWING,__localdep__vprintf_s_l,(char const *__restrict __format, __locale_t __locale, __builtin_va_list __args),_vprintf_l,(__format,__locale,__args))
#elif defined(__CRT_HAVE__vprintf_s_l)
__CREDIRECT(__ATTR_LIBC_PRINTF(1, 0) __ATTR_NONNULL((1)),__STDC_INT_AS_SIZE_T,__THROWING,__localdep__vprintf_s_l,(char const *__restrict __format, __locale_t __locale, __builtin_va_list __args),_vprintf_s_l,(__format,__locale,__args))
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep__vprintf_s_l __LIBC_LOCAL_NAME(_vprintf_l)
#else /* ... */
...
(__VLIBCCALL __LIBC_LOCAL_NAME(_printf_s_l))(char const *__restrict __format, __locale_t __locale, ...) __THROWS(...) {
	__STDC_INT_AS_SIZE_T __result;
	__builtin_va_list __args;
	__builtin_va_start(__args, __locale);
	__result = (__NAMESPACE_LOCAL_SYM __localdep__vprintf_s_l)(__format, __locale, __args);
	__builtin_va_end(__args);
	return __result;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__printf_s_l_defined
#define __local___localdep__printf_s_l_defined 1
#define __localdep__printf_s_l __LIBC_LOCAL_NAME(_printf_s_l)
#endif /* !__local___localdep__printf_s_l_defined */
...
#undef __local__printf_s_l_defined
