 ...
 */
#ifndef __local__vfscanf_s_l_defined
#define __local__vfscanf_s_l_defined
#include <__crt.h>
#include <features.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(_vfscanf_s_l) __ATTR_WUNUSED __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1) __ATTR_LIBC_SCANF(2, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_vfscanf_s_l))(__FILE *__stream, char const *__format, __locale_t __locale, __builtin_va_list __args) {
	return (__NAMESPACE_LOCAL_SYM __localdep___stdio_common_vfscanf)(_CRT_INTERNAL_LOCAL_SCANF_OPTIONS | 1, __stream, __format, __locale, __args);
}
__NAMESPACE_LOCAL_END
...
#undef __local__vfscanf_s_l_defined
...
#endif /* !__local__vfscanf_s_l_defined */
