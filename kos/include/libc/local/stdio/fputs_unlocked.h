...
__LOCAL_LIBC(fputs_unlocked) __ATTR_IN(1) __ATTR_INOUT(2) __STDC_INT_AS_SIZE_T
__NOTHROW_CB_NCX(__LIBCCALL __LIBC_LOCAL_NAME(fputs_unlocked))(char const *__restrict __string, __FILE *__restrict __stream) {
