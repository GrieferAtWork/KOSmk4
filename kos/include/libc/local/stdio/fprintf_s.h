...
__CREDIRECT(__ATTR_IN(2) __ATTR_INOUT(1) __ATTR_LIBC_PRINTF(2, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_CB_NCX,__localdep_vfprintf_s,(__FILE *__stream, char const *__format, __builtin_va_list __args),vfprintf_s,(__stream,__format,__args))
...
__NOTHROW_CB_NCX(__VLIBCCALL __LIBC_LOCAL_NAME(fprintf_s))(__FILE *__stream, char const *__format, ...) {
