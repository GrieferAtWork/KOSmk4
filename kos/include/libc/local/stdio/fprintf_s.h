...
__CREDIRECT(__ATTR_ACCESS_RW(1) __ATTR_LIBC_PRINTF(2, 0) __ATTR_NONNULL((2)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep_vfprintf_s,(__FILE *__stream, char const *__format, __builtin_va_list __args),vfprintf_s,(__stream,__format,__args))
...
__LOCAL_LIBC(fprintf_s) __ATTR_ACCESS_RW(1) __ATTR_LIBC_PRINTF(2, 3) __ATTR_NONNULL((2)) __STDC_INT_AS_SSIZE_T
