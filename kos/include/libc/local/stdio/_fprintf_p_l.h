...
__CREDIRECT(__ATTR_IN(2) __ATTR_INOUT(1) __ATTR_LIBC_PRINTF_P(2, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_CB_NCX,__localdep__vfprintf_p_l,(__FILE *__stream, char const *__format, __locale_t __locale, __builtin_va_list __args),_vfprintf_p_l,(__stream,__format,__locale,__args))
