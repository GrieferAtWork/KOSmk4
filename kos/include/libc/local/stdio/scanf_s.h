...
__CREDIRECT(__ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_SCANF(1, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_CB,__localdep_vscanf_s,(char const *__format, __builtin_va_list __args),vscanf_s,(__format,__args))
...
__NOTHROW_CB(__VLIBCCALL __LIBC_LOCAL_NAME(scanf_s))(char const *__format, ...) {
