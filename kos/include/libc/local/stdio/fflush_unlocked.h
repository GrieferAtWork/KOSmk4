...
__CREDIRECT(,int,__NOTHROW_CB_NCX,__localdep_crt_flushall,(void),_flushall,())
#elif defined(__CRT_HAVE__IO_flush_all)
__CREDIRECT(,int,__NOTHROW_CB_NCX,__localdep_crt_flushall,(void),_IO_flush_all,())
#else /* ... */
...
__NOTHROW_CB_NCX(__LIBCCALL __LIBC_LOCAL_NAME(fflush_unlocked))(__FILE *__stream) {
