...
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1, 2)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep_vsscanf_s,(char const *__buf, char const *__format, __builtin_va_list __args),vsscanf_s,(__buf,__format,__args))
...
__LOCAL_LIBC(sscanf_s) __ATTR_WUNUSED __ATTR_NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T
