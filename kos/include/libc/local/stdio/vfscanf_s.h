...
__LOCAL_LIBC(vfscanf_s) __ATTR_WUNUSED __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1) __ATTR_LIBC_SCANF(2, 0) __STDC_INT_AS_SSIZE_T
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(vfscanf_s))(__FILE *__stream, char const *__format, __builtin_va_list __args) {
