...
#define __local_fprintf_defined
#include <__crt.h>
#include <features.h>
...
__LOCAL_LIBC(fprintf) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1) __ATTR_LIBC_PRINTF(2, 3) __STDC_INT_AS_SSIZE_T
(__VLIBCCALL __LIBC_LOCAL_NAME(fprintf))(__FILE *__restrict __stream, char const *__restrict __format, ...) __THROWS(...) {
	__STDC_INT_AS_SSIZE_T __result;
	__builtin_va_list __args;
	__builtin_va_start(__args, __format);
	__result = (__NAMESPACE_LOCAL_SYM __localdep_vfprintf)(__stream, __format, __args);
