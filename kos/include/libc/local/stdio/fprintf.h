...
__LOCAL_LIBC(fprintf) __ATTR_IN(2) __ATTR_INOUT(1) __ATTR_LIBC_PRINTF(2, 3) __STDC_INT_AS_SSIZE_T
__NOTHROW_CB_NCX(__VLIBCCALL __LIBC_LOCAL_NAME(fprintf))(__FILE *__restrict __stream, char const *__restrict __format, ...) {
