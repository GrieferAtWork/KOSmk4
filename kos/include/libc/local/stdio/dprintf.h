...
__CREDIRECT(__ATTR_ACCESS_RO(2) __ATTR_LIBC_PRINTF(2, 0),__STDC_INT_AS_SSIZE_T,__NOTHROW_RPC,__localdep_vdprintf,(__fd_t __fd, char const *__restrict __format, __builtin_va_list __args),vdprintf,(__fd,__format,__args))
...
__LOCAL_LIBC(dprintf) __ATTR_ACCESS_RO(2) __ATTR_LIBC_PRINTF(2, 3) __STDC_INT_AS_SSIZE_T
