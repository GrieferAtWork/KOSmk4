...
__CREDIRECT(__ATTR_NONNULL((3)),__STDC_INT_AS_SSIZE_T,__NOTHROW_NCX,__localdep__vsnprintf_c,(char *__buf, __SIZE_TYPE__ __bufsize, char const *__format, __builtin_va_list __args),_vsnprintf_c,(__buf,__bufsize,__format,__args))
...
__LOCAL_LIBC(_snprintf_c) __ATTR_NONNULL((3)) __STDC_INT_AS_SSIZE_T
