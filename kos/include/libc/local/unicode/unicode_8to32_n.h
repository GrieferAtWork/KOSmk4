 ...
 */
#ifndef __local_unicode_8to32_n_defined
#define __local_unicode_8to32_n_defined
#include <__crt.h>
...
__LOCAL_LIBC(unicode_8to32_n) __ATTR_RETNONNULL __ATTR_INS(3, 4) __ATTR_OUTS(1, 2) __CHAR32_TYPE__ *
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(unicode_8to32_n))(__CHAR32_TYPE__ *__restrict __utf32_dst, __SIZE_TYPE__ __utf32_maxwords, char const *__restrict __utf8_text, __SIZE_TYPE__ __utf8_bytes) {
	char const *__utf8_end = __utf8_text + __utf8_bytes;
	while (__utf8_text < __utf8_end && __utf32_maxwords) {
...
#endif /* !__local_unicode_8to32_n_defined */
