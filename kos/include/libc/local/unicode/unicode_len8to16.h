 ...
 */
#ifndef __local_unicode_len8to16_defined
#define __local_unicode_len8to16_defined
#include <__crt.h>
...
__LOCAL_LIBC(unicode_len8to16) __ATTR_WUNUSED __ATTR_INS(1, 2) __SIZE_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(unicode_len8to16))(char const *__restrict __utf8_text, __SIZE_TYPE__ __utf8_bytes) {
...
#endif /* !__local_unicode_len8to16_defined */
