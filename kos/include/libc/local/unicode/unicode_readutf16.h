...
#define __local_unicode_readutf16_defined
#include <__crt.h>
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(unicode_readutf16) __ATTR_INOUT(1) __CHAR32_TYPE__
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(unicode_readutf16))(__CHAR16_TYPE__ const **__restrict __ptext) {
	...
	if (__result >= 0xd800 &&
		...
		if __likely(*__text) /* Don't advance past NUL! */
			++__text;
	}
	*__ptext = __text;
	return __result;
