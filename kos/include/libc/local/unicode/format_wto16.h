...
#define __local_format_wto16_defined
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(format_wto16) __ATTR_ACCESS_ROS(2, 3) __ATTR_NONNULL((1)) __SSIZE_TYPE__
__NOTHROW_NCX(__WFORMATPRINTER_CC __LIBC_LOCAL_NAME(format_wto16))(void *__arg, __WCHAR_TYPE__ const *__data, __SIZE_TYPE__ __datalen) {
...
#define __local___localdep_format_wto16_defined
