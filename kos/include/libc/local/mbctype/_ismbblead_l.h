 ...
 */
#ifndef __local__ismbblead_l_defined
#define __local__ismbblead_l_defined
#include <__crt.h>
...
__LOCAL_LIBC(_ismbblead_l) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_ismbblead_l))(unsigned int __ch, __locale_t __locale) {
	return (__NAMESPACE_LOCAL_SYM __localdep__get_mbbtype_l)((unsigned char)__ch, __locale) & 0x04;
}
__NAMESPACE_LOCAL_END
...
#undef __local__ismbblead_l_defined
#endif /* !__CRT_HAVE__mbctype && !__CRT_HAVE___p__mbctype */
#endif /* !__local__ismbblead_l_defined */
