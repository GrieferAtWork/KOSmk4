 ...
 */
#ifndef __local__ismbbkalnum_defined
#define __local__ismbbkalnum_defined
#include <__crt.h>
...
__LOCAL_LIBC(_ismbbkalnum) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_ismbbkalnum))(unsigned int __ch) {
	return (__NAMESPACE_LOCAL_SYM __localdep__ismbbkalnum_l)(__ch, __NULLPTR);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__ismbbkalnum_defined
#define __local___localdep__ismbbkalnum_defined
#define __localdep__ismbbkalnum __LIBC_LOCAL_NAME(_ismbbkalnum)
#endif /* !__local___localdep__ismbbkalnum_defined */
#else /* __CRT_HAVE__ismbbkalnum_l || __CRT_HAVE__mbctype || __CRT_HAVE___p__mbctype */
#undef __local__ismbbkalnum_defined
#endif /* !__CRT_HAVE__ismbbkalnum_l && !__CRT_HAVE__mbctype && !__CRT_HAVE___p__mbctype */
#endif /* !__local__ismbbkalnum_defined */
