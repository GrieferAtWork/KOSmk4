...
#include <__crt.h>
#if defined(__CRT_HAVE__ismbbtrail_l) || defined(__CRT_HAVE__mbctype) || defined(__CRT_HAVE___p__mbctype)
...
__LOCAL_LIBC(_ismbbtrail) __ATTR_PURE __ATTR_WUNUSED int
...
#else /* __CRT_HAVE__ismbbtrail_l || __CRT_HAVE__mbctype || __CRT_HAVE___p__mbctype */
#undef __local__ismbbtrail_defined
#endif /* !__CRT_HAVE__ismbbtrail_l && !__CRT_HAVE__mbctype && !__CRT_HAVE___p__mbctype */
