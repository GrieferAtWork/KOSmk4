 ...
 */
#ifndef __local__ismbbkpunct_defined
#define __local__ismbbkpunct_defined
#include <__crt.h>
...
__LOCAL_LIBC(_ismbbkpunct) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_ismbbkpunct))(unsigned int __ch) {
	return (__NAMESPACE_LOCAL_SYM __localdep__ismbbkpunct_l)(__ch, __NULLPTR);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep__ismbbkpunct_defined
#define __local___localdep__ismbbkpunct_defined
#define __localdep__ismbbkpunct __LIBC_LOCAL_NAME(_ismbbkpunct)
#endif /* !__local___localdep__ismbbkpunct_defined */
#else /* __CRT_HAVE__ismbbkpunct_l || __CRT_HAVE__mbctype || __CRT_HAVE___p__mbctype */
#undef __local__ismbbkpunct_defined
#endif /* !__CRT_HAVE__ismbbkpunct_l && !__CRT_HAVE__mbctype && !__CRT_HAVE___p__mbctype */
#endif /* !__local__ismbbkpunct_defined */
