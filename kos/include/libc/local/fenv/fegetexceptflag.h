...
#define __local_fegetexceptflag_defined
#include <__crt.h>
#include <bits/crt/fenv-inline.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(fegetexceptflag) __ATTR_ACCESS_WR(1) int
...
#define __local___localdep_fegetexceptflag_defined
