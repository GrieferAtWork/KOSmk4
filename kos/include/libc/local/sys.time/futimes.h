...
__CREDIRECT(__ATTR_ACCESS_RO_OPT(2),int,__NOTHROW_NCX,__localdep_futimes32,(__fd_t __fd, struct __timeval32 const __tvp[2]),futimes,(__fd,__tvp))
...
__CREDIRECT(__ATTR_ACCESS_RO_OPT(2),int,__NOTHROW_NCX,__localdep_futimes64,(__fd_t __fd, struct __timeval64 const __tvp[2]),lutimes,(__fd,__tvp))
#elif defined(__CRT_HAVE_futimes64)
__CREDIRECT(__ATTR_ACCESS_RO_OPT(2),int,__NOTHROW_NCX,__localdep_futimes64,(__fd_t __fd, struct __timeval64 const __tvp[2]),futimes64,(__fd,__tvp))
...
__LOCAL_LIBC(futimes) __ATTR_ACCESS_RO_OPT(2) int
...
#endif /* (!__CRT_HAVE_lutimes || __SIZEOF_TIME32_T__ != __SIZEOF_TIME64_T__) && !__CRT_HAVE_futimes64 && !__CRT_HAVE_futimes */
