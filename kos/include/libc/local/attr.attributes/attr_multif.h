...
__CREDIRECT(__ATTR_IN(2) __ATTR_INOUT(4),int,__NOTHROW_NCX,__localdep_attr_getf,(__fd_t __fd, char const *__attrname, char *__attrvalue, int *__valuelength, int __flags),attr_getf,(__fd,__attrname,__attrvalue,__valuelength,__flags))
...
__CREDIRECT(__ATTR_IN(2),int,__NOTHROW_NCX,__localdep_attr_removef,(__fd_t __fd, char const *__attrname, int __flags),attr_removef,(__fd,__attrname,__flags))
...
__CREDIRECT(__ATTR_IN(2) __ATTR_INS(3, 4),int,__NOTHROW_NCX,__localdep_attr_setf,(__fd_t __fd, char const *__attrname, char const *__attrvalue, int __valuelength, int __flags),attr_setf,(__fd,__attrname,__attrvalue,__valuelength,__flags))
