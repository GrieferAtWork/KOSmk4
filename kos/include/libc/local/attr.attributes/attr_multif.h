...
__CREDIRECT(,int,__NOTHROW_NCX,__localdep_attr_getf,(__fd_t __fd, char const *__attrname, char *__attrvalue, int *__valuelength, int __flags),attr_getf,(__fd,__attrname,__attrvalue,__valuelength,__flags))
...
__CREDIRECT(,int,__NOTHROW_NCX,__localdep_attr_removef,(__fd_t __fd, char const *__attrname, int __flags),attr_removef,(__fd,__attrname,__flags))
...
__CREDIRECT(,int,__NOTHROW_NCX,__localdep_attr_setf,(__fd_t __fd, char const *__attrname, char const *__attrvalue, int __valuelength, int __flags),attr_setf,(__fd,__attrname,__attrvalue,__valuelength,__flags))
#endif /* !__local___localdep_attr_setf_defined */
__NAMESPACE_LOCAL_END
#include <libc/errno.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(attr_multif) int
