 ...
 */
#ifndef __local_isctype16_l_defined
#define __local_isctype16_l_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_isctype16 __NAMESPACE_LOCAL_TYPEHAX(int(__LIBDCALL*)(__WINT16_TYPE__,__wctype_t),int(__LIBDCALL&)(__WINT16_TYPE__,__wctype_t),iswctype)
...
#else /* ... */
#undef __local___localdep_isctype16_defined
#endif /* !... */
#endif /* !__local___localdep_isctype16_defined */
__LOCAL_LIBC(isctype16_l) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(isctype16_l))(__WINT16_TYPE__ __wc, __wctype_t __type, __locale_t __locale) {
	(void)__locale;
	__COMPILER_IMPURE();
	return __NAMESPACE_LOCAL_SYM __localdep_isctype16(__wc, __type);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isctype16_l_defined
#define __local___localdep_isctype16_l_defined 1
#define __localdep_isctype16_l __LIBC_LOCAL_NAME(isctype16_l)
#endif /* !__local___localdep_isctype16_l_defined */
...
#undef __local_isctype16_l_defined
#endif /* (!__CRT_HAVE_iswctype || __SIZEOF_WCHAR_T__ != 2 || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$iswctype && (!__CRT_HAVE_is_wctype || __SIZEOF_WCHAR_T__ != 2 || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$is_wctype && (!__CRT_HAVE___iswctype || __SIZEOF_WCHAR_T__ != 2 || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$__iswctype && (!__CRT_KOS || !__CRT_HAVE___unicode_descriptor) */
#endif /* !__local_isctype16_l_defined */
