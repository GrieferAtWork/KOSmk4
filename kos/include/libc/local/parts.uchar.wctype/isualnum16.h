 ...
 */
#ifndef __local_isualnum16_defined
#define __local_isualnum16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isualnum16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(isualnum16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswalnum
	return __crt_iswalnum(__wc);
#else /* __crt_iswalnum */
	return __LIBC_LOCAL_NAME(isualnum16)(__localdep_c16tob(__wc));
...
#endif /* !__local_isualnum16_defined */
