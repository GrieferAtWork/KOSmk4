 ...
 */
#ifndef __local_toulower32_defined
#define __local_toulower32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(toulower32) __ATTR_CONST __ATTR_WUNUSED __WINT32_TYPE__
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(toulower32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_towlower
	return __crt_towlower(__wc);
#else /* __crt_towlower */
	return __localdep_btoc32(__LIBC_LOCAL_NAME(toulower32)(__localdep_c32tob(__wc)));
...
#endif /* !__local_toulower32_defined */
