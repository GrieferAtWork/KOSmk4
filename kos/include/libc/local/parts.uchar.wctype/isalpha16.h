 ...
 */
#ifndef __local_isalpha16_defined
#define __local_isalpha16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isalpha16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(isalpha16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswalpha
	return __crt_iswalpha(__wc);
#else /* __crt_iswalpha */
	return (__NAMESPACE_LOCAL_SYM __localdep_isalpha)((__NAMESPACE_LOCAL_SYM __localdep_c16tob)(__wc));
...
#endif /* !__local_isalpha16_defined */
