 ...
 */
#ifndef __local_isalpha16_l_defined
#define __local_isalpha16_l_defined 1
#include <__crt.h>
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
#ifndef __local___localdep_isalpha16_defined
#define __local___localdep_isalpha16_defined 1
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_isalpha16 (*(int(__LIBDCALL *)(__WINT16_TYPE__))&__LIBC_LOCAL_NAME(iswalpha))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__LOCAL_LIBC(isalpha16_l) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(isalpha16_l))(__WINT16_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return __localdep_isalpha16(__ch);
}
__NAMESPACE_LOCAL_END
...
#endif /* !__local_isalpha16_l_defined */
