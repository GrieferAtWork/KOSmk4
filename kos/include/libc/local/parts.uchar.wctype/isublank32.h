 ...
 */
#ifndef __local_isublank32_defined
#define __local_isublank32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isublank32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isublank32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswblank
	return __crt_iswblank(__wc);
#else /* __crt_iswblank */
	return __LIBC_LOCAL_NAME(isublank32)(__localdep_c32tob(__wc));
...
#endif /* !__local_isublank32_defined */
