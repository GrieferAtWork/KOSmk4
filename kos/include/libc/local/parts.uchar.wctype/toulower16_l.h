 ...
 */
#ifndef __local_toulower16_l_defined
#define __local_toulower16_l_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(toulower16_l) __ATTR_PURE __ATTR_WUNUSED __WINT16_TYPE__
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(toulower16_l))(__WINT16_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return __localdep_toulower16(__ch);
}
__NAMESPACE_LOCAL_END
...
#endif /* !__local_toulower16_l_defined */
