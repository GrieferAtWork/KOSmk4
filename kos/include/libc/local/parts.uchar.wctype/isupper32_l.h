...
#define __local_isupper32_l_defined
#include <__crt.h>
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
#ifndef __local___localdep_isupper32_defined
#define __local___localdep_isupper32_defined
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_isupper32 __NAMESPACE_LOCAL_TYPEHAX(int(__LIBKCALL*)(__WINT32_TYPE__),int(__LIBKCALL&)(__WINT32_TYPE__),iswupper)
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(isupper32_l))(__WINT32_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return (__NAMESPACE_LOCAL_SYM __localdep_isupper32)(__ch);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isupper32_l_defined
#define __local___localdep_isupper32_l_defined
