 ...
 */
#ifndef __local_isulower32_defined
#define __local_isulower32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isulower32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isulower32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswlower
	return __crt_iswlower(__wc);
#else /* __crt_iswlower */
	return __LIBC_LOCAL_NAME(isulower32)(__localdep_c32tob(__wc));
#endif /* !__crt_iswlower */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isulower32_defined
#define __local___localdep_isulower32_defined 1
#define __localdep_isulower32 __LIBC_LOCAL_NAME(isulower32)
#endif /* !__local___localdep_isulower32_defined */
#endif /* !__local_isulower32_defined */
