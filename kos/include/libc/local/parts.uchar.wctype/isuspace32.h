 ...
 */
#ifndef __local_isuspace32_defined
#define __local_isuspace32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isuspace32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isuspace32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswspace
	return __crt_iswspace(__wc);
#else /* __crt_iswspace */
	return __LIBC_LOCAL_NAME(isuspace32)(__localdep_c32tob(__wc));
...
#endif /* !__local_isuspace32_defined */
