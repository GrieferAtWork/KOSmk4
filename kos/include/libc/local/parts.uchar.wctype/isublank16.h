 ...
 */
#ifndef __local_isublank16_defined
#define __local_isublank16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isublank16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(isublank16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswblank
	return __crt_iswblank(__wc);
#else /* __crt_iswblank */
	return __LIBC_LOCAL_NAME(isublank16)(__localdep_c16tob(__wc));
...
#endif /* !__local_isublank16_defined */
