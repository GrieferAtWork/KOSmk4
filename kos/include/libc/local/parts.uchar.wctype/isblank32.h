 ...
 */
#ifndef __local_isblank32_defined
#define __local_isblank32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isblank32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isblank32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswblank
	return __crt_iswblank(__wc);
#else /* __crt_iswblank */
	return (__NAMESPACE_LOCAL_SYM __localdep_isblank)((__NAMESPACE_LOCAL_SYM __localdep_c32tob)(__wc));
#endif /* !__crt_iswblank */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isblank32_defined
#define __local___localdep_isblank32_defined 1
#define __localdep_isblank32 __LIBC_LOCAL_NAME(isblank32)
#endif /* !__local___localdep_isblank32_defined */
#endif /* !__local_isblank32_defined */
