 ...
 */
#ifndef __local_isprint32_defined
#define __local_isprint32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isprint32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isprint32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswprint
	return __crt_iswprint(__wc);
#else /* __crt_iswprint */
	return (__NAMESPACE_LOCAL_SYM __localdep_isprint)((__NAMESPACE_LOCAL_SYM __localdep_c32tob)(__wc));
...
#endif /* !__local_isprint32_defined */
