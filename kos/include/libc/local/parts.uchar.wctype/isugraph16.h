 ...
 */
#ifndef __local_isugraph16_defined
#define __local_isugraph16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isugraph16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(isugraph16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswgraph
	return __crt_iswgraph(__wc);
#else /* __crt_iswgraph */
	return __LIBC_LOCAL_NAME(isugraph16)(__localdep_c16tob(__wc));
...
#endif /* !__local_isugraph16_defined */
