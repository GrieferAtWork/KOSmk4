...
#define __local_isxdigit32_l_defined 1
#include <__crt.h>
...
__COMPILER_EIREDIRECT(__ATTR_CONST __ATTR_WUNUSED,int,__NOTHROW,__LIBKCALL,__localdep_isxdigit32,(__WINT32_TYPE__ __wc),iswxdigit,{ return __crt_iswxdigit(__wc); })
...
__COMPILER_EIREDIRECT(__ATTR_CONST __ATTR_WUNUSED,int,__NOTHROW,__LIBKCALL,__localdep_isxdigit32,(__WINT32_TYPE__ __wc),iswxdigit,{ return __builtin_iswxdigit(__wc); })
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_isxdigit32 (*(int(__LIBKCALL *)(__WINT32_TYPE__))&__LIBC_LOCAL_NAME(iswxdigit))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(isxdigit32_l))(__WINT32_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return __localdep_isxdigit32(__ch);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isxdigit32_l_defined
#define __local___localdep_isxdigit32_l_defined 1
