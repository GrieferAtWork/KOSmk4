 ...
 */
#ifndef __local_isupunct32_defined
#define __local_isupunct32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isupunct32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isupunct32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswpunct
	return __crt_iswpunct(__wc);
#else /* __crt_iswpunct */
	return __LIBC_LOCAL_NAME(isupunct32)(__localdep_c32tob(__wc));
...
#endif /* !__local_isupunct32_defined */
