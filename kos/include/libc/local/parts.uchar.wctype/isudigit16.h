 ...
 */
#ifndef __local_isudigit16_defined
#define __local_isudigit16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isudigit16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(isudigit16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswdigit
	return __crt_iswdigit(__wc);
#else /* __crt_iswdigit */
	return __LIBC_LOCAL_NAME(isudigit16)(__localdep_c16tob(__wc));
#endif /* !__crt_iswdigit */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isudigit16_defined
#define __local___localdep_isudigit16_defined 1
#define __localdep_isudigit16 __LIBC_LOCAL_NAME(isudigit16)
#endif /* !__local___localdep_isudigit16_defined */
#endif /* !__local_isudigit16_defined */
