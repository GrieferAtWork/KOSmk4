 ...
 */
#ifndef __local_toctrans32_defined
#define __local_toctrans32_defined 1
#include <__crt.h>
...
#include <bits/crt/unicode.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(toctrans32) __ATTR_CONST __ATTR_WUNUSED __WINT32_TYPE__
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(toctrans32))(__WINT32_TYPE__ __wc, __wctrans_t __desc) {
...
#define __local___localdep_toctrans32_defined 1
...
#undef __local_toctrans32_defined
#endif /* !__CRT_KOS || !__CRT_HAVE___unicode_descriptor */
#endif /* !__local_toctrans32_defined */
