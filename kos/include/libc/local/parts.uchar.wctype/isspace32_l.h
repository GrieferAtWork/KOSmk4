 ...
 */
#ifndef __local_isspace32_l_defined
#define __local_isspace32_l_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(isspace32_l) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(isspace32_l))(__WINT32_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return (__NAMESPACE_LOCAL_SYM __localdep_isspace32)(__ch);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isspace32_l_defined
#define __local___localdep_isspace32_l_defined 1
#define __localdep_isspace32_l __LIBC_LOCAL_NAME(isspace32_l)
#endif /* !__local___localdep_isspace32_l_defined */
#endif /* !__local_isspace32_l_defined */
