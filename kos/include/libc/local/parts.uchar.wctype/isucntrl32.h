 ...
 */
#ifndef __local_isucntrl32_defined
#define __local_isucntrl32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isucntrl32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isucntrl32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswcntrl
	return __crt_iswcntrl(__wc);
#else /* __crt_iswcntrl */
	return __LIBC_LOCAL_NAME(isucntrl32)(__localdep_c32tob(__wc));
#endif /* !__crt_iswcntrl */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isucntrl32_defined
#define __local___localdep_isucntrl32_defined 1
#define __localdep_isucntrl32 __LIBC_LOCAL_NAME(isucntrl32)
#endif /* !__local___localdep_isucntrl32_defined */
#endif /* !__local_isucntrl32_defined */
