...
#define __local_islower32_defined 1
#include <__crt.h>
...
#else /* __crt_iswlower */
	return __LIBC_LOCAL_NAME(islower32)(__NAMESPACE_LOCAL_SYM __localdep_c32tob(__wc));
#endif /* !__crt_iswlower */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_islower32_defined
#define __local___localdep_islower32_defined 1
