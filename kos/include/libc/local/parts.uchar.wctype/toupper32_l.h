 ...
 */
#ifndef __local_toupper32_l_defined
#define __local_toupper32_l_defined 1
#include <__crt.h>
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
#ifndef __local___localdep_toupper32_defined
#define __local___localdep_toupper32_defined 1
__NAMESPACE_LOCAL_END
#include <bits/crt/wctype.h>
__NAMESPACE_LOCAL_BEGIN
#if defined(__crt_towupper) && defined(__CRT_HAVE_towupper) && __SIZEOF_WCHAR_T__ == 4
__COMPILER_EIREDIRECT(__ATTR_CONST __ATTR_WUNUSED,__WINT32_TYPE__,__NOTHROW,__LIBKCALL,__localdep_toupper32,(__WINT32_TYPE__ __wc),towupper,{ return __crt_towupper(__wc); })
...
__COMPILER_EIREDIRECT(__ATTR_CONST __ATTR_WUNUSED,__WINT32_TYPE__,__NOTHROW,__LIBKCALL,__localdep_toupper32,(__WINT32_TYPE__ __wc),towupper,{ return __builtin_towupper(__wc); })
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_toupper32 (*(__WINT32_TYPE__(__LIBKCALL *)(__WINT32_TYPE__))&__LIBC_LOCAL_NAME(towupper))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__LOCAL_LIBC(toupper32_l) __ATTR_PURE __ATTR_WUNUSED __WINT32_TYPE__
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(toupper32_l))(__WINT32_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return __localdep_toupper32(__ch);
}
__NAMESPACE_LOCAL_END
...
#endif /* !__local_toupper32_l_defined */
