 ...
 */
#ifndef __local_isxdigit32_defined
#define __local_isxdigit32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isxdigit32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isxdigit32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswxdigit
	return __crt_iswxdigit(__wc);
#else /* __crt_iswxdigit */
	return (__NAMESPACE_LOCAL_SYM __localdep_isxdigit)((__NAMESPACE_LOCAL_SYM __localdep_c32tob)(__wc));
#endif /* !__crt_iswxdigit */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isxdigit32_defined
#define __local___localdep_isxdigit32_defined 1
#define __localdep_isxdigit32 __LIBC_LOCAL_NAME(isxdigit32)
#endif /* !__local___localdep_isxdigit32_defined */
#endif /* !__local_isxdigit32_defined */
