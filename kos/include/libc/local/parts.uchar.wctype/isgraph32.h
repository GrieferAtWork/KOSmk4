 ...
 */
#ifndef __local_isgraph32_defined
#define __local_isgraph32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isgraph32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isgraph32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswgraph
	return __crt_iswgraph(__wc);
#else /* __crt_iswgraph */
	return __LIBC_LOCAL_NAME(isgraph32)(__localdep_c32tob(__wc));
...
#endif /* !__local_isgraph32_defined */
