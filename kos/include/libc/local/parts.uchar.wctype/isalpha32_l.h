 ...
 */
#ifndef __local_isalpha32_l_defined
#define __local_isalpha32_l_defined 1
#include <__crt.h>
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
#ifndef __local___localdep_isalpha32_defined
#define __local___localdep_isalpha32_defined 1
__NAMESPACE_LOCAL_END
#include <bits/crt/wctype.h>
__NAMESPACE_LOCAL_BEGIN
#if defined(__crt_iswalpha) && defined(__CRT_HAVE_iswalpha) && __SIZEOF_WCHAR_T__ == 4
__COMPILER_EIREDIRECT(__ATTR_CONST __ATTR_WUNUSED,int,__NOTHROW,__LIBKCALL,__localdep_isalpha32,(__WINT32_TYPE__ __wc),iswalpha,{ return __crt_iswalpha(__wc); })
...
__COMPILER_EIREDIRECT(__ATTR_CONST __ATTR_WUNUSED,int,__NOTHROW,__LIBKCALL,__localdep_isalpha32,(__WINT32_TYPE__ __wc),iswalpha,{ return __builtin_iswalpha(__wc); })
...
__LOCAL_LIBC(isalpha32_l) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(isalpha32_l))(__WINT32_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return __NAMESPACE_LOCAL_SYM __localdep_isalpha32(__ch);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isalpha32_l_defined
#define __local___localdep_isalpha32_l_defined 1
#define __localdep_isalpha32_l __LIBC_LOCAL_NAME(isalpha32_l)
#endif /* !__local___localdep_isalpha32_l_defined */
#endif /* !__local_isalpha32_l_defined */
