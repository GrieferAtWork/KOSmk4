 ...
 */
#ifndef __local_toupper16_l_defined
#define __local_toupper16_l_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_toupper16 (*(__WINT16_TYPE__(__LIBDCALL *)(__WINT16_TYPE__))&__LIBC_LOCAL_NAME(towupper))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__LOCAL_LIBC(toupper16_l) __ATTR_PURE __ATTR_WUNUSED __WINT16_TYPE__
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(toupper16_l))(__WINT16_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return __localdep_toupper16(__ch);
}
__NAMESPACE_LOCAL_END
...
#endif /* !__local_toupper16_l_defined */
