 ...
 */
#ifndef __local_isuupper16_defined
#define __local_isuupper16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isuupper16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(isuupper16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswupper
	return __crt_iswupper(__wc);
#else /* __crt_iswupper */
	return __LIBC_LOCAL_NAME(isuupper16)(__localdep_c16tob(__wc));
...
#endif /* !__local_isuupper16_defined */
