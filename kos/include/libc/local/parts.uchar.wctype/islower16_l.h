...
#define __local_islower16_l_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_islower16 (*(int(__LIBDCALL *)(__WINT16_TYPE__))&__LIBC_LOCAL_NAME(iswlower))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(islower16_l))(__WINT16_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return __localdep_islower16(__ch);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_islower16_l_defined
#define __local___localdep_islower16_l_defined 1
