 ...
 */
#ifndef __local_islower16_defined
#define __local_islower16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(islower16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(islower16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswlower
	return __crt_iswlower(__wc);
#else /* __crt_iswlower */
	return (__NAMESPACE_LOCAL_SYM __localdep_islower)((__NAMESPACE_LOCAL_SYM __localdep_c16tob)(__wc));
#endif /* !__crt_iswlower */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_islower16_defined
#define __local___localdep_islower16_defined 1
#define __localdep_islower16 __LIBC_LOCAL_NAME(islower16)
#endif /* !__local___localdep_islower16_defined */
#endif /* !__local_islower16_defined */
