 ...
 */
#ifndef __local_toupper16_defined
#define __local_toupper16_defined 1
#include <__crt.h>
...
__CREDIRECT(__ATTR_CONST __ATTR_WUNUSED,__WINT16_TYPE__,__NOTHROW_NCX,__localdep_btoc16,(int __ch),btowc,(__ch))
#elif defined(__CRT_HAVE_DOS$btowc)
__CREDIRECT_DOS(__ATTR_CONST __ATTR_WUNUSED,__WINT16_TYPE__,__NOTHROW_NCX,__localdep_btoc16,(int __ch),btowc,(__ch))
#elif __SIZEOF_WCHAR_T__ == 2
__NAMESPACE_LOCAL_END
#include <libc/local/wchar/btowc.h>
__NAMESPACE_LOCAL_BEGIN
#define __localdep_btoc16 (*(__WINT16_TYPE__(__LIBDCALL *)(int))&__LIBC_LOCAL_NAME(btowc))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(toupper16) __ATTR_CONST __ATTR_WUNUSED __WINT16_TYPE__
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(toupper16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_towupper
	return __crt_towupper(__wc);
#else /* __crt_towupper */
	return __localdep_btoc16(__LIBC_LOCAL_NAME(toupper16)(__localdep_c16tob(__wc)));
...
#endif /* !__local_toupper16_defined */
