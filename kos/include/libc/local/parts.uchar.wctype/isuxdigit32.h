 ...
 */
#ifndef __local_isuxdigit32_defined
#define __local_isuxdigit32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isuxdigit32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isuxdigit32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswxdigit
	return __crt_iswxdigit(__wc);
#else /* __crt_iswxdigit */
	return __LIBC_LOCAL_NAME(isuxdigit32)(__localdep_c32tob(__wc));
...
#endif /* !__local_isuxdigit32_defined */
