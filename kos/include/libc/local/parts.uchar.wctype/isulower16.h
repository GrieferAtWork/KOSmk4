 ...
 */
#ifndef __local_isulower16_defined
#define __local_isulower16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isulower16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(isulower16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswlower
	return __crt_iswlower(__wc);
#else /* __crt_iswlower */
	return __LIBC_LOCAL_NAME(isulower16)(__localdep_c16tob(__wc));
#endif /* !__crt_iswlower */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isulower16_defined
#define __local___localdep_isulower16_defined 1
#define __localdep_isulower16 __LIBC_LOCAL_NAME(isulower16)
#endif /* !__local___localdep_isulower16_defined */
#endif /* !__local_isulower16_defined */
