 ...
 */
#ifndef __local_toulower16_defined
#define __local_toulower16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(toulower16) __ATTR_CONST __ATTR_WUNUSED __WINT16_TYPE__
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(toulower16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_towlower
	return __crt_towlower(__wc);
#else /* __crt_towlower */
	return __localdep_btoc16(__LIBC_LOCAL_NAME(toulower16)(__localdep_c16tob(__wc)));
...
#endif /* !__local_toulower16_defined */
