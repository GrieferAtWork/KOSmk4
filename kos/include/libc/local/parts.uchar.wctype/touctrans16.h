 ...
 */
#ifndef __local_touctrans16_defined
#define __local_touctrans16_defined 1
#include <__crt.h>
...
#include <bits/crt/unicode.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(touctrans16) __ATTR_CONST __ATTR_WUNUSED __WINT16_TYPE__
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(touctrans16))(__WINT16_TYPE__ __wc, __wctrans_t __desc) {
...
#undef __local_touctrans16_defined
#endif /* !__CRT_KOS || !__CRT_HAVE___unicode_descriptor */
#endif /* !__local_touctrans16_defined */
