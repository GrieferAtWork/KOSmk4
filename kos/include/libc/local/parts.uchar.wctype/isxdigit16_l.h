...
#define __local_isxdigit16_l_defined 1
#include <__crt.h>
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
#ifndef __local___localdep_isxdigit16_defined
#define __local___localdep_isxdigit16_defined 1
__NAMESPACE_LOCAL_END
#include <bits/crt/wctype.h>
__NAMESPACE_LOCAL_BEGIN
#if defined(__crt_iswxdigit) && defined(__CRT_HAVE_iswxdigit) && __SIZEOF_WCHAR_T__ == 2
__COMPILER_EIREDIRECT(__ATTR_CONST __ATTR_WUNUSED,int,__NOTHROW,__LIBDCALL,__localdep_isxdigit16,(__WINT16_TYPE__ __wc),iswxdigit,{ return __crt_iswxdigit(__wc); })
...
__COMPILER_EIREDIRECT(__ATTR_CONST __ATTR_WUNUSED,int,__NOTHROW,__LIBDCALL,__localdep_isxdigit16,(__WINT16_TYPE__ __wc),iswxdigit,{ return __builtin_iswxdigit(__wc); })
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_isxdigit16 (*(int(__LIBDCALL *)(__WINT16_TYPE__))&__LIBC_LOCAL_NAME(iswxdigit))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(isxdigit16_l))(__WINT16_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return __localdep_isxdigit16(__ch);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isxdigit16_l_defined
#define __local___localdep_isxdigit16_l_defined 1
