 ...
 */
#ifndef __local_isspace16_defined
#define __local_isspace16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isspace16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(isspace16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswspace
	return __crt_iswspace(__wc);
#else /* __crt_iswspace */
	return (__NAMESPACE_LOCAL_SYM __localdep_isspace)((__NAMESPACE_LOCAL_SYM __localdep_c16tob)(__wc));
...
#endif /* !__local_isspace16_defined */
