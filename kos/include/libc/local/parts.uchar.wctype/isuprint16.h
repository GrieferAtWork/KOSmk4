 ...
 */
#ifndef __local_isuprint16_defined
#define __local_isuprint16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isuprint16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(isuprint16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswprint
	return __crt_iswprint(__wc);
#else /* __crt_iswprint */
	return __LIBC_LOCAL_NAME(isuprint16)(__localdep_c16tob(__wc));
...
#endif /* !__local_isuprint16_defined */
