 ...
 */
#ifndef __local_isupper16_defined
#define __local_isupper16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isupper16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(isupper16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswupper
	return __crt_iswupper(__wc);
#else /* __crt_iswupper */
	return (__NAMESPACE_LOCAL_SYM __localdep_isupper)((__NAMESPACE_LOCAL_SYM __localdep_c16tob)(__wc));
...
#endif /* !__local_isupper16_defined */
