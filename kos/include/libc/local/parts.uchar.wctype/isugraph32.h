 ...
 */
#ifndef __local_isugraph32_defined
#define __local_isugraph32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isugraph32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isugraph32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswgraph
	return __crt_iswgraph(__wc);
#else /* __crt_iswgraph */
	return __LIBC_LOCAL_NAME(isugraph32)(__localdep_c32tob(__wc));
#endif /* !__crt_iswgraph */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isugraph32_defined
#define __local___localdep_isugraph32_defined 1
#define __localdep_isugraph32 __LIBC_LOCAL_NAME(isugraph32)
#endif /* !__local___localdep_isugraph32_defined */
#endif /* !__local_isugraph32_defined */
