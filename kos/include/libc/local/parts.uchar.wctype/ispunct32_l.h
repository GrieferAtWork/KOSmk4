...
#define __local_ispunct32_l_defined 1
#include <__crt.h>
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
#ifndef __local___localdep_ispunct32_defined
#define __local___localdep_ispunct32_defined 1
__NAMESPACE_LOCAL_END
#include <bits/crt/wctype.h>
__NAMESPACE_LOCAL_BEGIN
#if defined(__crt_iswpunct) && defined(__CRT_HAVE_iswpunct) && __SIZEOF_WCHAR_T__ == 4
__COMPILER_EIREDIRECT(__ATTR_CONST __ATTR_WUNUSED,int,__NOTHROW,__LIBKCALL,__localdep_ispunct32,(__WINT32_TYPE__ __wc),iswpunct,{ return __crt_iswpunct(__wc); })
...
__COMPILER_EIREDIRECT(__ATTR_CONST __ATTR_WUNUSED,int,__NOTHROW,__LIBKCALL,__localdep_ispunct32,(__WINT32_TYPE__ __wc),iswpunct,{ return __builtin_iswpunct(__wc); })
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_ispunct32 (*(int(__LIBKCALL *)(__WINT32_TYPE__))&__LIBC_LOCAL_NAME(iswpunct))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(ispunct32_l))(__WINT32_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return __localdep_ispunct32(__ch);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_ispunct32_l_defined
#define __local___localdep_ispunct32_l_defined 1
