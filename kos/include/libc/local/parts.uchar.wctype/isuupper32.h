 ...
 */
#ifndef __local_isuupper32_defined
#define __local_isuupper32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isuupper32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isuupper32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswupper
	return __crt_iswupper(__wc);
#else /* __crt_iswupper */
	return __LIBC_LOCAL_NAME(isuupper32)(__localdep_c32tob(__wc));
#endif /* !__crt_iswupper */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isuupper32_defined
#define __local___localdep_isuupper32_defined 1
#define __localdep_isuupper32 __LIBC_LOCAL_NAME(isuupper32)
#endif /* !__local___localdep_isuupper32_defined */
#endif /* !__local_isuupper32_defined */
