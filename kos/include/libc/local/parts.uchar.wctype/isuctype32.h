 ...
 */
#ifndef __local_isuctype32_defined
#define __local_isuctype32_defined 1
#include <__crt.h>
...
#include <bits/crt/unicode.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isuctype32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(isuctype32))(__WINT32_TYPE__ __wc, __wctype_t __desc) {
...
#undef __local_isuctype32_defined
#endif /* !__CRT_KOS || !__CRT_HAVE___unicode_descriptor */
#endif /* !__local_isuctype32_defined */
