...
#define __local_isalnum32_l_defined 1
#include <__crt.h>
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
#ifndef __local___localdep_isalnum32_defined
#define __local___localdep_isalnum32_defined 1
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_isalnum32 (*(int(__LIBKCALL *)(__WINT32_TYPE__))&__LIBC_LOCAL_NAME(iswalnum))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(isalnum32_l))(__WINT32_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return __localdep_isalnum32(__ch);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isalnum32_l_defined
#define __local___localdep_isalnum32_l_defined 1
