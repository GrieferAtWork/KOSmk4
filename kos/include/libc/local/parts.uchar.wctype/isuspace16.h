 ...
 */
#ifndef __local_isuspace16_defined
#define __local_isuspace16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isuspace16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(isuspace16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswspace
	return __crt_iswspace(__wc);
#else /* __crt_iswspace */
	return __LIBC_LOCAL_NAME(isuspace16)(__localdep_c16tob(__wc));
...
#endif /* !__local_isuspace16_defined */
