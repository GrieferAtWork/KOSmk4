...
#define __local_isblank32_l_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_isblank32 (*(int(__LIBKCALL *)(__WINT32_TYPE__))&__LIBC_LOCAL_NAME(iswblank))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(isblank32_l))(__WINT32_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return __localdep_isblank32(__ch);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isblank32_l_defined
#define __local___localdep_isblank32_l_defined 1
