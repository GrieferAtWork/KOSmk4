...
#define __local_isgraph16_defined 1
#include <__crt.h>
...
#else /* __crt_iswgraph */
	return __LIBC_LOCAL_NAME(isgraph16)(__NAMESPACE_LOCAL_SYM __localdep_c16tob(__wc));
#endif /* !__crt_iswgraph */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isgraph16_defined
#define __local___localdep_isgraph16_defined 1
