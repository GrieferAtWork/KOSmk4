 ...
 */
#ifndef __local_isspace32_defined
#define __local_isspace32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isspace32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isspace32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswspace
	return __crt_iswspace(__wc);
#else /* __crt_iswspace */
	return (__NAMESPACE_LOCAL_SYM __localdep_isspace)((__NAMESPACE_LOCAL_SYM __localdep_c32tob)(__wc));
...
#endif /* !__local_isspace32_defined */
