 ...
 */
#ifndef __local_isupunct16_defined
#define __local_isupunct16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isupunct16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(isupunct16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswpunct
	return __crt_iswpunct(__wc);
#else /* __crt_iswpunct */
	return __LIBC_LOCAL_NAME(isupunct16)(__localdep_c16tob(__wc));
#endif /* !__crt_iswpunct */
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isupunct16_defined
#define __local___localdep_isupunct16_defined 1
#define __localdep_isupunct16 __LIBC_LOCAL_NAME(isupunct16)
#endif /* !__local___localdep_isupunct16_defined */
#endif /* !__local_isupunct16_defined */
