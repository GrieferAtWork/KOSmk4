 ...
 */
#ifndef __local_isualnum32_defined
#define __local_isualnum32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isualnum32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isualnum32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswalnum
	return __crt_iswalnum(__wc);
#else /* __crt_iswalnum */
	return __LIBC_LOCAL_NAME(isualnum32)(__localdep_c32tob(__wc));
...
#endif /* !__local_isualnum32_defined */
