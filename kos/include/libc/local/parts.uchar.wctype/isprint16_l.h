 ...
 */
#ifndef __local_isprint16_l_defined
#define __local_isprint16_l_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(isprint16_l) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(isprint16_l))(__WINT16_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return __localdep_isprint16(__ch);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isprint16_l_defined
#define __local___localdep_isprint16_l_defined 1
#define __localdep_isprint16_l __LIBC_LOCAL_NAME(isprint16_l)
#endif /* !__local___localdep_isprint16_l_defined */
#endif /* !__local_isprint16_l_defined */
