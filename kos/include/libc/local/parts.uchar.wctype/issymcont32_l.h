...
__NAMESPACE_LOCAL_BEGIN
#define __localdep_isalnum32_l (*(int(__LIBKCALL *)(__WINT32_TYPE__, __locale_t))&__LIBC_LOCAL_NAME(iswalnum_l))
#else /* ... */
__NAMESPACE_LOCAL_END
...
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(issymcont32_l))(__WINT32_TYPE__ __wc, __locale_t __locale) {
	...
	return __localdep_isalnum32_l(__wc, __locale) || __wc == '_' || __wc == '$';
