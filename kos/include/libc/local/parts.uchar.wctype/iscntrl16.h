 ...
 */
#ifndef __local_iscntrl16_defined
#define __local_iscntrl16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(iscntrl16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(iscntrl16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswcntrl
	return __crt_iswcntrl(__wc);
#else /* __crt_iswcntrl */
	return (__NAMESPACE_LOCAL_SYM __localdep_iscntrl)((__NAMESPACE_LOCAL_SYM __localdep_c16tob)(__wc));
...
#endif /* !__local_iscntrl16_defined */
