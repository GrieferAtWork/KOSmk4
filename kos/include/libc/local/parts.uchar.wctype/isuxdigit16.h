 ...
 */
#ifndef __local_isuxdigit16_defined
#define __local_isuxdigit16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isuxdigit16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(isuxdigit16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswxdigit
	return __crt_iswxdigit(__wc);
#else /* __crt_iswxdigit */
	return __LIBC_LOCAL_NAME(isuxdigit16)(__localdep_c16tob(__wc));
...
#endif /* !__local_isuxdigit16_defined */
