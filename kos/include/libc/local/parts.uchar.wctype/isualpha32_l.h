 ...
 */
#ifndef __local_isualpha32_l_defined
#define __local_isualpha32_l_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(isualpha32_l) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(isualpha32_l))(__WINT32_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return __localdep_isualpha32(__ch);
}
__NAMESPACE_LOCAL_END
...
#endif /* !__local_isualpha32_l_defined */
