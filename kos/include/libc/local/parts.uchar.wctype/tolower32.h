...
#define __local_tolower32_defined 1
#include <__crt.h>
...
#else /* __crt_towlower */
	return (__NAMESPACE_LOCAL_SYM __localdep_btoc32)(__LIBC_LOCAL_NAME(tolower32)((__NAMESPACE_LOCAL_SYM __localdep_c32tob)(__wc)));
