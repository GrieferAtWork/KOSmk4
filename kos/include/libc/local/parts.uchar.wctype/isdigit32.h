 ...
 */
#ifndef __local_isdigit32_defined
#define __local_isdigit32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isdigit32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isdigit32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswdigit
	return __crt_iswdigit(__wc);
#else /* __crt_iswdigit */
	return __LIBC_LOCAL_NAME(isdigit32)(__localdep_c32tob(__wc));
...
#endif /* !__local_isdigit32_defined */
