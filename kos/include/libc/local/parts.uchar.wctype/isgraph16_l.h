 ...
 */
#ifndef __local_isgraph16_l_defined
#define __local_isgraph16_l_defined 1
#include <__crt.h>
...
__CREDIRECT_DOS(__ATTR_CONST __ATTR_WUNUSED,int,__NOTHROW,__localdep_isgraph16,(__WINT16_TYPE__ __wc),iswgraph,(__wc))
#elif __SIZEOF_WCHAR_T__ == 2
__NAMESPACE_LOCAL_END
#include <libc/local/wctype/iswgraph.h>
__NAMESPACE_LOCAL_BEGIN
#define __localdep_isgraph16 __NAMESPACE_LOCAL_TYPEHAX(int(__LIBDCALL*)(__WINT16_TYPE__),int(__LIBDCALL&)(__WINT16_TYPE__),iswgraph)
#else /* ... */
__NAMESPACE_LOCAL_END
...
__LOCAL_LIBC(isgraph16_l) __ATTR_PURE __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(isgraph16_l))(__WINT16_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return (__NAMESPACE_LOCAL_SYM __localdep_isgraph16)(__ch);
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_isgraph16_l_defined
#define __local___localdep_isgraph16_l_defined 1
#define __localdep_isgraph16_l __LIBC_LOCAL_NAME(isgraph16_l)
#endif /* !__local___localdep_isgraph16_l_defined */
#endif /* !__local_isgraph16_l_defined */
