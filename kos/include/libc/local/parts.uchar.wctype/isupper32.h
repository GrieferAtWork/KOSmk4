 ...
 */
#ifndef __local_isupper32_defined
#define __local_isupper32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isupper32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isupper32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswupper
	return __crt_iswupper(__wc);
#else /* __crt_iswupper */
	return (__NAMESPACE_LOCAL_SYM __localdep_isupper)((__NAMESPACE_LOCAL_SYM __localdep_c32tob)(__wc));
...
#endif /* !__local_isupper32_defined */
