 ...
 */
#ifndef __local_toulower32_l_defined
#define __local_toulower32_l_defined 1
#include <__crt.h>
...
__LOCAL_LIBC(toulower32_l) __ATTR_PURE __ATTR_WUNUSED __WINT32_TYPE__
__NOTHROW_NCX(__LIBKCALL __LIBC_LOCAL_NAME(toulower32_l))(__WINT32_TYPE__ __ch, __locale_t __locale) {
	__COMPILER_IMPURE();
	(void)__locale;
	return __localdep_toulower32(__ch);
}
__NAMESPACE_LOCAL_END
...
#endif /* !__local_toulower32_l_defined */
