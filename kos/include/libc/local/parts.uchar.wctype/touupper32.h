 ...
 */
#ifndef __local_touupper32_defined
#define __local_touupper32_defined 1
#include <__crt.h>
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
#ifndef __local___localdep_btoc32_defined
#define __local___localdep_btoc32_defined 1
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(touupper32) __ATTR_CONST __ATTR_WUNUSED __WINT32_TYPE__
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(touupper32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_towupper
	return __crt_towupper(__wc);
#else /* __crt_towupper */
	return __localdep_btoc32(__LIBC_LOCAL_NAME(touupper32)(__localdep_c32tob(__wc)));
...
#endif /* !__local_touupper32_defined */
