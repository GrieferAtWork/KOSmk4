 ...
 */
#ifndef __local_isualpha32_defined
#define __local_isualpha32_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(isualpha32) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBKCALL __LIBC_LOCAL_NAME(isualpha32))(__WINT32_TYPE__ __wc) {
#ifdef __crt_iswalpha
	return __crt_iswalpha(__wc);
#else /* __crt_iswalpha */
	return __LIBC_LOCAL_NAME(isualpha32)(__localdep_c32tob(__wc));
...
#endif /* !__local_isualpha32_defined */
