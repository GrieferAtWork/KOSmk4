 ...
 */
#ifndef __local___isucsym16_defined
#define __local___isucsym16_defined 1
#include <__crt.h>
...
#include <bits/crt/unicode.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(__isucsym16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW_NCX(__LIBDCALL __LIBC_LOCAL_NAME(__isucsym16))(__WINT16_TYPE__ __wc) {
	...
	return __localdep_isualnum16(__wc) || __wc == '_' || __wc == '$';
...
#endif /* !__local___isucsym16_defined */
