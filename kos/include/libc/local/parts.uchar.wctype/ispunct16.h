 ...
 */
#ifndef __local_ispunct16_defined
#define __local_ispunct16_defined 1
#include <__crt.h>
...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(ispunct16) __ATTR_CONST __ATTR_WUNUSED int
__NOTHROW(__LIBDCALL __LIBC_LOCAL_NAME(ispunct16))(__WINT16_TYPE__ __wc) {
#ifdef __crt_iswpunct
	return __crt_iswpunct(__wc);
#else /* __crt_iswpunct */
	return __LIBC_LOCAL_NAME(ispunct16)(__localdep_c16tob(__wc));
...
#endif /* !__local_ispunct16_defined */
