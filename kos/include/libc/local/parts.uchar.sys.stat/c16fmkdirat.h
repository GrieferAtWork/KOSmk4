 ...
 */
#ifndef __local_c16fmkdirat_defined
#define __local_c16fmkdirat_defined
#include <__crt.h>
...
__LOCAL_LIBC(c16fmkdirat) __ATTR_ACCESS_RO(2) int
__NOTHROW_RPC(__LIBDCALL __LIBC_LOCAL_NAME(c16fmkdirat))(__fd_t __dirfd, __CHAR16_TYPE__ const *__pathname, __mode_t __mode, __atflag_t __flags) {
	int __result;
...
#undef __local_c16fmkdirat_defined
#endif /* !__CRT_HAVE_fmkdirat || ((!__CRT_HAVE_convert_wcstombs || __SIZEOF_WCHAR_T__ != 2 || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$convert_wcstombs && (!__CRT_HAVE_convert_wcstombsn || __SIZEOF_WCHAR_T__ != 2) && !__CRT_HAVE_DOS$convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) */
#endif /* !__local_c16fmkdirat_defined */
