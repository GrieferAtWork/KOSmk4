...
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(c16utimensat64) __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO_OPT(3) int
__NOTHROW_RPC(__LIBDCALL __LIBC_LOCAL_NAME(c16utimensat64))(__fd_t __dirfd, __CHAR16_TYPE__ const *__filename, struct __timespec64 const __times[2 /*or:3*/], __atflag_t __flags) {
...
#else /* ((__CRT_HAVE_utimensat64 || __CRT_HAVE_utimensat) && ((__CRT_HAVE_convert_wcstombs && __SIZEOF_WCHAR_T__ == 2 && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_DOS$convert_wcstombs || (__CRT_HAVE_convert_wcstombsn && __SIZEOF_WCHAR_T__ == 2) || __CRT_HAVE_DOS$convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc)) || (__CRT_HAVE_wutimensat && __SIZEOF_WCHAR_T__ == 2 && __LIBCCALL_IS_LIBDCALL) || __CRT_HAVE_DOS$wutimensat */
#undef __local_c16utimensat64_defined
#endif /* ((!__CRT_HAVE_utimensat64 && !__CRT_HAVE_utimensat) || ((!__CRT_HAVE_convert_wcstombs || __SIZEOF_WCHAR_T__ != 2 || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$convert_wcstombs && (!__CRT_HAVE_convert_wcstombsn || __SIZEOF_WCHAR_T__ != 2) && !__CRT_HAVE_DOS$convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc)) && (!__CRT_HAVE_wutimensat || __SIZEOF_WCHAR_T__ != 2 || !__LIBCCALL_IS_LIBDCALL) && !__CRT_HAVE_DOS$wutimensat */
#endif /* !__local_c16utimensat64_defined */
