...
__CREDIRECT(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_c32fmknodat,(__fd_t __dirfd, __CHAR32_TYPE__ const *__nodename, __mode_t __mode, __dev_t __dev, __atflag_t __flags),wfmknodat,(__dirfd,__nodename,__mode,__dev,__flags))
#elif defined(__CRT_HAVE_KOS$wfmknodat)
__CREDIRECT_KOS(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_c32fmknodat,(__fd_t __dirfd, __CHAR32_TYPE__ const *__nodename, __mode_t __mode, __dev_t __dev, __atflag_t __flags),wfmknodat,(__dirfd,__nodename,__mode,__dev,__flags))
...
__LOCAL_LIBC(c32mknodat) __ATTR_NONNULL((2)) int
