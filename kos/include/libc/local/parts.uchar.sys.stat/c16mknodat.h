...
__CREDIRECT(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_c16fmknodat,(__fd_t __dirfd, __CHAR16_TYPE__ const *__nodename, __mode_t __mode, __dev_t __dev, __atflag_t __flags),wfmknodat,(__dirfd,__nodename,__mode,__dev,__flags))
#elif defined(__CRT_HAVE_DOS$wfmknodat)
__CREDIRECT_DOS(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_c16fmknodat,(__fd_t __dirfd, __CHAR16_TYPE__ const *__nodename, __mode_t __mode, __dev_t __dev, __atflag_t __flags),wfmknodat,(__dirfd,__nodename,__mode,__dev,__flags))
...
__LOCAL_LIBC(c16mknodat) __ATTR_NONNULL((2)) int
