...
__CREDIRECT(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_c32mkdirat,(__fd_t __dirfd, __CHAR32_TYPE__ const *__pathname, __mode_t __mode),wmkdirat,(__dirfd,__pathname,__mode))
#elif defined(__CRT_HAVE_KOS$wmkdirat)
__CREDIRECT_KOS(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_c32mkdirat,(__fd_t __dirfd, __CHAR32_TYPE__ const *__pathname, __mode_t __mode),wmkdirat,(__dirfd,__pathname,__mode))
...
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,__localdep_dos_c32mkdir,(__CHAR32_TYPE__ const *__pathname),_wmkdir,(__pathname))
#elif defined(__CRT_HAVE_KOS$_wmkdir)
__NAMESPACE_LOCAL_END
#include <hybrid/typecore.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT_KOS(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,__localdep_dos_c32mkdir,(__CHAR32_TYPE__ const *__pathname),_wmkdir,(__pathname))
#else /* ... */
...
__LOCAL_LIBC(c32mkdir) __ATTR_NONNULL((1)) int
