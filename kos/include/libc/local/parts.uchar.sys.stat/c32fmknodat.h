 ...
 */
#ifndef __local_c32fmknodat_defined
#define __local_c32fmknodat_defined
#include <__crt.h>
...
__LOCAL_LIBC(c32fmknodat) __ATTR_NONNULL((2)) int
__NOTHROW_RPC(__LIBKCALL __LIBC_LOCAL_NAME(c32fmknodat))(__fd_t __dirfd, __CHAR32_TYPE__ const *__nodename, __mode_t __mode, __dev_t __dev, __atflag_t __flags) {
	int __result;
...
#else /* __CRT_HAVE_fmknodat && ((__CRT_HAVE_convert_wcstombs && __SIZEOF_WCHAR_T__ == 4 && __LIBCCALL_IS_LIBKCALL) || __CRT_HAVE_KOS$convert_wcstombs || (__CRT_HAVE_convert_wcstombsn && __SIZEOF_WCHAR_T__ == 4) || __CRT_HAVE_KOS$convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc) */
#undef __local_c32fmknodat_defined
#endif /* !__CRT_HAVE_fmknodat || ((!__CRT_HAVE_convert_wcstombs || __SIZEOF_WCHAR_T__ != 4 || !__LIBCCALL_IS_LIBKCALL) && !__CRT_HAVE_KOS$convert_wcstombs && (!__CRT_HAVE_convert_wcstombsn || __SIZEOF_WCHAR_T__ != 4) && !__CRT_HAVE_KOS$convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) */
#endif /* !__local_c32fmknodat_defined */
