...
__CREDIRECT(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_c32mknodat,(__fd_t __dirfd, __CHAR32_TYPE__ const *__nodename, __mode_t __mode, __dev_t __dev),wmknodat,(__dirfd,__nodename,__mode,__dev))
#elif defined(__CRT_HAVE_KOS$wmknodat)
__CREDIRECT_KOS(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_c32mknodat,(__fd_t __dirfd, __CHAR32_TYPE__ const *__nodename, __mode_t __mode, __dev_t __dev),wmknodat,(__dirfd,__nodename,__mode,__dev))
...
__LOCAL_LIBC(c32mkfifoat) __ATTR_NONNULL((2)) int
