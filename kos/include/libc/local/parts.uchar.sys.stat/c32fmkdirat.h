 ...
 */
#ifndef __local_c32fmkdirat_defined
#define __local_c32fmkdirat_defined
#include <__crt.h>
...
__LOCAL_LIBC(c32fmkdirat) __ATTR_ACCESS_RO(2) int
__NOTHROW_RPC(__LIBKCALL __LIBC_LOCAL_NAME(c32fmkdirat))(__fd_t __dirfd, __CHAR32_TYPE__ const *__pathname, __mode_t __mode, __atflag_t __flags) {
	int __result;
...
#undef __local_c32fmkdirat_defined
#endif /* !__CRT_HAVE_fmkdirat || ((!__CRT_HAVE_convert_wcstombs || __SIZEOF_WCHAR_T__ != 4 || !__LIBCCALL_IS_LIBKCALL) && !__CRT_HAVE_KOS$convert_wcstombs && (!__CRT_HAVE_convert_wcstombsn || __SIZEOF_WCHAR_T__ != 4) && !__CRT_HAVE_KOS$convert_wcstombsn && !__CRT_HAVE_format_aprintf_printer && !__CRT_HAVE_format_aprintf_alloc && !__CRT_HAVE_realloc && !__CRT_HAVE___libc_realloc) */
#endif /* !__local_c32fmkdirat_defined */
