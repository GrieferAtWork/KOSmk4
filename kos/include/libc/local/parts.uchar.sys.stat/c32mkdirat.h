...
__CREDIRECT(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_c32fmkdirat,(__fd_t __dirfd, __CHAR32_TYPE__ const *__pathname, __mode_t __mode, __atflag_t __flags),wfmkdirat,(__dirfd,__pathname,__mode,__flags))
#elif defined(__CRT_HAVE_KOS$wfmkdirat)
__CREDIRECT_KOS(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,__localdep_c32fmkdirat,(__fd_t __dirfd, __CHAR32_TYPE__ const *__pathname, __mode_t __mode, __atflag_t __flags),wfmkdirat,(__dirfd,__pathname,__mode,__flags))
...
__LOCAL_LIBC(c32mkdirat) __ATTR_NONNULL((2)) int
