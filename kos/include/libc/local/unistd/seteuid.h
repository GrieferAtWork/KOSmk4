 ...
 */
#ifndef __local_seteuid_defined
#define __local_seteuid_defined
#include <__crt.h>
...
__LOCAL_LIBC(seteuid) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(seteuid))(__uid_t __euid) {
	return (__NAMESPACE_LOCAL_SYM __localdep_setreuid)((__uid_t)-1, __euid);
}
__NAMESPACE_LOCAL_END
