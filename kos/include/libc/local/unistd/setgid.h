 ...
 */
#ifndef __local_setgid_defined
#define __local_setgid_defined
#include <__crt.h>
...
__LOCAL_LIBC(setgid) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(setgid))(__gid_t __gid) {
	int __result = (__NAMESPACE_LOCAL_SYM __localdep_setregid)(__gid, __gid);
	if (__result != 0)
		__result = (__NAMESPACE_LOCAL_SYM __localdep_setegid)(__gid);
	return __result;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_setgid_defined
#define __local___localdep_setgid_defined
#define __localdep_setgid __LIBC_LOCAL_NAME(setgid)
#endif /* !__local___localdep_setgid_defined */
#else /* __CRT_HAVE_setreuid || __CRT_HAVE___setreuid || __CRT_HAVE___libc_setreuid || __CRT_HAVE_setresuid */
#undef __local_setgid_defined
#endif /* !__CRT_HAVE_setreuid && !__CRT_HAVE___setreuid && !__CRT_HAVE___libc_setreuid && !__CRT_HAVE_setresuid */
#endif /* !__local_setgid_defined */
