...
#endif /* __ECHO */
#ifdef __ECHOK
		__new_ios.c_lflag &= ~__ECHOK;
#endif /* __ECHOK */
#ifdef __ECHOE
		__new_ios.c_lflag &= ~__ECHOE;
#endif /* __ECHOE */
#ifdef __ECHOKE
		__new_ios.c_lflag &= ~__ECHOKE;
#endif /* __ECHOKE */
#ifdef __ECHOCTL
		__new_ios.c_lflag &= ~__ECHOCTL;
#endif /* __ECHOCTL */
#ifdef __ISIG
		__new_ios.c_lflag &= ~__ISIG;
#endif /* __ISIG */
#ifdef __ICANON
		__new_ios.c_lflag &= ~__ICANON;
#endif /* __ICANON */
