 ...
 */
#ifndef __local_setuid_defined
#define __local_setuid_defined
#include <__crt.h>
...
__LOCAL_LIBC(setuid) int
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(setuid))(__uid_t __uid) {
	int __result = (__NAMESPACE_LOCAL_SYM __localdep_setreuid)(__uid, __uid);
	if (__result != 0)
		__result = (__NAMESPACE_LOCAL_SYM __localdep_seteuid)(__uid);
	return __result;
}
__NAMESPACE_LOCAL_END
#ifndef __local___localdep_setuid_defined
#define __local___localdep_setuid_defined
#define __localdep_setuid __LIBC_LOCAL_NAME(setuid)
#endif /* !__local___localdep_setuid_defined */
#else /* __CRT_HAVE_setreuid || __CRT_HAVE___setreuid || __CRT_HAVE___libc_setreuid || __CRT_HAVE_setresuid */
#undef __local_setuid_defined
#endif /* !__CRT_HAVE_setreuid && !__CRT_HAVE___setreuid && !__CRT_HAVE___libc_setreuid && !__CRT_HAVE_setresuid */
#endif /* !__local_setuid_defined */
