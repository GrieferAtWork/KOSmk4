...
__LOCAL_LIBC(euidaccess) __ATTR_WUNUSED __ATTR_ACCESS_RO(1) int
__NOTHROW_RPC(__LIBCCALL __LIBC_LOCAL_NAME(euidaccess))(char const *__file, __STDC_INT_AS_UINT_T __type) {
	return (__NAMESPACE_LOCAL_SYM __localdep_faccessat)(__AT_FDCWD, __file, __type, __AT_EACCESS);
}
__NAMESPACE_LOCAL_END
