...
__CREDIRECT(__ATTR_ACCESS_ROS(2, 3),__SSIZE_TYPE__,__NOTHROW_RPC,__localdep_crt_pwrite32,(__fd_t __fd, void const *__buf, __SIZE_TYPE__ __bufsize, __pos32_t __offset),pwrite,(__fd,__buf,__bufsize,__offset))
...
__LOCAL_LIBC(pwrite64) __ATTR_ACCESS_ROS(2, 3) __SSIZE_TYPE__
