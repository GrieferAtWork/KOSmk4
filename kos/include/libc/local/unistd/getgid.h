 ...
 */
#ifndef __local_getgid_defined
#define __local_getgid_defined
#include <__crt.h>
...
__LOCAL_LIBC(getgid) __ATTR_WUNUSED __gid_t
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(getgid))(void) {
	__gid_t __result;
	if ((__NAMESPACE_LOCAL_SYM __localdep_getresgid)(&__result, __NULLPTR, __NULLPTR))
		__result = (__gid_t)-1;
	return __result;
}
...
#undef __local_getgid_defined
#endif /* !__CRT_HAVE_getresgid */
#endif /* !__local_getgid_defined */
