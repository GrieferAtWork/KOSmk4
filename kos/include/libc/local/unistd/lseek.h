...
__LOCAL_LIBC(lseek) __ATTR_FDARG(1) __off_t
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(lseek))(__fd_t __fd, __off_t __offset, __STDC_INT_AS_UINT_T __whence) {
