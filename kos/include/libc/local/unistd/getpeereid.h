...
#include <features.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_FDARG(1) __ATTR_INOUT(5) __ATTR_OUT(4),int,__NOTHROW_NCX,__localdep_getsockopt,(__fd_t __sockfd, __STDC_INT_AS_UINT_T __level, __STDC_INT_AS_UINT_T __optname, void *__restrict __optval, __socklen_t *__restrict __optlen),getsockopt,(__sockfd,__level,__optname,__optval,__optlen))
#endif /* !__local___localdep_getsockopt_defined */
__NAMESPACE_LOCAL_END
#include <bits/os/ucred.h>
#include <libc/errno.h>
__NAMESPACE_LOCAL_BEGIN
__LOCAL_LIBC(getpeereid) __ATTR_FDARG(1) __ATTR_OUT(2) __ATTR_OUT(3) int
