 ...
 */
#ifndef __local_geteuid_defined
#define __local_geteuid_defined
#include <__crt.h>
...
__LOCAL_LIBC(geteuid) __ATTR_WUNUSED __uid_t
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(geteuid))(void) {
	__uid_t __result;
	if ((__NAMESPACE_LOCAL_SYM __localdep_getresuid)(__NULLPTR, &__result, __NULLPTR))
		__result = (__uid_t)-1;
	return __result;
}
...
#define __localdep_geteuid __LIBC_LOCAL_NAME(geteuid)
#endif /* !__local___localdep_geteuid_defined */
#else /* __CRT_HAVE_getresuid */
#undef __local_geteuid_defined
#endif /* !__CRT_HAVE_getresuid */
#endif /* !__local_geteuid_defined */
