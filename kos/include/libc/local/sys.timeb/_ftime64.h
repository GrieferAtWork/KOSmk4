...
#define __local__ftime64_defined
#include <__crt.h>
#if defined(__CRT_HAVE__ftime64_s) || defined(__CRT_HAVE_ftime64) || defined(__CRT_HAVE__ftime32) || defined(__CRT_HAVE__ftime) || defined(__CRT_HAVE__ftime32_s) || defined(__CRT_HAVE_ftime)
...
__CREDIRECT_VOID(__ATTR_ACCESS_WR(1),__NOTHROW_NCX,__localdep_crt_dos_ftime32,(struct __timeb32 *__timebuf),_ftime32,(__timebuf))
#elif defined(__CRT_HAVE__ftime)
__CREDIRECT_VOID(__ATTR_ACCESS_WR(1),__NOTHROW_NCX,__localdep_crt_dos_ftime32,(struct __timeb32 *__timebuf),_ftime,(__timebuf))
#else /* ... */
...
__CREDIRECT(__ATTR_ACCESS_WR(1),int,__NOTHROW_NCX,__localdep_crt_ftime32,(struct __timeb32 *__timebuf),ftime,(__timebuf))
...
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_ACCESS_WR(1),__errno_t,__NOTHROW_NCX,__localdep_crt_ftime32_s,(struct __timeb32 *__timebuf),_ftime32_s,(__timebuf))
...
__CREDIRECT(__ATTR_ACCESS_WR(1),int,__NOTHROW_NCX,__localdep_crt_ftime64,(struct __timeb64 *__timebuf),ftime64,(__timebuf))
...
#include <bits/types.h>
__NAMESPACE_LOCAL_BEGIN
__CREDIRECT(__ATTR_ACCESS_WR(1),__errno_t,__NOTHROW_NCX,__localdep_crt_ftime64_s,(struct __timeb64 *__timebuf),_ftime64_s,(__timebuf))
#endif /* !__local___localdep_crt_ftime64_s_defined && __CRT_HAVE__ftime64_s */
__LOCAL_LIBC(_ftime64) __ATTR_ACCESS_WR(1) void
__NOTHROW_NCX(__LIBCCALL __LIBC_LOCAL_NAME(_ftime64))(struct __timeb64 *__timebuf) {
#ifdef __CRT_HAVE__ftime64_s
	if __unlikely((__NAMESPACE_LOCAL_SYM __localdep_crt_ftime64_s)(__timebuf))
		(__NAMESPACE_LOCAL_SYM __localdep_bzero)(__timebuf, sizeof(*__timebuf));
#elif defined(__CRT_HAVE_ftime64)
	if __unlikely((__NAMESPACE_LOCAL_SYM __localdep_crt_ftime64)(__timebuf))
		(__NAMESPACE_LOCAL_SYM __localdep_bzero)(__timebuf, sizeof(*__timebuf));
	...
	if __unlikely((__NAMESPACE_LOCAL_SYM __localdep_crt_ftime32_s)(&__temp))
...
#define __local___localdep__ftime64_defined
#define __localdep__ftime64 __LIBC_LOCAL_NAME(_ftime64)
#endif /* !__local___localdep__ftime64_defined */
#else /* __CRT_HAVE__ftime64_s || __CRT_HAVE_ftime64 || __CRT_HAVE__ftime32 || __CRT_HAVE__ftime || __CRT_HAVE__ftime32_s || __CRT_HAVE_ftime */
#undef __local__ftime64_defined
#endif /* !__CRT_HAVE__ftime64_s && !__CRT_HAVE_ftime64 && !__CRT_HAVE__ftime32 && !__CRT_HAVE__ftime && !__CRT_HAVE__ftime32_s && !__CRT_HAVE_ftime */
