...
__CDECLARE(__ATTR_NONNULL((1)),__STDC_INT_AS_UINT_T,__NOTHROW_NCX,partition_union,(struct partition_def *__self, __STDC_INT_AS_UINT_T __a, __STDC_INT_AS_UINT_T __b),(__self,__a,__b))
 ...
 * For  this, choose one  of the class's canonical  elements as the new
 * canonical element of the total  class, which is then also  returned. */
__NAMESPACE_LOCAL_USING_OR_IMPL(partition_union, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_NONNULL((1)) __STDC_INT_AS_UINT_T __NOTHROW_NCX(__LIBCCALL partition_union)(struct partition_def *__self, __STDC_INT_AS_UINT_T __a, __STDC_INT_AS_UINT_T __b) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(partition_union))(__self, __a, __b); })
...
__CDECLARE_VOID(__ATTR_ACCESS_RW(2) __ATTR_NONNULL((1)),__NOTHROW_NCX,partition_print,(struct partition_def __KOS_FIXED_CONST *__self, FILE *__fp),(__self,__fp))
 ...
 * The format used is: '[' ['(' [0 1 2 3 4]... ')']... ']'
 * Example: "[(0 1 2 4 8)(3 6)(5 7)]" */
__NAMESPACE_LOCAL_USING_OR_IMPL(partition_print, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(2) __ATTR_NONNULL((1)) void __NOTHROW_NCX(__LIBCCALL partition_print)(struct partition_def __KOS_FIXED_CONST *__self, FILE *__fp) { (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(partition_print))(__self, __fp); })
#endif /* ... */
