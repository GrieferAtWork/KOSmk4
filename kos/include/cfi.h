...
__ASM_L(	.Lcfi_reg_offset_text_size = (. - .Lcfi_reg_offset_text_start))
__ASM_L(	.popsection)
__ASM_L(	.cfi_escape_uleb128 (1 + .Lcfi_reg_offset_text_size)) /* +1 here instead of above to work around gas bug */
