...
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1)),int,__NOTHROW_RPC,_waccess,(wchar_t const *__file, __STDC_INT_AS_UINT_T __type),waccess,(__file,__type))
#elif defined(__CRT_HAVE__waccess)
__CDECLARE(__ATTR_WUNUSED __ATTR_NONNULL((1)),int,__NOTHROW_RPC,_waccess,(wchar_t const *__file, __STDC_INT_AS_UINT_T __type),(__file,__type))
...
__CDECLARE(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,_wchmod,(wchar_t const *__filename, __mode_t __mode),(__filename,__mode))
...
__FORCELOCAL __ATTR_ARTIFICIAL __ATTR_NONNULL((1)) int __NOTHROW_RPC(__LIBCCALL _wchmod)(wchar_t const *__filename, __mode_t __mode) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wchmod))(__filename, __mode); }
#endif /* ... */
#if defined(__CRT_HAVE_wcreat) && (!defined(__USE_FILE_OFFSET64) || !defined(__O_LARGEFILE) || !__O_LARGEFILE)
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1)),__fd_t,__NOTHROW_RPC,_wcreat,(wchar_t const *__filename, __mode_t __mode),wcreat,(__filename,__mode))
#elif defined(__CRT_HAVE__wcreat) && (!defined(__USE_FILE_OFFSET64) || !defined(__O_LARGEFILE) || !__O_LARGEFILE)
__CDECLARE(__ATTR_WUNUSED __ATTR_NONNULL((1)),__fd_t,__NOTHROW_RPC,_wcreat,(wchar_t const *__filename, __mode_t __mode),(__filename,__mode))
#elif defined(__CRT_HAVE_wcreat64)
__CREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1)),__fd_t,__NOTHROW_RPC,_wcreat,(wchar_t const *__filename, __mode_t __mode),wcreat64,(__filename,__mode))
...
__FORCELOCAL __ATTR_ARTIFICIAL __ATTR_WUNUSED __ATTR_NONNULL((1)) __fd_t __NOTHROW_RPC(__LIBCCALL _wcreat)(wchar_t const *__filename, __mode_t __mode) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wcreat))(__filename, __mode); }
#endif /* ... */
#ifdef __CRT_HAVE_wunlink
__CREDIRECT(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,_wunlink,(wchar_t const *__file),wunlink,(__file))
#elif defined(__CRT_HAVE__wunlink)
__CDECLARE(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,_wunlink,(wchar_t const *__file),(__file))
...
__FORCELOCAL __ATTR_ARTIFICIAL __ATTR_NONNULL((1)) int __NOTHROW_RPC(__LIBCCALL _wunlink)(wchar_t const *__file) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wunlink))(__file); }
#endif /* ... */
#ifdef __CRT_HAVE_wrename
__CREDIRECT(__ATTR_NONNULL((1, 2)),int,__NOTHROW_RPC,_wrename,(wchar_t const *__oldname, wchar_t const *__newname_or_path),wrename,(__oldname,__newname_or_path))
#elif defined(__CRT_HAVE__wrename)
__CDECLARE(__ATTR_NONNULL((1, 2)),int,__NOTHROW_RPC,_wrename,(wchar_t const *__oldname, wchar_t const *__newname_or_path),(__oldname,__newname_or_path))
...
__LIBC __ATTR_WUNUSED __ATTR_NONNULL((1)) __fd_t __NOTHROW_RPC(__VLIBCCALL _wopen)(wchar_t const *__filename, __oflag_t __oflags, ...) __CASMNAME_SAME("_wopen");
#elif defined(__CRT_HAVE_wopen64)
__CVREDIRECT(__ATTR_WUNUSED __ATTR_NONNULL((1)),__fd_t,__NOTHROW_RPC,_wopen,(wchar_t const *__filename, __oflag_t __oflags),wopen64,(__filename,__oflags),__oflags,1,(__mode_t))
...
#define _wopen (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wopen))
#endif /* ... */
...
#else /* __cplusplus */
#define _wsopen (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(_wsopen))
#endif /* !__cplusplus */
#endif /* ... */
