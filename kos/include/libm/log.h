...
__LIBM_LOCAL_FUNC(logf) __ATTR_WUNUSED __IEEE754_FLOAT_TYPE__
...
__LIBM_LOCAL_FUNC(log) __ATTR_WUNUSED __IEEE754_DOUBLE_TYPE__
...
__LIBM_LOCAL_FUNC(logl) __ATTR_WUNUSED __IEEE854_LONG_DOUBLE_TYPE__
