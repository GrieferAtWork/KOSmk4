...
/* R0/S0 on [0, 2.00] */
__LIBM_LOCAL_DECLARE(__IEEE754_FLOAT_TYPE__, R02f, __IEEE754_FLOAT_C(1.5625000000e-02))  /* 0x3c800000 */
__LIBM_LOCAL_DECLARE(__IEEE754_FLOAT_TYPE__, R03f, __IEEE754_FLOAT_C(-1.8997929874e-04)) /* 0xb947352e */
__LIBM_LOCAL_DECLARE(__IEEE754_FLOAT_TYPE__, R04f, __IEEE754_FLOAT_C(1.8295404516e-06))  /* 0x35f58e88 */
__LIBM_LOCAL_DECLARE(__IEEE754_FLOAT_TYPE__, R05f, __IEEE754_FLOAT_C(-4.6183270541e-09)) /* 0xb19eaf3c */
__LIBM_LOCAL_DECLARE(__IEEE754_FLOAT_TYPE__, S01f, __IEEE754_FLOAT_C(1.5619102865e-02))  /* 0x3c7fe744 */
__LIBM_LOCAL_DECLARE(__IEEE754_FLOAT_TYPE__, S02f, __IEEE754_FLOAT_C(1.1692678527e-04))  /* 0x38f53697 */
__LIBM_LOCAL_DECLARE(__IEEE754_FLOAT_TYPE__, S03f, __IEEE754_FLOAT_C(5.1354652442e-07))  /* 0x3509daa6 */
__LIBM_LOCAL_DECLARE(__IEEE754_FLOAT_TYPE__, S04f, __IEEE754_FLOAT_C(1.1661400734e-09))  /* 0x30a045e8 */
...
(__LIBCCALL __ieee754_j0f)(__IEEE754_FLOAT_TYPE__ __x) {
	...
	__z = __x * __x;
	__r = __z * (__LIBM_LOCAL_VALUE(R02f) +
	             __z * (__LIBM_LOCAL_VALUE(R03f) +
	                    __z * (__LIBM_LOCAL_VALUE(R04f) +
	                           __z * __LIBM_LOCAL_VALUE(R05f))));
	__s = __LIBM_LOCAL_VALUE(onef) +
	      __z * (__LIBM_LOCAL_VALUE(S01f) +
	             __z * (__LIBM_LOCAL_VALUE(S02f) +
	                    __z * (__LIBM_LOCAL_VALUE(S03f) +
	                           __z * __LIBM_LOCAL_VALUE(S04f))));
...
/* R0/S0 on [0, 2.00] */
__LIBM_LOCAL_DECLARE(__IEEE754_DOUBLE_TYPE__, R02, __IEEE754_DOUBLE_C(1.56249999999999947958e-02))  /* 0x3F8FFFFF, 0xFFFFFFFD */
__LIBM_LOCAL_DECLARE(__IEEE754_DOUBLE_TYPE__, R03, __IEEE754_DOUBLE_C(-1.89979294238854721751e-04)) /* 0xBF28E6A5, 0xB61AC6E9 */
__LIBM_LOCAL_DECLARE(__IEEE754_DOUBLE_TYPE__, R04, __IEEE754_DOUBLE_C(1.82954049532700665670e-06))  /* 0x3EBEB1D1, 0x0C503919 */
__LIBM_LOCAL_DECLARE(__IEEE754_DOUBLE_TYPE__, R05, __IEEE754_DOUBLE_C(-4.61832688532103189199e-09)) /* 0xBE33D5E7, 0x73D63FCE */
__LIBM_LOCAL_DECLARE(__IEEE754_DOUBLE_TYPE__, S01, __IEEE754_DOUBLE_C(1.56191029464890010492e-02))  /* 0x3F8FFCE8, 0x82C8C2A4 */
__LIBM_LOCAL_DECLARE(__IEEE754_DOUBLE_TYPE__, S02, __IEEE754_DOUBLE_C(1.16926784663337450260e-04))  /* 0x3F1EA6D2, 0xDD57DBF4 */
__LIBM_LOCAL_DECLARE(__IEEE754_DOUBLE_TYPE__, S03, __IEEE754_DOUBLE_C(5.13546550207318111446e-07))  /* 0x3EA13B54, 0xCE84D5A9 */
__LIBM_LOCAL_DECLARE(__IEEE754_DOUBLE_TYPE__, S04, __IEEE754_DOUBLE_C(1.16614003333790000205e-09))  /* 0x3E1408BC, 0xF4745D8F */
__LIBM_LOCAL_DECLARE_END
...
(__LIBCCALL __ieee754_j0)(__IEEE754_DOUBLE_TYPE__ __x) {
	...
	__z = __x * __x;
	__r1 = __z * __LIBM_LOCAL_VALUE(R02);
	__z2 = __z * __z;
	__r2 = __LIBM_LOCAL_VALUE(R03) + __z * __LIBM_LOCAL_VALUE(R04);
	__z4 = __z2 * __z2;
	__r  = __r1 + __z2 * __r2 + __z4 * __LIBM_LOCAL_VALUE(R05);
	__s1 = __LIBM_LOCAL_VALUE(one) + __z * __LIBM_LOCAL_VALUE(S01);
	__s2 = __LIBM_LOCAL_VALUE(S02) + __z * __LIBM_LOCAL_VALUE(S03);
	__s  = __s1 + __z2 * __s2 + __z4 * __LIBM_LOCAL_VALUE(S04);
...
__LIBM_LOCAL_DECLARE(__IEEE854_LONG_DOUBLE_TYPE__, R0l, __IEEE854_LONG_DOUBLE_C(4.287176872744686992880841716723478740566E7))
__LIBM_LOCAL_DECLARE(__IEEE854_LONG_DOUBLE_TYPE__, R1l, __IEEE854_LONG_DOUBLE_C(-6.652058897474241627570911531740907185772E5))
__LIBM_LOCAL_DECLARE(__IEEE854_LONG_DOUBLE_TYPE__, R2l, __IEEE854_LONG_DOUBLE_C(7.011848381719789863458364584613651091175E3))
__LIBM_LOCAL_DECLARE(__IEEE854_LONG_DOUBLE_TYPE__, R3l, __IEEE854_LONG_DOUBLE_C(-3.168040850193372408702135490809516253693E1))
__LIBM_LOCAL_DECLARE(__IEEE854_LONG_DOUBLE_TYPE__, R4l, __IEEE854_LONG_DOUBLE_C(6.030778552661102450545394348845599300939E-2))
__LIBM_LOCAL_DECLARE(__IEEE854_LONG_DOUBLE_TYPE__, S0l, __IEEE854_LONG_DOUBLE_C(2.743793198556599677955266341699130654342E9))
__LIBM_LOCAL_DECLARE(__IEEE854_LONG_DOUBLE_TYPE__, S1l, __IEEE854_LONG_DOUBLE_C(3.364330079384816249840086842058954076201E7))
__LIBM_LOCAL_DECLARE(__IEEE854_LONG_DOUBLE_TYPE__, S2l, __IEEE854_LONG_DOUBLE_C(1.924119649412510777584684927494642526573E5))
__LIBM_LOCAL_DECLARE(__IEEE854_LONG_DOUBLE_TYPE__, S3l, __IEEE854_LONG_DOUBLE_C(6.239282256012734914211715620088714856494E2))
__LIBM_LOCAL_DECLARE_END
...
(__LIBCCALL __ieee854_j0l)(__IEEE854_LONG_DOUBLE_TYPE__ __x) {
	...
	__z = __x * __x;
	__r = __z * (__LIBM_LOCAL_VALUE(R0l) +
	             __z * (__LIBM_LOCAL_VALUE(R1l) +
	                    __z * (__LIBM_LOCAL_VALUE(R2l) +
	                           __z * (__LIBM_LOCAL_VALUE(R3l) +
	                                  __z * __LIBM_LOCAL_VALUE(R4l)))));
	__s = __LIBM_LOCAL_VALUE(S0l) +
	      __z * (__LIBM_LOCAL_VALUE(S1l) +
	             __z * (__LIBM_LOCAL_VALUE(S2l) +
	                    __z * (__LIBM_LOCAL_VALUE(S3l) +
	                           __z)));
