...
__LIBM_LOCAL_DECLARE(__IEEE854_LONG_DOUBLE_TYPE__, hugevall, __IEEE854_LONG_DOUBLE_C(1.0e4930))
...
(__LIBCCALL __ieee854_atanl)(__IEEE854_LONG_DOUBLE_TYPE__ __x) {
	...
	if (__k <= 0x3fc5) { /* |x| < 2**-58 */
		/* Raise inexact. */
		if (__LIBM_LOCAL_VALUE(hugevall) + __x > __IEEE854_LONG_DOUBLE_C(0.0))
			return __x;
	}
