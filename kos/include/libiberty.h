 ...
 * >> basename("");                // Returns ""
 * >> basename(NULL);              // <Undefined behavior> */
__CREDIRECT(__ATTR_PURE __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_IN(1),char const *,__NOTHROW_NCX,lbasename,(char const *__filename),basename,(__filename))
#elif defined(__CRT_HAVE___basename)
/* >> basename(3)
 * Alternate `basename(3)' function that doesn't modify its `filename' argument
 * For a version that is allowed to modify its argument, but is also allowed to
 ...
 * >> basename("");                // Returns ""
 * >> basename(NULL);              // <Undefined behavior> */
__CREDIRECT(__ATTR_PURE __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_IN(1),char const *,__NOTHROW_NCX,lbasename,(char const *__filename),__basename,(__filename))
#elif defined(__CRT_HAVE_lbasename)
/* >> basename(3)
 * Alternate `basename(3)' function that doesn't modify its `filename' argument
 * For a version that is allowed to modify its argument, but is also allowed to
 ...
 * >> basename("");                // Returns ""
 * >> basename(NULL);              // <Undefined behavior> */
__CDECLARE(__ATTR_PURE __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_IN(1),char const *,__NOTHROW_NCX,lbasename,(char const *__filename),(__filename))
#else /* ... */
#include <libc/local/string/basename.h>
/* >> basename(3)
 * Alternate `basename(3)' function that doesn't modify its `filename' argument
 ...
 * >> basename("");                // Returns ""
 * >> basename(NULL);              // <Undefined behavior> */
__FORCELOCAL __ATTR_ARTIFICIAL __ATTR_PURE __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_IN(1) char const *__NOTHROW_NCX(__LIBCCALL lbasename)(char const *__filename) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(basename))(__filename); }
#endif /* !... */
...
__CDECLARE(__ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_IN(1),char *,__NOTHROW_NCX,lrealpath,(char const *__path),(__path))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(lrealpath, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_IN(1) char *__NOTHROW_NCX(__LIBCCALL lrealpath)(char const *__path) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(lrealpath))(__path); })
#endif /* ... */
...
__CDECLARE(__ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_IN(1),char *,__NOTHROW_NCX,xstrdup,(char const *__restrict __string),(__string))
#elif defined(__CRT_HAVE_xmalloc) || defined(__CRT_HAVE_xrealloc) || defined(__CRT_HAVE_xcalloc) || ((defined(__CRT_HAVE_malloc) || defined(__CRT_HAVE___libc_malloc) || defined(__CRT_HAVE_calloc) || defined(__CRT_HAVE___libc_calloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc) || defined(__CRT_HAVE_memalign) || defined(__CRT_HAVE_aligned_alloc) || defined(__CRT_HAVE___libc_memalign) || defined(__CRT_HAVE_posix_memalign)) && defined(__CRT_HAVE_xmalloc_failed))
#include <libc/local/libiberty/xstrdup.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(xstrdup, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_IN(1) char *__NOTHROW_NCX(__LIBCCALL xstrdup)(char const *__restrict __string) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(xstrdup))(__string); })
#endif /* ... */
...
__CDECLARE(__ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_ALLOC_SIZE((3)) __ATTR_INS(1, 2),void *,__NOTHROW_NCX,xmemdup,(void const *__src, size_t __src_bytes, size_t __alloc_size),(__src,__src_bytes,__alloc_size))
#elif defined(__CRT_HAVE_xmalloc) || defined(__CRT_HAVE_xrealloc) || defined(__CRT_HAVE_xcalloc) || ((defined(__CRT_HAVE_malloc) || defined(__CRT_HAVE___libc_malloc) || defined(__CRT_HAVE_calloc) || defined(__CRT_HAVE___libc_calloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc) || defined(__CRT_HAVE_memalign) || defined(__CRT_HAVE_aligned_alloc) || defined(__CRT_HAVE___libc_memalign) || defined(__CRT_HAVE_posix_memalign)) && defined(__CRT_HAVE_xmalloc_failed))
#include <libc/local/libiberty/xmemdup.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(xmemdup, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_ALLOC_SIZE((3)) __ATTR_INS(1, 2) void *__NOTHROW_NCX(__LIBCCALL xmemdup)(void const *__src, size_t __src_bytes, size_t __alloc_size) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(xmemdup))(__src, __src_bytes, __alloc_size); })
#endif /* ... */
#ifdef __CRT_HAVE_xvasprintf
/* >> strdupf(3), vstrdupf(3)
 * Print the given `format' into a newly allocated, heap-allocated string */
__CDECLARE(__ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_PRINTF(1, 0),char *,__NOTHROW_NCX,xvasprintf,(char const *__format, __builtin_va_list __args),(__format,__args))
...
/* >> strdupf(3), vstrdupf(3)
 * Print the given `format' into a newly allocated, heap-allocated string */
__NAMESPACE_LOCAL_USING_OR_IMPL(xvasprintf, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_PRINTF(1, 0) char *__NOTHROW_NCX(__LIBCCALL xvasprintf)(char const *__format, __builtin_va_list __args) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(xvasprintf))(__format, __args); })
#endif /* ... */
#ifdef __CRT_HAVE_xasprintf
__LIBC __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_IN(1) __ATTR_LIBC_PRINTF(1, 2) char *__NOTHROW_NCX(__VLIBCCALL xasprintf)(char const *__restrict __format, ...) __CASMNAME_SAME("xasprintf");
...
__CDECLARE(__ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_IN_OPT(1),char **,__NOTHROW_NCX,dupargv,(char *__KOS_FIXED_CONST *___argv),(___argv))
#elif defined(__CRT_HAVE_xmalloc) || defined(__CRT_HAVE_xrealloc) || defined(__CRT_HAVE_xcalloc) || ((defined(__CRT_HAVE_malloc) || defined(__CRT_HAVE___libc_malloc) || defined(__CRT_HAVE_calloc) || defined(__CRT_HAVE___libc_calloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc) || defined(__CRT_HAVE_memalign) || defined(__CRT_HAVE_aligned_alloc) || defined(__CRT_HAVE___libc_memalign) || defined(__CRT_HAVE_posix_memalign)) && defined(__CRT_HAVE_xmalloc_failed))
#include <libc/local/libiberty/dupargv.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(dupargv, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_IN_OPT(1) char **__NOTHROW_NCX(__LIBCCALL dupargv)(char *__KOS_FIXED_CONST *___argv) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(dupargv))(___argv); })
#endif /* ... */
#ifdef __CRT_HAVE_freeargv
__CDECLARE_VOID(__ATTR_IN_OPT(1),__NOTHROW_NCX,freeargv,(char **___argv),(___argv))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(freeargv, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN_OPT(1) void __NOTHROW_NCX(__LIBCCALL freeargv)(char **___argv) { (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(freeargv))(___argv); })
#endif /* ... */
#ifdef __CRT_HAVE_countargv
__CDECLARE(__ATTR_PURE __ATTR_WUNUSED __ATTR_IN_OPT(1),__STDC_INT_AS_SIZE_T,__NOTHROW_NCX,countargv,(char *const *___argv),(___argv))
...
#if (defined(__CRT_HAVE_kfstat) && defined(__CRT_KOS_PRIMARY)) || (defined(__CRT_HAVE_kfstat64) && defined(__CRT_KOS_PRIMARY)) || defined(__CRT_HAVE_fstat) || defined(__CRT_HAVE_fstat64) || defined(__CRT_HAVE___fstat64_time64) || defined(__CRT_HAVE__fstat) || defined(__CRT_HAVE__fstat32) || defined(__CRT_HAVE__fstati64) || defined(__CRT_HAVE__fstat32i64) || defined(__CRT_HAVE__fstat64) || defined(__CRT_HAVE__fstat64i32)
...
#endif /* (__CRT_HAVE_kfstat && __CRT_KOS_PRIMARY) || (__CRT_HAVE_kfstat64 && __CRT_KOS_PRIMARY) || __CRT_HAVE_fstat || __CRT_HAVE_fstat64 || __CRT_HAVE___fstat64_time64 || __CRT_HAVE__fstat || __CRT_HAVE__fstat32 || __CRT_HAVE__fstati64 || __CRT_HAVE__fstat32i64 || __CRT_HAVE__fstat64 || __CRT_HAVE__fstat64i32 */
#endif /* !__CRT_HAVE_fdmatch */
#ifdef __CRT_HAVE_buildargv
__CDECLARE(__ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_IN_OPT(1),char **,__NOTHROW_NCX,buildargv,(char const *__cmdline),(__cmdline))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(buildargv, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_WUNUSED __ATTR_IN_OPT(1) char **__NOTHROW_NCX(__LIBCCALL buildargv)(char const *__cmdline) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(buildargv))(__cmdline); })
#endif /* ... */
#ifdef __CRT_HAVE_expandargv
/* >> expandargv(3)
 * Expand special `@file' arguments passed on the commandline */
__CDECLARE_VOID(__ATTR_INOUT(1) __ATTR_INOUT(2),__NOTHROW_NCX,expandargv,(int *__p_argc, char ***__p_argv),(__p_argc,__p_argv))
...
/* >> expandargv(3)
 * Expand special `@file' arguments passed on the commandline */
__NAMESPACE_LOCAL_USING_OR_IMPL(expandargv, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_INOUT(1) __ATTR_INOUT(2) void __NOTHROW_NCX(__LIBCCALL expandargv)(int *__p_argc, char ***__p_argv) { (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(expandargv))(__p_argc, __p_argv); })
...
/* @return: 0 : Success
 * @return: 1 : Error */
__CDECLARE(__ATTR_IN(1) __ATTR_INOUT_OPT(2),int,__NOTHROW_NCX,writeargv,(char *const *___argv, FILE *__fp),(___argv,__fp))
...
/* @return: 0 : Success
 * @return: 1 : Error */
__NAMESPACE_LOCAL_USING_OR_IMPL(writeargv, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(1) __ATTR_INOUT_OPT(2) int __NOTHROW_NCX(__LIBCCALL writeargv)(char *const *___argv, FILE *__fp) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(writeargv))(___argv, __fp); })
#endif /* ... */
#ifdef __CRT_HAVE_concat
__LIBC __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_SENTINEL __ATTR_WUNUSED __ATTR_IN_OPT(1) char *__NOTHROW_NCX(__VLIBCCALL concat)(char const *__first, ...) __CASMNAME_SAME("concat");
#elif defined(__CRT_HAVE_xmalloc) || defined(__CRT_HAVE_xrealloc) || defined(__CRT_HAVE_xcalloc) || ((defined(__CRT_HAVE_malloc) || defined(__CRT_HAVE___libc_malloc) || defined(__CRT_HAVE_calloc) || defined(__CRT_HAVE___libc_calloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc) || defined(__CRT_HAVE_memalign) || defined(__CRT_HAVE_aligned_alloc) || defined(__CRT_HAVE___libc_memalign) || defined(__CRT_HAVE_posix_memalign)) && defined(__CRT_HAVE_xmalloc_failed))
#include <libc/local/libiberty/concat.h>
#if defined(__cplusplus) && __has_builtin(__builtin_va_arg_pack)
__NAMESPACE_LOCAL_USING_OR_IMPL(concat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_SENTINEL __ATTR_WUNUSED __ATTR_IN_OPT(1) char *__NOTHROW_NCX(__VLIBCCALL concat)(char const *__first, ...) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(concat))(__first, __builtin_va_arg_pack()); })
#else /* __cplusplus && __has_builtin(__builtin_va_arg_pack) */
#define concat(...) (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(concat))(__VA_ARGS__)
#endif /* !__cplusplus || !__has_builtin(__builtin_va_arg_pack) */
#endif /* ... */
#ifdef __CRT_HAVE_reconcat
__LIBC __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_SENTINEL __ATTR_WUNUSED __ATTR_IN_OPT(1) __ATTR_IN_OPT(2) char *__NOTHROW_NCX(__VLIBCCALL reconcat)(char *__old_ptr, char const *__first, ...) __CASMNAME_SAME("reconcat");
#elif defined(__CRT_HAVE_xmalloc) || defined(__CRT_HAVE_xrealloc) || defined(__CRT_HAVE_xcalloc) || ((defined(__CRT_HAVE_malloc) || defined(__CRT_HAVE___libc_malloc) || defined(__CRT_HAVE_calloc) || defined(__CRT_HAVE___libc_calloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc) || defined(__CRT_HAVE_memalign) || defined(__CRT_HAVE_aligned_alloc) || defined(__CRT_HAVE___libc_memalign) || defined(__CRT_HAVE_posix_memalign)) && defined(__CRT_HAVE_xmalloc_failed))
#include <libc/local/libiberty/reconcat.h>
#if defined(__cplusplus) && __has_builtin(__builtin_va_arg_pack)
__NAMESPACE_LOCAL_USING_OR_IMPL(reconcat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_SENTINEL __ATTR_WUNUSED __ATTR_IN_OPT(1) __ATTR_IN_OPT(2) char *__NOTHROW_NCX(__VLIBCCALL reconcat)(char *__old_ptr, char const *__first, ...) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(reconcat))(__old_ptr, __first, __builtin_va_arg_pack()); })
#else /* __cplusplus && __has_builtin(__builtin_va_arg_pack) */
#define reconcat(...) (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(reconcat))(__VA_ARGS__)
#endif /* !__cplusplus || !__has_builtin(__builtin_va_arg_pack) */
#endif /* ... */
#ifdef __CRT_HAVE_concat_length
__LIBC __ATTR_IN_OPT(1) __ULONGPTR_TYPE__ __NOTHROW_NCX(__VLIBCCALL concat_length)(char const *__first, ...) __CASMNAME_SAME("concat_length");
#else /* __CRT_HAVE_concat_length */
#include <libc/local/libiberty/concat_length.h>
#if defined(__cplusplus) && __has_builtin(__builtin_va_arg_pack)
__NAMESPACE_LOCAL_USING_OR_IMPL(concat_length, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN_OPT(1) __ULONGPTR_TYPE__ __NOTHROW_NCX(__VLIBCCALL concat_length)(char const *__first, ...) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(concat_length))(__first, __builtin_va_arg_pack()); })
#else /* __cplusplus && __has_builtin(__builtin_va_arg_pack) */
...
__LIBC __ATTR_RETNONNULL __ATTR_IN_OPT(2) __ATTR_OUT(1) char *__NOTHROW_NCX(__VLIBCCALL concat_copy)(char *__dst, char const *__first, ...) __CASMNAME_SAME("concat_copy");
#else /* __CRT_HAVE_concat_copy */
#include <libc/local/libiberty/concat_copy.h>
#if defined(__cplusplus) && __has_builtin(__builtin_va_arg_pack)
__NAMESPACE_LOCAL_USING_OR_IMPL(concat_copy, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_RETNONNULL __ATTR_IN_OPT(2) __ATTR_OUT(1) char *__NOTHROW_NCX(__VLIBCCALL concat_copy)(char *__dst, char const *__first, ...) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(concat_copy))(__dst, __first, __builtin_va_arg_pack()); })
#else /* __cplusplus && __has_builtin(__builtin_va_arg_pack) */
...
__LIBC __ATTR_IN_OPT(1) char *__NOTHROW_NCX(__VLIBCCALL concat_copy2)(char const *__first, ...) __CASMNAME_SAME("concat_copy2");
...
#if defined(__cplusplus) && __has_builtin(__builtin_va_arg_pack)
__NAMESPACE_LOCAL_USING_OR_IMPL(concat_copy2, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN_OPT(1) char *__NOTHROW_NCX(__VLIBCCALL concat_copy2)(char const *__first, ...) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(concat_copy2))(__first, __builtin_va_arg_pack()); })
#else /* __cplusplus && __has_builtin(__builtin_va_arg_pack) */
...
#endif /* (__RUSAGE_SELF && ((__CRT_HAVE_getrusage && __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__) || (__CRT_HAVE___getrusage && __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__) || (__CRT_HAVE___libc_getrusage && __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__) || __CRT_HAVE_getrusage64)) || (_SC_CLK_TCK && (__CRT_HAVE_sysconf || __CRT_HAVE___sysconf) && (__CRT_HAVE_times || __CRT_HAVE___times || __CRT_HAVE___libc_times)) || (__VTIMES_UNITS_PER_SECOND && (__CRT_HAVE_vtimes || (__RUSAGE_SELF && __RUSAGE_CHILDREN && ((__CRT_HAVE_getrusage && (!__USE_TIME_BITS64 || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)) || (__CRT_HAVE___getrusage && (!__USE_TIME_BITS64 || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)) || (__CRT_HAVE___libc_getrusage && (!__USE_TIME_BITS64 || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)) || (__CRT_HAVE_getrusage64 && (__USE_TIME_BITS64 || __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)))))) || (__CLOCKS_PER_SEC && (__CRT_HAVE_clock || (__CLOCK_PROCESS_CPUTIME_ID && (__CRT_HAVE_clock_gettime64 || __CRT_HAVE_clock_gettime || __CRT_HAVE___clock_gettime)) || __CRT_HAVE_times || __CRT_HAVE___times || __CRT_HAVE___libc_times)) */
...
__CDECLARE(__ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_IN_OPT(1) __ATTR_IN_OPT(2),char *,__NOTHROW_NCX,make_temp_file_with_prefix,(char const *__prefix, char const *__suffix),(__prefix,__suffix))
...
__CDECLARE(__ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_IN_OPT(1),char *,__NOTHROW_NCX,make_temp_file,(char const *__suffix),(__suffix))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(make_temp_file, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_MALLOC __ATTR_MALL_DEFAULT_ALIGNED __ATTR_RETNONNULL __ATTR_WUNUSED __ATTR_IN_OPT(1) char *__NOTHROW_NCX(__LIBCCALL make_temp_file)(char const *__suffix) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(make_temp_file))(__suffix); })
...
__CDECLARE(__ATTR_IN(1),int,__NOTHROW_NCX,unlink_if_ordinary,(char const *__filename),(__filename))
 ...
 * @return:  1: File doesn't exist, isn't accessible, or not a "regular" file.
 * @return: -1: Unlink failed (s.a. `errno') */
__NAMESPACE_LOCAL_USING_OR_IMPL(unlink_if_ordinary, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(1) int __NOTHROW_NCX(__LIBCCALL unlink_if_ordinary)(char const *__filename) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(unlink_if_ordinary))(__filename); })
...
__CDECLARE(__ATTR_PURE __ATTR_WUNUSED __ATTR_INS(1, 2) __ATTR_NONNULL((1)),__UINT32_TYPE__,__NOTHROW_NCX,xcrc32,(__BYTE_TYPE__ const *__buf, __STDC_INT_AS_SIZE_T __len, __UINT32_TYPE__ __crc),(__buf,__len,__crc))
#else /* __CRT_HAVE_xcrc32 */
#include <libc/local/libiberty/xcrc32.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(xcrc32, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_PURE __ATTR_WUNUSED __ATTR_INS(1, 2) __ATTR_NONNULL((1)) __UINT32_TYPE__ __NOTHROW_NCX(__LIBCCALL xcrc32)(__BYTE_TYPE__ const *__buf, __STDC_INT_AS_SIZE_T __len, __UINT32_TYPE__ __crc) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(xcrc32))(__buf, __len, __crc); })
