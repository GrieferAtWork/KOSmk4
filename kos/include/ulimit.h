...
#undef UL_GETFSIZE
#undef UL_SETFSIZE
#undef __UL_GETMAXBRK
#undef __UL_GETOPENMAX
#ifdef __CC__
enum {
...
#ifdef __CC__
#if defined(__CRT_HAVE_ulimit)
/* Control process limits according to CMD */
__LIBC long int __NOTHROW_NCX(__VLIBCCALL ulimit)(int __cmd, ...) __CASMNAME_SAME("ulimit");
#endif /* ulimit... */
#endif /* __CC__ */
