...
#define DlSection_ModuleEndRead(self)    (void)(atomic_rwlock_endread_ex(&(self)->ds_module_lock) && (DlSection_ModuleReap(self), 0))
#define _DlSection_ModuleEnd(self)       atomic_rwlock_end(&(self)->ds_module_lock)
#define DlSection_ModuleEnd(self)        (void)(atomic_rwlock_end_ex(&(self)->ds_module_lock) && (DlSection_ModuleReap(self), 0))
...
#define DlModule_SectionsEndRead(self)    (void)(atomic_rwlock_endread_ex(&(self)->dm_sections_lock) && (DlModule_SectionsReap(self), 0))
#define _DlModule_SectionsEnd(self)       atomic_rwlock_end(&(self)->dm_sections_lock)
#define DlModule_SectionsEnd(self)        (void)(atomic_rwlock_end_ex(&(self)->dm_sections_lock) && (DlModule_SectionsReap(self), 0))
...
#define __REFCNT_DESTROY_NOTHROW __NOTHROW_CB
...
#define dlglobals_global_endread(self)    (void)(atomic_rwlock_endread_ex(&(self)->dg_globallock) && (dlglobals_global_reap(self), 0))
#define _dlglobals_global_end(self)       atomic_rwlock_end(&(self)->dg_globallock)
#define dlglobals_global_end(self)        (void)(atomic_rwlock_end_ex(&(self)->dg_globallock) && (dlglobals_global_reap(self), 0))
...
#define dlglobals_all_endread(self)    (void)(atomic_rwlock_endread_ex(&(self)->dg_alllock) && (dlglobals_all_reap(self), 0))
#define _dlglobals_all_end(self)       atomic_rwlock_end(&(self)->dg_alllock)
#define dlglobals_all_end(self)        (void)(atomic_rwlock_end_ex(&(self)->dg_alllock) && (dlglobals_all_reap(self), 0))
...
#define dlglobals_tls_segment_endread(self)    (void)(atomic_rwlock_endread_ex(&(self)->dg_tls_segment_lock) && (dlglobals_tls_segment_reap(self), 0))
#define _dlglobals_tls_segment_end(self)       atomic_rwlock_end(&(self)->dg_tls_segment_lock)
#define dlglobals_tls_segment_end(self)        (void)(atomic_rwlock_end_ex(&(self)->dg_tls_segment_lock) && (dlglobals_tls_segment_reap(self), 0))
