...
#define dltls_segment_ex_endread(self)    (void)(atomic_rwlock_endread_ex(&(self)->ts_exlock) && (dltls_segment_ex_reap(self), 0))
#define _dltls_segment_ex_end(self)       atomic_rwlock_end(&(self)->ts_exlock)
#define dltls_segment_ex_end(self)        (void)(atomic_rwlock_end_ex(&(self)->ts_exlock) && (dltls_segment_ex_reap(self), 0))
