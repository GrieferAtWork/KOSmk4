...
__CREDIRECT(,intptr_t,__NOTHROW_NCX,_spawnv,(int __mode, char const *__restrict __path, __TARGV),spawnv,(__mode,__path,))
#elif defined(__CRT_HAVE__spawnv)
__CDECLARE(,intptr_t,__NOTHROW_NCX,_spawnv,(int __mode, char const *__restrict __path, __TARGV),(__mode,__path,))
#endif /* ... */
#ifdef __CRT_HAVE_spawnvp
__CREDIRECT(,intptr_t,__NOTHROW_NCX,_spawnvp,(int __mode, char const *__restrict __file, __TARGV),spawnvp,(__mode,__file,))
#elif defined(__CRT_HAVE__spawnvp)
__CDECLARE(,intptr_t,__NOTHROW_NCX,_spawnvp,(int __mode, char const *__restrict __file, __TARGV),(__mode,__file,))
#endif /* ... */
#ifdef __CRT_HAVE_spawnve
__CREDIRECT(,intptr_t,__NOTHROW_NCX,_spawnve,(int __mode, char const *__restrict __path, __TARGV, __TENVP),spawnve,(__mode,__path,,))
#elif defined(__CRT_HAVE__spawnve)
__CDECLARE(,intptr_t,__NOTHROW_NCX,_spawnve,(int __mode, char const *__restrict __path, __TARGV, __TENVP),(__mode,__path,,))
#endif /* ... */
#ifdef __CRT_HAVE_spawnvpe
__CREDIRECT(,intptr_t,__NOTHROW_NCX,_spawnvpe,(int __mode, char const *__restrict __file, __TARGV, __TENVP),spawnvpe,(__mode,__file,,))
#elif defined(__CRT_HAVE__spawnvpe)
__CDECLARE(,intptr_t,__NOTHROW_NCX,_spawnvpe,(int __mode, char const *__restrict __file, __TARGV, __TENVP),(__mode,__file,,))
#endif /* ... */
#ifdef __CRT_HAVE_spawnl
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _spawnl)(int __mode, char const *__restrict __path, char const *__args, ...) __CASMNAME("spawnl");
#elif defined(__CRT_HAVE__spawnl)
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _spawnl)(int __mode, char const *__restrict __path, char const *__args, ...) __CASMNAME_SAME("_spawnl");
...
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _spawnlp)(int __mode, char const *__restrict __file, char const *__args, ...) __CASMNAME("spawnlp");
#elif defined(__CRT_HAVE__spawnlp)
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _spawnlp)(int __mode, char const *__restrict __file, char const *__args, ...) __CASMNAME_SAME("_spawnlp");
...
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _spawnle)(int __mode, char const *__restrict __path, char const *__args, ...) __CASMNAME("spawnle");
#elif defined(__CRT_HAVE__spawnle)
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _spawnle)(int __mode, char const *__restrict __path, char const *__args, ...) __CASMNAME_SAME("_spawnle");
...
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _spawnlpe)(int __mode, char const *__restrict __file, char const *__args, ...) __CASMNAME("spawnlpe");
#elif defined(__CRT_HAVE__spawnlpe)
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _spawnlpe)(int __mode, char const *__restrict __file, char const *__args, ...) __CASMNAME_SAME("_spawnlpe");
...
__CREDIRECT(,intptr_t,__NOTHROW_NCX,_wspawnv,(int __mode, wchar_t const *__restrict __path, __TWARGV),wspawnv,(__mode,__path,))
#elif defined(__CRT_HAVE_DOS$wspawnv) && __SIZEOF_WCHAR_T__ == 4
__COMPILER_REDIRECT(__LIBC,,intptr_t,__NOTHROW_NCX,__LIBCCALL,_wspawnv,(int __mode, wchar_t const *__restrict __path, __TWARGV),KOS$wspawnv,(__mode,__path,))
#elif defined(__CRT_HAVE_DOS$_wspawnv) && __SIZEOF_WCHAR_T__ == 2
__COMPILER_REDIRECT(__LIBC,,intptr_t,__NOTHROW_NCX,__LIBCCALL,_wspawnv,(int __mode, wchar_t const *__restrict __path, __TWARGV),DOS$_wspawnv,(__mode,__path,))
#endif /* ... */
#ifdef __CRT_HAVE_wspawnvp
__CREDIRECT(,intptr_t,__NOTHROW_NCX,_wspawnvp,(int __mode, wchar_t const *__restrict __path, __TWARGV),wspawnvp,(__mode,__path,))
#elif defined(__CRT_HAVE_DOS$wspawnvp) && __SIZEOF_WCHAR_T__ == 4
__COMPILER_REDIRECT(__LIBC,,intptr_t,__NOTHROW_NCX,__LIBCCALL,_wspawnvp,(int __mode, wchar_t const *__restrict __path, __TWARGV),KOS$wspawnvp,(__mode,__path,))
#elif defined(__CRT_HAVE_DOS$_wspawnvp) && __SIZEOF_WCHAR_T__ == 2
__COMPILER_REDIRECT(__LIBC,,intptr_t,__NOTHROW_NCX,__LIBCCALL,_wspawnvp,(int __mode, wchar_t const *__restrict __path, __TWARGV),DOS$_wspawnvp,(__mode,__path,))
#endif /* ... */
#ifdef __CRT_HAVE_wspawnve
__CREDIRECT(,intptr_t,__NOTHROW_NCX,_wspawnve,(int __mode, wchar_t const *__restrict __path, __TWARGV, __TWENVP),wspawnve,(__mode,__path,,))
#elif defined(__CRT_HAVE_DOS$wspawnve) && __SIZEOF_WCHAR_T__ == 4
__COMPILER_REDIRECT(__LIBC,,intptr_t,__NOTHROW_NCX,__LIBCCALL,_wspawnve,(int __mode, wchar_t const *__restrict __path, __TWARGV, __TWENVP),KOS$wspawnve,(__mode,__path,,))
#elif defined(__CRT_HAVE_DOS$_wspawnve) && __SIZEOF_WCHAR_T__ == 2
__COMPILER_REDIRECT(__LIBC,,intptr_t,__NOTHROW_NCX,__LIBCCALL,_wspawnve,(int __mode, wchar_t const *__restrict __path, __TWARGV, __TWENVP),DOS$_wspawnve,(__mode,__path,,))
#endif /* ... */
#ifdef __CRT_HAVE_wspawnvpe
__CREDIRECT(,intptr_t,__NOTHROW_NCX,_wspawnvpe,(int __mode, wchar_t const *__restrict __path, __TWARGV, __TWENVP),wspawnvpe,(__mode,__path,,))
#elif defined(__CRT_HAVE_DOS$wspawnvpe) && __SIZEOF_WCHAR_T__ == 4
__COMPILER_REDIRECT(__LIBC,,intptr_t,__NOTHROW_NCX,__LIBCCALL,_wspawnvpe,(int __mode, wchar_t const *__restrict __path, __TWARGV, __TWENVP),KOS$wspawnvpe,(__mode,__path,,))
#elif defined(__CRT_HAVE_DOS$_wspawnvpe) && __SIZEOF_WCHAR_T__ == 2
__COMPILER_REDIRECT(__LIBC,,intptr_t,__NOTHROW_NCX,__LIBCCALL,_wspawnvpe,(int __mode, wchar_t const *__restrict __path, __TWARGV, __TWENVP),DOS$_wspawnvpe,(__mode,__path,,))
#endif /* ... */
#ifdef __CRT_HAVE_wspawnl
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _wspawnl)(int __mode, wchar_t const *__restrict __path, wchar_t const *__args, ...) __CASMNAME("wspawnl");
#elif defined(__CRT_HAVE_DOS$wspawnl) && __SIZEOF_WCHAR_T__ == 4
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _wspawnl)(int __mode, wchar_t const *__restrict __path, wchar_t const *__args, ...) __ASMNAME("KOS$wspawnl");
#elif defined(__CRT_HAVE_DOS$_wspawnl) && __SIZEOF_WCHAR_T__ == 2
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _wspawnl)(int __mode, wchar_t const *__restrict __path, wchar_t const *__args, ...) __ASMNAME("DOS$_wspawnl");
...
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _wspawnlp)(int __mode, wchar_t const *__restrict __path, wchar_t const *__args, ...) __CASMNAME("wspawnlp");
#elif defined(__CRT_HAVE_DOS$wspawnlp) && __SIZEOF_WCHAR_T__ == 4
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _wspawnlp)(int __mode, wchar_t const *__restrict __path, wchar_t const *__args, ...) __ASMNAME("KOS$wspawnlp");
#elif defined(__CRT_HAVE_DOS$_wspawnlp) && __SIZEOF_WCHAR_T__ == 2
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _wspawnlp)(int __mode, wchar_t const *__restrict __path, wchar_t const *__args, ...) __ASMNAME("DOS$_wspawnlp");
...
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _wspawnle)(int __mode, wchar_t const *__restrict __path, wchar_t const *__args, ...) __CASMNAME("wspawnle");
#elif defined(__CRT_HAVE_DOS$wspawnle) && __SIZEOF_WCHAR_T__ == 4
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _wspawnle)(int __mode, wchar_t const *__restrict __path, wchar_t const *__args, ...) __ASMNAME("KOS$wspawnle");
#elif defined(__CRT_HAVE_DOS$_wspawnle) && __SIZEOF_WCHAR_T__ == 2
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _wspawnle)(int __mode, wchar_t const *__restrict __path, wchar_t const *__args, ...) __ASMNAME("DOS$_wspawnle");
...
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _wspawnlpe)(int __mode, wchar_t const *__restrict __path, wchar_t const *__args, ...) __CASMNAME("wspawnlpe");
#elif defined(__CRT_HAVE_DOS$wspawnlpe) && __SIZEOF_WCHAR_T__ == 4
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _wspawnlpe)(int __mode, wchar_t const *__restrict __path, wchar_t const *__args, ...) __ASMNAME("KOS$wspawnlpe");
#elif defined(__CRT_HAVE_DOS$_wspawnle) && __SIZEOF_WCHAR_T__ == 2
__LIBC intptr_t __NOTHROW_NCX(__VLIBCCALL _wspawnlpe)(int __mode, wchar_t const *__restrict __path, wchar_t const *__args, ...) __ASMNAME("DOS$_wspawnle");
