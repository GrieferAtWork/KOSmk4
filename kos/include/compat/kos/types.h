...
#define __compat_time64_t_defined 1
...
#define __compat_pos64_t_defined 1
...
#define __compat_syscall_ulong_t_defined 1
...
#define __compat_uintptr_half_t_defined 1
#if __ARCH_COMPAT_SIZEOF_POINTER == 8
...
#define __compat_timer_t_defined 1
