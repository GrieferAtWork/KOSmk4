...
#define pb_buffer_lock_endread(self)      (void)(atomic_rwlock_endread_ex(&(self)->pb_lock) && (pb_buffer_lock_reap(self), 0))
#define _pb_buffer_lock_end(self)         atomic_rwlock_end(&(self)->pb_lock)
#define pb_buffer_lock_end(self)          (void)(atomic_rwlock_end_ex(&(self)->pb_lock) && (pb_buffer_lock_reap(self), 0))
