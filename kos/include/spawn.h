 ...
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_WR(1),__errno_t,__NOTHROW_NCX,posix_spawnattr_init,(posix_spawnattr_t *__restrict __attr),(__attr))
#else /* __CRT_HAVE_posix_spawnattr_init */
#include <libc/local/spawn/posix_spawnattr_init.h>
/* >> posix_spawnattr_init(3)
 * Initialize a given set of spawn attributes to all zero
 * @return: 0 : Success */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawnattr_init, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_WR(1) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawnattr_init)(posix_spawnattr_t *__restrict __attr) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawnattr_init))(__attr); })
 ...
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawnattr_destroy,(posix_spawnattr_t *__restrict __attr),(__attr))
#else /* __CRT_HAVE_posix_spawnattr_destroy */
#include <libc/local/spawn/posix_spawnattr_destroy.h>
/* >> posix_spawnattr_destroy(3)
 * Destroy a given set of spawn attributes
 * @return: 0 : Success */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawnattr_destroy, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(1) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawnattr_destroy)(posix_spawnattr_t *__restrict __attr) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawnattr_destroy))(__attr); })
 ...
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR(2),__errno_t,__NOTHROW_NCX,posix_spawnattr_getflags,(posix_spawnattr_t const *__restrict __attr, short int *__restrict __pflags),(__attr,__pflags))
#elif defined(__POSIX_SPAWN_USE_KOS)
#include <libc/local/spawn/posix_spawnattr_getflags.h>
/* >> posix_spawnattr_setflags(3)
 * Get the set of flags previously specified by `posix_spawnattr_setflags()'
 * @return: 0 : Success */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawnattr_getflags, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR(2) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawnattr_getflags)(posix_spawnattr_t const *__restrict __attr, short int *__restrict __pflags) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawnattr_getflags))(__attr, __pflags); })
#endif /* ... */
 ...
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawnattr_setflags,(posix_spawnattr_t *__restrict __attr, short int __flags),(__attr,__flags))
#elif defined(__POSIX_SPAWN_USE_KOS)
 ...
 *   - POSIX_SPAWN_SETSCHEDPARAM: s.a. posix_spawnattr_setschedparam(3)
 * @return: 0 : Success */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawnattr_setflags, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(1) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawnattr_setflags)(posix_spawnattr_t *__restrict __attr, short int __flags) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawnattr_setflags))(__attr, __flags); })
#endif /* ... */
 ...
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR(2),__errno_t,__NOTHROW_NCX,posix_spawnattr_getsigdefault,(posix_spawnattr_t const *__restrict __attr, sigset_t *__restrict __sigdefault),(__attr,__sigdefault))
#elif defined(__POSIX_SPAWN_USE_KOS)
 ...
 * the  child  process  when  `POSIX_SPAWN_SETSIGDEF'  is  set.
 * @return: 0 : Success */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawnattr_getsigdefault, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR(2) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawnattr_getsigdefault)(posix_spawnattr_t const *__restrict __attr, sigset_t *__restrict __sigdefault) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawnattr_getsigdefault))(__attr, __sigdefault); })
#endif /* ... */
 ...
 * the  child  process  when  `POSIX_SPAWN_SETSIGDEF'  is  set.
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawnattr_setsigdefault,(posix_spawnattr_t *__restrict __attr, sigset_t const *__restrict __sigdefault),(__attr,__sigdefault))
#elif defined(__POSIX_SPAWN_USE_KOS)
 ...
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR(2),__errno_t,__NOTHROW_NCX,posix_spawnattr_getsigmask,(posix_spawnattr_t const *__restrict __attr, sigset_t *__restrict __sigmask),(__attr,__sigmask))
#elif defined(__POSIX_SPAWN_USE_KOS)
 ...
 * that the  child process  will perform  when `POSIX_SPAWN_SETSIGMASK'  is  set.
 * @return: 0 : Success */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawnattr_getsigmask, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR(2) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawnattr_getsigmask)(posix_spawnattr_t const *__restrict __attr, sigset_t *__restrict __sigmask) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawnattr_getsigmask))(__attr, __sigmask); })
#endif /* ... */
 ...
 * that the  child process  will perform  when `POSIX_SPAWN_SETSIGMASK'  is  set.
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawnattr_setsigmask,(posix_spawnattr_t *__restrict __attr, sigset_t const *__restrict __sigmask),(__attr,__sigmask))
#elif defined(__POSIX_SPAWN_USE_KOS)
 ...
 * that the  child process  will perform  when `POSIX_SPAWN_SETSIGMASK'  is  set.
 * @return: 0 : Success */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawnattr_setsigmask, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawnattr_setsigmask)(posix_spawnattr_t *__restrict __attr, sigset_t const *__restrict __sigmask) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawnattr_setsigmask))(__attr, __sigmask); })
#endif /* ... */
 ...
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR(2),__errno_t,__NOTHROW_NCX,posix_spawnattr_getpgroup,(posix_spawnattr_t const *__restrict __attr, pid_t *__restrict __pgroup),(__attr,__pgroup))
#elif defined(__POSIX_SPAWN_USE_KOS)
 ...
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawnattr_setpgroup,(posix_spawnattr_t *__restrict __attr, pid_t __pgroup),(__attr,__pgroup))
#elif defined(__POSIX_SPAWN_USE_KOS)
 ...
 * HINT: A call `setpgid(getpid(), 0)' is the same as `setpgid(getpid(), getpid())'!
 * @return: 0 : Success */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawnattr_setpgroup, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(1) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawnattr_setpgroup)(posix_spawnattr_t *__restrict __attr, pid_t __pgroup) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawnattr_setpgroup))(__attr, __pgroup); })
#endif /* ... */
 ...
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR(2),__errno_t,__NOTHROW_NCX,posix_spawnattr_getschedpolicy,(posix_spawnattr_t const *__restrict __attr, int *__restrict __schedpolicy),(__attr,__schedpolicy))
#elif defined(__POSIX_SPAWN_USE_KOS)
 ...
 * that  the  child process  will  perform when  `POSIX_SPAWN_SETSCHEDULER'  is set.
 * @return: 0 : Success */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawnattr_getschedpolicy, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR(2) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawnattr_getschedpolicy)(posix_spawnattr_t const *__restrict __attr, int *__restrict __schedpolicy) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawnattr_getschedpolicy))(__attr, __schedpolicy); })
#endif /* ... */
 ...
 * that  the  child process  will  perform when  `POSIX_SPAWN_SETSCHEDULER'  is set.
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawnattr_setschedpolicy,(posix_spawnattr_t *__restrict __attr, int __schedpolicy),(__attr,__schedpolicy))
#elif defined(__POSIX_SPAWN_USE_KOS)
 ...
 * that  the  child process  will  perform when  `POSIX_SPAWN_SETSCHEDULER'  is set.
 * @return: 0 : Success */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawnattr_setschedpolicy, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(1) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawnattr_setschedpolicy)(posix_spawnattr_t *__restrict __attr, int __schedpolicy) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawnattr_setschedpolicy))(__attr, __schedpolicy); })
#endif /* ... */
 ...
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR(2),__errno_t,__NOTHROW_NCX,posix_spawnattr_getschedparam,(posix_spawnattr_t const *__restrict __attr, struct sched_param *__restrict __schedparam),(__attr,__schedparam))
#elif defined(__POSIX_SPAWN_USE_KOS)
 ...
 * that  the child  process will  perform when  `POSIX_SPAWN_SETSCHEDPARAM' is set.
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawnattr_setschedparam,(posix_spawnattr_t *__restrict __attr, struct sched_param const *__restrict __schedparam),(__attr,__schedparam))
#elif defined(__POSIX_SPAWN_USE_KOS)
 ...
 * @return: 0 : Success */
__CDECLARE(__ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawn_file_actions_destroy,(posix_spawn_file_actions_t *__restrict __file_actions),(__file_actions))
#elif defined(__POSIX_SPAWN_USE_KOS)
#include <libc/local/spawn/posix_spawn_file_actions_destroy.h>
/* >> posix_spawn_file_actions_destroy(3)
 * Finalize the given spawn-file-actions object `file_actions'
 * @return: 0 : Success */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawn_file_actions_destroy, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(1) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawn_file_actions_destroy)(posix_spawn_file_actions_t *__restrict __file_actions) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawn_file_actions_destroy))(__file_actions); })
#endif /* ... */
...
__CDECLARE(__ATTR_ACCESS_RO(3) __ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawn_file_actions_addopen,(posix_spawn_file_actions_t *__restrict __file_actions, __fd_t __fd, char const *__restrict __path, __oflag_t __oflags, mode_t __mode),(__file_actions,__fd,__path,__oflags,__mode))
 ...
 * @return: 0     : Success
 * @return: ENOMEM: Insufficient memory to enqueue the action */
__CDECLARE(__ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawn_file_actions_addclose,(posix_spawn_file_actions_t *__restrict __file_actions, __fd_t __fd),(__file_actions,__fd))
#elif defined(__POSIX_SPAWN_USE_KOS) && (defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc))
 ...
 * @return: 0     : Success
 * @return: ENOMEM: Insufficient memory to enqueue the action */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawn_file_actions_addclose, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(1) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawn_file_actions_addclose)(posix_spawn_file_actions_t *__restrict __file_actions, __fd_t __fd) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawn_file_actions_addclose))(__file_actions, __fd); })
#endif /* ... */
 ...
 * @return: 0     : Success
 * @return: ENOMEM: Insufficient memory to enqueue the action */
__CDECLARE(__ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawn_file_actions_adddup2,(posix_spawn_file_actions_t *__restrict __file_actions, __fd_t __oldfd, __fd_t __newfd),(__file_actions,__oldfd,__newfd))
#elif defined(__POSIX_SPAWN_USE_KOS) && (defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc))
 ...
 * @return: 0     : Success
 * @return: ENOMEM: Insufficient memory to enqueue the action */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawn_file_actions_adddup2, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(1) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawn_file_actions_adddup2)(posix_spawn_file_actions_t *__restrict __file_actions, __fd_t __oldfd, __fd_t __newfd) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawn_file_actions_adddup2))(__file_actions, __oldfd, __newfd); })
#endif /* ... */
 ...
 * @return: 0     : Success
 * @return: ENOMEM: Insufficient memory to enqueue the action */
__CDECLARE(__ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawn_file_actions_addtcsetpgrp_np,(posix_spawn_file_actions_t *__restrict __file_actions, __fd_t __fd),(__file_actions,__fd))
 ...
 * @return: 0     : Success
 * @return: ENOMEM: Insufficient memory to enqueue the action */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawn_file_actions_addtcsetpgrp_np, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(1) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawn_file_actions_addtcsetpgrp_np)(posix_spawn_file_actions_t *__restrict __file_actions, __fd_t __fd) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawn_file_actions_addtcsetpgrp_np))(__file_actions, __fd); })
#endif /* ... */
#endif /* __USE_KOS */
 ...
 * @return: 0     : Success
 * @return: ENOMEM: Insufficient memory to enqueue the action */
__CDECLARE(__ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawn_file_actions_addclosefrom_np,(posix_spawn_file_actions_t *__restrict __file_actions, __fd_t __lowfd),(__file_actions,__lowfd))
 ...
 * @return: 0     : Success
 * @return: ENOMEM: Insufficient memory to enqueue the action */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawn_file_actions_addclosefrom_np, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(1) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawn_file_actions_addclosefrom_np)(posix_spawn_file_actions_t *__restrict __file_actions, __fd_t __lowfd) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawn_file_actions_addclosefrom_np))(__file_actions, __lowfd); })
#endif /* ... */
#endif /* __USE_SOLARIS */
 ...
 * @return: 0     : Success
 * @return: ENOMEM: Insufficient memory to enqueue the action */
__CDECLARE(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawn_file_actions_addchdir_np,(posix_spawn_file_actions_t *__restrict __file_actions, const char *__restrict __path),(__file_actions,__path))
#elif defined(__POSIX_SPAWN_USE_KOS) && (defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc))
 ...
 * @return: 0     : Success
 * @return: ENOMEM: Insufficient memory to enqueue the action */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawn_file_actions_addchdir_np, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RW(1) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawn_file_actions_addchdir_np)(posix_spawn_file_actions_t *__restrict __file_actions, const char *__restrict __path) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawn_file_actions_addchdir_np))(__file_actions, __path); })
#endif /* ... */
 ...
 * @return: 0     : Success
 * @return: ENOMEM: Insufficient memory to enqueue the action */
__CDECLARE(__ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,posix_spawn_file_actions_addfchdir_np,(posix_spawn_file_actions_t *__restrict __file_actions, __fd_t __dfd),(__file_actions,__dfd))
#elif defined(__POSIX_SPAWN_USE_KOS) && (defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc))
 ...
 * @return: 0     : Success
 * @return: ENOMEM: Insufficient memory to enqueue the action */
__NAMESPACE_LOCAL_USING_OR_IMPL(posix_spawn_file_actions_addfchdir_np, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RW(1) __errno_t __NOTHROW_NCX(__LIBCCALL posix_spawn_file_actions_addfchdir_np)(posix_spawn_file_actions_t *__restrict __file_actions, __fd_t __dfd) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(posix_spawn_file_actions_addfchdir_np))(__file_actions, __dfd); })
#endif /* ... */
#endif /* __USE_GNU */
