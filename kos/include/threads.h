...
#if defined(__CRT_HAVE_thrd_create)
...
#endif /* thrd_create... */
#if defined(__CRT_HAVE_thrd_equal)
...
#endif /* thrd_equal... */
#if defined(__CRT_HAVE_thrd_current)
...
#endif /* thrd_sleep64... */
#endif /* __USE_TIME64 */
#if defined(__CRT_HAVE_thrd_exit)
...
#endif /* thrd_exit... */
#if defined(__CRT_HAVE_thrd_detach)
...
#endif /* thrd_detach... */
#if defined(__CRT_HAVE_thrd_join)
...
#endif /* thrd_join... */
#if defined(__CRT_HAVE_thrd_yield)
...
#if defined(__CRT_HAVE_mtx_init)
...
#endif /* mtx_init... */
#if defined(__CRT_HAVE_mtx_lock)
...
#elif (defined(__CRT_HAVE_pthread_mutex_timedlock) || defined(__CRT_HAVE_pthread_mutex_timedlock64)) || (defined(__CRT_HAVE_pthread_mutex_timedlock64) && defined(__USE_TIME_BITS64)) || (defined(__CRT_HAVE_pthread_mutex_timedlock) && !defined(__USE_TIME_BITS64))
...
#endif /* mtx_timedlock... */
#ifdef __USE_TIME64
#if defined(__CRT_HAVE_mtx_timedlock64)
/* Block the current thread until the mutex pointed by MUTEX
 * is unlocked or time pointed by TIME_POINT is reached.
 * In case the mutex is unlock, the current thread will not be blocked
 * s.a. `pthread_mutex_timedlock()' */
...
#elif defined(__CRT_HAVE_pthread_mutex_timedlock) || defined(__CRT_HAVE_pthread_mutex_timedlock64) || (defined(__CRT_HAVE_pthread_mutex_timedlock) && __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__)
...
#endif /* __USE_TIME64 */
#if defined(__CRT_HAVE_mtx_trylock)
...
#endif /* mtx_trylock... */
#if defined(__CRT_HAVE_mtx_unlock)
...
#endif /* mtx_unlock... */
#if defined(__CRT_HAVE_mtx_destroy)
...
#endif /* mtx_destroy... */
#if defined(__CRT_HAVE_call_once)
...
#if defined(__CRT_HAVE_cnd_init)
...
#endif /* cnd_init... */
#if defined(__CRT_HAVE_cnd_signal)
...
#endif /* cnd_signal... */
#if defined(__CRT_HAVE_cnd_broadcast)
...
#endif /* cnd_broadcast... */
#if defined(__CRT_HAVE_cnd_wait)
...
#elif (defined(__CRT_HAVE_pthread_cond_timedwait) || defined(__CRT_HAVE_pthread_cond_timedwait64)) || (defined(__CRT_HAVE_pthread_cond_timedwait64) && defined(__USE_TIME_BITS64)) || (defined(__CRT_HAVE_pthread_cond_timedwait) && !defined(__USE_TIME_BITS64))
...
#endif /* cnd_timedwait... */
#ifdef __USE_TIME64
#if defined(__CRT_HAVE_cnd_timedwait64)
/* Block current thread on the condition variable until condition variable
 * pointed by COND is signaled or time pointed by TIME_POINT is reached
 * s.a. `pthread_cond_timedwait()' */
...
#endif /* __USE_TIME64 */
#if defined(__CRT_HAVE_cnd_destroy)
...
#if defined(__CRT_HAVE_tss_create)
...
#endif /* tss_set... */
#if defined(__CRT_HAVE_tss_delete)
