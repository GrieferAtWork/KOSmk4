...
/* >> fgetwln(3) */
__CREDIRECT(__ATTR_WUNUSED __ATTR_INOUT(1) __ATTR_OUT_OPT(2),char16_t *,__NOTHROW_NCX,fgetc16ln,(FILE *__restrict __stream, __SIZE_TYPE__ *__restrict __lenp),fgetwln,(__stream,__lenp))
#elif defined(__CRT_HAVE_DOS$fgetwln)
/* >> fgetwln(3) */
__CREDIRECT_DOS(__ATTR_WUNUSED __ATTR_INOUT(1) __ATTR_OUT_OPT(2),char16_t *,__NOTHROW_NCX,fgetc16ln,(FILE *__restrict __stream, __SIZE_TYPE__ *__restrict __lenp),fgetwln,(__stream,__lenp))
#endif /* ... */
#if defined(__CRT_HAVE_fgetwln) && __SIZEOF_WCHAR_T__ == 4 && defined(__LIBCCALL_IS_LIBKCALL)
/* >> fgetwln(3) */
__CREDIRECT(__ATTR_WUNUSED __ATTR_INOUT(1) __ATTR_OUT_OPT(2),char32_t *,__NOTHROW_NCX,fgetc32ln,(FILE *__restrict __stream, __SIZE_TYPE__ *__restrict __lenp),fgetwln,(__stream,__lenp))
#elif defined(__CRT_HAVE_KOS$fgetwln)
/* >> fgetwln(3) */
__CREDIRECT_KOS(__ATTR_WUNUSED __ATTR_INOUT(1) __ATTR_OUT_OPT(2),char32_t *,__NOTHROW_NCX,fgetc32ln,(FILE *__restrict __stream, __SIZE_TYPE__ *__restrict __lenp),fgetwln,(__stream,__lenp))
#endif /* ... */
...
/* >> wcsnrtombs(3) */
__CREDIRECT(__ATTR_INOUT(2) __ATTR_INOUT_OPT(5) __ATTR_OUT_OPT(1),__SIZE_TYPE__,__NOTHROW_NCX,c16nrtombs,(char *__dst, char16_t const **__restrict __psrc, __SIZE_TYPE__ __nwc, __SIZE_TYPE__ __dstlen, struct __mbstate *__mbs),wcsnrtombs,(__dst,__psrc,__nwc,__dstlen,__mbs))
#elif defined(__CRT_HAVE_DOS$wcsnrtombs)
/* >> wcsnrtombs(3) */
__CREDIRECT_DOS(__ATTR_INOUT(2) __ATTR_INOUT_OPT(5) __ATTR_OUT_OPT(1),__SIZE_TYPE__,__NOTHROW_NCX,c16nrtombs,(char *__dst, char16_t const **__restrict __psrc, __SIZE_TYPE__ __nwc, __SIZE_TYPE__ __dstlen, struct __mbstate *__mbs),wcsnrtombs,(__dst,__psrc,__nwc,__dstlen,__mbs))
#elif __SIZEOF_WCHAR_T__ == 2
#include <libc/local/wchar/wcsnrtombs.h>
/* >> wcsnrtombs(3) */
__FORCELOCAL __ATTR_ARTIFICIAL __ATTR_INOUT(2) __ATTR_INOUT_OPT(5) __ATTR_OUT_OPT(1) __SIZE_TYPE__ __NOTHROW_NCX(__LIBDCALL c16nrtombs)(char *__dst, char16_t const **__restrict __psrc, __SIZE_TYPE__ __nwc, __SIZE_TYPE__ __dstlen, struct __mbstate *__mbs) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wcsnrtombs))(__dst, (__WCHAR_TYPE__ const **)__psrc, __nwc, __dstlen, __mbs); }
#else /* ... */
#include <libc/local/parts.uchar.wchar/c16nrtombs.h>
/* >> wcsnrtombs(3) */
__NAMESPACE_LOCAL_USING_OR_IMPL(c16nrtombs, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_INOUT(2) __ATTR_INOUT_OPT(5) __ATTR_OUT_OPT(1) __SIZE_TYPE__ __NOTHROW_NCX(__LIBDCALL c16nrtombs)(char *__dst, char16_t const **__restrict __psrc, __SIZE_TYPE__ __nwc, __SIZE_TYPE__ __dstlen, struct __mbstate *__mbs) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(c16nrtombs))(__dst, __psrc, __nwc, __dstlen, __mbs); })
#endif /* !... */
#if defined(__CRT_HAVE_wcsnrtombs) && __SIZEOF_WCHAR_T__ == 4 && defined(__LIBCCALL_IS_LIBKCALL)
/* >> wcsnrtombs(3) */
__CREDIRECT(__ATTR_INOUT(2) __ATTR_INOUT_OPT(5) __ATTR_OUT_OPT(1),__SIZE_TYPE__,__NOTHROW_NCX,c32nrtombs,(char *__dst, char32_t const **__restrict __psrc, __SIZE_TYPE__ __nwc, __SIZE_TYPE__ __dstlen, struct __mbstate *__mbs),wcsnrtombs,(__dst,__psrc,__nwc,__dstlen,__mbs))
#elif defined(__CRT_HAVE_KOS$wcsnrtombs)
/* >> wcsnrtombs(3) */
__CREDIRECT_KOS(__ATTR_INOUT(2) __ATTR_INOUT_OPT(5) __ATTR_OUT_OPT(1),__SIZE_TYPE__,__NOTHROW_NCX,c32nrtombs,(char *__dst, char32_t const **__restrict __psrc, __SIZE_TYPE__ __nwc, __SIZE_TYPE__ __dstlen, struct __mbstate *__mbs),wcsnrtombs,(__dst,__psrc,__nwc,__dstlen,__mbs))
#elif __SIZEOF_WCHAR_T__ == 4
#include <libc/local/wchar/wcsnrtombs.h>
/* >> wcsnrtombs(3) */
__FORCELOCAL __ATTR_ARTIFICIAL __ATTR_INOUT(2) __ATTR_INOUT_OPT(5) __ATTR_OUT_OPT(1) __SIZE_TYPE__ __NOTHROW_NCX(__LIBKCALL c32nrtombs)(char *__dst, char32_t const **__restrict __psrc, __SIZE_TYPE__ __nwc, __SIZE_TYPE__ __dstlen, struct __mbstate *__mbs) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wcsnrtombs))(__dst, (__WCHAR_TYPE__ const **)__psrc, __nwc, __dstlen, __mbs); }
#else /* ... */
