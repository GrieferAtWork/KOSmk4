...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1, 3, 4)),size_t,__NOTHROW_NCX,__LIBDCALL,c16ftime,(char16_t *__restrict __buf, size_t __buflen, char16_t const *__restrict __format, struct tm const *__restrict __tp),wcsftime,(__buf,__buflen,__format,__tp))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1, 3, 4)),size_t,__NOTHROW_NCX,__LIBKCALL,c32ftime,(char32_t *__restrict __buf, size_t __buflen, char32_t const *__restrict __format, struct tm const *__restrict __tp),wcsftime,(__buf,__buflen,__format,__tp))
#elif defined(__CRT_HAVE_DOS$wcsftime)
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1, 3, 4)),__SIZE_TYPE__,__NOTHROW_NCX,__LIBDCALL,c16ftime_l,(char16_t *__restrict __buf, __SIZE_TYPE__ __maxsize, char16_t const *__restrict __format, __STRUCT_TM const *__restrict __tp, __locale_t __locale),wcsftime_l,(__buf,__maxsize,__format,__tp,__locale))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1, 3, 4)),__SIZE_TYPE__,__NOTHROW_NCX,__LIBDCALL,c16ftime_l,(char16_t *__restrict __buf, __SIZE_TYPE__ __maxsize, char16_t const *__restrict __format, __STRUCT_TM const *__restrict __tp, __locale_t __locale),__wcsftime_l,(__buf,__maxsize,__format,__tp,__locale))
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1, 3, 4)),__SIZE_TYPE__,__NOTHROW_NCX,__LIBKCALL,c32ftime_l,(char32_t *__restrict __buf, __SIZE_TYPE__ __maxsize, char32_t const *__restrict __format, __STRUCT_TM const *__restrict __tp, __locale_t __locale),wcsftime_l,(__buf,__maxsize,__format,__tp,__locale))
#elif defined(__CRT_HAVE_DOS$wcsftime_l)
...
__COMPILER_REDIRECT(__LIBC,__ATTR_NONNULL((1, 3, 4)),__SIZE_TYPE__,__NOTHROW_NCX,__LIBKCALL,c32ftime_l,(char32_t *__restrict __buf, __SIZE_TYPE__ __maxsize, char32_t const *__restrict __format, __STRUCT_TM const *__restrict __tp, __locale_t __locale),__wcsftime_l,(__buf,__maxsize,__format,__tp,__locale))
#elif defined(__CRT_HAVE_DOS$__wcsftime_l)
