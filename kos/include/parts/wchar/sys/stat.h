...
__CDECLARE(__ATTR_IN(1),int,__NOTHROW_RPC,wmkdir,(wchar_t const *__pathname, __mode_t __mode),(__pathname,__mode))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wmkdir, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(1) int __NOTHROW_RPC(__LIBCCALL wmkdir)(wchar_t const *__pathname, __mode_t __mode) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wmkdir))(__pathname, __mode); })
...
__CDECLARE(__ATTR_IN(1),int,__NOTHROW_RPC,wchmod,(wchar_t const *__filename, __mode_t __mode),(__filename,__mode))
#elif defined(__CRT_HAVE__wchmod)
__CREDIRECT(__ATTR_IN(1),int,__NOTHROW_RPC,wchmod,(wchar_t const *__filename, __mode_t __mode),_wchmod,(__filename,__mode))
#else /* ... */
#include <asm/os/fcntl.h>
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wchmod, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(1) int __NOTHROW_RPC(__LIBCCALL wchmod)(wchar_t const *__filename, __mode_t __mode) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wchmod))(__filename, __mode); })
...
__CDECLARE(__ATTR_IN(1),int,__NOTHROW_RPC,wlchmod,(wchar_t const *__filename, __mode_t __mode),(__filename,__mode))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wlchmod, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(1) int __NOTHROW_RPC(__LIBCCALL wlchmod)(wchar_t const *__filename, __mode_t __mode) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wlchmod))(__filename, __mode); })
...
__CDECLARE(__ATTR_IN(2),int,__NOTHROW_RPC,wfmkdirat,(__fd_t __dirfd, wchar_t const *__pathname, __mode_t __mode, __atflag_t __flags),(__dirfd,__pathname,__mode,__flags))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wfmkdirat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(2) int __NOTHROW_RPC(__LIBCCALL wfmkdirat)(__fd_t __dirfd, wchar_t const *__pathname, __mode_t __mode, __atflag_t __flags) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wfmkdirat))(__dirfd, __pathname, __mode, __flags); })
#endif /* ... */
#ifdef __CRT_HAVE_wfmknodat
__CDECLARE(__ATTR_IN(2),int,__NOTHROW_RPC,wfmknodat,(__fd_t __dirfd, wchar_t const *__nodename, __mode_t __mode, __dev_t __dev, __atflag_t __flags),(__dirfd,__nodename,__mode,__dev,__flags))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wfmknodat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(2) int __NOTHROW_RPC(__LIBCCALL wfmknodat)(__fd_t __dirfd, wchar_t const *__nodename, __mode_t __mode, __dev_t __dev, __atflag_t __flags) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wfmknodat))(__dirfd, __nodename, __mode, __dev, __flags); })
#endif /* ... */
#endif /* __USE_KOS && __USE_ATFILE */
#ifdef __CRT_HAVE_wmkfifo
__CDECLARE(__ATTR_IN(1),int,__NOTHROW_RPC,wmkfifo,(wchar_t const *__fifoname, __mode_t __mode),(__fifoname,__mode))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wmkfifo, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(1) int __NOTHROW_RPC(__LIBCCALL wmkfifo)(wchar_t const *__fifoname, __mode_t __mode) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wmkfifo))(__fifoname, __mode); })
...
__CDECLARE(__ATTR_IN(2),int,__NOTHROW_RPC,wfchmodat,(__fd_t __dirfd, wchar_t const *__filename, __mode_t __mode, __atflag_t __flags),(__dirfd,__filename,__mode,__flags))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wfchmodat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(2) int __NOTHROW_RPC(__LIBCCALL wfchmodat)(__fd_t __dirfd, wchar_t const *__filename, __mode_t __mode, __atflag_t __flags) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wfchmodat))(__dirfd, __filename, __mode, __flags); })
#endif /* ... */
#ifdef __CRT_HAVE_wmkdirat
__CDECLARE(__ATTR_IN(2),int,__NOTHROW_RPC,wmkdirat,(__fd_t __dirfd, wchar_t const *__pathname, __mode_t __mode),(__dirfd,__pathname,__mode))
#elif defined(__CRT_HAVE_wfmkdirat) || (defined(__CRT_HAVE_fmkdirat) && (defined(__CRT_HAVE_convert_wcstombs) || defined(__CRT_HAVE_convert_wcstombsn) || defined(__CRT_HAVE_format_aprintf_printer) || defined(__CRT_HAVE_format_aprintf_alloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc))) || ((defined(__CRT_HAVE_mkdirat) || defined(__CRT_HAVE_fmkdirat)) && (defined(__CRT_HAVE_convert_wcstombs) || defined(__CRT_HAVE_convert_wcstombsn) || defined(__CRT_HAVE_format_aprintf_printer) || defined(__CRT_HAVE_format_aprintf_alloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc)))
#include <libc/local/parts.wchar.sys.stat/wmkdirat.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(wmkdirat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(2) int __NOTHROW_RPC(__LIBCCALL wmkdirat)(__fd_t __dirfd, wchar_t const *__pathname, __mode_t __mode) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wmkdirat))(__dirfd, __pathname, __mode); })
#endif /* ... */
#ifdef __CRT_HAVE_wmkfifoat
__CDECLARE(__ATTR_IN(2),int,__NOTHROW_RPC,wmkfifoat,(__fd_t __dirfd, wchar_t const *__fifoname, __mode_t __mode),(__dirfd,__fifoname,__mode))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wmkfifoat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(2) int __NOTHROW_RPC(__LIBCCALL wmkfifoat)(__fd_t __dirfd, wchar_t const *__fifoname, __mode_t __mode) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wmkfifoat))(__dirfd, __fifoname, __mode); })
...
__CDECLARE(__ATTR_IN(1),int,__NOTHROW_RPC,wmknod,(wchar_t const *__nodename, __mode_t __mode, __dev_t __dev),(__nodename,__mode,__dev))
#else /* __CRT_HAVE_wmknod */
#include <asm/os/fcntl.h>
#if ((defined(__CRT_HAVE_wmknodat) || defined(__CRT_HAVE_wfmknodat) || (defined(__CRT_HAVE_fmknodat) && (defined(__CRT_HAVE_convert_wcstombs) || defined(__CRT_HAVE_convert_wcstombsn) || defined(__CRT_HAVE_format_aprintf_printer) || defined(__CRT_HAVE_format_aprintf_alloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc))) || ((defined(__CRT_HAVE_mknodat) || defined(__CRT_HAVE_fmknodat)) && (defined(__CRT_HAVE_convert_wcstombs) || defined(__CRT_HAVE_convert_wcstombsn) || defined(__CRT_HAVE_format_aprintf_printer) || defined(__CRT_HAVE_format_aprintf_alloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc)))) && defined(__AT_FDCWD)) || ((defined(__CRT_HAVE_mknod) || ((defined(__CRT_HAVE_mknodat) || defined(__CRT_HAVE_fmknodat)) && defined(__AT_FDCWD))) && (defined(__CRT_HAVE_convert_wcstombs) || defined(__CRT_HAVE_convert_wcstombsn) || defined(__CRT_HAVE_format_aprintf_printer) || defined(__CRT_HAVE_format_aprintf_alloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc)))
#include <libc/local/parts.wchar.sys.stat/wmknod.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(wmknod, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(1) int __NOTHROW_RPC(__LIBCCALL wmknod)(wchar_t const *__nodename, __mode_t __mode, __dev_t __dev) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wmknod))(__nodename, __mode, __dev); })
...
__CDECLARE(__ATTR_IN(2),int,__NOTHROW_RPC,wmknodat,(__fd_t __dirfd, wchar_t const *__nodename, __mode_t __mode, __dev_t __dev),(__dirfd,__nodename,__mode,__dev))
#elif defined(__CRT_HAVE_wfmknodat) || (defined(__CRT_HAVE_fmknodat) && (defined(__CRT_HAVE_convert_wcstombs) || defined(__CRT_HAVE_convert_wcstombsn) || defined(__CRT_HAVE_format_aprintf_printer) || defined(__CRT_HAVE_format_aprintf_alloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc))) || ((defined(__CRT_HAVE_mknodat) || defined(__CRT_HAVE_fmknodat)) && (defined(__CRT_HAVE_convert_wcstombs) || defined(__CRT_HAVE_convert_wcstombsn) || defined(__CRT_HAVE_format_aprintf_printer) || defined(__CRT_HAVE_format_aprintf_alloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc)))
#include <libc/local/parts.wchar.sys.stat/wmknodat.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(wmknodat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(2) int __NOTHROW_RPC(__LIBCCALL wmknodat)(__fd_t __dirfd, wchar_t const *__nodename, __mode_t __mode, __dev_t __dev) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wmknodat))(__dirfd, __nodename, __mode, __dev); })
#endif /* ... */
#endif /* __USE_ATFILE */
