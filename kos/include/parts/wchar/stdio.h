...
__CDECLARE(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,wremove,(wchar_t const *__filename),(__filename))
#elif defined(__CRT_HAVE__wremove)
__CREDIRECT(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,wremove,(wchar_t const *__filename),_wremove,(__filename))
#else /* ... */
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wremove, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_NONNULL((1)) int __NOTHROW_RPC(__LIBCCALL wremove)(wchar_t const *__filename) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wremove))(__filename); })
...
__CDECLARE(__ATTR_NONNULL((1, 2)),int,__NOTHROW_RPC,wrename,(wchar_t const *__oldname, wchar_t const *__newname_or_path),(__oldname,__newname_or_path))
#elif defined(__CRT_HAVE__wrename)
__CREDIRECT(__ATTR_NONNULL((1, 2)),int,__NOTHROW_RPC,wrename,(wchar_t const *__oldname, wchar_t const *__newname_or_path),_wrename,(__oldname,__newname_or_path))
#else /* ... */
#include <asm/os/fcntl.h>
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wrename, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_NONNULL((1, 2)) int __NOTHROW_RPC(__LIBCCALL wrename)(wchar_t const *__oldname, wchar_t const *__newname_or_path) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wrename))(__oldname, __newname_or_path); })
...
__CDECLARE(__ATTR_NONNULL((2, 4)),int,__NOTHROW_RPC,wrenameat,(__fd_t __oldfd, wchar_t const *__oldname, __fd_t __newfd, wchar_t const *__newname_or_path),(__oldfd,__oldname,__newfd,__newname_or_path))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wrenameat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_NONNULL((2, 4)) int __NOTHROW_RPC(__LIBCCALL wrenameat)(__fd_t __oldfd, wchar_t const *__oldname, __fd_t __newfd, wchar_t const *__newname_or_path) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wrenameat))(__oldfd, __oldname, __newfd, __newname_or_path); })
#endif /* ... */

#ifdef __USE_KOS
#ifdef __CRT_HAVE_wremoveat
__CDECLARE(__ATTR_NONNULL((2)),int,__NOTHROW_RPC,wremoveat,(__fd_t __dirfd, wchar_t const *__filename),(__dirfd,__filename))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wremoveat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_NONNULL((2)) int __NOTHROW_RPC(__LIBCCALL wremoveat)(__fd_t __dirfd, wchar_t const *__filename) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wremoveat))(__dirfd, __filename); })
...
__CDECLARE(__ATTR_NONNULL((2, 4)),int,__NOTHROW_RPC,wrenameat2,(__fd_t __oldfd, wchar_t const *__oldname, __fd_t __newfd, wchar_t const *__newname_or_path, __atflag_t __flags),(__oldfd,__oldname,__newfd,__newname_or_path,__flags))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wrenameat2, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_NONNULL((2, 4)) int __NOTHROW_RPC(__LIBCCALL wrenameat2)(__fd_t __oldfd, wchar_t const *__oldname, __fd_t __newfd, wchar_t const *__newname_or_path, __atflag_t __flags) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wrenameat2))(__oldfd, __oldname, __newfd, __newname_or_path, __flags); })
#endif /* ... */
#endif /* __USE_GNU */
