...
#endif /* wchown... */
#if defined(__CRT_HAVE_wpathconf)
/* >> wpathconf(2)
...
#endif /* wrmdir... */
#ifdef __USE_GNU
#if defined(__CRT_HAVE_weuidaccess)
/* >> weuidaccess(2)
 * @param: TYPE: Set of `X_OK|W_OK|R_OK'
...
#endif /* weuidaccess... */
#if defined(__CRT_HAVE_weaccess)
/* >> weuidaccess(2)
 * @param: TYPE: Set of `X_OK|W_OK|R_OK'
 * Test for access to the specified file `FILE', testing for `TYPE', using the effective filesystem ids */
...
#endif /* __USE_GNU */
#ifdef __USE_ATFILE
#if defined(__CRT_HAVE_wfaccessat)
/* >> wfaccessat(2)
 * @param: TYPE: Set of `X_OK|W_OK|R_OK'
...
#endif /* wfaccessat... */
#if defined(__CRT_HAVE_wfchownat)
/* >> wfchownat(2)
...
#endif /* wreadlinkat... */
#ifdef __USE_KOS
#if defined(__CRT_HAVE_wfreadlinkat)
/* >> wfreadlinkat(2)
 * Read the text of a symbolic link under `DFD:PATH' into the provided buffer.
...
#if defined(__CRT_HAVE_wgetlogin_r)
...
#if defined(__CRT_HAVE_wgethostname)
/* >> wgethostname(3)
...
#if defined(__CRT_HAVE_wsetdomainname)
/* >> wsetdomainname(2)
...
__CDECLARE(__ATTR_NONNULL((1)),int,__NOTHROW_RPC,wchroot,(wchar_t const *__restrict __path),(__path))
   ...
   (defined(__USE_XOPEN) && !defined(__USE_XOPEN2K))
#if defined(__CRT_HAVE_wctermid)
