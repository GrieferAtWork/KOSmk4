...
/* >> ttyname_r(3)
 * Return the name of a TTY given its file descriptor */
__CDECLARE_OPT(__ATTR_ACCESS_WRS(2, 3),int,__NOTHROW_RPC,wttyname_r,(__fd_t __fd, wchar_t *__buf, size_t __buflen),(__fd,__buf,__buflen))
#ifdef __CRT_HAVE_wchown
__CDECLARE(__ATTR_ACCESS_RO(1),int,__NOTHROW_RPC,wchown,(wchar_t const *__file, __uid_t __owner, __gid_t __group),(__file,__owner,__group))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wchown, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) int __NOTHROW_RPC(__LIBCCALL wchown)(wchar_t const *__file, __uid_t __owner, __gid_t __group) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wchown))(__file, __owner, __group); })
...
__CDECLARE(__ATTR_ACCESS_RO(1),__LONGPTR_TYPE__,__NOTHROW_RPC,wpathconf,(wchar_t const *__path, __STDC_INT_AS_UINT_T __name),(__path,__name))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wpathconf, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) __LONGPTR_TYPE__ __NOTHROW_RPC(__LIBCCALL wpathconf)(wchar_t const *__path, __STDC_INT_AS_UINT_T __name) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wpathconf))(__path, __name); })
...
__CDECLARE(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2),int,__NOTHROW_RPC,wlink,(wchar_t const *__from, wchar_t const *__to),(__from,__to))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wlink, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2) int __NOTHROW_RPC(__LIBCCALL wlink)(wchar_t const *__from, wchar_t const *__to) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wlink))(__from, __to); })
...
__CDECLARE(__ATTR_WUNUSED __ATTR_ACCESS_RO(1),int,__NOTHROW_RPC,waccess,(wchar_t const *__file, __STDC_INT_AS_UINT_T __type),(__file,__type))
#elif defined(__CRT_HAVE__waccess)
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(1),int,__NOTHROW_RPC,waccess,(wchar_t const *__file, __STDC_INT_AS_UINT_T __type),_waccess,(__file,__type))
#else /* ... */
#include <asm/os/fcntl.h>
...
__NAMESPACE_LOCAL_USING_OR_IMPL(waccess, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_WUNUSED __ATTR_ACCESS_RO(1) int __NOTHROW_RPC(__LIBCCALL waccess)(wchar_t const *__file, __STDC_INT_AS_UINT_T __type) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(waccess))(__file, __type); })
...
__CDECLARE(__ATTR_ACCESS_RO(1),int,__NOTHROW_RPC,wchdir,(wchar_t const *__path),(__path))
#elif defined(__CRT_HAVE__wchdir)
__CREDIRECT(__ATTR_ACCESS_RO(1),int,__NOTHROW_RPC,wchdir,(wchar_t const *__path),_wchdir,(__path))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wchdir, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) int __NOTHROW_RPC(__LIBCCALL wchdir)(wchar_t const *__path) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wchdir))(__path); })
#endif /* ... */
#ifndef __wgetcwd_defined
#define __wgetcwd_defined
#ifdef __CRT_HAVE_wgetcwd
__CDECLARE(__ATTR_ACCESS_WRS(1, 2),wchar_t *,__NOTHROW_RPC,wgetcwd,(wchar_t *__buf, size_t __bufsize),(__buf,__bufsize))
#elif defined(__CRT_HAVE__wgetcwd)
__CREDIRECT(__ATTR_ACCESS_WRS(1, 2),wchar_t *,__NOTHROW_RPC,wgetcwd,(wchar_t *__buf, size_t __bufsize),_wgetcwd,(__buf,__bufsize))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wgetcwd, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_WRS(1, 2) wchar_t *__NOTHROW_RPC(__LIBCCALL wgetcwd)(wchar_t *__buf, size_t __bufsize) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wgetcwd))(__buf, __bufsize); })
#else /* ... */
#undef __wgetcwd_defined
#endif /* !... */
#endif /* !__wgetcwd_defined */
#ifdef __CRT_HAVE_wunlink
__CDECLARE(__ATTR_ACCESS_RO(1),int,__NOTHROW_RPC,wunlink,(wchar_t const *__file),(__file))
#elif defined(__CRT_HAVE__wunlink)
__CREDIRECT(__ATTR_ACCESS_RO(1),int,__NOTHROW_RPC,wunlink,(wchar_t const *__file),_wunlink,(__file))
#else /* ... */
#include <asm/os/fcntl.h>
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wunlink, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) int __NOTHROW_RPC(__LIBCCALL wunlink)(wchar_t const *__file) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wunlink))(__file); })
...
__CDECLARE(__ATTR_ACCESS_RO(1),int,__NOTHROW_RPC,wrmdir,(wchar_t const *__path),(__path))
#elif defined(__CRT_HAVE__wrmdir)
__CREDIRECT(__ATTR_ACCESS_RO(1),int,__NOTHROW_RPC,wrmdir,(wchar_t const *__path),_wrmdir,(__path))
#else /* ... */
#include <asm/os/fcntl.h>
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wrmdir, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) int __NOTHROW_RPC(__LIBCCALL wrmdir)(wchar_t const *__path) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wrmdir))(__path); })
...
__CDECLARE(__ATTR_WUNUSED __ATTR_ACCESS_RO(1),int,__NOTHROW_RPC,weuidaccess,(wchar_t const *__file, __STDC_INT_AS_UINT_T __type),(__file,__type))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(weuidaccess, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_WUNUSED __ATTR_ACCESS_RO(1) int __NOTHROW_RPC(__LIBCCALL weuidaccess)(wchar_t const *__file, __STDC_INT_AS_UINT_T __type) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(weuidaccess))(__file, __type); })
...
#ifdef __CRT_HAVE_weuidaccess
__CREDIRECT(__ATTR_WUNUSED __ATTR_ACCESS_RO(1),int,__NOTHROW_RPC,weaccess,(wchar_t const *__file, __STDC_INT_AS_UINT_T __type),weuidaccess,(__file,__type))
#else /* __CRT_HAVE_weuidaccess */
#include <asm/os/fcntl.h>
#if (defined(__AT_FDCWD) && defined(__AT_EACCESS) && (defined(__CRT_HAVE_wfaccessat) || (defined(__CRT_HAVE_faccessat) && (defined(__CRT_HAVE_convert_wcstombs) || defined(__CRT_HAVE_convert_wcstombsn) || defined(__CRT_HAVE_format_aprintf_printer) || defined(__CRT_HAVE_format_aprintf_alloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc))))) || ((defined(__CRT_HAVE_euidaccess) || defined(__CRT_HAVE_eaccess) || (defined(__CRT_HAVE__access) && defined(__CRT_DOS)) || (defined(__AT_FDCWD) && defined(__AT_EACCESS) && defined(__CRT_HAVE_faccessat))) && (defined(__CRT_HAVE_convert_wcstombs) || defined(__CRT_HAVE_convert_wcstombsn) || defined(__CRT_HAVE_format_aprintf_printer) || defined(__CRT_HAVE_format_aprintf_alloc) || defined(__CRT_HAVE_realloc) || defined(__CRT_HAVE___libc_realloc)))
#include <libc/local/parts.wchar.unistd/weuidaccess.h>
__FORCELOCAL __ATTR_ARTIFICIAL __ATTR_WUNUSED __ATTR_ACCESS_RO(1) int __NOTHROW_RPC(__LIBCCALL weaccess)(wchar_t const *__file, __STDC_INT_AS_UINT_T __type) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(weuidaccess))(__file, __type); }
#endif /* (__AT_FDCWD && __AT_EACCESS && (__CRT_HAVE_wfaccessat || (__CRT_HAVE_faccessat && (__CRT_HAVE_convert_wcstombs || __CRT_HAVE_convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc)))) || ((__CRT_HAVE_euidaccess || __CRT_HAVE_eaccess || (__CRT_HAVE__access && __CRT_DOS) || (__AT_FDCWD && __AT_EACCESS && __CRT_HAVE_faccessat)) && (__CRT_HAVE_convert_wcstombs || __CRT_HAVE_convert_wcstombsn || __CRT_HAVE_format_aprintf_printer || __CRT_HAVE_format_aprintf_alloc || __CRT_HAVE_realloc || __CRT_HAVE___libc_realloc)) */
#endif /* !__CRT_HAVE_weuidaccess */
...
__CDECLARE(__ATTR_ACCESS_RO(2),int,__NOTHROW_RPC,wfaccessat,(__fd_t __dfd, wchar_t const *__file, __STDC_INT_AS_UINT_T __type, __atflag_t __flags),(__dfd,__file,__type,__flags))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wfaccessat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(2) int __NOTHROW_RPC(__LIBCCALL wfaccessat)(__fd_t __dfd, wchar_t const *__file, __STDC_INT_AS_UINT_T __type, __atflag_t __flags) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wfaccessat))(__dfd, __file, __type, __flags); })
#endif /* ... */
#ifdef __CRT_HAVE_wfchownat
__CDECLARE(__ATTR_ACCESS_RO(2),int,__NOTHROW_RPC,wfchownat,(__fd_t __dfd, wchar_t const *__file, __uid_t __owner, __gid_t __group, __atflag_t __flags),(__dfd,__file,__owner,__group,__flags))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wfchownat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(2) int __NOTHROW_RPC(__LIBCCALL wfchownat)(__fd_t __dfd, wchar_t const *__file, __uid_t __owner, __gid_t __group, __atflag_t __flags) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wfchownat))(__dfd, __file, __owner, __group, __flags); })
#endif /* ... */
#ifdef __CRT_HAVE_wlinkat
__CDECLARE(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(4),int,__NOTHROW_RPC,wlinkat,(__fd_t __fromfd, wchar_t const *__from, __fd_t __tofd, wchar_t const *__to, __atflag_t __flags),(__fromfd,__from,__tofd,__to,__flags))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wlinkat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(2) __ATTR_ACCESS_RO(4) int __NOTHROW_RPC(__LIBCCALL wlinkat)(__fd_t __fromfd, wchar_t const *__from, __fd_t __tofd, wchar_t const *__to, __atflag_t __flags) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wlinkat))(__fromfd, __from, __tofd, __to, __flags); })
#endif /* ... */
#ifdef __CRT_HAVE_wsymlinkat
__CDECLARE(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(3),int,__NOTHROW_RPC,wsymlinkat,(wchar_t const *__link_text, __fd_t __tofd, wchar_t const *__target_path),(__link_text,__tofd,__target_path))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wsymlinkat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(3) int __NOTHROW_RPC(__LIBCCALL wsymlinkat)(wchar_t const *__link_text, __fd_t __tofd, wchar_t const *__target_path) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wsymlinkat))(__link_text, __tofd, __target_path); })
#endif /* ... */
__CDECLARE_OPT(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_WRS(3, 4),ssize_t,__NOTHROW_RPC,wreadlinkat,(__fd_t __dfd, wchar_t const *__path, wchar_t *__buf, size_t __buflen),(__dfd,__path,__buf,__buflen))
#ifdef __USE_KOS
#ifdef __CRT_HAVE_wfsymlinkat
__CDECLARE(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(3),int,__NOTHROW_RPC,wfsymlinkat,(wchar_t const *__link_text, __fd_t __tofd, wchar_t const *__target_path, __atflag_t __flags),(__link_text,__tofd,__target_path,__flags))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wfsymlinkat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(3) int __NOTHROW_RPC(__LIBCCALL wfsymlinkat)(wchar_t const *__link_text, __fd_t __tofd, wchar_t const *__target_path, __atflag_t __flags) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wfsymlinkat))(__link_text, __tofd, __target_path, __flags); })
#endif /* ... */
__CDECLARE_OPT(__ATTR_ACCESS_RO(2) __ATTR_ACCESS_WRS(3, 4),ssize_t,__NOTHROW_RPC,wfreadlinkat,(__fd_t __dfd, wchar_t const *__path, wchar_t *__buf, size_t __buflen, __atflag_t __flags),(__dfd,__path,__buf,__buflen,__flags))
#endif /* __USE_KOS */
#ifdef __CRT_HAVE_wunlinkat
__CDECLARE(__ATTR_ACCESS_RO(2),int,__NOTHROW_RPC,wunlinkat,(__fd_t __dfd, wchar_t const *__file, __atflag_t __flags),(__dfd,__file,__flags))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wunlinkat, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(2) int __NOTHROW_RPC(__LIBCCALL wunlinkat)(__fd_t __dfd, wchar_t const *__file, __atflag_t __flags) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wunlinkat))(__dfd, __file, __flags); })
#endif /* ... */
#endif /* __USE_ATFILE */
#ifdef __CRT_HAVE_wlchown
__CDECLARE(__ATTR_ACCESS_RO(1),int,__NOTHROW_RPC,wlchown,(wchar_t const *__file, __uid_t __owner, __gid_t __group),(__file,__owner,__group))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wlchown, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) int __NOTHROW_RPC(__LIBCCALL wlchown)(wchar_t const *__file, __uid_t __owner, __gid_t __group) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wlchown))(__file, __owner, __group); })
...
__CDECLARE(__ATTR_ACCESS_RO(1),int,__NOTHROW_NCX,wtruncate,(wchar_t const *__file, __PIO_OFFSET __length),(__file,__length))
#elif defined(__CRT_HAVE_wtruncate64) && (defined(__USE_FILE_OFFSET64) || __SIZEOF_OFF32_T__ == __SIZEOF_OFF64_T__)
__CREDIRECT(__ATTR_ACCESS_RO(1),int,__NOTHROW_NCX,wtruncate,(wchar_t const *__file, __PIO_OFFSET __length),wtruncate64,(__file,__length))
#else /* ... */
#include <asm/os/oflags.h>
#include <asm/os/fcntl.h>
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wtruncate, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) int __NOTHROW_NCX(__LIBCCALL wtruncate)(wchar_t const *__file, __PIO_OFFSET __length) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wtruncate))(__file, __length); })
...
__CREDIRECT(__ATTR_ACCESS_RO(1),int,__NOTHROW_NCX,wtruncate64,(wchar_t const *__file, __PIO_OFFSET64 __length),wtruncate,(__file,__length))
#elif defined(__CRT_HAVE_wtruncate64)
__CDECLARE(__ATTR_ACCESS_RO(1),int,__NOTHROW_NCX,wtruncate64,(wchar_t const *__file, __PIO_OFFSET64 __length),(__file,__length))
#else /* ... */
#include <asm/os/oflags.h>
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wtruncate64, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) int __NOTHROW_NCX(__LIBCCALL wtruncate64)(wchar_t const *__file, __PIO_OFFSET64 __length) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wtruncate64))(__file, __length); })
...
__CDECLARE(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2),int,__NOTHROW_RPC,wsymlink,(wchar_t const *__link_text, wchar_t const *__target_path),(__link_text,__target_path))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wsymlink, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) __ATTR_ACCESS_RO(2) int __NOTHROW_RPC(__LIBCCALL wsymlink)(wchar_t const *__link_text, wchar_t const *__target_path) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wsymlink))(__link_text, __target_path); })
...
__CDECLARE_OPT(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_WRS(2, 3),ssize_t,__NOTHROW_RPC,wreadlink,(wchar_t const *__path, wchar_t *__buf, size_t __buflen),(__path,__buf,__buflen))
#endif /* __USE_XOPEN_EXTENDED || __USE_XOPEN2K */

#if defined(__USE_UNIX98) || defined(__USE_XOPEN2K)
#ifdef __CRT_HAVE_wgethostname
__CDECLARE(__ATTR_ACCESS_WRS(1, 2),int,__NOTHROW_NCX,wgethostname,(wchar_t *__name, size_t __buflen),(__name,__buflen))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wgethostname, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_WRS(1, 2) int __NOTHROW_NCX(__LIBCCALL wgethostname)(wchar_t *__name, size_t __buflen) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wgethostname))(__name, __buflen); })
#endif /* ... */
#endif /* __USE_UNIX98 || __USE_XOPEN2K */

#ifdef __USE_MISC
#ifdef __CRT_HAVE_wsetlogin
__CDECLARE(__ATTR_ACCESS_RO(1),int,__NOTHROW_NCX,wsetlogin,(wchar_t const *__name),(__name))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wsetlogin, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) int __NOTHROW_NCX(__LIBCCALL wsetlogin)(wchar_t const *__name) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wsetlogin))(__name); })
#endif /* ... */
#ifdef __CRT_HAVE_wsethostname
__CDECLARE(__ATTR_ACCESS_ROS(1, 2),int,__NOTHROW_NCX,wsethostname,(wchar_t const *__name, size_t __len),(__name,__len))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wsethostname, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_ROS(1, 2) int __NOTHROW_NCX(__LIBCCALL wsethostname)(wchar_t const *__name, size_t __len) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wsethostname))(__name, __len); })
#endif /* ... */
#ifdef __CRT_HAVE_wgetdomainname
__CDECLARE(__ATTR_ACCESS_WRS(1, 2),int,__NOTHROW_NCX,wgetdomainname,(wchar_t *__name, size_t __buflen),(__name,__buflen))
#elif defined(__CRT_HAVE_uname) || defined(__CRT_HAVE___uname) || defined(__CRT_HAVE___libc_uname)
#include <libc/local/parts.wchar.unistd/wgetdomainname.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(wgetdomainname, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_WRS(1, 2) int __NOTHROW_NCX(__LIBCCALL wgetdomainname)(wchar_t *__name, size_t __buflen) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wgetdomainname))(__name, __buflen); })
#endif /* ... */
#ifdef __CRT_HAVE_wsetdomainname
__CDECLARE(__ATTR_ACCESS_ROS(1, 2),int,__NOTHROW_NCX,wsetdomainname,(wchar_t const *__name, size_t __len),(__name,__len))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wsetdomainname, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_ROS(1, 2) int __NOTHROW_NCX(__LIBCCALL wsetdomainname)(wchar_t const *__name, size_t __len) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wsetdomainname))(__name, __len); })
#endif /* ... */
#endif /* __USE_MISC */

#if defined(__USE_MISC) || (defined(__USE_XOPEN) && !defined(__USE_XOPEN2K))
#ifdef __CRT_HAVE_wchroot
__CDECLARE(__ATTR_ACCESS_RO(1),int,__NOTHROW_RPC,wchroot,(wchar_t const *__path),(__path))
...
__NAMESPACE_LOCAL_USING_OR_IMPL(wchroot, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_RO(1) int __NOTHROW_RPC(__LIBCCALL wchroot)(wchar_t const *__path) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(wchroot))(__path); })
#endif /* ... */
