...
__CDECLARE_OPT(__ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RO(1),size_t,__NOTHROW_NCX,__fbufsize,(__FILE __KOS_FIXED_CONST *__stream),(__stream))
/* >> __freading(3)
...
__CDECLARE_OPT(__ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RO(1),int,__NOTHROW_NCX,__freading,(__FILE __KOS_FIXED_CONST *__stream),(__stream))
/* >> __fwriting(3)
...
__CDECLARE_OPT(__ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RO(1),int,__NOTHROW_NCX,__fwriting,(__FILE __KOS_FIXED_CONST *__stream),(__stream))
/* >> __freadable(3)
...
__CDECLARE_OPT(__ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RO(1),int,__NOTHROW_NCX,__freadable,(__FILE __KOS_FIXED_CONST *__stream),(__stream))
/* >> __fwritable(3)
 * Returns non-zero if `stream' is writable, that is: has been opened
 * with "w",  "r+", or  some similar  flag that  allows for  writing. */
__CDECLARE_OPT(__ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RO(1),int,__NOTHROW_NCX,__fwritable,(__FILE __KOS_FIXED_CONST *__stream),(__stream))
/* >> __flbf(3)
...
__CDECLARE_OPT(__ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RW(1),int,__NOTHROW_NCX,__flbf,(__FILE *__stream),(__stream))
...
__CDECLARE_OPT(__ATTR_PURE __ATTR_WUNUSED __ATTR_ACCESS_RO(1),size_t,__NOTHROW_NCX,__fpending,(__FILE __KOS_FIXED_CONST *__stream),(__stream))
