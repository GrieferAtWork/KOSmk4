...
/* ... */
#if defined(__CRT_HAVE_getgroups)
...
#if defined(__CRT_HAVE_tcsetpgrp)
/* >> tcsetpgrp(2)
...
/* ... */
#if defined(__CRT_HAVE_getlogin)
...
#elif (defined(__CRT_HAVE_read) || defined(__CRT_HAVE__read) || defined(__CRT_HAVE___read)) && (defined(__CRT_HAVE_lseek) || defined(__CRT_HAVE_lseek64) || defined(__CRT_HAVE__lseek) || defined(__CRT_HAVE__lseeki64))
...
#elif (defined(__CRT_HAVE_lseek64) || defined(__CRT_HAVE__lseeki64) || defined(__CRT_HAVE_lseek) || defined(__CRT_HAVE__lseek))
...
#ifdef __USE_GNU
#if defined(__CRT_HAVE_euidaccess)
/* >> euidaccess(2)
 * @param: TYPE: Set of `X_OK|W_OK|R_OK'
...
__CDECLARE(__ATTR_NONNULL((1, 3)),int,__NOTHROW_RPC,symlinkat,(char const *__from, __fd_t __tofd, char const *__to),(__from,__tofd,__to))
#endif /* symlinkat... */
...
#elif (defined(__CRT_HAVE_pread64) || ((defined(__CRT_HAVE_read) || defined(__CRT_HAVE__read)) && (defined(__CRT_HAVE_lseek) || defined(__CRT_HAVE_lseek64) || defined(__CRT_HAVE__lseek) || defined(__CRT_HAVE__lseeki64))))
...
#elif (defined(__CRT_HAVE_pwrite64) || ((defined(__CRT_HAVE_write) || defined(__CRT_HAVE__write)) && (defined(__CRT_HAVE_lseek) || defined(__CRT_HAVE_lseek64) || defined(__CRT_HAVE__lseek) || defined(__CRT_HAVE__lseeki64))))
...
#elif (defined(__CRT_HAVE_pread) || ((defined(__CRT_HAVE_write) || defined(__CRT_HAVE__write)) && (defined(__CRT_HAVE_lseek) || defined(__CRT_HAVE_lseek64) || defined(__CRT_HAVE__lseek) || defined(__CRT_HAVE__lseeki64))))
...
#elif defined(__CRT_HAVE_dup2) || defined(__CRT_HAVE__dup2)
...
#endif /* dup3... */
#if defined(__CRT_HAVE_get_current_dir_name)
__CDECLARE(__ATTR_WUNUSED __ATTR_MALLOC,char *,__NOTHROW_RPC,get_current_dir_name,(void),())
#elif defined(__CRT_HAVE_getcwd) || defined(__CRT_HAVE__getcwd)
#include <local/unistd/get_current_dir_name.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(get_current_dir_name, __FORCELOCAL __ATTR_WUNUSED __ATTR_MALLOC char *__NOTHROW_RPC(__LIBCCALL get_current_dir_name)(void) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(get_current_dir_name))(); })
...
#endif /* syncfs... */
#if defined(__CRT_HAVE_group_member)
...
/* ... */
#if defined(__CRT_HAVE_gethostid)
...
/* ... */
#if defined(__CRT_HAVE_getdtablesize)
...
__CDECLARE(__ATTR_NONNULL((1, 2)),int,__NOTHROW_RPC,symlink,(char const *__from, char const *__to),(__from,__to))
 ...
 * text, at the filesystem location referred to by `TO'.
 * Same as `symlinkat(FROM, AT_FDCWD, TO)' */
__NAMESPACE_LOCAL_USING_OR_IMPL(symlink, __FORCELOCAL __ATTR_NONNULL((1, 2)) int __NOTHROW_RPC(__LIBCCALL symlink)(char const *__from, char const *__to) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(symlink))(__from, __to); })
#endif /* symlink... */
...
#if defined(__CRT_HAVE_getlogin_r)
...
#ifdef __USE_MISC
/* ... */
#if defined(__CRT_HAVE_setlogin)
...
/* ... */
#if defined(__CRT_HAVE_sethostid)
...
/* ... */
#if defined(__CRT_HAVE_vhangup)
__CDECLARE(,int,__NOTHROW_NCX,vhangup,(void),())
#endif /* vhangup... */

/* ... */
#if defined(__CRT_HAVE_profil)
...
__CDECLARE_VOID(__ATTR_NONNULL((1, 2)),__NOTHROW_NCX,swab,(void const *__restrict __from, void *__restrict __to, int __n_bytes),(__from,__to,__n_bytes))
#elif defined(__CRT_HAVE__swab)
/* Copy `n_bytes & ~1' (FLOOR_ALIGN(n_bytes, 2)) from `from' to `to',
 * exchanging the order of even and odd bytes ("123456" --> "214365")
 * When `n_bytes <= 1', don't do anything and return immediately */
__CREDIRECT_VOID(__ATTR_NONNULL((1, 2)),__NOTHROW_NCX,swab,(void const *__restrict __from, void *__restrict __to, int __n_bytes),_swab,(__from,__to,__n_bytes))
#else /* LIBC: swab */
#include <local/unistd/swab.h>
/* Copy `n_bytes & ~1' (FLOOR_ALIGN(n_bytes, 2)) from `from' to `to',
 * exchanging the order of even and odd bytes ("123456" --> "214365")
 * When `n_bytes <= 1', don't do anything and return immediately */
__NAMESPACE_LOCAL_USING_OR_IMPL(swab, __FORCELOCAL __ATTR_NONNULL((1, 2)) void __NOTHROW_NCX(__LIBCCALL swab)(void const *__restrict __from, void *__restrict __to, int __n_bytes) { (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(swab))(__from, __to, __n_bytes); })
#endif /* swab... */
