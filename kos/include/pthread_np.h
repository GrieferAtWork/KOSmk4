 ...
 * @return: EOK: Success */
__CREDIRECT(__ATTR_NONNULL((1, 2)),__errno_t,__NOTHROW_NCX,pthread_mutexattr_getkind_np,(pthread_mutexattr_t const *__restrict __attr, int *__restrict __kind),pthread_mutexattr_gettype,(__attr,__kind))
#elif defined(__CRT_HAVE_pthread_mutexattr_getkind_np)
/* >> pthread_mutexattr_gettype(3)
 * Return in `*kind' the mutex kind attribute in `*attr'
 * @return: EOK: Success */
__CDECLARE(__ATTR_NONNULL((1, 2)),__errno_t,__NOTHROW_NCX,pthread_mutexattr_getkind_np,(pthread_mutexattr_t const *__restrict __attr, int *__restrict __kind),(__attr,__kind))
#endif /* ... */
...
__CREDIRECT(__ATTR_NONNULL((1)),__errno_t,__NOTHROW_NCX,pthread_mutexattr_setkind_np,(pthread_mutexattr_t *__attr, int __kind),pthread_mutexattr_settype,(__attr,__kind))
 ...
 * @return: EOK:    Success
 * @return: EINVAL: Invalid/unsupported `kind' */
__CDECLARE(__ATTR_NONNULL((1)),__errno_t,__NOTHROW_NCX,pthread_mutexattr_setkind_np,(pthread_mutexattr_t *__attr, int __kind),(__attr,__kind))
#endif /* ... */
...
__CREDIRECT(__ATTR_NONNULL((2)),__errno_t,__NOTHROW_NCX,pthread_get_name_np,(pthread_t __target_thread, char *__buf, size_t __buflen),pthread_getname_np,(__target_thread,__buf,__buflen))
#elif defined(__CRT_HAVE_pthread_get_name_np)
/* >> pthread_getname_np(3)
 * Get thread name visible in the kernel and its interfaces
 * @return: EOK:    Success
 * @return: ERANGE: The given `buflen' is too small */
__CDECLARE(__ATTR_NONNULL((2)),__errno_t,__NOTHROW_NCX,pthread_get_name_np,(pthread_t __target_thread, char *__buf, size_t __buflen),(__target_thread,__buf,__buflen))
#endif /* ... */
...
__CREDIRECT(__ATTR_NONNULL((2)),__errno_t,__NOTHROW_NCX,pthread_set_name_np,(pthread_t __target_thread, const char *__name),pthread_setname_np,(__target_thread,__name))
...
__CDECLARE(__ATTR_NONNULL((2)),__errno_t,__NOTHROW_NCX,pthread_stackseg_np,(pthread_t __pthread, stack_t *__sinfo),(__pthread,__sinfo))
