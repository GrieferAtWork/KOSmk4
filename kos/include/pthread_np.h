 ...
 * @return: EOK: Success */
__CREDIRECT(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR(2),__errno_t,__NOTHROW_NCX,pthread_mutexattr_getkind_np,(pthread_mutexattr_t const *__restrict __attr, int *__restrict __kind),pthread_mutexattr_gettype,(__attr,__kind))
#elif defined(__CRT_HAVE_pthread_mutexattr_getkind_np)
/* >> pthread_mutexattr_gettype(3)
 * Return in `*kind' the mutex kind attribute in `*attr'
 * @return: EOK: Success */
__CDECLARE(__ATTR_ACCESS_RO(1) __ATTR_ACCESS_WR(2),__errno_t,__NOTHROW_NCX,pthread_mutexattr_getkind_np,(pthread_mutexattr_t const *__restrict __attr, int *__restrict __kind),(__attr,__kind))
#endif /* ... */
...
__CREDIRECT(__ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,pthread_mutexattr_setkind_np,(pthread_mutexattr_t *__attr, int __kind),pthread_mutexattr_settype,(__attr,__kind))
 ...
 * @return: EOK:    Success
 * @return: EINVAL: Invalid/unsupported `kind' */
__CDECLARE(__ATTR_ACCESS_RW(1),__errno_t,__NOTHROW_NCX,pthread_mutexattr_setkind_np,(pthread_mutexattr_t *__attr, int __kind),(__attr,__kind))
#endif /* ... */
...
__CREDIRECT(__ATTR_ACCESS_WRS(2, 3),__errno_t,__NOTHROW_NCX,pthread_get_name_np,(pthread_t __target_thread, char *__buf, size_t __buflen),pthread_getname_np,(__target_thread,__buf,__buflen))
#elif defined(__CRT_HAVE_pthread_get_name_np)
/* >> pthread_getname_np(3)
 * Get thread name visible in the kernel and its interfaces
 * @return: EOK:    Success
 * @return: ERANGE: The given `buflen' is too small */
__CDECLARE(__ATTR_ACCESS_WRS(2, 3),__errno_t,__NOTHROW_NCX,pthread_get_name_np,(pthread_t __target_thread, char *__buf, size_t __buflen),(__target_thread,__buf,__buflen))
#endif /* ... */
...
__CREDIRECT(__ATTR_ACCESS_RO(2),__errno_t,__NOTHROW_NCX,pthread_set_name_np,(pthread_t __target_thread, const char *__name),pthread_setname_np,(__target_thread,__name))
#elif defined(__CRT_HAVE_pthread_set_name_np)
/* >> pthread_setname_np(3)
 * Set thread name visible in the kernel and its interfaces
 * @return: EOK:    Success
 * @return: ERANGE: The given `name' is too long */
__CDECLARE(__ATTR_ACCESS_RO(2),__errno_t,__NOTHROW_NCX,pthread_set_name_np,(pthread_t __target_thread, const char *__name),(__target_thread,__name))
#endif /* ... */
...
__CDECLARE(__ATTR_ACCESS_WR(2),__errno_t,__NOTHROW_NCX,pthread_stackseg_np,(pthread_t __pthread, stack_t *__sinfo),(__pthread,__sinfo))
...
/* >> pthread_stackseg_np(3)
 * Convenience wrapper for `pthread_getattr_np(3)' + `pthread_attr_getstack()' */
__NAMESPACE_LOCAL_USING_OR_IMPL(pthread_stackseg_np, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_ACCESS_WR(2) __errno_t __NOTHROW_NCX(__LIBCCALL pthread_stackseg_np)(pthread_t __pthread, stack_t *__sinfo) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(pthread_stackseg_np))(__pthread, __sinfo); })
#endif /* ... */
