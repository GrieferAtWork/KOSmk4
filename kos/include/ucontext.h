...
__LIBC __ATTR_NONNULL((1, 2)) void __NOTHROW_NCX(__VLIBCCALL makecontext)(ucontext_t *__ucp, void (__LIBKCALL *__func)(void), __STDC_INT_AS_SIZE_T ___argc, ...) __CASMNAME_SAME("makecontext");
