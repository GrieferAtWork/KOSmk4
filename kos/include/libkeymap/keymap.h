...
(LIBKEYMAP_CC *PKEYMAP_CODESIZE)(__byte_t const *__restrict code,
                                 __uint8_t *__restrict preg_enc, __uint8_t def_enc);
#ifdef LIBKEYMAP_WANT_PROTOTYPES
LIBKEYMAP_DECL __ssize_t
...
typedef void __NOTHROW_NCX(LIBKEYMAP_CC *PKEYMAP_INIT_EN_US)(struct keymap *__restrict self);
#ifdef LIBKEYMAP_WANT_PROTOTYPES
LIBKEYMAP_DECL void
...
typedef __ssize_t (LIBKEYMAP_CC *PKEYMAP_TRANSLATE)(struct keymap *__restrict self,
...
typedef __size_t (LIBKEYMAP_CC *PKEYMAP_TRANSLATE_BUF)(struct keymap *__restrict self,
                                                       __uint16_t key, __uint16_t mod,
                                                       /*utf-8*/ char *buffer, __size_t buflen);
#ifdef LIBKEYMAP_WANT_PROTOTYPES
LIBKEYMAP_DECL __size_t
...
typedef __BOOL (LIBKEYMAP_CC *PKEYMAP_OPENBLOB)(struct keymap *__restrict self,
                                                void const *blob_base,
                                                __size_t blob_size);
#ifdef LIBKEYMAP_WANT_PROTOTYPES
LIBKEYMAP_DECL __BOOL
