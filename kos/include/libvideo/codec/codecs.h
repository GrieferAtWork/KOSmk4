...
struct video_codec {
	...
	video_pixel_t (LIBVIDEO_CODEC_CC *vc_getpixel)(__byte_t const *__restrict line, __uintptr_t x);
	...
	video_color_t (LIBVIDEO_CODEC_CC *vc_pixel2color)(struct video_format const *__restrict self, video_pixel_t pixel);
	video_pixel_t (LIBVIDEO_CODEC_CC *vc_color2pixel)(struct video_format const *__restrict self, video_color_t color);
};
