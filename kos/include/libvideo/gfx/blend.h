...
#define _GFX_BLENDMODE_CR_SHIFT (32 + VIDEO_COLOR_RED_SHIFT)
#define _GFX_BLENDMODE_CG_SHIFT (32 + VIDEO_COLOR_GREEN_SHIFT)
#define _GFX_BLENDMODE_CB_SHIFT (32 + VIDEO_COLOR_BLUE_SHIFT)
#define _GFX_BLENDMODE_CA_SHIFT (32 + VIDEO_COLOR_ALPHA_SHIFT)
