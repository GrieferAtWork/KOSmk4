...
typedef struct di_debuginfo_component_struct {
	...
	di_debuginfo_component_attrib_t __CHECKED const *dic_attrib;      /* [1..1] Pointer to the list of (attr_name, attr_form) ULEB pairs
...
typedef struct di_rnglists_sections_struct {
	...
	__byte_t __CHECKED const *drs_debug_rnglists_start;  /* [0..1] `.debug_rnglists' start */
	__byte_t __CHECKED const *drs_debug_rnglists_end;    /* [0..1] `.debug_rnglists' end */
	__byte_t __CHECKED const *drs_debug_ranges_start;    /* [0..1] `.debug_ranges' start */
	__byte_t __CHECKED const *drs_debug_ranges_end;      /* [0..1] `.debug_ranges' end */
} di_rnglists_sections_t;

typedef struct di_string_sections_struct {
	/* NOTE: The order of members in this struct is important!
	 *       s.a. `Section containers & overlap' in `/kos/include/libdebuginfo/debug_info.h' */
	__byte_t __CHECKED const *dss_debug_str_start;      /* [0..1] `.debug_str' start */
	__byte_t __CHECKED const *dss_debug_str_end;        /* [0..1] `.debug_str' end */
	__byte_t __CHECKED const *dss_debug_line_str_start; /* [0..1] `.debug_str' start */
	__byte_t __CHECKED const *dss_debug_line_str_end;   /* [0..1] `.debug_str' end */
} di_string_sections_t;

typedef struct di_debuginfo_cu_parser_sections_struct {
	/* NOTE: The order of members in this struct is important!
	 *       s.a. `Section containers & overlap' in `/kos/include/libdebuginfo/debug_info.h' */
	__byte_t __CHECKED const *cps_debug_loclists_start; /* [0..1][const] `.debug_loclists' start */
	__byte_t __CHECKED const *cps_debug_loclists_end;   /* [0..1][const] `.debug_loclists' end */
	__byte_t __CHECKED const *cps_debug_loc_start;      /* [0..1][const] `.debug_loc' start */
	__byte_t __CHECKED const *cps_debug_loc_end;        /* [0..1][const] `.debug_loc' end */
	__byte_t __CHECKED const *cps_debug_abbrev_start;   /* [1..1][const] `.debug_abbrev' start */
	__byte_t __CHECKED const *cps_debug_abbrev_end;     /* [1..1][const] `.debug_abbrev' end */
	__byte_t __CHECKED const *cps_debug_info_start;     /* [0..1][const] `.debug_info' start */
	__byte_t __CHECKED const *cps_debug_info_end;       /* [0..1][const] `.debug_info' end */
	/*BEGIN:compat(di_string_sections_t)*/
	__byte_t __CHECKED const *cps_debug_str_start;      /* [0..1][const] `.debug_str' start
	                                                     * NOTE: When set equal to `cps_debug_str_end', strings referring to
	                                                     *       this section will be returned  as `???' (3 question  marks) */
	__byte_t __CHECKED const *cps_debug_str_end;        /* [0..1][const] `.debug_str' end */
	__byte_t __CHECKED const *cps_debug_line_str_start; /* [0..1][const] `.debug_line_str' start
	                                                     * NOTE: When set equal to `cps_debug_line_str_end', strings referring
	                                                     *       to  this section will be returned as `???' (3 question marks) */
	__byte_t __CHECKED const *cps_debug_line_str_end;   /* [0..1][const] `.debug_line_str' end */
...
typedef struct di_debuginfo_cu_abbrev_cache_entry_struct {
	...
	__byte_t __CHECKED const *ace_data; /* [1..1][valid_if(ace_code)] Abbreviation code data.
...
typedef struct di_debuginfo_cu_abbrev_struct {
	__byte_t __CHECKED const             *dua_abbrev;     /* [1..1][const] Starting address of debug abbreviations (in .debug_abbrev). */
...
typedef struct di_debuginfo_cu_simple_parser_struct {
	__byte_t __CHECKED const *dsp_cu_info_end; /* [1..1][const] End address of debug information data (usually in .debug_info). */
	__byte_t __CHECKED const *dsp_cu_info_pos; /* [1..1][>= dup_cu_info_hdr && <= dup_base.dsp_cu_info_pos] Current position in debug information data (usually in .debug_info). */
...
#define _di_debuginfo_cu_parser_struct_base_     /* nothing */
	...
	__byte_t __CHECKED const                *dup_cu_info_hdr; /* [1..1][const] Address of the debug information header (in .debug_info). */
...
#define DI_DEBUGINFO_CU_PARSER_EACHATTR(attr, self)                                                        \
	for (__byte_t __CHECKED const *_attr_reader = (__byte_t __CHECKED const *)(self)->dup_comp.dic_attrib; \
	     ...
	     debuginfo_cu_parser_skipform(_di_debuginfo_cu_parser_struct_asbase(self),                         \
	                                  (attr).dica_form, (__byte_t __CHECKED const **)&_attr_reader))       \
		if (((attr).dica_name = dwarf_decode_uleb128((__byte_t __CHECKED const **)&_attr_reader),          \
		     (attr).dica_form = dwarf_decode_uleb128((__byte_t __CHECKED const **)&_attr_reader), 0))      \
			;                                                                                              \
	...
	do {                                                                                                \
		for (;;) {                                                                                      \
			...
			if ((self)->_di_debuginfo_cu_parser_struct_base_ dsp_cu_info_pos >=                         \
			    (self)->_di_debuginfo_cu_parser_struct_base_ dsp_cu_info_end)                           \
				break;                                                                                  \
			(attr).dica_name = dwarf_decode_uleb128((__byte_t __CHECKED const **)&_attr_reader);        \
			(attr).dica_form = dwarf_decode_uleb128((__byte_t __CHECKED const **)&_attr_reader);        \
...
__NOTHROW_NCX_T(LIBDEBUGINFO_CC *PDEBUGINFO_CU_PARSER_LOADUNIT)(__byte_t __CHECKED const **__restrict pdebug_info_reader,
                                                                __byte_t __CHECKED const *__restrict debug_info_end,
                                                                ...
                                                                __byte_t __CHECKED const *first_component_pointer);
#ifdef LIBDEBUGINFO_WANT_PROTOTYPES
LIBDEBUGINFO_DECL __ATTR_NONNULL((1, 2, 3, 4, 5)) debuginfo_errno_t
__NOTHROW_NCX(LIBDEBUGINFO_CC debuginfo_cu_parser_loadunit)(__byte_t __CHECKED const **__restrict pdebug_info_reader,
                                                            __byte_t __CHECKED const *__restrict debug_info_end,
                                                            di_debuginfo_cu_parser_sections_t const *__restrict sectinfo,
                                                            di_debuginfo_cu_parser_t *__restrict result,
                                                            di_debuginfo_cu_abbrev_t *__restrict abbrev,
...
__NOTHROW_T(LIBDEBUGINFO_CC *PDEBUGINFO_CU_ABBREV_FINI)(di_debuginfo_cu_abbrev_t *__restrict self);
#ifdef LIBDEBUGINFO_WANT_PROTOTYPES
LIBDEBUGINFO_DECL __ATTR_NONNULL((1)) void
__NOTHROW(LIBDEBUGINFO_CC debuginfo_cu_abbrev_fini)(di_debuginfo_cu_abbrev_t *__restrict self);
#endif /* LIBDEBUGINFO_WANT_PROTOTYPES */
...
__NOTHROW_NCX_T(LIBDEBUGINFO_CC *PDEBUGINFO_CU_PARSER_SKIPFORM)(di_debuginfo_cu_simple_parser_t *__restrict self,
                                                                ...
                                                                __byte_t __CHECKED const **__restrict p_attr_reader);
#ifdef LIBDEBUGINFO_WANT_PROTOTYPES
...
__NOTHROW_NCX_T(LIBDEBUGINFO_CC *PDEBUGINFO_CU_PARSER_NEXT_WITH_DIP)(di_debuginfo_cu_parser_t *__restrict self,
                                                                     __byte_t __CHECKED const **__restrict p_dip);
#ifdef LIBDEBUGINFO_WANT_PROTOTYPES
...
typedef __ATTR_NONNULL_T((1, 3)) __BOOL __NOTHROW_NCX_T(LIBDEBUGINFO_CC *PDEBUGINFO_CU_PARSER_GETSTRING)(di_debuginfo_cu_parser_t const *__restrict self, __uintptr_t form, char __CHECKED const **__restrict presult);
typedef __ATTR_NONNULL_T((1, 3)) __BOOL __NOTHROW_NCX_T(LIBDEBUGINFO_CC *PDEBUGINFO_CU_PARSER_GETSTRING_EX)(di_debuginfo_cu_simple_parser_t const *__restrict self, __uintptr_t form, char __CHECKED const **__restrict presult, di_string_sections_t const *__restrict sections);
...
typedef __ATTR_NONNULL_T((1, 3)) __BOOL __NOTHROW_NCX_T(LIBDEBUGINFO_CC *PDEBUGINFO_CU_PARSER_GETCONST)(di_debuginfo_cu_simple_parser_t const *__restrict self, __uintptr_t form, __uintptr_t *__restrict presult, __byte_t __CHECKED const *__restrict attr_reader);
typedef __ATTR_NONNULL_T((1, 3)) __BOOL __NOTHROW_NCX_T(LIBDEBUGINFO_CC *PDEBUGINFO_CU_PARSER_GETCONST64)(di_debuginfo_cu_simple_parser_t const *__restrict self, __uintptr_t form, __uintptr_t *__restrict presult, __byte_t __CHECKED const *__restrict attr_reader);
typedef __ATTR_NONNULL_T((1, 3)) __BOOL __NOTHROW_NCX_T(LIBDEBUGINFO_CC *PDEBUGINFO_CU_PARSER_GETCONST128)(di_debuginfo_cu_simple_parser_t const *__restrict self, __uintptr_t form, __hybrid_uint128_t *__restrict presult, __byte_t __CHECKED const *__restrict attr_reader);
...
typedef __ATTR_NONNULL_T((1, 3)) __BOOL __NOTHROW_NCX_T(LIBDEBUGINFO_CC *PDEBUGINFO_CU_PARSER_GETREF)(di_debuginfo_cu_parser_t const *__restrict self, __uintptr_t form, __byte_t __CHECKED const **__restrict presult);
...
#ifdef LIBDEBUGINFO_WANT_PROTOTYPES
LIBDEBUGINFO_DECL __ATTR_NONNULL((1, 3)) __BOOL __NOTHROW_NCX(LIBDEBUGINFO_CC debuginfo_cu_parser_getstring)(di_debuginfo_cu_parser_t const *__restrict self, __uintptr_t form, char __CHECKED const **__restrict presult);
LIBDEBUGINFO_DECL __ATTR_NONNULL((1, 3)) __BOOL __NOTHROW_NCX(LIBDEBUGINFO_CC debuginfo_cu_parser_getstring_ex)(di_debuginfo_cu_simple_parser_t const *__restrict self, __uintptr_t form, char __CHECKED const **__restrict presult, di_string_sections_t const *__restrict sections);
...
LIBDEBUGINFO_DECL __ATTR_NONNULL((1, 3)) __BOOL __NOTHROW_NCX(LIBDEBUGINFO_CC debuginfo_cu_parser_getconst)(di_debuginfo_cu_simple_parser_t const *__restrict self, __uintptr_t form, __uintptr_t *__restrict presult, __byte_t __CHECKED const *__restrict attr_reader);
LIBDEBUGINFO_DECL __ATTR_NONNULL((1, 3)) __BOOL __NOTHROW_NCX(LIBDEBUGINFO_CC debuginfo_cu_parser_getconst64)(di_debuginfo_cu_simple_parser_t const *__restrict self, __uintptr_t form, __uint64_t *__restrict presult, __byte_t __CHECKED const *__restrict attr_reader);
LIBDEBUGINFO_DECL __ATTR_NONNULL((1, 3)) __BOOL __NOTHROW_NCX(LIBDEBUGINFO_CC debuginfo_cu_parser_getconst128)(di_debuginfo_cu_simple_parser_t const *__restrict self, __uintptr_t form, __hybrid_uint128_t *__restrict presult, __byte_t __CHECKED const *__restrict attr_reader);
...
LIBDEBUGINFO_DECL __ATTR_NONNULL((1, 3)) __BOOL __NOTHROW_NCX(LIBDEBUGINFO_CC debuginfo_cu_parser_getref)(di_debuginfo_cu_parser_t const *__restrict self, __uintptr_t form, __byte_t __CHECKED const **__restrict presult);
...
typedef struct {
	...
	__byte_t __CHECKED const      *ri_pos;      /* [1..1] Current iterator position (or >= ri_end if the iterator was exhausted) */
	__byte_t __CHECKED const      *ri_end;      /* [1..1][const] Iterator end position */
...
typedef struct di_debuginfo_compile_unit_struct {
	...
	char __CHECKED const   *cu_name;      /* [0..1] Name of the compilation unit. */
	char __CHECKED const   *cu_comp_dir;  /* [0..1] Path to  the compiler  base  directory (prepended  before  filenames,
...
#define DW_SUBPROGRAM_FNORETURN 0x00000002 /* The function is either NORETURN */
	...
	char __CHECKED const   *sp_name;         /* [0..1] Name of the function. */
	char __CHECKED const   *sp_rawname;      /* [0..1] Raw (linkage) name of the function. */
...
typedef struct di_debuginfo_inlined_subroutine_struct {
	...
	__byte_t __CHECKED const *is_subprogram;    /* [0..1] Pointer to the debug_info for the function's declaration (i.e. its `DW_TAG_subprogram').
...
typedef struct di_debuginfo_type_struct {
	/* For `DW_TAG_*_type' */
	char __CHECKED const     *t_name;        /* [0..1] Name of the type. */
	char __CHECKED const     *t_rawname;     /* [0..1] Raw (linkage) name of the type. */
	...
	__byte_t __CHECKED const *t_type;        /* [0..1] Underlying type (e.g. array element type). */
...
typedef struct di_debuginfo_member_struct {
	/* For `DW_TAG_member' */
	__byte_t __CHECKED const *m_type;        /* [0..1] Pointer  to  the  debug_info  for  the  member's  type  (which  is  one  of   `DW_TAG_*_type').
	...
	char __CHECKED const     *m_name;        /* [0..1] Name of the member. */
...
typedef struct di_debuginfo_variable_struct {
	...
	__byte_t __CHECKED const *v_type;        /* [0..1] Type of this variable. */
	di_debuginfo_location_t   v_location;    /* CFI expression to decode the storage location of this variable. */
	char __CHECKED const     *v_name;        /* [0..1] Name of the variable. */
	char __CHECKED const     *v_rawname;     /* [0..1] Raw (linkage) name of the variable. */
...
(LIBDEBUGINFO_CC *PDEBUGINFO_PRINT_VALUE)(__pformatprinter printer, void *arg,
                                          ...
                                          char __CHECKED const *varname, void __CHECKED const *data,
...
debuginfo_print_value(__pformatprinter printer, void *arg,
                      di_debuginfo_cu_parser_t const *__restrict parser,
                      di_debuginfo_type_t const *__restrict type,
                      __CHECKED char const *varname, __CHECKED void const *data,
                      __size_t datasize, __size_t newline_indentation,
                      debuginfo_print_format_t format_printer,
                      void *format_arg, unsigned int flags);
LIBDEBUGINFO_DECL __ATTR_NONNULL((1, 3, 4)) __ssize_t LIBDEBUGINFO_CC
...
typedef struct di_enum_locals_sections_struct {
	/* NOTE: The order of members in this struct is important!
	 *       s.a. `Section containers & overlap' in `/kos/include/libdebuginfo/debug_info.h' */
	__byte_t __CHECKED const *el_debug_addr_start;     /* [0..1] `.debug_addr' start */
	__byte_t __CHECKED const *el_debug_addr_end;       /* [0..1] `.debug_addr' end */
	/*BEGIN:compat(di_debuginfo_cu_parser_sections_t)*/
	__byte_t __CHECKED const *el_debug_loclists_start; /* [0..1] `.debug_loclists' start */
	__byte_t __CHECKED const *el_debug_loclists_end;   /* [0..1] `.debug_loclists' end */
	__byte_t __CHECKED const *el_debug_loc_start;      /* [0..1] `.debug_loc' start */
	__byte_t __CHECKED const *el_debug_loc_end;        /* [0..1] `.debug_loc' end */
	__byte_t __CHECKED const *el_debug_abbrev_start;   /* [0..1] `.debug_abbrev' start */
	__byte_t __CHECKED const *el_debug_abbrev_end;     /* [0..1] `.debug_abbrev' end */
	__byte_t __CHECKED const *el_debug_info_start;     /* [0..1] `.debug_info' start */
	__byte_t __CHECKED const *el_debug_info_end;       /* [0..1] `.debug_info' end */
	/*BEGIN:compat(di_string_sections_t)*/
	__byte_t __CHECKED const *el_debug_str_start;      /* [0..1] `.debug_str' start */
	__byte_t __CHECKED const *el_debug_str_end;        /* [0..1] `.debug_str' end */
	__byte_t __CHECKED const *el_debug_line_str_start; /* [0..1] `.debug_str' start */
	__byte_t __CHECKED const *el_debug_line_str_end;   /* [0..1] `.debug_str' end */
	/*END:compat(di_string_sections_t)*/
	/*END:compat(di_debuginfo_cu_parser_sections_t)*/
	__byte_t __CHECKED const *el_debug_aranges_start;  /* [0..1] `.debug_aranges' start */
	__byte_t __CHECKED const *el_debug_aranges_end;    /* [0..1] `.debug_aranges' end */
	/*BEGIN:compat(di_rnglists_sections_t)*/
	__byte_t __CHECKED const *el_debug_rnglists_start; /* [0..1] `.debug_rnglists' start */
	__byte_t __CHECKED const *el_debug_rnglists_end;   /* [0..1] `.debug_rnglists' end */
	__byte_t __CHECKED const *el_debug_ranges_start;   /* [0..1] `.debug_ranges' start */
	__byte_t __CHECKED const *el_debug_ranges_end;     /* [0..1] `.debug_ranges' end */
...
typedef struct di_debug_sections_struct {
	...
	__byte_t __CHECKED const *ds_eh_frame_hdr_start;   /* [0..1] `.eh_frame_hdr' start */
	__byte_t __CHECKED const *ds_eh_frame_hdr_end;     /* [0..1] `.eh_frame_hdr' end */
	__byte_t __CHECKED const *ds_eh_frame_start;       /* [0..1] `.eh_frame' start */
	__byte_t __CHECKED const *ds_eh_frame_end;         /* [0..1] `.eh_frame' end */
	__byte_t __CHECKED const *ds_debug_frame_start;    /* [0..1] `.debug_frame' start */
	__byte_t __CHECKED const *ds_debug_frame_end;      /* [0..1] `.debug_frame' end */
	/*BEGIN:compat(di_enum_locals_sections_t)*/
	__byte_t __CHECKED const *ds_debug_addr_start;     /* [0..1] `.debug_addr' start */
	__byte_t __CHECKED const *ds_debug_addr_end;       /* [0..1] `.debug_addr' end */
	/*BEGIN:compat(di_debuginfo_cu_parser_sections_t)*/
	__byte_t __CHECKED const *ds_debug_loclists_start; /* [0..1] `.debug_loclists' start */
	__byte_t __CHECKED const *ds_debug_loclists_end;   /* [0..1] `.debug_loclists' end */
	__byte_t __CHECKED const *ds_debug_loc_start;      /* [0..1] `.debug_loc' start */
	__byte_t __CHECKED const *ds_debug_loc_end;        /* [0..1] `.debug_loc' end */
	/*BEGIN:compat(di_addr2line_sections_t)*/
	__byte_t __CHECKED const *ds_debug_abbrev_start;   /* [0..1] `.debug_abbrev' start */
	__byte_t __CHECKED const *ds_debug_abbrev_end;     /* [0..1] `.debug_abbrev' end */
	__byte_t __CHECKED const *ds_debug_info_start;     /* [0..1] `.debug_info' start */
	__byte_t __CHECKED const *ds_debug_info_end;       /* [0..1] `.debug_info' end */
	/*END:compat(unwind_emulator_sections_t)*/
	/*BEGIN:compat(di_string_sections_t)*/
	__byte_t __CHECKED const *ds_debug_str_start;      /* [0..1] `.debug_str' start */
	__byte_t __CHECKED const *ds_debug_str_end;        /* [0..1] `.debug_str' end */
	__byte_t __CHECKED const *ds_debug_line_str_start; /* [0..1] `.debug_line_str' start */
	__byte_t __CHECKED const *ds_debug_line_str_end;   /* [0..1] `.debug_line_str' end */
	/*END:compat(di_string_sections_t)*/
	/*END:compat(di_debuginfo_cu_parser_sections_t)*/
	__byte_t __CHECKED const *ds_debug_aranges_start;  /* [0..1] `.debug_aranges' start */
	__byte_t __CHECKED const *ds_debug_aranges_end;    /* [0..1] `.debug_aranges' end */
	/*BEGIN:compat(di_rnglists_sections_t)*/
	__byte_t __CHECKED const *ds_debug_rnglists_start; /* [0..1] `.debug_rnglists' start */
	__byte_t __CHECKED const *ds_debug_rnglists_end;   /* [0..1] `.debug_rnglists' end */
	__byte_t __CHECKED const *ds_debug_ranges_start;   /* [0..1] `.debug_ranges' start */
	__byte_t __CHECKED const *ds_debug_ranges_end;     /* [0..1] `.debug_ranges' end */
	/*END:compat(di_rnglists_sections_t)*/
	/*END:compat(di_enum_locals_sections_t)*/
	__byte_t __CHECKED const *ds_debug_line_start;     /* [0..1] `.debug_line' start */
	__byte_t __CHECKED const *ds_debug_line_end;       /* [0..1] `.debug_line' end */
	__byte_t __CHECKED const *ds_strtab_start;         /* [0..1] `.strtab' / `.dynstr' start */
	__byte_t __CHECKED const *ds_strtab_end;           /* [0..1] `.strtab' / `.dynstr' end */
	__byte_t __CHECKED const *ds_symtab_start;         /* [0..1] `.symtab' / `.dynsym' start */
	__byte_t __CHECKED const *ds_symtab_end;           /* [0..1] `.symtab' / `.dynsym' end */
