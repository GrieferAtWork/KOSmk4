...
__NOTHROW_NCX_T(LIBDEBUGINFO_CC *PSYMTAB_SCANTABLE)(__NCX __byte_t const *symtab_start,
                                                    __NCX __byte_t const *symtab_end,
                                                    __size_t symtab_entsize,
                                                    __uintptr_t module_relative_pc);
#ifdef LIBDEBUGINFO_WANT_PROTOTYPES
LIBDEBUGINFO_DECL __ATTR_PURE __ATTR_WUNUSED __NCX __byte_t const *
__NOTHROW_NCX(LIBDEBUGINFO_CC symtab_scantable)(__NCX __byte_t const *symtab_start,
                                                __NCX __byte_t const *symtab_end,
                                                __size_t symtab_entsize,
                                                __uintptr_t module_relative_pc);
