...
__LIBC __ATTR_NONNULL((2)) int __NOTHROW_NCX(__LIBDCALL _seh_filter_dll)(__ULONG32_TYPE__ __xno, struct _EXCEPTION_POINTERS *__infp_ptrs) __CASMNAME_SAME("_seh_filter_dll");
#endif /* __CRT_HAVE__seh_filter_dll */
#ifdef __CRT_HAVE__seh_filter_exe
__LIBC __ATTR_NONNULL((2)) int __NOTHROW_NCX(__LIBDCALL _seh_filter_exe)(__ULONG32_TYPE__ __xno, struct _EXCEPTION_POINTERS *__infp_ptrs) __CASMNAME_SAME("_seh_filter_exe");
