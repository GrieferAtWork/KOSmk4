...
typedef __ATTR_NONNULL((1)) dwarf_sleb128_t
/*__NOTHROW_NCX*/ (LIBUNWIND_CC *PDWARF_DECODE_SLEB128)(__byte_t const **__restrict preader);
typedef __ATTR_NONNULL((1)) dwarf_uleb128_t
/*__NOTHROW_NCX*/ (LIBUNWIND_CC *PDWARF_DECODE_ULEB128)(__byte_t const **__restrict preader);
