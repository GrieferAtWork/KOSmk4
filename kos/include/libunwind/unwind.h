...
__NOTHROW_NCX_T(LIBUNWIND_CC *PUNWIND_FDE_FIND)(void __CHECKED const *__absolute_pc,
                                                unwind_fde_t *__restrict __result);
#ifdef LIBUNWIND_WANT_PROTOTYPES
LIBUNWIND_DECL __ATTR_NONNULL((2)) unwind_errno_t
__NOTHROW_NCX(LIBUNWIND_CC unwind_fde_find)(void __CHECKED const *__absolute_pc,
                                            unwind_fde_t *__restrict __result);
...
(LIBUNWIND_CC *PUNWIND)(void __CHECKED const *__absolute_pc,
...
(LIBUNWIND_CC unwind)(void __CHECKED const *__absolute_pc,
                      unwind_getreg_t __reg_getter, void const *__reg_getter_arg,
                      unwind_setreg_t __reg_setter, void *__reg_setter_arg);
#endif /* LIBUNWIND_WANT_PROTOTYPES */
