...
__CDECLARE(__ATTR_IN(1) __ATTR_IN(2) __ATTR_OUT_OPT(3),int,__NOTHROW_NCX,sym_ston,(struct res_sym const *__symbols, char const *__wanted_name, int *__p_success),(__symbols,__wanted_name,__p_success))
#elif defined(__CRT_HAVE___sym_ston)
__CREDIRECT(__ATTR_IN(1) __ATTR_IN(2) __ATTR_OUT_OPT(3),int,__NOTHROW_NCX,sym_ston,(struct res_sym const *__symbols, char const *__wanted_name, int *__p_success),__sym_ston,(__symbols,__wanted_name,__p_success))
#else /* ... */
#include <libc/local/resolv/sym_ston.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(sym_ston, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(1) __ATTR_IN(2) __ATTR_OUT_OPT(3) int __NOTHROW_NCX(__LIBCCALL sym_ston)(struct res_sym const *__symbols, char const *__wanted_name, int *__p_success) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(sym_ston))(__symbols, __wanted_name, __p_success); })
#endif /* !... */
#ifdef __CRT_HAVE_sym_ntos
__CDECLARE(__ATTR_RETNONNULL __ATTR_IN(1) __ATTR_OUT_OPT(3),char const *,__NOTHROW_NCX,sym_ntos,(struct res_sym const *__symbols, int __wanted_number, int *__p_success),(__symbols,__wanted_number,__p_success))
#elif defined(__CRT_HAVE___sym_ntos)
__CREDIRECT(__ATTR_RETNONNULL __ATTR_IN(1) __ATTR_OUT_OPT(3),char const *,__NOTHROW_NCX,sym_ntos,(struct res_sym const *__symbols, int __wanted_number, int *__p_success),__sym_ntos,(__symbols,__wanted_number,__p_success))
#else /* ... */
#include <libc/local/resolv/sym_ntos.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(sym_ntos, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_RETNONNULL __ATTR_IN(1) __ATTR_OUT_OPT(3) char const *__NOTHROW_NCX(__LIBCCALL sym_ntos)(struct res_sym const *__symbols, int __wanted_number, int *__p_success) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(sym_ntos))(__symbols, __wanted_number, __p_success); })
#endif /* !... */
#ifdef __CRT_HAVE_sym_ntop
__CDECLARE(__ATTR_RETNONNULL __ATTR_IN(1) __ATTR_OUT_OPT(3),char const *,__NOTHROW_NCX,sym_ntop,(struct res_sym const *__symbols, int __wanted_number, int *__p_success),(__symbols,__wanted_number,__p_success))
#elif defined(__CRT_HAVE___sym_ntop)
__CREDIRECT(__ATTR_RETNONNULL __ATTR_IN(1) __ATTR_OUT_OPT(3),char const *,__NOTHROW_NCX,sym_ntop,(struct res_sym const *__symbols, int __wanted_number, int *__p_success),__sym_ntop,(__symbols,__wanted_number,__p_success))
#else /* ... */
#include <libc/local/resolv/sym_ntop.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(sym_ntop, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_RETNONNULL __ATTR_IN(1) __ATTR_OUT_OPT(3) char const *__NOTHROW_NCX(__LIBCCALL sym_ntop)(struct res_sym const *__symbols, int __wanted_number, int *__p_success) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(sym_ntop))(__symbols, __wanted_number, __p_success); })
#endif /* !... */
...
__CDECLARE(__ATTR_IN(1) __ATTR_NONNULL((2)),int,__NOTHROW_NCX,dn_skipname,(unsigned char const *__msg_ptr, unsigned char const *__end_of_msg),(__msg_ptr,__end_of_msg))
#elif defined(__CRT_HAVE___dn_skipname)
__CREDIRECT(__ATTR_IN(1) __ATTR_NONNULL((2)),int,__NOTHROW_NCX,dn_skipname,(unsigned char const *__msg_ptr, unsigned char const *__end_of_msg),__dn_skipname,(__msg_ptr,__end_of_msg))
#elif defined(__CRT_HAVE_ns_name_skip)
#include <libc/local/resolv/dn_skipname.h>
__NAMESPACE_LOCAL_USING_OR_IMPL(dn_skipname, __FORCELOCAL __ATTR_ARTIFICIAL __ATTR_IN(1) __ATTR_NONNULL((2)) int __NOTHROW_NCX(__LIBCCALL dn_skipname)(unsigned char const *__msg_ptr, unsigned char const *__end_of_msg) { return (__NAMESPACE_LOCAL_SYM __LIBC_LOCAL_NAME(dn_skipname))(__msg_ptr, __end_of_msg); })
#endif /* ... */
