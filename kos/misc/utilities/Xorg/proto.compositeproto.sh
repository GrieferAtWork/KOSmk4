#TEST: require_utility Xorg/proto.compositeproto "$PKG_CONFIG_PATH/compositeproto.pc"
...
VERSION="0.4.2"
SRCPATH="$KOS_ROOT/binutils/src/Xorg/compositeproto-$VERSION"
...
if ! [ -f "$SRCPATH/configure" ]; then
	...
	download_file \
		...
		"https://www.x.org/releases/individual/proto/compositeproto-$VERSION.tar.gz"
...
install_rawfile_stdin "$PKG_CONFIG_PATH/compositeproto.pc" <<EOF
prefix=/
exec_prefix=/
