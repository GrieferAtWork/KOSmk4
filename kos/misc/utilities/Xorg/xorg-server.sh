...
require_utility Xorg/proto.fixesproto       "$PKG_CONFIG_PATH/fixesproto.pc"
require_utility Xorg/proto.damageproto      "$PKG_CONFIG_PATH/damageproto.pc"
require_utility Xorg/proto.xcmiscproto      "$PKG_CONFIG_PATH/xcmiscproto.pc"
require_utility Xorg/proto.bigreqsproto     "$PKG_CONFIG_PATH/bigreqsproto.pc"
require_utility Xorg/proto.presentproto     "$PKG_CONFIG_PATH/presentproto.pc"
require_utility Xorg/proto.xtrans           "$PKG_CONFIG_PATH/xtrans.pc"
require_utility Xorg/proto.compositeproto   "$PKG_CONFIG_PATH/compositeproto.pc"
require_utility Xorg/proto.recordproto      "$PKG_CONFIG_PATH/recordproto.pc"
require_utility Xorg/proto.resourceproto    "$PKG_CONFIG_PATH/resourceproto.pc"
require_utility Xorg/proto.scrnsaverproto   "$PKG_CONFIG_PATH/scrnsaverproto.pc"
require_utility Xorg/proto.videoproto       "$PKG_CONFIG_PATH/videoproto.pc"
require_utility Xorg/proto.xf86bigfontproto "$PKG_CONFIG_PATH/xf86bigfontproto.pc"
require_utility Xorg/proto.xf86vidmodeproto "$PKG_CONFIG_PATH/xf86vidmodeproto.pc"
require_utility Xorg/proto.xf86dgaproto     "$PKG_CONFIG_PATH/xf86dgaproto.pc"
