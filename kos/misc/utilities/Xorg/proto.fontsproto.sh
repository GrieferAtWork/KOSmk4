#TEST: require_utility Xorg/proto.fontsproto "$PKG_CONFIG_PATH/fontsproto.pc"
...
VERSION="2.1.3"
SRCPATH="$KOS_ROOT/binutils/src/Xorg/fontsproto-$VERSION"
...
if ! [ -f "$SRCPATH/configure" ]; then
	...
	download_file \
		...
		"https://www.x.org/releases/individual/proto/fontsproto-$VERSION.tar.gz"
...
install_rawfile_stdin "$PKG_CONFIG_PATH/fontsproto.pc" <<EOF
prefix=/
exec_prefix=/
