#TEST: require_utility Xorg/proto.bigreqsproto "$PKG_CONFIG_PATH/bigreqsproto.pc"
...
VERSION="1.1.2"
SRCPATH="$KOS_ROOT/binutils/src/Xorg/bigreqsproto-$VERSION"
...
if ! [ -f "$SRCPATH/configure" ]; then
	...
	download_file \
		...
		"https://www.x.org/releases/individual/proto/bigreqsproto-$VERSION.tar.gz"
...
install_rawfile_stdin "$PKG_CONFIG_PATH/bigreqsproto.pc" <<EOF
prefix=/
exec_prefix=/
