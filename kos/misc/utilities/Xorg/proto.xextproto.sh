#TEST: require_utility Xorg/proto.xextproto "$PKG_CONFIG_PATH/xextproto.pc"
...
VERSION="7.3.0"
SRCPATH="$KOS_ROOT/binutils/src/Xorg/xextproto-$VERSION"
...
if ! [ -f "$SRCPATH/configure" ]; then
	...
	download_file \
		...
		"https://www.x.org/releases/individual/proto/xextproto-$VERSION.tar.gz"
...
install_rawfile_stdin "$PKG_CONFIG_PATH/xextproto.pc" <<EOF
prefix=/
exec_prefix=/
