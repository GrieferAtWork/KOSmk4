...
#define fde_cache_endread()    (void)(atomic_rwlock_endread_ex(&fde_cache_lock) && (fde_cache_reap(), 0))
#define _fde_cache_end()       atomic_rwlock_end(&fde_cache_lock)
#define fde_cache_end()        (void)(atomic_rwlock_end_ex(&fde_cache_lock) && (fde_cache_reap(), 0))
...
#define register_frame_aux_endread()    (void)(atomic_rwlock_endread_ex(&register_frame_aux_lock) && (register_frame_aux_reap(), 0))
#define _register_frame_aux_end()       atomic_rwlock_end(&register_frame_aux_lock)
#define register_frame_aux_end()        (void)(atomic_rwlock_end_ex(&register_frame_aux_lock) && (register_frame_aux_reap(), 0))
...
NOTHROW_NCX(CC libuw_unwind_fde_find_rf)(void __CHECKED const *absolute_pc,
...
NOTHROW_NCX(CC libuw_unwind_fde_find_new)(void *dlmod,
	...
	error = libuw_unwind_fde_scan((byte_t __CHECKED const *)eh_frame_sect->ds_data,
	                              (byte_t __CHECKED const *)eh_frame_sect->ds_data +
