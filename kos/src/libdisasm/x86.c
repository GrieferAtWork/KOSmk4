...
/*[[[start:ops]]]*/
	...
	I(0x00, IF_MODRM,        "addb\t" OP_RM8  OP_R8),
	I(0x01, IF_66|IF_MODRM,  "addw\t" OP_RM16 OP_R16),
	I(0x01, IF_MODRM,        "addl\t" OP_RM32 OP_R32),
	I(0x01, IF_REXW|IF_MODRM,"addq\t" OP_RM64 OP_R64),
	I(0x02, IF_MODRM,        "addb\t" OP_R32 OP_RM8),
	I(0x03, IF_66|IF_MODRM,  "addw\t" OP_R32 OP_RM16),
	I(0x03, IF_MODRM,        "addl\t" OP_R32 OP_RM32),
	I(0x03, IF_REXW|IF_MODRM,"addq\t" OP_R64 OP_RM64),
	...
	I(0x08, IF_MODRM,        "orb\t" OP_RM8  OP_R8),
	I(0x09, IF_66|IF_MODRM,  "orw\t" OP_RM16 OP_R16),
	I(0x09, IF_MODRM,        "orl\t" OP_RM32 OP_R32),
	I(0x09, IF_REXW|IF_MODRM,"orq\t" OP_RM64 OP_R64),
	I(0x0a, IF_MODRM,        "orb\t" OP_R32 OP_RM8),
	I(0x0b, IF_66|IF_MODRM,  "orw\t" OP_R32 OP_RM16),
	I(0x0b, IF_MODRM,        "orl\t" OP_R32 OP_RM32),
	I(0x0b, IF_REXW|IF_MODRM,"orq\t" OP_R64 OP_RM64),
	...
	I(0x10, IF_MODRM,        "adcb\t" OP_RM8  OP_R8),
	I(0x11, IF_66|IF_MODRM,  "adcw\t" OP_RM16 OP_R16),
	I(0x11, IF_MODRM,        "adcl\t" OP_RM32 OP_R32),
	I(0x11, IF_REXW|IF_MODRM,"adcq\t" OP_RM64 OP_R64),
	I(0x12, IF_MODRM,        "adcb\t" OP_R32 OP_RM8),
	I(0x13, IF_66|IF_MODRM,  "adcw\t" OP_R32 OP_RM16),
	I(0x13, IF_MODRM,        "adcl\t" OP_R32 OP_RM32),
	I(0x13, IF_REXW|IF_MODRM,"adcq\t" OP_R64 OP_RM64),
	...
	I(0x18, IF_MODRM,        "sbbb\t" OP_RM8  OP_R8),
	I(0x19, IF_66|IF_MODRM,  "sbbw\t" OP_RM16 OP_R16),
	I(0x19, IF_MODRM,        "sbbl\t" OP_RM32 OP_R32),
	I(0x19, IF_REXW|IF_MODRM,"sbbq\t" OP_RM64 OP_R64),
	I(0x1a, IF_MODRM,        "sbbb\t" OP_R32 OP_RM8),
	I(0x1b, IF_66|IF_MODRM,  "sbbw\t" OP_R32 OP_RM16),
	I(0x1b, IF_MODRM,        "sbbl\t" OP_R32 OP_RM32),
	I(0x1b, IF_REXW|IF_MODRM,"sbbq\t" OP_R64 OP_RM64),
	...
	I(0x20, IF_MODRM,        "andb\t" OP_RM8  OP_R8),
	I(0x21, IF_66|IF_MODRM,  "andw\t" OP_RM16 OP_R16),
	I(0x21, IF_MODRM,        "andl\t" OP_RM32 OP_R32),
	I(0x21, IF_REXW|IF_MODRM,"andq\t" OP_RM64 OP_R64),
	I(0x22, IF_MODRM,        "andb\t" OP_R32 OP_RM8),
	I(0x23, IF_66|IF_MODRM,  "andw\t" OP_R32 OP_RM16),
	I(0x23, IF_MODRM,        "andl\t" OP_R32 OP_RM32),
	I(0x23, IF_REXW|IF_MODRM,"andq\t" OP_R64 OP_RM64),
	...
	I(0x28, IF_MODRM,        "subb\t" OP_RM8  OP_R8),
	I(0x29, IF_66|IF_MODRM,  "subw\t" OP_RM16 OP_R16),
	I(0x29, IF_MODRM,        "subl\t" OP_RM32 OP_R32),
	I(0x29, IF_REXW|IF_MODRM,"subq\t" OP_RM64 OP_R64),
	I(0x2a, IF_MODRM,        "subb\t" OP_R32 OP_RM8),
	I(0x2b, IF_66|IF_MODRM,  "subw\t" OP_R32 OP_RM16),
	I(0x2b, IF_MODRM,        "subl\t" OP_R32 OP_RM32),
	I(0x2b, IF_REXW|IF_MODRM,"subq\t" OP_R64 OP_RM64),
	...
	I(0x30, IF_MODRM,        "xorb\t" OP_RM8  OP_R8),
	I(0x31, IF_66|IF_MODRM,  "xorw\t" OP_RM16 OP_R16),
	I(0x31, IF_MODRM,        "xorl\t" OP_RM32 OP_R32),
	I(0x31, IF_REXW|IF_MODRM,"xorq\t" OP_RM64 OP_R64),
	I(0x32, IF_MODRM,        "xorb\t" OP_R32 OP_RM8),
	I(0x33, IF_66|IF_MODRM,  "xorw\t" OP_R32 OP_RM16),
	I(0x33, IF_MODRM,        "xorl\t" OP_R32 OP_RM32),
	I(0x33, IF_REXW|IF_MODRM,"xorq\t" OP_R64 OP_RM64),
	...
	I(0x38, IF_MODRM,        "cmpb\t" OP_RM8  OP_R8),
	I(0x39, IF_66|IF_MODRM,  "cmpw\t" OP_RM16 OP_R16),
	I(0x39, IF_MODRM,        "cmpl\t" OP_RM32 OP_R32),
	I(0x39, IF_REXW|IF_MODRM,"cmpq\t" OP_RM64 OP_R64),
	I(0x3a, IF_MODRM,        "cmpb\t" OP_R32 OP_RM8),
	I(0x3b, IF_66|IF_MODRM,  "cmpw\t" OP_R32 OP_RM16),
	I(0x3b, IF_MODRM,        "cmpl\t" OP_R32 OP_RM32),
	I(0x3b, IF_REXW|IF_MODRM,"cmpq\t" OP_R64 OP_RM64),
...
STATIC_ASSERT(COMPILER_LENOF(ops) == 950);
PRIVATE u16 const ops_offsets[256] = {
	0, 1, 4, 5, 8, 9, 12, 14, 16, 17, 20, 21, 24, 25, 28, 949,
	30, 31, 34, 35, 38, 39, 42, 44, 46, 47, 50, 51, 54, 55, 58, 60,
	62, 63, 66, 67, 70, 71, 949, 74, 75, 76, 79, 80, 83, 84, 949, 87,
	88, 89, 92, 93, 96, 97, 949, 100, 101, 102, 105, 106, 109, 110, 949, 113,
	114, 116, 118, 120, 122, 124, 126, 128, 130, 132, 134, 136, 138, 140, 142, 144,
	146, 150, 154, 158, 162, 166, 170, 174, 178, 182, 186, 190, 194, 198, 202, 206,
	210, 212, 214, 216, 949, 949, 949, 949, 217, 220, 223, 224, 227, 229, 233, 235,
	239, 240, 241, 242, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254,
	255, 263, 287, 295, 319, 320, 323, 324, 327, 328, 331, 332, 335, 338, 341, 344,
	350, 356, 362, 368, 374, 380, 386, 392, 398, 399, 401, 403, 405, 407, 409, 410,
	411, 413, 417, 419, 423, 425, 431, 434, 443, 444, 447, 449, 455, 457, 463, 466,
	475, 477, 479, 481, 483, 485, 487, 489, 491, 497, 503, 509, 515, 521, 527, 533,
	539, 547, 571, 573, 575, 577, 579, 581, 586, 587, 588, 589, 590, 591, 592, 593,
	597, 605, 629, 637, 661, 662, 663, 664, 665, 681, 734, 747, 771, 785, 820, 835,
	860, 861, 862, 863, 866, 867, 869, 870, 872, 874, 876, 878, 879, 880, 882, 883,
	949, 885, 949, 949, 886, 887, 888, 896, 920, 921, 922, 923, 924, 925, 926, 928
};
