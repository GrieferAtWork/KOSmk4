...
/*[[[start:ops_0f38]]]*/
	...
	I(0x4e, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 1, 0), LO_VRSQRT14PD_XMM)), /* EVEX.128.66.0f38.W1 4e /r vrsqrt14pd xmm1{k1}{z}, xmm2/m128/m64bcst */
	I(0x4e, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 1, 1), LO_VRSQRT14PD_YMM)), /* EVEX.256.66.0f38.W1 4e /r vrsqrt14pd ymm1{k1}{z}, ymm2/m256/m64bcst */
	I(0x4e, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 1, 2), LO_VRSQRT14PD_ZMM)), /* EVEX.512.66.0f38.W1 4e /r vrsqrt14pd zmm1{k1}{z}, zmm2/m512/m64bcst */
	I(0x4e, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 0, 0), LO_VRSQRT14PS_XMM)), /* EVEX.128.66.0f38.W0 4e /r vrsqrt14ps xmm1{k1}{z}, xmm2/m128/m32bcst */
	I(0x4e, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 0, 1), LO_VRSQRT14PS_YMM)), /* EVEX.256.66.0f38.W0 4e /r vrsqrt14ps ymm1{k1}{z}, ymm2/m256/m32bcst */
	I(0x4e, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 0, 2), LO_VRSQRT14PS_ZMM)), /* EVEX.512.66.0f38.W0 4e /r vrsqrt14ps zmm1{k1}{z}, zmm2/m512/m32bcst */

	I(0x4f, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0_LIG(0, 0, 1), LO_VRSQRT14SD)), /* EVEX.LIG.66.0f38.W1 4f /r vrsqrt14sd xmm1{k1}{z}, xmm2, xmm3/m64 */
	I(0x4f, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0_LIG(0, 0, 0), LO_VRSQRT14SS)), /* EVEX.LIG.66.0f38.W0 4f /r vrsqrt14ss xmm1{k1}{z}, xmm2, xmm3/m32 */
...
/*[[[start:ops_0f3a]]]*/
	...
	I(0x23, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 0, 1), LO_VSHUFF32X4_YMM)), /* EVEX.256.66.0f3a.W0 23 /r ib vshuff32x4 ymm1{k1}{z}, ymm2, ymm3/m256/m32bcst, imm8 */
	I(0x23, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 0, 2), LO_VSHUFF32X4_ZMM)), /* EVEX.512.66.0f3a.W0 23 /r ib vshuff32x4 zmm1{k1}{z}, zmm2, zmm3/m512/m32bcst, imm8 */
	I(0x23, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 1, 1), LO_VSHUFF64X2_YMM)), /* EVEX.256.66.0f3a.W1 23 /r ib vshuff64x2 ymm1{k1}{z}, ymm2, ymm3/m256/m64bcst, imm8 */
	I(0x23, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 1, 2), LO_VSHUFF64X2_ZMM)), /* EVEX.512.66.0f3a.W1 23 /r ib vshuff64x2 zmm1{k1}{z}, zmm2, zmm3/m512/m64bcst, imm8 */

	I(0x25, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 0, 0), LO_VPTERNLOGD_XMM)), /* EVEX.128.66.0f3a.W0 25 /r ib vpternlogd xmm1{k1}{z}, xmm2, xmm3/m128/m32bcst, imm8 */
	I(0x25, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 0, 1), LO_VPTERNLOGD_YMM)), /* EVEX.256.66.0f3a.W0 25 /r ib vpternlogd ymm1{k1}{z}, ymm2, ymm3/m256/m32bcst, imm8 */
	I(0x25, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 0, 2), LO_VPTERNLOGD_ZMM)), /* EVEX.512.66.0f3a.W0 25 /r ib vpternlogd zmm1{k1}{z}, zmm2, zmm3/m512/m32bcst, imm8 */
	I(0x25, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 1, 0), LO_VPTERNLOGQ_XMM)), /* EVEX.128.66.0f3a.W1 25 /r ib vpternlogq xmm1{k1}{z}, xmm2, xmm3/m128/m64bcst, imm8 */
	I(0x25, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 1, 1), LO_VPTERNLOGQ_YMM)), /* EVEX.256.66.0f3a.W1 25 /r ib vpternlogq ymm1{k1}{z}, ymm2, ymm3/m256/m64bcst, imm8 */
	I(0x25, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 1, 2), LO_VPTERNLOGQ_ZMM)), /* EVEX.512.66.0f3a.W1 25 /r ib vpternlogq zmm1{k1}{z}, zmm2, zmm3/m512/m64bcst, imm8 */
	...
	I(0x43, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 0, 1), LO_VSHUFI32X4_YMM)), /* EVEX.256.66.0f3a.W0 43 /r ib vshufi32x4 ymm1{k1}{z}, ymm2, ymm3/m256/m32bcst, imm8 */
	I(0x43, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 0, 2), LO_VSHUFI32X4_ZMM)), /* EVEX.512.66.0f3a.W0 43 /r ib vshufi32x4 zmm1{k1}{z}, zmm2, zmm3/m512/m32bcst, imm8 */
	I(0x43, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 1, 1), LO_VSHUFI64X2_YMM)), /* EVEX.256.66.0f3a.W1 43 /r ib vshufi64x2 ymm1{k1}{z}, ymm2, ymm3/m256/m64bcst, imm8 */
	I(0x43, IF_VEX|IF_66|IF_MODRM, LONGREPR_B(B_OP_VEX_B0(0, 0, 1, 2), LO_VSHUFI64X2_ZMM)), /* EVEX.512.66.0f3a.W1 43 /r ib vshufi64x2 zmm1{k1}{z}, zmm2, zmm3/m512/m64bcst, imm8 */
...
STATIC_ASSERT(COMPILER_LENOF(ops_0f) == 1197);
PRIVATE u16 const ops_0f_offsets[256] = {
	0, 6, 36, 38, 1196, 40, 42, 43, 45, 46, 47, 48, 1196, 49, 1196, 1196,
	51, 75, 97, 118, 124, 136, 148, 163, 169, 1196, 173, 179, 184, 1196, 1196, 185,
	187, 189, 191, 193, 195, 1196, 196, 1196, 197, 209, 221, 222, 234, 236, 1196, 1196,
	238, 239, 240, 241, 242, 243, 244, 245, 1196, 1196, 1196, 1196, 1196, 1196, 1196, 246,
	247, 250, 257, 264, 267, 274, 281, 288, 295, 298, 301, 308, 314, 317, 320, 323,
	326, 1196, 338, 343, 348, 360, 372, 384, 1196, 1196, 1196, 1196, 1196, 1196, 1196, 1196,
	396, 401, 406, 413, 418, 423, 428, 435, 440, 445, 450, 457, 462, 468, 474, 480,
	504, 519, 534, 558, 580, 585, 590, 597, 600, 602, 1196, 1196, 604, 610, 616, 622,
	646, 648, 650, 652, 654, 656, 658, 660, 662, 664, 666, 668, 670, 672, 674, 676,
	678, 683, 688, 693, 698, 699, 700, 701, 702, 707, 712, 713, 714, 715, 716, 717,
	718, 721, 724, 725, 728, 731, 1196, 1196, 734, 737, 740, 741, 744, 747, 750, 782,
	785, 786, 789, 792, 795, 798, 801, 804, 806, 809, 810, 822, 825, 831, 837, 840,
	842, 843, 1196, 846, 848, 852, 860, 872, 888, 892, 896, 900, 904, 908, 912, 916,
	920, 926, 931, 938, 945, 952, 957, 959, 967, 972, 977, 982, 992, 997, 1002, 1007,
	1017, 1022, 1027, 1037, 1042, 1047, 1052, 1058, 1065, 1070, 1075, 1080, 1090, 1095, 1100, 1105,
	1196, 1115, 1120, 1127, 1134, 1141, 1146, 1151, 1154, 1159, 1164, 1171, 1178, 1183, 1188, 1195
};

#define HAVE_OPS_0F38_OFFSETS 1
STATIC_ASSERT(COMPILER_LENOF(ops_0f38) == 361);
PRIVATE u16 const ops_0f38_offsets[256] = {
	0, 5, 9, 13, 17, 22, 26, 30, 34, 38, 42, 46, 51, 54, 59, 61,
	63, 66, 69, 360, 360, 360, 72, 76, 360, 360, 360, 360, 79, 84, 89, 96,
	99, 103, 107, 111, 115, 119, 360, 360, 125, 131, 137, 143, 360, 360, 360, 360,
	149, 153, 157, 161, 165, 169, 175, 360, 179, 183, 192, 196, 205, 209, 218, 222,
	231, 240, 360, 360, 360, 242, 248, 254, 360, 360, 360, 360, 360, 360, 260, 266,
	360, 360, 360, 360, 360, 360, 360, 360, 268, 271, 279, 284, 360, 360, 360, 360,
	360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360,
	360, 360, 360, 360, 360, 360, 360, 360, 286, 289, 360, 360, 360, 360, 360, 360,
	292, 294, 296, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 298, 360, 360,
	360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360,
	360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360,
	360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360,
	360, 360, 360, 360, 360, 360, 360, 360, 301, 302, 303, 304, 305, 306, 360, 307,
	360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 309, 311, 313, 315, 317,
	360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360, 360,
	319, 324, 330, 332, 360, 338, 344, 350, 358, 360, 360, 360, 360, 360, 360, 360
};

#define HAVE_OPS_0F3A_OFFSETS 1
STATIC_ASSERT(COMPILER_LENOF(ops_0f3a) == 110);
PRIVATE u8 const ops_0f3a_offsets[256] = {
	0, 2, 4, 109, 6, 9, 14, 109, 15, 18, 21, 23, 25, 28, 31, 34,
	109, 109, 109, 109, 109, 39, 109, 109, 42, 109, 47, 109, 109, 109, 109, 109,
	109, 49, 109, 52, 109, 56, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109,
	62, 64, 66, 68, 109, 109, 109, 109, 70, 109, 75, 109, 109, 109, 109, 109,
	77, 80, 82, 85, 89, 109, 91, 109, 109, 109, 109, 109, 109, 109, 109, 109,
	109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109,
	92, 94, 96, 98, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109,
	109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109,
	109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109,
	109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109,
	109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109,
	109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109,
	109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 100, 109, 101, 103,
	109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 105,
	109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109, 109,
