...
#undef NEED_return_4
	...
	case DISASSEMBLER_TARGET_ARM_A32:
#define NEED_return_8
#endif /* DISASSEMBLER_TARGET_ARM_A32 */
#if DISASSEMBLER_TARGET_SUPPORTED(DISASSEMBLER_TARGET_ARM_T32)
	case DISASSEMBLER_TARGET_ARM_T32:
#define NEED_return_8
#endif /* DISASSEMBLER_TARGET_ARM_T32 */
