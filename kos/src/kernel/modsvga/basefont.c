...
INTERN_CONST struct vga_palcolor const basevga_defaultpal[64] = {
#define RGB(r, g, b) { r >> 2, g >> 2, b >> 2 }
	/*00*/ RGB(0x00, 0x00, 0x00), RGB(0x00, 0x00, 0xaa), RGB(0x00, 0xaa, 0x00), RGB(0x00, 0xaa, 0xaa),
	/*04*/ RGB(0xaa, 0x00, 0x00), RGB(0xaa, 0x00, 0xaa), RGB(0xaa, 0xaa, 0x00), RGB(0xaa, 0xaa, 0xaa),
	/*08*/ RGB(0x00, 0x00, 0x55), RGB(0x00, 0x00, 0xff), RGB(0x00, 0xaa, 0x55), RGB(0x00, 0xaa, 0xff),
	/*0c*/ RGB(0xaa, 0x00, 0x55), RGB(0xaa, 0x00, 0xff), RGB(0xaa, 0xaa, 0x55), RGB(0xaa, 0xaa, 0xff),
	/*10*/ RGB(0x00, 0x55, 0x00), RGB(0x00, 0x55, 0xaa), RGB(0x00, 0xff, 0x00), RGB(0x00, 0xff, 0xaa),
	/*14*/ RGB(0xaa, 0x55, 0x00), RGB(0xaa, 0x55, 0xaa), RGB(0xaa, 0xff, 0x00), RGB(0xaa, 0xff, 0xaa),
	/*18*/ RGB(0x00, 0x55, 0x55), RGB(0x00, 0x55, 0xff), RGB(0x00, 0xff, 0x55), RGB(0x00, 0xff, 0xff),
	/*1c*/ RGB(0xaa, 0x55, 0x55), RGB(0xaa, 0x55, 0xff), RGB(0xaa, 0xff, 0x55), RGB(0xaa, 0xff, 0xff),
	/*20*/ RGB(0x55, 0x00, 0x00), RGB(0x55, 0x00, 0xaa), RGB(0x55, 0xaa, 0x00), RGB(0x55, 0xaa, 0xaa),
	/*24*/ RGB(0xff, 0x00, 0x00), RGB(0xff, 0x00, 0xaa), RGB(0xff, 0xaa, 0x00), RGB(0xff, 0xaa, 0xaa),
	/*28*/ RGB(0x55, 0x00, 0x55), RGB(0x55, 0x00, 0xff), RGB(0x55, 0xaa, 0x55), RGB(0x55, 0xaa, 0xff),
	/*2c*/ RGB(0xff, 0x00, 0x55), RGB(0xff, 0x00, 0xff), RGB(0xff, 0xaa, 0x55), RGB(0xff, 0xaa, 0xff),
	/*30*/ RGB(0x55, 0x55, 0x00), RGB(0x55, 0x55, 0xaa), RGB(0x55, 0xff, 0x00), RGB(0x55, 0xff, 0xaa),
	/*34*/ RGB(0xff, 0x55, 0x00), RGB(0xff, 0x55, 0xaa), RGB(0xff, 0xff, 0x00), RGB(0xff, 0xff, 0xaa),
	/*38*/ RGB(0x55, 0x55, 0x55), RGB(0x55, 0x55, 0xff), RGB(0x55, 0xff, 0x55), RGB(0x55, 0xff, 0xff),
	/*3c*/ RGB(0xff, 0x55, 0x55), RGB(0xff, 0x55, 0xff), RGB(0xff, 0xff, 0x55), RGB(0xff, 0xff, 0xff),
#undef RGB
};
...
INTERN_CONST uint8_t const basevga_defaultattpal[16] = {
	[0x0] = 0x00, /* RGB(0x00, 0x00, 0x00) */
	[0x1] = 0x04, /* RGB(0xaa, 0x00, 0x00) */
	[0x2] = 0x02, /* RGB(0x00, 0xaa, 0x00) */
	[0x3] = 0x14, /* RGB(0xaa, 0x55, 0x00) */
	[0x4] = 0x01, /* RGB(0x00, 0x00, 0xaa) */
	[0x5] = 0x05, /* RGB(0xaa, 0x00, 0xaa) */
	[0x6] = 0x04, /* RGB(0x00, 0xaa, 0xaa) */
	[0x7] = 0x07, /* RGB(0xaa, 0xaa, 0xaa) */
	[0x8] = 0x38, /* RGB(0x55, 0x55, 0x55) */
	[0x9] = 0x3c, /* RGB(0xff, 0x55, 0x55) */
	[0xa] = 0x3a, /* RGB(0x55, 0xff, 0x55) */
	[0xb] = 0x3e, /* RGB(0xff, 0xff, 0x55) */
	[0xc] = 0x39, /* RGB(0x55, 0x55, 0xff) */
	[0xd] = 0x3d, /* RGB(0xff, 0x55, 0xff) */
	[0xe] = 0x3b, /* RGB(0x55, 0xff, 0xff) */
	[0xf] = 0x3f, /* RGB(0xff, 0xff, 0xff) */
};
