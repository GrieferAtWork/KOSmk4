...
#define RGB(r, g, b) { r >> 2, g >> 2, b >> 2 }
	/* 0 */ RGB(0x00, 0x00, 0x00), RGB(0x00, 0x00, 0xaa), RGB(0x00, 0xaa, 0x00), RGB(0x00, 0xaa, 0xaa),
	/* 4 */ RGB(0xaa, 0x00, 0x00), RGB(0xaa, 0x00, 0xaa), RGB(0xaa, 0x55, 0x00), RGB(0xaa, 0xaa, 0xaa),
	/* 8 */ RGB(0x55, 0x55, 0x55), RGB(0x55, 0x55, 0xff), RGB(0x55, 0xff, 0x55), RGB(0x55, 0xff, 0xff),
	/* c */ RGB(0xff, 0x55, 0x55), RGB(0xff, 0x55, 0xff), RGB(0xff, 0xff, 0x55), RGB(0xff, 0xff, 0xff),
#undef RGB
};
