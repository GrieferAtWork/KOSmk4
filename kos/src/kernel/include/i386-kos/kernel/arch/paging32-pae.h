...
NOTHROW(FCALL pae_npagedir_map)(PAGEDIR_PAGEALIGNED VIRT void *addr,
                                ...
                                u16 perm);
#else /* CONFIG_USE_NEW_PAGING */
INTDEF NOBLOCK void NOTHROW(FCALL pae_pagedir_mapone)(VIRT vm_vpage_t virt_page, PHYS pageptr_t phys_page, u16 perm);
INTDEF NOBLOCK void NOTHROW(FCALL pae_pagedir_map)(VIRT vm_vpage_t virt_page, size_t num_pages, PHYS pageptr_t phys_page, u16 perm);
#endif /* !CONFIG_USE_NEW_PAGING */
...
#else /* CONFIG_USE_NEW_PAGING */
INTDEF NOBLOCK WUNUSED pae_pagedir_pushval_t
NOTHROW(FCALL pae_pagedir_push_mapone)(VIRT vm_vpage_t virt_page, PHYS pageptr_t phys_page, u16 perm);
...
INTDEF NOBLOCK WUNUSED PHYS vm_phys_t NOTHROW(FCALL pae_pagedir_translate)(VIRT void *addr);
