 ...
 * >> .endif
 * >> if (__NR32RC_##name == 0) {
 * >>     DEFINE_INTERN_ALIAS(__x86_asm32_sysrun32_##name, sys32_##name);
 * >> }
 */
...
#define DEFINE_SYSCALL32_0(return_type, name)                                                                      \
	...
	__ARCH_DEFINE_SYSCALL32_COMMON(name);                                                                          \
...
#define DEFINE_SYSCALL0_COMPAT DEFINE_SYSCALL32_0
#define DEFINE_SYSCALL1_COMPAT DEFINE_SYSCALL32_1
#define DEFINE_SYSCALL2_COMPAT DEFINE_SYSCALL32_2
#define DEFINE_SYSCALL3_COMPAT DEFINE_SYSCALL32_3
#define DEFINE_SYSCALL4_COMPAT DEFINE_SYSCALL32_4
#define DEFINE_SYSCALL5_COMPAT DEFINE_SYSCALL32_5
#define DEFINE_SYSCALL6_COMPAT DEFINE_SYSCALL32_6
#else /* __x86_64__ */
