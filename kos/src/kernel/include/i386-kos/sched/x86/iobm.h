...
FUNDEF ATTR_RETNONNULL WUNUSED ATTR_MALLOC REF struct ioperm_bitmap *KCALL
ioperm_bitmap_alloc(void) THROWS(E_BADALLOC);
FUNDEF ATTR_RETNONNULL WUNUSED ATTR_MALLOC NOBLOCK_IF(flags & GFP_ATOMIC)
...
FUNDEF ATTR_RETNONNULL WUNUSED ATTR_MALLOC NOBLOCK_IF(flags & GFP_ATOMIC) REF struct ioperm_bitmap *KCALL
