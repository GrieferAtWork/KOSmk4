...
#define usb_controller_devs_endread(self)      (void)(atomic_rwlock_endread_ex(&(self)->uc_devslock) && (usb_controller_devs_reap(self), 0))
#define _usb_controller_devs_end(self)         atomic_rwlock_end(&(self)->uc_devslock)
#define usb_controller_devs_end(self)          (void)(atomic_rwlock_end_ex(&(self)->uc_devslock) && (usb_controller_devs_reap(self), 0))
