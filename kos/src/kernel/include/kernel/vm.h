...
#define vm_getnodeofaddress(self, addr)                        mman_mappings_locate(self, addr)
#define vm_isused(self, addr, num_bytes)                       (mman_mappings_rlocate(self, addr, (byte_t *)(addr) + (num_bytes)-1) != __NULLPTR)
#define vm_node_insert(self)                                   mman_mappings_insert((self)->mn_mman, self)
#define vm_node_remove(self, addr)                             COMPILER_UNUSED(mman_mappings_remove(self, addr))
