...
#define mfile_vioread(...)                            vm_datablock_vio_read(__VA_ARGS__)
#define mfile_viowrite(...)                           vm_datablock_vio_write(__VA_ARGS__)
#define mfile_vioread_p(...)                          vm_datablock_vio_read_phys(__VA_ARGS__)
#define mfile_viowrite_p(...)                         vm_datablock_vio_write_phys(__VA_ARGS__)
#define mfile_vioreadv(...)                           vm_datablock_vio_readv(__VA_ARGS__)
#define mfile_viowritev(...)                          vm_datablock_vio_writev(__VA_ARGS__)
#define mfile_vioreadv_p(...)                         vm_datablock_vio_readv_phys(__VA_ARGS__)
#define mfile_viowritev_p(...)                        vm_datablock_vio_writev_phys(__VA_ARGS__)
