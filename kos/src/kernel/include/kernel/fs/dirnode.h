...
/* `struct fdirenum' offsets */
#define OFFSET_FDIRENUM_OPS 0
#define OFFSET_FDIRENUM_DIR __SIZEOF_POINTER__
#define SIZEOF_FDIRENUM     (2 * __SIZEOF_POINTER__)
#define ALIGNOF_FDIRENUM    __ALIGNOF_POINTER__
