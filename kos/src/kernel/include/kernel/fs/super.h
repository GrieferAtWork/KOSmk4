...
#define fsuper_nodes_endread(self)      (void)(atomic_rwlock_endread_ex(&(self)->fs_nodeslock) && (fsuper_nodes_reap(self), 0))
#define _fsuper_nodes_end(self)         atomic_rwlock_end(&(self)->fs_nodeslock)
#define fsuper_nodes_end(self)          (void)(atomic_rwlock_end_ex(&(self)->fs_nodeslock) && (fsuper_nodes_reap(self), 0))
...
#define fsuper_mounts_endread(self)      (void)(atomic_rwlock_endread_ex(&(self)->fs_mountslock) && (fsuper_mounts_reap(self), 0))
#define _fsuper_mounts_end(self)         atomic_rwlock_end(&(self)->fs_mountslock)
#define fsuper_mounts_end(self)          (void)(atomic_rwlock_end_ex(&(self)->fs_mountslock) && (fsuper_mounts_reap(self), 0))
