...
#define fnode_asblkpart(self) ((struct blkpart *)(self))
...
#define mfile_isblkpart(self) ((self)->mf_ops == &blkpart_ops.bdo_dev.dfno_node.dno_node.no_file)
...
#define mfile_isblkpart(self) fnode_asblkpart(mfile_asnode(self))
