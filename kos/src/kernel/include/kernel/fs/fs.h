...
#define fs_pathlock_endread(self)      (void)(atomic_rwlock_endread_ex(&(self)->fs_pathlock) && (fs_pathlock_reap(self), 0))
#define _fs_pathlock_end(self)         atomic_rwlock_end(&(self)->fs_pathlock)
#define fs_pathlock_end(self)          (void)(atomic_rwlock_end_ex(&(self)->fs_pathlock) && (fs_pathlock_reap(self), 0))
