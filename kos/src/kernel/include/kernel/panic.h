...
/* Cause kernel panic. */
FUNDEF ATTR_KERNEL_PANIC_NORETURN ATTR_COLD void KCALL kernel_panic_here(void);
...
#ifdef __cplusplus
extern "C++" {
FUNDEF ATTR_KERNEL_PANIC_NORETURN ATTR_COLD void KCALL kernel_panic(void) ASMNAME("kernel_panic_here");
