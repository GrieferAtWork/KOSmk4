 ...
 */
#ifndef GUARD_KERNEL_INCLUDE_KERNEL_MMAN_MM_EVENT_H
#define GUARD_KERNEL_INCLUDE_KERNEL_MMAN_MM_EVENT_H 1
...
#endif /* !GUARD_KERNEL_INCLUDE_KERNEL_MMAN_MM_EVENT_H */
