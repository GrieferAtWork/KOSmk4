...
#define kernel_uvio_request_endread(self)      (void)(atomic_rwlock_endread_ex(&(self)->kur_lock) && (kernel_uvio_request_reap(self), 0))
#define _kernel_uvio_request_end(self)         atomic_rwlock_end(&(self)->kur_lock)
#define kernel_uvio_request_end(self)          (void)(atomic_rwlock_end_ex(&(self)->kur_lock) && (kernel_uvio_request_reap(self), 0))
