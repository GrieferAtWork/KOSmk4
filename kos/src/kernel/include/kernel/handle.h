...
#define handle_get_datablock(fd)        ((REF struct vm_datablock *)handle_getas(fd, HANDLE_TYPE_MFILE))
...
#define handle_get_vm(fd)               ((REF struct vm *)handle_getas(fd, HANDLE_TYPE_MMAN))
...
#define handle_as_vm(self)               ((REF struct vm *)handle_as(self, HANDLE_TYPE_MMAN))
