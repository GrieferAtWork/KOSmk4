...
/* Stuff needed for:
 * - TODO: clock_settime(2)
 * - clock_gettime(2)
 * - clock_getres(2)
 * - clock_nanosleep(2)
 * - TODO: timer_create(2)
 * - TODO: timer_delete(2)
 * - TODO: timer_getoverrun(2)
 * - TODO: timer_gettime(2)
 * - TODO: timer_settime(2)
 * - TODO: alarm(2)
 * - TODO: getitimer(2)
 * - TODO: setitimer(2)
 * - timerfd_create(2)
...
#define timer_endread(self)      (void)(atomic_rwlock_endread_ex(&(self)->t_lock) && (timer_reap(self), 0))
#define _timer_end(self)         atomic_rwlock_end(&(self)->t_lock)
#define timer_end(self)          (void)(atomic_rwlock_end_ex(&(self)->t_lock) && (timer_reap(self), 0))
