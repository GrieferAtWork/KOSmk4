 ...
 */
/*!always_includes <kos/capability.h>*/
...
#define cred_endread(self)      (void)(atomic_rwlock_endread_ex(&(self)->c_lock) && (cred_reap(self), 0))
#define _cred_end(self)         atomic_rwlock_end(&(self)->c_lock)
#define cred_end(self)          (void)(atomic_rwlock_end_ex(&(self)->c_lock) && (cred_reap(self), 0))
