...
#define pidns_endread(self)      (void)(atomic_rwlock_endread_ex(&(self)->pn_lock) && (pidns_reap(self), 0))
#define _pidns_end(self)         atomic_rwlock_end(&(self)->pn_lock)
#define pidns_end(self)          (void)(atomic_rwlock_end_ex(&(self)->pn_lock) && (pidns_reap(self), 0))
