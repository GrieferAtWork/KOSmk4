 ...
 */
#ifndef GUARD_MODGDBSERVER_MEMORY_CRC32_C
#define GUARD_MODGDBSERVER_MEMORY_CRC32_C 1
...
INTERN ATTR_PURE WUNUSED u32 FCALL
...
#endif /* !GUARD_MODGDBSERVER_MEMORY_CRC32_C */
