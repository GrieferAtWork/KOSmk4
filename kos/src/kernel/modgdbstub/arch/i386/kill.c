 ...
 */
#ifndef GUARD_MODGDB_ARCH_I386_KILL_C
#define GUARD_MODGDB_ARCH_I386_KILL_C 1
...
INTERN ATTR_NORETURN void NOTHROW(FCALL GDB_KillKernel)(void) {
...
#endif /* !GUARD_MODGDB_ARCH_I386_KILL_C */
