...
struct ms_scsi_controller {
	WEAK refcnt_t              scsi_refcnt; /* Reference counter. */
	REF struct usb_controller *scsi_ctrl;   /* [1..1][const] The associated USB controller. */
	REF struct usb_endpoint   *scsi_in;     /* [1..1][const] Input endpoint (for reading from the device) */
	REF struct usb_endpoint   *scsi_out;    /* [1..1][const] Output endpoint (for writing to the device) */
};
