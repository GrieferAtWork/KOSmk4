...
DEFINE_SYSCALL1(ssize_t, select,
	...
	USER UNCHECKED fd_set *inp;           /* Read fd-set */
	USER UNCHECKED fd_set *outp;          /* Write fd-set */
	USER UNCHECKED fd_set *exp;           /* Except fd-set */
	USER UNCHECKED struct timeval32 *tvp; /* Timeout argument */
