...
INTERN BLOCKING WUNUSED NONNULL((1)) ATTR_SECTION(".text.kernel.handle_undefined.read") size_t KCALL handle_undefined_read(void *__restrict UNUSED(self), NCX void *UNUSED(dst), size_t UNUSED(num_bytes), iomode_t UNUSED(mode)) THROWS(...) { THROW(E_FSERROR_UNSUPPORTED_OPERATION, E_FILESYSTEM_OPERATION_READ); }
INTERN BLOCKING NONNULL((1)) ATTR_SECTION(".text.kernel.handle_undefined.write") size_t KCALL handle_undefined_write(void *__restrict UNUSED(self), NCX void const *UNUSED(src), size_t UNUSED(num_bytes), iomode_t UNUSED(mode)) THROWS(...) { THROW(E_FSERROR_UNSUPPORTED_OPERATION, E_FILESYSTEM_OPERATION_WRITE); }
INTERN BLOCKING WUNUSED NONNULL((1)) ATTR_SECTION(".text.kernel.handle_undefined.pread") size_t KCALL handle_undefined_pread(void *__restrict UNUSED(self), NCX void *UNUSED(dst), size_t UNUSED(num_bytes), pos_t UNUSED(addr), iomode_t UNUSED(mode)) THROWS(...) { THROW(E_FSERROR_UNSUPPORTED_OPERATION, E_FILESYSTEM_OPERATION_PREAD); }
INTERN BLOCKING NONNULL((1)) ATTR_SECTION(".text.kernel.handle_undefined.pwrite") size_t KCALL handle_undefined_pwrite(void *__restrict UNUSED(self), NCX void const *UNUSED(src), size_t UNUSED(num_bytes), pos_t UNUSED(addr), iomode_t UNUSED(mode)) THROWS(...) { THROW(E_FSERROR_UNSUPPORTED_OPERATION, E_FILESYSTEM_OPERATION_PWRITE); }
...
INTERN BLOCKING NONNULL((1)) ATTR_SECTION(".text.kernel.handle_undefined.ioctl") syscall_slong_t KCALL handle_undefined_ioctl(void *__restrict UNUSED(self), ioctl_t cmd, NCX UNCHECKED void *UNUSED(arg), iomode_t UNUSED(mode)) THROWS(...) { THROW(E_INVALID_ARGUMENT_UNKNOWN_COMMAND, E_INVALID_ARGUMENT_CONTEXT_IOCTL_COMMAND, cmd); }
...
PUBLIC_CONST struct handle_types const handle_type_db = {
	...
	.h_read = {
		[HANDLE_TYPE_UNDEFINED]       = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_undefined_read,
		[HANDLE_TYPE_MFILE]           = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_mfile_read,
		[HANDLE_TYPE_DIRENT]          = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_dirent_read,
		[HANDLE_TYPE_PATH]            = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_path_read,
		[HANDLE_TYPE_FILEHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_filehandle_read,
		[HANDLE_TYPE_TEMPHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_temphandle_read,
		[HANDLE_TYPE_DIRHANDLE]       = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_dirhandle_read,
		[HANDLE_TYPE_FIFOHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_fifohandle_read,
		[HANDLE_TYPE_SOCKET]          = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_socket_read,
		[HANDLE_TYPE_EPOLL]           = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_epoll_read,
		[HANDLE_TYPE_PIPE]            = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_pipe_read,
		[HANDLE_TYPE_PIPE_READER]     = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_pipe_reader_read,
		[HANDLE_TYPE_PIPE_WRITER]     = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_pipe_writer_read,
		[HANDLE_TYPE_EVENTFD_FENCE]   = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_eventfd_fence_read,
		[HANDLE_TYPE_EVENTFD_SEMA]    = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_eventfd_sema_read,
		[HANDLE_TYPE_SIGNALFD]        = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_signalfd_read,
		[HANDLE_TYPE_FUTEXFD]         = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_futexfd_read,
		[HANDLE_TYPE_PIDFD]           = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_pidfd_read,
		[HANDLE_TYPE_MODULE]          = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_module_read,
		[HANDLE_TYPE_DRIVER_LOADLIST] = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_driver_loadlist_read,
		[HANDLE_TYPE_REFCOUNTABLE]    = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_refcountable_read,
		[HANDLE_TYPE_NOTIFYFD]        = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_notifyfd_read,
		[HANDLE_TYPE_DIRHANDLEX]      = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_dirhandlex_read,
		[HANDLE_TYPE_TIMERFD]         = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, iomode_t))&handle_timerfd_read
	},
	.h_write = {
		[HANDLE_TYPE_UNDEFINED]       = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_undefined_write,
		[HANDLE_TYPE_MFILE]           = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_mfile_write,
		[HANDLE_TYPE_DIRENT]          = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_dirent_write,
		[HANDLE_TYPE_PATH]            = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_path_write,
		[HANDLE_TYPE_FILEHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_filehandle_write,
		[HANDLE_TYPE_TEMPHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_temphandle_write,
		[HANDLE_TYPE_DIRHANDLE]       = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_dirhandle_write,
		[HANDLE_TYPE_FIFOHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_fifohandle_write,
		[HANDLE_TYPE_SOCKET]          = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_socket_write,
		[HANDLE_TYPE_EPOLL]           = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_epoll_write,
		[HANDLE_TYPE_PIPE]            = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_pipe_write,
		[HANDLE_TYPE_PIPE_READER]     = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_pipe_reader_write,
		[HANDLE_TYPE_PIPE_WRITER]     = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_pipe_writer_write,
		[HANDLE_TYPE_EVENTFD_FENCE]   = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_eventfd_fence_write,
		[HANDLE_TYPE_EVENTFD_SEMA]    = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_eventfd_sema_write,
		[HANDLE_TYPE_SIGNALFD]        = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_signalfd_write,
		[HANDLE_TYPE_FUTEXFD]         = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_futexfd_write,
		[HANDLE_TYPE_PIDFD]           = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_pidfd_write,
		[HANDLE_TYPE_MODULE]          = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_module_write,
		[HANDLE_TYPE_DRIVER_LOADLIST] = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_driver_loadlist_write,
		[HANDLE_TYPE_REFCOUNTABLE]    = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_refcountable_write,
		[HANDLE_TYPE_NOTIFYFD]        = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_notifyfd_write,
		[HANDLE_TYPE_DIRHANDLEX]      = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_dirhandlex_write,
		[HANDLE_TYPE_TIMERFD]         = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, iomode_t))&handle_timerfd_write
	},
	.h_pread = {
		[HANDLE_TYPE_UNDEFINED]       = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_undefined_pread,
		[HANDLE_TYPE_MFILE]           = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_mfile_pread,
		[HANDLE_TYPE_DIRENT]          = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_dirent_pread,
		[HANDLE_TYPE_PATH]            = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_path_pread,
		[HANDLE_TYPE_FILEHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_filehandle_pread,
		[HANDLE_TYPE_TEMPHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_temphandle_pread,
		[HANDLE_TYPE_DIRHANDLE]       = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_dirhandle_pread,
		[HANDLE_TYPE_FIFOHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_fifohandle_pread,
		[HANDLE_TYPE_SOCKET]          = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_socket_pread,
		[HANDLE_TYPE_EPOLL]           = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_epoll_pread,
		[HANDLE_TYPE_PIPE]            = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_pipe_pread,
		[HANDLE_TYPE_PIPE_READER]     = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_pipe_reader_pread,
		[HANDLE_TYPE_PIPE_WRITER]     = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_pipe_writer_pread,
		[HANDLE_TYPE_EVENTFD_FENCE]   = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_eventfd_fence_pread,
		[HANDLE_TYPE_EVENTFD_SEMA]    = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_eventfd_sema_pread,
		[HANDLE_TYPE_SIGNALFD]        = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_signalfd_pread,
		[HANDLE_TYPE_FUTEXFD]         = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_futexfd_pread,
		[HANDLE_TYPE_PIDFD]           = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_pidfd_pread,
		[HANDLE_TYPE_MODULE]          = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_module_pread,
		[HANDLE_TYPE_DRIVER_LOADLIST] = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_driver_loadlist_pread,
		[HANDLE_TYPE_REFCOUNTABLE]    = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_refcountable_pread,
		[HANDLE_TYPE_NOTIFYFD]        = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_notifyfd_pread,
		[HANDLE_TYPE_DIRHANDLEX]      = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_dirhandlex_pread,
		[HANDLE_TYPE_TIMERFD]         = (size_t (KCALL *)(void *__restrict, NCX void *, size_t, pos_t, iomode_t))&handle_timerfd_pread
	},
	.h_pwrite = {
		[HANDLE_TYPE_UNDEFINED]       = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_undefined_pwrite,
		[HANDLE_TYPE_MFILE]           = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_mfile_pwrite,
		[HANDLE_TYPE_DIRENT]          = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_dirent_pwrite,
		[HANDLE_TYPE_PATH]            = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_path_pwrite,
		[HANDLE_TYPE_FILEHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_filehandle_pwrite,
		[HANDLE_TYPE_TEMPHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_temphandle_pwrite,
		[HANDLE_TYPE_DIRHANDLE]       = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_dirhandle_pwrite,
		[HANDLE_TYPE_FIFOHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_fifohandle_pwrite,
		[HANDLE_TYPE_SOCKET]          = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_socket_pwrite,
		[HANDLE_TYPE_EPOLL]           = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_epoll_pwrite,
		[HANDLE_TYPE_PIPE]            = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_pipe_pwrite,
		[HANDLE_TYPE_PIPE_READER]     = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_pipe_reader_pwrite,
		[HANDLE_TYPE_PIPE_WRITER]     = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_pipe_writer_pwrite,
		[HANDLE_TYPE_EVENTFD_FENCE]   = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_eventfd_fence_pwrite,
		[HANDLE_TYPE_EVENTFD_SEMA]    = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_eventfd_sema_pwrite,
		[HANDLE_TYPE_SIGNALFD]        = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_signalfd_pwrite,
		[HANDLE_TYPE_FUTEXFD]         = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_futexfd_pwrite,
		[HANDLE_TYPE_PIDFD]           = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_pidfd_pwrite,
		[HANDLE_TYPE_MODULE]          = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_module_pwrite,
		[HANDLE_TYPE_DRIVER_LOADLIST] = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_driver_loadlist_pwrite,
		[HANDLE_TYPE_REFCOUNTABLE]    = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_refcountable_pwrite,
		[HANDLE_TYPE_NOTIFYFD]        = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_notifyfd_pwrite,
		[HANDLE_TYPE_DIRHANDLEX]      = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_dirhandlex_pwrite,
		[HANDLE_TYPE_TIMERFD]         = (size_t (KCALL *)(void *__restrict, NCX void const *, size_t, pos_t, iomode_t))&handle_timerfd_pwrite
	},
	.h_readv = {
	...
	.h_readdir = {
		[HANDLE_TYPE_UNDEFINED]       = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_undefined_readdir,
		[HANDLE_TYPE_MFILE]           = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_mfile_readdir,
		[HANDLE_TYPE_DIRENT]          = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_dirent_readdir,
		[HANDLE_TYPE_PATH]            = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_path_readdir,
		[HANDLE_TYPE_FILEHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_filehandle_readdir,
		[HANDLE_TYPE_TEMPHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_temphandle_readdir,
		[HANDLE_TYPE_DIRHANDLE]       = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_dirhandle_readdir,
		[HANDLE_TYPE_FIFOHANDLE]      = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_fifohandle_readdir,
		[HANDLE_TYPE_SOCKET]          = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_socket_readdir,
		[HANDLE_TYPE_EPOLL]           = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_epoll_readdir,
		[HANDLE_TYPE_PIPE]            = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_pipe_readdir,
		[HANDLE_TYPE_PIPE_READER]     = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_pipe_reader_readdir,
		[HANDLE_TYPE_PIPE_WRITER]     = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_pipe_writer_readdir,
		[HANDLE_TYPE_EVENTFD_FENCE]   = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_eventfd_fence_readdir,
		[HANDLE_TYPE_EVENTFD_SEMA]    = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_eventfd_sema_readdir,
		[HANDLE_TYPE_SIGNALFD]        = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_signalfd_readdir,
		[HANDLE_TYPE_FUTEXFD]         = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_futexfd_readdir,
		[HANDLE_TYPE_PIDFD]           = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_pidfd_readdir,
		[HANDLE_TYPE_MODULE]          = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_module_readdir,
		[HANDLE_TYPE_DRIVER_LOADLIST] = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_driver_loadlist_readdir,
		[HANDLE_TYPE_REFCOUNTABLE]    = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_refcountable_readdir,
		[HANDLE_TYPE_NOTIFYFD]        = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_notifyfd_readdir,
		[HANDLE_TYPE_DIRHANDLEX]      = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_dirhandlex_readdir,
		[HANDLE_TYPE_TIMERFD]         = (size_t (KCALL *)(void *__restrict, NCX struct dirent *, size_t, readdir_mode_t, iomode_t))&handle_timerfd_readdir
	},
	.h_seek = {
	...
	.h_ioctl = {
		[HANDLE_TYPE_UNDEFINED]       = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_undefined_ioctl,
		[HANDLE_TYPE_MFILE]           = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_mfile_ioctl,
		[HANDLE_TYPE_DIRENT]          = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_dirent_ioctl,
		[HANDLE_TYPE_PATH]            = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_path_ioctl,
		[HANDLE_TYPE_FILEHANDLE]      = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_filehandle_ioctl,
		[HANDLE_TYPE_TEMPHANDLE]      = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_temphandle_ioctl,
		[HANDLE_TYPE_DIRHANDLE]       = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_dirhandle_ioctl,
		[HANDLE_TYPE_FIFOHANDLE]      = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_fifohandle_ioctl,
		[HANDLE_TYPE_SOCKET]          = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_socket_ioctl,
		[HANDLE_TYPE_EPOLL]           = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_epoll_ioctl,
		[HANDLE_TYPE_PIPE]            = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_pipe_ioctl,
		[HANDLE_TYPE_PIPE_READER]     = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_pipe_reader_ioctl,
		[HANDLE_TYPE_PIPE_WRITER]     = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_pipe_writer_ioctl,
		[HANDLE_TYPE_EVENTFD_FENCE]   = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_eventfd_fence_ioctl,
		[HANDLE_TYPE_EVENTFD_SEMA]    = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_eventfd_sema_ioctl,
		[HANDLE_TYPE_SIGNALFD]        = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_signalfd_ioctl,
		[HANDLE_TYPE_FUTEXFD]         = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_futexfd_ioctl,
		[HANDLE_TYPE_PIDFD]           = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_pidfd_ioctl,
		[HANDLE_TYPE_MODULE]          = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_module_ioctl,
		[HANDLE_TYPE_DRIVER_LOADLIST] = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_driver_loadlist_ioctl,
		[HANDLE_TYPE_REFCOUNTABLE]    = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_refcountable_ioctl,
		[HANDLE_TYPE_NOTIFYFD]        = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_notifyfd_ioctl,
		[HANDLE_TYPE_DIRHANDLEX]      = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_dirhandlex_ioctl,
		[HANDLE_TYPE_TIMERFD]         = (syscall_slong_t (KCALL *)(void *__restrict, ioctl_t, NCX UNCHECKED void *, iomode_t))&handle_timerfd_ioctl
	},
	.h_truncate = {
	...
	.h_stat = {
		[HANDLE_TYPE_UNDEFINED]       = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_undefined_stat,
		[HANDLE_TYPE_MFILE]           = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_mfile_stat,
		[HANDLE_TYPE_DIRENT]          = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_dirent_stat,
		[HANDLE_TYPE_PATH]            = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_path_stat,
		[HANDLE_TYPE_FILEHANDLE]      = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_filehandle_stat,
		[HANDLE_TYPE_TEMPHANDLE]      = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_temphandle_stat,
		[HANDLE_TYPE_DIRHANDLE]       = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_dirhandle_stat,
		[HANDLE_TYPE_FIFOHANDLE]      = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_fifohandle_stat,
		[HANDLE_TYPE_SOCKET]          = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_socket_stat,
		[HANDLE_TYPE_EPOLL]           = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_epoll_stat,
		[HANDLE_TYPE_PIPE]            = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_pipe_stat,
		[HANDLE_TYPE_PIPE_READER]     = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_pipe_reader_stat,
		[HANDLE_TYPE_PIPE_WRITER]     = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_pipe_writer_stat,
		[HANDLE_TYPE_EVENTFD_FENCE]   = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_eventfd_fence_stat,
		[HANDLE_TYPE_EVENTFD_SEMA]    = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_eventfd_sema_stat,
		[HANDLE_TYPE_SIGNALFD]        = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_signalfd_stat,
		[HANDLE_TYPE_FUTEXFD]         = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_futexfd_stat,
		[HANDLE_TYPE_PIDFD]           = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_pidfd_stat,
		[HANDLE_TYPE_MODULE]          = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_module_stat,
		[HANDLE_TYPE_DRIVER_LOADLIST] = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_driver_loadlist_stat,
		[HANDLE_TYPE_REFCOUNTABLE]    = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_refcountable_stat,
		[HANDLE_TYPE_NOTIFYFD]        = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_notifyfd_stat,
		[HANDLE_TYPE_DIRHANDLEX]      = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_dirhandlex_stat,
		[HANDLE_TYPE_TIMERFD]         = (void (KCALL *)(void *__restrict, NCX struct stat *))&handle_timerfd_stat
	},
	.h_pollconnect = {
