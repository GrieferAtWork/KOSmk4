 ...
 */
#ifndef GUARD_KERNEL_SRC_DEV_AT_SCANCODES_H
#define GUARD_KERNEL_SRC_DEV_AT_SCANCODES_H 1
 ...
 * currently always 0. */
INTDEF uint16_t const at_scancodes[256];

DECL_END

#endif /* !GUARD_KERNEL_SRC_DEV_AT_SCANCODES_H */
