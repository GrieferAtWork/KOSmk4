 ...
 */
#ifndef GUARD_KERNEL_CORE_ARCH_I386_HW_BOUND_C
#define GUARD_KERNEL_CORE_ARCH_I386_HW_BOUND_C 1
...
x86_handle_bound_range(struct icpustate *__restrict state) {
	...
	PERTASK_SET(_this_exception_info.ei_data.e_pointers[0], bound_index);
	PERTASK_SET(_this_exception_info.ei_data.e_pointers[1], bound_min);
	PERTASK_SET(_this_exception_info.ei_data.e_pointers[2], bound_max);
	{
		unsigned int i;
...
#endif /* !GUARD_KERNEL_CORE_ARCH_I386_HW_BOUND_C */
