...
#define page_mallocone_noblock_for_paging(...)           page_mallocone_noblock_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_mallocone_nocc_for_paging(...)              page_mallocone_nocc_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_for_paging(...)                      page_malloc_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_noblock_for_paging(...)              page_malloc_noblock_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_nocc_for_paging(...)                 page_malloc_nocc_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_part_for_paging(...)                 page_malloc_part_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_part_noblock_for_paging(...)         page_malloc_part_noblock_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_part_nocc_for_paging(...)            page_malloc_part_nocc_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_at_for_paging(...)                   page_malloc_at_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_at_noblock_for_paging(...)           page_malloc_at_noblock_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_at_nocc_for_paging(...)              page_malloc_at_nocc_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_between_for_paging(...)              page_malloc_between_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_between_noblock_for_paging(...)      page_malloc_between_noblock_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_between_nocc_for_paging(...)         page_malloc_between_nocc_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_part_between_for_paging(...)         page_malloc_part_between_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_part_between_noblock_for_paging(...) page_malloc_part_between_noblock_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc_part_between_nocc_for_paging(...)    page_malloc_part_between_nocc_for(page_usage.pu_paging, ##__VA_ARGS__)
...
#define page_malloc32_noblock_for_paging(...)            page_malloc32_noblock_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_malloc32_nocc_for_paging(...)               page_malloc32_nocc_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_mallocone32_for_paging(...)                 page_mallocone32_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_mallocone32_noblock_for_paging(...)         page_mallocone32_noblock_for(page_usage.pu_paging, ##__VA_ARGS__)
#define page_mallocone32_nocc_for_paging(...)            page_mallocone32_nocc_for(page_usage.pu_paging, ##__VA_ARGS__)
