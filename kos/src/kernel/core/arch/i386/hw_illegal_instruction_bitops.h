 ...
 */
#ifndef GUARD_KERNEL_CORE_ARCH_I386_HW_ILLEGAL_INSTRUCTION_BITOPS_H
#define GUARD_KERNEL_CORE_ARCH_I386_HW_ILLEGAL_INSTRUCTION_BITOPS_H 1
...
#endif /* !GUARD_KERNEL_CORE_ARCH_I386_HW_ILLEGAL_INSTRUCTION_BITOPS_H */
