...
#ifdef __x86_64__
	[0] = { { .s_u = (uintptr_t)__x86_ldt_lcall7_main_lo } },
	[1] = { { .s_u = (uintptr_t)__x86_ldt_lcall7_main_hi } },
#else /* __x86_64__ */
	[0] = { { { (uintptr_t)__x86_ldt_lcall7_main_lo, (uintptr_t)__x86_ldt_lcall7_main_hi } } }
#endif /* !__x86_64__ */
};
...
{
	uintptr_t offset;
	/* Assign a random (pointer-aligned) offset into kernel-space as the base
	 * address for the userkern segment. */
	offset = (uintptr_t)(krand() * USERKERN_SEGMENT_ALIGN);
	offset %= (VM_PAGE2ADDR(KERNEL_NUM_PAGES) - (USERKERN_SYSCALL_MAXVALID + 1));
