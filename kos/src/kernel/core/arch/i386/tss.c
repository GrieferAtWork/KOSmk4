 ...
 */
#ifndef GUARD_KERNEL_CORE_ARCH_I386_TSS_C
#define GUARD_KERNEL_CORE_ARCH_I386_TSS_C 1
...
#ifndef __x86_64__
INTDEF void ASMCALL __x86_defisr_double_fault(void);
...
PUBLIC ATTR_PERCPU struct tss x86_cputss_df = {
	...
	.__t_zero3    = 0,
	.t_cr3        = (u32)(uintptr_t)&pagedir_kernel_phys,
	.t_eip        = (u32)(uintptr_t)&__x86_defisr_double_fault,
	.t_eflags     = 0,
	.t_eax        = 0,
	.t_ecx        = 0,
...
#endif /* !GUARD_KERNEL_CORE_ARCH_I386_TSS_C */
