...
NOTHROW(KCALL __i386_kernel_main)(struct icpustate *__restrict state) {
	...
	/* TODO: Kernel memory leak:
	 * $ /sbin/blockdev --rereadpt /dev/hda    # Running this twice...
	 * $ /sbin/blockdev --rereadpt /dev/hda
	 * $ leaks                                 # Causes memory leaks
	 *
	 * >> ============= 2 Memory leaks
	 * >> Leaked 396 bytes of kmalloc-memory at E2001700...E200188B [tid=7] (Referenced 1 times)
	 * >> 	Referenced at [E101CE78]=E2001700 by leak at E101CE78...E101CE9F
	 * >> /kos/src/kernel/include/kernel/malloc.h(178,20) : kmalloc+6 : C026F130+5 : Allocated here
	 * >> /kos/src/kernel/core/filesys/blkdev.c(347,32) : blkdev_makeparts_create+52 : C026F12A+12 : Allocated here
	 * >> /kos/src/kernel/core/filesys/blkdev.c(880,33) : blkdev_makeparts_from_mbr+1818 : C0271158+5 : Called here
	 * >> /kos/src/kernel/core/filesys/blkdev.c(919,27) : blkdev_makeparts_loadmbr+282 : C0271338+5 : Called here
	 * >> /kos/src/kernel/core/filesys/blkdev.c(953,28) : blkdev_makeparts+232 : C027143A+5 : Called here
	 * >> /kos/src/kernel/core/filesys/blkdev.c(1199,41) : blkdev_repart+75 : C0272011+5 : Called here
	 * >> E2001700 01 00 00 00 20 8C 41 C0 00 00 00 00 AA AA AA AA .... .A.........
	 * >> E2001710 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ................
	 * >> E2001720 FF 0F 00 00 09 01 AA AA 00 00 08 60 00 00 00 00 ...........`....
	 * >> E2001730 00 00 00 20 00 00 00 00 95 4B 47 62 00 00 00 00 ... .....KGb....
	 * >> E2001740 EE BA 0F 1E 04 00 00 00 95 4B 47 62 00 00 00 00 .........KGb....
	 * >> E2001750 EE BA 0F 1E 04 00 00 00 95 4B 47 62 00 00 00 00 .........KGb....
	 * >> E2001760 EE BA 0F 1E 04 00 00 00 95 4B 47 62 00 00 00 00 .........KGb....
	 * >> E2001770 EE BA 0F 1E 04 00 00 00 01 00 00 00 A4 61 00 00 .............a..
	 * >> E2001780 00 00 00 00 00 00 00 00 0F 00 80 01 00 00 00 80 ................
	 * >> E2001790 C0 92 83 C0 CC CC CC CC 00 00 00 00 00 00 00 00 ................
	 * >> E20017A0 FF FF FF FF CC CC CC CC 00 00 00 00 AA AA AA AA ................
	 * >> E20017B0 01 00 30 00 00 00 00 00 60 75 83 C0 78 CE 01 E1 ..0.....`u..x...
	 * >> E20017C0 04 C7 01 E2 FF FF FF FF 00 00 00 00 BC BD 01 E2 ................
	 * >> E20017D0 CC CC CC CC 00 00 00 00 AA AA AA AA 00 00 00 00 ................
	 * >> E20017E0 00 00 00 00 00 00 00 00 FF 00 CC CC CC CC CC CC ................
	 * >> E20017F0 CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC ................
	 * >> E2001800 CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC ................
	 * >> E2001810 CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC ................
	 * >> E2001820 CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC ................
	 * >> E2001830 CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC ................
	 * >> E2001840 CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC ................
	 * >> E2001850 CC CC CC CC CC CC 00 AA 00 00 00 00 00 00 00 00 ................
	 * >> E2001860 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ................
	 * >> E2001870 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ................
	 * >> E2001880 AA AA AA AA AA AA AA AA AA AA AA AA             ............
	 * >>
	 * >> Leaked 40 bytes of kmalloc-memory at E101CE78...E101CE9F [tid=7] (Referenced 1 times)
	 * >> 	Referenced at [E20017BC]=E101CE78 by leak at E2001700...E200188B [.+0xbc]
	 * >> /kos/src/kernel/include/kernel/malloc.h(178,20) : kmalloc+6 : C0271550+5 : Allocated here
	 * >> /kos/src/kernel/core/filesys/blkdev.c(975,46) : blkdev_makeparts+504 : C027154A+12 : Allocated here
	 * >> /kos/src/kernel/core/filesys/blkdev.c(1199,41) : blkdev_repart+75 : C0272011+5 : Called here
	 * >> /kos/src/kernel/core/filesys/blkdev.c(242,16) : blkdev_v_ioctl+58 : C026ED50+5 : Called here
	 * >> /kos/src/kernel/core/memory/mman/mfile-handle.c(892,21) : handle_mfile_ioctl+74 : C01C0455+2 : Called here
	 * >> E101CE78 00 17 00 E2 00 00 00 00 01 00 00 00 14 A6 41 C0 ..............A.
	 * >> E101CE88 0F 00 80 01 00 00 00 80 A8 87 6C BC 04 00 06 68 ..........l....h
	 * >> E101CE98 64 61 31 00 AA AA AA AA                         da1.....
	 *
	 */
