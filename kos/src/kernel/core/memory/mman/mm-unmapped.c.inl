...
#define LOCAL_mnode                   mbnode
#define LOCAL_mnode_tree_locate       mbnode_tree_locate
#define LOCAL_mnode_tree_rlocate      mbnode_tree_rlocate
#define LOCAL_mnode_tree_insert       mbnode_tree_insert
#define LOCAL_mnode_tree_tryinsert    mbnode_tree_tryinsert
#define LOCAL_mnode_tree_remove       mbnode_tree_remove
#define LOCAL_mnode_tree_rremove      mbnode_tree_rremove
#define LOCAL_mnode_tree_removenode   mbnode_tree_removenode
#define LOCAL_mnode_tree_prevnode     mbnode_tree_prevnode
#define LOCAL_mnode_tree_nextnode     mbnode_tree_nextnode
#define LOCAL_mnode_tree_minmax       mbnode_tree_minmax
#define LOCAL_mnode_tree_minmaxlocate mbnode_tree_minmaxlocate
#define LOCAL_mnode_getminaddr        mbnode_getminaddr
#define LOCAL_mnode_getmaxaddr        mbnode_getmaxaddr
#define LOCAL_mnode_getendaddr        mbnode_getendaddr
#define LOCAL_mnode_getaddr           mbnode_getaddr
#define LOCAL_mnode_getsize           mbnode_getsize
#define LOCAL_mnode_iskern            mbnode_iskern
#define LOCAL_mnode_isuser            mbnode_isuser
#define LOCAL_mnode_getmapminaddr     mbnode_getmapminaddr
#define LOCAL_mnode_getmapmaxaddr     mbnode_getmapmaxaddr
#define LOCAL_mnode_getmapendaddr     mbnode_getmapendaddr
