...
#ifdef CONFIG_HAVE_KERNEL_SLAB_ALLOCATORS
#ifdef POISON_HEAP_CONFIG_NEED_ZERO_FUNCTIONS
#define DEFINE_PH_SLAB_MALLOC_FUNCTIONS(sz, _) \
	INTDEF ATTR_CONST void *NOTHROW(KCALL ph_slab_malloc##sz)(gfp_t flags);
SLAB_FOREACH_SIZE(DEFINE_PH_SLAB_MALLOC_FUNCTIONS, _)
#undef DEFINE_PH_SLAB_MALLOC_FUNCTIONS
#endif /* POISON_HEAP_CONFIG_NEED_ZERO_FUNCTIONS */
#define DEFINE_PH_SLAB_KMALLOC_FUNCTIONS(sz, _)                          \
...
SLAB_FOREACH_SIZE(DEFINE_PH_SLAB_KMALLOC_FUNCTIONS, _)
#undef DEFINE_PH_SLAB_KMALLOC_FUNCTIONS
#endif /* CONFIG_HAVE_KERNEL_SLAB_ALLOCATORS */
...
#endif /* POISON_HEAP_CONFIG_NEED_VOID_FUNCTIONS */
#ifdef CONFIG_HAVE_KERNEL_TRACE_MALLOC
INTDEF ATTR_CONST ATTR_RETNONNULL WUNUSED void *KCALL
ph_kmalloc_trace(void *base, size_t num_bytes, gfp_t gfp, unsigned int tb_skip);
...
#ifdef CONFIG_HAVE_KERNEL_SLAB_ALLOCATORS
#ifdef POISON_HEAP_CONFIG_NEED_ZERO_FUNCTIONS
#define DEFINE_PH_SLAB_MALLOC_FUNCTIONS_IMPL(sz, _)          \
	INTERN ATTR_CONST ATTR_COLDTEXT void *                   \
	NOTHROW(KCALL ph_slab_malloc##sz)(gfp_t UNUSED(flags)) { \
		return NULL;                                         \
	}
SLAB_FOREACH_SIZE(DEFINE_PH_SLAB_MALLOC_FUNCTIONS_IMPL, _)
#undef DEFINE_PH_SLAB_MALLOC_FUNCTIONS_IMPL
#endif /* POISON_HEAP_CONFIG_NEED_ZERO_FUNCTIONS */
#define DEFINE_PH_SLAB_KMALLOC_FUNCTIONS_IMPL(sz, _)     \
...
SLAB_FOREACH_SIZE(DEFINE_PH_SLAB_KMALLOC_FUNCTIONS_IMPL, _)
#undef DEFINE_PH_SLAB_KMALLOC_FUNCTIONS_IMPL
#endif /* CONFIG_HAVE_KERNEL_SLAB_ALLOCATORS */
...
#ifdef CONFIG_HAVE_KERNEL_TRACE_MALLOC
DEFINE_INTERN_ALIAS(ph_kmalloc_trace, ph_kmalloc_trace_nx);
