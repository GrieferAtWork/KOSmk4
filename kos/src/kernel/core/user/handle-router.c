...
INTERN WUNUSED NONNULL((1, 2)) ATTR_SECTION(".text.kernel.handle_undefined.preadv") size_t KCALL handle_undefined_preadv(void *__restrict UNUSED(self), struct iov_buffer *__restrict UNUSED(dst), size_t UNUSED(num_bytes), pos_t UNUSED(addr), iomode_t UNUSED(mode)) THROWS(...) { THROW(E_FSERROR_UNSUPPORTED_OPERATION, E_FILESYSTEM_OPERATION_READ); }
INTERN WUNUSED NONNULL((1, 2)) ATTR_SECTION(".text.kernel.handle_undefined.pwritev") size_t KCALL handle_undefined_pwritev(void *__restrict UNUSED(self), struct iov_buffer *__restrict UNUSED(src), size_t UNUSED(num_bytes), pos_t UNUSED(addr), iomode_t UNUSED(mode)) THROWS(...) { THROW(E_FSERROR_UNSUPPORTED_OPERATION, E_FILESYSTEM_OPERATION_WRITE); }
...
PUBLIC_CONST struct handle_types const handle_type_db = {
	...
	/* .h_readv = */ {
		...
		/* [HANDLE_TYPE_DATABLOCK]              = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, iomode_t))&handle_datablock_readv,
		...
		/* [HANDLE_TYPE_VM]                     = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, iomode_t))&handle_vm_readv,
		...
		/* [HANDLE_TYPE_DRIVER]                 = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, iomode_t))&handle_driver_readv,
		...
		/* [HANDLE_TYPE_DRIVER_STATE]           = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, iomode_t))&handle_driver_state_readv,
		...
		/* [HANDLE_TYPE_DATAPART]               = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, iomode_t))&handle_datapart_readv,
		...
		/* [HANDLE_TYPE_DRIVER_SECTION]         = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, iomode_t))&handle_driver_section_readv,
	...
	/* .h_writev = */ {
		...
		/* [HANDLE_TYPE_DATABLOCK]              = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, iomode_t))&handle_datablock_writev,
		...
		/* [HANDLE_TYPE_VM]                     = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, iomode_t))&handle_vm_writev,
		...
		/* [HANDLE_TYPE_DRIVER]                 = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, iomode_t))&handle_driver_writev,
		...
		/* [HANDLE_TYPE_DRIVER_STATE]           = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, iomode_t))&handle_driver_state_writev,
		...
		/* [HANDLE_TYPE_DATAPART]               = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, iomode_t))&handle_datapart_writev,
		...
		/* [HANDLE_TYPE_DRIVER_SECTION]         = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, iomode_t))&handle_driver_section_writev,
	...
	/* .h_preadv = */ {
		...
		/* [HANDLE_TYPE_DATABLOCK]              = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, pos_t, iomode_t))&handle_datablock_preadv,
		...
		/* [HANDLE_TYPE_VM]                     = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, pos_t, iomode_t))&handle_vm_preadv,
		...
		/* [HANDLE_TYPE_DRIVER]                 = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, pos_t, iomode_t))&handle_driver_preadv,
		...
		/* [HANDLE_TYPE_DRIVER_STATE]           = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, pos_t, iomode_t))&handle_driver_state_preadv,
		...
		/* [HANDLE_TYPE_DATAPART]               = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, pos_t, iomode_t))&handle_datapart_preadv,
		...
		/* [HANDLE_TYPE_DRIVER_SECTION]         = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, pos_t, iomode_t))&handle_driver_section_preadv,
	...
	/* .h_pwritev = */ {
		...
		/* [HANDLE_TYPE_DATABLOCK]              = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, pos_t, iomode_t))&handle_datablock_pwritev,
		...
		/* [HANDLE_TYPE_VM]                     = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, pos_t, iomode_t))&handle_vm_pwritev,
		...
		/* [HANDLE_TYPE_DRIVER]                 = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, pos_t, iomode_t))&handle_driver_pwritev,
		...
		/* [HANDLE_TYPE_DRIVER_STATE]           = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, pos_t, iomode_t))&handle_driver_state_pwritev,
		...
		/* [HANDLE_TYPE_DATAPART]               = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, pos_t, iomode_t))&handle_datapart_pwritev,
		...
		/* [HANDLE_TYPE_DRIVER_SECTION]         = */ (size_t (KCALL *)(void *__restrict, struct iov_buffer *__restrict, size_t, pos_t, iomode_t))&handle_driver_section_pwritev,
