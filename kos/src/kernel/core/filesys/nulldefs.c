...
for (local name, st_mode, st_rdev: DEVICES) {
	...
	print("				MFILE_INIT_mf_initdone(dev_", name, ".dv_devnode.dn_node.fn_file),");
	...
	.dv_devnode = {
		.dn_node = {
			.fn_file = {
				...
				MFILE_INIT_mf_initdone(dev_mem.dv_devnode.dn_node.fn_file),
	...
	.dv_devnode = {
		.dn_node = {
			.fn_file = {
				...
				MFILE_INIT_mf_lock,
				MFILE_INIT_mf_parts(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_initdone(dev_kmem.dv_devnode.dn_node.fn_file),
				MFILE_INIT_mf_changed(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_blockshift(PAGESHIFT, PAGESHIFT),
				MFILE_INIT_mf_meta,
				MFILE_INIT_mf_flags(MFILE_F_ATTRCHANGED | MFILE_F_CHANGED |
	...
	.dv_devnode = {
		.dn_node = {
			.fn_file = {
				...
				MFILE_INIT_mf_lock,
				MFILE_INIT_mf_parts(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_initdone(dev_null.dv_devnode.dn_node.fn_file),
				MFILE_INIT_mf_changed(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_blockshift(PAGESHIFT, PAGESHIFT),
				MFILE_INIT_mf_meta,
				MFILE_INIT_mf_flags(MFILE_F_ATTRCHANGED | MFILE_F_CHANGED |
	...
	.dv_devnode = {
		.dn_node = {
			.fn_file = {
				...
				MFILE_INIT_mf_lock,
				MFILE_INIT_mf_parts(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_initdone(dev_port.dv_devnode.dn_node.fn_file),
				MFILE_INIT_mf_changed(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_blockshift(PAGESHIFT, PAGESHIFT),
				MFILE_INIT_mf_meta,
				MFILE_INIT_mf_flags(MFILE_F_ATTRCHANGED | MFILE_F_CHANGED |
	...
	.dv_devnode = {
		.dn_node = {
			.fn_file = {
				...
				MFILE_INIT_mf_lock,
				MFILE_INIT_mf_parts(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_initdone(dev_zero.dv_devnode.dn_node.fn_file),
				MFILE_INIT_mf_changed(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_blockshift(PAGESHIFT, PAGESHIFT),
				MFILE_INIT_mf_meta,
				MFILE_INIT_mf_flags(MFILE_F_ATTRCHANGED | MFILE_F_CHANGED |
	...
	.dv_devnode = {
		.dn_node = {
			.fn_file = {
				...
				MFILE_INIT_mf_lock,
				MFILE_INIT_mf_parts(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_initdone(dev_full.dv_devnode.dn_node.fn_file),
				MFILE_INIT_mf_changed(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_blockshift(PAGESHIFT, PAGESHIFT),
				MFILE_INIT_mf_meta,
				MFILE_INIT_mf_flags(MFILE_F_ATTRCHANGED | MFILE_F_CHANGED |
	...
	.dv_devnode = {
		.dn_node = {
			.fn_file = {
				...
				MFILE_INIT_mf_lock,
				MFILE_INIT_mf_parts(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_initdone(dev_random.dv_devnode.dn_node.fn_file),
				MFILE_INIT_mf_changed(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_blockshift(PAGESHIFT, PAGESHIFT),
				MFILE_INIT_mf_meta,
				MFILE_INIT_mf_flags(MFILE_F_ATTRCHANGED | MFILE_F_CHANGED |
	...
	.dv_devnode = {
		.dn_node = {
			.fn_file = {
				...
				MFILE_INIT_mf_lock,
				MFILE_INIT_mf_parts(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_initdone(dev_urandom.dv_devnode.dn_node.fn_file),
				MFILE_INIT_mf_changed(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_blockshift(PAGESHIFT, PAGESHIFT),
				MFILE_INIT_mf_meta,
				MFILE_INIT_mf_flags(MFILE_F_ATTRCHANGED | MFILE_F_CHANGED |
	...
	.dv_devnode = {
		.dn_node = {
			.fn_file = {
				...
				MFILE_INIT_mf_lock,
				MFILE_INIT_mf_parts(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_initdone(dev_kmsg.dv_devnode.dn_node.fn_file),
				MFILE_INIT_mf_changed(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_blockshift(PAGESHIFT, PAGESHIFT),
				MFILE_INIT_mf_meta,
				MFILE_INIT_mf_flags(MFILE_F_ATTRCHANGED | MFILE_F_CHANGED |
	...
	.dv_devnode = {
		.dn_node = {
			.fn_file = {
				...
				MFILE_INIT_mf_lock,
				MFILE_INIT_mf_parts(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_initdone(dev_void.dv_devnode.dn_node.fn_file),
				MFILE_INIT_mf_changed(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_blockshift(PAGESHIFT, PAGESHIFT),
				MFILE_INIT_mf_meta,
				MFILE_INIT_mf_flags(MFILE_F_ATTRCHANGED | MFILE_F_CHANGED |
	...
	.dv_devnode = {
		.dn_node = {
			.fn_file = {
				...
				MFILE_INIT_mf_lock,
				MFILE_INIT_mf_parts(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_initdone(dev_tty.dv_devnode.dn_node.fn_file),
				MFILE_INIT_mf_changed(MFILE_PARTS_ANONYMOUS),
				MFILE_INIT_mf_blockshift(PAGESHIFT, PAGESHIFT),
				MFILE_INIT_mf_meta,
				MFILE_INIT_mf_flags(MFILE_F_ATTRCHANGED | MFILE_F_CHANGED |
