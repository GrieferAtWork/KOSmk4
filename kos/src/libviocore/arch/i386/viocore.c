...
#define EMU86_GETSPREG() ((u16)EMU86_GETSP_RAW())
...
#define EMU86_SETSPREG(value) EMU86_SETSP_RAW((uintptr_t)(u16)(value))
...
#define EMU86_GETESP() ((u32)EMU86_GETSP_RAW())
...
#define EMU86_SETESP(value) EMU86_SETSP_RAW((uintptr_t)(u32)(value))
...
#ifdef __x86_64__
#define EMU86_GETSPL() ((u8)EMU86_GETSP_RAW())
...
#define EMU86_SETSPL(value) EMU86_SETSP_RAW((EMU86_GETSP_RAW() & ~0xff) | (u8)(value))
...
#define EMU86_GETRSP() ((u64)EMU86_GETSP_RAW())
...
#define EMU86_SETRSP(value) EMU86_SETSP_RAW((u64)(value))
