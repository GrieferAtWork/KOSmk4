...
NOTHROW(FCALL comgen_memcpy_with_rep_movs)(struct com_generator *__restrict self,
	...
	size_t pwords;
#ifdef __x86_64__
	STATIC_ASSERT(GEN86_INSTRLEN_MAX >= 15);
	if (!comgen_txav(self, 15)) /* Worst-case number of generated bytes */
		return;
#else /* __x86_64__ */
	STATIC_ASSERT(GEN86_INSTRLEN_MAX >= 11);
	if (!comgen_txav(self, 11)) /* Worst-case number of generated bytes */
		return;
#endif /* !__x86_64__ */
...
NOTHROW(FCALL comgen_serialize_integer_arguments)(struct com_generator *__restrict self) {
	...
	for (i = 0; i < self->cg_int_paramc;) {
		...
		if (self->cg_features & (COM_GENERATOR_FEATURE_INT_PARAMS_USE_LODS |
			...
			if (self->cg_features & COM_GENERATOR_FEATURE_INT_PARAMS_USE_LODS)
				must_adjust_psi = psi_spoffset != spoffset;
			if (self->cg_features & COM_GENERATOR_FEATURE_INT_PARAMS_USE_STOS)
				must_adjust_pdi = pdi_serial_offset != param.cip_serial_offset;
