...
#define service_textlock_endread(self)    (void)(atomic_rwlock_endread_ex(&(self)->s_textlock) && (service_textlock_reap(self), 0))
#define _service_textlock_end(self)       atomic_rwlock_end(&(self)->s_textlock)
#define service_textlock_end(self)        (void)(atomic_rwlock_end_ex(&(self)->s_textlock) && (service_textlock_reap(self), 0))
