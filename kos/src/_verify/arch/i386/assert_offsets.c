...
STATIC_ASSERT(offsetof(struct xfpustate32, fx_fpucs) == OFFSET_XFPUSTATE32_FPUCS);
STATIC_ASSERT(offsetof(struct xfpustate32, fx_fpudp) == OFFSET_XFPUSTATE32_FPUDP);
STATIC_ASSERT(offsetof(struct xfpustate32, fx_fpuds) == OFFSET_XFPUSTATE32_FPUDS);
STATIC_ASSERT(offsetof(struct xfpustate32, fx_fpuip) == OFFSET_XFPUSTATE32_FPUIP);
...
STATIC_ASSERT(offsetof(struct xfpustate64, fx_fpudp) == OFFSET_XFPUSTATE64_FPUDP);
STATIC_ASSERT(offsetof(struct xfpustate64, fx_fpuip) == OFFSET_XFPUSTATE64_FPUIP);
