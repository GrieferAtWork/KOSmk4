...
INTDEF NONNULL((1)) void CC libvio_xchwithvio(struct vio_args *__restrict args, vio_addr_t offset, __USER __CHECKED void *oldbuf, __USER __CHECKED void const *newbuf, size_t num_bytes, bool atomic) __THROWS(E_SEGFAULT, ...);
