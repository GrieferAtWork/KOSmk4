...
INTDEF NONNULL((1)) void CC libvio_xchwithvio(struct vioargs *__restrict args, vio_addr_t offset, __USER __CHECKED void *oldbuf, __USER __CHECKED void const *newbuf, size_t num_bytes, bool atomic) __THROWS(E_SEGFAULT, ...);
INTDEF NONNULL((1)) void CC libvio_copyfromvio(struct vioargs *__restrict args, vio_addr_t offset, __USER __CHECKED void *buf, size_t num_bytes) __THROWS(E_SEGFAULT, ...);
INTDEF NONNULL((1)) void CC libvio_copytovio(struct vioargs *__restrict args, vio_addr_t offset, __USER __CHECKED void const *buf, size_t num_bytes) __THROWS(E_SEGFAULT, ...);
