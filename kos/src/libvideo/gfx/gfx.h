...
INTDEF void CC libvideo_gfx_defaultgfx_vline(struct video_gfx *__restrict self, uintptr_t x, uintptr_t y, size_t length, video_color_t color);
INTDEF void CC libvideo_gfx_defaultgfx_hline(struct video_gfx *__restrict self, uintptr_t x, uintptr_t y, size_t length, video_color_t color);
...
INTDEF void CC libvideo_gfx_defaultgfx_bitstretchfill(struct video_gfx *__restrict self, intptr_t dst_x, intptr_t dst_y, size_t dst_size_x, size_t dst_size_y, video_color_t color, size_t src_size_x, size_t src_size_y, void const *__restrict bitmask);
INTDEF void CC libvideo_gfx_defaultgfx_bitstretchblit(struct video_gfx *self, intptr_t dst_x, intptr_t dst_y, size_t dst_size_x, size_t dst_size_y, struct video_gfx const *src, intptr_t src_x, intptr_t src_y, size_t src_size_x, size_t src_size_y, void const *__restrict bitmask);
...
INTDEF void CC libvideo_gfx_defaultgfx_vline_o(struct video_gfx *__restrict self, uintptr_t x, uintptr_t y, size_t length, video_color_t color);
INTDEF void CC libvideo_gfx_defaultgfx_hline_o(struct video_gfx *__restrict self, uintptr_t x, uintptr_t y, size_t length, video_color_t color);
