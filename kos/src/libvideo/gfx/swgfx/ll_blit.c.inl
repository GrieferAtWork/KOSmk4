...
libvideo_swblitter_generic__blit(struct video_blitter const *__restrict self,
	...
	TRACE_START("swblitter_generic__blit("
	...
	TRACE_END("swblitter_generic__blit()\n");
}
...
libvideo_swblitter_generic__blit_imatrix(struct video_blitter const *__restrict self,
	...
	TRACE_START("swblitter_generic__blit_imatrix("
	            "dst: {%" PRIuCRD "x%" PRIuCRD "}, "
	            "src: {%" PRIuCRD "x%" PRIuCRD "}, "
	            "dim: {%" PRIuDIM "x%" PRIuDIM "}, "
	            "matrix: {{%d,%d},{%d,%d}})\n",
	...
	GFX_BLIT_FOREACH_IMATRIX(dst_x_, dst_y_, src_x_, src_y_, size_x_, size_y_, src_matrix,
	                         BLIT_PIXEL, GFX_ROW_NOOP, GFX_ROW_NOOP);
	TRACE_END("swblitter_generic__blit_imatrix()\n");
}
...
#define pixel_blend(dst_x, dst_y, src_x0, src_y0, src_x1, src_y1, frac_x0, frac_x1, frac_y0, frac_y1) \
	...
	TRACE_START("swblitter_generic__stretch_l("
	...
	TRACE_END("swblitter_generic__stretch_l()\n");
...
#define pixel_blend(dst_x, dst_y, src_x0, src_y0, src_x1, src_y1, frac_x0, frac_x1, frac_y0, frac_y1) \
	...
	GFX_LINEAR_STRETCH(dst_x_, dst_y_, dst_size_x_, dst_size_y_,
	                   ...
	                   pixel_blend_ymax,
	                   pixel_blend_xmax_ymax);
	TRACE_END("swblitter_generic__stretch_imatrix_l()\n");
#undef pixel_blend_xmin_ymin
#undef pixel_blend_ymin
#undef pixel_blend_xmax_ymin
#undef pixel_blend_xmin
...
libvideo_swblitter_generic__stretch_n(struct video_blitter const *__restrict self,
	...
	struct video_gfx const *dst = self->vbt_dst;
	struct video_gfx const *src = self->vbt_src;
	TRACE_START("swblitter_generic__stretch_n("
	            "dst: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "}, "
	            "src: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "})\n",
	            dst_x_, dst_y_, dst_size_x_, dst_size_y_,
	            src_x_, src_y_, src_size_x_, src_size_y_);
	GFX_NEAREST_STRETCH(dst_x_, dst_y_, dst_size_x_, dst_size_y_,
	                    src_x_, src_y_, src_size_x_, src_size_y_,
	                    BLIT_PIXEL, GFX_ROW_NOOP, GFX_ROW_NOOP);
	TRACE_END("swblitter_generic__stretch_n()\n");
}
...
libvideo_swblitter_generic__stretch_imatrix_n(struct video_blitter const *__restrict self,
	...
	TRACE_START("swblitter_generic__stretch_imatrix_n("
	            "dst: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "}, "
	            "src: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "}, "
	            "matrix: {{%d,%d},{%d,%d}})\n",
	            dst_x_, dst_y_, dst_size_x_, dst_size_y_,
	...
	GFX_NEAREST_STRETCH_IMATRIX(dst_x_, dst_y_, dst_size_x_, dst_size_y_,
	                            src_x_, src_y_, src_size_x_, src_size_y_,
	                            src_matrix, BLIT_PIXEL, GFX_ROW_NOOP, GFX_ROW_NOOP);
	TRACE_END("swblitter_generic__stretch_imatrix_n()\n");
}
...
libvideo_swblitter_generic__blit__rev(struct video_blitter const *__restrict self,
	...
	struct video_gfx const *src = self->vbt_src;
	struct video_gfx const *dst = self->vbt_dst;
	TRACE_START("swblitter_generic__blit__rev("
	            "dst: {%" PRIuCRD "x%" PRIuCRD "}, "
	            "src: {%" PRIuCRD "x%" PRIuCRD "}, "
	            "dim: {%" PRIuDIM "x%" PRIuDIM "})\n",
	            dst_x_, dst_y_, src_x_, src_y_, size_x_, size_y_);
	GFX_BLIT_FOREACH_REV(dst_x_, dst_y_, src_x_, src_y_, size_x_, size_y_,
	                     BLIT_PIXEL, GFX_ROW_NOOP, GFX_ROW_NOOP);
	TRACE_END("swblitter_generic__blit__rev()\n");
}
...
libvideo_swblitter_generic__stretch_n__rev(struct video_blitter const *__restrict self,
	...
	struct video_gfx const *dst = self->vbt_dst;
	struct video_gfx const *src = self->vbt_src;
	TRACE_START("swblitter_generic__stretch_n__rev("
	            "dst: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "}, "
	            "src: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "})\n",
	...
	GFX_NEAREST_STRETCH_REV(dst_x, dst_y, dst_size_x, dst_size_y,
	                        ...
	                        GFX_ROW_NOOP,
	                        GFX_ROW_NOOP);
	TRACE_END("swblitter_generic__stretch_n__rev()\n");
}
...
/* Color key blitting */
#define ckey_pixel2color(pixel)     video_gfx_pixel2color(src, pixel)
#define ckey_pixel2color_opt(pixel) video_gfx_pixel2color(src, pixel) /* "pixel" may be "src_colorkey" */

#define BLIT_PIXEL(dst_x, dst_y, src_x, src_y)                \
	{                                                         \
		video_pixel_t pixel = LL_getpixel(src, src_x, src_y); \
		if (pixel != src_colorkey) {                          \
			video_pixel_t color = ckey_pixel2color(pixel);    \
			LL_putcolor(dst, dst_x, dst_y, color);            \
		}                                                     \
	}
...
INTERN ATTR_IN(1) void CC
libvideo_swblitter_ckey__blit(struct video_blitter const *__restrict self,
                              video_coord_t dst_x_, video_coord_t dst_y_,
                              video_coord_t src_x_, video_coord_t src_y_,
                              video_dim_t size_x_, video_dim_t size_y_) {
	struct video_gfx const *src = self->vbt_src;
	...
	TRACE_START("swblitter_ckey__blit("
	            "dst: {%" PRIuCRD "x%" PRIuCRD "}, "
	            "src: {%" PRIuCRD "x%" PRIuCRD "}, "
	            "dim: {%" PRIuDIM "x%" PRIuDIM "})\n",
	            dst_x_, dst_y_, src_x_, src_y_, size_x_, size_y_);
	GFX_BLIT_FOREACH(dst_x_, dst_y_, src_x_, src_y_, size_x_, size_y_,
	                 BLIT_PIXEL, GFX_ROW_NOOP, GFX_ROW_NOOP);
	TRACE_END("swblitter_ckey__blit()\n");
}

INTERN ATTR_IN(1) void CC
libvideo_swblitter_ckey__stretch_l(struct video_blitter const *__restrict self,
                                   video_coord_t dst_x_, video_coord_t dst_y_,
                                   video_dim_t dst_size_x_, video_dim_t dst_size_y_,
                                   video_coord_t src_x_, video_coord_t src_y_,
                                   video_dim_t src_size_x_, video_dim_t src_size_y_) {
...
#define pixel_blend(dst_x, dst_y, src_x0, src_y0, src_x1, src_y1, frac_x0, frac_x1, frac_y0, frac_y1) \
	{                                                                                                 \
		video_pixel_t p_src_y0_x0 = LL_getpixel(src, src_x0, src_y0);                                 \
		video_pixel_t p_src_y0_x1 = LL_getpixel(src, src_x1, src_y0);                                 \
		video_pixel_t p_src_y1_x0 = LL_getpixel(src, src_x0, src_y1);                                 \
		video_pixel_t p_src_y1_x1 = LL_getpixel(src, src_x1, src_y1);                                 \
		if (p_src_y0_x0 != src_colorkey || p_src_y0_x1 != src_colorkey ||                             \
		    p_src_y1_x0 != src_colorkey || p_src_y1_x1 != src_colorkey) {                             \
			video_pixel_t c_src_y0_x0 = ckey_pixel2color_opt(p_src_y0_x0);                            \
			video_pixel_t c_src_y0_x1 = ckey_pixel2color_opt(p_src_y0_x1);                            \
			video_pixel_t c_src_y1_x0 = ckey_pixel2color_opt(p_src_y1_x0);                            \
	...
	TRACE_START("swblitter_ckey__stretch_l("
	            "dst: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "}, "
	            "src: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "})\n",
	            dst_x_, dst_y_, dst_size_x_, dst_size_y_,
	            src_x_, src_y_, src_size_x_, src_size_y_);
	GFX_LINEAR_STRETCH(dst_x_, dst_y_, dst_size_x_, dst_size_y_,
	                   ...
	                   pixel_blend_ymax,
	                   pixel_blend_xmax_ymax);
	TRACE_END("swblitter_ckey__stretch_l()\n");
#undef pixel_blend_xmin_ymin
#undef pixel_blend_ymin
#undef pixel_blend_xmax_ymin
#undef pixel_blend_xmin
...
INTERN ATTR_IN(1) void CC
libvideo_swblitter_ckey__stretch_n(struct video_blitter const *__restrict self,
                                   video_coord_t dst_x_, video_coord_t dst_y_,
                                   video_dim_t dst_size_x_, video_dim_t dst_size_y_,
                                   video_coord_t src_x_, video_coord_t src_y_,
                                   video_dim_t src_size_x_, video_dim_t src_size_y_) {
	...
	struct video_gfx const *src = self->vbt_src;
	video_pixel_t src_colorkey = video_gfx_getcolorkey(src);
	TRACE_START("swblitter_ckey__stretch_n("
	            "dst: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "}, "
	            "src: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "})\n",
	            dst_x_, dst_y_, dst_size_x_, dst_size_y_,
	            src_x_, src_y_, src_size_x_, src_size_y_);
	GFX_NEAREST_STRETCH(dst_x_, dst_y_, dst_size_x_, dst_size_y_,
	                    src_x_, src_y_, src_size_x_, src_size_y_,
	                    BLIT_PIXEL, GFX_ROW_NOOP, GFX_ROW_NOOP);
	TRACE_END("swblitter_ckey__stretch_n()\n");
}

INTERN ATTR_IN(1) void CC
libvideo_swblitter_ckey__blit_imatrix(struct video_blitter const *__restrict self,
                                      video_coord_t dst_x_, video_coord_t dst_y_,
                                      video_coord_t src_x_, video_coord_t src_y_,
                                      video_dim_t size_x_, video_dim_t size_y_,
                                      video_imatrix2d_t src_matrix) {
	...
	/* Fast-pass for known matrices */
	if (src_matrix == VIDEO_IMATRIX2D_INIT(1, 0, 0, 1)) {
		libvideo_swblitter_ckey__blit(self, dst_x_, dst_y_, src_x_, src_y_, size_x_, size_y_);
		return;
	}

	/* TODO: More optimizations for known rotation/mirror matrices */

	TRACE_START("swblitter_ckey__blit_imatrix("
	            "dst: {%" PRIuCRD "x%" PRIuCRD "}, "
	            "src: {%" PRIuCRD "x%" PRIuCRD "}, "
	            "dim: {%" PRIuDIM "x%" PRIuDIM "}, "
	            "matrix: {{%d,%d},{%d,%d}})\n",
	...
	GFX_BLIT_FOREACH_IMATRIX(dst_x_, dst_y_, src_x_, src_y_, size_x_, size_y_, src_matrix,
	                         BLIT_PIXEL, GFX_ROW_NOOP, GFX_ROW_NOOP);
	TRACE_END("swblitter_ckey__blit_imatrix()\n");
}

INTERN ATTR_IN(1) void CC
libvideo_swblitter_ckey__stretch_imatrix_l(struct video_blitter const *__restrict self,
                                           video_coord_t dst_x_, video_coord_t dst_y_,
                                           video_dim_t dst_size_x_, video_dim_t dst_size_y_,
                                           video_coord_t src_x_, video_coord_t src_y_,
                                           video_dim_t src_size_x_, video_dim_t src_size_y_,
...
#define pixel_blend(dst_x, dst_y, src_x0, src_y0, src_x1, src_y1, frac_x0, frac_x1, frac_y0, frac_y1) \
	{                                                                                                 \
		video_pixel_t p_src_y0_x0 = LOCAL_getpixel(src_x0, src_y0);                                   \
		video_pixel_t p_src_y0_x1 = LOCAL_getpixel(src_x1, src_y0);                                   \
		video_pixel_t p_src_y1_x0 = LOCAL_getpixel(src_x0, src_y1);                                   \
		video_pixel_t p_src_y1_x1 = LOCAL_getpixel(src_x1, src_y1);                                   \
		if (p_src_y0_x0 != src_colorkey || p_src_y0_x1 != src_colorkey ||                             \
		    p_src_y1_x0 != src_colorkey || p_src_y1_x1 != src_colorkey) {                             \
			video_pixel_t c_src_y0_x0 = ckey_pixel2color_opt(p_src_y0_x0);                            \
			video_pixel_t c_src_y0_x1 = ckey_pixel2color_opt(p_src_y0_x1);                            \
	...
	TRACE_START("swblitter_ckey__stretch_imatrix_l("
	            "dst: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "}, "
	            "src: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "}, "
	            "matrix: {{%d,%d},{%d,%d}})\n",
	            dst_x_, dst_y_, dst_size_x_, dst_size_y_,
	...
	GFX_LINEAR_STRETCH(dst_x_, dst_y_, dst_size_x_, dst_size_y_,
	                   ...
	                   pixel_blend_ymax,
	                   pixel_blend_xmax_ymax);
	TRACE_END("swblitter_ckey__stretch_imatrix_l()\n");
#undef pixel_blend_xmin_ymin
#undef pixel_blend_ymin
#undef pixel_blend_xmax_ymin
#undef pixel_blend_xmin
...
INTERN ATTR_IN(1) void CC
libvideo_swblitter_ckey__stretch_imatrix_n(struct video_blitter const *__restrict self,
                                           video_coord_t dst_x_, video_coord_t dst_y_,
                                           video_dim_t dst_size_x_, video_dim_t dst_size_y_,
                                           video_coord_t src_x_, video_coord_t src_y_,
                                           video_dim_t src_size_x_, video_dim_t src_size_y_,
	...
	/* Fast-pass for known matrices */
	if (src_matrix == VIDEO_IMATRIX2D_INIT(1, 0, 0, 1)) {
		libvideo_swblitter_ckey__stretch_n(self,
		                                   dst_x_, dst_y_, dst_size_x_, dst_size_y_,
		                                   src_x_, src_y_, src_size_x_, src_size_y_);
		return;
	}
	TRACE_START("swblitter_ckey__stretch_imatrix_n("
	            "dst: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "}, "
	            "src: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "}, "
	            "matrix: {{%d,%d},{%d,%d}})\n",
	            dst_x_, dst_y_, dst_size_x_, dst_size_y_,
	...
	GFX_NEAREST_STRETCH_IMATRIX(dst_x_, dst_y_, dst_size_x_, dst_size_y_,
	                            src_x_, src_y_, src_size_x_, src_size_y_,
	                            src_matrix, BLIT_PIXEL, GFX_ROW_NOOP, GFX_ROW_NOOP);
	TRACE_END("swblitter_ckey__stretch_imatrix_n()\n");
}


PRIVATE ATTR_IN(1) void CC
libvideo_swblitter_ckey__blit__rev(struct video_blitter const *__restrict self,
                                   video_coord_t dst_x_, video_coord_t dst_y_,
                                   video_coord_t src_x_, video_coord_t src_y_,
                                   video_dim_t size_x_, video_dim_t size_y_) {
	struct video_gfx const *src = self->vbt_src;
	struct video_gfx const *dst = self->vbt_dst;
	video_pixel_t src_colorkey = video_gfx_getcolorkey(src);
	TRACE_START("swblitter_ckey__blit__rev("
	            "dst: {%" PRIuCRD "x%" PRIuCRD "}, "
	            "src: {%" PRIuCRD "x%" PRIuCRD "}, "
	            "dim: {%" PRIuDIM "x%" PRIuDIM "})\n",
	            dst_x_, dst_y_, src_x_, src_y_, size_x_, size_y_);
	GFX_BLIT_FOREACH_REV(dst_x_, dst_y_, src_x_, src_y_, size_x_, size_y_,
	                     BLIT_PIXEL, GFX_ROW_NOOP, GFX_ROW_NOOP);
	TRACE_END("swblitter_ckey__blit__rev()\n");
}

PRIVATE ATTR_IN(1) void CC
libvideo_swblitter_ckey__stretch_n__rev(struct video_blitter const *__restrict self,
                                        video_coord_t dst_x, video_coord_t dst_y,
                                        video_dim_t dst_size_x, video_dim_t dst_size_y,
                                        video_coord_t src_x, video_coord_t src_y,
                                        video_dim_t src_size_x, video_dim_t src_size_y) {
	...
	struct video_gfx const *src = self->vbt_src;
	video_pixel_t src_colorkey = video_gfx_getcolorkey(src);
	TRACE_START("swblitter_ckey__stretch_n__rev("
	            "dst: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "}, "
	            "src: {%" PRIuCRD "x%" PRIuCRD ", %" PRIuDIM "x%" PRIuDIM "})\n",
	            dst_x, dst_y, dst_size_x, dst_size_y,
	            src_x, src_y, src_size_x, src_size_y);
	GFX_NEAREST_STRETCH_REV(dst_x, dst_y, dst_size_x, dst_size_y,
	                        src_x, src_y, src_size_x, src_size_y,
	                        BLIT_PIXEL, GFX_ROW_NOOP, GFX_ROW_NOOP);
	TRACE_END("swblitter_ckey__stretch_n__rev()\n");
}

PRIVATE ATTR_IN(1) void CC
libvideo_swblitter_ckey__stretch_l__rev(struct video_blitter const *__restrict self,
                                        video_coord_t dst_x_, video_coord_t dst_y_,
                                        video_dim_t dst_size_x_, video_dim_t dst_size_y_,
                                        video_coord_t src_x_, video_coord_t src_y_,
                                        video_dim_t src_size_x_, video_dim_t src_size_y_) {
...
PRIVATE ATTR_NOINLINE ATTR_IN(1) void CC
libvideo_swblitter_samebuf_ckey__stretch__with_temporary(struct video_blitter const *__restrict self,
                                                         video_coord_t dst_x, video_coord_t dst_y,
                                                         video_dim_t dst_size_x, video_dim_t dst_size_y,
                                                         video_coord_t src_x, video_coord_t src_y,
                                                         video_dim_t src_size_x, video_dim_t src_size_y) {
	...
	/* Blit source into temporary buffer... (without color key) */
	if (src_size_x == video_buffer_getxdim(&rb) &&
	    src_size_y == video_buffer_getydim(&rb)) {
		libvideo_swblitter_noblend_samefmt__blit(&blitter, 0, 0,
		                                         src_x, src_y, src_size_x, src_size_y);
	...
	if (dst_size_x == video_buffer_getxdim(&rb) &&
	    dst_size_y == video_buffer_getydim(&rb)) {
		libvideo_swblitter_noblend_samefmt_ckey__blit(&blitter, dst_x, dst_y,
		                                              0, 0, dst_size_x, dst_size_y);
	} else if (video_gfx_getflags(&rb_gfx) & VIDEO_GFX_F_LINEAR) {
		libvideo_swblitter_noblend_samefmt_ckey__stretch_l(&blitter, dst_x, dst_y,
		                                                   dst_size_x, dst_size_y, 0, 0,
		                                                   video_buffer_getxdim(&rb),
		                                                   video_buffer_getydim(&rb));
	} else {
		libvideo_swblitter_noblend_samefmt_ckey__stretch_n(&blitter, dst_x, dst_y,
		                                                   dst_size_x, dst_size_y, 0, 0,
		                                                   video_buffer_getxdim(&rb),
		                                                   video_buffer_getydim(&rb));
	}
...
INTERN ATTR_IN(1) void CC
libvideo_swblitter_samebuf_ckey__blit(struct video_blitter const *__restrict self,
                                      video_coord_t dst_x, video_coord_t dst_y,
                                      video_coord_t src_x, video_coord_t src_y,
                                      video_dim_t size_x, video_dim_t size_y) {
	if (xy_before_or_equal(dst_x, dst_y, src_x, src_y)) {
		libvideo_swblitter_ckey__blit(self, dst_x, dst_y, src_x, src_y, size_x, size_y);
	} else {
		libvideo_swblitter_ckey__blit__rev(self, dst_x, dst_y, src_x, src_y, size_x, size_y);
	}
}

INTERN ATTR_IN(1) void CC
libvideo_swblitter_samebuf_ckey__stretch_l(struct video_blitter const *__restrict self,
                                           video_coord_t dst_x, video_coord_t dst_y,
                                           video_dim_t dst_size_x, video_dim_t dst_size_y,
                                           video_coord_t src_x, video_coord_t src_y,
                                           video_dim_t src_size_x, video_dim_t src_size_y) {
	...
	bool dst_xyend_before_src_xyend = xy_before_or_equal(dst_xend, dst_yend, src_xend, src_yend);
	if (dst_xymin_before_src_xymin && dst_xyend_before_src_xyend) {
		libvideo_swblitter_ckey__stretch_l(self, dst_x, dst_y, dst_size_x, dst_size_y, src_x, src_y, src_size_x, src_size_y);
	} else if (!dst_xymin_before_src_xymin && !dst_xyend_before_src_xyend) {
		libvideo_swblitter_ckey__stretch_l__rev(self, dst_x, dst_y, dst_size_x, dst_size_y, src_x, src_y, src_size_x, src_size_y);
	} else if (dst_xend <= src_x || dst_yend <= src_y || dst_x >= src_xend || dst_y >= src_yend) {
		libvideo_swblitter_ckey__stretch_l(self, dst_x, dst_y, dst_size_x, dst_size_y, src_x, src_y, src_size_x, src_size_y);
	} else {
		/* Special case: destination- and source-rect overlap in such a way that
		 * we need a temporary copy of the source rect so-as not to clobber data
		 * that has yet to be read. */
		libvideo_swblitter_samebuf_ckey__stretch__with_temporary(self, dst_x, dst_y, dst_size_x, dst_size_y, src_x, src_y, src_size_x, src_size_y);
	}
}

INTERN ATTR_IN(1) void CC
libvideo_swblitter_samebuf_ckey__stretch_n(struct video_blitter const *__restrict self,
                                           video_coord_t dst_x, video_coord_t dst_y,
                                           video_dim_t dst_size_x, video_dim_t dst_size_y,
                                           video_coord_t src_x, video_coord_t src_y,
                                           video_dim_t src_size_x, video_dim_t src_size_y) {
	...
	bool dst_xyend_before_src_xyend = xy_before_or_equal(dst_xend, dst_yend, src_xend, src_yend);
	if (dst_xymin_before_src_xymin && dst_xyend_before_src_xyend) {
		libvideo_swblitter_ckey__stretch_n(self, dst_x, dst_y, dst_size_x, dst_size_y, src_x, src_y, src_size_x, src_size_y);
	} else if (!dst_xymin_before_src_xymin && !dst_xyend_before_src_xyend) {
		libvideo_swblitter_ckey__stretch_n__rev(self, dst_x, dst_y, dst_size_x, dst_size_y, src_x, src_y, src_size_x, src_size_y);
	} else if (dst_xend <= src_x || dst_yend <= src_y || dst_x >= src_xend || dst_y >= src_yend) {
		libvideo_swblitter_ckey__stretch_n(self, dst_x, dst_y, dst_size_x, dst_size_y, src_x, src_y, src_size_x, src_size_y);
	} else {
		/* Special case: destination- and source-rect overlap in such a way that
...
INTERN ATTR_IN(1) void CC
libvideo_swblitter_samebuf_ckey__blit_imatrix(struct video_blitter const *__restrict self,
                                              video_coord_t dst_x, video_coord_t dst_y,
                                              video_coord_t src_x, video_coord_t src_y,
                                              video_dim_t size_x, video_dim_t size_y,
                                              video_imatrix2d_t src_matrix) {
	/* TODO: Overlap handling */
	libvideo_swblitter_ckey__blit_imatrix(self, dst_x, dst_y, src_x, src_y, size_x, size_y, src_matrix);
}

INTERN ATTR_IN(1) void CC
libvideo_swblitter_samebuf_ckey__stretch_imatrix_l(struct video_blitter const *__restrict self,
                                                   video_coord_t dst_x, video_coord_t dst_y,
                                                   video_dim_t dst_size_x, video_dim_t dst_size_y,
                                                   video_coord_t src_x, video_coord_t src_y,
                                                   video_dim_t src_size_x, video_dim_t src_size_y,
...
INTERN ATTR_IN(1) void CC
libvideo_swblitter_samebuf_ckey__stretch_imatrix_n(struct video_blitter const *__restrict self,
                                                   video_coord_t dst_x, video_coord_t dst_y,
                                                   video_dim_t dst_size_x, video_dim_t dst_size_y,
                                                   video_coord_t src_x, video_coord_t src_y,
                                                   video_dim_t src_size_x, video_dim_t src_size_y,
                                                   video_imatrix2d_t src_matrix) {
	/* TODO: Overlap handling */
	libvideo_swblitter_ckey__stretch_imatrix_n(self,
	                                           dst_x, dst_y, dst_size_x, dst_size_y,
	                                           src_x, src_y, src_size_x, src_size_y,
	                                           src_matrix);
}
