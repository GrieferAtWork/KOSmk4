...
#include "old-gfx.h" /* struct old_subregion_buffer */
...
struct old_bigregion_buffer: video_buffer { /* TODO: MERGE WITH "old_bigregion_buffer_r" */
...
struct old_bigregion_buffer_r: old_bigregion_buffer {
...
struct old_subregion_buffer_r: old_subregion_buffer { /* TODO: REMOVE THIS */
	...
	revokable_inuse_t    srbr_inuse; /* [lock(ATOMIC)] s.a. `struct old_bigregion_buffer_r::brbr_inuse' */
};

INTDEF struct video_buffer_ops old_bigregion_buffer_ops; /* TODO: REMOVE THIS */
INTDEF struct video_buffer_ops old_bigregion_buffer_ops_r;
//TDEF struct video_buffer_ops old_subregion_buffer_ops;         /* `srb_vm_xrem != 0' */ /* TODO: REMOVE THIS */
//TDEF struct video_buffer_ops old_subregion_buffer_ops_norem;   /* `srb_vm_xrem == 0' */ /* TODO: REMOVE THIS */
INTDEF struct video_buffer_ops old_subregion_buffer_ops_r;       /* `srb_vm_xrem != 0' */ /* TODO: REMOVE THIS */
INTDEF struct video_buffer_ops old_subregion_buffer_ops_norem_r; /* `srb_vm_xrem == 0' */ /* TODO: REMOVE THIS */
INTDEF struct video_buffer_ops old_basregion_buffer_ops_r;       /* Same dimensions as base-buffer */ /* TODO: REMOVE THIS */
INTDEF ATTR_RETNONNULL WUNUSED struct video_buffer_ops *CC _old_bigregion_buffer_ops(void); /* TODO: REMOVE THIS */
INTDEF ATTR_RETNONNULL WUNUSED struct video_buffer_ops *CC _old_bigregion_buffer_ops_r(void);
INTDEF ATTR_RETNONNULL WUNUSED struct video_buffer_ops *CC _old_subregion_buffer_ops_r(void); /* TODO: REMOVE THIS */
INTDEF ATTR_RETNONNULL WUNUSED struct video_buffer_ops *CC _old_subregion_buffer_ops_norem_r(void); /* TODO: REMOVE THIS */
INTDEF ATTR_RETNONNULL WUNUSED struct video_buffer_ops *CC _old_basregion_buffer_ops_r(void); /* TODO: REMOVE THIS */
