...
initconv_from_p(struct video_converter *__restrict self) {
	...
	if (self->vcv_to.vf_codec->vc_color2pixel == &pal_color2pixel) {
		if (self->vcv_from.vf_pal == self->vcv_to.vf_pal) {
...
initconv_from_rgb(struct video_converter *__restrict self) {
	...
	if (!(to_codec->vc_specs.vcs_flags & (VIDEO_CODEC_FLAG_PAL | VIDEO_CODEC_FLAG_LUM))) {
		self->_vcv_driver[0] = (void *)(uintptr_t)to_codec->vc_specs.vcs_amask;
		if (px_shl(from_codec->vc_specs.vcs_rmask, 8) == to_codec->vc_specs.vcs_rmask &&
			...
			self->vcv_mappixel = self->_vcv_driver[0] ? &map_shl8_plus_drv0 : &map_shl8;
			goto done;
			...
			self->vcv_mappixel = self->_vcv_driver[0] ? &map_shr8_plus_drv0 : &map_shr8;
			goto done;
			...
			self->vcv_mappixel = self->_vcv_driver[0] ? &map_rol8_plus_drv0 : &map_rol8;
			goto done;
			...
			self->vcv_mappixel = self->_vcv_driver[0] ? &map_ror8_plus_drv0 : &map_ror8;
			goto done;
			...
			self->vcv_mappixel = self->_vcv_driver[0] ? &map_rol16_plus_drv0 : &map_rol16;
			goto done;
		} else {
			...
			if (sw_from_rmask == to_codec->vc_specs.vcs_rmask &&
				...
				self->vcv_mappixel = self->_vcv_driver[0] ? &map_bswap_plus_drv0 : &map_bswap;
				goto done;
				...
				self->vcv_mappixel = self->_vcv_driver[0] ? &map_bswap_shl8_plus_drv0 : &map_bswap_shl8;
				goto done;
				...
				self->vcv_mappixel = self->_vcv_driver[0] ? &map_bswap_shr8_plus_drv0 : &map_bswap_shr8;
				goto done;
				...
				self->vcv_mappixel = self->_vcv_driver[0] ? &map_bswap_rol8_plus_drv0 : &map_bswap_rol8;
				goto done;
				...
				self->vcv_mappixel = self->_vcv_driver[0] ? &map_bswap_ror8_plus_drv0 : &map_bswap_ror8;
				goto done;
				...
				self->vcv_mappixel = self->_vcv_driver[0] ? &map_bswap_rol16_plus_drv0 : &map_bswap_rol16;
				goto done;
			}
		}
	}
