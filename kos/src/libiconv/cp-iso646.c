...
INTERN_CONST struct iconv_iso646_codepage const libiconv_iso646_pages[46] = {
	...
	[CODEC_ISO646_DANO_NATS - CODEC_ISO646_MIN]      = { { 0x0021, 0x00ab, 0x00bb, 0x0024, 0x0026, 0x003a, 0x003f, 0x3000, 0x00c6, 0x00d8, 0x00c5, 0x25a0, 0x005f, 0x2007, 0x00e6, 0x00f8, 0x00e5, 0x2013 } },
