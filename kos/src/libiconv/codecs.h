...
/*[[[deemon (printCodecEnums from .iconvdata.iconvdata)();]]]*/
	...
	CODEC_C_ESCAPE_BYTES_ALL,   /* "c-escape-all-bytes", "c-escape-bytes-all" */
	CODEC_C_ESCAPE_BYTES_CHR,   /* "c-escape-bytes-chr", "c-escape-chr-bytes" */
	CODEC_C_ESCAPE_BYTES_INCHR, /* "c-escape-inchr-bytes", "c-escape-bytes-inchr" */
	CODEC_C_ESCAPE_BYTES_INSTR, /* "c-escape-instr-bytes", "c-escape-bytes-instr" */
	CODEC_C_ESCAPE_BYTES_RAW,   /* "c-escape-bytes-raw", "c-escape-raw-bytes" */
	CODEC_C_ESCAPE_BYTES_STR,   /* "c-escape-bytes-str", "c-escape-str-bytes" */
	CODEC_C_ESCAPE_CHR,         /* "c-escape-chr" */
	CODEC_C_ESCAPE_INCHR,       /* "c-escape-inchr" */
	CODEC_C_ESCAPE_INSTR,       /* "c-escape-instr" */
	CODEC_C_ESCAPE_RAW,         /* "c-escape-raw" */
