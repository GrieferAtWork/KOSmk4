...
#define CODEC_CP_MIN CODEC_ADOBE_STANDARD_ENCODING
	...
	CODEC_CP1026,                  /* "ibm1026", "cp1026", "csibm1026" */
	...
	CODEC_CP273,                   /* "ibm273", "cp273", "csibm273" */
	CODEC_CP274,                   /* "ibm274", "ebcdic-be", "cp274", "csibm274" */
	CODEC_CP275,                   /* "ibm275", "ebcdic-br", "cp275", "csibm275" */
	CODEC_CP278,                   /* "ibm278", "cp278", "ebcdic-cp-fi", "ebcdic-cp-se", "csibm278" */
	CODEC_CP280,                   /* "ibm280", "cp280", "ebcdic-cp-it", "csibm280" */
	CODEC_CP281,                   /* "ibm281", "ebcdic-jp-e", "cp281", "csibm281" */
	CODEC_CP284,                   /* "ibm284", "cp284", "ebcdic-cp-es", "csibm284" */
	CODEC_CP285,                   /* "ibm285", "cp285", "ebcdic-cp-gb", "csibm285" */
	CODEC_CP290,                   /* "ibm290", "cp290", "ebcdic-jp-kana", "csibm290" */
	CODEC_CP297,                   /* "ibm297", "cp297", "ebcdic-cp-fr", "csibm297" */
	CODEC_CP37,                    /* "ibm37", "cp37", "ebcdic-cp-us", "ebcdic-cp-ca", "ebcdic-cp-wt", "ebcdic-cp-nl", "csibm37" */
	CODEC_CP38,                    /* "ibm38", "ebcdic-int", "cp38", "csibm38" */
	CODEC_CP420,                   /* "ibm420", "cp420", "ebcdic-cp-ar1", "csibm420" */
	CODEC_CP423,                   /* "ibm423", "cp423", "ebcdic-cp-gr", "csibm423" */
	CODEC_CP424,                   /* "ibm424", "cp424", "ebcdic-cp-he", "csibm424" */
	CODEC_CP437,                   /* "ibm437", "cp437", "437", "cspc8codepage437", "oemus", "osf100201b5" */
	CODEC_CP500,                   /* "ibm500", "cp500", "ebcdic-cp-be", "ebcdic-cp-ch", "csibm500" */
	CODEC_CP864,                   /* "ibm864", "cp864", "csibm864" */
	CODEC_CP870,                   /* "ibm870", "cp870", "ebcdic-cp-roece", "ebcdic-cp-yu", "csibm870" */
	CODEC_CP871,                   /* "ibm871", "cp871", "ebcdic-cp-is", "csibm871" */
	CODEC_CP880,                   /* "ibm880", "cp880", "ebcdic-cyrillic", "csibm880" */
	CODEC_CP897,                   /* "cp897" */
	CODEC_CP901,                   /* "cp901", "ibm901" */
	CODEC_CP902,                   /* "cp902", "ibm902" */
	CODEC_CP905,                   /* "ibm905", "cp905", "ebcdic-cp-tr", "csibm905" */
	CODEC_CP918,                   /* "ibm918", "cp918", "ebcdic-cp-ar2", "csibm918" */
	CODEC_CP921,                   /* "cp921", "ibm921" */
	CODEC_CP922,                   /* "cp922", "ibm922", "estonia-iso-8" */
	CODEC_DIN_66303,               /* "din-66303", "drv8" */
	CODEC_EBCDIC_AT_DE,            /* "ebcdic-at-de", "csibmebcdicatde" */
	CODEC_EBCDIC_AT_DE_A,          /* "ebcdic-at-de-a", "csebcdicatdea" */
	CODEC_EBCDIC_CA_FR,            /* "ebcdic-ca-fr", "csebcdiccafr" */
	CODEC_EBCDIC_CP_DK_NO,         /* "ibm277", "ebcdic-cp-dk", "ebcdic-cp-no", "csibm277" */
	CODEC_EBCDIC_DK_NO,            /* "ebcdic-dk-no", "csebcdicdkno" */
	CODEC_EBCDIC_DK_NO_A,          /* "ebcdic-dk-no-a", "csebcdicdknoa" */
	CODEC_EBCDIC_ES,               /* "ebcdic-es", "csebcdices" */
	CODEC_EBCDIC_ES_A,             /* "ebcdic-es-a", "csebcdicesa" */
	CODEC_EBCDIC_ES_S,             /* "ebcdic-es-s", "csebcdicess" */
	CODEC_EBCDIC_FI_SE,            /* "ebcdic-fi-se", "csebcdicfise" */
	CODEC_EBCDIC_FI_SE_A,          /* "ebcdic-fi-se-a", "csebcdicfisea" */
	CODEC_EBCDIC_FR,               /* "ebcdic-fr", "csebcdicfr" */
	CODEC_EBCDIC_IT,               /* "ebcdic-it", "csebcdicit" */
	CODEC_EBCDIC_PT,               /* "ebcdic-pt", "csebcdicpt" */
	CODEC_EBCDIC_UK,               /* "ebcdic-uk", "csebcdicuk" */
	CODEC_EBCDIC_US,               /* "ebcdic-us", "csebcdicus" */
	CODEC_ISO_5427,                /* "iso5427", "iso-ir-37", "koi7-n1", "koi0", "csiso5427cyrillic" */
...
#define CODEC_CP7L_MIN CODEC_BCDIC
	...
	CODEC_CP904,           /* "ibm904", "cp904", "904", "csibbm904" */
	CODEC_GBCD,            /* "gbcd" */
	...
	CODEC_ISO_IR_150,      /* "greek-ccitt", "iso-ir-150", "csiso150", "csiso150greekccitt" */
	CODEC_ISO_IR_18,       /* "greek7-old", "iso-ir-18", "csiso18greek7old" */
	CODEC_ISO_IR_19,       /* "latin-greek", "iso-ir-19", "latingreek", "csiso19latingreek" */
	CODEC_ISO_IR_50,       /* "inis-8", "iso-ir-50", "csiso50inis8" */
	CODEC_ISO_IR_51,       /* "inis-cyrillic", "iso-ir-51", "csiso51iniscyrillic" */
	CODEC_ISO_IR_54,       /* "iso5427:1981", "iso-ir-54", "iso5427cyrillic1981", "csiso54271981" */
	CODEC_ISO_IR_55,       /* "iso5428:1980", "iso-ir-55", "csiso5428greek" */
	...
	CODEC_ISO_IR_98,       /* "iso2033-1983", "iso-ir-98", "e13b", "csiso2033" */
...
#define CODEC_CP7H_MIN CODEC_AMIGA_1251
	...
	CODEC_CP1162,                 /* "cp1162", "ibm1162", "windows-874", "ms874", "x-windows-874", "cswindows874" */
	CODEC_CP1163,                 /* "cp1163", "ibm1163" */
	CODEC_CP1250,                 /* "cp1250", "windows-1250", "cswindows1250" */
	CODEC_CP1251,                 /* "cp1251", "windows-1251", "cswindows1251" */
	CODEC_CP1252,                 /* "cp1252", "windows-1252", "cswindows1252" */
	CODEC_CP1253,                 /* "cp1253", "windows-1253", "cswindows1253" */
	CODEC_CP1254,                 /* "cp1254", "windows-1254", "cswindows1254" */
	CODEC_CP1255,                 /* "cp1255", "windows-1255", "cswindows1255" */
	CODEC_CP1256,                 /* "cp1256", "windows-1256", "cswindows1256" */
	CODEC_CP1257,                 /* "cp1257", "windows-1257", "lst-1590-3", "cswindows1257" */
	...
	CODEC_CP855,                  /* "ibm855", "cp855", "855", "oem855", "csibm855" */
	CODEC_CP856,                  /* "cp856", "ibm856" */
	CODEC_CP857,                  /* "ibm857", "cp857", "857", "oem857", "csibm857" */
	CODEC_CP858,                  /* "cp858", "ibm858", "oem858", "pc-multilingual-850+euro", "ccsid858", "csibm858" */
	CODEC_CP859,                  /* "cp859", "ibm859" */
	CODEC_CP860,                  /* "ibm860", "cp860", "860", "oem860", "csibm860" */
	CODEC_CP861,                  /* "ibm861", "cp861", "861", "oem861", "cp-is", "csibm861" */
	CODEC_CP862,                  /* "ibm862", "cp862", "862", "oem862", "cspc862latinhebrew" */
	CODEC_CP863,                  /* "ibm863", "cp863", "863", "oem863", "csibm863" */
	CODEC_CP865,                  /* "ibm865", "cp865", "865", "oem865", "csibm865" */
	CODEC_CP866,                  /* "cp866", "866", "ibm866", "csibm866" */
	CODEC_CP867,                  /* "cp867" */
	CODEC_CP868,                  /* "ibm868", "cp868", "cp-ar", "csibm868" */
	CODEC_CP869,                  /* "ibm869", "cp869", "869", "cp-gr", "oem869", "csibm869" */
	CODEC_CP872,                  /* "cp872" */
	CODEC_CP874,                  /* "cp874", "cp9066", "ibm874", "ibm9066", "x-ibm874" */
	CODEC_EXTENDED_LATIN_8,       /* "extended-latin-8" */
	CODEC_HP_ROMAN8,              /* "hp-roman8", "roman8", "r8", "cshproman8" */
	...
	CODEC_ISO_8859_13,            /* "iso8859-13", "iso885913", "iso-ir-179", "csisolatin7", "latin7", "l7", "baltic", "cp28603", "windows-28603", "csiso885913" */
	...
	CODEC_ISO_IR_143,             /* "iec-p27-1", "iso-ir-143", "csiso143iecp271" */
	CODEC_ISO_IR_153,             /* "gost-19768-74", "st-sev-358-88", "iso-ir-153", "csiso153gost1976874" */
	CODEC_ISO_IR_154,             /* "iso8859-supp", "iso-ir-154", "latin1-2-5", "csiso8859supp" */
	CODEC_ISO_IR_155,             /* "iso10367-box", "iso-ir-155", "csiso10367box" */
	...
	CODEC_KOI8,                   /* "koi8" */
	CODEC_KOI8_B,                 /* "koi8-b" */
	CODEC_KOI8_E,                 /* "ecma-cyrillic", "iso-ir-111", "ecma-113", "koi8-e", "csiso111ecmacyrillic" */
	...
	CODEC_KOI8_T,                 /* "koi8-t" */
	CODEC_KOI8_U,                 /* "koi8-u", "cp21866", "cp1168", "ibm1168", "cskoi8u" */
