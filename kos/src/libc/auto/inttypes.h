...
INTDEF ATTR_LEAF NONNULL((1)) intmax_t NOTHROW_NCX(LIBCCALL libc_wcstoimax)(char32_t const *__restrict nptr, char32_t **endptr, int base);
...
INTDEF ATTR_LEAF NONNULL((1)) uintmax_t NOTHROW_NCX(LIBCCALL libc_wcstoumax)(char32_t const *__restrict nptr, char32_t **endptr, int base);
