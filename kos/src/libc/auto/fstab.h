...
INTDEF WUNUSED NONNULL((1)) struct fstab *NOTHROW_NCX(LIBDCALL libd_getfsspec)(const char *special_file);
 ...
 * @return: NULL: [errno = <unchanged>] No entry exists matching `special_file'
 * @return: NULL: [errno = *] Error */
INTDEF WUNUSED NONNULL((1)) struct fstab *NOTHROW_NCX(LIBCCALL libc_getfsspec)(const char *special_file);
#endif /* !__KERNEL__ */
#if !defined(__LIBCCALL_IS_LIBDCALL) && !defined(__KERNEL__)
/* >> getfsfile(3)
 ...
 * @return: NULL: [errno = *] Error */
INTDEF WUNUSED NONNULL((1)) struct fstab *NOTHROW_NCX(LIBDCALL libd_getfsfile)(const char *mount_point);
#endif /* !__LIBCCALL_IS_LIBDCALL && !__KERNEL__ */
#ifndef __KERNEL__
/* >> getfsfile(3)
 * Find and return the fstab entry with `strcmp(ent->fs_file, mount_point) == 0'
 ...
 * @return: NULL: [errno = <unchanged>] No entry exists matching `mount_point'
 * @return: NULL: [errno = *] Error */
INTDEF WUNUSED NONNULL((1)) struct fstab *NOTHROW_NCX(LIBCCALL libc_getfsfile)(const char *mount_point);
#endif /* !__KERNEL__ */
