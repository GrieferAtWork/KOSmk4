...
INTDEF char const *NOTHROW_NCX(LIBDCALL libd___shm_directory)(size_t *len);
#endif /* !__LIBCCALL_IS_LIBDCALL && !__KERNEL__ */
#ifndef __KERNEL__
/* Weird function that just returns "/dev/shm/" */
INTDEF char const *NOTHROW_NCX(LIBCCALL libc___shm_directory)(size_t *len);
#endif /* !__KERNEL__ */
#if !defined(__LIBCCALL_IS_LIBDCALL) && !defined(__KERNEL__)
/* >> shm_open(3) */
