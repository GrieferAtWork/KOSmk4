...
INTERN ATTR_SECTION(".text.crt.sched.lockop") __NOBLOCK NONNULL((1, 2, 3)) void
...
#endif /* !_KOS_LOCKOP_H */
#include <hybrid/__atomic.h>
INTERN ATTR_SECTION(".text.crt.sched.lockop") __NOBLOCK NONNULL((1, 2, 3, 5)) void
...
INTERN ATTR_SECTION(".text.crt.sched.lockop") __NOBLOCK NONNULL((1, 2)) void
