...
INTDEF ATTR_ACCESS_WR(1) errno_t NOTHROW_NCX(LIBDCALL libd_posix_memalign)(void **__restrict pp, size_t alignment, size_t n_bytes);
...
INTDEF ATTR_MALLOC ATTR_MALL_DEFAULT_ALIGNED WUNUSED ATTR_ACCESS_ROS(1, 2) ATTR_ALLOC_SIZE((2)) void *NOTHROW_NCX(LIBDCALL libd_memdup)(void const *__restrict ptr, size_t n_bytes);
INTDEF ATTR_MALLOC ATTR_MALL_DEFAULT_ALIGNED WUNUSED ATTR_ACCESS_ROS(1, 3) ATTR_ALLOC_SIZE((2)) void *NOTHROW_NCX(LIBDCALL libd_memcdup)(void const *__restrict ptr, int needle, size_t n_bytes);
