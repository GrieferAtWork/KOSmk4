...
INTDEF int NOTHROW_NCX(LIBDCALL libd_fmtmsg)(long classification, char const *label, __STDC_INT_AS_UINT_T severity, char const *text, char const *action, char const *tag);
/* >> addseverity(3)
...
INTDEF int NOTHROW_NCX(LIBDCALL libd_addseverity)(__STDC_INT_AS_UINT_T severity, char const *s);
