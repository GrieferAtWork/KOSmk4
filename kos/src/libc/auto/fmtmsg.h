...
INTDEF int NOTHROW_NCX(LIBDCALL libd_fmtmsg)(long classification, const char *label, int severity, char const *text, char const *action, char const *tag);
/* >> addseverity(3)
...
INTDEF int NOTHROW_NCX(LIBDCALL libd_addseverity)(int severity, const char *s);
