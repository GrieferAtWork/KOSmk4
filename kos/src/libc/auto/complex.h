...
INTDEF NONNULL((2, 3)) void NOTHROW_NCX(LIBCCALL libc__cchshf)(float x, float *c, float *s);
/* calculate cosh and sinh */
INTDEF NONNULL((2, 3)) void NOTHROW_NCX(LIBCCALL libc__cchshl)(__LONGDOUBLE x, __LONGDOUBLE *c, __LONGDOUBLE *s);
/* calculate cosh and sinh */
INTDEF NONNULL((2, 3)) void NOTHROW_NCX(LIBCCALL libc__cchsh)(double x, double *c, double *s);
