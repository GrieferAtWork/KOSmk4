 ...
 */
#ifndef GUARD_LIBC_AUTO_BITS_SCHED_H
#define GUARD_LIBC_AUTO_BITS_SCHED_H 1
...
INTDEF int NOTHROW_NCX(LIBDCALL libd_unshare)(int flags);
/* >> setns(2)
 ...
 *                `CLONE_NEWUTS') */
INTDEF int NOTHROW_NCX(LIBDCALL libd_setns)(fd_t fd, int nstype);
...
#endif /* !GUARD_LIBC_AUTO_BITS_SCHED_H */
