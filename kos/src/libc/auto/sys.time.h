...
INTDEF ATTR_OUT_OPT(1) ATTR_OUT_OPT(2) int NOTHROW_NCX(LIBDCALL libd_gettimeofday)(struct timeval *__restrict tv, __timezone_ptr_t tz);
/* >> getitimer(2), getitimer64(2) */
INTDEF ATTR_OUT(2) int NOTHROW_NCX(LIBDCALL libd_getitimer)(__itimer_which_t which, struct itimerval *curr_value);
/* >> setitimer(2), setitimer64(2) */
INTDEF ATTR_IN_OPT(2) ATTR_OUT_OPT(3) int NOTHROW_NCX(LIBDCALL libd_setitimer)(__itimer_which_t which, struct itimerval const *newval, struct itimerval *oldval);
/* >> utimes(2), utimes64(2) */
...
INTDEF ATTR_IN_OPT(1) ATTR_OUT_OPT(2) int NOTHROW_NCX(LIBDCALL libd_adjtime)(struct timeval const *delta, struct timeval *olddelta);
...
/* >> getitimer(2), getitimer64(2) */
INTDEF ATTR_OUT(2) int NOTHROW_NCX(LIBDCALL libd_getitimer64)(__itimer_which_t which, struct itimerval64 *curr_value);
/* >> setitimer(2), setitimer64(2) */
INTDEF ATTR_IN_OPT(2) ATTR_OUT_OPT(3) int NOTHROW_NCX(LIBDCALL libd_setitimer64)(__itimer_which_t which, struct itimerval64 const *newval, struct itimerval64 *oldval);
/* >> utimes(2), utimes64(2) */
INTDEF ATTR_IN(1) ATTR_IN_OPT(2) int NOTHROW_NCX(LIBDCALL libd_utimes64)(char const *file, struct timeval64 const tvp[2]);
/* >> settimeofday(2), settimeofday64(2) */
INTDEF ATTR_IN_OPT(1) ATTR_IN_OPT(2) int NOTHROW_NCX(LIBDCALL libd_settimeofday64)(struct timeval64 const *tv, struct timezone const *tz);
/* >> adjtime(3), adjtime64(3) */
INTDEF ATTR_IN_OPT(1) ATTR_OUT_OPT(2) int NOTHROW_NCX(LIBDCALL libd_adjtime64)(struct timeval64 const *delta, struct timeval64 *olddelta);
/* >> lutimes(2), lutimes64(2) */
