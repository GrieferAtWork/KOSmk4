...
#endif /* !__KERNEL__ */
#if !defined(__LIBCCALL_IS_LIBDCALL) && !defined(__KERNEL__)
INTDEF WUNUSED ATTR_IN(2) ATTR_INOUT(1) ATTR_OUT(3) int NOTHROW_NCX(LIBDCALL libd_getsubopt)(char **__restrict optionp, char *const *__restrict tokens, char **__restrict valuep);
#endif /* !__LIBCCALL_IS_LIBDCALL && !__KERNEL__ */
#ifndef __KERNEL__
INTDEF WUNUSED ATTR_IN(2) ATTR_INOUT(1) ATTR_OUT(3) int NOTHROW_NCX(LIBCCALL libc_getsubopt)(char **__restrict optionp, char *const *__restrict tokens, char **__restrict valuep);
#endif /* !__KERNEL__ */
#if !defined(__LIBCCALL_IS_LIBDCALL) && !defined(__KERNEL__)
...
#endif /* !__KERNEL__ */
#if !defined(__LIBCCALL_IS_LIBDCALL) && !defined(__KERNEL__)
INTDEF ATTR_OUT(1) errno_t NOTHROW_RPC(LIBDCALL libd__get_environ)(char ***p_environ);
#endif /* !__LIBCCALL_IS_LIBDCALL && !__KERNEL__ */
#ifndef __KERNEL__
INTDEF ATTR_OUT(1) errno_t NOTHROW_RPC(LIBCCALL libc__get_environ)(char ***p_environ);
INTDEF ATTR_OUT(1) errno_t NOTHROW_RPC(LIBDCALL libd__get_wenviron)(char16_t ***p_wenviron);
INTDEF ATTR_OUT(1) errno_t NOTHROW_RPC(LIBKCALL libc__get_wenviron)(char32_t ***p_wenviron);
#endif /* !__KERNEL__ */
