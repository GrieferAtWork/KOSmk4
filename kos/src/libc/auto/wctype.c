...
NOTHROW_NCX(LIBCCALL libc_towctrans)(wint_t wc, wctrans_t desc) {
	/* TODO */
	(void)wc;
	(void)desc;
	return 0;
...
NOTHROW_NCX(LIBCCALL libc_iswctype)(wint_t wc, wctype_t desc) {
	/* TODO */
	(void)wc;
	(void)desc;
	return 0;
...
NOTHROW_NCX(LIBCCALL libc_iswalnum_l)(wint_t wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return iswalnum(wc);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.ctype") ATTR_PURE WUNUSED int
NOTHROW_NCX(LIBCCALL libc_iswalpha_l)(wint_t wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return iswalpha(wc);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.ctype") ATTR_PURE WUNUSED int
NOTHROW_NCX(LIBCCALL libc_iswcntrl_l)(wint_t wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return iswcntrl(wc);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.ctype") ATTR_PURE WUNUSED int
NOTHROW_NCX(LIBCCALL libc_iswdigit_l)(wint_t wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return iswdigit(wc);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.ctype") ATTR_PURE WUNUSED int
NOTHROW_NCX(LIBCCALL libc_iswgraph_l)(wint_t wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return iswgraph(wc);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.ctype") ATTR_PURE WUNUSED int
NOTHROW_NCX(LIBCCALL libc_iswlower_l)(wint_t wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return iswlower(wc);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.ctype") ATTR_PURE WUNUSED int
NOTHROW_NCX(LIBCCALL libc_iswprint_l)(wint_t wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return iswprint(wc);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.ctype") ATTR_PURE WUNUSED int
NOTHROW_NCX(LIBCCALL libc_iswpunct_l)(wint_t wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return iswpunct(wc);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.ctype") ATTR_PURE WUNUSED int
NOTHROW_NCX(LIBCCALL libc_iswspace_l)(wint_t wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return iswspace(wc);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.ctype") ATTR_PURE WUNUSED int
NOTHROW_NCX(LIBCCALL libc_iswupper_l)(wint_t wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return iswupper(wc);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.ctype") ATTR_PURE WUNUSED int
NOTHROW_NCX(LIBCCALL libc_iswxdigit_l)(wint_t wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return iswxdigit(wc);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.ctype") ATTR_PURE WUNUSED int
NOTHROW_NCX(LIBCCALL libc_iswblank_l)(wint_t wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return iswblank(wc);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.ctype") ATTR_PURE WUNUSED int
NOTHROW_NCX(LIBCCALL libc_iswctype_l)(wint_t wc, wctype_t type, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return iswctype(wc, type);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.ctype") ATTR_PURE WUNUSED wint_t
NOTHROW_NCX(LIBCCALL libc_towupper_l)(wint_t wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return towupper(wc);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.ctype") ATTR_PURE WUNUSED wint_t
NOTHROW_NCX(LIBCCALL libc_towlower_l)(wint_t wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return towlower(wc);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.mbs") WUNUSED NONNULL((1)) wctype_t
NOTHROW_NCX(LIBCCALL libc_wctype_l)(char const *prop, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return wctype(prop);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.mbs") WUNUSED NONNULL((1)) wctrans_t
NOTHROW_NCX(LIBCCALL libc_wctrans_l)(char const *prop, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
	return wctrans(prop);
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.mbs") WUNUSED wint_t
NOTHROW_NCX(LIBCCALL libc_towctrans_l)(wint_t wc, wctrans_t desc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
...
NOTHROW_NCX(LIBCCALL libc__isleadbyte_l)(int wc, locale_t locale) {
	(void)locale;
	COMPILER_IMPURE();
...
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.mbs") ATTR_PURE WUNUSED int
NOTHROW_NCX(LIBCCALL libc__iswcsymf_l)(wint_t wc, locale_t locale) {
	return iswalpha_l(wc, locale) || wc == '_' || wc == '$';
}
INTERN ATTR_SECTION(".text.crt.wchar.unicode.locale.mbs") ATTR_PURE WUNUSED int
NOTHROW_NCX(LIBCCALL libc__iswcsym_l)(wint_t wc, locale_t locale) {
