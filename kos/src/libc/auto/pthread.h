 ...
 * @return: ETIMEDOUT: The given `abstime' has expired */
INTDEF ATTR_IN_OPT(4) ATTR_OUT_OPT(2) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_clockjoin_np)(pthread_t self, void **thread_return, clockid_t clock_id, struct timespec const *abstime);
/* >> pthread_timedjoin_np(3), pthread_timedjoin64_np(3)
 * Make calling thread  wait for termination  of the thread  `self',
 * but only until `timeout'. The exit status of the thread is stored
 * in  `*thread_return',   if   `thread_return'   is   not   `NULL'.
 ...
 * @return: EINVAL:    Invalid/unsupported `clock_id'
 * @return: ETIMEDOUT: The given `abstime' has expired */
INTDEF ATTR_IN_OPT(4) ATTR_OUT_OPT(2) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_clockjoin64_np)(pthread_t self, void **thread_return, clockid_t clock_id, struct timespec64 const *abstime);
/* >> pthread_detach(3)
 ...
 * @return: EDEADLK:   [PTHREAD_RWLOCK_PREFER_WRITER_NONRECURSIVE_NP]
 *                     You're already holding a read-lock */
INTDEF WUNUSED ATTR_IN(3) ATTR_INOUT(1) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_rwlock_clockrdlock)(pthread_rwlock_t *__restrict self, clockid_t clock_id, struct timespec const *__restrict abstime);
 ...
 * @return: EDEADLK:   [!PTHREAD_RWLOCK_PREFER_WRITER_NONRECURSIVE_NP]
 *                     You're already holding a write-lock */
INTDEF WUNUSED ATTR_IN(3) ATTR_INOUT(1) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_rwlock_clockwrlock)(pthread_rwlock_t *__restrict self, clockid_t clock_id, struct timespec const *__restrict abstime);
/* >> pthread_rwlock_clockrdlock(3), pthread_rwlock_clockrdlock64(3)
 * Same  as `pthread_rwlock_timedrdlock(3)', but  the given `abstime'  is relative to `clock_id',
 * whereas when using `pthread_rwlock_timedrdlock(3)', it is always relative to `CLOCK_REALTIME'.
 * @return: EOK:       Success
 ...
 * @return: EDEADLK:   [PTHREAD_RWLOCK_PREFER_WRITER_NONRECURSIVE_NP]
 *                     You're already holding a read-lock */
INTDEF WUNUSED ATTR_IN(3) ATTR_INOUT(1) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_rwlock_clockrdlock64)(pthread_rwlock_t *__restrict self, clockid_t clock_id, struct timespec64 const *__restrict abstime);
/* >> pthread_rwlock_clockwrlock(3), pthread_rwlock_clockwrlock64(3)
 * Same  as `pthread_rwlock_timedwrlock(3)', but  the given `abstime'  is relative to `clock_id',
 * whereas when using `pthread_rwlock_timedwrlock(3)', it is always relative to `CLOCK_REALTIME'.
 * @return: EOK:       Success
 ...
 * @return: EDEADLK:   [!PTHREAD_RWLOCK_PREFER_WRITER_NONRECURSIVE_NP]
 *                     You're already holding a write-lock */
INTDEF WUNUSED ATTR_IN(3) ATTR_INOUT(1) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_rwlock_clockwrlock64)(pthread_rwlock_t *__restrict self, clockid_t clock_id, struct timespec64 const *__restrict abstime);
 ...
 * @return: EINVAL:    Invalid/unsupported `clock_id'
 * @return: ETIMEDOUT: The given `abstime' has expired */
INTDEF WUNUSED ATTR_IN(4) ATTR_INOUT(1) ATTR_INOUT(2) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_cond_clockwait)(pthread_cond_t *__restrict self, pthread_mutex_t *__restrict mutex, clockid_t clock_id, struct timespec const *__restrict abstime);
/* >> pthread_cond_clockwait(3), pthread_cond_clockwait64(3)
 * Same as `pthread_cond_timedwait(3)', but the given `abstime' is relative to `clock_id',
 * whereas  when using `pthread_cond_timedwait(3)',  it is relative  to whatever clock was
 * previously  set  by  `pthread_condattr_setclock(3)'  (or  `CLOCK_REALTIME'  when  never
 ...
 * @return: EINVAL:    Invalid/unsupported `clock_id'
 * @return: ETIMEDOUT: The given `abstime' has expired */
INTDEF WUNUSED ATTR_IN(4) ATTR_INOUT(1) ATTR_INOUT(2) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_cond_clockwait64)(pthread_cond_t *__restrict self, pthread_mutex_t *__restrict mutex, clockid_t clock_id, struct timespec64 const *__restrict abstime);
