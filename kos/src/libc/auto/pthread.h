...
/* Try locking a mutex */
INTDEF NONNULL((1)) errno_t NOTHROW_NCX(LIBDCALL libd_pthread_mutex_trylock)(pthread_mutex_t *mutex);
/* Lock a mutex */
INTDEF NONNULL((1)) errno_t NOTHROW_NCX(LIBDCALL libd_pthread_mutex_lock)(pthread_mutex_t *mutex);
/* Wait until lock becomes available, or specified time passes */
INTDEF NONNULL((1, 2)) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_mutex_timedlock)(pthread_mutex_t *__restrict mutex, struct timespec const *__restrict abstime);
/* Wait until lock becomes available, or specified time passes */
INTDEF NONNULL((1, 2)) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_mutex_timedlock64)(pthread_mutex_t *__restrict mutex, struct timespec64 const *__restrict abstime);
/* Unlock a mutex */
...
INTDEF NONNULL((1, 3)) errno_t NOTHROW_NCX(LIBDCALL libd_pthread_mutex_setprioceiling)(pthread_mutex_t *__restrict mutex, int prioceiling, int *__restrict old_ceiling);
...
INTDEF NONNULL((1)) errno_t NOTHROW_NCX(LIBDCALL libd_pthread_rwlock_tryrdlock)(pthread_rwlock_t *rwlock);
/* Try to acquire read lock for RWLOCK or return after specfied time */
INTDEF NONNULL((1, 2)) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_rwlock_timedrdlock)(pthread_rwlock_t *__restrict rwlock, struct timespec const *__restrict abstime);
/* Try to acquire read lock for RWLOCK or return after specfied time */
INTDEF NONNULL((1, 2)) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_rwlock_timedrdlock64)(pthread_rwlock_t *__restrict rwlock, struct timespec64 const *__restrict abstime);
/* Acquire write lock for RWLOCK */
INTDEF NONNULL((1)) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_rwlock_wrlock)(pthread_rwlock_t *rwlock);
/* Try to acquire write lock for RWLOCK */
INTDEF NONNULL((1)) errno_t NOTHROW_NCX(LIBDCALL libd_pthread_rwlock_trywrlock)(pthread_rwlock_t *rwlock);
/* Try to acquire write lock for RWLOCK or return after specfied time */
INTDEF NONNULL((1, 2)) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_rwlock_timedwrlock)(pthread_rwlock_t *__restrict rwlock, struct timespec const *__restrict abstime);
/* Try to acquire write lock for RWLOCK or return after specfied time */
INTDEF NONNULL((1, 2)) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_rwlock_timedwrlock64)(pthread_rwlock_t *__restrict rwlock, struct timespec64 const *__restrict abstime);
/* Unlock RWLOCK */
...
INTDEF NONNULL((1, 2, 3)) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_cond_timedwait)(pthread_cond_t *__restrict cond, pthread_mutex_t *__restrict mutex, struct timespec const *__restrict abstime);
/* Wait for condition variable COND to be signaled or broadcast until
 * ABSTIME. MUTEX is assumed to be locked before. ABSTIME is an
 * absolute time specification; zero is the beginning of the epoch
 * (00:00:00 GMT, January 1, 1970). */
INTDEF NONNULL((1, 2, 3)) errno_t NOTHROW_RPC(LIBDCALL libd_pthread_cond_timedwait64)(pthread_cond_t *__restrict cond, pthread_mutex_t *__restrict mutex, struct timespec64 const *__restrict abstime);
...
INTDEF NONNULL((1)) errno_t NOTHROW_NCX(LIBDCALL libd_pthread_spin_trylock)(pthread_spinlock_t *lock);
#endif /* !__LIBCCALL_IS_LIBDCALL && !__KERNEL__ */
#ifndef __KERNEL__
/* Try to lock spinlock LOCK */
INTDEF NONNULL((1)) errno_t NOTHROW_NCX(LIBCCALL libc_pthread_spin_trylock)(pthread_spinlock_t *lock);
#endif /* !__KERNEL__ */
#if !defined(__LIBCCALL_IS_LIBDCALL) && !defined(__KERNEL__)
