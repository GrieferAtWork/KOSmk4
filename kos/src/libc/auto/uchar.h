...
INTDEF ATTR_MALLOC WUNUSED char *NOTHROW_NCX(LIBKCALL libc_convert_wcstombsn)(char32_t const *__restrict str, size_t len, size_t *preslen);
INTDEF ATTR_MALLOC WUNUSED char **NOTHROW_NCX(LIBDCALL libd_convert_wcstombsv)(char16_t const *const *__restrict vector);
INTDEF ATTR_MALLOC WUNUSED char **NOTHROW_NCX(LIBKCALL libc_convert_wcstombsv)(char32_t const *const *__restrict vector);
INTDEF ATTR_MALLOC WUNUSED char **NOTHROW_NCX(LIBDCALL libd_convert_wcstombsvn)(char16_t const *const *__restrict vector, size_t count);
INTDEF ATTR_MALLOC WUNUSED char **NOTHROW_NCX(LIBKCALL libc_convert_wcstombsvn)(char32_t const *const *__restrict vector, size_t count);
INTDEF ATTR_MALLOC WUNUSED char16_t *NOTHROW_NCX(LIBDCALL libd_convert_mbstowcs)(char const *__restrict str);
