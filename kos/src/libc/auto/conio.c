...
INTERN ATTR_SECTION(".text.crt.dos.conio") ATTR_ACCESS_RW(1) char *
...
INTERN ATTR_SECTION(".text.crt.dos.conio") ATTR_ACCESS_WR(3) ATTR_ACCESS_WRS(1, 2) errno_t
...
#include <libc/template/stdtty.h>
INTERN ATTR_SECTION(".text.crt.dos.conio") ATTR_ACCESS_RO(1) int
...
#include <libc/template/stdtty.h>
INTERN ATTR_SECTION(".text.crt.dos.conio") ATTR_ACCESS_RO(2) ATTR_LIBC_PRINTF(2, 0) __STDC_INT_AS_SSIZE_T
...
INTERN ATTR_SECTION(".text.crt.dos.conio") WUNUSED ATTR_ACCESS_RO(2) ATTR_LIBC_SCANF(2, 0) __STDC_INT_AS_SSIZE_T
...
INTERN ATTR_SECTION(".text.crt.dos.conio") ATTR_ACCESS_RO(1) ATTR_LIBC_PRINTF(1, 0) __STDC_INT_AS_SSIZE_T
...
#include <corecrt_stdio_config.h>
INTERN ATTR_SECTION(".text.crt.dos.conio") WUNUSED ATTR_ACCESS_RO(1) ATTR_LIBC_SCANF(1, 0) __STDC_INT_AS_SSIZE_T
...
INTERN ATTR_OPTIMIZE_SIZE ATTR_SECTION(".text.crt.dos.conio") ATTR_ACCESS_RO(1) ATTR_LIBC_PRINTF(1, 2) __STDC_INT_AS_SSIZE_T
...
#ifndef __KERNEL__
INTERN ATTR_SECTION(".text.crt.dos.conio") ATTR_ACCESS_RO(1) ATTR_LIBC_PRINTF(1, 2) __STDC_INT_AS_SSIZE_T
...
#endif /* !__KERNEL__ */
#if !defined(__LIBCCALL_IS_LIBDCALL) && !defined(__KERNEL__)
INTERN ATTR_OPTIMIZE_SIZE ATTR_SECTION(".text.crt.dos.conio") ATTR_ACCESS_RO(1) ATTR_LIBC_PRINTF(1, 3) __STDC_INT_AS_SSIZE_T
...
#endif /* !__LIBCCALL_IS_LIBDCALL && !__KERNEL__ */
#ifndef __KERNEL__
INTERN ATTR_SECTION(".text.crt.dos.conio") ATTR_ACCESS_RO(1) ATTR_LIBC_PRINTF(1, 3) __STDC_INT_AS_SSIZE_T
...
#endif /* !__KERNEL__ */
#if !defined(__LIBCCALL_IS_LIBDCALL) && !defined(__KERNEL__)
INTERN ATTR_OPTIMIZE_SIZE ATTR_SECTION(".text.crt.dos.conio") WUNUSED ATTR_ACCESS_RO(1) ATTR_LIBC_SCANF(1, 2) __STDC_INT_AS_SSIZE_T
...
#endif /* !__LIBCCALL_IS_LIBDCALL && !__KERNEL__ */
#ifndef __KERNEL__
INTERN ATTR_SECTION(".text.crt.dos.conio") WUNUSED ATTR_ACCESS_RO(1) ATTR_LIBC_SCANF(1, 2) __STDC_INT_AS_SSIZE_T
...
#endif /* !__KERNEL__ */
#if !defined(__LIBCCALL_IS_LIBDCALL) && !defined(__KERNEL__)
INTERN ATTR_OPTIMIZE_SIZE ATTR_SECTION(".text.crt.dos.conio") WUNUSED ATTR_ACCESS_RO(1) ATTR_LIBC_SCANF(1, 3) __STDC_INT_AS_SSIZE_T
...
#endif /* !__LIBCCALL_IS_LIBDCALL && !__KERNEL__ */
#ifndef __KERNEL__
INTERN ATTR_SECTION(".text.crt.dos.conio") WUNUSED ATTR_ACCESS_RO(1) ATTR_LIBC_SCANF(1, 3) __STDC_INT_AS_SSIZE_T
...
INTERN ATTR_SECTION(".text.crt.dos.conio") ATTR_ACCESS_RO(1) ATTR_ACCESS_RW(2) char *
...
INTERN ATTR_SECTION(".text.crt.dos.conio") ATTR_ACCESS_RO(3) void
...
INTERN ATTR_SECTION(".text.crt.dos.conio") ATTR_ACCESS_WR(1) int
