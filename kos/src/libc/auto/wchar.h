...
INTDEF NONNULL((1, 3)) ATTR_LIBC_WPRINTF(3, 0) __STDC_INT_AS_SIZE_T NOTHROW_NCX(LIBCCALL libc_vswprintf)(char32_t *__restrict buf, size_t buflen, char32_t const *__restrict format, va_list args);
INTDEF NONNULL((1, 3)) ATTR_LIBC_WPRINTF(3, 0) __STDC_INT_AS_SIZE_T NOTHROW_NCX(LIBDCALL libd_vswprintf)(char16_t *__restrict buf, size_t buflen, char16_t const *__restrict format, va_list args);
INTDEF NONNULL((1, 3)) ATTR_LIBC_WPRINTF(3, 4) __STDC_INT_AS_SIZE_T NOTHROW_NCX(VLIBCCALL libc_swprintf)(char32_t *__restrict buf, size_t buflen, char32_t const *__restrict format, ...);
INTDEF NONNULL((1, 3)) ATTR_LIBC_WPRINTF(3, 4) __STDC_INT_AS_SIZE_T NOTHROW_NCX(VLIBDCALL libd_swprintf)(char16_t *__restrict buf, size_t buflen, char16_t const *__restrict format, ...);
