...
INTDEF size_t NOTHROW_NCX(LIBCCALL libc_mbrtowc)(char32_t *pwc, char const *__restrict str, size_t maxlen, mbstate_t *mbs);
INTDEF size_t NOTHROW_NCX(LIBDCALL libd_mbrtowc)(char16_t *pwc, char const *__restrict str, size_t maxlen, mbstate_t *mbs);
INTDEF size_t NOTHROW_NCX(LIBCCALL libc_wcrtomb)(char *__restrict str, char32_t wc, mbstate_t *mbs);
INTDEF size_t NOTHROW_NCX(LIBDCALL libd_wcrtomb)(char *__restrict str, char16_t wc, mbstate_t *mbs);
INTDEF WUNUSED size_t NOTHROW_NCX(LIBCCALL libc_mbrlen)(char const *__restrict str, size_t maxlen, mbstate_t *mbs);
INTDEF WUNUSED size_t NOTHROW_NCX(LIBDCALL libd_mbrlen)(char const *__restrict str, size_t maxlen, mbstate_t *mbs);
INTDEF NONNULL((1, 2)) size_t NOTHROW_NCX(LIBCCALL libc_mbsrtowcs)(char32_t *__restrict dst, char const **__restrict psrc, size_t dstlen, mbstate_t *mbs);
...
INTDEF NONNULL((1, 2)) size_t NOTHROW_NCX(LIBCCALL libc_wcsrtombs)(char *dst, char32_t const **__restrict psrc, size_t dstlen, mbstate_t *mbs);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wmemcmp)(char32_t const *s1, char32_t const *s2, size_t num_chars);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wcscmp)(char32_t const *s1, char32_t const *s2);
/* Compare 2 strings and return the difference of the first non-matching character, or `0' if they are identical */
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wcsncmp)(char32_t const *s1, char32_t const *s2, size_t maxlen);
/* Same as `wcscmp', but compare at most `MAXLEN' characters from either string */
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wcscoll)(char32_t const *s1, char32_t const *s2);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1)) size_t NOTHROW_NCX(LIBCCALL libc_wcslen)(char32_t const *__restrict string);
/* Return the length of the string in characters (Same as `rawmemlen[...](STR, '\0')') */
INTDEF ATTR_PURE WUNUSED NONNULL((1)) size_t NOTHROW_NCX(LIBDCALL libd_wcslen)(char16_t const *__restrict string);
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) size_t NOTHROW_NCX(LIBCCALL libc_wcsspn)(char32_t const *haystack, char32_t const *accept);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) size_t NOTHROW_NCX(LIBCCALL libc_wcscspn)(char32_t const *haystack, char32_t const *reject);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1)) char32_t *NOTHROW_NCX(LIBCCALL libc_wcschr)(char32_t const *__restrict haystack, char32_t needle);
/* Return the pointer of the first instance of `NEEDLE', or `NULL' if `NEEDLE' wasn't found. */
...
INTDEF ATTR_PURE WUNUSED NONNULL((1)) char32_t *NOTHROW_NCX(LIBCCALL libc_wcsrchr)(char32_t const *__restrict haystack, char32_t needle);
/* Return the pointer of the last instance of `NEEDLE', or `NULL' if `NEEDLE' wasn't found. */
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) char32_t *NOTHROW_NCX(LIBCCALL libc_wcspbrk)(char32_t const *haystack, char32_t const *accept);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) char32_t *NOTHROW_NCX(LIBCCALL libc_wcsstr)(char32_t const *haystack, char32_t const *needle);
/* Search for a given `NEEDLE' appearing as a sub-string within `HAYSTACK'
 * If no such needle exists, return `NULL' */
...
INTDEF ATTR_PURE NONNULL((1)) __LONGDOUBLE NOTHROW_NCX(LIBCCALL libc_wcstold)(char32_t const *__restrict nptr, char32_t **endptr);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wcsncasecmp)(char32_t const *s1, char32_t const *s2, size_t maxlen);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wcscasecmp_l)(char32_t const *s1, char32_t const *s2, locale_t locale);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wcsncasecmp_l)(char32_t const *s1, char32_t const *s2, size_t maxlen, locale_t locale);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wcscoll_l)(char32_t const *s1, char32_t const *s2, locale_t locale);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1)) size_t NOTHROW_NCX(LIBCCALL libc_wcsnlen)(char32_t const *__restrict string, size_t maxlen);
/* Same as `wcslen', but don't exceed `MAX_CHARS' characters (Same as `memlen[...](STR, '\0', MAX_CHARS)´) */
...
INTDEF ATTR_PURE WUNUSED NONNULL((1)) __LONGDOUBLE NOTHROW_NCX(LIBCCALL libc_wcstold_l)(char32_t const *__restrict nptr, char32_t **endptr, locale_t locale);
...
INTDEF ATTR_PURE ATTR_RETNONNULL WUNUSED NONNULL((1)) char32_t *NOTHROW_NCX(LIBCCALL libc_wcsend)(char32_t const *__restrict string);
/* Same as `STR+wcslen(STR)' */
...
INTDEF ATTR_PURE ATTR_RETNONNULL WUNUSED NONNULL((1)) char32_t *NOTHROW_NCX(LIBCCALL libc_wcsnchrnul)(char32_t const *__restrict haystack, char32_t needle, size_t maxlen);
/* Same as `wcsnchr', but return `wcsnend(STR, MAX_CHARS)', rather than `NULL' if `NEEDLE' wasn't found. */
...
INTDEF ATTR_PURE ATTR_RETNONNULL WUNUSED NONNULL((1)) char32_t *NOTHROW_NCX(LIBCCALL libc_wcsnrchrnul)(char32_t const *__restrict haystack, char32_t needle, size_t maxlen);
/* Same as `wcsnrchr', but return `STR-1', rather than `NULL' if `NEEDLE' wasn't found. */
...
INTDEF ATTR_PURE WUNUSED NONNULL((1)) size_t NOTHROW_NCX(LIBCCALL libc_wcsoff)(char32_t const *__restrict haystack, char32_t needle);
/* Same as `wcschrnul', but return the offset from `STR', rather than the actual address */
...
INTDEF ATTR_PURE WUNUSED NONNULL((1)) size_t NOTHROW_NCX(LIBCCALL libc_wcsroff)(char32_t const *__restrict haystack, char32_t needle);
/* Same as `wcsrchrnul', but return the offset from `STR', rather than the actual address */
...
INTDEF ATTR_PURE WUNUSED NONNULL((1)) size_t NOTHROW_NCX(LIBCCALL libc_wcsnoff)(char32_t const *__restrict haystack, char32_t needle, size_t maxlen);
/* Same as `wcsnchrnul', but return the offset from `STR', rather than the actual address */
...
INTDEF ATTR_PURE WUNUSED NONNULL((1)) size_t NOTHROW_NCX(LIBCCALL libc_wcsnroff)(char32_t const *__restrict haystack, char32_t needle, size_t maxlen);
/* Same as `wcsnrchrnul', but return the offset from `STR', rather than the actual address */
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 3)) size_t NOTHROW_NCX(LIBCCALL libc_fuzzy_wmemcmp)(char32_t const *s1, size_t s1_chars, char32_t const *s2, size_t s2_chars);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) size_t NOTHROW_NCX(LIBCCALL libc_fuzzy_wcscmp)(char32_t const *s1, char32_t const *s2);
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) size_t NOTHROW_NCX(LIBDCALL libd_fuzzy_wcscmp)(char16_t const *s1, char16_t const *s2);
INTDEF ATTR_PURE WUNUSED NONNULL((1, 3)) size_t NOTHROW_NCX(LIBCCALL libc_fuzzy_wcsncmp)(char32_t const *s1, size_t s1_maxlen, char32_t const *s2, size_t s2_maxlen);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 3)) size_t NOTHROW_NCX(LIBCCALL libc_fuzzy_wmemcasecmp)(char32_t const *s1, size_t s1_bytes, char32_t const *s2, size_t s2_bytes);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) size_t NOTHROW_NCX(LIBCCALL libc_fuzzy_wcscasecmp)(char32_t const *s1, char32_t const *s2);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 3)) size_t NOTHROW_NCX(LIBCCALL libc_fuzzy_wcsncasecmp)(char32_t const *s1, size_t s1_maxlen, char32_t const *s2, size_t s2_maxlen);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wildwcscmp)(char32_t const *pattern, char32_t const *string);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wildwcscasecmp)(char32_t const *pattern, char32_t const *string);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wcsverscmp)(char32_t const *s1, char32_t const *s2);
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBDCALL libd_wcsverscmp)(char16_t const *s1, char16_t const *s2);
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wcsncoll_l)(char32_t const *s1, char32_t const *s2, size_t maxlen, locale_t locale);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wcscasecoll_l)(char32_t const *s1, char32_t const *s2, locale_t locale);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wcsncasecoll_l)(char32_t const *s1, char32_t const *s2, size_t maxlen, locale_t locale);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) char32_t *NOTHROW_NCX(LIBCCALL libc_wcscasestr_l)(char32_t const *haystack, char32_t const *needle, locale_t locale);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 3)) size_t NOTHROW_NCX(LIBCCALL libc_fuzzy_wmemcasecmp_l)(char32_t const *s1, size_t s1_bytes, char32_t const *s2, size_t s2_bytes, locale_t locale);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) size_t NOTHROW_NCX(LIBCCALL libc_fuzzy_wcscasecmp_l)(char32_t const *s1, char32_t const *s2, locale_t locale);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 3)) size_t NOTHROW_NCX(LIBCCALL libc_fuzzy_wcsncasecmp_l)(char32_t const *s1, size_t s1_maxlen, char32_t const *s2, size_t s2_maxlen, locale_t locale);
...
INTDEF ATTR_PURE WUNUSED NONNULL((1, 2)) int NOTHROW_NCX(LIBCCALL libc_wildwcscasecmp_l)(char32_t const *pattern, char32_t const *string, locale_t locale);
...
INTDEF WUNUSED NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBCCALL libc__vscwprintf_p)(char32_t const *format, va_list args);
...
INTDEF WUNUSED NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBCCALL libc__scwprintf_p)(char32_t const *format, ...);
INTDEF WUNUSED NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBDCALL libd__scwprintf_p)(char16_t const *format, ...);
INTDEF WUNUSED NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBCCALL libc__vscwprintf_l)(char32_t const *format, locale_t locale, va_list args);
...
INTDEF WUNUSED NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBCCALL libc__scwprintf_l)(char32_t const *format, locale_t locale, ...);
...
INTDEF WUNUSED NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBCCALL libc__vscwprintf_p_l)(char32_t const *format, locale_t locale, va_list args);
...
INTDEF WUNUSED NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBCCALL libc__scwprintf_p_l)(char32_t const *format, locale_t locale, ...);
...
INTDEF NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T (LIBCCALL libc__vfwprintf_p)(FILE *stream, char32_t const *format, va_list args) __THROWS(...);
INTDEF NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T (LIBDCALL libd__vfwprintf_p)(FILE *stream, char16_t const *format, va_list args) __THROWS(...);
INTDEF NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T (VLIBCCALL libc__fwprintf_p)(FILE *stream, char32_t const *format, ...) __THROWS(...);
INTDEF NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T (VLIBDCALL libd__fwprintf_p)(FILE *stream, char16_t const *format, ...) __THROWS(...);
INTDEF NONNULL((1, 3)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBCCALL libc__vswprintf_p)(char32_t *buf, size_t bufsize, char32_t const *format, va_list args);
...
INTDEF NONNULL((1, 3)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBCCALL libc__swprintf_p)(char32_t *dst, size_t bufsize, char32_t const *format, ...);
...
INTDEF NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T (LIBCCALL libc__vfwprintf_p_l)(FILE *stream, char32_t const *format, locale_t locale, va_list args) __THROWS(...);
INTDEF NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T (LIBDCALL libd__vfwprintf_p_l)(FILE *stream, char16_t const *format, locale_t locale, va_list args) __THROWS(...);
INTDEF NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T (VLIBCCALL libc__fwprintf_p_l)(FILE *stream, char32_t const *format, locale_t locale, ...) __THROWS(...);
INTDEF NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T (VLIBDCALL libd__fwprintf_p_l)(FILE *stream, char16_t const *format, locale_t locale, ...) __THROWS(...);
INTDEF NONNULL((1, 3)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBCCALL libc__vswprintf_c_l)(char32_t *dst, size_t bufsize, char32_t const *format, locale_t locale, va_list args);
...
INTDEF NONNULL((1, 3)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBCCALL libc__swprintf_c_l)(char32_t *dst, size_t bufsize, char32_t const *format, locale_t locale, ...);
...
INTDEF NONNULL((1, 3)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBCCALL libc__vswprintf_p_l)(char32_t *dst, size_t bufsize, char32_t const *format, locale_t locale, va_list args);
...
INTDEF NONNULL((1, 3)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBCCALL libc__swprintf_p_l)(char32_t *dst, size_t bufsize, char32_t const *format, locale_t locale, ...);
...
INTDEF NONNULL((1, 3)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBCCALL libc__vswprintf_s_l)(char32_t *dst, size_t wchar_count, char32_t const *format, locale_t locale, va_list args);
...
INTDEF NONNULL((1, 3)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBCCALL libc__swprintf_s_l)(char32_t *dst, size_t wchar_count, char32_t const *format, locale_t locale, ...);
...
INTDEF NONNULL((1, 3)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBCCALL libc__vsnwprintf_l)(char32_t *dst, size_t bufsize, char32_t const *format, locale_t locale, va_list args);
...
INTDEF NONNULL((1, 3)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBCCALL libc__snwprintf_l)(char32_t *dst, size_t bufsize, char32_t const *format, locale_t locale, ...);
...
INTDEF NONNULL((1, 4)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBCCALL libc__vsnwprintf_s_l)(char32_t *dst, size_t wchar_count, size_t bufsize, char32_t const *format, locale_t locale, va_list args);
...
INTDEF NONNULL((1, 4)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBCCALL libc__snwprintf_s_l)(char32_t *dst, size_t wchar_count, size_t bufsize, char32_t const *format, locale_t locale, ...);
...
INTDEF WUNUSED NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBCCALL libc__vswscanf_l)(char32_t const *src, char32_t const *format, locale_t locale, va_list args);
...
INTDEF WUNUSED NONNULL((1, 2)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBCCALL libc__swscanf_l)(char32_t const *src, char32_t const *format, locale_t locale, ...);
...
INTDEF WUNUSED NONNULL((1, 3)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBCCALL libc__vsnwscanf_l)(char32_t const *src, size_t bufsize, char32_t const *format, locale_t locale, va_list args);
...
INTDEF WUNUSED NONNULL((1, 3)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBCCALL libc__snwscanf_l)(char32_t const *src, size_t bufsize, char32_t const *format, locale_t locale, ...);
