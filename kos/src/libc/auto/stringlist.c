...
INTERN ATTR_SECTION(".text.crt.bsd.stringlist") ATTR_ACCESS_RO(2) ATTR_ACCESS_RW(1) int
 ...
 * `free(3)'d. */
INTERN ATTR_SECTION(".text.crt.bsd.stringlist") ATTR_ACCESS_RW_OPT(1) void
...
INTERN ATTR_SECTION(".text.crt.bsd.stringlist") ATTR_PURE ATTR_ACCESS_RO(1) ATTR_ACCESS_RO(2) char *
...
INTERN ATTR_SECTION(".text.crt.bsd.stringlist") WUNUSED ATTR_ACCESS_RO(2) ATTR_ACCESS_RW(1) int
