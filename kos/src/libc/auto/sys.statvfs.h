...
INTDEF ATTR_OUT(2) int NOTHROW_NCX(LIBDCALL libd_fstatvfs)(fd_t filedes, struct statvfs *buf);
INTDEF ATTR_IN(1) ATTR_OUT(2) int NOTHROW_NCX(LIBDCALL libd_statvfs64)(const char *file, struct statvfs64 *buf);
INTDEF ATTR_OUT(2) int NOTHROW_NCX(LIBDCALL libd_fstatvfs64)(fd_t filedes, struct statvfs64 *buf);
