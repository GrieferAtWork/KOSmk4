...
INTDEF NONNULL((3, 6)) int NOTHROW_NCX(LIBDCALL libd_epoll_rpc_exec)(fd_t epfd, fd_t fd, struct epoll_event *event, pid_t target_tid, unsigned int mode, prpc_exec_callback_t func);
