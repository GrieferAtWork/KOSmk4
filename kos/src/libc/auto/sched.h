...
INTDEF int NOTHROW_NCX(LIBDCALL libd_sched_get_priority_max)(__STDC_INT_AS_UINT_T algorithm);
INTDEF int NOTHROW_NCX(LIBDCALL libd_sched_get_priority_min)(__STDC_INT_AS_UINT_T algorithm);
