...
INTDEF ATTR_LIBC_SCANF(2, 4) NONNULL((1, 2)) __STDC_INT_AS_SIZE_T (VLIBCCALL libc__sscanf_s_l)(char const *__restrict input, char const *__restrict format, locale_t locale, ...) __THROWS(...);
INTDEF ATTR_LIBC_SCANF(3, 4) NONNULL((1, 3)) __STDC_INT_AS_SIZE_T NOTHROW_NCX(VLIBCCALL libc__snscanf_s)(char const *__restrict input, size_t inputlen, char const *__restrict format, ...);
INTDEF ATTR_LIBC_SCANF(3, 5) NONNULL((1, 3)) __STDC_INT_AS_SIZE_T NOTHROW_NCX(VLIBCCALL libc__snscanf_s_l)(char const *__restrict input, size_t inputlen, char const *__restrict format, locale_t locale, ...);
