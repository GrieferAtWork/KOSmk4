...
NOTHROW_NCX(LIBCCALL libc__wfullpath_dbg)(__WCHAR16_TYPE__ *full_path,
                                          ...
                                          char const *filename,
                                          int line) {
#line 465 "kos/src/libc/magic/crtdbg.c"
	(void)block_type;
	(void)filename;
	(void)line;
	(void)full_path;
...
#line 598 "kos/src/libc/magic/crtdbg.c"
...
#line 625 "kos/src/libc/magic/crtdbg.c"
	COMPILER_IMPURE();
	return 0;
}
...
#line 638 "kos/src/libc/magic/crtdbg.c"
	COMPILER_IMPURE();
	return 0;
}
