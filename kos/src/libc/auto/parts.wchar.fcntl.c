...
#ifndef __KERNEL__
INTERN ATTR_OPTIMIZE_SIZE ATTR_SECTION(".text.crt.dos.wchar.io.utility") WUNUSED NONNULL((1)) fd_t
...
#endif /* __O_LARGEFILE */
INTERN ATTR_OPTIMIZE_SIZE ATTR_SECTION(".text.crt.dos.wchar.io.utility") WUNUSED NONNULL((2)) fd_t
