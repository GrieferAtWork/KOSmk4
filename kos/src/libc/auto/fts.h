...
INTDEF WUNUSED NONNULL((1)) FTSENT *NOTHROW_RPC(LIBDCALL libd_fts_children)(FTS *ftsp, __STDC_INT_AS_UINT_T instr);
 ...
 * @param: instr: One of `FTS_AGAIN', `FTS_FOLLOW', `FTS_NOINSTR' or `FTS_SKIP' */
INTDEF NONNULL((1, 2)) int NOTHROW_NCX(LIBDCALL libd_fts_set)(FTS *ftsp, FTSENT *f, __STDC_INT_AS_UINT_T instr);
/* >> fts_children(3), fts_children64(3)
 * @param: instr: One of `FTS_AGAIN', `FTS_FOLLOW', `FTS_NOINSTR' or `FTS_SKIP' */
INTDEF WUNUSED NONNULL((1)) FTSENT64 *NOTHROW_RPC(LIBDCALL libd_fts64_children)(FTS64 *ftsp, __STDC_INT_AS_UINT_T instr);
/* >> fts_close(3), fts_close64(3) */
...
/* >> fts_set(3), fts_set64(3)
 * @param: instr: One of `FTS_AGAIN', `FTS_FOLLOW', `FTS_NOINSTR' or `FTS_SKIP' */
INTDEF NONNULL((1, 2)) int NOTHROW_NCX(LIBDCALL libd_fts64_set)(FTS64 *ftsp, FTSENT64 *f, __STDC_INT_AS_UINT_T instr);
