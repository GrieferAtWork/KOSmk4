 ...
 */
#ifndef GUARD_LIBC_AUTO_SYS_IOCTL_H
#define GUARD_LIBC_AUTO_SYS_IOCTL_H 1
...
INTDEF ATTR_FDARG(1) __STDC_INT_AS_SSIZE_T NOTHROW_RPC(VLIBDCALL libd_ioctl)(fd_t fd, ioctl_t request, ...);
#endif /* !__LIBCCALL_IS_LIBDCALL && !__KERNEL__ */

DECL_END

#endif /* !GUARD_LIBC_AUTO_SYS_IOCTL_H */
