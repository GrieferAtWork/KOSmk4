...
INTDEF NONNULL((1)) int NOTHROW_NCX(LIBCCALL libc_futex_trywaitwhile)(lfutex_t *uaddr, lfutex_t equal_to_value);
/* Check if `futex_waituntil()' would block
 * @return: 0: `futex_waituntil()' would block
 * @return: 1: `futex_waituntil()' wouldn't block */
INTDEF NONNULL((1)) int NOTHROW_NCX(LIBCCALL libc_futex_trywaituntil)(lfutex_t *uaddr, lfutex_t not_equal_to_value);
...
INTDEF NONNULL((1)) int NOTHROW_NCX(LIBCCALL libc_futex_trywaitwhile_equal)(lfutex_t *uaddr, lfutex_t equal_to_value);
...
INTDEF NONNULL((1)) int NOTHROW_NCX(LIBCCALL libc_futex_trywaitwhile_notequal)(lfutex_t *uaddr, lfutex_t not_equal_to_value);
...
INTDEF NONNULL((1)) int NOTHROW_NCX(LIBCCALL libc_futex_trywaitwhile_above)(lfutex_t *uaddr, lfutex_t above_value);
...
INTDEF NONNULL((1)) int NOTHROW_NCX(LIBCCALL libc_futex_trywaitwhile_below)(lfutex_t *uaddr, lfutex_t below_value);
...
INTDEF NONNULL((1)) int NOTHROW_NCX(LIBCCALL libc_futex_trywaitwhile_aboveequal)(lfutex_t *uaddr, lfutex_t above_or_equal_value);
...
INTDEF NONNULL((1)) int NOTHROW_NCX(LIBCCALL libc_futex_trywaitwhile_belowequal)(lfutex_t *uaddr, lfutex_t below_or_equal_value);
...
INTDEF NONNULL((1)) int NOTHROW_NCX(LIBCCALL libc_futex_trywaitwhile_exactbits)(lfutex_t *uaddr, lfutex_t bitmask, lfutex_t setmask);
...
INTDEF NONNULL((1)) int NOTHROW_NCX(LIBCCALL libc_futex_trywaituntil_exactbits)(lfutex_t *uaddr, lfutex_t bitmask, lfutex_t setmask);
...
INTDEF NONNULL((1)) int NOTHROW_NCX(LIBCCALL libc_futex_trywaitwhile_anybit)(lfutex_t *uaddr, lfutex_t bitmask);
...
INTDEF NONNULL((1)) int NOTHROW_NCX(LIBCCALL libc_futex_trywaitwhile_allbits)(lfutex_t *uaddr, lfutex_t bitmask);
#endif /* !__KERNEL__ */
