...
INTDEF ATTR_IN(2) ATTR_LIBC_C16PRINTF(2, 0) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBDCALL libd___vswprintf_l)(char16_t *buf, char16_t const *format, locale_t locale, va_list args);
INTDEF ATTR_IN(2) ATTR_LIBC_C32PRINTF(2, 0) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBKCALL libc___vswprintf_l)(char32_t *buf, char32_t const *format, locale_t locale, va_list args);
...
INTDEF ATTR_IN(2) ATTR_LIBC_C16PRINTF(2, 0) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBDCALL libd__vswprintf)(char16_t *buf, char16_t const *format, va_list args);
INTDEF ATTR_IN(2) ATTR_LIBC_C32PRINTF(2, 0) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBKCALL libc__vswprintf)(char32_t *buf, char32_t const *format, va_list args);
...
INTDEF ATTR_IN(2) ATTR_LIBC_C16SCANF(2, 0) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBDCALL libd__vswscanf_l)(char16_t const *buf, char16_t const *format, locale_t locale, va_list args);
INTDEF ATTR_IN(2) ATTR_LIBC_C32SCANF(2, 0) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBKCALL libc__vswscanf_l)(char32_t const *buf, char32_t const *format, locale_t locale, va_list args);
INTDEF ATTR_IN(2) ATTR_LIBC_C16SCANF(2, 0) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBDCALL libd__vswscanf_s_l)(char16_t const *buf, char16_t const *format, locale_t locale, va_list args);
INTDEF ATTR_IN(2) ATTR_LIBC_C32SCANF(2, 0) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBKCALL libc__vswscanf_s_l)(char32_t const *buf, char32_t const *format, locale_t locale, va_list args);
...
INTDEF ATTR_IN(2) ATTR_LIBC_C16PRINTF(2, 4) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBDCALL libd___swprintf_l)(char16_t *buf, char16_t const *format, locale_t locale, ...);
INTDEF ATTR_IN(2) ATTR_LIBC_C32PRINTF(2, 4) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBKCALL libc___swprintf_l)(char32_t *buf, char32_t const *format, locale_t locale, ...);
INTDEF ATTR_IN(2) ATTR_LIBC_C16PRINTF(2, 3) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBDCALL libd__swprintf)(char16_t *buf, char16_t const *format, ...);
INTDEF ATTR_IN(2) ATTR_LIBC_C32PRINTF(2, 3) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBKCALL libc__swprintf)(char32_t *buf, char32_t const *format, ...);
...
INTDEF WUNUSED ATTR_IN(2) ATTR_LIBC_C16SCANF(2, 4) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBDCALL libd__swscanf_l)(char16_t const *buf, char16_t const *format, locale_t locale, ...);
INTDEF WUNUSED ATTR_IN(2) ATTR_LIBC_C32SCANF(2, 4) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBKCALL libc__swscanf_l)(char32_t const *buf, char32_t const *format, locale_t locale, ...);
INTDEF WUNUSED ATTR_IN(2) ATTR_LIBC_C16SCANF(2, 4) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBDCALL libd__swscanf_s_l)(char16_t const *buf, char16_t const *format, locale_t locale, ...);
INTDEF WUNUSED ATTR_IN(2) ATTR_LIBC_C32SCANF(2, 4) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBKCALL libc__swscanf_s_l)(char32_t const *buf, char32_t const *format, locale_t locale, ...);
...
INTDEF WUNUSED ATTR_IN(2) ATTR_LIBC_C16SCANF(2, 0) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBDCALL libd_vswscanf_s)(char16_t const *buf, char16_t const *format, va_list args);
INTDEF WUNUSED ATTR_IN(2) ATTR_LIBC_C32SCANF(2, 0) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(LIBKCALL libc_vswscanf_s)(char32_t const *buf, char32_t const *format, va_list args);
...
INTDEF WUNUSED ATTR_IN(2) ATTR_LIBC_C16SCANF(2, 3) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBDCALL libd_swscanf_s)(char16_t const *buf, char16_t const *format, ...);
INTDEF WUNUSED ATTR_IN(2) ATTR_LIBC_C32SCANF(2, 3) NONNULL((1)) __STDC_INT_AS_SSIZE_T NOTHROW_NCX(VLIBKCALL libc_swscanf_s)(char32_t const *buf, char32_t const *format, ...);
#endif /* !__KERNEL__ */
