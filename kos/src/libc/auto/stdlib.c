...
NOTHROW_NCX(LIBCCALL libc__atoll_l)(char const *__restrict nptr,
                                    locale_t locale) {
#line 2095 "kos/src/libc/magic/stdlib.c"
...
#line 2126 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_qsort_s)(void *base,
                                   ...
                                   __dos_compar_d_fn_t compar,
                                   void *arg) {
#line 2196 "kos/src/libc/magic/stdlib.c"
	struct __invoke_compare_helper_s_data data;
	data.__fun = compar;
	data.__arg = arg;
...
NOTHROW_NCX(LIBCCALL libc__ultoa_s)(unsigned long val,
                                    ...
                                    size_t buflen,
                                    int radix) {
#line 2285 "kos/src/libc/magic/stdlib.c"
	char *p;
	unsigned long temp;
	if (radix < 2)
		radix = 10;
...
#line 2390 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atoi64_l)(char const *__restrict nptr,
                                     locale_t locale) {
#line 2398 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__mbstowcs_s)(size_t *presult,
                                       ...
                                       char const *src,
                                       size_t dstlen) {
#line 2458 "kos/src/libc/magic/stdlib.c"
	size_t error;
	if (dstlen >= dstsize) {
		if (!dstsize)
			return 0;
...
NOTHROW_NCX(LIBCCALL libc__wcstombs_l)(char *dst,
                                       ...
                                       size_t maxlen,
                                       locale_t locale) {
#line 2564 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_wcstombs_s)(size_t *presult,
                                      ...
                                      char32_t const *src,
                                      size_t maxlen) {
#line 2572 "kos/src/libc/magic/stdlib.c"
	if (!presult || !buf || !src)
		return __EINVAL;
...
NOTHROW_NCX(LIBCCALL libc__aligned_msize)(void *aligned_mallptr,
                                          ...
                                          size_t offset) {
#line 2705 "kos/src/libc/magic/stdlib.c"
	(void)min_alignment;
	(void)offset;
	if (!aligned_mallptr)
		return 0;
...
NOTHROW_NCX(LIBCCALL libc__fcvt_s)(char *buf,
                                   ...
                                   int *__restrict decptr,
                                   int *__restrict sign) {
#line 2740 "kos/src/libc/magic/stdlib.c"
	if (!buf || !decptr || !sign)
		return __EINVAL;
...
NOTHROW_NCX(LIBCCALL libc__gcvt_s)(char *buf,
                                   ...
                                   double val,
                                   int ndigit) {
#line 2748 "kos/src/libc/magic/stdlib.c"
	int a, b;
	if (!buf)
		return __EINVAL;
...
NOTHROW_NCX(LIBCCALL libc__atoflt_l)(float *__restrict result,
                                     char const *__restrict nptr,
                                     locale_t locale) {
#line 2768 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotr64)(u64 val,
                               int shift) {
#line 2843 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__lrotr)(unsigned long val,
                              int shift) {
#line 2862 "kos/src/libc/magic/stdlib.c"
	return __hybrid_ror(val, shift);
}
...
NOTHROW_NCX(LIBCCALL libc__splitpath)(char const *__restrict abspath,
                                      ...
                                      char *file,
                                      char *ext) {
#line 2906 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__makepath_s)(char *buf,
                                       ...
                                       char const *file,
                                       char const *ext) {
#line 2917 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__splitpath_s)(char const *__restrict abspath,
                                        ...
                                        char *ext,
                                        size_t extlen) {
#line 2967 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_ultoa)(unsigned long val,
                                 char *buf,
                                 int radix) {
#line 3143 "kos/src/libc/magic/stdlib.c"
...
#line 3182 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__wtof_l)(char32_t const *nptr,
                                   locale_t locale) {
#line 3187 "kos/src/libc/magic/stdlib.c"
