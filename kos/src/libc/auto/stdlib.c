...
NOTHROW_NCX(LIBCCALL libc_strto32)(char const *__restrict nptr,
                                   char **endptr,
                                   int base) {
#line 838 "kos/src/libc/magic/stdlib.c"
	u32 result;
	bool neg = 0;
	while (*nptr == '-') {
		neg = !neg;
...
NOTHROW_NCX(LIBCCALL libc_strtou64)(char const *__restrict nptr,
                                    char **endptr,
                                    int base) {
#line 854 "kos/src/libc/magic/stdlib.c"
	u64 result, temp;
	if (!base) {
		if (*nptr == '0') {
			++nptr;
...
#line 662 "kos/src/libc/magic/stdlib.c"
...
#line 673 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_strtoul)(char const *__restrict nptr,
                                   char **endptr,
                                   int base) {
#line 688 "kos/src/libc/magic/stdlib.c"
#if __SIZEOF_LONG__ <= 4
...
NOTHROW_NCX(LIBCCALL libc_strtoull)(char const *__restrict nptr,
                                    char **endptr,
                                    int base) {
#line 716 "kos/src/libc/magic/stdlib.c"
#if __SIZEOF_LONG_LONG__ <= 4
...
NOTHROW_NCX(LIBCCALL libc_ecvt_r)(double val,
                                  ...
                                  char *__restrict buf,
                                  size_t len) {
#line 948 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_fcvt_r)(double val,
                                  ...
                                  char *__restrict buf,
                                  size_t len) {
#line 957 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_qgcvt)(long double val,
                                 int ndigit,
                                 char *buf) {
#line 969 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_qecvt)(long double val,
                                 ...
                                 int *__restrict decptr,
                                 int *__restrict sign) {
#line 1014 "kos/src/libc/magic/stdlib.c"
...
#line 1100 "kos/src/libc/magic/stdlib.c"
	/* https://xkcd.com/221/ */
	return 4;
}
...
#line 1187 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_ecvt)(double val,
                                ...
                                int *__restrict decptr,
                                int *__restrict sign) {
#line 1305 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_fcvt)(double val,
                                ...
                                int *__restrict decptr,
                                int *__restrict sign) {
#line 1320 "kos/src/libc/magic/stdlib.c"
...
#line 1333 "kos/src/libc/magic/stdlib.c"
	/* TODO: Implement here */
	return 0;
}
...
NOTHROW_NCX(LIBCCALL libc_strtol_l)(char const *__restrict nptr,
                                    ...
                                    int base,
                                    locale_t locale) {
#line 1379 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_strtoul_l)(char const *__restrict nptr,
                                     ...
                                     int base,
                                     locale_t locale) {
#line 1388 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_strtod_l)(char const *__restrict nptr,
                                    char **endptr,
                                    locale_t locale) {
#line 1416 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__atoi_l)(char const *__restrict nptr,
                                   locale_t locale) {
#line 1695 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atoll_l)(char const *__restrict nptr,
                                    locale_t locale) {
#line 1704 "kos/src/libc/magic/stdlib.c"
...
#line 1724 "kos/src/libc/magic/stdlib.c"
...
#line 1735 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_qsort_s)(void *base,
                                   ...
                                   __dos_compar_d_fn_t compar,
                                   void *arg) {
#line 1799 "kos/src/libc/magic/stdlib.c"
	struct __invoke_compare_helper_s_data data;
	data.__fun = compar;
	data.__arg = arg;
...
NOTHROW_NCX(LIBCCALL libc__itoa_s)(int val,
                                   ...
                                   size_t bufsize,
                                   int radix) {
#line 1833 "kos/src/libc/magic/stdlib.c"
	char *p;
	int temp;
	if (radix < 2)
		radix = 10;
...
NOTHROW_NCX(LIBCCALL libc__ltoa_s)(long val,
                                   ...
                                   size_t bufsize,
                                   int radix) {
#line 1864 "kos/src/libc/magic/stdlib.c"
	char *p;
	long temp;
	if (radix < 2)
		radix = 10;
...
NOTHROW_NCX(LIBCCALL libc__i64toa)(s64 val,
                                   char *buf,
                                   int radix) {
#line 1922 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__i64toa_s)(s64 val,
                                     ...
                                     size_t bufsize,
                                     int radix) {
#line 1938 "kos/src/libc/magic/stdlib.c"
	char *p;
	s64 temp;
	if (radix < 2)
		radix = 10;
...
NOTHROW_NCX(LIBCCALL libc__ui64toa_s)(u64 val,
                                      ...
                                      size_t bufsize,
                                      int radix) {
#line 1968 "kos/src/libc/magic/stdlib.c"
	char *p;
	u64 temp;
	if (radix < 2)
		radix = 10;
...
#line 2026 "kos/src/libc/magic/stdlib.c"
	/* TODO */
	return 0;
}
...
NOTHROW_NCX(LIBCCALL libc__mbstrnlen)(char const *str,
                                      size_t maxlen) {
#line 2031 "kos/src/libc/magic/stdlib.c"
	/* TODO */
	return 0;
}
...
NOTHROW_NCX(LIBCCALL libc__mbstrnlen_l)(char const *str,
                                        size_t maxlen,
                                        locale_t locale) {
#line 2042 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__mbtowc_l)(char32_t *dst,
                                     ...
                                     size_t srclen,
                                     locale_t locale) {
#line 2054 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__mbstowcs_l)(char32_t *buf,
                                       ...
                                       size_t maxlen,
                                       locale_t locale) {
#line 2059 "kos/src/libc/magic/stdlib.c"
	size_t result;
...
NOTHROW_NCX(LIBCCALL libc__wctomb_s_l)(int *presult,
                                       ...
                                       char32_t wc,
                                       locale_t locale) {
#line 2152 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
#line 2342 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atoldbl)(long double *__restrict result,
                                    char __KOS_FIXED_CONST *__restrict nptr) {
#line 2358 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotl)(unsigned int val,
                             int shift) {
#line 2379 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotr)(unsigned int val,
                             int shift) {
#line 2387 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotl64)(u64 val,
                               int shift) {
#line 2396 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_strto64_l)(char const *__restrict nptr,
                                     ...
                                     int base,
                                     locale_t locale) {
#line 2600 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_strtou64_l)(char const *__restrict nptr,
                                      ...
                                      int base,
                                      locale_t locale) {
#line 2607 "kos/src/libc/magic/stdlib.c"
	(void)locale;
