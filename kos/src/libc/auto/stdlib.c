...
NOTHROW_NCX(LIBCCALL libc_strtoll_l)(char const *__restrict nptr,
                                     ...
                                     int base,
                                     locale_t locale) {
#line 1675 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_strtod_l)(char const *__restrict nptr,
                                    char **endptr,
                                    locale_t locale) {
#line 1696 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_strtold_l)(char const *__restrict nptr,
                                     char **endptr,
                                     locale_t locale) {
#line 1712 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__atoi_l)(char const *__restrict nptr,
                                   locale_t locale) {
#line 2186 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atol_l)(char const *__restrict nptr,
                                   locale_t locale) {
#line 2192 "kos/src/libc/magic/stdlib.c"
...
#line 2219 "kos/src/libc/magic/stdlib.c"
...
#line 2230 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_qsort_s)(void *base,
                                   ...
                                   __dos_compar_d_fn_t compar,
                                   void *arg) {
#line 2302 "kos/src/libc/magic/stdlib.c"
	struct __invoke_compare_helper_s_data data;
	data.__fun = compar;
	data.__arg = arg;
...
NOTHROW_NCX(LIBCCALL libc__itoa_s)(int val,
                                   ...
                                   size_t buflen,
                                   int radix) {
#line 2330 "kos/src/libc/magic/stdlib.c"
	char *p;
	int temp;
	if (radix < 2)
		radix = 10;
...
NOTHROW_NCX(LIBCCALL libc__ltoa_s)(long val,
                                   ...
                                   size_t buflen,
                                   int radix) {
#line 2371 "kos/src/libc/magic/stdlib.c"
	char *p;
	long temp;
	if (radix < 2)
		radix = 10;
...
NOTHROW_NCX(LIBCCALL libc__ultoa_s)(unsigned long val,
                                    ...
                                    size_t buflen,
                                    int radix) {
#line 2411 "kos/src/libc/magic/stdlib.c"
	char *p;
	unsigned long temp;
	if (radix < 2)
		radix = 10;
...
NOTHROW_NCX(LIBCCALL libc__i64toa)(s64 val,
                                   char *buf,
                                   int radix) {
#line 2445 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__ui64toa)(u64 val,
                                    char *buf,
                                    int radix) {
#line 2452 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__ui64toa_s)(u64 val,
                                      ...
                                      size_t buflen,
                                      int radix) {
#line 2499 "kos/src/libc/magic/stdlib.c"
	char *p;
	u64 temp;
	if (radix < 2)
		radix = 10;
...
#line 2536 "kos/src/libc/magic/stdlib.c"
...
#line 2552 "kos/src/libc/magic/stdlib.c"
	size_t result = 0;
...
NOTHROW_NCX(LIBCCALL libc__mbstrnlen)(char const *str,
                                      size_t maxlen) {
#line 2560 "kos/src/libc/magic/stdlib.c"
	size_t result = 0;
...
NOTHROW_NCX(LIBCCALL libc__mbstrnlen_l)(char const *str,
                                        size_t maxlen,
                                        locale_t locale) {
#line 2575 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__mbstowcs_s)(size_t *presult,
                                       ...
                                       char const *src,
                                       size_t dstlen) {
#line 2604 "kos/src/libc/magic/stdlib.c"
	size_t error;
	if (dstlen >= dstsize) {
		if (!dstsize)
			return 0;
...
NOTHROW_NCX(LIBCCALL libc__mbstowcs_s_l)(size_t *presult,
                                         ...
                                         size_t dstlen,
                                         locale_t locale) {
#line 2625 "kos/src/libc/magic/stdlib.c"
	size_t error;
	if (dstlen >= dstsize) {
		if (!dstsize)
			return 0;
...
#line 2645 "kos/src/libc/magic/stdlib.c"
	if (!randval) {
#ifdef EINVAL
		return EINVAL;
#else /* EINVAL */
...
NOTHROW_NCX(LIBCCALL libc__wctomb_l)(char *buf,
                                     char32_t wc,
                                     locale_t locale) {
#line 2680 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_wctomb_s)(int *presult,
                                    ...
                                    rsize_t buflen,
                                    char32_t wc) {
#line 2689 "kos/src/libc/magic/stdlib.c"
	if (!presult || !buf) {
#ifdef EINVAL
		return EINVAL;
#else /* EINVAL */
...
NOTHROW_NCX(LIBCCALL libc__wctomb_s_l)(int *presult,
                                       ...
                                       char32_t wc,
                                       locale_t locale) {
#line 2711 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__ecvt_s)(char *buf,
                                   ...
                                   int *__restrict decptr,
                                   int *__restrict sign) {
#line 2886 "kos/src/libc/magic/stdlib.c"
	if (!buf || !decptr || !sign)
		return __EINVAL;
...
NOTHROW_NCX(LIBCCALL libc__fcvt_s)(char *buf,
                                   ...
                                   int *__restrict decptr,
                                   int *__restrict sign) {
#line 2896 "kos/src/libc/magic/stdlib.c"
	if (!buf || !decptr || !sign)
		return __EINVAL;
...
#line 2918 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atoflt_l)(float *__restrict result,
                                     char const *__restrict nptr,
                                     locale_t locale) {
#line 2924 "kos/src/libc/magic/stdlib.c"
...
#line 2932 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atodbl_l)(double *__restrict result,
                                     char __KOS_FIXED_CONST *__restrict nptr,
                                     locale_t locale) {
#line 2940 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atoldbl)(__LONGDOUBLE *__restrict result,
                                    char __KOS_FIXED_CONST *__restrict nptr) {
#line 2949 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atoldbl_l)(__LONGDOUBLE *__restrict result,
                                      char __KOS_FIXED_CONST *__restrict nptr,
                                      locale_t locale) {
#line 2957 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotr)(unsigned int val,
                             int shift) {
#line 2980 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotr64)(u64 val,
                               int shift) {
#line 2999 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__lrotr)(unsigned long val,
                              int shift) {
#line 3018 "kos/src/libc/magic/stdlib.c"
	return __hybrid_ror(val, shift);
}
...
NOTHROW_NCX(LIBCCALL libc__makepath)(char *__restrict buf,
                                     ...
                                     char const *file,
                                     char const *ext) {
#line 3056 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__splitpath)(char const *__restrict abspath,
                                      ...
                                      char *file,
                                      char *ext) {
#line 3062 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__makepath_s)(char *buf,
                                       ...
                                       char const *file,
                                       char const *ext) {
#line 3073 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_itoa)(int val,
                                char *buf,
                                int radix) {
#line 3283 "kos/src/libc/magic/stdlib.c"
...
#line 3338 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__wtof_l)(char32_t const *nptr,
                                   locale_t locale) {
#line 3343 "kos/src/libc/magic/stdlib.c"
