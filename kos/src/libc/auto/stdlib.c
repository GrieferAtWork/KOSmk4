...
NOTHROW_NCX(LIBCCALL libc_strtou32)(char const *__restrict nptr,
                                    char **endptr,
                                    int base) {
#line 964 "kos/src/libc/magic/stdlib.c"
	u32 result, temp;
	if (!base) {
		if (*nptr == '0') {
			++nptr;
...
NOTHROW_NCX(LIBCCALL libc_strto32)(char const *__restrict nptr,
                                   char **endptr,
                                   int base) {
#line 1009 "kos/src/libc/magic/stdlib.c"
	u32 result;
	bool neg = 0;
	while (*nptr == '-') {
		neg = !neg;
...
NOTHROW_NCX(LIBCCALL libc_strto64)(char const *__restrict nptr,
                                   char **endptr,
                                   int base) {
#line 1068 "kos/src/libc/magic/stdlib.c"
	u64 result;
	bool neg = 0;
	while (*nptr == '-') {
		neg = !neg;
...
(LIBCCALL libc_qsort_r)(void *pbase,
                        ...
                        __compar_d_fn_t cmp,
                        void *arg) __THROWS(...) {
#line 224 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_bsearch_r)(void const *pkey,
                                     ...
                                     __compar_d_fn_t cmp,
                                     void *arg) {
#line 376 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_bsearch)(void const *pkey,
                                   ...
                                   size_t item_size,
                                   __compar_fn_t cmp) {
#line 451 "kos/src/libc/magic/stdlib.c"
...
#line 463 "kos/src/libc/magic/stdlib.c"
	return x < 0 ? -x : x;
}
#endif /* MAGIC:alias */
...
#line 473 "kos/src/libc/magic/stdlib.c"
	return x < 0 ? -x : x;
}
#endif /* MAGIC:alias */
...
NOTHROW_NCX(LIBCCALL libc_lldiv)(__LONGLONG numer,
                                 __LONGLONG denom) {
#line 551 "kos/src/libc/magic/stdlib.c"
	lldiv_t result;
	result.quot = numer / denom;
	result.rem  = numer % denom;
	return result;
...
#line 646 "kos/src/libc/magic/stdlib.c"
	return x < 0 ? -x : x;
}
...
NOTHROW_NCX(LIBCCALL libc_wcstombs)(char *__restrict dst,
                                    ...
                                    size_t dstlen) {
#line 715 "kos/src/libc/magic/stdlib.c"
...
#line 795 "kos/src/libc/magic/stdlib.c"
	/* ... */
	(void)seed;
	COMPILER_IMPURE();
}
...
#line 803 "kos/src/libc/magic/stdlib.c"
	COMPILER_IMPURE();
	/* https://xkcd.com/221/ */
	return 4;
}
...
NOTHROW_NCX(LIBCCALL libc_strtoul)(char const *__restrict nptr,
                                   char **endptr,
                                   int base) {
#line 852 "kos/src/libc/magic/stdlib.c"
#if __SIZEOF_LONG__ <= 4
...
NOTHROW_NCX(LIBCCALL libc_strtoll)(char const *__restrict nptr,
                                   char **endptr,
                                   int base) {
#line 895 "kos/src/libc/magic/stdlib.c"
#if __SIZEOF_LONG_LONG__ <= 4
...
#line 907 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_strtof)(char const *__restrict nptr,
                                  char **endptr) {
#line 923 "kos/src/libc/magic/stdlib.c"
	/* TODO */
	COMPILER_IMPURE();
	if (endptr)
		*endptr = (char *)nptr;
...
NOTHROW_NCX(LIBCCALL libc_strtold)(char const *__restrict nptr,
                                   char **endptr) {
#line 934 "kos/src/libc/magic/stdlib.c"
	/* TODO */
	COMPILER_IMPURE();
	if (endptr)
		*endptr = (char *)nptr;
...
NOTHROW_NCX(LIBCCALL libc_strto32_l)(char const *__restrict nptr,
                                     ...
                                     int base,
                                     locale_t locale) {
#line 1094 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_strtou64_l)(char const *__restrict nptr,
                                      ...
                                      int base,
                                      locale_t locale) {
#line 1104 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_strto64_l)(char const *__restrict nptr,
                                     ...
                                     int base,
                                     locale_t locale) {
#line 1113 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_gcvt)(double val,
                                int ndigit,
                                char *buf) {
#line 1127 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_ecvt_r)(double val,
                                  ...
                                  char *__restrict buf,
                                  size_t len) {
#line 1157 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_fcvt_r)(double val,
                                  ...
                                  char *__restrict buf,
                                  size_t len) {
#line 1176 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_qgcvt)(__LONGDOUBLE val,
                                 int ndigit,
                                 char *buf) {
#line 1195 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_qecvt_r)(__LONGDOUBLE val,
                                   ...
                                   char *__restrict buf,
                                   size_t len) {
#line 1217 "kos/src/libc/magic/stdlib.c"
#if defined(__CRT_HAVE__ecvt_s) && !defined(__BUILDING_LIBC)
...
NOTHROW_NCX(LIBCCALL libc_qfcvt_r)(__LONGDOUBLE val,
                                   ...
                                   char *__restrict buf,
                                   size_t len) {
#line 1236 "kos/src/libc/magic/stdlib.c"
#if defined(__CRT_HAVE__fcvt_s) && !defined(__BUILDING_LIBC)
...
NOTHROW_NCX(LIBCCALL libc_qecvt)(__LONGDOUBLE val,
                                 ...
                                 int *__restrict decptr,
                                 int *__restrict sign) {
#line 1266 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_qfcvt)(__LONGDOUBLE val,
                                 ...
                                 int *__restrict decptr,
                                 int *__restrict sign) {
#line 1276 "kos/src/libc/magic/stdlib.c"
...
#line 1347 "kos/src/libc/magic/stdlib.c"
	(void)pseed;
	COMPILER_IMPURE();
	/* https://xkcd.com/221/ */
	return 4;
...
#line 1432 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_ecvt)(double val,
                                ...
                                int *__restrict decptr,
                                int *__restrict sign) {
#line 1549 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_strtol_l)(char const *__restrict nptr,
                                    ...
                                    int base,
                                    locale_t locale) {
#line 1626 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_strtoll_l)(char const *__restrict nptr,
                                     ...
                                     int base,
                                     locale_t locale) {
#line 1648 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_strtod_l)(char const *__restrict nptr,
                                    char **endptr,
                                    locale_t locale) {
#line 1669 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_strtof_l)(char const *__restrict nptr,
                                    char **endptr,
                                    locale_t locale) {
#line 1676 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_strtold_l)(char const *__restrict nptr,
                                     char **endptr,
                                     locale_t locale) {
#line 1685 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
#line 2066 "kos/src/libc/magic/stdlib.c"
	return x < 0 ? -x : x;
}
#endif /* MAGIC:alias */
...
NOTHROW_NCX(LIBCCALL libc__atof_l)(char const *__restrict nptr,
                                   locale_t locale) {
#line 2076 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atoi_l)(char const *__restrict nptr,
                                   locale_t locale) {
#line 2084 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atol_l)(char const *__restrict nptr,
                                   locale_t locale) {
#line 2090 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atoll_l)(char const *__restrict nptr,
                                    locale_t locale) {
#line 2097 "kos/src/libc/magic/stdlib.c"
...
#line 2122 "kos/src/libc/magic/stdlib.c"
...
#line 2128 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_qsort_s)(void *base,
                                   ...
                                   __dos_compar_d_fn_t compar,
                                   void *arg) {
#line 2200 "kos/src/libc/magic/stdlib.c"
	struct __invoke_compare_helper_s_data data;
	data.__fun = compar;
	data.__arg = arg;
...
NOTHROW_NCX(LIBCCALL libc__itoa_s)(int val,
                                   ...
                                   size_t buflen,
                                   int radix) {
#line 2228 "kos/src/libc/magic/stdlib.c"
	char *p;
	int temp;
	if (radix < 2)
		radix = 10;
...
NOTHROW_NCX(LIBCCALL libc__i64toa)(s64 val,
                                   char *buf,
                                   int radix) {
#line 2318 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__ui64toa)(u64 val,
                                    char *buf,
                                    int radix) {
#line 2325 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__ui64toa_s)(u64 val,
                                      ...
                                      size_t buflen,
                                      int radix) {
#line 2362 "kos/src/libc/magic/stdlib.c"
	char *p;
	u64 temp;
	if (radix < 2)
		radix = 10;
...
#line 2394 "kos/src/libc/magic/stdlib.c"
...
#line 2410 "kos/src/libc/magic/stdlib.c"
	size_t result = 0;
...
NOTHROW_NCX(LIBCCALL libc__mbstrlen_l)(char const *str,
                                       locale_t locale) {
#line 2427 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__mblen_l)(char const *str,
                                    size_t maxlen,
                                    locale_t locale) {
#line 2439 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__mbtowc_l)(char32_t *dst,
                                     ...
                                     size_t srclen,
                                     locale_t locale) {
#line 2446 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__mbstowcs_l)(char32_t *dst,
                                       ...
                                       size_t dstlen,
                                       locale_t locale) {
#line 2453 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
#line 2503 "kos/src/libc/magic/stdlib.c"
	if (!randval)
		return __EINVAL;
	*randval = libc_rand();
	return 0;
...
NOTHROW_NCX(LIBCCALL libc_wctomb_s)(int *presult,
                                    ...
                                    rsize_t buflen,
                                    char32_t wc) {
#line 2542 "kos/src/libc/magic/stdlib.c"
	if (!presult || !buf)
		return __EINVAL;
...
NOTHROW_NCX(LIBCCALL libc__wctomb_s_l)(int *presult,
                                       ...
                                       char32_t wc,
                                       locale_t locale) {
#line 2554 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__wcstombs_s_l)(size_t *presult,
                                         ...
                                         size_t maxlen,
                                         locale_t locale) {
#line 2562 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__wcstombs_l)(char *dst,
                                       ...
                                       size_t maxlen,
                                       locale_t locale) {
#line 2568 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__aligned_msize)(void *aligned_mallptr,
                                          ...
                                          size_t offset) {
#line 2709 "kos/src/libc/magic/stdlib.c"
	(void)min_alignment;
	(void)offset;
	if (!aligned_mallptr)
		return 0;
...
NOTHROW_NCX(LIBCCALL libc__ecvt_s)(char *buf,
                                   ...
                                   int *__restrict decptr,
                                   int *__restrict sign) {
#line 2734 "kos/src/libc/magic/stdlib.c"
	if (!buf || !decptr || !sign)
		return __EINVAL;
...
NOTHROW_NCX(LIBCCALL libc__fcvt_s)(char *buf,
                                   ...
                                   int *__restrict decptr,
                                   int *__restrict sign) {
#line 2744 "kos/src/libc/magic/stdlib.c"
	if (!buf || !decptr || !sign)
		return __EINVAL;
...
NOTHROW_NCX(LIBCCALL libc__gcvt_s)(char *buf,
                                   ...
                                   double val,
                                   int ndigit) {
#line 2752 "kos/src/libc/magic/stdlib.c"
	int a, b;
	if (!buf)
		return __EINVAL;
...
#line 2766 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atoflt_l)(float *__restrict result,
                                     char const *__restrict nptr,
                                     locale_t locale) {
#line 2772 "kos/src/libc/magic/stdlib.c"
...
#line 2780 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atodbl_l)(double *__restrict result,
                                     char __KOS_FIXED_CONST *__restrict nptr,
                                     locale_t locale) {
#line 2788 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atoldbl)(__LONGDOUBLE *__restrict result,
                                    char __KOS_FIXED_CONST *__restrict nptr) {
#line 2797 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atoldbl_l)(__LONGDOUBLE *__restrict result,
                                      char __KOS_FIXED_CONST *__restrict nptr,
                                      locale_t locale) {
#line 2805 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotl)(unsigned int val,
                             int shift) {
#line 2819 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotr)(unsigned int val,
                             int shift) {
#line 2828 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotl64)(u64 val,
                               int shift) {
#line 2838 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotr64)(u64 val,
                               int shift) {
#line 2847 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__lrotl)(unsigned long val,
                              int shift) {
#line 2857 "kos/src/libc/magic/stdlib.c"
	return __hybrid_rol(val, shift);
}
...
NOTHROW(LIBCCALL libc__lrotr)(unsigned long val,
                              int shift) {
#line 2866 "kos/src/libc/magic/stdlib.c"
	return __hybrid_ror(val, shift);
}
...
NOTHROW_NCX(LIBCCALL libc__makepath_s)(char *buf,
                                       ...
                                       char const *file,
                                       char const *ext) {
#line 2921 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_itoa)(int val,
                                char *buf,
                                int radix) {
#line 3131 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_ultoa)(unsigned long val,
                                 char *buf,
                                 int radix) {
#line 3147 "kos/src/libc/magic/stdlib.c"
...
#line 3186 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__wtof_l)(char32_t const *nptr,
                                   locale_t locale) {
#line 3191 "kos/src/libc/magic/stdlib.c"
