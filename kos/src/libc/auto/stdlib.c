...
#line 2093 "kos/src/libc/magic/stdlib.c"
	return x < 0 ? -x : x;
}
#endif /* MAGIC:alias */
...
#line 2144 "kos/src/libc/magic/stdlib.c"
...
#line 2149 "kos/src/libc/magic/stdlib.c"
...
#line 2155 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_bsearch_s)(void const *key,
                                     ...
                                     void *arg) {
#line 2201 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_qsort_s)(void *base,
                                   ...
                                   __dos_compar_d_fn_t compar,
                                   void *arg) {
#line 2227 "kos/src/libc/magic/stdlib.c"
	struct __invoke_compare_helper_s_data data;
	data.__fun = compar;
	data.__arg = arg;
...
NOTHROW_NCX(LIBCCALL libc__itoa_s)(int val,
                                   ...
                                   size_t buflen,
                                   int radix) {
#line 2255 "kos/src/libc/magic/stdlib.c"
	char *p;
	int temp;
	if (radix < 2)
		radix = 10;
...
NOTHROW_NCX(LIBCCALL libc__i64toa)(s64 val,
                                   char *buf,
                                   int radix) {
#line 2370 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__ui64toa)(u64 val,
                                    char *buf,
                                    int radix) {
#line 2377 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__ui64toa_s)(u64 val,
                                      ...
                                      size_t buflen,
                                      int radix) {
#line 2424 "kos/src/libc/magic/stdlib.c"
	char *p;
	u64 temp;
	if (radix < 2)
		radix = 10;
...
#line 2461 "kos/src/libc/magic/stdlib.c"
...
#line 2477 "kos/src/libc/magic/stdlib.c"
	size_t result = 0;
...
NOTHROW_NCX(LIBCCALL libc__mbstrnlen)(char const *str,
                                      size_t maxlen) {
#line 2485 "kos/src/libc/magic/stdlib.c"
	size_t result = 0;
...
NOTHROW_NCX(LIBCCALL libc__mbstrlen_l)(char const *str,
                                       locale_t locale) {
#line 2494 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__mbstrnlen_l)(char const *str,
                                        size_t maxlen,
                                        locale_t locale) {
#line 2500 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__mbtowc_l)(char32_t *dst,
                                     ...
                                     size_t srclen,
                                     locale_t locale) {
#line 2513 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__mbstowcs_s_l)(size_t *presult,
                                         ...
                                         size_t dstlen,
                                         locale_t locale) {
#line 2550 "kos/src/libc/magic/stdlib.c"
	size_t error;
	if (dstlen >= dstsize) {
		if (!dstsize)
			return 0;
...
#line 2570 "kos/src/libc/magic/stdlib.c"
	if (!randval) {
#ifdef EINVAL
		return EINVAL;
#else /* EINVAL */
...
NOTHROW_NCX(LIBCCALL libc__wcstombs_l)(char *dst,
                                       ...
                                       size_t maxlen,
                                       locale_t locale) {
#line 2650 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_wcstombs_s)(size_t *presult,
                                      ...
                                      char32_t const *src,
                                      size_t maxlen) {
#line 2658 "kos/src/libc/magic/stdlib.c"
	if (!presult || !buf || !src) {
#ifdef EINVAL
		return EINVAL;
#else /* EINVAL */
...
NOTHROW_NCX(LIBCCALL libc__aligned_msize)(void *aligned_mallptr,
                                          ...
                                          size_t offset) {
#line 2801 "kos/src/libc/magic/stdlib.c"
	(void)min_alignment;
	(void)offset;
	if (!aligned_mallptr)
		return 0;
...
#line 2858 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atoflt_l)(float *__restrict result,
                                     char const *__restrict nptr,
                                     locale_t locale) {
#line 2864 "kos/src/libc/magic/stdlib.c"
...
#line 2872 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotl)(unsigned int val,
                             int shift) {
#line 2911 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotr)(unsigned int val,
                             int shift) {
#line 2920 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotl64)(u64 val,
                               int shift) {
#line 2930 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotr64)(u64 val,
                               int shift) {
#line 2939 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__makepath)(char *__restrict buf,
                                     ...
                                     char const *file,
                                     char const *ext) {
#line 2996 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__splitpath)(char const *__restrict abspath,
                                      ...
                                      char *file,
                                      char *ext) {
#line 3002 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_itoa)(int val,
                                char *buf,
                                int radix) {
#line 3223 "kos/src/libc/magic/stdlib.c"
...
#line 3278 "kos/src/libc/magic/stdlib.c"
