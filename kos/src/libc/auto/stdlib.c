...
NOTHROW_NCX(LIBCCALL libc_strto32)(char const *__restrict nptr,
                                   char **endptr,
                                   int base) {
#line 837 "kos/src/libc/magic/stdlib.c"
	u32 result;
	bool neg = 0;
	while (*nptr == '-') {
		neg = !neg;
...
NOTHROW_NCX(LIBCCALL libc_strto64)(char const *__restrict nptr,
                                   char **endptr,
                                   int base) {
#line 898 "kos/src/libc/magic/stdlib.c"
	u64 result;
	bool neg = 0;
	while (*nptr == '-') {
		neg = !neg;
...
(LIBCCALL libc_qsort_r)(void *pbase,
                        ...
                        __compar_d_fn_t cmp,
                        void *arg) __THROWS(...) {
#line 209 "kos/src/libc/magic/stdlib.c"
...
#line 417 "kos/src/libc/magic/stdlib.c"
...
#line 444 "kos/src/libc/magic/stdlib.c"
	return x < 0 ? -x : x;
}
...
NOTHROW_NCX(LIBCCALL libc_ldiv)(long numer,
                                long denom) {
#line 459 "kos/src/libc/magic/stdlib.c"
	ldiv_t result;
...
#line 552 "kos/src/libc/magic/stdlib.c"
	return x < 0 ? -x : x;
}
...
NOTHROW_NCX(LIBCCALL libc_div)(int numer,
                               int denom) {
#line 559 "kos/src/libc/magic/stdlib.c"
	div_t result;
	result.quot = numer / denom;
	result.rem  = numer % denom;
	return result;
...
NOTHROW_NCX(LIBCCALL libc_mblen)(char const *s,
                                 size_t n) {
#line 573 "kos/src/libc/magic/stdlib.c"
	/* TODO */
	return 0;
}
...
NOTHROW_NCX(LIBCCALL libc_mbtowc)(char32_t *__restrict pwc,
                                  ...
                                  size_t n) {
#line 578 "kos/src/libc/magic/stdlib.c"
	/* TODO */
	return 0;
}
...
NOTHROW_NCX(LIBCCALL libc_wctomb)(char *s,
                                  char32_t wchar) {
#line 583 "kos/src/libc/magic/stdlib.c"
	/* TODO */
	return 0;
}
...
NOTHROW_NCX(LIBCCALL libc_mbstowcs)(char32_t *__restrict pwcs,
                                    ...
                                    size_t maxlen) {
#line 588 "kos/src/libc/magic/stdlib.c"
	size_t result;
...
NOTHROW_NCX(LIBCCALL libc_wcstombs)(char *__restrict s,
                                    ...
                                    size_t n) {
#line 595 "kos/src/libc/magic/stdlib.c"
	/* TODO */
	return 0;
}
...
#line 661 "kos/src/libc/magic/stdlib.c"
...
#line 672 "kos/src/libc/magic/stdlib.c"
...
#line 739 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_strtof)(char const *__restrict nptr,
                                  char **endptr) {
#line 750 "kos/src/libc/magic/stdlib.c"
	/* TODO */
	return 0;
}
...
NOTHROW_NCX(LIBCCALL libc_ecvt_r)(double val,
                                  ...
                                  char *__restrict buf,
                                  size_t len) {
#line 947 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_fcvt_r)(double val,
                                  ...
                                  char *__restrict buf,
                                  size_t len) {
#line 956 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_qgcvt)(long double val,
                                 int ndigit,
                                 char *buf) {
#line 968 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_qecvt)(long double val,
                                 ...
                                 int *__restrict decptr,
                                 int *__restrict sign) {
#line 1013 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_ecvt)(double val,
                                ...
                                int *__restrict decptr,
                                int *__restrict sign) {
#line 1304 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_fcvt)(double val,
                                ...
                                int *__restrict decptr,
                                int *__restrict sign) {
#line 1319 "kos/src/libc/magic/stdlib.c"
...
#line 1332 "kos/src/libc/magic/stdlib.c"
	/* TODO: Implement here */
	return 0;
}
...
NOTHROW_NCX(LIBCCALL libc_strtoll_l)(char const *__restrict nptr,
                                     ...
                                     int base,
                                     locale_t locale) {
#line 1397 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc_strtold_l)(char const *__restrict nptr,
                                     char **endptr,
                                     locale_t locale) {
#line 1428 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__atoi_l)(char const *__restrict nptr,
                                   locale_t locale) {
#line 1694 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atol_l)(char const *__restrict nptr,
                                   locale_t locale) {
#line 1698 "kos/src/libc/magic/stdlib.c"
...
#line 1723 "kos/src/libc/magic/stdlib.c"
...
#line 1728 "kos/src/libc/magic/stdlib.c"
...
#line 1734 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_bsearch_s)(void const *key,
                                     ...
                                     void *arg) {
#line 1774 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_qsort_s)(void *base,
                                   ...
                                   __dos_compar_d_fn_t compar,
                                   void *arg) {
#line 1798 "kos/src/libc/magic/stdlib.c"
	struct __invoke_compare_helper_s_data data;
	data.__fun = compar;
	data.__arg = arg;
...
NOTHROW_NCX(LIBCCALL libc__itoa_s)(int val,
                                   ...
                                   size_t bufsize,
                                   int radix) {
#line 1832 "kos/src/libc/magic/stdlib.c"
	char *p;
	int temp;
	if (radix < 2)
		radix = 10;
...
NOTHROW_NCX(LIBCCALL libc__ltoa_s)(long val,
                                   ...
                                   size_t bufsize,
                                   int radix) {
#line 1863 "kos/src/libc/magic/stdlib.c"
	char *p;
	long temp;
	if (radix < 2)
		radix = 10;
...
NOTHROW_NCX(LIBCCALL libc__i64toa)(s64 val,
                                   char *buf,
                                   int radix) {
#line 1921 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__i64toa_s)(s64 val,
                                     ...
                                     size_t bufsize,
                                     int radix) {
#line 1937 "kos/src/libc/magic/stdlib.c"
	char *p;
	s64 temp;
	if (radix < 2)
		radix = 10;
...
NOTHROW_NCX(LIBCCALL libc__ui64toa_s)(u64 val,
                                      ...
                                      size_t bufsize,
                                      int radix) {
#line 1967 "kos/src/libc/magic/stdlib.c"
	char *p;
	u64 temp;
	if (radix < 2)
		radix = 10;
...
NOTHROW_NCX(LIBCCALL libc__atoi64_l)(char const *__restrict nptr,
                                     locale_t locale) {
#line 2017 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__mbstrnlen)(char const *str,
                                      size_t maxlen) {
#line 2030 "kos/src/libc/magic/stdlib.c"
	/* TODO */
	return 0;
}
...
NOTHROW_NCX(LIBCCALL libc__mbtowc_l)(char32_t *dst,
                                     ...
                                     size_t srclen,
                                     locale_t locale) {
#line 2053 "kos/src/libc/magic/stdlib.c"
	(void)locale;
...
NOTHROW_NCX(LIBCCALL libc__mbstowcs_l)(char32_t *buf,
                                       ...
                                       size_t maxlen,
                                       locale_t locale) {
#line 2058 "kos/src/libc/magic/stdlib.c"
	size_t result;
...
NOTHROW_NCX(LIBCCALL libc_wctomb_s)(int *presult,
                                    ...
                                    rsize_t buflen,
                                    char32_t wc) {
#line 2140 "kos/src/libc/magic/stdlib.c"
	if (!presult || !buf)
		return __EINVAL;
...
NOTHROW_NCX(LIBCCALL libc__aligned_msize)(void *mptr,
                                          ...
                                          size_t offset) {
#line 2275 "kos/src/libc/magic/stdlib.c"
	(void)min_alignment;
	(void)offset;
	if (!mptr)
		return 0;
...
NOTHROW_NCX(LIBCCALL libc__gcvt_s)(char *buf,
                                   ...
                                   double val,
                                   int ndigit) {
#line 2311 "kos/src/libc/magic/stdlib.c"
	int a, b;
	if (!buf)
		return __EINVAL;
...
#line 2329 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__atodbl_l)(double *__restrict result,
                                     char __KOS_FIXED_CONST *__restrict nptr,
                                     locale_t locale) {
#line 2348 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotl)(unsigned int val,
                             int shift) {
#line 2378 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotr)(unsigned int val,
                             int shift) {
#line 2386 "kos/src/libc/magic/stdlib.c"
...
NOTHROW(LIBCCALL libc__rotr64)(u64 val,
                               int shift) {
#line 2403 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc__makepath)(char *__restrict buf,
                                     ...
                                     char const *file,
                                     char const *ext) {
#line 2456 "kos/src/libc/magic/stdlib.c"
...
NOTHROW_NCX(LIBCCALL libc_strto64_l)(char const *__restrict nptr,
                                     ...
                                     int base,
                                     locale_t locale) {
#line 2599 "kos/src/libc/magic/stdlib.c"
	(void)locale;
