...
#line 179 "kos/src/libc/magic/wchar.c"
	/* TODO */
	return ch;
}
...
NOTHROW_NCX(LIBCCALL libc_mbrlen)(char const *__restrict str,
                                  size_t maxlen,
                                  mbstate_t *ps) {
#line 202 "kos/src/libc/magic/wchar.c"
	/* TODO */
	return 0;
}
INTERN WUNUSED NONNULL((1))
...
#line 247 "kos/src/libc/magic/wchar.c"
...
NOTHROW_NCX(LIBCCALL libc_vswprintf)(char32_t *__restrict buf,
                                     ...
                                     char32_t const *__restrict format,
                                     va_list args) {
#line 523 "kos/src/libc/magic/wchar.c"
	/* TODO: format_wprintf() */
	return 0;
}
INTERN ATTR_LIBC_WPRINTF(3, 0) NONNULL((1, 3))
...
NOTHROW_NCX(LIBCCALL libc_vswscanf)(char32_t const *__restrict src,
                                    char32_t const *__restrict format,
                                    va_list args) {
#line 580 "kos/src/libc/magic/wchar.c"
	/* TODO: format_wscanf() */
	return 0;
}
INTERN WUNUSED ATTR_LIBC_WSCANF(2, 0) NONNULL((1, 2))
...
#line 1428 "kos/src/libc/magic/wchar.c"
#if 4 == 2
