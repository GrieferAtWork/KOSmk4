...
[[if($extended_include_prefix("<features.h>")defined(__USE_FILE_OFFSET64)), preferred_alias("fts64_children")]]
[[if($extended_include_prefix("<features.h>")!defined(__USE_FILE_OFFSET64)), preferred_alias("fts_children")]]
FTSENT *fts_children([[nonnull]] FTS *ftsp, __STDC_INT_AS_UINT_T instr);

@@>> fts_close(3), fts_close64(3)
[[no_crt_self_import]]
[[if($extended_include_prefix("<features.h>")defined(__USE_FILE_OFFSET64)), preferred_alias("fts64_close")]]
[[if($extended_include_prefix("<features.h>")!defined(__USE_FILE_OFFSET64)), preferred_alias("fts_children")]]
...
[[cp, wunused, no_crt_self_import]]
[[if($extended_include_prefix("<bits/crt/fts.h>")defined(__FTS32_MATCHES_FTS64)), preferred_alias("fts_read")]]
[[if($extended_include_prefix("<features.h>")defined(__USE_FILE_OFFSET64)), preferred_alias("fts64_read")]]
[[if($extended_include_prefix("<features.h>")!defined(__USE_FILE_OFFSET64)), preferred_alias("fts_read")]]
FTSENT *fts_read([[nonnull]] FTS *ftsp);

@@>> fts_set(3), fts_set64(3)
@@@param: instr: One of `FTS_AGAIN', `FTS_FOLLOW', `FTS_NOINSTR' or `FTS_SKIP'
[[no_crt_self_import, decl_include("<features.h>")]]
[[if($extended_include_prefix("<bits/crt/fts.h>")defined(__FTS32_MATCHES_FTS64)), preferred_alias("fts_set")]]
[[if($extended_include_prefix("<features.h>")defined(__USE_FILE_OFFSET64)), preferred_alias("fts64_set")]]
[[if($extended_include_prefix("<features.h>")!defined(__USE_FILE_OFFSET64)), preferred_alias("fts_set")]]
...
[[doc_alias("fts_children"), fts64_variant_of(fts_children)]]
[[if($extended_include_prefix("<bits/crt/fts.h>")defined(__FTS32_MATCHES_FTS64)), preferred_alias("fts_children")]]
FTSENT64 *fts64_children([[nonnull]] FTS64 *ftsp, __STDC_INT_AS_UINT_T instr);

[[cp, wunused, decl_include("<bits/crt/fts.h>")]]
[[doc_alias("fts_close"), fts64_variant_of(fts_close)]]
...
[[if($extended_include_prefix("<bits/crt/fts.h>")defined(__FTS32_MATCHES_FTS64)), preferred_alias("fts_read")]]
FTSENT64 *fts64_read([[nonnull]] FTS64 *ftsp);

[[decl_include("<features.h>", "<bits/crt/fts.h>")]]
[[doc_alias("fts_set"), fts64_variant_of(fts_set)]]
[[if($extended_include_prefix("<bits/crt/fts.h>")defined(__FTS32_MATCHES_FTS64)), preferred_alias("fts_set")]]
int fts64_set([[nonnull]] FTS64 *ftsp,
              [[nonnull]] FTSENT64 *f,
              __STDC_INT_AS_UINT_T instr);
