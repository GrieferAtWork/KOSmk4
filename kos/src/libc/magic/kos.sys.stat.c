...
[throws][user][noexport][nocrt][doc_alias(stat)]
...
%
[throws][user][noexport][nocrt][doc_alias(fstat)]
...
[throws][user][noexport][nocrt][doc_alias(lstat)]
...
[throws][user][noexport][nocrt][doc_alias(stat64)][preferred_alias(KStat64)]
Stat64:([nonnull] char const *__restrict filename, [nonnull] struct stat64 *__restrict buf);

[throws][user][noexport][nocrt][doc_alias(fstat64)][preferred_alias(KFStat64)]
FStat64:($fd_t fd, [nonnull] struct stat64 *__restrict buf);

%
%#if defined(__USE_XOPEN_EXTENDED) || defined(__USE_XOPEN2K)
[throws][user][noexport][nocrt][doc_alias(lstat64)][preferred_alias(KLStat64)]
...
[throws][user][noexport][nocrt][doc_alias(fstatat)]
...
%#ifdef __USE_LARGEFILE64
[throws][user][noexport][nocrt][doc_alias(fstatat64)][preferred_alias(KFStatAt64)]
...
[throws][cp][noexport][doc_alias(futimens)]
