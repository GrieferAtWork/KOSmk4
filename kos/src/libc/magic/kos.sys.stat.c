...
[[throws, nocrt, doc_alias("stat")]]
[[if($extended_include_prefix("<features.h>", "<bits/os/stat.h>") defined(__USE_FILE_OFFSET64) || defined(__STAT32_MATCHES_STAT64)), preferred_alias("KStat")]]
[[if($extended_include_prefix("<features.h>", "<bits/os/stat.h>")!defined(__USE_FILE_OFFSET64) || defined(__STAT32_MATCHES_STAT64)), preferred_alias("KStat64")]]
void Stat([[nonnull]] char const *__restrict filename, [[nonnull]] struct stat *__restrict buf);

%
[[throws, nocrt, doc_alias("fstat")]]
[[if($extended_include_prefix("<features.h>", "<bits/os/stat.h>") defined(__USE_FILE_OFFSET64) || defined(__STAT32_MATCHES_STAT64)), preferred_alias("KFStat")]]
[[if($extended_include_prefix("<features.h>", "<bits/os/stat.h>")!defined(__USE_FILE_OFFSET64) || defined(__STAT32_MATCHES_STAT64)), preferred_alias("KFStat64")]]
void FStat($fd_t fd, [[nonnull]] struct stat *__restrict buf);

%
%#if defined(__USE_XOPEN_EXTENDED) || defined(__USE_XOPEN2K)
[[throws, nocrt, doc_alias("lstat")]]
[[if($extended_include_prefix("<features.h>", "<bits/os/stat.h>") defined(__USE_FILE_OFFSET64) || defined(__STAT32_MATCHES_STAT64)), preferred_alias("KLStat")]]
[[if($extended_include_prefix("<features.h>", "<bits/os/stat.h>")!defined(__USE_FILE_OFFSET64) || defined(__STAT32_MATCHES_STAT64)), preferred_alias("KLStat64")]]
...
[[throws, nocrt, doc_alias("fstatat")]]
[[if($extended_include_prefix("<features.h>", "<bits/os/stat.h>") defined(__USE_FILE_OFFSET64) || defined(__STAT32_MATCHES_STAT64)), preferred_alias("KFStatAt")]]
[[if($extended_include_prefix("<features.h>", "<bits/os/stat.h>")!defined(__USE_FILE_OFFSET64) || defined(__STAT32_MATCHES_STAT64)), preferred_alias("KFStatAt64")]]
...
void FMkdirAt($fd_t dirfd, [[nonnull]] char const *pathname, $mode_t mode, $atflag_t flags);

[[cp, throws, doc_alias("fmknodat")]]
void FMknodAt($fd_t dirfd, [[nonnull]] char const *nodename, $mode_t mode, $dev_t dev, $atflag_t flags);
...
void FChmodAt($fd_t dirfd, [[nonnull]] char const *filename, $mode_t mode, $atflag_t flags);
...
void Mknod([[nonnull]] char const *nodename, $mode_t mode, $dev_t dev);

%#ifdef __USE_ATFILE

[[cp, throws, doc_alias("mknodat")]]
void MknodAt($fd_t dirfd, [[nonnull]] char const *nodename, $mode_t mode, $dev_t dev);
...
%#ifdef __USE_TIME64
[[cp, throws, preferred_time64_variant_of(UTimensAt), doc_alias("utimensat")]]
...
[[cp, throws, preferred_time64_variant_of(FUtimens), doc_alias("futimens")]]
