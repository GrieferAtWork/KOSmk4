...
[crtbuiltin] acos:(double x) -> double;

@@Arc sine of X
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__asin)][nothrow]
[crtbuiltin] asin:(double x) -> double;

@@Arc tangent of X
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__atan)][nothrow]
[crtbuiltin] atan:(double x) -> double;

@@Arc tangent of Y/X
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__atan2)][nothrow]
[crtbuiltin] atan2:(double y, double x) -> double;

@@Cosine of X
[attribute(@__DECL_SIMD_cos@)][decl_include(<bits/math-vector.h>)]
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__cos)][nothrow]
[crtbuiltin] cos:(double x) -> double;

@@Sine of X
[attribute(@__DECL_SIMD_sin@)][decl_include(<bits/math-vector.h>)]
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__sin)][nothrow]
[crtbuiltin] sin:(double x) -> double;

@@Tangent of X
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__tan)][nothrow]
[crtbuiltin] tan:(double x) -> double;

[std][ATTR_WUNUSED][ATTR_MCONST][alias(__acosf)][nothrow][crtbuiltin] acosf:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__asinf)][nothrow][crtbuiltin] asinf:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__atanf)][nothrow][crtbuiltin] atanf:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__atan2f)][nothrow][crtbuiltin] atan2f:(float y, float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__cosf)][nothrow][crtbuiltin] cosf:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__sinf)][nothrow][crtbuiltin] sinf:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__tanf)][nothrow][crtbuiltin] tanf:(float x) -> float %{auto_block(math)}
%(std, c, ccompat)#ifdef __COMPILER_HAVE_LONGDOUBLE
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__acosl)][nothrow][crtbuiltin] acosl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__asinl)][nothrow][crtbuiltin] asinl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__atanl)][nothrow][crtbuiltin] atanl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__atan2l)][nothrow][crtbuiltin] atan2l:(long double y, long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__cosl)][nothrow][crtbuiltin] cosl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__sinl)][nothrow][crtbuiltin] sinl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__tanl)][nothrow][crtbuiltin] tanl:(long double x) -> long double %{auto_block(math)}
...
[crtbuiltin] cosh:(double x) -> double;

@@Hyperbolic sine of X
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__sinh)][nothrow]
[crtbuiltin] sinh:(double x) -> double;

@@Hyperbolic tangent of X
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__tanh)][nothrow]
[crtbuiltin] tanh:(double x) -> double;

[std][ATTR_WUNUSED][ATTR_MCONST][alias(__coshf)][nothrow][crtbuiltin] coshf:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__sinhf)][nothrow][crtbuiltin] sinhf:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__tanhf)][nothrow][crtbuiltin] tanhf:(float x) -> float %{auto_block(math)}
%(std, c, ccompat)#ifdef __COMPILER_HAVE_LONGDOUBLE
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__coshl)][nothrow][crtbuiltin] coshl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__sinhl)][nothrow][crtbuiltin] sinhl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__tanhl)][nothrow][crtbuiltin] tanhl:(long double x) -> long double %{auto_block(math)}
%(std, c, ccompat)#endif /* __COMPILER_HAVE_LONGDOUBLE */
...
[crtbuiltin] acosh:(double x) -> double;

@@Hyperbolic arc sine of X
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__asinh)][nothrow]
[crtbuiltin] asinh:(double x) -> double;

@@Hyperbolic arc tangent of X
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__atanh)][nothrow]
[crtbuiltin] atanh:(double x) -> double;

[std][ATTR_WUNUSED][ATTR_MCONST][alias(__acoshf)][nothrow][crtbuiltin] acoshf:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__asinhf)][nothrow][crtbuiltin] asinhf:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__atanhf)][nothrow][crtbuiltin] atanhf:(float x) -> float %{auto_block(math)}
%(std, c, ccompat)#ifdef __COMPILER_HAVE_LONGDOUBLE
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__acoshl)][nothrow][crtbuiltin] acoshl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__asinhl)][nothrow][crtbuiltin] asinhl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__atanhl)][nothrow][crtbuiltin] atanhl:(long double x) -> long double %{auto_block(math)}
%(std, c, ccompat)#endif /* __COMPILER_HAVE_LONGDOUBLE */
...
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__exp)][nothrow]
[crtbuiltin] exp:(double x) -> double;

@@Break VALUE into a normalized fraction and an integral power of 2
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__frexp)]
[crtbuiltin] frexp:(double x, int *pexponent) -> double;

@@X times (two to the EXP power)
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__ldexp)][nothrow]
[crtbuiltin] ldexp:(double x, int exponent) -> double;

@@Natural logarithm of X
[attribute(@__DECL_SIMD_log@)][decl_include(<bits/math-vector.h>)]
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__log)][nothrow]
[crtbuiltin] log:(double x) -> double;

@@Base-ten logarithm of X
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__log10)][nothrow]
[crtbuiltin] log10:(double x) -> double;

@@Break VALUE into integral and fractional parts
[std][ATTR_WUNUSED][alias(__modf)]
[crtbuiltin] modf:(double x, [nonnull] double *iptr) -> double;

[attribute(@__DECL_SIMD_expf@)][decl_include(<bits/math-vector.h>)]
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__expf)][nothrow]
[crtbuiltin] expf:(float x) -> float %{auto_block(math)}

[std][ATTR_WUNUSED][alias(__frexpf)][crtbuiltin] frexpf:(float x, int *pexponent) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__ldexpf)][nothrow][crtbuiltin] ldexpf:(float x, int exponent) -> float %{auto_block(math)}
[attribute(@__DECL_SIMD_logf@)][decl_include(<bits/math-vector.h>)]
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__logf)][nothrow][crtbuiltin] logf:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__log10f)][nothrow][crtbuiltin] log10f:(float x) -> float %{auto_block(math)}
...
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__expl)][nothrow][crtbuiltin] expl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__frexpl)][crtbuiltin] frexpl:(long double x, int *pexponent) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__ldexpl)][nothrow][crtbuiltin] ldexpl:(long double x, int exponent) -> long double %{auto_block(math)}
[attribute(@__DECL_SIMD_logl@)][decl_include(<bits/math-vector.h>)]
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__logl)][nothrow][crtbuiltin] logl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__log10l)][nothrow][crtbuiltin] log10l:(long double x) -> long double %{auto_block(math)}
[std][alias(__modfl)]
[if(__SIZEOF_LONG_DOUBLE__ == __SIZEOF_DOUBLE__), alias(__modf, modf)]
...
%(std, c, ccompat)#if defined(__USE_XOPEN_EXTENDED) || defined(__USE_ISOC99)
@@Return exp(X) - 1
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__expm1)][nothrow][crtbuiltin] expm1:(double x) -> double;

@@Return log(1 + X)
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__log1p)][nothrow][crtbuiltin] log1p:(double x) -> double;

@@Return the base 2 signed integral exponent of X
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__logb, _logb)][nothrow][crtbuiltin] logb:(double x) -> double;

[std][ATTR_WUNUSED][ATTR_MCONST][alias(__expm1f)][nothrow][crtbuiltin] expm1f:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__log1pf)][nothrow][crtbuiltin] log1pf:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__logbf)][nothrow][crtbuiltin] logbf:(float x) -> float %{auto_block(math)}
%(std, c, ccompat)#ifdef __COMPILER_HAVE_LONGDOUBLE
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__expm1l)][nothrow][crtbuiltin] expm1l:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__log1pl)][nothrow][crtbuiltin] log1pl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__logbl)][nothrow][crtbuiltin] logbl:(long double x) -> long double %{auto_block(math)}
%(std, c, ccompat)#endif /* __COMPILER_HAVE_LONGDOUBLE */
%(std, c, ccompat)#endif /* __USE_XOPEN_EXTENDED || __USE_ISOC99 */
...
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__exp2)][nothrow][crtbuiltin] exp2:(double x) -> double;

@@Compute base-2 logarithm of X
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__log2)][nothrow][crtbuiltin] log2:(double x) -> double;

[std][ATTR_WUNUSED][ATTR_MCONST][alias(__exp2f)][nothrow][crtbuiltin] exp2f:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__log2f)][nothrow][crtbuiltin] log2f:(float x) -> float %{auto_block(math)}
%(std, c, ccompat)#ifdef __COMPILER_HAVE_LONGDOUBLE
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__exp2l)][nothrow][crtbuiltin] exp2l:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__log2l)][nothrow][crtbuiltin] log2l:(long double x) -> long double %{auto_block(math)}
%(std, c, ccompat)#endif /* __COMPILER_HAVE_LONGDOUBLE */
...
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__pow)][nothrow][crtbuiltin] pow:(double x, double y) -> double;

@@Return the square root of X
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__sqrt)][nothrow][crtbuiltin] sqrt:(double x) -> double;

[attribute(@__DECL_SIMD_powf@)][decl_include(<bits/math-vector.h>)]
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__powf)][nothrow][crtbuiltin] powf:(float x, float y) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__sqrtf)][nothrow][crtbuiltin] sqrtf:(float x) -> float %{auto_block(math)}
%(std, c, ccompat)#ifdef __COMPILER_HAVE_LONGDOUBLE
[attribute(@__DECL_SIMD_powl@)][decl_include(<bits/math-vector.h>)]
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__powl)][nothrow][crtbuiltin] powl:(long double x, long double y) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__sqrtl)][nothrow][crtbuiltin] sqrtl:(long double x) -> long double %{auto_block(math)}
%(std, c, ccompat)#endif /* __COMPILER_HAVE_LONGDOUBLE */

%(std, c)
%(std, c, ccompat)#if defined(__USE_XOPEN) || defined(__USE_ISOC99)
@@Return `sqrt(X*X + Y*Y)'
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__hypot)][nothrow][crtbuiltin] hypot:(double x, double y) -> double;
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__hypotf)][nothrow][crtbuiltin] hypotf:(float x, float y) -> float %{auto_block(math)}
%(std, c, ccompat)#ifdef __COMPILER_HAVE_LONGDOUBLE
[std][ATTR_WUNUSED][ATTR_MCONST][alias(__hypotl)][nothrow][crtbuiltin] hypotl:(long double x, long double y) -> long double %{auto_block(math)}
%(std, c, ccompat)#endif /* __COMPILER_HAVE_LONGDOUBLE */
...
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__cbrt)][crtbuiltin] cbrt:(double x) -> double;
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__cbrtf)][crtbuiltin] cbrtf:(float x) -> float %{auto_block(math)}
%(std, c, ccompat)#ifdef __COMPILER_HAVE_LONGDOUBLE
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__cbrtl)][crtbuiltin] cbrtl:(long double x) -> long double %{auto_block(math)}
%(std, c, ccompat)#endif /* __COMPILER_HAVE_LONGDOUBLE */
%(std, c, ccompat)#endif /* __USE_XOPEN_EXTENDED || __USE_ISOC99 */
...
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__ceilf)][crtbuiltin] ceilf:(float x) -> float %{copy(%auto, math)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__fabsf)][crtbuiltin] fabsf:(float x) -> float %{copy(%auto, math)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__floorf)][crtbuiltin] floorf:(float x) -> float %{copy(%auto, math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__fmodf)][crtbuiltin] fmodf:(float x, float y) -> float %{auto_block(math)}
%(std, c, ccompat)#ifdef __COMPILER_HAVE_LONGDOUBLE
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__ceill)][crtbuiltin] ceill:(long double x) -> long double %{copy(%auto, math)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__fabsl)][crtbuiltin] fabsl:(long double x) -> long double %{copy(%auto, math)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__floorl)][crtbuiltin] floorl:(long double x) -> long double %{copy(%auto, math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__fmodl)][crtbuiltin] fmodl:(long double x, long double y) -> long double %{auto_block(math)}
%(std, c, ccompat)#endif /* __COMPILER_HAVE_LONGDOUBLE */
...
[crtbuiltin] copysign:(double num, double sign) -> double {
	if ((num < 0.0) != (sign < 0.0))
		num = -num;
	return num;
}
...
[dependency_include(<bits/nan.h>)]
[crtbuiltin] nan:(char const *tagb) -> double {
	(void)tagb;
	return (double)@NAN@;
}

[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__copysignf)][crtbuiltin] copysignf:(float num, float sign) -> float %{copy(%auto, math)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__nanf)][crtbuiltin] nanf:(char const *tagb) -> float %{copy(%auto, math)}
%(std, c, ccompat)#ifdef __COMPILER_HAVE_LONGDOUBLE
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__copysignl)][crtbuiltin] copysignl:(long double num, long double sign) -> long double %{copy(%auto, math)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__nanl)][crtbuiltin] nanl:(char const *tagb) -> long double %{copy(%auto, math)}
%(std, c, ccompat)#endif /* __COMPILER_HAVE_LONGDOUBLE */
%(std, c, ccompat)#endif /* __USE_ISOC99 */
...
%(std, c, ccompat)#if defined(__USE_XOPEN) || defined(__USE_ISOC99)
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__erf)][crtbuiltin] erf:(double x) -> double;
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__erfc)][crtbuiltin] erfc:(double x) -> double;
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__lgamma, __gamma, gamma)][crtbuiltin] lgamma:(double x) -> double;

[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__erff)][crtbuiltin] erff:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__erfcf)][crtbuiltin] erfcf:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__lgammaf, __gammaf, gammaf)][crtbuiltin] lgammaf:(float x) -> float %{auto_block(math)}
%(std, c, ccompat)#ifdef __COMPILER_HAVE_LONGDOUBLE
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__erfl)][crtbuiltin] erfl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__erfcl)][crtbuiltin] erfcl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__lgammal, __gammal, gammal)][crtbuiltin] lgammal:(long double x) -> long double %{auto_block(math)}
%(std, c, ccompat)#endif /* __COMPILER_HAVE_LONGDOUBLE */
%(std, c, ccompat)#endif /* __USE_XOPEN || __USE_ISOC99 */

%(std, c, ccompat)#ifdef __USE_ISOC99
@@True gamma function
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__tgamma)][crtbuiltin] tgamma:(double x) -> double;
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__tgammaf)][crtbuiltin] tgammaf:(float x) -> float %{auto_block(math)}
%(std, c, ccompat)#ifdef __COMPILER_HAVE_LONGDOUBLE
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__tgammal)][crtbuiltin] tgammal:(long double x) -> long double %{auto_block(math)}
%(std, c, ccompat)#endif /* __COMPILER_HAVE_LONGDOUBLE */
%(std, c, ccompat)#endif /* __USE_ISOC99 */
...
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__rint)][crtbuiltin] rint:(double x) -> double;

@@Return X + epsilon if X < Y, X - epsilon if X > Y
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__nextafter, _nextafter)][crtbuiltin] nextafter:(double x, double y) -> double;

@@Return the remainder of integer divison X / Y with infinite precision
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__remainder)][crtbuiltin] remainder:(double x, double y) -> double;

@@Return the binary exponent of X, which must be nonzero
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__ilogb)][crtbuiltin] ilogb:(double x) -> int;

[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__rintf)][crtbuiltin] rintf:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__nextafterf)][crtbuiltin] nextafterf:(float x, float y) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__remainderf)][crtbuiltin] remainderf:(float x, float y) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__ilogbf)][crtbuiltin] ilogbf:(float x) -> int %{auto_block(math)}
%(std, c, ccompat)#ifdef __COMPILER_HAVE_LONGDOUBLE
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__rintl)][crtbuiltin] rintl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__nextafterl)][crtbuiltin] nextafterl:(long double x, long double y) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__remainderl)][crtbuiltin] remainderl:(long double x, long double y) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__ilogbl)][crtbuiltin] ilogbl:(long double x) -> int %{auto_block(math)}
%(std, c, ccompat)#endif /* __COMPILER_HAVE_LONGDOUBLE */
%(std, c, ccompat)#endif /* __USE_XOPEN_EXTENDED || __USE_ISOC99 */
...
nexttoward:(double x, long double y) -> double;

@@Return X times (2 to the Nth power)
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__scalbn)][crtbuiltin]
scalbn:(double x, int n) -> double;

@@Return X times (2 to the Nth power)
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__scalbln)][crtbuiltin]
...
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__remquo)]
[crtbuiltin] remquo:(double x, double y, int *pquo) -> double;

@@Round X to nearest integral value according to current rounding direction
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__lrint)][crtbuiltin] lrint:(double x) -> long int;
...
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__fdim)][crtbuiltin]
fdim:(double x, double y) -> double {
	return fabs(y - x);
}

@@Return maximum numeric value from X and Y
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__fmax)]
[crtbuiltin] fmax:(double x, double y) -> double {
	return x < y ? y : x;
}

@@Return minimum numeric value from X and Y
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__fmin)]
[crtbuiltin] fmin:(double x, double y) -> double {
	return x < y ? x : y;
}

@@Multiply-add function computed as a ternary operation
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__fma)]
[crtbuiltin] fma:(double x, double y, double z) -> double {
	return (x * y) + z;
}
...
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__nexttowardf)][crtbuiltin] nexttowardf:(float x, long double y) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__scalbnf)][crtbuiltin] scalbnf:(float x, int n) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__scalblnf)][crtbuiltin] scalblnf:(float x, long int n) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__nearbyintf)][crtbuiltin] nearbyintf:(float x) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__roundf)][crtbuiltin] roundf:(float x) -> float %{copy(%auto, double2float)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__truncf)][crtbuiltin] truncf:(float x) -> float %{copy(%auto, double2float)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__remquof)][crtbuiltin] remquof:(float x, float y, int *pquo) -> float %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__lrintf)][crtbuiltin] lrintf:(float x) -> long int %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__lroundf)][crtbuiltin] lroundf:(float x) -> long int %{copy(%auto, double2float)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__fdimf)][crtbuiltin] fdimf:(float x, float y) -> float %{copy(%auto, math)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__fmaxf)][crtbuiltin] fmaxf:(float x, float y) -> float %{copy(%auto, double2float)}
...
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__scalbnl)][crtbuiltin] scalbnl:(long double x, int n) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__scalblnl)][crtbuiltin] scalblnl:(long double x, long int n) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__nearbyintl)][crtbuiltin] nearbyintl:(long double x) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__roundl)][crtbuiltin] roundl:(long double x) -> long double %{copy(%auto, math)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__truncl)][crtbuiltin] truncl:(long double x) -> long double %{copy(%auto, math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__remquol)][crtbuiltin] remquol:(long double x, long double y, int *pquo) -> long double %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__lrintl)][crtbuiltin] lrintl:(long double x) -> long int %{auto_block(math)}
[std][ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__lroundl)][crtbuiltin] lroundl:(long double x) -> long int %{copy(%auto, math)}
...
[alias(__sincos)][nothrow][crtbuiltin]
[attribute(@__DECL_SIMD_sincos@)][decl_include(<bits/math-vector.h>)]
sincos:(double x, [nonnull] double *psinx, [nonnull] double *pcosx);


@@A function missing in all standards: compute exponent to base ten
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__exp10)] exp10:(double x) -> double;

@@Another name occasionally used
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__pow10)] pow10:(double x) -> double;
...
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__exp10f)] exp10f:(float x) -> float %{auto_block(math)}
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__pow10f)] pow10f:(float x) -> float %{auto_block(math)}
%#ifdef __COMPILER_HAVE_LONGDOUBLE
[alias(__sincosl)][nothrow][doc_alias(sincos)]
[attribute(@__DECL_SIMD_sincosl@)][decl_include(<bits/math-vector.h>)]
[if(__SIZEOF_LONG_DOUBLE__ == __SIZEOF_DOUBLE__), alias(__sincos, sincos)]
[requires($has_function(sincos))][crtbuiltin]
...
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__exp10l)] exp10l:(long double x) -> long double %{auto_block(math)}
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__pow10l)] pow10l:(long double x) -> long double %{auto_block(math)}
...
[if(__SIZEOF_LONG_DOUBLE__ == __SIZEOF_DOUBLE__), alias(__isinf, isinf)]
[dependency_include(<bits/huge_vall.h>)][crtbuiltin]
isinfl:(long double val) -> int {
...
finite:(double val) -> int {
	return !isinf(val) && !isnan(val);
}

@@Return the remainder of X/Y
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__drem)] drem:(double x, double y) -> double;

@@Return the fractional part of X after dividing out `ilogb (X)'
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__significand)] significand:(double x) -> double;

[ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__finitef)][crtbuiltin]
finitef:(float val) -> int  {
	return !isinff(val) && !isnanf(val);
}

[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__dremf)] dremf:(float x, float y) -> float %{auto_block(math)}
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__significandf)] significandf:(float x) -> float %{auto_block(math)}

%#ifdef __COMPILER_HAVE_LONGDOUBLE
[ATTR_WUNUSED][ATTR_CONST][nothrow][alias(__finitel)][crtbuiltin]
[if(__SIZEOF_LONG_DOUBLE__ == __SIZEOF_DOUBLE__), alias(__finite, finite)]
finitel:(long double val) -> int {
	return !isinfl(val) && !isnanl(val);
}

[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__dreml)] dreml:(long double x, long double y) -> long double %{auto_block(math)}
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__significandl)] significandl:(long double x) -> long double %{auto_block(math)}
%#endif /* __COMPILER_HAVE_LONGDOUBLE */
%#endif /* __USE_MISC */
...
[if(__SIZEOF_LONG_DOUBLE__ == __SIZEOF_DOUBLE__), alias(__isnan, _isnan, isnan)]
[dependency_include(<bits/nan.h>)][crtbuiltin]
isnanl:(long double val) -> int  {
...
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__j0)] j0:(double x) -> double;
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__j1)] j1:(double x) -> double;
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__jn)] jn:(int n, double x) -> double;
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__y0)] y0:(double x) -> double;
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__y1)] y1:(double x) -> double;
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__yn)] yn:(int n, double x) -> double;

[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__j0f)] j0f:(float x) -> float %{auto_block(math)}
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__j1f)] j1f:(float x) -> float %{auto_block(math)}
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__jnf)] jnf:(int n, float x) -> float %{auto_block(math)}
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__y0f)] y0f:(float x) -> float %{auto_block(math)}
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__y1f)] y1f:(float x) -> float %{auto_block(math)}
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__ynf)] ynf:(int n, float x) -> float %{auto_block(math)}
%#ifdef __COMPILER_HAVE_LONGDOUBLE
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__j0l)] j0l:(long double x) -> long double %{auto_block(math)}
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__j1l)] j1l:(long double x) -> long double %{auto_block(math)}
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__jnl)] jnl:(int n, long double x) -> long double %{auto_block(math)}
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__y0l)] y0l:(long double x) -> long double %{auto_block(math)}
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__y1l)] y1l:(long double x) -> long double %{auto_block(math)}
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__ynl)] ynl:(int n, long double x) -> long double %{auto_block(math)}
%#endif /* __COMPILER_HAVE_LONGDOUBLE */
...
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__gamma, __lgamma)] gamma:(double x) -> double = lgamma;
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__gammaf, __lgammaf)] gammaf:(float x) -> float = lgammaf;
%#ifdef __COMPILER_HAVE_LONGDOUBLE
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__gammal, __lgammal)] gammal:(long double x) -> long double = lgammal;
%#endif /* __COMPILER_HAVE_LONGDOUBLE */
%#endif /* __USE_MISC || (__USE_XOPEN && !__USE_XOPEN2K) */
...
[crtbuiltin][ATTR_WUNUSED][alias(__lgamma_r)] lgamma_r:(double x, int *signgamp) -> double;
[crtbuiltin][ATTR_WUNUSED][alias(__lgammaf_r)] lgammaf_r:(float x, int *signgamp) -> float %{auto_block(math(float, lgamma_r))}
%#ifdef __COMPILER_HAVE_LONGDOUBLE
[crtbuiltin][ATTR_WUNUSED][alias(__lgammal_r)] lgammal_r:(long double x, int *signgamp) -> long double %{auto_block(math(long double, lgamma_r))}
%#endif /* __COMPILER_HAVE_LONGDOUBLE */
%#endif /* __USE_MISC */
...
@@Return X times (2 to the Nth power)
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__scalb, _scalb)] scalb:(double x, double n) -> double;
%#endif /* __USE_MISC || (__USE_XOPEN_EXTENDED && !__USE_XOPEN2K8) */
%#ifdef __USE_MISC
@@Return X times (2 to the Nth power)
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__scalbf, _scalbf)] scalbf:(float x, float n) -> float %{auto_block(math)}
%#ifdef __COMPILER_HAVE_LONGDOUBLE
@@Return X times (2 to the Nth power)
[crtbuiltin][ATTR_WUNUSED][ATTR_MCONST][nothrow][alias(__scalbl)]
[if(__SIZEOF_LONG_DOUBLE__ == __SIZEOF_DOUBLE__), alias(_scalb)]
...
%#ifdef __USE_ISOC99
[ATTR_WUNUSED][ATTR_CONST][nothrow][alias(_dclass)] __fpclassify:(double val) -> int;
[ATTR_WUNUSED][ATTR_CONST][nothrow][alias(_dsign)] __signbit:(double val) -> int;
[ATTR_WUNUSED][ATTR_CONST][nothrow][alias(_fdclass)] __fpclassifyf:(float val) -> int %{auto_block(math)}
[ATTR_WUNUSED][ATTR_CONST][nothrow][alias(_fdsign)] __signbitf:(float val) -> int %{auto_block(math)}
%#ifdef __COMPILER_HAVE_LONGDOUBLE
[ATTR_WUNUSED][ATTR_CONST][nothrow][alias(_ldclass)] __fpclassifyl:(long double val) -> int %{auto_block(math)}
[ATTR_WUNUSED][ATTR_CONST][nothrow][alias(_ldsign)] __signbitl:(long double val) -> int %{auto_block(math)}
%#endif /* __COMPILER_HAVE_LONGDOUBLE */
%#endif /* __USE_ISOC99 */

%
%#ifdef __USE_GNU
[ATTR_WUNUSED][ATTR_CONST][nothrow] __issignaling:(double val) -> int;
[ATTR_WUNUSED][ATTR_CONST][nothrow] __issignalingf:(float val) -> int %{auto_block(math)}
%#ifdef __COMPILER_HAVE_LONGDOUBLE
[ATTR_WUNUSED][ATTR_CONST][nothrow] __issignalingl:(long double val) -> int %{auto_block(math)}
%#endif /* __COMPILER_HAVE_LONGDOUBLE */
%#endif /* __USE_GNU */

[ignore][nouser][noexport][ATTR_WUNUSED][ATTR_CONST] _dpcomp:(double x, double y) -> int;
[ignore][nouser][noexport][ATTR_WUNUSED][ATTR_CONST] _fdpcomp:(float x, float y) -> int %{auto_block(math(float, _dpcomp))}
[ignore][nouser][noexport][ATTR_WUNUSED][ATTR_CONST] _ldpcomp:(long double x, long double y) -> int %{auto_block(math(long double, _dpcomp))}
