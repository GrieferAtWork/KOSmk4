...
[requires_dependent_function(wexecv)][ATTR_SENTINEL][dosname(_wexecl)][allow_macros]
...
[cp][wchar][guard][dependency_include("<parts/redirect-exec.h>")]
[requires_dependent_function(wexecvp)][ATTR_SENTINEL][dosname(_wexeclp)][allow_macros]
...
[cp][wchar][guard][dependency_include("<parts/redirect-exec.h>")]
[requires_dependent_function(wexecve)][ATTR_SENTINEL_O(1)][dosname(_wexecle)][allow_macros]
...
[cp][wchar][guard][dependency_include("<parts/redirect-exec.h>")]
[requires_dependent_function(wexecvpe)][ATTR_SENTINEL_O(1)][dosname(_wexecle)][allow_macros]
...
[cp][wchar][guard][dependency_include("<parts/redirect-exec.h>")]
[requires_dependent_function(wspawnv)][ATTR_SENTINEL][dosname(_wspawnl)][allow_macros]
...
[cp][wchar][guard][dependency_include("<parts/redirect-exec.h>")]
[requires_dependent_function(wspawnvp)][ATTR_SENTINEL][dosname(_wspawnlp)][allow_macros]
...
[cp][wchar][guard][dependency_include("<parts/redirect-exec.h>")]
[requires_dependent_function(wspawnve)][ATTR_SENTINEL_O(1)][dosname(_wspawnle)][allow_macros]
...
[cp][wchar][guard][dependency_include("<parts/redirect-exec.h>")]
[requires_dependent_function(wspawnvpe)][ATTR_SENTINEL_O(1)][dosname(_wspawnle)][allow_macros]
