...
%
[[throws, doc_alias("pipe"), section(".text.crt.except.io.access")]]
void Pipe([[nonnull]] $fd_t pipedes[2]);


%
[[cp, throws, doc_alias("fsync"), userimpl]]
...
%
[[throws, doc_alias("setsid")]]
$pid_t SetSid();

%
[[throws, doc_alias("setuid")]]
void SetUid($uid_t uid);

%
[[throws, doc_alias("setgid")]]
...
%
[[cp, throws, doc_alias("read"), section(".text.crt.except.io.read")]]
size_t Read($fd_t fd, [[outp(bufsize)]] void *buf, size_t bufsize);

%
[[cp, throws, doc_alias("write"), section(".text.crt.except.io.write")]]
size_t Write($fd_t fd, [[inp(bufsize)]] void const *buf, size_t bufsize);

%
%#ifdef __USE_KOS
[[cp, throws, doc_alias("readall"), section(".text.crt.except.io.read")]]
...
[[throws, doc_alias("lseek32"), ignore, nocrt, alias("LSeek")]]
...
%
[[throws, doc_alias("dup2"), section(".text.crt.except.io.access")]]
...
%
%#ifdef __USE_LARGEFILE64
[[throws, doc_alias("lseek64"), off64_variant_of(LSeek)]]
...
%
[[cp, throws, doc_alias(pread), no_crt_self_import]]
...
[[cp, throws, doc_alias("pwrite"), no_crt_self_import]]
...
%
%#ifdef __USE_KOS
[[cp, throws, doc_alias("preadall"), no_crt_self_import]]
...
[[userimpl, requires_function(PRead32), section(".text.crt.except.io.large.read")]]
size_t PRead64($fd_t fd, [[outp(bufsize)]] void *buf, size_t bufsize, pos64_t offset) {
	return PRead32(fd, buf, bufsize, (pos32_t)offset);
}

[[cp, throws, doc_alias("pwrite64"), off64_variant_of(PWrite)]]
[[userimpl, requires_function(PWrite32), section(".text.crt.except.io.large.write")]]
...
%
%#ifdef __USE_KOS
[[cp, throws, ignore, nocrt, alias("PReadAll")]]
...
[[userimpl, requires_function(PRead64), section(".text.crt.except.io.large.read")]]
...
[[throws, doc_alias("pipe2"), section(".text.crt.except.io.access")]]
void Pipe2([[nonnull]] $fd_t pipedes[2], $oflag_t flags);

[[throws, doc_alias("dup3"), section(".text.crt.except.io.access")]]
$fd_t Dup3($fd_t oldfd, $fd_t newfd, $oflag_t flags);

[[cp, throws, doc_alias("get_current_dir_name")]]
[[userimpl, requires_function(GetCwd), section(".text.crt.except.fs.basic_property")]]
GetCurrentDirName() -> [[nonnull, malloc]] char * {
	return GetCwd(NULL, 0);
}

[[cp, throws]]
[[userimpl, section(".text.crt.except.fs.modify")]]
void SyncFs($fd_t fd) {
	(void)fd;
	/* NO-OP */
}
...
%
[[cp, throws, doc_alias("fchown"), section(".text.crt.except.fs.modify")]]
void FChown($fd_t fd, $uid_t owner, $gid_t group);

%
[[cp, throws, doc_alias("fchdir"), section(".text.crt.except.fs.basic_property")]]
void FChdir($fd_t fd);
...
%
[[cp, throws, doc_alias("lchown"), section(".text.crt.except.fs.modify")]]
[[userimpl, requires(defined(__CRT_AT_FDCWD) && $has_function(FChownAt))]]
...
[[throws, doc_alias("Truncate"), ignore, nocrt, alias("Truncate")]]
vodi Truncate32([[nonnull]] char const *file, $pos32_t length);

%
%#ifdef __USE_LARGEFILE64
[[throws, doc_alias("truncate64"), off64_variant_of(Truncate)]]
[[userimpl, requires_function(Truncate32), section(".text.crt.except.fs.modify")]]
...
%
[[cp, throws, guard, ATTR_NORETURN, doc_alias("fexecve")]]
...
[[throws, userimpl, section(".text.crt.except.sched.param")]]
int Nice(int inc) {
	(void)inc;
...
[[throws, doc_alias(setpgrp), section(".text.crt.except.sched.process")]]
void SetPGrp();

[[throws, doc_alias(setreuid), section(".text.crt.except.sched.user")]]
void SetReUid($uid_t ruid, $uid_t euid);

[[throws, doc_alias(setregid), section(".text.crt.except.sched.user")]]
void SetReGid($gid_t rgid, $gid_t egid);
%#endif /* __USE_MISC || __USE_XOPEN_EXTENDED */

%
%#ifdef __USE_XOPEN2K
[[throws, doc_alias(seteuid), section(".text.crt.except.sched.user")]]
void SetEUid($uid_t euid);

[[throws, doc_alias(setegid), section(".text.crt.except.sched.user")]]
void SetEGid($gid_t egid);
%#endif /* __USE_XOPEN2K */

%
%#if defined(__USE_XOPEN_EXTENDED) || defined(__USE_XOPEN2K)
[[cp, throws, doc_alias("symlink"), section(".text.crt.except.fs.modify")]]
...
%
[[cp, throws, doc_alias("readlink"), section(".text.crt.except.fs.property")]]
...
[[throws, doc_alias("gethostname")]]
[[section(".text.crt.except.system.configuration")]]
...
[[cp, throws, section(".text.crt.except.system.utility")]]
__syscall_slong_t Syscall(__syscall_ulong_t sysno, ...);

%#ifdef __USE_KOS
[[cp, throws, section(".text.crt.except.system.utility"), preferred_alias("Syscall")]]
...
[[cp, throws, doc_alias("chroot"), section(".text.crt.except.fs.utility")]]
...
[[throws, doc_alias("ftruncate32"), ignore, nocrt, alias("FTruncate")]]
...
[[cp, throws, doc_alias("fdatasync"), userimpl]]
[[alias("FSync"), section(".text.crt.except.io.sync")]]
