...
%
[[cp, throws, doc_alias("read"), section(".text.crt{|.dos}.except.io.read")]]
size_t Read($fd_t fd, [[outp(bufsize)]] void *buf, size_t bufsize);

%
[[cp, throws, doc_alias("write"), section(".text.crt{|.dos}.except.io.write")]]
size_t Write($fd_t fd, [[inp(bufsize)]] void const *buf, size_t bufsize);

%
%#ifdef __USE_KOS
[[cp, throws, doc_alias("readall"), section(".text.crt{|.dos}.except.io.read")]]
...
%
[[throws, doc_alias("dup2"), section(".text.crt{|.dos}.except.io.access")]]
$fd_t Dup2($fd_t oldfd, $fd_t newfd);

%
[[wunused, doc_alias("dup"), section(".text.crt{|.dos}.except.io.access")]]
$fd_t Dup($fd_t fd);
...
[[throws, doc_alias("pipe2"), section(".text.crt{|.dos}.except.io.access")]]
void Pipe2([[nonnull]] $fd_t pipedes[2], $oflag_t flags);

[[throws, doc_alias("dup3"), section(".text.crt{|.dos}.except.io.access")]]
...
%
[[cp, throws, doc_alias("fchown"), section(".text.crt{|.dos}.except.fs.modify")]]
void FChown($fd_t fd, $uid_t owner, $gid_t group);

%
[[cp, throws, doc_alias("fchdir"), section(".text.crt{|.dos}.except.fs.basic_property")]]
void FChdir($fd_t fd);

%
[[throws, wunused, doc_alias("getpgid"), section(".text.crt{|.dos}.except.sched.user")]]
$pid_t GetPGid($pid_t pid);

%
[[throws, wunused, doc_alias("getsid"), section(".text.crt{|.dos}.except.sched.process")]]
$pid_t GetSid($pid_t pid);

%
[[cp, throws, doc_alias("lchown"), section(".text.crt{|.dos}.except.fs.modify")]]
[[userimpl, requires(defined(__CRT_AT_FDCWD) && $has_function(FChownAt))]]
...
[[throws, doc_alias(setreuid), section(".text.crt{|.dos}.except.sched.user")]]
void SetReUid($uid_t ruid, $uid_t euid);

[[throws, doc_alias(setregid), section(".text.crt{|.dos}.except.sched.user")]]
void SetReGid($gid_t rgid, $gid_t egid);
%#endif /* __USE_MISC || __USE_XOPEN_EXTENDED */

%
%#ifdef __USE_XOPEN2K
[[throws, doc_alias(seteuid), section(".text.crt{|.dos}.except.sched.user")]]
void SetEUid($uid_t euid);

[[throws, doc_alias(setegid), section(".text.crt{|.dos}.except.sched.user")]]
...
%
[[cp, throws, doc_alias("readlink"), section(".text.crt{|.dos}.except.fs.property")]]
...
%#ifdef __USE_MISC
%
[[throws, doc_alias("sethostname"), section(".text.crt{|.dos}.except.system.configuration")]]
void SetHostName([[inp(len)]] char const *name, size_t len);

%
[[throws, doc_alias("getdomainname"), section(".text.crt{|.dos}.except.system.configuration")]]
void GetDomainName([[outp(buflen)]] char *name, size_t buflen);

%
[[throws, doc_alias("setdomainname"), section(".text.crt{|.dos}.except.system.configuration")]]
