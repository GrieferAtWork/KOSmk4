...
[[noblock, wunused, nothrow]] bool readb_nopf([[user, checked]] void const *addr, [[nonnull]] $uint8_t *presult);
[[noblock, wunused, nothrow, doc_alias("readb_nopf")]] bool readw_nopf([[user, checked]] void const *addr, [[nonnull]] $uint16_t *presult);
[[noblock, wunused, nothrow, doc_alias("readb_nopf")]] bool readl_nopf([[user, checked]] void const *addr, [[nonnull]] $uint32_t *presult);
[[noblock, wunused, nothrow, doc_alias("readb_nopf")]] bool readq_nopf([[user, checked]] void const *addr, [[nonnull]] $uint64_t *presult);

@@>> write[bwlq]_nopf(3)
@@Try to write `val' into a possibly faulty `addr'
@@Return  `true'  on  success,  `false'  on  error
[[no_crt_impl, noblock, wunused, nothrow]] bool writeb_nopf([[user, checked]] void *addr, $uint8_t val);
[[no_crt_impl, noblock, wunused, nothrow, doc_alias("writeb_nopf")]] bool writew_nopf([[user, checked]] void *addr, $uint16_t val);
[[no_crt_impl, noblock, wunused, nothrow, doc_alias("writeb_nopf")]] bool writel_nopf([[user, checked]] void *addr, $uint32_t val);
[[no_crt_impl, noblock, wunused, nothrow, doc_alias("writeb_nopf")]] bool writeq_nopf([[user, checked]] void *addr, $uint64_t val);
...
@@Return `true' on success, `false' on fault
[[noblock, wunused, nothrow]] bool atomic_xchb_nopf([[user, checked]] void const *addr, $uint8_t newval, [[nonnull]] $uint8_t *poldval);
[[noblock, wunused, nothrow, doc_alias("atomic_xchb_nopf")]] bool atomic_xchw_nopf([[user, checked]] void const *addr, $uint16_t newval, [[nonnull]] $uint16_t *poldval);
[[noblock, wunused, nothrow, doc_alias("atomic_xchb_nopf")]] bool atomic_xchl_nopf([[user, checked]] void const *addr, $uint32_t newval, [[nonnull]] $uint32_t *poldval);
...
[[noblock, wunused, nothrow, doc_alias("atomic_fetchaddb_nopf")]] bool atomic_fetchaddw_nopf([[user, checked]] void const *addr, $uint16_t addend, [[nonnull]] $uint16_t *poldval);
[[noblock, wunused, nothrow, doc_alias("atomic_fetchaddb_nopf")]] bool atomic_fetchaddl_nopf([[user, checked]] void const *addr, $uint32_t addend, [[nonnull]] $uint32_t *poldval);
[[noblock, wunused, nothrow, doc_alias("atomic_fetchaddb_nopf")]] bool atomic_fetchaddq_nopf([[user, checked]] void const *addr, $uint64_t addend, [[nonnull]] $uint64_t *poldval);

@@>> atomic_or[bwlq]_nopf(3)
@@Try to atomically turn on all bits from `mask' at the possibly faulty `addr'
@@Return `true' on success, `false' on fault
[[noblock, wunused, nothrow]] bool atomic_orb_nopf([[user, checked]] void *addr, $uint8_t mask);
[[noblock, wunused, nothrow, doc_alias("atomic_orb_nopf")]] bool atomic_orw_nopf([[user, checked]] void *addr, $uint16_t mask);
[[noblock, wunused, nothrow, doc_alias("atomic_orb_nopf")]] bool atomic_orl_nopf([[user, checked]] void *addr, $uint32_t mask);
[[noblock, wunused, nothrow, doc_alias("atomic_orb_nopf")]] bool atomic_orq_nopf([[user, checked]] void *addr, $uint64_t mask);

@@>> atomic_and[bwlq]_nopf(3)
@@Try to atomically mask all bits with `mask' at the possibly faulty `addr'
@@Return `true' on success, `false' on fault
[[noblock, wunused, nothrow]] bool atomic_andb_nopf([[user, checked]] void *addr, $uint8_t mask);
[[noblock, wunused, nothrow, doc_alias("atomic_andb_nopf")]] bool atomic_andw_nopf([[user, checked]] void *addr, $uint16_t mask);
[[noblock, wunused, nothrow, doc_alias("atomic_andb_nopf")]] bool atomic_andl_nopf([[user, checked]] void *addr, $uint32_t mask);
[[noblock, wunused, nothrow, doc_alias("atomic_andb_nopf")]] bool atomic_andq_nopf([[user, checked]] void *addr, $uint64_t mask);

@@>> atomic_xor[bwlq]_nopf(3)
@@Try to atomically flip all bits from `mask' at the possibly faulty `addr'
@@Return `true' on success, `false' on fault
[[noblock, wunused, nothrow]] bool atomic_xorb_nopf([[user, checked]] void *addr, $uint8_t mask);
[[noblock, wunused, nothrow, doc_alias("atomic_xorb_nopf")]] bool atomic_xorw_nopf([[user, checked]] void *addr, $uint16_t mask);
[[noblock, wunused, nothrow, doc_alias("atomic_xorb_nopf")]] bool atomic_xorl_nopf([[user, checked]] void *addr, $uint32_t mask);
[[noblock, wunused, nothrow, doc_alias("atomic_xorb_nopf")]] bool atomic_xorq_nopf([[user, checked]] void *addr, $uint64_t mask);

@@>> atomic_cmpxch[bwlq]_nopf(3)
@@Try to do an atomic-compare-exchange at the possibly faulty `addr'
@@Return `true' on success, `false' on fault
[[noblock, wunused, nothrow]] bool atomic_cmpxchb_nopf([[user, checked]] void *addr, $uint8_t oldval, $uint8_t newval, [[nonnull]] $uint8_t *preal_oldval);
[[noblock, wunused, nothrow, doc_alias("atomic_cmpxchb_nopf")]] bool atomic_cmpxchw_nopf([[user, checked]] void *addr, $uint16_t oldval, $uint16_t newval, [[nonnull]] $uint16_t *preal_oldval);
[[noblock, wunused, nothrow, doc_alias("atomic_cmpxchb_nopf")]] bool atomic_cmpxchl_nopf([[user, checked]] void *addr, $uint32_t oldval, $uint32_t newval, [[nonnull]] $uint32_t *preal_oldval);
[[noblock, wunused, nothrow, doc_alias("atomic_cmpxchb_nopf")]] bool atomic_cmpxchq_nopf([[user, checked]] void *addr, $uint64_t oldval, $uint64_t newval, [[nonnull]] $uint64_t *preal_oldval);
