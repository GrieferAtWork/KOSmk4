...
/* pthread */
DFUN(".text.crt.dos.sched.pthread.core.exit", libd_pthread_exit, libc_pthread_exit, TV, 1, TP)
DFUN(".text.crt.dos.sched.pthread.core.thread", libd_pthread_join, libc_pthread_join, TIn(__SIZEOF_ERRNO_T__), 2, TIn(__SIZEOF_PTHREAD_T), TP)
DFUN(".text.crt.dos.sched.pthread.ext.kos.thread", libd_pthread_getresult_np, libc_pthread_getresult_np, TIn(__SIZEOF_ERRNO_T__), 2, TIn(__SIZEOF_PTHREAD_T), TP)
DFUN(".text.crt.dos.sched.pthread.ext.gnu.thread", libd_pthread_tryjoin_np, libc_pthread_tryjoin_np, TIn(__SIZEOF_ERRNO_T__), 2, TIn(__SIZEOF_PTHREAD_T), TP)
DFUN(".text.crt.dos.sched.pthread.ext.timed.thread", libd_pthread_timedjoin_np, libc_pthread_timedjoin_np, TIn(__SIZEOF_ERRNO_T__), 3, TIn(__SIZEOF_PTHREAD_T), TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.clock.thread", libd_pthread_clockjoin_np, libc_pthread_clockjoin_np, TIn(__SIZEOF_ERRNO_T__), 4, TIn(__SIZEOF_PTHREAD_T), TP, TIn(__SIZEOF_CLOCKID_T__), TP)
DFUN(".text.crt.dos.sched.pthread.ext.timed64.thread", libd_pthread_timedjoin64_np, libc_pthread_timedjoin64_np, TIn(__SIZEOF_ERRNO_T__), 3, TIn(__SIZEOF_PTHREAD_T), TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.clock64.thread", libd_pthread_clockjoin64_np, libc_pthread_clockjoin64_np, TIn(__SIZEOF_ERRNO_T__), 4, TIn(__SIZEOF_PTHREAD_T), TP, TIn(__SIZEOF_CLOCKID_T__), TP)
DFUN(".text.crt.dos.sched.pthread.core.thread", libd_pthread_detach, libc_pthread_detach, TIn(__SIZEOF_ERRNO_T__), 1, TIn(__SIZEOF_PTHREAD_T))
DFUN(".text.crt.dos.sched.pthread.core.thread", libd_pthread_equal, libc_pthread_equal, TD, 2, TIn(__SIZEOF_PTHREAD_T), TIn(__SIZEOF_PTHREAD_T))
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_init, libc_pthread_attr_init, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_destroy, libc_pthread_attr_destroy, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_getdetachstate, libc_pthread_attr_getdetachstate, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_setdetachstate, libc_pthread_attr_setdetachstate, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_getguardsize, libc_pthread_attr_getguardsize, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_setguardsize, libc_pthread_attr_setguardsize, TIn(__SIZEOF_ERRNO_T__), 2, TP, TI)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_getschedparam, libc_pthread_attr_getschedparam, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_setschedparam, libc_pthread_attr_setschedparam, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_getschedpolicy, libc_pthread_attr_getschedpolicy, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_setschedpolicy, libc_pthread_attr_setschedpolicy, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_getinheritsched, libc_pthread_attr_getinheritsched, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_setinheritsched, libc_pthread_attr_setinheritsched, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_getscope, libc_pthread_attr_getscope, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_setscope, libc_pthread_attr_setscope, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_getstackaddr, libc_pthread_attr_getstackaddr, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_setstackaddr, libc_pthread_attr_setstackaddr, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_getstacksize, libc_pthread_attr_getstacksize, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_setstacksize, libc_pthread_attr_setstacksize, TIn(__SIZEOF_ERRNO_T__), 2, TP, TI)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_getstack, libc_pthread_attr_getstack, TIn(__SIZEOF_ERRNO_T__), 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_attr_setstack, libc_pthread_attr_setstack, TIn(__SIZEOF_ERRNO_T__), 3, TP, TP, TI)
DFUN(".text.crt.dos.sched.pthread.ext.gnu.affinity", libd_pthread_attr_setaffinity_np, libc_pthread_attr_setaffinity_np, TIn(__SIZEOF_ERRNO_T__), 3, TP, TI, TP)
DFUN(".text.crt.dos.sched.pthread.ext.gnu.affinity", libd_pthread_attr_getaffinity_np, libc_pthread_attr_getaffinity_np, TIn(__SIZEOF_ERRNO_T__), 3, TP, TI, TP)
DFUN(".text.crt.dos.sched.pthread.core.thread", libd_pthread_getattr_default_np, libc_pthread_getattr_default_np, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.ext.gnu.thread", libd_pthread_setattr_default_np, libc_pthread_setattr_default_np, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.ext.gnu.thread", libd_pthread_getattr_np, libc_pthread_getattr_np, TIn(__SIZEOF_ERRNO_T__), 2, TIn(__SIZEOF_PTHREAD_T), TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_setschedparam, libc_pthread_setschedparam, TIn(__SIZEOF_ERRNO_T__), 3, TIn(__SIZEOF_PTHREAD_T), TD, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_getschedparam, libc_pthread_getschedparam, TIn(__SIZEOF_ERRNO_T__), 3, TIn(__SIZEOF_PTHREAD_T), TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.thread", libd_pthread_setschedprio, libc_pthread_setschedprio, TIn(__SIZEOF_ERRNO_T__), 2, TIn(__SIZEOF_PTHREAD_T), TD)
DFUN(".text.crt.dos.sched.pthread.ext.gnu.thread.name", libd_pthread_getname_np, libc_pthread_getname_np, TIn(__SIZEOF_ERRNO_T__), 3, TIn(__SIZEOF_PTHREAD_T), TP, TI)
DFUN(".text.crt.dos.sched.pthread.ext.gnu.thread.name", libd_pthread_setname_np, libc_pthread_setname_np, TIn(__SIZEOF_ERRNO_T__), 2, TIn(__SIZEOF_PTHREAD_T), TP)
DFUN(".text.crt.dos.sched.pthread.ext.kos.tid", libd_pthread_gettid_np, libc_pthread_gettid_np, TIn(__SIZEOF_PID_T__), 1, TIn(__SIZEOF_PTHREAD_T))
DFUN(".text.crt.dos.sched.pthread.ext.kos.tid", libd_pthread_getpidfd_np, libc_pthread_getpidfd_np, TIn(__SIZEOF_ERRNO_T__), 2, TIn(__SIZEOF_PTHREAD_T), TP)
DFUN(".text.crt.dos.sched.pthread.ext.kos.tid", libd_pthread_attr_setpidfdallocated_np, libc_pthread_attr_setpidfdallocated_np, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.ext.kos.tid", libd_pthread_attr_getpidfdallocated_np, libc_pthread_attr_getpidfdallocated_np, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.concurrency", libd_pthread_setconcurrency, libc_pthread_setconcurrency, TIn(__SIZEOF_ERRNO_T__), 1, TD)
DFUN(".text.crt.dos.sched.pthread.ext.gnu.affinity", libd_pthread_setaffinity_np, libc_pthread_setaffinity_np, TIn(__SIZEOF_ERRNO_T__), 3, TIn(__SIZEOF_PTHREAD_T), TI, TP)
DFUN(".text.crt.dos.sched.pthread.ext.gnu.affinity", libd_pthread_getaffinity_np, libc_pthread_getaffinity_np, TIn(__SIZEOF_ERRNO_T__), 3, TIn(__SIZEOF_PTHREAD_T), TI, TP)
DFUN(".text.crt.dos.sched.pthread.core.once", libd_pthread_once, libc_pthread_once, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.cancel", libd_pthread_setcancelstate, libc_pthread_setcancelstate, TIn(__SIZEOF_ERRNO_T__), 2, TD, TP)
DFUN(".text.crt.dos.sched.pthread.cancel", libd_pthread_setcanceltype, libc_pthread_setcanceltype, TIn(__SIZEOF_ERRNO_T__), 2, TD, TP)
DFUN(".text.crt.dos.sched.pthread.cancel", libd_pthread_cancel, libc_pthread_cancel, TIn(__SIZEOF_ERRNO_T__), 1, TIn(__SIZEOF_PTHREAD_T))
DFUN(".text.crt.dos.sched.pthread.ext.gnu.cleanup", libd___pthread_cleanup_routine, libc___pthread_cleanup_routine, TV, 1, TP)
DFUN(".text.crt.dos.sched.pthread.ext.gnu.cleanup", libd___pthread_register_cancel, libc___pthread_register_cancel, TV, 1, TP)
DFUN(".text.crt.dos.sched.pthread.ext.gnu.cleanup", libd___pthread_unregister_cancel, libc___pthread_unregister_cancel, TV, 1, TP)
DFUN(".text.crt.dos.sched.pthread.ext.gnu.cleanup", libd___pthread_register_cancel_defer, libc___pthread_register_cancel_defer, TV, 1, TP)
DFUN(".text.crt.dos.sched.pthread.ext.gnu.cleanup", libd___pthread_unregister_cancel_restore, libc___pthread_unregister_cancel_restore, TV, 1, TP)
DFUN(".text.crt.dos.sched.pthread.ext.gnu.cleanup", libd___pthread_unwind_next, libc___pthread_unwind_next, TV, 1, TP)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutex_init, libc_pthread_mutex_init, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutex_destroy, libc_pthread_mutex_destroy, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.core.mutex", libd_pthread_mutex_trylock, libc_pthread_mutex_trylock, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.core.mutex", libd_pthread_mutex_lock, libc_pthread_mutex_lock, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.ext.timed.mutex", libd_pthread_mutex_timedlock, libc_pthread_mutex_timedlock, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.timed64.mutex", libd_pthread_mutex_timedlock64, libc_pthread_mutex_timedlock64, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.reltimed.mutex", libd_pthread_mutex_reltimedlock_np, libc_pthread_mutex_reltimedlock_np, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.reltimed64.mutex", libd_pthread_mutex_reltimedlock64_np, libc_pthread_mutex_reltimedlock64_np, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.clock.mutex", libd_pthread_mutex_clocklock, libc_pthread_mutex_clocklock, TIn(__SIZEOF_ERRNO_T__), 3, TP, TIn(__SIZEOF_CLOCKID_T__), TP)
DFUN(".text.crt.dos.sched.pthread.ext.clock64.mutex", libd_pthread_mutex_clocklock64, libc_pthread_mutex_clocklock64, TIn(__SIZEOF_ERRNO_T__), 3, TP, TIn(__SIZEOF_CLOCKID_T__), TP)
DFUN(".text.crt.dos.sched.pthread.core.mutex", libd_pthread_mutex_unlock, libc_pthread_mutex_unlock, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutex_getprioceiling, libc_pthread_mutex_getprioceiling, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutex_setprioceiling, libc_pthread_mutex_setprioceiling, TIn(__SIZEOF_ERRNO_T__), 3, TP, TD, TP)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutex_consistent, libc_pthread_mutex_consistent, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutexattr_init, libc_pthread_mutexattr_init, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutexattr_destroy, libc_pthread_mutexattr_destroy, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutexattr_getpshared, libc_pthread_mutexattr_getpshared, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutexattr_setpshared, libc_pthread_mutexattr_setpshared, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutexattr_gettype, libc_pthread_mutexattr_gettype, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutexattr_settype, libc_pthread_mutexattr_settype, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutexattr_getprotocol, libc_pthread_mutexattr_getprotocol, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutexattr_setprotocol, libc_pthread_mutexattr_setprotocol, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutexattr_getprioceiling, libc_pthread_mutexattr_getprioceiling, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutexattr_setprioceiling, libc_pthread_mutexattr_setprioceiling, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutexattr_getrobust, libc_pthread_mutexattr_getrobust, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.mutex", libd_pthread_mutexattr_setrobust, libc_pthread_mutexattr_setrobust, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.attr.rwlock", libd_pthread_rwlock_init, libc_pthread_rwlock_init, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.rwlock", libd_pthread_rwlock_destroy, libc_pthread_rwlock_destroy, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.core.rwlock", libd_pthread_rwlock_rdlock, libc_pthread_rwlock_rdlock, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.core.rwlock", libd_pthread_rwlock_tryrdlock, libc_pthread_rwlock_tryrdlock, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.core.rwlock", libd_pthread_rwlock_wrlock, libc_pthread_rwlock_wrlock, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.core.rwlock", libd_pthread_rwlock_trywrlock, libc_pthread_rwlock_trywrlock, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.ext.timed.rwlock", libd_pthread_rwlock_timedrdlock, libc_pthread_rwlock_timedrdlock, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.timed.rwlock", libd_pthread_rwlock_timedwrlock, libc_pthread_rwlock_timedwrlock, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.timed64.rwlock", libd_pthread_rwlock_timedrdlock64, libc_pthread_rwlock_timedrdlock64, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.timed64.rwlock", libd_pthread_rwlock_timedwrlock64, libc_pthread_rwlock_timedwrlock64, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.reltimed.rwlock", libd_pthread_rwlock_reltimedrdlock_np, libc_pthread_rwlock_reltimedrdlock_np, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
...
DFUN(".text.crt.dos.sched.pthread.attr.rwlock", libd_pthread_rwlockattr_getpshared, libc_pthread_rwlockattr_getpshared, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.rwlock", libd_pthread_rwlockattr_setpshared, libc_pthread_rwlockattr_setpshared, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.ext.misc", libd_pthread_rwlockattr_getkind_np, libc_pthread_rwlockattr_getkind_np, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.misc", libd_pthread_rwlockattr_setkind_np, libc_pthread_rwlockattr_setkind_np, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.attr.cond", libd_pthread_cond_init, libc_pthread_cond_init, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.cond", libd_pthread_cond_destroy, libc_pthread_cond_destroy, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.core.cond", libd_pthread_cond_signal, libc_pthread_cond_signal, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.core.cond", libd_pthread_cond_broadcast, libc_pthread_cond_broadcast, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.core.cond", libd_pthread_cond_wait, libc_pthread_cond_wait, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.timed.cond", libd_pthread_cond_timedwait, libc_pthread_cond_timedwait, TIn(__SIZEOF_ERRNO_T__), 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.timed64.cond", libd_pthread_cond_timedwait64, libc_pthread_cond_timedwait64, TIn(__SIZEOF_ERRNO_T__), 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.reltimed.cond", libd_pthread_cond_reltimedwait_np, libc_pthread_cond_reltimedwait_np, TIn(__SIZEOF_ERRNO_T__), 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.reltimed64.cond", libd_pthread_cond_reltimedwait64_np, libc_pthread_cond_reltimedwait64_np, TIn(__SIZEOF_ERRNO_T__), 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.clock.cond", libd_pthread_cond_clockwait, libc_pthread_cond_clockwait, TIn(__SIZEOF_ERRNO_T__), 4, TP, TP, TIn(__SIZEOF_CLOCKID_T__), TP)
DFUN(".text.crt.dos.sched.pthread.ext.clock64.cond", libd_pthread_cond_clockwait64, libc_pthread_cond_clockwait64, TIn(__SIZEOF_ERRNO_T__), 4, TP, TP, TIn(__SIZEOF_CLOCKID_T__), TP)
DFUN(".text.crt.dos.sched.pthread.attr.cond", libd_pthread_condattr_init, libc_pthread_condattr_init, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.attr.cond", libd_pthread_condattr_destroy, libc_pthread_condattr_destroy, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.attr.cond", libd_pthread_condattr_getpshared, libc_pthread_condattr_getpshared, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.cond", libd_pthread_condattr_setpshared, libc_pthread_condattr_setpshared, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.ext.timed64.cond", libd_pthread_condattr_getclock, libc_pthread_condattr_getclock, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.timed64.cond", libd_pthread_condattr_setclock, libc_pthread_condattr_setclock, TIn(__SIZEOF_ERRNO_T__), 2, TP, TIn(__SIZEOF_CLOCKID_T__))
DFUN(".text.crt.dos.sched.pthread.core.spin", libd_pthread_spin_init, libc_pthread_spin_init, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.core.spin", libd_pthread_spin_destroy, libc_pthread_spin_destroy, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.core.spin", libd_pthread_spin_lock, libc_pthread_spin_lock, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.core.spin", libd_pthread_spin_trylock, libc_pthread_spin_trylock, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.core.spin", libd_pthread_spin_unlock, libc_pthread_spin_unlock, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.attr.barrier", libd_pthread_barrier_init, libc_pthread_barrier_init, TIn(__SIZEOF_ERRNO_T__), 3, TP, TP, TD)
DFUN(".text.crt.dos.sched.pthread.attr.barrier", libd_pthread_barrier_destroy, libc_pthread_barrier_destroy, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.core.barrier", libd_pthread_barrier_wait, libc_pthread_barrier_wait, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.attr.barrier", libd_pthread_barrierattr_init, libc_pthread_barrierattr_init, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.attr.barrier", libd_pthread_barrierattr_destroy, libc_pthread_barrierattr_destroy, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.attr.barrier", libd_pthread_barrierattr_getpshared, libc_pthread_barrierattr_getpshared, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.attr.barrier", libd_pthread_barrierattr_setpshared, libc_pthread_barrierattr_setpshared, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.core.tls", libd_pthread_key_delete, libc_pthread_key_delete, TIn(__SIZEOF_ERRNO_T__), 1, TIn(__SIZEOF_PTHREAD_KEY_T))
DFUN(".text.crt.dos.sched.pthread.core.tls", libd_pthread_getspecific, libc_pthread_getspecific, TP, 1, TIn(__SIZEOF_PTHREAD_KEY_T))
DFUN(".text.crt.dos.sched.pthread.core.tls", libd_pthread_setspecific, libc_pthread_setspecific, TIn(__SIZEOF_ERRNO_T__), 2, TIn(__SIZEOF_PTHREAD_KEY_T), TP)
DFUN(".text.crt.dos.sched.pthread.core.tls", libd_pthread_getspecificptr_np, libc_pthread_getspecificptr_np, TP, 1, TIn(__SIZEOF_PTHREAD_KEY_T))
DFUN(".text.crt.dos.sched.pthread.ext.misc", libd_pthread_getcpuclockid, libc_pthread_getcpuclockid, TIn(__SIZEOF_ERRNO_T__), 2, TIn(__SIZEOF_PTHREAD_T), TP)
DFUN(".text.crt.dos.sched.pthread.ext.misc", libd_pthread_atfork, libc_pthread_atfork, TIn(__SIZEOF_ERRNO_T__), 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.misc.affinity", libd_pthread_set_num_processors_np, libc_pthread_set_num_processors_np, TIn(__SIZEOF_ERRNO_T__), 1, TD)
DFUN(".text.crt.dos.sched.pthread.ext.kos.suspend", libd_pthread_attr_setstartsuspended_np, libc_pthread_attr_setstartsuspended_np, TIn(__SIZEOF_ERRNO_T__), 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread.ext.kos.suspend", libd_pthread_attr_getstartsuspended_np, libc_pthread_attr_getstartsuspended_np, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.kos.suspend", libd_pthread_suspend2_np, libc_pthread_suspend2_np, TIn(__SIZEOF_ERRNO_T__), 2, TIn(__SIZEOF_PTHREAD_T), TP)
DFUN(".text.crt.dos.sched.pthread.ext.kos.suspend", libd_pthread_resume2_np, libc_pthread_resume2_np, TIn(__SIZEOF_ERRNO_T__), 2, TIn(__SIZEOF_PTHREAD_T), TP)
DFUN(".text.crt.dos.sched.pthread.ext.kos.tid", libd_pthread_attach_np, libc_pthread_attach_np, TV, 1, TIn(__SIZEOF_PTHREAD_T))
DFUN(".text.crt.dos.sched.pthread.ext.kos.tid", libd_pthread_enumthreads_np, libc_pthread_enumthreads_np, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread.ext.kos.tid", libd_pthread_attachtid_np, libc_pthread_attachtid_np, TIn(__SIZEOF_ERRNO_T__), 2, TIn(__SIZEOF_PID_T__), TP)
DFUN(".text.crt.dos.sched.pthread.ext.kos.tid", libd_pthread_attachpidfd_np, libc_pthread_attachpidfd_np, TIn(__SIZEOF_ERRNO_T__), 2, TIn(__SIZEOF_FD_T__), TP)
DFUN(".text.crt.dos.sched.pthread.ext.kos.suspend", libd_pthread_continue_np, libc_pthread_continue_np, TIn(__SIZEOF_ERRNO_T__), 1, TIn(__SIZEOF_PTHREAD_T))
DFUN(".text.crt.dos.sched.pthread.ext.kos.suspend", libd_pthread_attr_setcreatesuspend_np, libc_pthread_attr_setcreatesuspend_np, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DFUN(".text.crt.dos.sched.pthread.ext.kos.suspend", libd_pthread_suspend_np, libc_pthread_suspend_np, TIn(__SIZEOF_ERRNO_T__), 1, TIn(__SIZEOF_PTHREAD_T))
DFUN(".text.crt.dos.sched.pthread.ext.kos.suspend", libd_pthread_resume_np, libc_pthread_resume_np, TIn(__SIZEOF_ERRNO_T__), 1, TIn(__SIZEOF_PTHREAD_T))
DFUN(".text.crt.dos.sched.pthread.ext.kos.tid", libd_pthread_getunique_np, libc_pthread_getunique_np, TIn(__SIZEOF_ERRNO_T__), 2, TIn(__SIZEOF_PTHREAD_T), TP)
DFUN(".text.crt.dos.sched.pthread.ext.kos", libd_pthread_mutex_isowned_np, libc_pthread_mutex_isowned_np, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread.ext.misc", libd_pthread_switch_add_np, libc_pthread_switch_add_np, TIn(__SIZEOF_ERRNO_T__), 1, TP)
DEFINE_INTERN_ALIAS(libd_pthread_switch_delete_np, libd_pthread_switch_add_np);
DFUN(".text.crt.dos.sched.pthread.ext.misc", libd_pthread_get_stacksize_np, libc_pthread_get_stacksize_np, TI, 1, TIn(__SIZEOF_PTHREAD_T))
DFUN(".text.crt.dos.sched.pthread.ext.misc", libd_pthread_get_stackaddr_np, libc_pthread_get_stackaddr_np, TP, 1, TIn(__SIZEOF_PTHREAD_T))
...
DFUN(".text.crt.dos.fs.exec.posix_spawn", libd_posix_xspawn_np, libc_posix_xspawn_np, TIn(__SIZEOF_ERRNO_T__), 5, TP, TP, TP, TP, TP)
...
DFUN(".text.crt.dos.fs.exec.posix_spawn", libd_pidfd_xspawn_np, libc_pidfd_xspawn_np, TIn(__SIZEOF_ERRNO_T__), 5, TP, TP, TP, TP, TP)
...
/* stdbit */
DFUN(".text.crt.dos.stdbit", libd_stdc_leading_zeros_uc, libc_stdc_leading_zeros_uc, TD, 1, THH)
DFUN(".text.crt.dos.stdbit", libd_stdc_leading_zeros_us, libc_stdc_leading_zeros_us, TD, 1, TH)
DFUN(".text.crt.dos.stdbit", libd_stdc_leading_zeros_ui, libc_stdc_leading_zeros_ui, TD, 1, TD)
DFUN(".text.crt.dos.stdbit", libd_stdc_leading_zeros_ul, libc_stdc_leading_zeros_ul, TD, 1, TL)
DFUN(".text.crt.dos.stdbit", libd_stdc_leading_ones_uc, libc_stdc_leading_ones_uc, TD, 1, THH)
DFUN(".text.crt.dos.stdbit", libd_stdc_leading_ones_us, libc_stdc_leading_ones_us, TD, 1, TH)
DFUN(".text.crt.dos.stdbit", libd_stdc_leading_ones_ui, libc_stdc_leading_ones_ui, TD, 1, TD)
DFUN(".text.crt.dos.stdbit", libd_stdc_leading_ones_ul, libc_stdc_leading_ones_ul, TD, 1, TL)
DFUN(".text.crt.dos.stdbit", libd_stdc_trailing_zeros_uc, libc_stdc_trailing_zeros_uc, TD, 1, THH)
DFUN(".text.crt.dos.stdbit", libd_stdc_trailing_zeros_us, libc_stdc_trailing_zeros_us, TD, 1, TH)
DFUN(".text.crt.dos.stdbit", libd_stdc_trailing_zeros_ui, libc_stdc_trailing_zeros_ui, TD, 1, TD)
DFUN(".text.crt.dos.stdbit", libd_stdc_trailing_zeros_ul, libc_stdc_trailing_zeros_ul, TD, 1, TL)
DFUN(".text.crt.dos.stdbit", libd_stdc_trailing_ones_uc, libc_stdc_trailing_ones_uc, TD, 1, THH)
DFUN(".text.crt.dos.stdbit", libd_stdc_trailing_ones_us, libc_stdc_trailing_ones_us, TD, 1, TH)
DFUN(".text.crt.dos.stdbit", libd_stdc_trailing_ones_ui, libc_stdc_trailing_ones_ui, TD, 1, TD)
DFUN(".text.crt.dos.stdbit", libd_stdc_trailing_ones_ul, libc_stdc_trailing_ones_ul, TD, 1, TL)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_leading_one_uc, libc_stdc_first_leading_one_uc, TD, 1, THH)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_leading_one_us, libc_stdc_first_leading_one_us, TD, 1, TH)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_leading_zero_uc, libc_stdc_first_leading_zero_uc, TD, 1, THH)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_leading_zero_us, libc_stdc_first_leading_zero_us, TD, 1, TH)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_leading_zero_ui, libc_stdc_first_leading_zero_ui, TD, 1, TD)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_leading_zero_ul, libc_stdc_first_leading_zero_ul, TD, 1, TL)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_trailing_zero_uc, libc_stdc_first_trailing_zero_uc, TD, 1, THH)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_trailing_zero_us, libc_stdc_first_trailing_zero_us, TD, 1, TH)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_trailing_zero_ui, libc_stdc_first_trailing_zero_ui, TD, 1, TD)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_trailing_zero_ul, libc_stdc_first_trailing_zero_ul, TD, 1, TL)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_trailing_one_uc, libc_stdc_first_trailing_one_uc, TD, 1, THH)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_trailing_one_us, libc_stdc_first_trailing_one_us, TD, 1, TH)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_trailing_one_ui, libc_stdc_first_trailing_one_ui, TD, 1, TD)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_trailing_one_ul, libc_stdc_first_trailing_one_ul, TD, 1, TL)
DFUN(".text.crt.dos.stdbit", libd_stdc_count_ones_uc, libc_stdc_count_ones_uc, TD, 1, THH)
DFUN(".text.crt.dos.stdbit", libd_stdc_count_ones_us, libc_stdc_count_ones_us, TD, 1, TH)
DFUN(".text.crt.dos.stdbit", libd_stdc_count_zeros_uc, libc_stdc_count_zeros_uc, TD, 1, THH)
DFUN(".text.crt.dos.stdbit", libd_stdc_count_zeros_us, libc_stdc_count_zeros_us, TD, 1, TH)
DFUN(".text.crt.dos.stdbit", libd_stdc_count_zeros_ui, libc_stdc_count_zeros_ui, TD, 1, TD)
DFUN(".text.crt.dos.stdbit", libd_stdc_count_zeros_ul, libc_stdc_count_zeros_ul, TD, 1, TL)
DFUN(".text.crt.dos.stdbit", libd_stdc_has_single_bit_uc, libc_stdc_has_single_bit_uc, TD, 1, THH)
DFUN(".text.crt.dos.stdbit", libd_stdc_has_single_bit_us, libc_stdc_has_single_bit_us, TD, 1, TH)
DFUN(".text.crt.dos.stdbit", libd_stdc_has_single_bit_ui, libc_stdc_has_single_bit_ui, TD, 1, TD)
DFUN(".text.crt.dos.stdbit", libd_stdc_has_single_bit_ul, libc_stdc_has_single_bit_ul, TD, 1, TL)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_width_uc, libc_stdc_bit_width_uc, TD, 1, THH)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_width_us, libc_stdc_bit_width_us, TD, 1, TH)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_width_ui, libc_stdc_bit_width_ui, TD, 1, TD)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_width_ul, libc_stdc_bit_width_ul, TD, 1, TL)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_floor_uc, libc_stdc_bit_floor_uc, THH, 1, THH)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_floor_us, libc_stdc_bit_floor_us, TH, 1, TH)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_floor_ui, libc_stdc_bit_floor_ui, TD, 1, TD)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_floor_ul, libc_stdc_bit_floor_ul, TL, 1, TL)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_ceil_uc, libc_stdc_bit_ceil_uc, THH, 1, THH)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_ceil_us, libc_stdc_bit_ceil_us, TH, 1, TH)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_ceil_ui, libc_stdc_bit_ceil_ui, TD, 1, TD)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_ceil_ul, libc_stdc_bit_ceil_ul, TL, 1, TL)
DFUN(".text.crt.dos.stdbit", libd_stdc_leading_zeros_ull, libc_stdc_leading_zeros_ull, TD, 1, TLL)
DFUN(".text.crt.dos.stdbit", libd_stdc_leading_ones_ull, libc_stdc_leading_ones_ull, TD, 1, TLL)
DFUN(".text.crt.dos.stdbit", libd_stdc_trailing_zeros_ull, libc_stdc_trailing_zeros_ull, TD, 1, TLL)
DFUN(".text.crt.dos.stdbit", libd_stdc_trailing_ones_ull, libc_stdc_trailing_ones_ull, TD, 1, TLL)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_leading_zero_ull, libc_stdc_first_leading_zero_ull, TD, 1, TLL)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_trailing_zero_ull, libc_stdc_first_trailing_zero_ull, TD, 1, TLL)
DFUN(".text.crt.dos.stdbit", libd_stdc_first_trailing_one_ull, libc_stdc_first_trailing_one_ull, TD, 1, TLL)
DFUN(".text.crt.dos.stdbit", libd_stdc_count_zeros_ull, libc_stdc_count_zeros_ull, TD, 1, TLL)
DFUN(".text.crt.dos.stdbit", libd_stdc_has_single_bit_ull, libc_stdc_has_single_bit_ull, TD, 1, TLL)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_width_ull, libc_stdc_bit_width_ull, TD, 1, TLL)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_floor_ull, libc_stdc_bit_floor_ull, TLL, 1, TLL)
DFUN(".text.crt.dos.stdbit", libd_stdc_bit_ceil_ull, libc_stdc_bit_ceil_ull, TLL, 1, TLL)
