...
DFUN(".text.crt.dos.sched.pthread", libd_pthread_kill, libc_pthread_kill, TD, 2, TIn(__SIZEOF_PTHREAD_T), TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_sigqueue, libc_pthread_sigqueue, TD, 3, TIn(__SIZEOF_PTHREAD_T), TD, TS(__SIZEOF_SIGVAL CONST))
...
DFUN(".text.crt.dos.fs.dir", libd_scandirat, libc_scandirat, TD, 5, TIn(__SIZEOF_FD_T__), TP, TP, TP, TP)
DFUN(".text.crt.dos.fs.dir", libd_scandir64, libc_scandir64, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.fs.dir", libd_scandirat64, libc_scandirat64, TD, 5, TIn(__SIZEOF_FD_T__), TP, TP, TP, TP)
...
/* glob */
DFUN(".text.crt.dos.utility.glob", libd_glob, libc_glob, TD, 4, TP, TD, TP, TP)
DFUN(".text.crt.dos.utility.glob", libd_globfree, libc_globfree, TV, 1, TP)
DFUN(".text.crt.dos.utility.glob", libd_glob64, libc_glob64, TD, 4, TP, TD, TP, TP)
...
DFUN(".text.crt.dos.fs.dir", libd__findfirst32, libc__findfirst32, TP, 2, TP, TP)
DFUN(".text.crt.dos.fs.dir", libd__findfirst32i64, libc__findfirst32i64, TP, 2, TP, TP)
DFUN(".text.crt.dos.fs.dir", libd__findfirst64, libc__findfirst64, TP, 2, TP, TP)
...
DFUN(".text.crt.dos.fs.io", libd__sopen_s, libc__sopen_s, TIn(__SIZEOF_ERRNO_T__), 5, TP, TP, TIn(__SIZEOF_OFLAG_T__), TD, TIn(__SIZEOF_MODE_T__))
...
DFUN(".text.crt.dos.unsorted", libd_get_exception_handler, libc_get_exception_handler, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.unsorted", libd_except_handler3, libc_except_handler3, TV, 2, TP, TP)
DFUN(".text.crt.dos.unsorted", libd_except_handler4, libc_except_handler4, TV, 2, TP, TP)

/* kos.fcntl */
DFUN(".text.crt.dos.except.io.utility", libd_Fcntl, libc_Fcntl, TD, 3, TIn(__SIZEOF_FD_T__), TD, TP)
DFUN(".text.crt.dos.except.io.access", libd_Open, libc_Open, TIn(__SIZEOF_FD_T__), 3, TP, TIn(__SIZEOF_OFLAG_T__), TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.except.io.access", libd_Creat, libc_Creat, TIn(__SIZEOF_FD_T__), 2, TP, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.except.io.access", libd_Open64, libc_Open64, TIn(__SIZEOF_FD_T__), 3, TP, TIn(__SIZEOF_OFLAG_T__), TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.except.io.access", libd_Creat64, libc_Creat64, TIn(__SIZEOF_FD_T__), 2, TP, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.except.io.access", libd_OpenAt, libc_OpenAt, TIn(__SIZEOF_FD_T__), 4, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_OFLAG_T__), TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.except.io.access", libd_OpenAt64, libc_OpenAt64, TIn(__SIZEOF_FD_T__), 4, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_OFLAG_T__), TIn(__SIZEOF_MODE_T__))

/* kos.futex */
DFUN(".text.crt.dos.sched.futex", libd_lfutex, libc_lfutex, TI, 5, TP, TIn(__SIZEOF_SYSCALL_LONG_T__), TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_lfutex64, libc_lfutex64, TI, 5, TP, TIn(__SIZEOF_SYSCALL_LONG_T__), TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_wake, libc_futex_wake, TI, 2, TP, TI)
DFUN(".text.crt.dos.sched.futex", libd_futex_wakeall, libc_futex_wakeall, TI, 1, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_wakemask, libc_futex_wakemask, TI, 4, TP, TI, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_waitwhile, libc_futex_waitwhile, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_waituntil, libc_futex_waituntil, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_waitwhile_above, libc_futex_waitwhile_above, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_waitwhile_below, libc_futex_waitwhile_below, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_waitwhile_aboveequal, libc_futex_waitwhile_aboveequal, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_waitwhile_belowequal, libc_futex_waitwhile_belowequal, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_waitwhile_cmpxch, libc_futex_waitwhile_cmpxch, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_waituntil_cmpxch, libc_futex_waituntil_cmpxch, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_waitlock, libc_futex_waitlock, TD, 1, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_waitwhile_exactbits, libc_futex_waitwhile_exactbits, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_waituntil_exactbits, libc_futex_waituntil_exactbits, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_waitwhile_anybit, libc_futex_waitwhile_anybit, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_waitwhile_allbits, libc_futex_waitwhile_allbits, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile, libc_futex_timedwaitwhile, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaituntil, libc_futex_timedwaituntil, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_above, libc_futex_timedwaitwhile_above, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_below, libc_futex_timedwaitwhile_below, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_aboveequal, libc_futex_timedwaitwhile_aboveequal, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_belowequal, libc_futex_timedwaitwhile_belowequal, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_cmpxch, libc_futex_timedwaitwhile_cmpxch, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaituntil_cmpxch, libc_futex_timedwaituntil_cmpxch, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitlock, libc_futex_timedwaitlock, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_exactbits, libc_futex_timedwaitwhile_exactbits, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaituntil_exactbits, libc_futex_timedwaituntil_exactbits, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_anybit, libc_futex_timedwaitwhile_anybit, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_allbits, libc_futex_timedwaitwhile_allbits, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile64, libc_futex_timedwaitwhile64, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaituntil64, libc_futex_timedwaituntil64, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_above64, libc_futex_timedwaitwhile_above64, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_below64, libc_futex_timedwaitwhile_below64, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_aboveequal64, libc_futex_timedwaitwhile_aboveequal64, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_belowequal64, libc_futex_timedwaitwhile_belowequal64, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_cmpxch64, libc_futex_timedwaitwhile_cmpxch64, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaituntil_cmpxch64, libc_futex_timedwaituntil_cmpxch64, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitlock64, libc_futex_timedwaitlock64, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_exactbits64, libc_futex_timedwaitwhile_exactbits64, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaituntil_exactbits64, libc_futex_timedwaituntil_exactbits64, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_anybit64, libc_futex_timedwaitwhile_anybit64, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_timedwaitwhile_allbits64, libc_futex_timedwaitwhile_allbits64, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futex", libd_futex_setspin, libc_futex_setspin, TD, 1, TD)

/* kos.futexexpr */
DFUN(".text.crt.dos.sched.futexexpr", libd_lfutexexpr, libc_lfutexexpr, TD, 5, TP, TI, TP, TP, TD)
DFUN(".text.crt.dos.sched.futexlockexpr", libd_lfutexlockexpr, libc_lfutexlockexpr, TD, 6, TP, TP, TI, TP, TP, TD)
DFUN(".text.crt.dos.sched.futexexpr", libd_lfutexexpr64, libc_lfutexexpr64, TD, 5, TP, TI, TP, TP, TD)
DFUN(".text.crt.dos.sched.futexlockexpr", libd_lfutexlockexpr64, libc_lfutexlockexpr64, TD, 6, TP, TP, TI, TP, TP, TD)

/* kos.futexlock */
DFUN(".text.crt.dos.sched.futexlock", libd_lfutexlock, libc_lfutexlock, TI, 6, TP, TP, TIn(__SIZEOF_SYSCALL_LONG_T__), TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_lfutexlock64, libc_lfutexlock64, TI, 6, TP, TP, TIn(__SIZEOF_SYSCALL_LONG_T__), TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_wake, libc_futexlock_wake, TI, 2, TP, TI)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_wakeall, libc_futexlock_wakeall, TI, 1, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_waitwhile, libc_futexlock_waitwhile, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_waituntil, libc_futexlock_waituntil, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_waitwhile_above, libc_futexlock_waitwhile_above, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_waitwhile_below, libc_futexlock_waitwhile_below, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_waitwhile_aboveequal, libc_futexlock_waitwhile_aboveequal, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_waitwhile_belowequal, libc_futexlock_waitwhile_belowequal, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_waitwhile_cmpxch, libc_futexlock_waitwhile_cmpxch, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_waituntil_cmpxch, libc_futexlock_waituntil_cmpxch, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_waitlock, libc_futexlock_waitlock, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_waitwhile_exactbits, libc_futexlock_waitwhile_exactbits, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_waituntil_exactbits, libc_futexlock_waituntil_exactbits, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_waitwhile_anybit, libc_futexlock_waitwhile_anybit, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_waitwhile_allbits, libc_futexlock_waitwhile_allbits, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile, libc_futexlock_timedwaitwhile, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaituntil, libc_futexlock_timedwaituntil, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile_above, libc_futexlock_timedwaitwhile_above, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile_below, libc_futexlock_timedwaitwhile_below, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile_aboveequal, libc_futexlock_timedwaitwhile_aboveequal, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile_belowequal, libc_futexlock_timedwaitwhile_belowequal, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile_cmpxch, libc_futexlock_timedwaitwhile_cmpxch, TD, 5, TP, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaituntil_cmpxch, libc_futexlock_timedwaituntil_cmpxch, TD, 5, TP, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitlock, libc_futexlock_timedwaitlock, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile_exactbits, libc_futexlock_timedwaitwhile_exactbits, TD, 5, TP, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaituntil_exactbits, libc_futexlock_timedwaituntil_exactbits, TD, 5, TP, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile_anybit, libc_futexlock_timedwaitwhile_anybit, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile_allbits, libc_futexlock_timedwaitwhile_allbits, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile64, libc_futexlock_timedwaitwhile64, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaituntil64, libc_futexlock_timedwaituntil64, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile_above64, libc_futexlock_timedwaitwhile_above64, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile_below64, libc_futexlock_timedwaitwhile_below64, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile_aboveequal64, libc_futexlock_timedwaitwhile_aboveequal64, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile_belowequal64, libc_futexlock_timedwaitwhile_belowequal64, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile_cmpxch64, libc_futexlock_timedwaitwhile_cmpxch64, TD, 5, TP, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaituntil_cmpxch64, libc_futexlock_timedwaituntil_cmpxch64, TD, 5, TP, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitlock64, libc_futexlock_timedwaitlock64, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.futexlock", libd_futexlock_timedwaitwhile_exactbits64, libc_futexlock_timedwaitwhile_exactbits64, TD, 5, TP, TP, TP, TP, TP)
...
DFUN(".text.crt.dos.except.heap.malloc", libd_Calloc, libc_Calloc, TP, 2, TI, TI)
DFUN(".text.crt.dos.except.heap.malloc", libd_Realloc, libc_Realloc, TP, 2, TP, TI)
DFUN(".text.crt.dos.except.heap.malloc", libd_Memalign, libc_Memalign, TP, 2, TI, TI)
DFUN(".text.crt.dos.except.heap.rare_helpers", libd_PValloc, libc_PValloc, TP, 1, TI)
DFUN(".text.crt.dos.except.heap.rare_helpers", libd_Valloc, libc_Valloc, TP, 1, TI)
DFUN(".text.crt.dos.except.heap.rare_helpers", libd_Memdup, libc_Memdup, TP, 2, TP, TI)
DFUN(".text.crt.dos.except.heap.rare_helpers", libd_Memcdup, libc_Memcdup, TP, 3, TP, TD, TI)

/* kos.sys.ioctl */
DFUN(".text.crt.dos.except.io.utility", libd_Ioctl, libc_Ioctl, TI, 3, TIn(__SIZEOF_FD_T__), TL, TP)

/* kos.sys.stat */
DFUN(".text.crt.dos.except.fs.modify", libd_Mkdir, libc_Mkdir, TV, 2, TP, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_Chmod, libc_Chmod, TV, 2, TP, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_LChmod, libc_LChmod, TV, 2, TP, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_FMkdirAt, libc_FMkdirAt, TV, 4, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_MODE_T__), TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_FMknodAt, libc_FMknodAt, TV, 5, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_MODE_T__), TIn(__SIZEOF_DEV_T__), TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_Mkfifo, libc_Mkfifo, TV, 2, TP, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_FChmodAt, libc_FChmodAt, TV, 4, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_MODE_T__), TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_MkdirAt, libc_MkdirAt, TV, 3, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_MkfifoAt, libc_MkfifoAt, TV, 3, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_FChmod, libc_FChmod, TV, 2, TIn(__SIZEOF_FD_T__), TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_Mknod, libc_Mknod, TV, 3, TP, TIn(__SIZEOF_MODE_T__), TIn(__SIZEOF_DEV_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_MknodAt, libc_MknodAt, TV, 4, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_MODE_T__), TIn(__SIZEOF_DEV_T__))
DFUN(".text.crt.dos.except.fs.modify_time", libd_UTimensAt, libc_UTimensAt, TV, 4, TIn(__SIZEOF_FD_T__), TP, TP, TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.except.fs.modify_time", libd_UTimensAt64, libc_UTimensAt64, TV, 4, TIn(__SIZEOF_FD_T__), TP, TP, TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.except.fs.modify_time", libd_FUtimens, libc_FUtimens, TV, 2, TIn(__SIZEOF_FD_T__), TP)
DFUN(".text.crt.dos.except.fs.modify_time", libd_FUtimens64, libc_FUtimens64, TV, 2, TIn(__SIZEOF_FD_T__), TP)

/* kos.unistd */
DFUN(".text.crt.dos.except.fs.exec.exec", libd_Execv, libc_Execv, TV, 2, TP, TP)
DFUN(".text.crt.dos.except.fs.exec.exec", libd_Execve, libc_Execve, TV, 3, TP, TP, TP)
DFUN(".text.crt.dos.except.fs.exec.exec", libd_Execvp, libc_Execvp, TV, 2, TP, TP)
DFUN(".text.crt.dos.except.io.access", libd_Pipe, libc_Pipe, TV, 1, TP)
DFUN(".text.crt.dos.except.io.sync", libd_FSync, libc_FSync, TV, 1, TIn(__SIZEOF_FD_T__))
...
DFUN(".text.crt.dos.except.io.read", libd_ReadAll, libc_ReadAll, TI, 3, TIn(__SIZEOF_FD_T__), TP, TI)
DFUN(".text.crt.dos.except.io.seek", libd_LSeek, libc_LSeek, TIn(__SIZEOF_OFF32_T__), 3, TIn(__SIZEOF_FD_T__), TIn(__SIZEOF_OFF32_T__), TD)
DFUN(".text.crt.dos.except.io.access", libd_Dup2, libc_Dup2, TIn(__SIZEOF_FD_T__), 2, TIn(__SIZEOF_FD_T__), TIn(__SIZEOF_FD_T__))
DFUN(".text.crt.dos.except.io.access", libd_Dup, libc_Dup, TIn(__SIZEOF_FD_T__), 1, TIn(__SIZEOF_FD_T__))
DFUN(".text.crt.dos.except.fs.basic_property", libd_Chdir, libc_Chdir, TV, 1, TP)
DFUN(".text.crt.dos.except.fs.basic_property", libd_GetCwd, libc_GetCwd, TP, 2, TP, TI)
DFUN(".text.crt.dos.fs.modify", libd_Unlink, libc_Unlink, TV, 1, TP)
DFUN(".text.crt.dos.fs.modify", libd_Rmdir, libc_Rmdir, TV, 1, TP)
DFUN(".text.crt.dos.except.fs.modify", libd_FChownAt, libc_FChownAt, TV, 5, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_UID_T__), TIn(__SIZEOF_GID_T__), TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_LinkAt, libc_LinkAt, TV, 5, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_SymlinkAt, libc_SymlinkAt, TV, 3, TP, TIn(__SIZEOF_FD_T__), TP)
DFUN(".text.crt.dos.except.fs.property", libd_ReadlinkAt, libc_ReadlinkAt, TI, 4, TIn(__SIZEOF_FD_T__), TP, TP, TI)
DFUN(".text.crt.dos.except.fs.property", libd_FReadlinkAt, libc_FReadlinkAt, TI, 5, TIn(__SIZEOF_FD_T__), TP, TP, TI, TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_UnlinkAt, libc_UnlinkAt, TV, 3, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.except.io.large.seek", libd_LSeek64, libc_LSeek64, TIn(__SIZEOF_OFF64_T__), 3, TIn(__SIZEOF_FD_T__), TIn(__SIZEOF_OFF64_T__), TD)
DFUN(".text.crt.dos.except.io.read", libd_PRead, libc_PRead, TI, 4, TIn(__SIZEOF_FD_T__), TP, TI, TIn(__SIZEOF_OFF32_T__))
DFUN(".text.crt.dos.except.io.write", libd_PWrite, libc_PWrite, TI, 4, TIn(__SIZEOF_FD_T__), TP, TI, TIn(__SIZEOF_OFF32_T__))
DFUN(".text.crt.dos.except.io.read", libd_PReadAll, libc_PReadAll, TI, 4, TIn(__SIZEOF_FD_T__), TP, TI, TIn(__SIZEOF_OFF32_T__))
DFUN(".text.crt.dos.except.io.large.read", libd_PRead64, libc_PRead64, TI, 4, TIn(__SIZEOF_FD_T__), TP, TI, TIn(__SIZEOF_OFF64_T__))
DFUN(".text.crt.dos.except.io.large.write", libd_PWrite64, libc_PWrite64, TI, 4, TIn(__SIZEOF_FD_T__), TP, TI, TIn(__SIZEOF_OFF64_T__))
DFUN(".text.crt.dos.except.io.large.read", libd_PReadAll64, libc_PReadAll64, TI, 4, TIn(__SIZEOF_FD_T__), TP, TI, TIn(__SIZEOF_OFF64_T__))
DFUN(".text.crt.dos.except.io.access", libd_Pipe2, libc_Pipe2, TV, 2, TP, TIn(__SIZEOF_OFLAG_T__))
DFUN(".text.crt.dos.except.io.access", libd_Dup3, libc_Dup3, TIn(__SIZEOF_FD_T__), 3, TIn(__SIZEOF_FD_T__), TIn(__SIZEOF_FD_T__), TIn(__SIZEOF_OFLAG_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_SyncFs, libc_SyncFs, TV, 1, TIn(__SIZEOF_FD_T__))
DFUN(".text.crt.dos.except.sched.user", libd_GetResUid, libc_GetResUid, TV, 3, TP, TP, TP)
DFUN(".text.crt.dos.except.sched.user", libd_GetResGid, libc_GetResGid, TV, 3, TP, TP, TP)
DFUN(".text.crt.dos.except.sched.user", libd_SetResUid, libc_SetResUid, TV, 3, TIn(__SIZEOF_UID_T__), TIn(__SIZEOF_UID_T__), TIn(__SIZEOF_UID_T__))
DFUN(".text.crt.dos.except.sched.user", libd_SetResGid, libc_SetResGid, TV, 3, TIn(__SIZEOF_GID_T__), TIn(__SIZEOF_GID_T__), TIn(__SIZEOF_GID_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_FChown, libc_FChown, TV, 3, TIn(__SIZEOF_FD_T__), TIn(__SIZEOF_UID_T__), TIn(__SIZEOF_GID_T__))
DFUN(".text.crt.dos.except.fs.basic_property", libd_FChdir, libc_FChdir, TV, 1, TIn(__SIZEOF_FD_T__))
DFUN(".text.crt.dos.except.sched.user", libd_GetPGid, libc_GetPGid, TIn(__SIZEOF_PID_T__), 1, TIn(__SIZEOF_PID_T__))
DFUN(".text.crt.dos.except.sched.process", libd_GetSid, libc_GetSid, TIn(__SIZEOF_PID_T__), 1, TIn(__SIZEOF_PID_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_LChown, libc_LChown, TV, 3, TP, TIn(__SIZEOF_UID_T__), TIn(__SIZEOF_GID_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_Truncate, libc_Truncate, TV, 2, TP, TIn(__SIZEOF_OFF32_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_Truncate64, libc_Truncate64, TV, 2, TP, TIn(__SIZEOF_OFF64_T__))
DFUN(".text.crt.dos.except.fs.exec.exec", libd_FExecve, libc_FExecve, TV, 3, TIn(__SIZEOF_FD_T__), TP, TP)
DFUN(".text.crt.dos.except.fs.exec.exec", libd_Execvpe, libc_Execvpe, TV, 3, TP, TP, TP)
DFUN(".text.crt.dos.except.sched.param", libd_Nice, libc_Nice, TD, 1, TD)
DFUN(".text.crt.dos.except.sched.user", libd_SetReUid, libc_SetReUid, TV, 2, TIn(__SIZEOF_UID_T__), TIn(__SIZEOF_UID_T__))
DFUN(".text.crt.dos.except.sched.user", libd_SetReGid, libc_SetReGid, TV, 2, TIn(__SIZEOF_GID_T__), TIn(__SIZEOF_GID_T__))
DFUN(".text.crt.dos.except.sched.user", libd_SetEUid, libc_SetEUid, TV, 1, TIn(__SIZEOF_UID_T__))
DFUN(".text.crt.dos.except.sched.user", libd_SetEGid, libc_SetEGid, TV, 1, TIn(__SIZEOF_GID_T__))
DFUN(".text.crt.dos.except.fs.modify", libd_Symlink, libc_Symlink, TV, 2, TP, TP)
DFUN(".text.crt.dos.except.fs.property", libd_Readlink, libc_Readlink, TI, 3, TP, TP, TI)
DFUN(".text.crt.dos.except.system.configuration", libd_GetHostName, libc_GetHostName, TV, 2, TP, TI)
...
DFUN(".text.crt.dos.except.io.sync", libd_FDataSync, libc_FDataSync, TV, 1, TIn(__SIZEOF_FD_T__))
...
/* locale */
DFUN(".text.crt.dos.unsorted", libd_setlocale, libc_setlocale, TP, 2, TD, TP)
DFUN(".text.crt.dos.unsorted", libd_newlocale, libc_newlocale, TP, 3, TD, TP, TP)
DFUN(".text.crt.dos.unsorted", libd_duplocale, libc_duplocale, TP, 1, TP)
DFUN(".text.crt.dos.unsorted", libd_freelocale, libc_freelocale, TV, 1, TP)
DFUN(".text.crt.dos.unsorted", libd_uselocale, libc_uselocale, TP, 1, TP)
...
DFUN(".text.crt.dos.math.math", libd___fpclassify, libc___fpclassify, TD, 1, TFD)
DFUN(".text.crt.dos.math.math", libd___signbit, libc___signbit, TD, 1, TFD)
DFUN(".text.crt.dos.math.math", libd___fpclassifyf, libc___fpclassifyf, TD, 1, TF)
DFUN(".text.crt.dos.math.math", libd___signbitf, libc___signbitf, TD, 1, TF)
DFUN(".text.crt.dos.math.math", libd___fpclassifyl, libc___fpclassifyl, TD, 1, TFL)
...
/* pthread */
DFUN(".text.crt.dos.sched.pthread", libd_pthread_create, libc_pthread_create, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_exit, libc_pthread_exit, TV, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_join, libc_pthread_join, TD, 2, TIn(__SIZEOF_PTHREAD_T), TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_tryjoin_np, libc_pthread_tryjoin_np, TD, 2, TIn(__SIZEOF_PTHREAD_T), TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_timedjoin_np, libc_pthread_timedjoin_np, TD, 3, TIn(__SIZEOF_PTHREAD_T), TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_timedjoin64_np, libc_pthread_timedjoin64_np, TD, 3, TIn(__SIZEOF_PTHREAD_T), TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_detach, libc_pthread_detach, TD, 1, TIn(__SIZEOF_PTHREAD_T))
DFUN(".text.crt.dos.sched.pthread", libd_pthread_equal, libc_pthread_equal, TD, 2, TIn(__SIZEOF_PTHREAD_T), TIn(__SIZEOF_PTHREAD_T))
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_init, libc_pthread_attr_init, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_destroy, libc_pthread_attr_destroy, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_getdetachstate, libc_pthread_attr_getdetachstate, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_setdetachstate, libc_pthread_attr_setdetachstate, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_getguardsize, libc_pthread_attr_getguardsize, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_setguardsize, libc_pthread_attr_setguardsize, TD, 2, TP, TI)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_getschedparam, libc_pthread_attr_getschedparam, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_setschedparam, libc_pthread_attr_setschedparam, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_getschedpolicy, libc_pthread_attr_getschedpolicy, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_setschedpolicy, libc_pthread_attr_setschedpolicy, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_getinheritsched, libc_pthread_attr_getinheritsched, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_setinheritsched, libc_pthread_attr_setinheritsched, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_getscope, libc_pthread_attr_getscope, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_setscope, libc_pthread_attr_setscope, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_getstackaddr, libc_pthread_attr_getstackaddr, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_setstackaddr, libc_pthread_attr_setstackaddr, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_getstacksize, libc_pthread_attr_getstacksize, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_setstacksize, libc_pthread_attr_setstacksize, TD, 2, TP, TI)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_getstack, libc_pthread_attr_getstack, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_setstack, libc_pthread_attr_setstack, TD, 3, TP, TP, TI)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_setaffinity_np, libc_pthread_attr_setaffinity_np, TD, 3, TP, TI, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_attr_getaffinity_np, libc_pthread_attr_getaffinity_np, TD, 3, TP, TI, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_getattr_default_np, libc_pthread_getattr_default_np, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_setattr_default_np, libc_pthread_setattr_default_np, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_getattr_np, libc_pthread_getattr_np, TD, 2, TIn(__SIZEOF_PTHREAD_T), TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_setschedparam, libc_pthread_setschedparam, TD, 3, TIn(__SIZEOF_PTHREAD_T), TD, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_getschedparam, libc_pthread_getschedparam, TD, 3, TIn(__SIZEOF_PTHREAD_T), TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_setschedprio, libc_pthread_setschedprio, TD, 2, TIn(__SIZEOF_PTHREAD_T), TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_getname_np, libc_pthread_getname_np, TD, 3, TIn(__SIZEOF_PTHREAD_T), TP, TI)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_setname_np, libc_pthread_setname_np, TD, 2, TIn(__SIZEOF_PTHREAD_T), TP)
...
DFUN(".text.crt.dos.sched.pthread", libd_pthread_setconcurrency, libc_pthread_setconcurrency, TD, 1, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_setaffinity_np, libc_pthread_setaffinity_np, TD, 3, TIn(__SIZEOF_PTHREAD_T), TI, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_getaffinity_np, libc_pthread_getaffinity_np, TD, 3, TIn(__SIZEOF_PTHREAD_T), TI, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_once, libc_pthread_once, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_setcancelstate, libc_pthread_setcancelstate, TD, 2, TD, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_setcanceltype, libc_pthread_setcanceltype, TD, 2, TD, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_cancel, libc_pthread_cancel, TD, 1, TIn(__SIZEOF_PTHREAD_T))
...
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutex_init, libc_pthread_mutex_init, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutex_destroy, libc_pthread_mutex_destroy, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutex_trylock, libc_pthread_mutex_trylock, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutex_lock, libc_pthread_mutex_lock, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutex_timedlock, libc_pthread_mutex_timedlock, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutex_timedlock64, libc_pthread_mutex_timedlock64, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutex_unlock, libc_pthread_mutex_unlock, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutex_getprioceiling, libc_pthread_mutex_getprioceiling, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutex_setprioceiling, libc_pthread_mutex_setprioceiling, TD, 3, TP, TD, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutex_consistent, libc_pthread_mutex_consistent, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutex_consistent_np, libc_pthread_mutex_consistent_np, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutexattr_init, libc_pthread_mutexattr_init, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutexattr_destroy, libc_pthread_mutexattr_destroy, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutexattr_getpshared, libc_pthread_mutexattr_getpshared, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutexattr_setpshared, libc_pthread_mutexattr_setpshared, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutexattr_gettype, libc_pthread_mutexattr_gettype, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutexattr_settype, libc_pthread_mutexattr_settype, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutexattr_getprotocol, libc_pthread_mutexattr_getprotocol, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutexattr_setprotocol, libc_pthread_mutexattr_setprotocol, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutexattr_getprioceiling, libc_pthread_mutexattr_getprioceiling, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutexattr_setprioceiling, libc_pthread_mutexattr_setprioceiling, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutexattr_getrobust, libc_pthread_mutexattr_getrobust, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutexattr_setrobust, libc_pthread_mutexattr_setrobust, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutexattr_getrobust_np, libc_pthread_mutexattr_getrobust_np, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_mutexattr_setrobust_np, libc_pthread_mutexattr_setrobust_np, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlock_init, libc_pthread_rwlock_init, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlock_destroy, libc_pthread_rwlock_destroy, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlock_rdlock, libc_pthread_rwlock_rdlock, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlock_tryrdlock, libc_pthread_rwlock_tryrdlock, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlock_timedrdlock, libc_pthread_rwlock_timedrdlock, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlock_timedrdlock64, libc_pthread_rwlock_timedrdlock64, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlock_wrlock, libc_pthread_rwlock_wrlock, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlock_trywrlock, libc_pthread_rwlock_trywrlock, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlock_timedwrlock, libc_pthread_rwlock_timedwrlock, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlock_timedwrlock64, libc_pthread_rwlock_timedwrlock64, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlock_unlock, libc_pthread_rwlock_unlock, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlockattr_init, libc_pthread_rwlockattr_init, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlockattr_destroy, libc_pthread_rwlockattr_destroy, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlockattr_getpshared, libc_pthread_rwlockattr_getpshared, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlockattr_setpshared, libc_pthread_rwlockattr_setpshared, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlockattr_getkind_np, libc_pthread_rwlockattr_getkind_np, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_rwlockattr_setkind_np, libc_pthread_rwlockattr_setkind_np, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_cond_init, libc_pthread_cond_init, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_cond_destroy, libc_pthread_cond_destroy, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_cond_signal, libc_pthread_cond_signal, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_cond_broadcast, libc_pthread_cond_broadcast, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_cond_wait, libc_pthread_cond_wait, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_cond_timedwait, libc_pthread_cond_timedwait, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_cond_timedwait64, libc_pthread_cond_timedwait64, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_condattr_init, libc_pthread_condattr_init, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_condattr_destroy, libc_pthread_condattr_destroy, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_condattr_getpshared, libc_pthread_condattr_getpshared, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_condattr_setpshared, libc_pthread_condattr_setpshared, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_condattr_getclock, libc_pthread_condattr_getclock, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_condattr_setclock, libc_pthread_condattr_setclock, TD, 2, TP, TIn(__SIZEOF_CLOCKID_T__))
DFUN(".text.crt.dos.sched.pthread", libd_pthread_spin_init, libc_pthread_spin_init, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_spin_destroy, libc_pthread_spin_destroy, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_spin_lock, libc_pthread_spin_lock, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_spin_trylock, libc_pthread_spin_trylock, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_spin_unlock, libc_pthread_spin_unlock, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_barrier_init, libc_pthread_barrier_init, TD, 3, TP, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_barrier_destroy, libc_pthread_barrier_destroy, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_barrier_wait, libc_pthread_barrier_wait, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_barrierattr_init, libc_pthread_barrierattr_init, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_barrierattr_destroy, libc_pthread_barrierattr_destroy, TD, 1, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_barrierattr_getpshared, libc_pthread_barrierattr_getpshared, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_barrierattr_setpshared, libc_pthread_barrierattr_setpshared, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_key_create, libc_pthread_key_create, TD, 2, TP, TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_key_delete, libc_pthread_key_delete, TD, 1, TIn(__SIZEOF_PTHREAD_KEY_T))
DFUN(".text.crt.dos.sched.pthread", libd_pthread_getspecific, libc_pthread_getspecific, TP, 1, TIn(__SIZEOF_PTHREAD_KEY_T))
DFUN(".text.crt.dos.sched.pthread", libd_pthread_setspecific, libc_pthread_setspecific, TD, 2, TIn(__SIZEOF_PTHREAD_KEY_T), TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_getcpuclockid, libc_pthread_getcpuclockid, TD, 2, TIn(__SIZEOF_PTHREAD_T), TP)
DFUN(".text.crt.dos.sched.pthread", libd_pthread_atfork, libc_pthread_atfork, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.pthread_ext", libd_pthread_set_num_processors_np, libc_pthread_set_num_processors_np, TD, 1, TD)
...
DFUN(".text.crt.dos.database.pwd", libd_getpwuid_r, libc_getpwuid_r, TD, 5, TIn(__SIZEOF_UID_T__), TP, TP, TI, TP)
DFUN(".text.crt.dos.database.pwd", libd_getpwnam_r, libc_getpwnam_r, TD, 5, TP, TP, TP, TI, TP)
DFUN(".text.crt.dos.database.pwd", libd_getpwent_r, libc_getpwent_r, TD, 4, TP, TP, TI, TP)
DFUN(".text.crt.dos.database.pwd", libd_fgetpwent_r, libc_fgetpwent_r, TD, 5, TP, TP, TP, TI, TP)
...
DFUN(".text.crt.dos.utility.search", libd_tsearch, libc_tsearch, TP, 3, TP, TP, TP)
DFUN(".text.crt.dos.utility.search", libd_tfind, libc_tfind, TP, 3, TP, TP, TP)
DFUN(".text.crt.dos.utility.search", libd_tdelete, libc_tdelete, TP, 3, TP, TP, TP)
DFUN(".text.crt.dos.utility.search", libd_twalk, libc_twalk, TV, 2, TP, TP)
DFUN(".text.crt.dos.utility.search", libd_tdestroy, libc_tdestroy, TV, 2, TP, TP)
DFUN(".text.crt.dos.utility.search", libd_lfind, libc_lfind, TP, 5, TP, TP, TP, TI, TP)
DFUN(".text.crt.dos.utility.search", libd_lsearch, libc_lsearch, TP, 5, TP, TP, TP, TI, TP)
...
/* signal */
DFUN(".text.crt.dos.sched.signal", libd_raise, libc_raise, TD, 1, TD)
DFUN(".text.crt.dos.sched.signal", libd_sysv_signal, libc_sysv_signal, TP, 2, TD, TP)
DFUN(".text.crt.dos.sched.signal", libd_signal, libc_signal, TP, 2, TD, TP)
DFUN(".text.crt.dos.sched.signal", libd_ssignal, libc_ssignal, TP, 2, TD, TP)
DFUN(".text.crt.dos.sched.signal", libd_gsignal, libc_gsignal, TD, 1, TD)
...
DFUN(".text.crt.dos.sched.signal", libd_bsd_signal, libc_bsd_signal, TP, 2, TD, TP)
DFUN(".text.crt.dos.sched.signal", libd___xpg_sigpause, libc___xpg_sigpause, TD, 1, TD)
DFUN(".text.crt.dos.sched.signal", libd_kill, libc_kill, TD, 2, TIn(__SIZEOF_PID_T__), TD)
...
DFUN(".text.crt.dos.sched.signal", libd_sigaddset, libc_sigaddset, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.signal", libd_sigdelset, libc_sigdelset, TD, 2, TP, TD)
DFUN(".text.crt.dos.sched.signal", libd_sigismember, libc_sigismember, TD, 2, TP, TD)
...
DFUN(".text.crt.dos.sched.signal", libd_sigaction, libc_sigaction, TD, 3, TD, TP, TP)
...
DFUN(".text.crt.dos.sched.signal", libd_sigqueue, libc_sigqueue, TD, 3, TIn(__SIZEOF_PID_T__), TD, TS(__SIZEOF_SIGVAL CONST))
DFUN(".text.crt.dos.sched.signal", libd_sigtimedwait64, libc_sigtimedwait64, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.sched.signal", libd_sigqueueinfo, libc_sigqueueinfo, TD, 3, TIn(__SIZEOF_PID_T__), TD, TP)
DFUN(".text.crt.dos.sched.signal", libd_tgsigqueueinfo, libc_tgsigqueueinfo, TD, 4, TIn(__SIZEOF_PID_T__), TIn(__SIZEOF_PID_T__), TD, TP)
DFUN(".text.crt.dos.sched.signal", libd_killpg, libc_killpg, TD, 2, TIn(__SIZEOF_PID_T__), TD)
DFUN(".text.crt.dos.sched.signal", libd_psignal, libc_psignal, TV, 2, TD, TP)
DFUN(".text.crt.dos.sched.signal", libd_psiginfo, libc_psiginfo, TV, 2, TP, TP)
DFUN(".text.crt.dos.sched.signal", libd_siginterrupt, libc_siginterrupt, TD, 2, TD, TD)
...
DFUN(".text.crt.dos.sched.signal", libd_sighold, libc_sighold, TD, 1, TD)
DFUN(".text.crt.dos.sched.signal", libd_sigrelse, libc_sigrelse, TD, 1, TD)
DFUN(".text.crt.dos.sched.signal", libd_sigignore, libc_sigignore, TD, 1, TD)
DFUN(".text.crt.dos.sched.signal", libd_sigset, libc_sigset, TP, 2, TD, TP)
...
/* stdio */
DFUN(".text.crt.dos.fs.modify", libd_remove, libc_remove, TD, 1, TP)
DFUN(".text.crt.dos.fs.modify", libd_rename, libc_rename, TD, 2, TP, TP)
DFUN(".text.crt.dos.fs.utility", libd_tmpnam, libc_tmpnam, TP, 1, TP)
...
DFUN(".text.crt.dos.FILE.locked.access", libd_fopen, libc_fopen, TP, 2, TP, TP)
DFUN(".text.crt.dos.FILE.locked.access", libd_freopen, libc_freopen, TP, 3, TP, TP, TP)
...
DFUN(".text.crt.dos.FILE.locked.access", libd_fopen64, libc_fopen64, TP, 2, TP, TP)
...
DFUN(".text.crt.dos.FILE.unlocked.access", libd_freopen_unlocked, libc_freopen_unlocked, TP, 3, TP, TP, TP)
DFUN(".text.crt.dos.FILE.unlocked.access", libd_freopen64_unlocked, libc_freopen64_unlocked, TP, 3, TP, TP, TP)
...
DFUN(".text.crt.dos.FILE.locked.access", libd__fsopen, libc__fsopen, TP, 3, TP, TP, TD)
...
DFUN(".text.crt.dos.FILE.locked.read.scanf", libd__vscanf_l, libc__vscanf_l, TD, 3, TP, TP, TP)
DFUN(".text.crt.dos.FILE.locked.read.scanf", libd__vfscanf_l, libc__vfscanf_l, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.unicode.locale.format.scanf", libd__vsscanf_l, libc__vsscanf_l, TD, 4, TP, TP, TP, TP)
DFUN(".text.crt.dos.unicode.static.format.scanf", libd__vsnscanf, libc__vsnscanf, TD, 4, TP, TI, TP, TP)
DFUN(".text.crt.dos.unicode.locale.format.scanf", libd__vsnscanf_l, libc__vsnscanf_l, TD, 5, TP, TI, TP, TP, TP)
...
DFUN(".text.crt.dos.FILE.locked.access", libd_fopen_s, libc_fopen_s, TIn(__SIZEOF_ERRNO_T__), 3, TP, TP, TP)
DFUN(".text.crt.dos.FILE.locked.access", libd_freopen_s, libc_freopen_s, TIn(__SIZEOF_ERRNO_T__), 4, TP, TP, TP, TP)
...
DFUN(".text.crt.dos.FILE.locked.read.read", libd_vsnprintf_s, libc_vsnprintf_s, TD, 5, TP, TI, TI, TP, TP)
...
DFUN(".text.crt.dos.fs.environ", libd_getenv, libc_getenv, TP, 1, TP)
...
DFUN(".text.crt.dos.fs.environ", libd_putenv, libc_putenv, TD, 1, TP)
...
DFUN(".text.crt.dos.fs.property", libd_frealpathat, libc_frealpathat, TP, 5, TIn(__SIZEOF_FD_T__), TP, TP, TI, TIn(__SIZEOF_ATFLAG_T__))
...
DFUN(".text.crt.dos.fs.utility", libd_mkstemp, libc_mkstemp, TD, 1, TP)
DFUN(".text.crt.dos.fs.utility", libd_mkstemp64, libc_mkstemp64, TD, 1, TP)
...
DFUN(".text.crt.dos.fs.environ", libd_secure_getenv, libc_secure_getenv, TP, 1, TP)
DFUN(".text.crt.dos.io.tty", libd_ptsname_r, libc_ptsname_r, TD, 3, TIn(__SIZEOF_FD_T__), TP, TI)
DFUN(".text.crt.dos.fs.property", libd_canonicalize_file_name, libc_canonicalize_file_name, TP, 1, TP)
DFUN(".text.crt.dos.fs.utility", libd_mkostemp, libc_mkostemp, TD, 2, TP, TD)
DFUN(".text.crt.dos.fs.utility", libd_mkostemps, libc_mkostemps, TD, 3, TP, TD, TD)
DFUN(".text.crt.dos.fs.utility", libd_mkostemp64, libc_mkostemp64, TD, 2, TP, TD)
DFUN(".text.crt.dos.fs.utility", libd_mkostemps64, libc_mkostemps64, TD, 3, TP, TD, TD)
...
DFUN(".text.crt.dos.utility", libd_bsearch_s, libc_bsearch_s, TP, 6, TP, TP, TI, TI, TP, TP)
DFUN(".text.crt.dos.utility", libd_qsort_s, libc_qsort_s, TV, 5, TP, TI, TI, TP, TP)
DFUN(".text.crt.dos.utility", libd_getenv_s, libc_getenv_s, TIn(__SIZEOF_ERRNO_T__), 4, TP, TP, TI, TP)
DFUN(".text.crt.dos.utility", libd__dupenv_s, libc__dupenv_s, TIn(__SIZEOF_ERRNO_T__), 3, TP, TP, TP)
DFUN(".text.crt.dos.unicode.static.convert", libd__itoa_s, libc__itoa_s, TIn(__SIZEOF_ERRNO_T__), 4, TD, TP, TI, TD)
DFUN(".text.crt.dos.unicode.static.convert", libd__ltoa_s, libc__ltoa_s, TIn(__SIZEOF_ERRNO_T__), 4, TL, TP, TI, TD)
DFUN(".text.crt.dos.unicode.static.convert", libd__ultoa_s, libc__ultoa_s, TIn(__SIZEOF_ERRNO_T__), 4, TL, TP, TI, TD)
...
DFUN(".text.crt.dos.unicode.static.convert", libd__i64toa_s, libc__i64toa_s, TIn(__SIZEOF_ERRNO_T__), 4, TI64, TP, TI, TD)
DFUN(".text.crt.dos.unicode.static.convert", libd__ui64toa_s, libc__ui64toa_s, TIn(__SIZEOF_ERRNO_T__), 4, TI64, TP, TI, TD)
...
DFUN(".text.crt.dos.random", libd_rand_s, libc_rand_s, TIn(__SIZEOF_ERRNO_T__), 1, TP)
...
DFUN(".text.crt.dos.unicode.static.convert", libd__ecvt_s, libc__ecvt_s, TIn(__SIZEOF_ERRNO_T__), 6, TP, TI, TFD, TD, TP, TP)
DFUN(".text.crt.dos.unicode.static.convert", libd__fcvt_s, libc__fcvt_s, TIn(__SIZEOF_ERRNO_T__), 6, TP, TI, TFD, TD, TP, TP)
DFUN(".text.crt.dos.unicode.static.convert", libd__gcvt_s, libc__gcvt_s, TIn(__SIZEOF_ERRNO_T__), 4, TP, TI, TFD, TD)
...
DFUN(".text.crt.dos.fs.environ", libd__putenv_s, libc__putenv_s, TIn(__SIZEOF_ERRNO_T__), 2, TP, TP)
...
DFUN(".text.crt.dos.fs.utility", libd__makepath_s, libc__makepath_s, TIn(__SIZEOF_ERRNO_T__), 6, TP, TI, TP, TP, TP, TP)
DFUN(".text.crt.dos.fs.utility", libd__splitpath_s, libc__splitpath_s, TIn(__SIZEOF_ERRNO_T__), 9, TP, TP, TI, TP, TI, TP, TI, TP, TI)
...
/* sys.stat */
DFUN(".text.crt.dos.fs.modify", libd_mkdir, libc_mkdir, TD, 2, TP, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.fs.modify", libd_chmod, libc_chmod, TD, 2, TP, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.fs.modify", libd_lchmod, libc_lchmod, TD, 2, TP, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.fs.basic_property", libd_umask, libc_umask, TIn(__SIZEOF_MODE_T__), 1, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.fs.modify", libd_fmkdirat, libc_fmkdirat, TD, 4, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_MODE_T__), TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.fs.modify", libd_fmknodat, libc_fmknodat, TD, 5, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_MODE_T__), TIn(__SIZEOF_DEV_T__), TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.fs.modify", libd_mkfifo, libc_mkfifo, TD, 2, TP, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.fs.modify", libd_fchmodat, libc_fchmodat, TD, 4, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_MODE_T__), TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.fs.modify", libd_mkdirat, libc_mkdirat, TD, 3, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.fs.modify", libd_mkfifoat, libc_mkfifoat, TD, 3, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.fs.modify", libd_fchmod, libc_fchmod, TD, 2, TIn(__SIZEOF_FD_T__), TIn(__SIZEOF_MODE_T__))
DFUN(".text.crt.dos.fs.modify", libd_mknod, libc_mknod, TD, 3, TP, TIn(__SIZEOF_MODE_T__), TIn(__SIZEOF_DEV_T__))
DFUN(".text.crt.dos.fs.modify", libd_mknodat, libc_mknodat, TD, 4, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_MODE_T__), TIn(__SIZEOF_DEV_T__))
DFUN(".text.crt.dos.fs.modify_time", libd_utimensat, libc_utimensat, TD, 4, TIn(__SIZEOF_FD_T__), TP, TP, TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.fs.modify_time", libd_utimensat64, libc_utimensat64, TD, 4, TIn(__SIZEOF_FD_T__), TP, TP, TIn(__SIZEOF_ATFLAG_T__))
...
/* threads */
DFUN(".text.crt.dos.sched.threads", libd_thrd_create, libc_thrd_create, TD, 3, TP, TP, TP)
...
DFUN(".text.crt.dos.fs.modify", libd_chown, libc_chown, TD, 3, TP, TIn(__SIZEOF_UID_T__), TIn(__SIZEOF_GID_T__))
DFUN(".text.crt.dos.fs.property", libd_pathconf, libc_pathconf, TP, 2, TP, TD)
DFUN(".text.crt.dos.fs.modify", libd_link, libc_link, TD, 2, TP, TP)
...
DFUN(".text.crt.dos.fs.property", libd_access, libc_access, TD, 2, TP, TD)
DFUN(".text.crt.dos.fs.basic_property", libd_chdir, libc_chdir, TD, 1, TP)
DFUN(".text.crt.dos.fs.basic_property", libd_getcwd, libc_getcwd, TP, 2, TP, TI)
DFUN(".text.crt.dos.fs.modify", libd_unlink, libc_unlink, TD, 1, TP)
DFUN(".text.crt.dos.fs.modify", libd_rmdir, libc_rmdir, TD, 1, TP)
DFUN(".text.crt.dos.fs.property", libd_euidaccess, libc_euidaccess, TD, 2, TP, TD)
DFUN(".text.crt.dos.fs.property", libd_faccessat, libc_faccessat, TD, 4, TIn(__SIZEOF_FD_T__), TP, TD, TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.fs.modify", libd_fchownat, libc_fchownat, TD, 5, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_UID_T__), TIn(__SIZEOF_GID_T__), TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.fs.modify", libd_linkat, libc_linkat, TD, 5, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.fs.modify", libd_symlinkat, libc_symlinkat, TD, 3, TP, TIn(__SIZEOF_FD_T__), TP)
DFUN(".text.crt.dos.fs.property", libd_readlinkat, libc_readlinkat, TI, 4, TIn(__SIZEOF_FD_T__), TP, TP, TI)
DFUN(".text.crt.dos.fs.property", libd_freadlinkat, libc_freadlinkat, TI, 5, TIn(__SIZEOF_FD_T__), TP, TP, TI, TIn(__SIZEOF_ATFLAG_T__))
DFUN(".text.crt.dos.fs.modify", libd_unlinkat, libc_unlinkat, TD, 3, TIn(__SIZEOF_FD_T__), TP, TIn(__SIZEOF_ATFLAG_T__))
...
DFUN(".text.crt.dos.fs.basic_property", libd_getwd, libc_getwd, TP, 1, TP)
...
DFUN(".text.crt.dos.fs.modify", libd_lchown, libc_lchown, TD, 3, TP, TIn(__SIZEOF_UID_T__), TIn(__SIZEOF_GID_T__))
DFUN(".text.crt.dos.fs.modify", libd_truncate, libc_truncate, TD, 2, TP, TIn(__SIZEOF_OFF32_T__))
DFUN(".text.crt.dos.fs.modify", libd_truncate64, libc_truncate64, TD, 2, TP, TIn(__SIZEOF_OFF64_T__))
...
DFUN(".text.crt.dos.fs.modify", libd_symlink, libc_symlink, TD, 2, TP, TP)
DFUN(".text.crt.dos.fs.property", libd_readlink, libc_readlink, TI, 3, TP, TP, TI)
...
/* wchar */
DFUN(".text.crt.dos.wchar.unicode.static.mbs", libd_wctob, libc_wctob, TD, 1, TIn(__SIZEOF_WINT_T__))
...
/* wctype */
DFUN(".text.crt.dos.wchar.unicode.static.ctype", libd_iswalnum, libc_iswalnum, TD, 1, TIn(__SIZEOF_WINT_T__))
DFUN(".text.crt.dos.wchar.unicode.static.ctype", libd_iswalpha, libc_iswalpha, TD, 1, TIn(__SIZEOF_WINT_T__))
DFUN(".text.crt.dos.wchar.unicode.static.ctype", libd_iswcntrl, libc_iswcntrl, TD, 1, TIn(__SIZEOF_WINT_T__))
DFUN(".text.crt.dos.wchar.unicode.static.ctype", libd_iswdigit, libc_iswdigit, TD, 1, TIn(__SIZEOF_WINT_T__))
DFUN(".text.crt.dos.wchar.unicode.static.ctype", libd_iswgraph, libc_iswgraph, TD, 1, TIn(__SIZEOF_WINT_T__))
DFUN(".text.crt.dos.wchar.unicode.static.ctype", libd_iswlower, libc_iswlower, TD, 1, TIn(__SIZEOF_WINT_T__))
DFUN(".text.crt.dos.wchar.unicode.static.ctype", libd_iswprint, libc_iswprint, TD, 1, TIn(__SIZEOF_WINT_T__))
DFUN(".text.crt.dos.wchar.unicode.static.ctype", libd_iswpunct, libc_iswpunct, TD, 1, TIn(__SIZEOF_WINT_T__))
...
DFUN(".text.crt.dos.wchar.unicode.static.ctype", libd_towlower, libc_towlower, TIn(__SIZEOF_WINT_T__), 1, TIn(__SIZEOF_WINT_T__))
DFUN(".text.crt.dos.wchar.unicode.static.ctype", libd_towupper, libc_towupper, TIn(__SIZEOF_WINT_T__), 1, TIn(__SIZEOF_WINT_T__))
DFUN(".text.crt.dos.wchar.unicode.static.ctype", libd_iswascii, libc_iswascii, TD, 1, TIn(__SIZEOF_WINT_T__))
DFUN(".text.crt.dos.wchar.unicode.locale.ctype", libd_iswalnum_l, libc_iswalnum_l, TD, 2, TIn(__SIZEOF_WINT_T__), TP)
DFUN(".text.crt.dos.wchar.unicode.locale.ctype", libd_iswalpha_l, libc_iswalpha_l, TD, 2, TIn(__SIZEOF_WINT_T__), TP)
DFUN(".text.crt.dos.wchar.unicode.locale.ctype", libd_iswcntrl_l, libc_iswcntrl_l, TD, 2, TIn(__SIZEOF_WINT_T__), TP)
DFUN(".text.crt.dos.wchar.unicode.locale.ctype", libd_iswdigit_l, libc_iswdigit_l, TD, 2, TIn(__SIZEOF_WINT_T__), TP)
DFUN(".text.crt.dos.wchar.unicode.locale.ctype", libd_iswgraph_l, libc_iswgraph_l, TD, 2, TIn(__SIZEOF_WINT_T__), TP)
DFUN(".text.crt.dos.wchar.unicode.locale.ctype", libd_iswlower_l, libc_iswlower_l, TD, 2, TIn(__SIZEOF_WINT_T__), TP)
DFUN(".text.crt.dos.wchar.unicode.locale.ctype", libd_iswprint_l, libc_iswprint_l, TD, 2, TIn(__SIZEOF_WINT_T__), TP)
DFUN(".text.crt.dos.wchar.unicode.locale.ctype", libd_iswpunct_l, libc_iswpunct_l, TD, 2, TIn(__SIZEOF_WINT_T__), TP)
DFUN(".text.crt.dos.wchar.unicode.locale.ctype", libd_iswspace_l, libc_iswspace_l, TD, 2, TIn(__SIZEOF_WINT_T__), TP)
DFUN(".text.crt.dos.wchar.unicode.locale.ctype", libd_iswupper_l, libc_iswupper_l, TD, 2, TIn(__SIZEOF_WINT_T__), TP)
DFUN(".text.crt.dos.wchar.unicode.locale.ctype", libd_iswxdigit_l, libc_iswxdigit_l, TD, 2, TIn(__SIZEOF_WINT_T__), TP)
DFUN(".text.crt.dos.wchar.unicode.locale.ctype", libd_iswblank_l, libc_iswblank_l, TD, 2, TIn(__SIZEOF_WINT_T__), TP)
DFUN(".text.crt.dos.wchar.unicode.locale.ctype", libd_iswctype_l, libc_iswctype_l, TD, 3, TIn(__SIZEOF_WINT_T__), TIn(__SIZEOF_WCTYPE_T__), TP)
...
DFUN(".text.crt.dos.wchar.unicode.static.mbs", libd___iswcsym, libc___iswcsym, TD, 1, TIn(__SIZEOF_WINT_T__))
DFUN(".text.crt.dos.wchar.unicode.locale.mbs", libd__iswcsymf_l, libc__iswcsymf_l, TD, 2, TIn(__SIZEOF_WINT_T__), TP)
DFUN(".text.crt.dos.wchar.unicode.locale.mbs", libd__iswcsym_l, libc__iswcsym_l, TD, 2, TIn(__SIZEOF_WINT_T__), TP)
