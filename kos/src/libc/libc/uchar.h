...
INTDEF WUNUSED ATTR_MALLOC NONNULL((1)) /*utf-8*/ char *LIBCCALL libc_uchar_c32tombs(char32_t const *__restrict str);
INTDEF WUNUSED ATTR_MALLOC NONNULL((1)) /*utf-8*/ char *LIBDCALL libc_uchar_c16tombsn(char16_t const *__restrict str, size_t len, size_t *preslen);
INTDEF WUNUSED ATTR_MALLOC NONNULL((1)) /*utf-8*/ char *LIBCCALL libc_uchar_c32tombsn(char32_t const *__restrict str, size_t len, size_t *preslen);
INTDEF WUNUSED ATTR_MALLOC NONNULL((1)) /*utf-8*/ char **LIBDCALL libc_uchar_c16tombsv(char16_t const *const *__restrict vector); /* Terminated by a NULL-pointer */
