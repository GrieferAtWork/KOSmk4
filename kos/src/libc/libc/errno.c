...
INTERN ATTR_CONST ATTR_SECTION(".text.crt.errno_access")
...
INTERN ATTR_SECTION(".text.crt.dos.errno_access")
...
INTERN ATTR_CONST ATTR_SECTION(".text.crt.dos.errno_access")
