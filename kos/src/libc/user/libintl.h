...
INTDEF ATTR_IN_OPT(1) char *NOTHROW_NCX(LIBCCALL libc_textdomain)(char const *domainname);
INTDEF ATTR_IN_OPT(1) ATTR_IN_OPT(2) char *NOTHROW_NCX(LIBCCALL libc_bindtextdomain)(char const *domainname, char const *dirname);
INTDEF ATTR_IN_OPT(1) ATTR_IN_OPT(2) char *NOTHROW_NCX(LIBCCALL libc_bind_textdomain_codeset)(char const *domainname, char const *codeset);
#endif /* !__KERNEL__ */
