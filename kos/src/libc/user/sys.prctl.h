 ...
 */
#ifndef GUARD_LIBC_USER_SYS_PRCTL_H
#define GUARD_LIBC_USER_SYS_PRCTL_H 1

#include "../api.h"
#include "../auto/sys.prctl.h"
...
INTDEF int NOTHROW_NCX(VLIBCCALL libc_prctl)(__STDC_INT_AS_UINT_T command, ...);
#endif /* !__KERNEL__ */

DECL_END

#endif /* !GUARD_LIBC_USER_SYS_PRCTL_H */
