...
/*[[[head:libc_EPollPWait,hash:CRC-32=0x7d612160]]]*/
/* >> epoll_pwait(2)
...
INTERN ATTR_SECTION(".text.crt.except.io.utility") NONNULL((2)) __STDC_UINT_AS_SIZE_T
...
INTERN ATTR_SECTION(".text.crt.except.io.utility") NONNULL((3, 6)) void
