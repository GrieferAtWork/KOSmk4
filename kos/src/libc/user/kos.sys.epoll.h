...
INTDEF void (LIBCCALL libc_EPollCtl)(fd_t epfd, __epoll_ctl_t op, fd_t fd, struct epoll_event *event) THROWS(...);
/* >> epoll_wait(2)
 ...
 * @return: -1:       Error (s.a. `errno') */
INTDEF ATTR_INOUTS(2, 3) __STDC_UINT_AS_SIZE_T (LIBCCALL libc_EPollWait)(fd_t epfd, struct epoll_event *events, __STDC_UINT_AS_SIZE_T maxevents, int timeout) THROWS(...);
/* >> epoll_pwait(2)
 ...
 * @return: 0:        No events happened before `timeout' expired.
 * @return: -1:       Error (s.a. `errno') */
INTDEF ATTR_INOUTS(2, 3) ATTR_IN_OPT(5) __STDC_UINT_AS_SIZE_T (LIBCCALL libc_EPollPWait)(fd_t epfd, struct epoll_event *events, __STDC_UINT_AS_SIZE_T maxevents, int timeout, sigset_t const *ss) THROWS(...);
/* >> epoll_rpc_exec(3)
...
INTDEF ATTR_IN(3) NONNULL((6)) void (LIBCCALL libc_EPollRpcExec)(fd_t epfd, fd_t fd, struct epoll_event const *event, pid_t target_tid, unsigned int mode, prpc_exec_callback_t func) THROWS(...);
#endif /* !__KERNEL__ */
