...
#endif /* !__T32ARGV */
#ifndef __KERNEL__
INTDEF NONNULL((1, 2)) int NOTHROW_RPC(LIBDCALL libd__wexecv)(char16_t const *__restrict path, __T16ARGV);
INTDEF NONNULL((1, 2)) int NOTHROW_RPC(LIBKCALL libc_wexecv)(char32_t const *__restrict path, __T32ARGV);
INTDEF NONNULL((1, 2, 3)) int NOTHROW_RPC(LIBDCALL libd__wexecve)(char16_t const *__restrict path, __T16ARGV, __T16ENVP);
INTDEF NONNULL((1, 2, 3)) int NOTHROW_RPC(LIBKCALL libc_wexecve)(char32_t const *__restrict path, __T32ARGV, __T32ENVP);
INTDEF NONNULL((1, 2)) int NOTHROW_RPC(LIBDCALL libd__wexecvp)(char16_t const *__restrict file, __T16ARGV);
INTDEF NONNULL((1, 2)) int NOTHROW_RPC(LIBKCALL libc_wexecvp)(char32_t const *__restrict file, __T32ARGV);
INTDEF NONNULL((1, 2, 3)) int NOTHROW_RPC(LIBDCALL libd__wexecvpe)(char16_t const *__restrict file, __T16ARGV, __T16ENVP);
INTDEF NONNULL((1, 2, 3)) int NOTHROW_RPC(LIBKCALL libc_wexecvpe)(char32_t const *__restrict file, __T32ARGV, __T32ENVP);
INTDEF ATTR_SENTINEL NONNULL((1)) int NOTHROW_RPC(VLIBDCALL libd__wexecl)(char16_t const *__restrict path, char16_t const *args, ...);
INTDEF ATTR_SENTINEL NONNULL((1)) int NOTHROW_RPC(VLIBKCALL libc_wexecl)(char32_t const *__restrict path, char32_t const *args, ...);
INTDEF ATTR_SENTINEL NONNULL((1)) int NOTHROW_RPC(VLIBDCALL libd__wexeclp)(char16_t const *__restrict file, char16_t const *args, ...);
INTDEF ATTR_SENTINEL NONNULL((1)) int NOTHROW_RPC(VLIBKCALL libc_wexeclp)(char32_t const *__restrict file, char32_t const *args, ...);
INTDEF ATTR_SENTINEL_O(1) NONNULL((1)) int NOTHROW_RPC(VLIBDCALL libd__wexecle)(char16_t const *__restrict path, char16_t const *args, ...);
...
INTDEF ATTR_SENTINEL_O(1) NONNULL((1)) int NOTHROW_RPC(VLIBDCALL libd__wexeclpe)(char16_t const *__restrict file, char16_t const *args, ...);
...
INTDEF NONNULL((2, 3)) pid_t NOTHROW_RPC(LIBDCALL libd__wspawnv)(int mode, char16_t const *__restrict path, __T16ARGV);
INTDEF NONNULL((2, 3)) pid_t NOTHROW_RPC(LIBKCALL libc_wspawnv)(int mode, char32_t const *__restrict path, __T32ARGV);
INTDEF NONNULL((2, 3, 4)) pid_t NOTHROW_RPC(LIBDCALL libd__wspawnve)(int mode, char16_t const *__restrict path, __T16ARGV, __T16ENVP);
...
INTDEF NONNULL((2, 3)) pid_t NOTHROW_RPC(LIBDCALL libd__wspawnvp)(int mode, char16_t const *__restrict file, __T16ARGV);
INTDEF NONNULL((2, 3)) pid_t NOTHROW_RPC(LIBKCALL libc_wspawnvp)(int mode, char32_t const *__restrict file, __T32ARGV);
INTDEF NONNULL((2, 3, 4)) pid_t NOTHROW_RPC(LIBDCALL libd__wspawnvpe)(int mode, char16_t const *__restrict file, __T16ARGV, __T16ENVP);
...
INTDEF ATTR_SENTINEL NONNULL((2)) pid_t NOTHROW_RPC(VLIBDCALL libd__wspawnl)(int mode, char16_t const *__restrict path, char16_t const *args, ...);
...
INTDEF ATTR_SENTINEL NONNULL((2)) pid_t NOTHROW_RPC(VLIBDCALL libd__wspawnlp)(int mode, char16_t const *__restrict file, char16_t const *args, ...);
...
INTDEF ATTR_SENTINEL_O(1) NONNULL((2)) pid_t NOTHROW_RPC(VLIBDCALL libd__wspawnle)(int mode, char16_t const *__restrict path, char16_t const *args, ...);
...
INTDEF ATTR_SENTINEL_O(1) NONNULL((2)) pid_t NOTHROW_RPC(VLIBDCALL libd__wspawnlpe)(int mode, char16_t const *__restrict file, char16_t const *args, ...);
...
INTDEF int NOTHROW_RPC(LIBDCALL libd__wsystem)(char16_t const *cmd);
