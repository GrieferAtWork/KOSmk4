...
INTDEF NONNULL((2)) size_t NOTHROW_NCX(LIBCCALL libc_mbsnrtowcs)(char32_t *dst, char const **__restrict psrc, size_t nmc, size_t len, __mbstate_t *ps);
INTDEF NONNULL((2)) size_t NOTHROW_NCX(LIBDCALL libd_mbsnrtowcs)(char16_t *dst, char const **__restrict psrc, size_t nmc, size_t len, __mbstate_t *ps);
INTDEF NONNULL((2)) size_t NOTHROW_NCX(LIBCCALL libc_wcsnrtombs)(char *dst, char32_t const **__restrict psrc, size_t nwc, size_t len, __mbstate_t *ps);
INTDEF NONNULL((2)) size_t NOTHROW_NCX(LIBDCALL libd_wcsnrtombs)(char *dst, char16_t const **__restrict psrc, size_t nwc, size_t len, __mbstate_t *ps);
...
INTDEF ATTR_LIBC_SCANF(1, 0) WUNUSED NONNULL((1)) __STDC_INT_AS_SIZE_T (LIBCCALL libc_vwscanf_unlocked)(char32_t const *__restrict format, va_list args) __THROWS(...);
INTDEF ATTR_LIBC_SCANF(1, 0) WUNUSED NONNULL((1)) __STDC_INT_AS_SIZE_T (LIBDCALL libd_vwscanf_unlocked)(char16_t const *__restrict format, va_list args) __THROWS(...);
INTDEF ATTR_LIBC_SCANF(2, 3) WUNUSED NONNULL((1, 2)) __STDC_INT_AS_SIZE_T (VLIBCCALL libc_fwscanf_unlocked)(FILE *__restrict stream, char32_t const *__restrict format, ...) __THROWS(...);
INTDEF ATTR_LIBC_SCANF(2, 3) WUNUSED NONNULL((1, 2)) __STDC_INT_AS_SIZE_T (VLIBDCALL libd_fwscanf_unlocked)(FILE *__restrict stream, char16_t const *__restrict format, ...) __THROWS(...);
INTDEF ATTR_LIBC_SCANF(1, 2) WUNUSED NONNULL((1)) __STDC_INT_AS_SIZE_T (VLIBCCALL libc_wscanf_unlocked)(char32_t const *__restrict format, ...) __THROWS(...);
INTDEF ATTR_LIBC_SCANF(1, 2) WUNUSED NONNULL((1)) __STDC_INT_AS_SIZE_T (VLIBDCALL libd_wscanf_unlocked)(char16_t const *__restrict format, ...) __THROWS(...);
