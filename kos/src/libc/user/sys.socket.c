...
/*[[[head:libc_socketpair,hash:CRC-32=0xf094b4f]]]*/
/* >> socketpair(2)
...
/*[[[head:libc_bind,hash:CRC-32=0x674ac963]]]*/
/* >> bind(2)
...
/*[[[head:libc_getsockname,hash:CRC-32=0xcba55e86]]]*/
/* >> getsockname(2)
...
/*[[[head:libc_getpeername,hash:CRC-32=0x6d72512e]]]*/
/* >> getpeername(2)
...
/*[[[head:libc_connect,hash:CRC-32=0x875cb5dc]]]*/
/* >> connect(2)
...
/*[[[head:libc_recv,hash:CRC-32=0x8a3c3de9]]]*/
/* >> recv(2)
...
/*[[[head:libc_recvfrom,hash:CRC-32=0x1d58f921]]]*/
/* >> recvfrom(2)
...
/*[[[head:libc_recvmsg,hash:CRC-32=0xff7c52d9]]]*/
/* >> recvmsg(2)
...
/*[[[head:libc_send,hash:CRC-32=0xe2531017]]]*/
/* >> send(2)
...
/*[[[head:libc_sendto,hash:CRC-32=0x1df336b6]]]*/
/* >> sendto(2)
...
/*[[[head:libc_sendmsg,hash:CRC-32=0xd9d85e30]]]*/
/* >> sendmsg(2)
...
/*[[[head:libc_getsockopt,hash:CRC-32=0x8c86e1b5]]]*/
/* >> getsockopt(2)
...
INTERN ATTR_SECTION(".text.crt.net.socket") NONNULL((4, 5)) int
...
/*[[[head:libc_accept,hash:CRC-32=0x2588914b]]]*/
/* >> accept(2)
...
/*[[[head:libc_accept4,hash:CRC-32=0x8d6f0a3]]]*/
/* >> accept4(2)
 * Accept incoming client (aka. peer) connection requests.
 * @param: addr:       Peer address of the sender (or `NULL' when `addr_len' is `NULL')
 * @param: addr_len:   [NULL] Don't fill in the client's peer address
