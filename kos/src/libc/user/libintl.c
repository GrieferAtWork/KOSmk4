...
#define mofiletree_endread()    (void)(atomic_rwlock_endread_ex(&mofiletree_lock) && (mofiletree_reap(), 0))
#define _mofiletree_end()       atomic_rwlock_end(&mofiletree_lock)
#define mofiletree_end()        (void)(atomic_rwlock_end_ex(&mofiletree_lock) && (mofiletree_reap(), 0))
...
#define last_endread()    (void)(atomic_rwlock_endread_ex(&last_lock) && (last_reap(), 0))
#define _last_end()       atomic_rwlock_end(&last_lock)
#define last_end()        (void)(atomic_rwlock_end_ex(&last_lock) && (last_reap(), 0))
