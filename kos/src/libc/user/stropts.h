...
INTDEF int NOTHROW_RPC(LIBCCALL libc_getmsg)(fd_t fildes, struct strbuf *__restrict ctlptr, struct strbuf *__restrict dataptr, __STDC_INT_AS_UINT_T *__restrict flagsp);
/* Receive next message from a STREAMS file, with *FLAGSP allowing to control which message. */
INTDEF int NOTHROW_RPC(LIBCCALL libc_getpmsg)(fd_t fildes, struct strbuf *__restrict ctlptr, struct strbuf *__restrict dataptr, int *__restrict bandp, __STDC_INT_AS_UINT_T *__restrict flagsp);
/* Send a message on a STREAM */
INTDEF int NOTHROW_RPC(LIBCCALL libc_putmsg)(fd_t fildes, struct strbuf const *ctlptr, struct strbuf const *dataptr, __STDC_INT_AS_UINT_T flags);
/* Send a message on a STREAM to the BAND */
INTDEF int NOTHROW_RPC(LIBCCALL libc_putpmsg)(fd_t fildes, struct strbuf const *ctlptr, struct strbuf const *dataptr, __STDC_INT_AS_UINT_T band, __STDC_INT_AS_UINT_T flags);
