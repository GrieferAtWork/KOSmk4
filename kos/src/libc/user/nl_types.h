...
INTDEF ATTR_INOUT(1) char *NOTHROW_NCX(LIBCCALL libc_catgets)(nl_catd catalog, int set, int number, char const *string);
INTDEF ATTR_INOUT(1) int NOTHROW_NCX(LIBCCALL libc_catclose)(nl_catd catalog);
#endif /* !__KERNEL__ */
