...
/*[[[head:libc__flushall,hash:CRC-32=0xb1393270]]]*/
...
/*[[[head:libc_flushall_unlocked,hash:CRC-32=0x145bfa6f]]]*/
INTERN ATTR_SECTION(".text.crt.FILE.unlocked.write.utility") int
NOTHROW_CB_NCX(LIBCCALL libc_flushall_unlocked)(void)
...
/*[[[head:libc_fflush,hash:CRC-32=0x8d9140c4]]]*/
/* >> fflush(3)
...
NOTHROW_CB_NCX(LIBCCALL libc_fflush)(FILE *stream)
/*[[[body:libc_fflush]]]*/
{
	int result;
	if (!stream)
...
/*[[[head:libc_fflush_unlocked,hash:CRC-32=0x5500ff94]]]*/
/* >> fflush_unlocked(3)
 * Same as `fflush()', but performs I/O without acquiring a lock to `stream' */
INTERN ATTR_SECTION(".text.crt.FILE.unlocked.write.utility") int
NOTHROW_CB_NCX(LIBCCALL libc_fflush_unlocked)(FILE *stream)
...
/*[[[head:libc_fread,hash:CRC-32=0x726f8621]]]*/
/* >> fread(3)
...
NOTHROW_CB_NCX(LIBCCALL libc_fread)(void *__restrict buf,
                                    size_t elemsize,
                                    size_t elemcount,
...
/*[[[head:libc_fread_unlocked,hash:CRC-32=0xd6059d23]]]*/
/* >> fread_unlocked(3)
...
NOTHROW_CB_NCX(LIBCCALL libc_fread_unlocked)(void *__restrict buf,
                                             size_t elemsize,
                                             size_t elemcount,
                                             FILE *__restrict stream)
...
/*[[[head:libc_fwrite,hash:CRC-32=0xef743426]]]*/
/* >> fwrite(3)
...
NOTHROW_CB_NCX(LIBCCALL libc_fwrite)(void const *__restrict buf,
                                     size_t elemsize,
                                     size_t elemcount,
                                     FILE *__restrict stream)
/*[[[body:libc_fwrite]]]*/
...
/*[[[head:libc_fwrite_unlocked,hash:CRC-32=0x6881783]]]*/
/* >> fwrite_unlocked(3)
...
NOTHROW_CB_NCX(LIBCCALL libc_fwrite_unlocked)(void const *__restrict buf,
                                              size_t elemsize,
                                              size_t elemcount,
                                              FILE *__restrict stream)
...
/*[[[head:libc_file_printer,hash:CRC-32=0xa0f7d38b]]]*/
/* >> file_printer(3)
 * For use with `format_printf()' and friends: Prints to a `FILE *' closure argument */
INTERN ATTR_SECTION(".text.crt.FILE.locked.write.write") ATTR_INS(2, 3) NONNULL((1)) ssize_t
NOTHROW_CB_NCX(__FORMATPRINTER_CC libc_file_printer)(void *arg,
...
/*[[[head:libc_file_printer_unlocked,hash:CRC-32=0x2326f26e]]]*/
...
NOTHROW_CB_NCX(__FORMATPRINTER_CC libc_file_printer_unlocked)(void *arg,
                                                              char const *__restrict data,
                                                              size_t datalen)
...
/*[[[head:libc_ftell,hash:CRC-32=0x7368c391]]]*/
/* >> ftell(3)
...
NOTHROW_CB_NCX(LIBCCALL libc_ftell)(FILE *__restrict stream)
/*[[[body:libc_ftell]]]*/
{
	pos64_t result;
	if unlikely(!stream)
...
/*[[[head:libc_ftell_unlocked,hash:CRC-32=0x22540ece]]]*/
INTERN ATTR_SECTION(".text.crt.FILE.unlocked.seek.seek") WUNUSED ATTR_INOUT(1) long int
NOTHROW_CB_NCX(LIBCCALL libc_ftell_unlocked)(FILE *__restrict stream)
...
/*[[[head:libc_ftello,hash:CRC-32=0x3aad9eca]]]*/
...
NOTHROW_CB_NCX(LIBCCALL libc_ftello)(FILE *__restrict stream)
/*[[[body:libc_ftello]]]*/
{
	pos64_t result;
	if unlikely(!stream)
...
/*[[[head:libc_ftello_unlocked,hash:CRC-32=0x4fa5f508]]]*/
#if __SIZEOF_OFF_T__ == __SIZEOF_LONG__
...
NOTHROW_CB_NCX(LIBCCALL libc_ftello_unlocked)(FILE *__restrict stream)
...
/*[[[head:libc_ftello64,hash:CRC-32=0x8361a1b8]]]*/
...
NOTHROW_CB_NCX(LIBCCALL libc_ftello64)(FILE *__restrict stream)
/*[[[body:libc_ftello64]]]*/
{
	pos64_t result;
	if unlikely(!stream)
...
/*[[[head:libc_ftello64_unlocked,hash:CRC-32=0xd6297d33]]]*/
#if __SIZEOF_OFF32_T__ == __SIZEOF_OFF64_T__
...
NOTHROW_CB_NCX(LIBCCALL libc_ftello64_unlocked)(FILE *__restrict stream)
...
/*[[[head:libc_fseek,hash:CRC-32=0x937b8d29]]]*/
/* >> fseek(3)
...
NOTHROW_CB_NCX(LIBCCALL libc_fseek)(FILE *__restrict stream,
                                    long int off,
                                    int whence)
/*[[[body:libc_fseek]]]*/
{
...
/*[[[head:libc_fseek_unlocked,hash:CRC-32=0x724b622b]]]*/
INTERN ATTR_SECTION(".text.crt.FILE.unlocked.seek.seek") ATTR_INOUT(1) int
NOTHROW_CB_NCX(LIBCCALL libc_fseek_unlocked)(FILE *__restrict stream,
                                             long int off,
                                             int whence)
...
/*[[[head:libc_fseeko,hash:CRC-32=0xbfa89245]]]*/
#if __SIZEOF_OFF_T__ == __SIZEOF_LONG__
...
INTERN ATTR_SECTION(".text.crt.FILE.locked.seek.seek") ATTR_INOUT(1) int
NOTHROW_CB_NCX(LIBCCALL libc_fseeko)(FILE *__restrict stream,
                                     off_t off,
                                     int whence)
/*[[[body:libc_fseeko]]]*/
{
...
/*[[[head:libc_fseeko_unlocked,hash:CRC-32=0xff58a6be]]]*/
#if __SIZEOF_OFF_T__ == __SIZEOF_LONG__
DEFINE_INTERN_ALIAS(libc_fseeko_unlocked, libc_fseek_unlocked);
#else /* MAGIC:alias */
INTERN ATTR_SECTION(".text.crt.FILE.unlocked.seek.seek") ATTR_INOUT(1) int
NOTHROW_CB_NCX(LIBCCALL libc_fseeko_unlocked)(FILE *__restrict stream,
                                              off_t off,
                                              int whence)
...
/*[[[head:libc_fseeko64,hash:CRC-32=0xa1b7d427]]]*/
#if __SIZEOF_OFF32_T__ == __SIZEOF_OFF64_T__
 ...
 * Change the current in-file position of `stream' */
INTERN ATTR_SECTION(".text.crt.FILE.locked.seek.seek") ATTR_INOUT(1) int
NOTHROW_CB_NCX(LIBCCALL libc_fseeko64)(FILE *__restrict stream,
                                       off64_t off,
                                       int whence)
/*[[[body:libc_fseeko64]]]*/
{
...
/*[[[head:libc_fseeko64_unlocked,hash:CRC-32=0xb81ddeda]]]*/
#if __SIZEOF_OFF32_T__ == __SIZEOF_OFF64_T__
DEFINE_INTERN_ALIAS(libc_fseeko64_unlocked, libc_fseeko_unlocked);
#else /* MAGIC:alias */
INTERN ATTR_SECTION(".text.crt.FILE.unlocked.seek.seek") ATTR_INOUT(1) int
NOTHROW_CB_NCX(LIBCCALL libc_fseeko64_unlocked)(FILE *__restrict stream,
                                                off64_t off,
                                                int whence)
...
/*[[[head:libc_fgetpos,hash:CRC-32=0xc4b66d73]]]*/
...
NOTHROW_CB_NCX(LIBCCALL libc_fgetpos)(FILE *__restrict stream,
...
/*[[[head:libc_fgetpos_unlocked,hash:CRC-32=0xd3204dd9]]]*/
INTERN ATTR_SECTION(".text.crt.FILE.unlocked.seek.pos") ATTR_INOUT(1) ATTR_OUT(2) int
NOTHROW_CB_NCX(LIBCCALL libc_fgetpos_unlocked)(FILE *__restrict stream,
                                               fpos_t *__restrict pos)
...
/*[[[head:libc_fsetpos,hash:CRC-32=0x1171db7f]]]*/
...
NOTHROW_CB_NCX(LIBCCALL libc_fsetpos)(FILE *__restrict stream,
...
/*[[[head:libc_fsetpos_unlocked,hash:CRC-32=0xdf43a28e]]]*/
INTERN ATTR_SECTION(".text.crt.FILE.unlocked.seek.pos") ATTR_IN(2) ATTR_INOUT(1) int
NOTHROW_CB_NCX(LIBCCALL libc_fsetpos_unlocked)(FILE *__restrict stream,
                                               fpos_t const *__restrict pos)
...
/*[[[head:libc_fgetpos64,hash:CRC-32=0xc4ef4f67]]]*/
 ...
 * Upon success (return == 0), `pos' can be used to restore the current position by calling `fsetpos()' */
INTERN ATTR_SECTION(".text.crt.FILE.locked.seek.pos") ATTR_INOUT(1) ATTR_OUT(2) int
NOTHROW_CB_NCX(LIBCCALL libc_fgetpos64)(FILE *__restrict stream,
...
/*[[[head:libc_fgetpos64_unlocked,hash:CRC-32=0x36a58bc2]]]*/
#if __SIZEOF_FPOS32_T__ == __SIZEOF_FPOS64_T__
DEFINE_INTERN_ALIAS(libc_fgetpos64_unlocked, libc_fgetpos_unlocked);
#else /* MAGIC:alias */
INTERN ATTR_SECTION(".text.crt.FILE.unlocked.seek.pos") ATTR_INOUT(1) ATTR_OUT(2) int
NOTHROW_CB_NCX(LIBCCALL libc_fgetpos64_unlocked)(FILE *__restrict stream,
                                                 fpos64_t *__restrict pos)
...
/*[[[head:libc_fsetpos64,hash:CRC-32=0x434c2386]]]*/
#if __SIZEOF_FPOS32_T__ == __SIZEOF_FPOS64_T__
 ...
 * Set the file position of `stream' to `pos', as previously initialized with a call to `fgetpos()' */
INTERN ATTR_SECTION(".text.crt.FILE.locked.seek.pos") ATTR_IN(2) ATTR_INOUT(1) int
NOTHROW_CB_NCX(LIBCCALL libc_fsetpos64)(FILE *__restrict stream,
...
/*[[[head:libc_fsetpos64_unlocked,hash:CRC-32=0x73ad60e1]]]*/
#if __SIZEOF_FPOS32_T__ == __SIZEOF_FPOS64_T__
DEFINE_INTERN_ALIAS(libc_fsetpos64_unlocked, libc_fsetpos_unlocked);
#else /* MAGIC:alias */
INTERN ATTR_SECTION(".text.crt.FILE.unlocked.seek.pos") ATTR_IN(2) ATTR_INOUT(1) int
NOTHROW_CB_NCX(LIBCCALL libc_fsetpos64_unlocked)(FILE *__restrict stream,
                                                 fpos64_t const *__restrict pos)
...
/*[[[head:libc_rewind,hash:CRC-32=0x866fbb58]]]*/
/* >> rewind(3)
...
NOTHROW_CB_NCX(LIBCCALL libc_rewind)(FILE *__restrict stream)
/*[[[body:libc_rewind]]]*/
{
	if likely(stream) {
		stream = file_fromuser(stream);
...
/*[[[head:libc_rewind_unlocked,hash:CRC-32=0x2e104240]]]*/
INTERN ATTR_SECTION(".text.crt.FILE.unlocked.seek.utility") ATTR_INOUT(1) void
NOTHROW_CB_NCX(LIBCCALL libc_rewind_unlocked)(FILE *__restrict stream)
...
/*[[[head:libc_fftruncate_unlocked,hash:CRC-32=0xae2d48b5]]]*/
...
NOTHROW_CB_NCX(LIBCCALL libc_fftruncate_unlocked)(FILE *__restrict stream,
                                                  __PIO_OFFSET length)
...
/*[[[head:libc_fftruncate64,hash:CRC-32=0x2ce66640]]]*/
#if __SIZEOF_OFF32_T__ == __SIZEOF_OFF64_T__
 ...
 * Truncate the given file `stream' to a length of `length' */
INTERN ATTR_SECTION(".text.crt.FILE.locked.utility") ATTR_INOUT(1) int
NOTHROW_CB_NCX(LIBCCALL libc_fftruncate64)(FILE *__restrict stream,
...
/*[[[head:libc_fftruncate64_unlocked,hash:CRC-32=0xac3b29c2]]]*/
#if __SIZEOF_OFF32_T__ == __SIZEOF_OFF64_T__
 ...
 * Truncate the given file `stream' to a length of `length' */
INTERN ATTR_SECTION(".text.crt.FILE.unlocked.utility") ATTR_INOUT(1) int
NOTHROW_CB_NCX(LIBCCALL libc_fftruncate64_unlocked)(FILE *__restrict stream,
                                                    __PIO_OFFSET64 length)
...
/*[[[head:libc_fputc_unlocked,hash:CRC-32=0x5c6fb190]]]*/
/* >> fputc_unlocked(3)
...
NOTHROW_CB_NCX(LIBCCALL libc_fputc_unlocked)(int ch,
                                             FILE *__restrict stream)
...
/*[[[head:libc_fgetc_unlocked,hash:CRC-32=0x6fc9df7d]]]*/
/* >> fgetc_unlocked(3)
...
NOTHROW_CB_NCX(LIBCCALL libc_fgetc_unlocked)(FILE *__restrict stream)
...
/*[[[head:libc_fcloseall,hash:CRC-32=0xc4f4c668]]]*/
/* >> fcloseall(3)
 * Close all opened files */
INTERN ATTR_SECTION(".text.crt.dos.FILE.utility") int
NOTHROW_CB_NCX(LIBCCALL libc_fcloseall)(void)
/*[[[body:libc_fcloseall]]]*/
{
	int result = 0;
	FILE *fp;
...
DEFINE_PUBLIC_ALIAS_P(__rename,libc_rename,ATTR_IN(1) ATTR_IN(2),int,NOTHROW_RPC,LIBCCALL,(char const *oldname, char const *newname_or_path),(oldname,newname_or_path));
DEFINE_PUBLIC_ALIAS_P(__libc_rename,libc_rename,ATTR_IN(1) ATTR_IN(2),int,NOTHROW_RPC,LIBCCALL,(char const *oldname, char const *newname_or_path),(oldname,newname_or_path));
DEFINE_PUBLIC_ALIAS_P(rename,libc_rename,ATTR_IN(1) ATTR_IN(2),int,NOTHROW_RPC,LIBCCALL,(char const *oldname, char const *newname_or_path),(oldname,newname_or_path));
DEFINE_PUBLIC_ALIAS_P(DOS$tmpnam,libd_tmpnam,WUNUSED ATTR_OUT(1),char *,NOTHROW_NCX,LIBDCALL,(char *buf),(buf));
DEFINE_PUBLIC_ALIAS_P(tmpnam,libc_tmpnam,WUNUSED ATTR_OUT(1),char *,NOTHROW_NCX,LIBCCALL,(char *buf),(buf));
#ifdef __LIBCCALL_IS_LIBDCALL
DEFINE_PUBLIC_ALIAS_P(_fclose_nolock,libc_fclose,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
#endif /* __LIBCCALL_IS_LIBDCALL */
DEFINE_PUBLIC_ALIAS_P(_IO_fclose,libc_fclose,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(fclose,libc_fclose,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(fflush,libc_fflush,,int,NOTHROW_CB_NCX,LIBCCALL,(FILE *stream),(stream));
DEFINE_PUBLIC_ALIAS_P(_IO_fflush,libc_fflush,,int,NOTHROW_CB_NCX,LIBCCALL,(FILE *stream),(stream));
DEFINE_PUBLIC_ALIAS_P(_IO_sync,libc_fflush,,int,NOTHROW_CB_NCX,LIBCCALL,(FILE *stream),(stream));
DEFINE_PUBLIC_ALIAS_P(fflush_locked,libc_fflush,,int,NOTHROW_CB_NCX,LIBCCALL,(FILE *stream),(stream));
DEFINE_PUBLIC_ALIAS_P(setvbuf,libc_setvbuf,ATTR_INOUT(1),int,NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream, char *__restrict buf, __STDC_INT_AS_UINT_T modes, size_t bufsize),(stream,buf,modes,bufsize));
DEFINE_PUBLIC_ALIAS_P(_IO_setvbuf,libc_setvbuf,ATTR_INOUT(1),int,NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream, char *__restrict buf, __STDC_INT_AS_UINT_T modes, size_t bufsize),(stream,buf,modes,bufsize));
DEFINE_PUBLIC_ALIAS_P(getc,libc_fgetc,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(fgetc,libc_fgetc,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(_IO_getc,libc_fgetc,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(_IO_default_uflow,libc_fgetc,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(getc_locked,libc_fgetc,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(putc,libc_fputc,ATTR_INOUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(int ch, FILE *__restrict stream),(ch,stream));
DEFINE_PUBLIC_ALIAS_P(fputc,libc_fputc,ATTR_INOUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(int ch, FILE *__restrict stream),(ch,stream));
DEFINE_PUBLIC_ALIAS_P(_IO_putc,libc_fputc,ATTR_INOUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(int ch, FILE *__restrict stream),(ch,stream));
DEFINE_PUBLIC_ALIAS_P(fputc_locked,libc_fputc,ATTR_INOUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(int ch, FILE *__restrict stream),(ch,stream));
DEFINE_PUBLIC_ALIAS_P(putc_locked,libc_fputc,ATTR_INOUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(int ch, FILE *__restrict stream),(ch,stream));
DEFINE_PUBLIC_ALIAS_P(ungetc,libc_ungetc,ATTR_INOUT(2),int,NOTHROW_NCX,LIBCCALL,(int ch, FILE *__restrict stream),(ch,stream));
DEFINE_PUBLIC_ALIAS_P(_IO_ungetc,libc_ungetc,ATTR_INOUT(2),int,NOTHROW_NCX,LIBCCALL,(int ch, FILE *__restrict stream),(ch,stream));
DEFINE_PUBLIC_ALIAS_P(fread,libc_fread,WUNUSED ATTR_INOUT(4) ATTR_OUT_OPT(1),size_t,NOTHROW_CB_NCX,LIBCCALL,(void *__restrict buf, size_t elemsize, size_t elemcount, FILE *__restrict stream),(buf,elemsize,elemcount,stream));
DEFINE_PUBLIC_ALIAS_P(_IO_fread,libc_fread,WUNUSED ATTR_INOUT(4) ATTR_OUT_OPT(1),size_t,NOTHROW_CB_NCX,LIBCCALL,(void *__restrict buf, size_t elemsize, size_t elemcount, FILE *__restrict stream),(buf,elemsize,elemcount,stream));
DEFINE_PUBLIC_ALIAS_P(fwrite,libc_fwrite,ATTR_INOUT(4) ATTR_IN_OPT(1),size_t,NOTHROW_CB_NCX,LIBCCALL,(void const *__restrict buf, size_t elemsize, size_t elemcount, FILE *__restrict stream),(buf,elemsize,elemcount,stream));
DEFINE_PUBLIC_ALIAS_P(_IO_fwrite,libc_fwrite,ATTR_INOUT(4) ATTR_IN_OPT(1),size_t,NOTHROW_CB_NCX,LIBCCALL,(void const *__restrict buf, size_t elemsize, size_t elemcount, FILE *__restrict stream),(buf,elemsize,elemcount,stream));
DEFINE_PUBLIC_ALIAS_P(fwrite_s,libc_fwrite,ATTR_INOUT(4) ATTR_IN_OPT(1),size_t,NOTHROW_CB_NCX,LIBCCALL,(void const *__restrict buf, size_t elemsize, size_t elemcount, FILE *__restrict stream),(buf,elemsize,elemcount,stream));
DEFINE_PUBLIC_ALIAS_P(fseek,libc_fseek,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, long int off, int whence),(stream,off,whence));
DEFINE_PUBLIC_ALIAS_P(ftell,libc_ftell,WUNUSED ATTR_INOUT(1),long int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(_IO_ftell,libc_ftell,WUNUSED ATTR_INOUT(1),long int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P_VOID(rewind_unlocked,libc_rewind,ATTR_INOUT(1),NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P_VOID(rewind,libc_rewind,ATTR_INOUT(1),NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P_VOID(clearerr_unlocked,libc_clearerr,ATTR_INOUT(1),NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P_VOID(clearerr_locked,libc_clearerr,ATTR_INOUT(1),NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P_VOID(clearerr,libc_clearerr,ATTR_INOUT(1),NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(_IO_feof,libc_feof,ATTR_PURE WUNUSED ATTR_IN(1),int,NOTHROW_NCX,LIBCCALL,(FILE __KOS_FIXED_CONST *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(feof_unlocked,libc_feof,ATTR_PURE WUNUSED ATTR_IN(1),int,NOTHROW_NCX,LIBCCALL,(FILE __KOS_FIXED_CONST *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(feof_locked,libc_feof,ATTR_PURE WUNUSED ATTR_IN(1),int,NOTHROW_NCX,LIBCCALL,(FILE __KOS_FIXED_CONST *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(feof,libc_feof,ATTR_PURE WUNUSED ATTR_IN(1),int,NOTHROW_NCX,LIBCCALL,(FILE __KOS_FIXED_CONST *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(_IO_ferror,libc_ferror,ATTR_PURE WUNUSED ATTR_IN(1),int,NOTHROW_NCX,LIBCCALL,(FILE __KOS_FIXED_CONST *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(ferror_unlocked,libc_ferror,ATTR_PURE WUNUSED ATTR_IN(1),int,NOTHROW_NCX,LIBCCALL,(FILE __KOS_FIXED_CONST *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(ferror_locked,libc_ferror,ATTR_PURE WUNUSED ATTR_IN(1),int,NOTHROW_NCX,LIBCCALL,(FILE __KOS_FIXED_CONST *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(ferror,libc_ferror,ATTR_PURE WUNUSED ATTR_IN(1),int,NOTHROW_NCX,LIBCCALL,(FILE __KOS_FIXED_CONST *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(DOS$_IO_fopen,libd_fopen,WUNUSED ATTR_IN(1) ATTR_IN(2),FILE *,NOTHROW_RPC,LIBDCALL,(char const *__restrict filename, char const *__restrict modes),(filename,modes));
DEFINE_PUBLIC_ALIAS_P(DOS$setmntent,libd_fopen,WUNUSED ATTR_IN(1) ATTR_IN(2),FILE *,NOTHROW_RPC,LIBDCALL,(char const *__restrict filename, char const *__restrict modes),(filename,modes));
DEFINE_PUBLIC_ALIAS_P(DOS$__setmntent,libd_fopen,WUNUSED ATTR_IN(1) ATTR_IN(2),FILE *,NOTHROW_RPC,LIBDCALL,(char const *__restrict filename, char const *__restrict modes),(filename,modes));
DEFINE_PUBLIC_ALIAS_P(DOS$fopen,libd_fopen,WUNUSED ATTR_IN(1) ATTR_IN(2),FILE *,NOTHROW_RPC,LIBDCALL,(char const *__restrict filename, char const *__restrict modes),(filename,modes));
DEFINE_PUBLIC_ALIAS_P(_IO_fopen,libc_fopen,WUNUSED ATTR_IN(1) ATTR_IN(2),FILE *,NOTHROW_RPC,LIBCCALL,(char const *__restrict filename, char const *__restrict modes),(filename,modes));
DEFINE_PUBLIC_ALIAS_P(setmntent,libc_fopen,WUNUSED ATTR_IN(1) ATTR_IN(2),FILE *,NOTHROW_RPC,LIBCCALL,(char const *__restrict filename, char const *__restrict modes),(filename,modes));
DEFINE_PUBLIC_ALIAS_P(__setmntent,libc_fopen,WUNUSED ATTR_IN(1) ATTR_IN(2),FILE *,NOTHROW_RPC,LIBCCALL,(char const *__restrict filename, char const *__restrict modes),(filename,modes));
DEFINE_PUBLIC_ALIAS_P(fopen,libc_fopen,WUNUSED ATTR_IN(1) ATTR_IN(2),FILE *,NOTHROW_RPC,LIBCCALL,(char const *__restrict filename, char const *__restrict modes),(filename,modes));
DEFINE_PUBLIC_ALIAS_P(DOS$freopen,libd_freopen,ATTR_IN(1) ATTR_IN(2) ATTR_INOUT(3),FILE *,NOTHROW_RPC,LIBDCALL,(char const *__restrict filename, char const *__restrict modes, FILE *__restrict stream),(filename,modes,stream));
DEFINE_PUBLIC_ALIAS_P(freopen,libc_freopen,ATTR_IN(1) ATTR_IN(2) ATTR_INOUT(3),FILE *,NOTHROW_RPC,LIBCCALL,(char const *__restrict filename, char const *__restrict modes, FILE *__restrict stream),(filename,modes,stream));
DEFINE_PUBLIC_ALIAS_P(fgetpos,libc_fgetpos,ATTR_INOUT(1) ATTR_OUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, fpos_t *__restrict pos),(stream,pos));
DEFINE_PUBLIC_ALIAS_P(_IO_fgetpos,libc_fgetpos,ATTR_INOUT(1) ATTR_OUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, fpos_t *__restrict pos),(stream,pos));
DEFINE_PUBLIC_ALIAS_P(fsetpos,libc_fsetpos,ATTR_IN(2) ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, fpos_t const *__restrict pos),(stream,pos));
DEFINE_PUBLIC_ALIAS_P(_IO_fsetpos,libc_fsetpos,ATTR_IN(2) ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, fpos_t const *__restrict pos),(stream,pos));
DEFINE_PUBLIC_ALIAS_P(_IO_vfprintf,libc_vfprintf,ATTR_IN(2) ATTR_INOUT(1) ATTR_LIBC_PRINTF(2, 0),__STDC_INT_AS_SSIZE_T,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, char const *__restrict format, va_list args),(stream,format,args));
DEFINE_PUBLIC_ALIAS_P(_vfprintf_p,libc_vfprintf,ATTR_IN(2) ATTR_INOUT(1) ATTR_LIBC_PRINTF(2, 0),__STDC_INT_AS_SSIZE_T,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, char const *__restrict format, va_list args),(stream,format,args));
DEFINE_PUBLIC_ALIAS_P(vfprintf,libc_vfprintf,ATTR_IN(2) ATTR_INOUT(1) ATTR_LIBC_PRINTF(2, 0),__STDC_INT_AS_SSIZE_T,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, char const *__restrict format, va_list args),(stream,format,args));
DEFINE_PUBLIC_ALIAS_P(DOS$renameat,libd_renameat,ATTR_IN(2) ATTR_IN(4),int,NOTHROW_RPC,LIBDCALL,(fd_t oldfd, char const *oldname, fd_t newfd, char const *newname_or_path),(oldfd,oldname,newfd,newname_or_path));
DEFINE_PUBLIC_ALIAS_P(renameat,libc_renameat,ATTR_IN(2) ATTR_IN(4),int,NOTHROW_RPC,LIBCCALL,(fd_t oldfd, char const *oldname, fd_t newfd, char const *newname_or_path),(oldfd,oldname,newfd,newname_or_path));
DEFINE_PUBLIC_ALIAS_P(DOS$renameat2,libd_renameat2,ATTR_IN(2) ATTR_IN(4),int,NOTHROW_RPC,LIBDCALL,(fd_t oldfd, char const *oldname, fd_t newfd, char const *newname_or_path, atflag_t flags),(oldfd,oldname,newfd,newname_or_path,flags));
DEFINE_PUBLIC_ALIAS_P(renameat2,libc_renameat2,ATTR_IN(2) ATTR_IN(4),int,NOTHROW_RPC,LIBCCALL,(fd_t oldfd, char const *oldname, fd_t newfd, char const *newname_or_path, atflag_t flags),(oldfd,oldname,newfd,newname_or_path,flags));
#ifdef __LIBCCALL_IS_LIBDCALL
DEFINE_PUBLIC_ALIAS_P(_fflush_nolock,libc_fflush_unlocked,,int,NOTHROW_CB_NCX,LIBCCALL,(FILE *stream),(stream));
#endif /* __LIBCCALL_IS_LIBDCALL */
DEFINE_PUBLIC_ALIAS_P(fflush_unlocked,libc_fflush_unlocked,,int,NOTHROW_CB_NCX,LIBCCALL,(FILE *stream),(stream));
DEFINE_PUBLIC_ALIAS_P(fread_unlocked,libc_fread_unlocked,WUNUSED ATTR_INOUT(4) ATTR_OUT_OPT(1),size_t,NOTHROW_CB_NCX,LIBCCALL,(void *__restrict buf, size_t elemsize, size_t elemcount, FILE *__restrict stream),(buf,elemsize,elemcount,stream));
DEFINE_PUBLIC_ALIAS_P(_fread_nolock,libc_fread_unlocked,WUNUSED ATTR_INOUT(4) ATTR_OUT_OPT(1),size_t,NOTHROW_CB_NCX,LIBCCALL,(void *__restrict buf, size_t elemsize, size_t elemcount, FILE *__restrict stream),(buf,elemsize,elemcount,stream));
DEFINE_PUBLIC_ALIAS_P(fwrite_unlocked,libc_fwrite_unlocked,ATTR_INOUT(4) ATTR_IN_OPT(1),size_t,NOTHROW_CB_NCX,LIBCCALL,(void const *__restrict buf, size_t elemsize, size_t elemcount, FILE *__restrict stream),(buf,elemsize,elemcount,stream));
DEFINE_PUBLIC_ALIAS_P(_fwrite_nolock,libc_fwrite_unlocked,ATTR_INOUT(4) ATTR_IN_OPT(1),size_t,NOTHROW_CB_NCX,LIBCCALL,(void const *__restrict buf, size_t elemsize, size_t elemcount, FILE *__restrict stream),(buf,elemsize,elemcount,stream));
DEFINE_PUBLIC_ALIAS_P(fgetc_unlocked,libc_fgetc_unlocked,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(getc_unlocked,libc_fgetc_unlocked,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(_getc_nolock,libc_fgetc_unlocked,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(_fgetc_nolock,libc_fgetc_unlocked,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(putc_unlocked,libc_fputc_unlocked,ATTR_INOUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(int ch, FILE *__restrict stream),(ch,stream));
DEFINE_PUBLIC_ALIAS_P(fputc_unlocked,libc_fputc_unlocked,ATTR_INOUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(int ch, FILE *__restrict stream),(ch,stream));
DEFINE_PUBLIC_ALIAS_P(_putc_nolock,libc_fputc_unlocked,ATTR_INOUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(int ch, FILE *__restrict stream),(ch,stream));
DEFINE_PUBLIC_ALIAS_P(_fputc_nolock,libc_fputc_unlocked,ATTR_INOUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(int ch, FILE *__restrict stream),(ch,stream));
#ifdef __LIBCCALL_IS_LIBDCALL
DEFINE_PUBLIC_ALIAS_P(_tempnam,libc_tempnam,ATTR_MALLOC WUNUSED,char *,NOTHROW_NCX,LIBCCALL,(char const *dir, char const *pfx),(dir,pfx));
#endif /* __LIBCCALL_IS_LIBDCALL */
DEFINE_PUBLIC_ALIAS_P(tempnam,libc_tempnam,ATTR_MALLOC WUNUSED,char *,NOTHROW_NCX,LIBCCALL,(char const *dir, char const *pfx),(dir,pfx));
#ifdef __LIBCCALL_IS_LIBDCALL
DEFINE_PUBLIC_ALIAS_P(_fdopen,libc_fdopen,WUNUSED ATTR_FDARG(1) ATTR_IN(2),FILE *,NOTHROW_NCX,LIBCCALL,(fd_t fd, char const *__restrict modes),(fd,modes));
#endif /* __LIBCCALL_IS_LIBDCALL */
DEFINE_PUBLIC_ALIAS_P(_IO_fdopen,libc_fdopen,WUNUSED ATTR_FDARG(1) ATTR_IN(2),FILE *,NOTHROW_NCX,LIBCCALL,(fd_t fd, char const *__restrict modes),(fd,modes));
DEFINE_PUBLIC_ALIAS_P(fdopen,libc_fdopen,WUNUSED ATTR_FDARG(1) ATTR_IN(2),FILE *,NOTHROW_NCX,LIBCCALL,(fd_t fd, char const *__restrict modes),(fd,modes));
#ifdef __LIBCCALL_IS_LIBDCALL
DEFINE_PUBLIC_ALIAS_P(_fileno,libc_fileno,WUNUSED ATTR_INOUT(1),fd_t,NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
#endif /* __LIBCCALL_IS_LIBDCALL */
DEFINE_PUBLIC_ALIAS_P(fileno_unlocked,libc_fileno,WUNUSED ATTR_INOUT(1),fd_t,NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(fileno_locked,libc_fileno,WUNUSED ATTR_INOUT(1),fd_t,NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(fileno,libc_fileno,WUNUSED ATTR_INOUT(1),fd_t,NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
#ifdef __LIBCCALL_IS_LIBDCALL
DEFINE_PUBLIC_ALIAS_P_VOID(_lock_file,libc_flockfile,ATTR_INOUT(1),NOTHROW_RPC,LIBCCALL,(FILE *__restrict stream),(stream));
#endif /* __LIBCCALL_IS_LIBDCALL */
DEFINE_PUBLIC_ALIAS_P_VOID(_IO_flockfile,libc_flockfile,ATTR_INOUT(1),NOTHROW_RPC,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P_VOID(__internal_flockfile,libc_flockfile,ATTR_INOUT(1),NOTHROW_RPC,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P_VOID(__flockfile,libc_flockfile,ATTR_INOUT(1),NOTHROW_RPC,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P_VOID(flockfile,libc_flockfile,ATTR_INOUT(1),NOTHROW_RPC,LIBCCALL,(FILE *__restrict stream),(stream));
#ifdef __LIBCCALL_IS_LIBDCALL
DEFINE_PUBLIC_ALIAS_P_VOID(_unlock_file,libc_funlockfile,ATTR_INOUT(1),NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
#endif /* __LIBCCALL_IS_LIBDCALL */
DEFINE_PUBLIC_ALIAS_P_VOID(_IO_funlockfile,libc_funlockfile,ATTR_INOUT(1),NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P_VOID(__internal_funlockfile,libc_funlockfile,ATTR_INOUT(1),NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P_VOID(__funlockfile,libc_funlockfile,ATTR_INOUT(1),NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P_VOID(funlockfile,libc_funlockfile,ATTR_INOUT(1),NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(_IO_ftrylockfile,libc_ftrylockfile,WUNUSED ATTR_INOUT(1),int,NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(__internal_ftrylockfile,libc_ftrylockfile,WUNUSED ATTR_INOUT(1),int,NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(__ftrylockfile,libc_ftrylockfile,WUNUSED ATTR_INOUT(1),int,NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(ftrylockfile,libc_ftrylockfile,WUNUSED ATTR_INOUT(1),int,NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
#ifdef __LIBCCALL_IS_LIBDCALL
DEFINE_PUBLIC_ALIAS_P(_popen,libc_popen,WUNUSED ATTR_IN(2) ATTR_IN_OPT(1),FILE *,NOTHROW_RPC,LIBCCALL,(char const *command, char const *modes),(command,modes));
#endif /* __LIBCCALL_IS_LIBDCALL */
DEFINE_PUBLIC_ALIAS_P(_IO_popen,libc_popen,WUNUSED ATTR_IN(2) ATTR_IN_OPT(1),FILE *,NOTHROW_RPC,LIBCCALL,(char const *command, char const *modes),(command,modes));
DEFINE_PUBLIC_ALIAS_P(popen,libc_popen,WUNUSED ATTR_IN(2) ATTR_IN_OPT(1),FILE *,NOTHROW_RPC,LIBCCALL,(char const *command, char const *modes),(command,modes));
#ifdef __LIBCCALL_IS_LIBDCALL
DEFINE_PUBLIC_ALIAS_P(_pclose,libc_pclose,ATTR_INOUT(1),int,NOTHROW_NCX,LIBCCALL,(FILE *stream),(stream));
#endif /* __LIBCCALL_IS_LIBDCALL */
DEFINE_PUBLIC_ALIAS_P(pclose,libc_pclose,ATTR_INOUT(1),int,NOTHROW_NCX,LIBCCALL,(FILE *stream),(stream));
DEFINE_PUBLIC_ALIAS_P(popenve,libc_popenve,WUNUSED ATTR_IN(1) ATTR_IN(2) ATTR_IN(3) ATTR_IN(4),FILE *,NOTHROW_RPC,LIBCCALL,(char const *path, __TARGV, __TENVP, char const *modes),(path,___argv,___envp,modes));
DEFINE_PUBLIC_ALIAS_P(_fcloseall,libc_fcloseall,,int,NOTHROW_CB_NCX,LIBCCALL,(void),());
DEFINE_PUBLIC_ALIAS_P(__fcloseall,libc_fcloseall,,int,NOTHROW_CB_NCX,LIBCCALL,(void),());
DEFINE_PUBLIC_ALIAS_P(fcloseall,libc_fcloseall,,int,NOTHROW_CB_NCX,LIBCCALL,(void),());
DEFINE_PUBLIC_ALIAS_P(fseeko,libc_fseeko,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, off_t off, int whence),(stream,off,whence));
DEFINE_PUBLIC_ALIAS_P(ftello,libc_ftello,WUNUSED ATTR_INOUT(1),off_t,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(fseeko64,libc_fseeko64,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, off64_t off, int whence),(stream,off,whence));
DEFINE_PUBLIC_ALIAS_P(__fseeko64,libc_fseeko64,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, off64_t off, int whence),(stream,off,whence));
DEFINE_PUBLIC_ALIAS_P(fseek64,libc_fseeko64,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, off64_t off, int whence),(stream,off,whence));
DEFINE_PUBLIC_ALIAS_P(_fseeki64,libc_fseeko64,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, off64_t off, int whence),(stream,off,whence));
DEFINE_PUBLIC_ALIAS_P(ftello64,libc_ftello64,WUNUSED ATTR_INOUT(1),off64_t,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(__ftello64,libc_ftello64,WUNUSED ATTR_INOUT(1),off64_t,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(ftell64,libc_ftello64,WUNUSED ATTR_INOUT(1),off64_t,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(_ftelli64,libc_ftello64,WUNUSED ATTR_INOUT(1),off64_t,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(DOS$fopen64,libd_fopen64,WUNUSED ATTR_IN(1) ATTR_IN(2),FILE *,NOTHROW_RPC,LIBDCALL,(char const *__restrict filename, char const *__restrict modes),(filename,modes));
DEFINE_PUBLIC_ALIAS_P(fopen64,libc_fopen64,WUNUSED ATTR_IN(1) ATTR_IN(2),FILE *,NOTHROW_RPC,LIBCCALL,(char const *__restrict filename, char const *__restrict modes),(filename,modes));
DEFINE_PUBLIC_ALIAS_P(DOS$freopen64,libd_freopen64,ATTR_IN(1) ATTR_IN(2) ATTR_INOUT(3),FILE *,NOTHROW_RPC,LIBDCALL,(char const *__restrict filename, char const *__restrict modes, FILE *__restrict stream),(filename,modes,stream));
DEFINE_PUBLIC_ALIAS_P(freopen64,libc_freopen64,ATTR_IN(1) ATTR_IN(2) ATTR_INOUT(3),FILE *,NOTHROW_RPC,LIBCCALL,(char const *__restrict filename, char const *__restrict modes, FILE *__restrict stream),(filename,modes,stream));
DEFINE_PUBLIC_ALIAS_P(fgetpos64,libc_fgetpos64,ATTR_INOUT(1) ATTR_OUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, fpos64_t *__restrict pos),(stream,pos));
DEFINE_PUBLIC_ALIAS_P(_IO_fgetpos64,libc_fgetpos64,ATTR_INOUT(1) ATTR_OUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, fpos64_t *__restrict pos),(stream,pos));
DEFINE_PUBLIC_ALIAS_P(fsetpos64,libc_fsetpos64,ATTR_IN(2) ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, fpos64_t const *__restrict pos),(stream,pos));
DEFINE_PUBLIC_ALIAS_P(_IO_fsetpos64,libc_fsetpos64,ATTR_IN(2) ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, fpos64_t const *__restrict pos),(stream,pos));
DEFINE_PUBLIC_ALIAS_P(file_printer,libc_file_printer,ATTR_INS(2, 3) NONNULL((1)),ssize_t,NOTHROW_CB_NCX,__FORMATPRINTER_CC,(void *arg, char const *__restrict data, size_t datalen),(arg,data,datalen));
DEFINE_PUBLIC_ALIAS_P(file_printer_unlocked,libc_file_printer_unlocked,ATTR_INS(2, 3) NONNULL((1)),ssize_t,NOTHROW_CB_NCX,__FORMATPRINTER_CC,(void *arg, char const *__restrict data, size_t datalen),(arg,data,datalen));
DEFINE_PUBLIC_ALIAS_P(fdreopen,libc_fdreopen,ATTR_FDARG(1) ATTR_IN(2) ATTR_INOUT(3),FILE *,NOTHROW_RPC,LIBCCALL,(fd_t fd, char const *__restrict modes, FILE *__restrict stream),(fd,modes,stream));
DEFINE_PUBLIC_ALIAS_P(fdreopen_unlocked,libc_fdreopen_unlocked,ATTR_FDARG(1) ATTR_IN(2) ATTR_INOUT(3),FILE *,NOTHROW_RPC,LIBCCALL,(fd_t fd, char const *__restrict modes, FILE *__restrict stream),(fd,modes,stream));
DEFINE_PUBLIC_ALIAS_P(DOS$freopen_unlocked,libd_freopen_unlocked,ATTR_IN(1) ATTR_IN(2) ATTR_INOUT(3),FILE *,NOTHROW_RPC,LIBDCALL,(char const *__restrict filename, char const *__restrict modes, FILE *__restrict stream),(filename,modes,stream));
DEFINE_PUBLIC_ALIAS_P(freopen_unlocked,libc_freopen_unlocked,ATTR_IN(1) ATTR_IN(2) ATTR_INOUT(3),FILE *,NOTHROW_RPC,LIBCCALL,(char const *__restrict filename, char const *__restrict modes, FILE *__restrict stream),(filename,modes,stream));
DEFINE_PUBLIC_ALIAS_P(DOS$freopen64_unlocked,libd_freopen64_unlocked,ATTR_IN(1) ATTR_IN(2) ATTR_INOUT(3),FILE *,NOTHROW_RPC,LIBDCALL,(char const *__restrict filename, char const *__restrict modes, FILE *__restrict stream),(filename,modes,stream));
DEFINE_PUBLIC_ALIAS_P(freopen64_unlocked,libc_freopen64_unlocked,ATTR_IN(1) ATTR_IN(2) ATTR_INOUT(3),FILE *,NOTHROW_RPC,LIBCCALL,(char const *__restrict filename, char const *__restrict modes, FILE *__restrict stream),(filename,modes,stream));
DEFINE_PUBLIC_ALIAS_P(fseek_unlocked,libc_fseek_unlocked,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, long int off, int whence),(stream,off,whence));
DEFINE_PUBLIC_ALIAS_P(_fseek_nolock,libc_fseek_unlocked,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, long int off, int whence),(stream,off,whence));
DEFINE_PUBLIC_ALIAS_P(ftell_unlocked,libc_ftell_unlocked,WUNUSED ATTR_INOUT(1),long int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(_ftell_nolock,libc_ftell_unlocked,WUNUSED ATTR_INOUT(1),long int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(fseeko_unlocked,libc_fseeko_unlocked,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, off_t off, int whence),(stream,off,whence));
DEFINE_PUBLIC_ALIAS_P(ftello_unlocked,libc_ftello_unlocked,WUNUSED ATTR_INOUT(1),off_t,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(flushall_unlocked,libc_flushall_unlocked,,int,NOTHROW_CB_NCX,LIBCCALL,(void),());
DEFINE_PUBLIC_ALIAS_P(fgetpos_unlocked,libc_fgetpos_unlocked,ATTR_INOUT(1) ATTR_OUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, fpos_t *__restrict pos),(stream,pos));
DEFINE_PUBLIC_ALIAS_P(fsetpos_unlocked,libc_fsetpos_unlocked,ATTR_IN(2) ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, fpos_t const *__restrict pos),(stream,pos));
DEFINE_PUBLIC_ALIAS_P(setvbuf_unlocked,libc_setvbuf_unlocked,ATTR_INOUT(1),int,NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream, char *__restrict buf, __STDC_INT_AS_UINT_T modes, size_t bufsize),(stream,buf,modes,bufsize));
DEFINE_PUBLIC_ALIAS_P(ungetc_unlocked,libc_ungetc_unlocked,ATTR_INOUT(2),int,NOTHROW_NCX,LIBCCALL,(int ch, FILE *__restrict stream),(ch,stream));
...
DEFINE_PUBLIC_ALIAS_P(fseek64_unlocked,libc_fseeko64_unlocked,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, off64_t off, int whence),(stream,off,whence));
DEFINE_PUBLIC_ALIAS_P(_fseeki64_nolock,libc_fseeko64_unlocked,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, off64_t off, int whence),(stream,off,whence));
DEFINE_PUBLIC_ALIAS_P(ftello64_unlocked,libc_ftello64_unlocked,WUNUSED ATTR_INOUT(1),off64_t,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(ftell64_unlocked,libc_ftello64_unlocked,WUNUSED ATTR_INOUT(1),off64_t,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(_ftelli64_nolock,libc_ftello64_unlocked,WUNUSED ATTR_INOUT(1),off64_t,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(fgetpos64_unlocked,libc_fgetpos64_unlocked,ATTR_INOUT(1) ATTR_OUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, fpos64_t *__restrict pos),(stream,pos));
DEFINE_PUBLIC_ALIAS_P(fsetpos64_unlocked,libc_fsetpos64_unlocked,ATTR_IN(2) ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, fpos64_t const *__restrict pos),(stream,pos));
DEFINE_PUBLIC_ALIAS_P(fftruncate64,libc_fftruncate64,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, __PIO_OFFSET64 length),(stream,length));
DEFINE_PUBLIC_ALIAS_P(fftruncate64_unlocked,libc_fftruncate64_unlocked,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream, __PIO_OFFSET64 length),(stream,length));
DEFINE_PUBLIC_ALIAS_P(fgetln,libc_fgetln,WUNUSED ATTR_INOUT(1) ATTR_OUT_OPT(2),char *,NOTHROW_NCX,LIBCCALL,(FILE *__restrict stream, size_t *__restrict lenp),(stream,lenp));
DEFINE_PUBLIC_ALIAS_P(funopen2,libc_funopen2,WUNUSED,FILE *,NOTHROW_NCX,LIBCCALL,(void const *cookie, ssize_t (LIBKCALL *readfn)(void *cookie, void *buf, size_t num_bytes), ssize_t (LIBKCALL *writefn)(void *cookie, void const *buf, size_t num_bytes), off_t (LIBKCALL *seekfn)(void *cookie, off_t off, int whence), int (LIBKCALL *flushfn)(void *cookie), int (LIBKCALL *closefn)(void *cookie)),(cookie,readfn,writefn,seekfn,flushfn,closefn));
DEFINE_PUBLIC_ALIAS_P(funopen2_64,libc_funopen2_64,WUNUSED,FILE *,NOTHROW_NCX,LIBCCALL,(void const *cookie, ssize_t (LIBKCALL *readfn)(void *cookie, void *buf, size_t num_bytes), ssize_t (LIBKCALL *writefn)(void *cookie, void const *buf, size_t num_bytes), off64_t (LIBKCALL *seekfn)(void *cookie, off64_t off, int whence), int (LIBKCALL *flushfn)(void *cookie), int (LIBKCALL *closefn)(void *cookie)),(cookie,readfn,writefn,seekfn,flushfn,closefn));
DEFINE_PUBLIC_ALIAS_P(_flushall,libc__flushall,,int,NOTHROW_CB_NCX,LIBCCALL,(void),());
DEFINE_PUBLIC_ALIAS_P(_IO_flush_all,libc__flushall,,int,NOTHROW_CB_NCX,LIBCCALL,(void),());
DEFINE_PUBLIC_ALIAS_P(_IO_cleanup,libc__flushall,,int,NOTHROW_CB_NCX,LIBCCALL,(void),());
DEFINE_PUBLIC_ALIAS_P(_rmtmp,libc__rmtmp,,int,NOTHROW_RPC,LIBCCALL,(void),());
DEFINE_PUBLIC_ALIAS_P(__uflow,libc__filbuf,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(__underflow,libc__filbuf,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(__srget,libc__filbuf,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(_filbuf,libc__filbuf,ATTR_INOUT(1),int,NOTHROW_CB_NCX,LIBCCALL,(FILE *__restrict stream),(stream));
DEFINE_PUBLIC_ALIAS_P(__swbuf,libc__flsbuf,ATTR_INOUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(int ch, FILE *__restrict stream),(ch,stream));
DEFINE_PUBLIC_ALIAS_P(_flsbuf,libc__flsbuf,ATTR_INOUT(2),int,NOTHROW_CB_NCX,LIBCCALL,(int ch, FILE *__restrict stream),(ch,stream));
DEFINE_PUBLIC_ALIAS_P(_get_printf_count_output,libc__get_printf_count_output,ATTR_PURE WUNUSED,int,NOTHROW_NCX,LIBCCALL,(void),());
DEFINE_PUBLIC_ALIAS_P(_set_printf_count_output,libc__set_printf_count_output,,int,NOTHROW_NCX,LIBCCALL,(int val),(val));
DEFINE_PUBLIC_ALIAS_P(_get_output_format,libc__get_output_format,WUNUSED,uint32_t,NOTHROW_NCX,LIBCCALL,(void),());
DEFINE_PUBLIC_ALIAS_P(_set_output_format,libc__set_output_format,,uint32_t,NOTHROW_NCX,LIBCCALL,(uint32_t format),(format));
DEFINE_PUBLIC_ALIAS_P(_vfprintf_p,libc__vfprintf_p,ATTR_IN(2) ATTR_INOUT(1) ATTR_LIBC_PRINTF_P(2, 0),__STDC_INT_AS_SSIZE_T,NOTHROW_CB_NCX,LIBCCALL,(FILE *stream, char const *format, va_list args),(stream,format,args));
/*[[[end:exports]]]*/
