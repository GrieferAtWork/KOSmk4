...
INTDEF ATTR_PURE WUNUSED ATTR_ACCESS_RO(1) size_t NOTHROW_NCX(LIBCCALL libc___fbufsize)(FILE __KOS_FIXED_CONST *stream);
/* >> __freading(3)
...
INTDEF ATTR_PURE WUNUSED ATTR_ACCESS_RO(1) int NOTHROW_NCX(LIBCCALL libc___freading)(FILE __KOS_FIXED_CONST *stream);
/* >> __fwriting(3)
...
INTDEF ATTR_PURE WUNUSED ATTR_ACCESS_RO(1) int NOTHROW_NCX(LIBCCALL libc___fwriting)(FILE __KOS_FIXED_CONST *stream);
/* >> __freadable(3)
...
INTDEF ATTR_PURE WUNUSED ATTR_ACCESS_RO(1) int NOTHROW_NCX(LIBCCALL libc___freadable)(FILE __KOS_FIXED_CONST *stream);
/* >> __fwritable(3)
 * Returns non-zero if `stream' is writable, that is: has been opened
 * with "w",  "r+", or  some similar  flag that  allows for  writing. */
INTDEF ATTR_PURE WUNUSED ATTR_ACCESS_RO(1) int NOTHROW_NCX(LIBCCALL libc___fwritable)(FILE __KOS_FIXED_CONST *stream);
/* >> __flbf(3)
...
INTDEF ATTR_PURE WUNUSED ATTR_ACCESS_RW(1) int NOTHROW_NCX(LIBCCALL libc___flbf)(FILE *stream);
/* >> __fpurge(3)
...
INTDEF ATTR_PURE WUNUSED ATTR_ACCESS_RO(1) size_t NOTHROW_NCX(LIBCCALL libc___fpending)(FILE __KOS_FIXED_CONST *stream);
/* >> _flushlbf(3)
