...
INTDEF void NOTHROW_NCX(LIBCCALL libc___fpurge)(FILE *stream);
...
INTDEF int NOTHROW_NCX(LIBCCALL libc___fsetlocking)(FILE *stream, int type);
/* >> __fseterr(3)
...
INTDEF void NOTHROW_NCX(LIBCCALL libc___fseterr)(FILE *stream);
