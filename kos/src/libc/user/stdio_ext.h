...
INTDEF ATTR_PURE WUNUSED ATTR_IN(1) size_t NOTHROW_NCX(LIBCCALL libc___fbufsize)(FILE __KOS_FIXED_CONST *stream);
/* >> __freading(3)
...
INTDEF ATTR_PURE WUNUSED ATTR_IN(1) int NOTHROW_NCX(LIBCCALL libc___freading)(FILE __KOS_FIXED_CONST *stream);
/* >> __fwriting(3)
...
INTDEF ATTR_PURE WUNUSED ATTR_IN(1) int NOTHROW_NCX(LIBCCALL libc___fwriting)(FILE __KOS_FIXED_CONST *stream);
/* >> __freadable(3)
...
INTDEF ATTR_PURE WUNUSED ATTR_IN(1) int NOTHROW_NCX(LIBCCALL libc___freadable)(FILE __KOS_FIXED_CONST *stream);
/* >> __fwritable(3)
 * Returns non-zero if `stream' is writable, that is: has been opened
 * with "w",  "r+", or  some similar  flag that  allows for  writing. */
INTDEF ATTR_PURE WUNUSED ATTR_IN(1) int NOTHROW_NCX(LIBCCALL libc___fwritable)(FILE __KOS_FIXED_CONST *stream);
/* >> __flbf(3)
...
INTDEF ATTR_PURE WUNUSED ATTR_INOUT(1) int NOTHROW_NCX(LIBCCALL libc___flbf)(FILE *stream);
/* >> __fpurge(3)
...
INTDEF ATTR_INOUT(1) void NOTHROW_NCX(LIBCCALL libc___fpurge)(FILE *stream);
...
INTDEF ATTR_PURE WUNUSED ATTR_IN(1) size_t NOTHROW_NCX(LIBCCALL libc___fpending)(FILE __KOS_FIXED_CONST *stream);
/* >> __fpending(3), __fpending_unlocked(3)
 * Returns the number of pending, but not-yet-written bytes of modified
 * file  data (s.a. `__fwriting(3)'). A call to `fflush(3)' can be used
 * to write all modified data to the system, and following such a call,
 * this function will return `0' until new unwritten data appears. */
INTDEF ATTR_PURE WUNUSED ATTR_IN(1) size_t NOTHROW_NCX(LIBCCALL libc___fpending_unlocked)(FILE __KOS_FIXED_CONST *stream);
/* >> _flushlbf(3)
...
INTDEF ATTR_INOUT(1) int NOTHROW_NCX(LIBCCALL libc___fsetlocking)(FILE *stream, int type);
/* >> __fseterr(3)
...
INTDEF ATTR_INOUT(1) void NOTHROW_NCX(LIBCCALL libc___fseterr)(FILE *stream);
...
INTDEF ATTR_PURE WUNUSED ATTR_IN(1) size_t NOTHROW_NCX(LIBCCALL libc___freadahead)(FILE __KOS_FIXED_CONST *stream);
/* >> __freadahead(3), __freadahead_unlocked(3)
 * Returns  the # of bytes pending to-be read from the given `stream's internal buffer.
 * Once this many bytes have been read (or `__fpurge(3)' is called), the next read will
 * query the stream's underlying read function (usually `read(2)') for more data.
 ...
 *       are pending for write-back.
 * @return: * : The # of pending, unread bytes in the `stream's read-buffer. */
INTDEF ATTR_PURE WUNUSED ATTR_IN(1) size_t NOTHROW_NCX(LIBCCALL libc___freadahead_unlocked)(FILE __KOS_FIXED_CONST *stream);
/* >> __freadptr(3)
...
INTDEF WUNUSED ATTR_IN(1) char const *NOTHROW_NCX(LIBCCALL libc___freadptr)(FILE __KOS_FIXED_CONST *stream, size_t *p_num_bytes);
/* >> __freadptrinc(3)
 ...
 * undefined behavior. */
INTDEF ATTR_INOUT(1) void NOTHROW_NCX(LIBCCALL libc___freadptrinc)(FILE *stream, size_t num_bytes);
#endif /* !__KERNEL__ */
