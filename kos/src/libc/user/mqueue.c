...
/*[[[head:libc_mq_open,hash:CRC-32=0xf36e9339]]]*/
/* >> mq_open(3) */
INTERN ATTR_SECTION(".text.crt.utility.mqueue") WUNUSED NONNULL((1)) mqd_t
...
/*[[[head:libc_mq_getattr,hash:CRC-32=0x46f1445b]]]*/
/* >> mq_getattr(3) */
INTERN ATTR_SECTION(".text.crt.utility.mqueue") NONNULL((2)) int
...
/*[[[head:libc_mq_setattr,hash:CRC-32=0x7a1b8f9b]]]*/
/* >> mq_setattr(3) */
INTERN ATTR_SECTION(".text.crt.utility.mqueue") NONNULL((2)) int
...
/*[[[head:libc_mq_unlink,hash:CRC-32=0xf92624d]]]*/
/* >> mq_unlink(3) */
INTERN ATTR_SECTION(".text.crt.utility.mqueue") NONNULL((1)) int
...
/*[[[head:libc_mq_receive,hash:CRC-32=0x303f046d]]]*/
/* >> mq_receive(3) */
INTERN ATTR_SECTION(".text.crt.utility.mqueue") NONNULL((2)) ssize_t
...
/*[[[head:libc_mq_send,hash:CRC-32=0x8094903c]]]*/
/* >> mq_send(3) */
INTERN ATTR_SECTION(".text.crt.utility.mqueue") NONNULL((2)) int
...
/*[[[head:libc_mq_timedreceive,hash:CRC-32=0xa4d9ea4a]]]*/
/* >> mq_timedreceive(3), mq_timedreceive64(3) */
INTERN ATTR_SECTION(".text.crt.utility.mqueue") NONNULL((2, 5)) ssize_t
...
/*[[[head:libc_mq_timedsend,hash:CRC-32=0x3e237a5b]]]*/
/* >> mq_timedsend(3), mq_timedsend64(3) */
INTERN ATTR_SECTION(".text.crt.utility.mqueue") NONNULL((2, 5)) int
...
/*[[[head:libc_mq_timedreceive64,hash:CRC-32=0x1b06a865]]]*/
...
/*[[[head:libc_mq_timedsend64,hash:CRC-32=0x5763d2b6]]]*/
#if __SIZEOF_TIME32_T__ == __SIZEOF_TIME64_T__
