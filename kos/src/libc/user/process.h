...
INTDEF ATTR_IN_OPT(1) intptr_t (LIBDCALL libd__loaddll)(char __KOS_FIXED_CONST *file) THROWS(...);
INTDEF ATTR_IN_OPT(1) intptr_t (LIBCCALL libc__loaddll)(char __KOS_FIXED_CONST *file) THROWS(...);
#endif /* !__KERNEL__ */
