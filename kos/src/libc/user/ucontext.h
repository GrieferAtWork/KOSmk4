...
INTDEF ATTR_ACCESS_WR(1) int NOTHROW_NCX(LIBCCALL libc_getcontext)(ucontext_t *__restrict ucp);
/* >> setcontext(3)
 ...
 *       may test for, and which allows you to omit error-checks for this
 *       function. */
INTDEF ATTR_ACCESS_RO(1) int NOTHROW_NCX(LIBCCALL libc_setcontext)(ucontext_t const *__restrict ucp);
/* >> swapcontext(3)
 ...
 *       may test for, and which allows you to omit error-checks for this
 *       function. */
INTDEF ATTR_ACCESS_RO(2) ATTR_ACCESS_WR(1) int NOTHROW_NCX(LIBCCALL libc_swapcontext)(ucontext_t *__restrict oucp, ucontext_t const *__restrict ucp);
/* >> makecontext(3)
...
INTDEF ATTR_ACCESS_WR(1) NONNULL((2)) void NOTHROW_NCX(VLIBCCALL libc_makecontext)(ucontext_t *ucp, void (LIBKCALL *func)(void), __STDC_INT_AS_SIZE_T argc, ...);
#endif /* !__KERNEL__ */
