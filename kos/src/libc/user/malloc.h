...
INTDEF WUNUSED ATTR_ALLOC_ALIGN(1) ATTR_ALLOC_SIZE((2)) ATTR_MALLOC void *NOTHROW_NCX(LIBCCALL libc_memalign)(size_t alignment, size_t n_bytes);
INTDEF WUNUSED ATTR_MALL_PAGEALIGNED ATTR_ALLOC_SIZE((1)) ATTR_MALLOC void *NOTHROW_NCX(LIBCCALL libc_pvalloc)(size_t n_bytes);
INTDEF WUNUSED ATTR_MALL_PAGEALIGNED ATTR_ALLOC_SIZE((1)) void *NOTHROW_NCX(LIBCCALL libc_valloc)(size_t n_bytes);
...
INTDEF WUNUSED ATTR_MALL_DEFAULT_ALIGNED ATTR_ALLOC_SIZE((2)) ATTR_MALLOC NONNULL((1)) void *NOTHROW_NCX(LIBCCALL libc_memdup)(void const *__restrict ptr, size_t n_bytes);
INTDEF WUNUSED ATTR_MALL_DEFAULT_ALIGNED ATTR_ALLOC_SIZE((2)) ATTR_MALLOC NONNULL((1)) void *NOTHROW_NCX(LIBCCALL libc_memcdup)(void const *__restrict ptr, int needle, size_t n_bytes);
