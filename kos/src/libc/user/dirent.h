...
INTDEF NONNULL((1)) void NOTHROW_NCX(LIBCCALL libc_seekdir)(DIR *__restrict dirp, long int pos);
/* Get the directory stream position */
...
INTDEF NONNULL((1)) fd_t NOTHROW_NCX(LIBCCALL libc_dirfd)(DIR *__restrict dirp);
/* Scan a directory `DIR' for all contained directory entries */
INTDEF NONNULL((1, 2)) int NOTHROW_RPC(LIBCCALL libc_scandir)(char const *__restrict dir, struct dirent ***__restrict namelist, __scandir_selector_t selector, __scandir_cmp_t cmp);
/* Scan a directory `DIRFD:DIR' for all contained directory entries */
INTDEF NONNULL((2, 3)) int NOTHROW_RPC(LIBCCALL libc_scandirat)(fd_t dirfd, char const *__restrict dir, struct dirent ***__restrict namelist, __scandir_selector_t selector, __scandir_cmp_t cmp);
/* 64-bit variant of `scandir()' */
INTDEF NONNULL((1, 2)) int NOTHROW_RPC(LIBCCALL libc_scandir64)(char const *__restrict dir, struct dirent64 ***__restrict namelist, __scandir64_selector_t selector, __scandir64_cmp_t cmp);
/* 64-bit variant of `scandirat()' */
INTDEF NONNULL((2, 3)) int NOTHROW_RPC(LIBCCALL libc_scandirat64)(fd_t dirfd, char const *__restrict dir, struct dirent64 ***__restrict namelist, __scandir64_selector_t selector, __scandir64_cmp_t cmp);
