...
/*[[[head:libc_fts_children,hash:CRC-32=0x4622b039]]]*/
/* >> fts_children(3), fts_children64(3)
 * @param: instr: One of `FTS_AGAIN', `FTS_FOLLOW', `FTS_NOINSTR' or `FTS_SKIP' */
INTERN ATTR_SECTION(".text.crt.fs.fts") WUNUSED NONNULL((1)) FTSENT *
...
/*[[[head:libc_fts_close,hash:CRC-32=0xcef3e940]]]*/
/* >> fts_close(3), fts_close64(3) */
INTERN ATTR_SECTION(".text.crt.fs.fts") NONNULL((1)) int
...
/*[[[head:libc_fts_read,hash:CRC-32=0x6e39f543]]]*/
...
/*[[[head:libc_fts_set,hash:CRC-32=0xf4c1d2]]]*/
/* >> fts_set(3), fts_set64(3)
 * @param: instr: One of `FTS_AGAIN', `FTS_FOLLOW', `FTS_NOINSTR' or `FTS_SKIP' */
INTERN ATTR_SECTION(".text.crt.fs.fts") NONNULL((1, 2)) int
...
/*[[[head:libc_fts64_children,hash:CRC-32=0x4fb32c67]]]*/
#ifdef __FTS32_MATCHES_FTS64
DEFINE_INTERN_ALIAS(libc_fts64_children, libc_fts_children);
#else /* MAGIC:alias */
/* >> fts_children(3), fts_children64(3)
 * @param: instr: One of `FTS_AGAIN', `FTS_FOLLOW', `FTS_NOINSTR' or `FTS_SKIP' */
INTERN ATTR_SECTION(".text.crt.fs.fts") WUNUSED NONNULL((1)) FTSENT64 *
...
/*[[[head:libc_fts64_close,hash:CRC-32=0xd3c508a5]]]*/
#ifdef __FTS32_MATCHES_FTS64
DEFINE_INTERN_ALIAS(libc_fts64_close, libc_fts_close);
#else /* MAGIC:alias */
/* >> fts_close(3), fts_close64(3) */
INTERN ATTR_SECTION(".text.crt.fs.fts") WUNUSED NONNULL((1)) int
...
/*[[[head:libc_fts64_read,hash:CRC-32=0x4e2c6764]]]*/
#ifdef __FTS32_MATCHES_FTS64
...
/*[[[head:libc_fts64_set,hash:CRC-32=0xe2d88338]]]*/
#ifdef __FTS32_MATCHES_FTS64
