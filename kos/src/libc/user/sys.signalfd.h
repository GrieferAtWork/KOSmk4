...
INTDEF WUNUSED ATTR_ACCESS_RO(2) fd_t NOTHROW_NCX(LIBCCALL libc_signalfd)(fd_t fd, sigset_t const *sigmask, __STDC_INT_AS_UINT_T flags);
#endif /* !__KERNEL__ */
