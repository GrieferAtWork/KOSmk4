 ...
 */
#ifndef GUARD_LIBC_USER_KOS_FD_H
#define GUARD_LIBC_USER_KOS_FD_H 1

#include "../api.h"
#include "../auto/kos.fd.h"
...
INTDEF WUNUSED ATTR_FDARG(1) poll_mode_t NOTHROW_NCX(LIBCCALL libc_fd_polltest)(fd_t fd, poll_mode_t what);
/* >> fd_cast(3)
...
INTDEF WUNUSED ATTR_FDARG(1) fd_t NOTHROW_NCX(LIBCCALL libc_fd_cast)(fd_t fd, uint32_t type, iomode_t mode);
/* >> fd_msalign(3)
...
INTDEF WUNUSED ATTR_FDARG(1) ATTR_INOUT(2) fd_t NOTHROW_NCX(LIBCCALL libc_fd_msalign)(fd_t fd, uint64_t *p_offset, iomode_t mode);
/* >> fd_subregion(3)
...
INTDEF WUNUSED ATTR_FDARG(1) fd_t NOTHROW_NCX(LIBCCALL libc_fd_subregion)(fd_t fd, uint64_t base, uint64_t num_bytes, iomode_t mode);
/* >> fd_delregion(3)
...
INTDEF ATTR_FDARG(1) int NOTHROW_NCX(LIBCCALL libc_fd_delregion)(fd_t fd);
/* >> fd_tailread(3)
...
INTDEF WUNUSED ATTR_FDREAD(1) ATTR_OUTS(2, 3) ssize_t NOTHROW_NCX(LIBCCALL libc_fd_tailread)(fd_t fd, void *buf, size_t bufsize, uint64_t offset);
/* >> fd_trim(3)
...
INTDEF ATTR_FDARG(1) uint64_t NOTHROW_NCX(LIBCCALL libc_fd_trim)(fd_t fd, uint64_t base, uint64_t num_bytes, uint32_t mode);
#endif /* !__KERNEL__ */

DECL_END

#endif /* !GUARD_LIBC_USER_KOS_FD_H */
