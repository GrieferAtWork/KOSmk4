...
/*[[[head:libc_getcontext,hash:CRC-32=0x21f9024d]]]*/
...
INTERN ATTR_SECTION(".text.crt.cpu.ucontext") NONNULL((1)) int
...
/*[[[head:libc_setcontext,hash:CRC-32=0x812eb2a0]]]*/
...
/*[[[head:libc_swapcontext,hash:CRC-32=0x397875fa]]]*/
 ...
 *       may test for, and which allows you to omit error-checks for this
 *       function. */
INTERN ATTR_SECTION(".text.crt.cpu.ucontext") NONNULL((1, 2)) int
...
/*[[[head:libc_makecontext,hash:CRC-32=0x8b64a01c]]]*/
