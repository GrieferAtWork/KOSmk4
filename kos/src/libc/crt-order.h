...
#define CRT_SECTIONS_LINKORDER(CB, PREFIX) \
	...
	CB(PREFIX.crt.compat.linux.__register_frame PREFIX.crt.compat.linux.dirent PREFIX.crt.compat.linux.heap PREFIX.crt.compat.linux.stdio) \
	...
	CB(PREFIX.crt.dos.compat.dos.errno PREFIX.crt.dos.compat.dos.fs.stat PREFIX.crt.dos.compat.dos.msabi64) \
